   ...
   a_aerialis: {
      ...
      story: {
         ...
         barricade2: () => [
            ...
            choicer.create('* （你要怎麼回答？）', 'MTT Beauty', 'MTT Cooking', 'MTT Tech', 'MTT TV')
         ],
         barricade2b1: [
         ...
         cooker4a: [ '<32>{#p/mettaton}* 好極了！', '<32>* NOW, IF I MAY...' ],
         cooker4b: [ '<32>{#p/mettaton}* OKAY!', "<32>* 我們要用這些東西..." ],
         cooker5: () =>
            iFancyYourVilliany()
         ...
         cooker16e: () => [
            ...
            ...(iFancyYourVilliany()
               ...
               : [ '<32>* SO, UNTIL NEXT TIME...', '<32>* 讓我們祝願人類平安無事。' ])
         ],
         cooker16f: [
            '<32>{#p/basic}* Huh??',
         ...
         cooker17c: () => [
            ...
            ...(iFancyYourVilliany()
               ...
               : [ '<32>* SO, UNTIL NEXT TIME...', '<32>* 再見了各位！' ])
         ],
         cooker17d: [
      ...
      elevator1: () => [
         choicer.create('* （你想去哪裡？）', '取消', '核心入口', '核心出口', 'The Citadel')
      ],
      elevatorStory1: () => [ choicer.create('* （你想去哪裡？）', '核心入口', '取消') ],
      elevator2: () => [
         choicer.create('* （你想去哪裡？）', '空境', '取消', '核心出口', 'The Citadel')
      ],
      elevatorStory2: () => [ choicer.create('* （你想去哪裡？）', '空境', '取消') ],
      elevator3: () => [
         choicer.create('* （你想去哪裡？）', '空境', '核心入口', '取消', 'The Citadel')
      ],
      elevatorStory3: () => [ choicer.create('* （你想去哪裡？）', 'The Citadel', '取消') ],
      elevator4: () => [
