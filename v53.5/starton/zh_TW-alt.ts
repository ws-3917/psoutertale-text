...
export default {
   a_starton: {
      ...
      capstation2: [ '<32>{#p/human}* (You look behind the station.)', '<32>{#p/basic}* 沒有新東西。' ],
      crossword0: () =>
         world.edgy
            ? [
                 '<25>{#p/sans}* 喔，你來了。',
      ...
      whew1: () =>
         [
            ...
            [
               ...
               choicer.create('* (What will you do?)', '不睡', '睡覺')
            ],
            [
   ...
   b_opponent_mouse: {
      ...
      disownStatus: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Whizkarat.' ] : [ '<32>{#p/story}* 紳鼠貓逐漸變得不再冷靜。' ],
