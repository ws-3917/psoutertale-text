...
import { battler, choicer, dialogue_primitive, pager, player, world } from '../systems/framework';
...
const text = {
   ...
   a_common: {
      ...
      lastblook1: [
         ...
         () => [
            ...
            '<32>* my life the old homeworld was a quiet one.',
      ...
      charatrigger: {
         ...
         _frontier7: pager.create(
            ...
            [
               "<32>{#p/basic}* And it might be downhill from here, too, if we weren't buried in a jungle.",
      ...
      balcony1: [ '<25>{#p/kidd}{#f/3}* ... haha.', "<25>{#f/1}* We'll just have to explore it to find out!" ],
      balcony2: () => [
         '<25>{#p/kidd}{#f/7}* Wait...',
      ...
      balcony3: [
         "<25>{#p/kidd}{#f/2}* Man, I can't wait...",
   ...
   b_group_common: {
      nobody: () => (world.bullied ? '* ... but everybody ran.' : '* ... but nobody came.')
   },
   ...
   b_party_kidd: {
      ...
      mkShyrenDeathSad: [ "<25>{#p/kidd}{#f/8}* I'm so sorry..." ],
      mkMagic1: [
