...
// START-TRANSLATE
export function lateCall () {
   return SAVE.data.n.plot < 30
      ? [
      ...
      : [
           ...
           '<25>{#f/0}* Silly child.',
           '<25>{#f/1}* If you would like to visit, you may do so at any time...'
        ];
}
...
const text = {
   a_outlands: {
      ...
      finaltext: {
         ...
         e9: [
            ...
            '<26>{#f/17}* Despite our differences, $(name) and I really were inseperable.',
      ...
      fireplace1: () =>
         SAVE.data.b.svr
            ...
            : [
                 SAVE.data.n.state_wastelands_toriel === 2 || SAVE.flag.n.pacifist_marker_bully > 3
      ...
      bedfailToriel: [
         ...
         '<32>{#p/basic}* Toriel sang a nice lullaby to put you to sleep.'
      ],
      blooky1: [
      ...
      danger_puzzle1: () => [
         ...
         [ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy)
            ? '<25>{#f/1}* Perhaps you will do better with this one?'
      ...
      danger_puzzle4: () => [
         ...([ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy)
            ? [
                 '<25>{#p/toriel}{#f/9}* Ah... I see.',
                 '<25>{#f/5}* The terminal is too high for you to reach.',
                 '<25>{#f/0}* No matter.\n* I can enter the password for you.'
              ]
            : [
         ...
         '<25>{#f/1}* Still, it would be nice to see you solve its riddle...',
      ...
      danger_puzzle5e: () =>
         [ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy)
            ? [ '<25>{#p/toriel}{#f/5}* ...', '<25>{#f/1}* I suppose I can solve this one for you...' ]
            : [
                 '<25>{#p/toriel}{#f/1}* Ah... that is alright.',
                 '<25>{#f/0}* I do not want to pressure you, after all.'
              ],
      danger_puzzle6: () => [
      ...
      danger_puzzle7: () => [
         [ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? '<25>{#p/toriel}{#f/1}* Once ready, you may enter the next room...'
      ...
      dummy1: [
         ...
         '<25>{#f/1}* Do not worry, the process in any such encounter is simple...',
      ...
      dummy3: [
         ...
         '<25>{#f/5}* Hmm...',
         '<25>{#f/0}* Oh, I know!\n* Why not talk about how you got here?',
         '<25>{#f/0}* I am sure you must have quite the story.'
      ],
      dummy4: [
      ...
      food: () => [
         ...(SAVE.data.n.state_wastelands_mash === 2
            ...
            : [
                 ...
                 '<26>* I have prepared a plate of fried snails for you.'
              ]),
      ...
      front2: () => [
         ...(world.postnoot
            ? [
                 ...
                 "<25>{#f/1}* You weren't asleep for very long...",
                 '<25>{#f/5}* ...',
      ...
      front4: () => [
         ...
         ...(world.bullied
            ...
            : [
                 ...
                 '<25>* No fussing, no phone calls...',
                 ...(16 <= outlandsKills() && SAVE.flag.n.genocide_twinkly < resetThreshold()
                    ? [ '<25>* Nothing, save for that little yellow star...', '<25>* ...' ]
                    : [ '<25>* Nothing.' ])
              ]),
         ...(SAVE.data.n.state_wastelands_mash === 1
            ? [
      ...
      goodbye2: [
         ...
         '<25>{#f/9}* I know I cannot keep you here against your will.',
         '<25>{#f/1}* However... if you ever need someone to talk to out there...',
         '<25>{#f/0}* Feel free to call me, at any time.',
         '<25>{#f/1}* And if you need to return here for any reason...',
         '<25>{#f/0}* I will do my best to accommodate you during your stay.'
      ],
      goodbye3: [
         '<25>{#p/toriel}{#f/5}* I am sorry for what I have put you through.',
         '<25>{#f/9}* I know I cannot keep you here against your will.',
      ...
      indie1: () => [
         ...([ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? [
                 ...
                 '<25>{#f/0}* Perhaps this exercise will help.'
              ]
            : [
                 '<25>{#p/toriel}* So far, we have learned how to solve puzzles and handle encounters.',
      ...
      indie1b: [
         '<25>{#p/toriel}{#f/1}* Err...',
         '<25>{#f/0}* It IS important to do things on your own, correct?',
         choicer.create('* (Change your mind?)', 'Yes', 'No')
      ],
      ...
      indie3a: [ '<25>{#p/toriel}* You made it!' ],
      indie3b: [
      ...
      indie4: () => [
         ...([ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? [
                 '<26>{#f/1}* I must admit, I am surprised at how you handled yourself here...',
                 '<25>{#f/3}* Your behavior in earlier tests left much to be desired.',
                 '<25>{#f/23}* ... have you been trying to mess with me the whole time?',
                 '<25>{#f/1}* Well, regardless, I have some important errands to run.'
              ]
            : [
                 '<25>{#p/toriel}{#f/1}* Do not worry, you were never in any danger...',
                 '<25>{#f/0}* This was merely a test of your independence!',
                 '<25>{#f/1}* As it happens, I have some important errands to run.'
              ]),
         '<25>{#f/0}* While I am away, I expect you to be on your best behavior.',
         '<25>{#f/1}* There are puzzles ahead which I have yet to explain, and...',
         ...
         ...([ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? [
                 ...
                 '<25>{#f/5}* ...',
                 '<25>{#f/23}* Stay out of trouble, alright?'
              ]
            : [
                 '<25>{#p/toriel}{#f/1}* If you need anything while I am away, please...',
                 '<25>{#f/0}* Do not hesitate to call.',
      ...
      indie5: [
         [
            ...
            '<25>{#p/toriel}* Hello!\n* This is {@fill:#003cff}TORIEL{@fill:#fff}.',
      ...
      lobby_puzzle2: [
         '<25>{#p/toriel}* The outpost is littered with puzzles of many shapes and sizes.',
         '<25>{#f/1}* One must unlock them to move from room to room...',
         '<25>{#f/0}* Please, adjust yourself to the sight of them.'
      ],
      ...
      loox: {
         ...
         d: [
            "<32>{#p/basic}{#n1}* I hear you're somewhat of a rogue around here.",
            '<32>* Ha!\n* Join the club, pal.',
            "<32>* You're talking to the number one roughhouser around.",
      ...
      plot_call: {
         ...
         b: () => [
            ...
            '<25>{#f/1}* Would it be alright if you found it on your plate?',
            choicer.create('* (What do you say?)', 'Yes', 'No')
         ],
         b1: [ '<25>{#p/toriel}* Right, right, of course.', '<25>{#f/1}* Carry on, then...' ],
         b2: [
            '<25>{#p/toriel}{#f/5}* ...',
            '<25>{#f/0}* Well then.',
            '<25>{#f/1}* ...',
         ...
         world.meanie
            ...
            : [
                 ...
                 ...(SAVE.data.b.oops
                    ? []
                    : [
                         "<32>{#p/human}* (...)\n* (It appears there's a switch hidden in the drawer.)",
                         choicer.create('* (Pull the switch?)', 'Yes', 'No')
                      ])
              ],
      socks3: [
         "<32>{#p/human}* (...)\n* (It appears there's a switch hidden in the drawer.)",
      ...
      socks5: () =>
         SAVE.flag.b.$svr
            ...
            : !SAVE.isCanon()
            ? [
                 '<32>{#p/human}* (The switch appears to be broken.)',
                 "<32>{#p/basic}* Hmm... I guess there's not much you can do about this."
              ]
            : 8.1 <= SAVE.data.n.plot
            ? [
                 '<32>{#p/human}* (The switch appears to be stuck.)',
                 '<32>{#p/basic}* Hmm... it must have gotten stuck at some point.'
              ]
            : [ '<32>{#p/human}* (You pull the switch.)' ],
      socks6: [ '<32>{#p/human}* (You decide not to pull.)' ],
      socks7: () =>
         SAVE.data.b.svr
            ? [
      ...
      latetoriel1: [
         ...
         '<25>{#f/9}* ...',
         '<25>{#f/5}* Please, take the reigns and carry on...',
         '<25>{#f/1}* ... because, for once, I believe in you.',
         '<25>{#f/0}* I know you will do the right thing with or without me.'
      ],
      latetoriel2: [ '<25>{#p/toriel}{#npc/a}{#f/1}* Go on, young one.' ],
      ...
      trivia: {
         ...
         w_kitchenwall: () =>
            SAVE.data.n.plot === 9
               ? [ '<26>{#p/toriel}{#f/1}* Have patience, my child!' ]
         ...
         w_restricted1: () =>
            SAVE.data.n.plot === 72 && game.room === 'w_restricted' // NO-TRANSLATE
               ? [
               ...
               : [ '<32>{#p/basic}* There is a security field here.\n* It is locked.' ],
         w_ta_box: () =>
            SAVE.data.b.svr
               ? [
                    [
         ...
         w_tl_tools: () =>
            SAVE.data.b.svr
               ...
               ? [
                    ...
                    '<32>* Consider that Toriel\'s fire is only "pleasantly warm."',
         ...
         w_toriel_toriel: () => [
            ...
            toriSV()
               ...
               : '<32>{#p/basic}* It sounds like Toriel is looking for something...'
         ],
         w_tt_bed: () =>
            SAVE.data.b.svr
               ? [ '<32>{#p/human}* (The bed seems to be a little too large for you.)' ]
               : SAVE.data.n.state_wastelands_toriel === 2 || SAVE.flag.n.pacifist_marker_bully > 3
               ? [ "<32>{#p/basic}* It's a bed." ]
               : SAVE.data.n.plot < 72 || SAVE.flag.n.pacifist_marker_bully > 3
               ? [
               ...
               lines => () =>
                  SAVE.data.b.svr
                     ...
                     ? [
                          ...
                          '<32>{#p/basic}* That... was a pleasant surprise, actually.'
                       ]
                     : SAVE.data.n.plot < 14 ||
      ...
      twinkly20: [
         '<20>Ah, do not fear, little one. I am {@fill:#003cff}TORIEL{@fill:#000}, overseer of the {@fill:#f00}OUTLANDS{@fill:#000}.',
      ...
      twinkly21: [
         ...
         '<25>{#f/0}* Please, do not fear.\n* I am {@fill:#003cff}TORIEL{@fill:#fff}, overseer of the {@fill:#f00}OUTLANDS{@fill:#fff}.',
   ...
   b_opponent_toriel: {
      ...
      spareTalk17: [
         '<11>{#p/toriel}{#f/13}I know we do not have much, but...',
      ...
      spareTalk28b: [
         ...
         '<11>{#f/9}Maybe I should have just listened to you.',
         '<11>{#f/9}...',
         '<11>{#f/9}Forgive me, my child...',
         '<11>{#f/13}Forgive me for all that has transpired.'
      ],
   ...
   c_call_outlands: {
      ...
      hello: [
         [
            '<25>{#p/toriel}* This is {@fill:#003cff}TORIEL{@fill:#fff}.',
      ...
      insult1: (sus: boolean) =>
         sus
            ? [
                 ...
                 '<25>{#f/2}* ...!',
                 '<25>{#f/23}* Would you mind repeating that for me?'
              ]
            : [
                 '<25>{#p/toriel}{#f/0}* Hello?\n* This is...',
                 '<25>{#f/2}* ...!',
   ...
   c_call_toriel: (() => {
      ...
      const s_doggo = pager.create(0, () =>
         game.room === 's_doggo' && player.position.y > 60 // NO-TRANSLATE
            ? [
            ...
            : [
                 ...
                 '<25>{#f/0}* Sans did say he would discourage them from fighting you.',
                 '<25>{#f/1}* I know that I should be more worried...',
                 '<25>{#f/0}* But something tells me you will be alright.',
                 '<25>{#f/1}* It is like... instinct?'
              ]
      );
      const s_taxi = pager.create(
         0,
         [
            '<25>{#p/toriel}{#f/1}* So you have found another taxi stop?',
            '<25>{#f/1}* Hmm...',
            '<25>{#f/0}* I often wonder if they are different from the one in the Outlands',
            '<25>{#f/1}* Of course, I would have no way of knowing until I went there...'
         ],
         [ '<25>{#p/toriel}{#f/5}* I often wonder if I will ever go there again.' ]
      );
      const s_battle = [
      ...
      const f_battle = pager.create(
         0,
         [
            '<25>{#p/toriel}{#f/1}* You are near the end of the factory, my child...',
            '<25>{#f/0}* Take heart.\n* There are brighter pastures up ahead.',
            '<25>{#f/0}* Not to mention...',
            '<25>{#f/2}* My cell phone will be able to reach you in more places there!'
         ],
         [ '<25>{#p/toriel}{#f/3}* I should really get an upgrade...' ]
      );
      // TODO: Toriel plot-calls
      const a_start = pager.create(0, [ '<25>{#p/toriel}{#f/0}* It is only a placeholder, my child.' ]);
      /*
      a1: [
      ...
      a2: ['<25>{#p/toriel}{#f/5}* I wonder if humans still enjoy monster delicacies like these.'],
      a3: [
         '<25>{#f/0}* If I ever become a teacher, I would host a field trip here!',
      "<25>{#f/1}* With Dr. Alphys's permission of course."],
      a4: [
      ...
      a6: [ '<25>{#p/toriel}{#f/2}* I do not enjoy being moved against my will, thank you very much!' ],
      a7: [
      ...
      a8: [ '<25>{#p/toriel}{#f/0}* I look forward to seeing what you do next!' ],
      a9: [
         '<25>{#p/toriel}{#f/1}* Oh, I had almost forgotten about Sans.',
         '<25>{#f/1}* He is still looking after you, is he not?',
         '<25>{#f/5}* That, or he has started selling corn dogs once again.',
         '<25>{#f/3}* Why do I get the feeling it is the latter.',
      ...
      a12: [ '<25>{#p/toriel}{#f/1}* Spire houses, perhaps?' ],
      a13: [
      ...
      */
      return <Partial<CosmosKeyed<CosmosProvider<string[]>, string>>>{
         ...
         w_alley4: () =>
            SAVE.data.b.w_state_fightroom
               ...
               : [
                    ...
                    '<25>{#f/2}* Please, give me a chance to breathe!',
         ...
         w_danger: () =>
            SAVE.data.n.state_wastelands_froggit === 3
               ? [
                    ...
                    '<25>{#f/0}* How odd.\n* That particular one happened to be different.'
                 ]
               : [
                    ...
                    '<25>{#f/0}* The past cannot be changed, after all.'
                 ],
         w_dummy: () =>
            [
               [
               ...
               [
                  ...
                  '<25>{#f/0}* I have taught many... erm, monsters, how to handle encounters.',
               ...
               [
                  ...
                  '<25>{#f/0}* Perhaps you could use that to your advantage?'
               ]
         ...
         w_exit: () =>
            SAVE.data.n.plot < 16.1
               ? [
                    ...
                    '<25>{#f/1}* Whatever happens, no matter how terrile...',
                    '<25>{#f/0}* I want you to know that I have faith in you.',
                    '<25>{#f/1}* I know you want to do the right thing, and...',
                    '<25>{#f/0}* I believe you can.',
                    '<25>{#f/1}* Remember that for me, alright?',
                    '<25>{#f/1}* ...',
                    '<25>{#f/0}* Good luck.'
                 ]
               : lateCall(),
         w_froggit: [
            ...
            '<25>{#f/9}* Ones that believe it is their duty to defend the outpost.',
            '<25>{#f/1}* While they have every right to do so...',
            '<25>{#f/9}* That does not mean I have to agree with it.'
         ],
         w_junction: [
            '<25>{#p/toriel}* This area is but a few steps away from the taxi stop.',
            '<25>{#f/1}* Although it is a mostly uninteresting room in the present...',
            '<25>{#f/0}* In the past, we had planned a community area of sorts.',
            '<25>{#f/0}* Outlands visitors would be met with a warm, welcoming atmosphere.',
            '<25>{#f/1}* Over time, though, our plans for the area changed...',
            '<25>{#f/0}* Now, all you can find there are defunct pieces of equipment.'
         ],
         w_lobby: [
            '<25>{#p/toriel}{#f/1}* That is where I introduced myself to you, is it not?',
            '<25>{#f/0}* Who would have thought you would come all this way.',
         ...
         w_pacing: [
            '<25>{#p/toriel}{#f/5}* Are those monsters STILL sitting there?',
         ...
         w_party: [
            ...
            '<25>{#f/1}* Drama, dance nights, and the arts, of course...',
            '<25>{#f/0}* It is always good to see people expressing themselves.',
            '<25>{#f/1}* I once attended a comedy in that very room.',
         ...
         w_toriel_front: [
            ...
            '<25>{#f/0}* In fact, it led right to the exit of the Outlands.',
         ...
         w_toriel_toriel: [
            '<25>{#p/toriel}{#f/1}* Ah...\n* I see you have stumbled into my room.',
            '<25>{#f/1}* If you like, you may read a book from my bookshelf...',
            '<25>{#f/1}* But please do not forget to put it back.',
            '<25>{#f/23}* Oh, and keep out of my sock drawer!'
         ],
         w_toriel_hallway: [
            '<25>{#p/toriel}{#f/1}* There is not much to say about the hallway...',
            '<26>{#f/0}* Though, you can take a look in the mirror, if you like.',
            '<25>{#f/0}* I hear self-reflection can be quite useful.'
         ],
         w_toriel_kitchen: [
         ...
         w_twinkly: () =>
            SAVE.data.b.toriel_twinkly
               ? [
                    ...
                    '<25>{#f/1}* I wonder where he came from...'
                 ]
               : [
                    '<25>{#p/toriel}{#f/1}* That is where I found you, is it not?',
         ...
         s_sans: () =>
            SAVE.data.n.plot < 17.001
               ...
               ? [
                    ...
                    '<25>{#f/0}* Nothing less for such a sweet child!'
                 ]
               : [
                    '<25>{#p/toriel}{#f/1}* Oh, that Sans...',
                    '<25>{#f/0}* I wonder what you and him have gotten up to by now.',
         ...
         s_crossroads: [
            ...
            '<25>{#f/1}* There were some issues with craft arriving safely...',
         ...
         s_dogs: pager.create(0, [
            '<25>{#p/toriel}{#f/1}* Please, can somebody explain "dog justice?"',
            '<25>{#f/7}* It is an odd phrase I continue to hear every so often.',
            '<25>{#f/5}* I do know of one little puppy that likes to visit the Outlands...',
            '<25>{#f/0}* Maybe they are the one who deserves justice.',
            '<25>{#f/1}* Hmm...'
         ]),
         ...
         s_math: [
            ...
            '<25>{#f/1}* ...',
            '<25>{#f/1}* Er, most of the time, anyway.'
         ],
         s_jenga: [
            '<25>{#p/toriel}* To my knowledge, Dr. Alphys is the current royal scientist.',
            '<25>{#f/1}* Although she may never replace the experience of Dr. Roman...',
         ...
         f_quiche: pager.create(
            ...
            [
               ...
               '<25>{#f/0}* A good signal can be rather hard to come by out there.',
               '<25>{#f/6}* Though, my old phone might have something to do with that.',
               '<25>{#f/0}* It is good to hear from you, though.',
               '<25>{#f/1}* Please, keep yourself safe out there, will you?',
               '<25>{#f/9}* I have heard the guards out there are quite dangerous.'
            ],
         ...
         f_entrance: [
            ...
            '<25>{#f/2}* Synthbushes!',
            '<25>{#f/3}* Those things are horrible to get stuck in.',
         ...
         f_bird: pager.create(
            0,
            () =>
               SAVE.data.n.plot < 42 || SAVE.data.s.state_foundry_deathroom === 'f_bird' // NO-TRANSLATE
                  ? [
                  ...
                  : [
                       '<25>{#p/toriel}{#f/0}* Nothing like the chirp of a fearsome little bird.',
                       '<25>{#f/1}* Even when it still lived in a bucket of water...',
   ...
   s_save_outlands: {
      ...
      w_mouse: {
         ...
         text: () =>
            world.population > 5 && !SAVE.data.b.svr && SAVE.flag.n.pacifist_marker_bully < 4
               ? [
