...
import { battler, calcLV, choicer, instance, pager, player, world } from '../systems/framework';
import { SAVE } from '../systems/save';
import { CosmosInstance, CosmosUtils } from '../systems/storyteller';
...
const text = {
   a_citadel: {
      ...
      story: {
               ...
               ? [
                    ...
                    ...(rep < 2
                       ? [
                            ...
                            '<25>{*}{#e/twinkly/0}And if you come back...',
                            '<25>{*}{#e/twinkly/0}Try to act a little more in line next time.',
                            '<25>{*}{#e/twinkly/0}If there IS a next time.'
                         ]
                       : [
                            "<25>{*}{#p/twinkly}{#f/19}{#e/twinkly/0}Like always, I've given you Asgore's SOUL.",
                            '<25>{*}{#e/twinkly/0}Take it, and get out of my sight.',
                            '<25>{*}{#e/twinkly/0}And remember...',
                            "<25>{*}{#e/twinkly/0}This doesn't stop until you do exactly what I've told you."
                         ])
                 ]
               : [],
         ...
         killer1: [
            ...
            "<25>{*}{#e/twinkly/15}But now, you can't get it back unless you start over from scratch."
         ],
         killer2: [
         ...
         killer4: [
            ...
            "<25>{*}{#e/twinkly/18}You'll remember.\nAnd you'll avoid this outcome next time.",
         ...
         regret3: [
            ...
            "<25>{*}{#e/twinkly/6}Something I've been afraid of for a long time."
         ],
         regret4: () => [
            '<25>{*}{#p/twinkly}{#f/19}{#e/twinkly/7}...',
            "<25>{*}{#e/twinkly/7}You see, in the Outlands, there's a room.",
            ...(SAVE.data.b.w_state_diary
               ? [
                    '<25>{*}{#e/twinkly/3}A room with a diary, which I think you might have opened.',
                    "<25>{*}{#e/twinkly/4}At least, that's what it looks like.",
                    '<25>{*}{#e/twinkly/6}...',
                    "<25>{*}{#e/twinkly/6}You did read it, didn't you?",
                    '<25>{*}{#e/twinkly/7}Maybe... you could talk to Toriel about what you saw.'
                 ]
               : [
                    ...
                    '<25>{*}{#e/twinkly/6}...',
                    "<25>{*}{#e/twinkly/6}There's a switch in Toriel's room to unlock it.",
                    "<25>{*}{#e/twinkly/7}It's usually stuck, so you'd have to use it at the right time."
                 ]),
            '<25>{*}{#e/twinkly/10}...',
            ...
            "<25>{*}{#e/twinkly/1}There's probably not much point to it at all.",
            "<25>{*}{#e/twinkly/2}Everyone's happy, right?",
            '<25>{*}{#e/twinkly/3}Napstablook, Toriel, Sans, Papyrus, Undyne, Alphys, Asgore...',
            '<25>{*}{#e/twinkly/4}Even Monster Kid, and... Frisk.',
            '<25>{*}{#e/twinkly/2}Would you really throw it all away for something so... small?',
            '<25>{*}{#e/twinkly/2}...',
            "<25>{*}{#e/twinkly/10}Maybe I'm only telling you this, because... when I had your powers...",
            "<25>{*}{#e/twinkly/11}I might've considered doing the same.",
            '<25>{*}{#e/twinkly/12}But now, the idea of resetting everything...',
            '<25>{*}{#e/twinkly/10}I...',
            "<25>{*}{#e/twinkly/10}I don't think I could do it all again.",
            '<25>{*}{#e/twinkly/10}Not after that.',
            '<25>{*}{#e/twinkly/11}...',
            '<25>{*}{#e/twinkly/11}So, please.',
            '<25>{*}{#e/twinkly/11}Just let them go.',
            '<25>{*}{#e/twinkly/10}Let Frisk be happy.',
            "<25>{*}{#e/twinkly/5}Let the monsters see the future you've created for them."
         ],
         regret5: [
            ...
            '<25>{*}{#e/twinkly/6}...',
            '<25>{*}{#e/twinkly/2}You have to erase my memories, too.',
            '<25>{*}{#e/twinkly/7}...',
         ...
         choice1b: () =>
            world.bad_robot
               ? [
                    '<25>{#f/1}* Whatever the case may be, I cannot ask you to enter the archive.',
         ...
         sad0: () =>
            SAVE.flag.n.pacifist_marker_bully > 3
               ? [ '<25>{#p/asriel1}{#f/30}* I surrender!' ]
               : [ "<25>{#p/asriel1}{#f/25}* I'm so sorry." ],
         sad1: () => [
            ...(SAVE.flag.n.pacifist_marker_bully > 3
                       ...
                       ? [
                            ...
                            ...(SAVE.flag.n.genocide_milestone > 0
                               ? [
                                    ...
                                    "<25>{#f/21}* All those people I know you'd do anything to protect..."
                                 ]
                               : [
                                    "<25>{#p/asriel1}{#f/21}* I know we didn't get far, but...",
                                    '<25>{#f/15}* ... still...',
                                    '<25>{#f/21}* It was wrong of me to force you along like that.',
                                    "<25>{#f/21}* Especially when I know you'd do anything to protect them."
                                 ]),
                            ...(SAVE.data.b.oops
                               ? []
         ...
         hangar1: () =>
            SAVE.data.b.svr
               ? [
                    ...
                    "<25>{#f/17}* And, maybe it's just my imagination...",
               ...
               : [
                    ...
                    '<26>{#f/5}* You could say the universe is like... a box of chocolates.',
                    '<26>{#f/6}* You never know what you are going to get.',
                    '<25>{#f/21}* Unless you scan it in advance, that is.'
                 ],
         hangar2: () =>
            SAVE.data.b.svr
               ? [
                    ...
                    '<25>{#f/15}* ...',
                    '<25>{#f/15}* Mom and Dad will want to see me, so...',
                    "<25>{#f/17}* I'll go find them once we're on board.",
                    '<25>{#f/13}* As for you...',
                    '<25>{#f/20}* ... you should probably get some rest, Frisk.',
                    '<26>{#f/17}* You must be exhausted after all of this.',
                    '<25>{#f/13}* ...',
                    '<25>{#f/13}* Maybe, by the time you wake up...',
                    "<25>{#f/17}* You'll have a new home, and a loving family to support you."
                 ]
               : [
                    '<25>{#p/asgore}{#f/6}* Well... the transport ship is ready.',
                    '<25>{#f/5}* After you and I have boarded, the others will, too.',
                    '<25>{#f/6}* Once on board, you should lay down and get some rest.',
                    '<25>{#f/6}* The living quarters are on and below deck forty-seven.'
                 ],
         hangar3: () => (SAVE.data.b.svr ? [ '<26>{#p/asriel1}{#f/17}* Ready?' ] : [ '<25>{#p/asgore}{#f/6}* Ready?' ]),
         ...
         returnofchara3: [
            ...
            '<32>* ...',
            '<33>* At the moment of his death, my SOUL was... seperated.\n* From his one.',
      ...
      overworld: {
         ...
         fridgetrap1: () =>
            SAVE.data.b.svr
               ...
               : [ "<32>{#p/basic}* It's a stockpile of brand-name chocolate bars." ],
         fridgetrap2: () => [
            ...(SAVE.data.b.svr ? [] : [ '<32>{#p/basic}* ...', '<32>* Do you want one?' ]),
         ...
         brocall6: [
            ...
            "<25>{#g/alphysWorried}* It's like we've been waiting our while lives for you.",
            '<25>{#g/alphysWorried}* ...',
      ...
      trivia: {
         ...
         warningsign: () =>
            SAVE.data.b.svr
               ...
               : [
                    ...
                    '<32>{*}* "Scanning..."\n* "Scanning..."\n* "Scanning..."{^50}{%}',
                    world.genocide
                       ? '<32>{*}* "Subject \'$(nameu)\' identified."\n* "Subject \'ASRIEL\' identified."\n* "Verifying..."{^50}{%}'
                       : '<32>{*}* "Subject \'HUMAN\' identified."\n* "Verifying..."{^50}{%}',
                    '<32>{#c.backdoor}* "Access granted."\n* "You may now continue forth."'
                 ],
            ...
            SAVE.data.b.svr
               ? [
                    ...
                    [
                       ...
                       '<25>{#f/13}* So $(name) took a picture of it for good luck.'
                    ],
                    [
                       '<25>{#p/asriel1}{#f/13}* After $(name) took the picture, we were ready to head home...',
                       '<25>{#f/15}* But we looked up at the stars... and there we saw...',
                       '<25>{#f/23}* A thousand more starling flowers descending down from the heavens.',
         ...
         c_aa_bureau: () =>
            SAVE.data.b.svr
               ...
               ? [
                    '<32>{#p/human}* (You look inside the bureau...)',
                    '<32>{#p/basic}* The clothes once stored within have been taken out.'
                 ]
               : [
                    '<32>{#p/human}* (You look inside the bureau...)',
         ...
         c_aa_underwear: () =>
            SAVE.data.n.plot === 72 && !SAVE.data.b.svr && SAVE.flag.n.pacifist_marker_bully < 4
               ? []
               : [
   ...
   b_opponent_archive1: {
      name: () => (battler.volatile[0].sparable ? '* Toriel' : '* 0x546f7269656c'),
      status0: [ '<32>{#p/human}* (0x546f7269656c now stands before you.)' ],
      status1: [ '<32>{#p/human}* (0x546f7269656c seems intent on following a routine.)' ],
      ...
      dinnerStatus: [ '<32>{#p/human}* (0x546f7269656c would like to share something with you.)' ],

      act_storytimeX: [ '<32>{#p/human}* (But you have already been read a story.)' ],
      act_storytimeE: [ '<32>{#p/human}* (But 0x546f7269656c was not yet ready to read you a story.)' ],
      storyTalk: [
         '<11>{#p/toriel}Once, there was a {@fill:#42fcff}{@mystify:monster}monster{@mystify:}{@fill:#ffffff}...'
      ],
      storyStatus: [ '<32>{#p/human}* (0x546f7269656c has one more thing to do.)' ],

      act_bedtimeX: [ '<32>{#p/human}* (But you have already been put to sleep.)' ],
      act_bedtimeE: [ '<32>{#p/human}* (But 0x546f7269656c was not yet ready to put you to sleep.)' ],
      bedTalk: [ '<11>{#p/toriel}Good night, my child.' ],
      bedStatus: [ '<32>{#p/human}* (Toriel has served her purpose in this world.)' ],

      act_talkE: [ "<32>{#p/human}* (But 0x546f7269656c's wasn't finished with her routine.)" ],
   ...
   b_opponent_archive2: {
      name: () => (battler.volatile[0].sparable ? '* Gerson' : '* 0x476572736f6e'),
      status0: [ '<32>{#p/human}* (0x476572736f6e stands opposite the training area.)' ],
      status1: [ '<32>{#p/human}* (0x476572736f6e awaits your first move.)' ],
      ...
      failStatus: [ "<32>{#p/human}* (0x476572736f6e thinks it's time for a break.)" ],
      ...
      restStatus: [ '<32>{#p/human}* (0x476572736f6e awaits your next move with anticipation.)' ],

      act_handshakeE: [ "<32>{#p/human}* (But 0x476572736f6e's training was not yet complete.)" ],
   ...
   b_opponent_archive3: {
      name: () => (battler.volatile[0].sparable ? '* Dr. Roman' : '* 0x44722e20526f6d616e'),
      status0: [ '<32>{#p/human}* (0x44722e20526f6d616e takes control of the situation.)' ],
      status1: [ '<32>{#p/human}* (0x44722e20526f6d616e would like to run some tests on you.)' ],
      ...
      testStatus1: [ '<32>{#p/human}* (0x44722e20526f6d616e is ready to begin the next test.)' ],
      testStatus2: [ '<32>{#p/human}* (Dr. Roman has served his purpose in this world.)' ],

      act_notesE: [ "<32>{#p/human}* (But 0x44722e20526f6d616e wasn't ready to exchange notes.)" ],
      act_notesN: [ '<32>{#p/human}* (And Dr. Roman exchanged notes before fading away.)' ]
   },
   b_opponent_archive4: {
      name: () => (battler.volatile[0].sparable ? '* Napstablook' : '* 0x4e6170737461626c6f6f6b'),
      status0: [ '<32>{#p/human}* (0x4e6170737461626c6f6f6b is here by their computer.)' ],
      status1: [ '<32>{#p/human}* (0x4e6170737461626c6f6f6b is looking for a new sound.)' ],
      ...
      sampleStatus: [ '<32>{#p/human}* (0x4e6170737461626c6f6f6b is ready to start composing.)' ],
      ...
      failStatus: [ '<32>{#p/human}* (0x4e6170737461626c6f6f6b would like to try that again.)' ],
      composeStatus: [ '<32>{#p/human}* (0x4e6170737461626c6f6f6b is ready to start mixing.)' ],
      ...
      act_secretE: [ "<32>{#p/human}* (But 0x4e6170737461626c6f6f6b wasn't yet ready to tell you that.)" ],
   ...
   b_opponent_archive5: {
      name: () => (battler.volatile[0].sparable ? '* Asgore' : '* 0x4173676f7265'),
      status0: [ '<32>{#p/human}* (0x4173676f7265 stands tall.)' ],
      status1: [ '<32>{#p/human}* (0x4173676f7265 only wants one thing from you.)' ],
      ...
      act_promiseE: [ "<32>{#p/human}* (But 0x4173676f7265 hasn't served his purpose yet.)" ],
   ...
   b_opponent_asriel: {
      ...
      status11: () =>
         SAVE.data.b.oops
            ...
            : [ '<32>{#p/basic}* All those times I saw him talking with Toriel... about the past...' ],
            ...
            ? [
                 ...
                 ...(SAVE.flag.b.confront_twinkly
                    ...
                    : [
                         ...
                         '<20>{#e/twinkly/5}{#v/0}Oooh, we would have been INSEPERABLE.',
   ...
   s_save_citadel: {
      ...
      c_archive_start: { name: '0x64657465726d696e6174696f6e', text: [] },
      c_archive_path1: { name: '0x50617469656e6365', text: [] },
      c_archive_path2: { name: '0x42726176657279', text: [] },
      c_archive_path3: { name: '0x496e74656772697479', text: [] },
      c_archive_path4: { name: '0x5065727365766572616e6365', text: [] },
      c_archive_path5: { name: '0x4b696e646e657373', text: [] },
      c_archive_path6: { name: '0x4a757374696365', text: [] },
