...
import { battler, choicer, instance, pager, roomKills, shopper, world } from '../systems/framework';
...
export function iFancyYourVilliany () {
   return (
      ...
      (SAVE.data.n.bad_lizard === 1 ||
         (SAVE.data.n.plot < 49 ? SAVE.data.n.bully > 9 : SAVE.data.n.state_aerialis_basebully > 9) ||
         (SAVE.data.n.plot < 49 ? world.trueKills > 9 : SAVE.data.n.state_aerialis_basekill > 9))
   );
}
...
export function pms () {
   if (world.bad_lizard < 2) {
      return [
         'alphys0',
         ...(SAVE.data.s.pms === '' ? [] : SAVE.data.s.pms.split(',').filter(key => key in sidebarCellPms3))
      ];
   } else {
            ...
            : [
                 ...
                 ...(startonKill || sentryKill
                    ? [
                         ...
                         [ 'alphysY8A1a', 'alphysY8A1b', 'alphysY8A1c', 'alphysY8A1d' ][
                            SAVE.data.n.state_starton_doggo === 2 ? 3 : (startonKill ? 1 : 0) + (sentryKill ? 2 : 0) - 1
                         ],
                         'alphysY8A2',
                         'alphysY8A3'
                      ]
                 ...
                 ...(papyrusKill
                    ? [
                         ...
                         'alphysY8B2',
                         'alphysY8B3',
                         world.edgy || (world.population_area('s') <= 0 && !world.bullied_area('s'))
                            ? 'alphysY8B4a'
                            : 'alphysY8B4b',
                         'alphysY8B5',
                         'alphysY8B6',
...
export const evac = (ep = false) =>
   world.genocide ||
   ((ep ? epilogueOverride(world.population < 2) : world.population < 2) && !world.bullied) ||
   (world.badder_lizard && world.population < 4) ||
   world.bad_lizard > 1 ||
   SAVE.flag.n.pacifist_marker_bully > 3;

export const childEvac = (ep = false) =>
   world.genocide ||
   (ep ? epilogueOverride(world.population < 2) : world.population < 2) ||
   (world.badder_lizard && world.population < 6) ||
   world.bad_lizard > 1 ||
   SAVE.flag.n.pacifist_marker_bully > 3;

// START-TRANSLATE
export const sidebarCellPms3 = {
   alphysBadLizard: {
      author: 'SYSTEM',
   ...
   alphys2: {
      ...
      pm: () =>
         [
            iFancyYourVilliany()
               ? "still can't believe mettaton gave them a moniker???"
               : "still can't believe mettaton wanted me to fight them???", // pacifist
   ...
   alphys3: {
      ...
      pm: () =>
         [
            iFancyYourVilliany()
               ? "yeah let's hope that doesn't get blown out of proportion"
               : "yeah let's hope that doesn't happen again", // pacifist
            "yeah let's hope nothing bad happens" // badlizard 1
         ][SAVE.data.n.bad_lizard]
   },
   alphys4: {
      author: 'ALPHYS',
      pm: () =>
         [
            "really guys?\nTHERE'S ICE CREAM AT THE REC CENTER", // pacifist
            'awkward' // badlizard 1
         ][SAVE.data.n.bad_lizard]
   },
   alphys6: {
   ...
   alphys7: {
      ...
      pm: () =>
         SAVE.data.n.state_aerialis_crafterresult === 0
            ? "ok i'll be honest i have no idea how that worked out LOL" // if you didn't do the jetpack part in the MTT show
            : SAVE.data.n.bad_lizard < 1
            ? [
                 "wow, i should've known those bombs were just TV props LOL", // pacifist - didn't make it halfway to the end
                 ...
                 "anyone who wasn't watching just now missed out big time" // pacifist - made it to the end easily
   ...
   alphys10: {
      author: () => [ 'ALPHYS', 'NAPSTABLOOK22' ][SAVE.data.n.bad_lizard],
      pm: () =>
         [
            'oh hi undyne', // pacifist
            'i did... that one time...' // badlizard 1
         ][SAVE.data.n.bad_lizard]
   },
   alphys11: {
      author: () =>
   ...
   alphys13: {
      ...
      pm: () =>
         [
            "let me guess you're one of those mew mew starfire fans aren't you", // pacifist
            'uhhhh' // badlizard1
         ][SAVE.data.n.bad_lizard]
   },
   alphys14: {
   ...
   alphys15: {
      ...
      pm: () =>
         [
            'LOLLLLLLLLLLL "SPACE VENTURE"\naverage starfire fan can\'t spell XD', // pacifist
            "i'm really starting to regret not adding a block function" // badlizard1
         ][SAVE.data.n.bad_lizard]
   },
   alphys16: {
      author: 'ALPHYS',
   ...
   alphysYdoggo3: {
      author: 'ALPHYS',
      pm: "after he lost his eyesight, he'd come to my lab after work..."
   },
   alphysYdoggo4: {
      author: 'ALPHYS',
      pm: "i'd teach him how to use his ears with these little games i came up with"
   },
   alphysYdoggo5: {
      author: 'ALPHYS',
      pm: "he'd always leave with a big smile on his face. but now he's..."
   },
   alphysYdoggo6: {
      author: 'lazybones.',
      pm: 'i see.'
   ...
   alphysY8A1: {
      author: 'ALPHYS',
      pm: "you know the human's been killing monsters in starton right?"
   },
   alphysY8A1a: {
      author: 'ALPHYS',
      pm: "they're going after regular citizens"
   },
   alphysY8A1b: {
      author: 'ALPHYS',
      pm: "they're targeting the sentries"
   },
   alphysY8A1c: {
      author: 'ALPHYS',
      pm: "they're going after everyone"
   },
   alphysY8A1d: {
      author: 'ALPHYS',
      pm: "it's not just doggo they're after"
   },
   alphysY8A2: {
      author: 'lazybones.',
   ...
   alphysYdrake1: {
      author: 'ALPHYS',
      pm: "y'know... stardrake's mom came in the other day"
   },
   alphysYdrake2: {
      author: 'ALPHYS',
      pm: "she told me how proud she is of her son and the new friends he's made..."
   },
   alphysYdrake3: {
      author: 'ALPHYS',
   ...
   alphysYdrake5: {
      author: 'ALPHYS',
      pm: "yeah... i guess that's all i really can tell her huh"
   },
   alphysYdrake6: {
      author: 'lazybones.',
   ...
   alphysY8A7: {
      author: 'ALPHYS',
      pm: "never mind the human's back to killing again"
   },
   alphysY8A8: {
      author: 'lazybones.',
      pm: 'welp.'
   ...
   alphysY8B3: {
      author: 'ALPHYS',
      pm: "please tell me you're there"
   },
   alphysY8B4a: {
      author: 'lazybones.',
   ...
   alphysY8B16: {
      author: 'ALPHYS',
      pm: "things aren't getting any better"
   },
   alphysY8B17: {
      author: 'lazybones.',
   ...
   alphysY8B18: {
      author: 'ALPHYS',
      pm: "yeah but you're gonna help me evacuate right?"
   },
   alphysY8B19: {
      author: 'lazybones.',
   ...
   alphysY8C2a: {
      author: 'ALPHYS',
      pm: "it's the human... even the elite squad can't stop it"
   },
   alphysY8C2b: {
      author: 'ALPHYS',
      pm: "it's the human... they're going after the residents down there"
   },
   alphysY8C2c: {
      author: 'ALPHYS',
      pm: "it's the human... they're killing everybody down there"
   },
   alphysY8C3: {
      author: 'lazybones.',
   ...
   alphysY8D2a: {
      author: 'lazybones.',
      pm: "i don't know, alphys. i just don't."
   },
   alphysY8D2b: {
      author: 'lazybones.',
      pm: "i'm sorry, alphys. i wish i could do something, but i really can't."
   },
   alphysY8D2x: {
      author: 'ALPHYS',
      pm: "though i don't think i want to be here after everything that happened"
   },
   alphysY8D3: {
      author: 'ALPHYS',
   ...
   alphysY8D3x: {
      author: 'ALPHYS',
      pm: "who knows what they'll do next?"
   },
   alphysY8D4: {
      author: 'lazybones.',
   ...
   alphysY8D5: {
      author: 'ALPHYS',
      pm: "ok but don't get too close. they could kill someone at any moment"
   },
   alphysY8D6: {
      author: 'lazybones.',
   ...
   alphysY8D9: {
      author: 'ALPHYS',
      pm: "yeah i'll do that dont worry"
   },
   alphysZ1: {
      author: 'ALPHYS',
      pm: '...\nhello?'
   ...
   alphysZ2: {
      author: 'ALPHYS',
      pm: "sans i'm kinda getting worried"
   },
   alphysZ3: {
      author: 'ALPHYS',
   ...
   alphysZ4: {
      author: 'ALPHYS',
      pm: "you're pranking me right?\nyou wouldn't just die like that"
   },
   alphysZ5: {
      author: 'ALPHYS',
      pm: "sans please tell me that you're alive and safe"
   },
   alphysZ6: {
      author: 'ALPHYS',
      pm: "i'm sorry if i upset you for some reason or did something bad"
   },
   alphysZ7: {
      author: 'ALPHYS',
      pm: "it's just been tough on me since you left and i don't know what to do"
   },
   alphysZ8: {
      author: 'ALPHYS',
      pm: 'papyrus... no...'
   ...
   alphysZ9: {
      author: 'ALPHYS',
      pm: "god... i couldn't even bear to watch it this time"
   },
   alphysZ10: {
      author: 'ALPHYS',
      pm: 'um... sans'
   ...
   alphysZ11: {
      author: 'ALPHYS',
      pm: "i don't know if you're there in some form or not but"
   },
   alphysZ12: {
      author: 'ALPHYS',
      pm: "undyne's gone"
   ...
   alphysZ13: {
      author: 'ALPHYS',
      pm: "UNDYNE'S GONE AND I DONT FING KNOW WHAT TO DO"
   },
   alphysZ14: {
      author: 'ALPHYS',
      pm: 'sorry'
   ...
   alphysZ16: {
      author: 'ALPHYS',
      pm: "heck i don't even know why i'm talking to you anymore"
   },
   alphysZ17: {
      author: 'ALPHYS',
...
const text = {
      ...
      story: {
         ...
         moneyT3: (i: number) =>
            [
               ...
               [ '<25>{#p/asriel2}{#f/3}* This is so stupid.{%200}' ],
               []
            ][Math.min(i, 2)],
         moneyT4: (i: number) =>
            [
         ...
         opera25a: () =>
            iFancyYourVilliany()
               ? [ '<25>{*}{#p/alphys}{#g/alphysGarboCenter}* Geez.{^40}{%}' ]
         ...
         end7: () => [
            ...
            ...(SAVE.data.n.state_aerialis_mettastrikes > 2
               ? [
                    ...
                    "<32>{#x1}{#p/hapstablook}* There's no damage, dear.\n* I was just lowering my HP for dramatic effect.",
         ...
         endwalk1: () =>
            world.bad_lizard < 2
               ...
               : [
                    '<25>{#p/alphys}{#g/alphysNeutralSweat}* So... Mettaton, huh?',
                    '<25>{#g/alphysHaveSomeCompassion}* ...',
                    '<25>{#g/alphysSideSad}* He was going to kill you for all you did.',
                    '<25>{#g/alphysTheFactIs}* Not that I blame him.\n* Your actions caused him a lot of pain...',
                    '<25>{#g/alphysWorried}* Caused me... a lot of pain.'
                 ],
         endwalk2: () => [
            ...(world.bad_lizard < 2
               ? [ "<25>{#p/alphys}{#g/alphysNeutralSweat}* Look... there's a reason I've been watching over you." ]
               : [ "<25>{#p/alphys}{#g/alphysNeutralSweat}* But the kingdom can't afford your death." ]),
            '<25>* ...',
            '<25>{#g/alphysSideSad}* You see...',
         ...
         endwalk4: () => [
            ...
            ...(world.bad_lizard < 2
               ...
               : [
                    '<25>{#g/alphysHaveSomeCompassion}* ... just, please...',
                    "<26>* Don't get into any more trouble, okay?",
                    ...(world.postnoot
                       ? world.nootflags.has('undyne') // NO-TRANSLATE
                          ? [ '<25>{#g/alphysNeutralSweat}* ... especially with the atmospheric system acting up.' ]
                          : [ "<25>{#g/alphysInquisitive}* ... regardless if there's... something strange in the air..." ]
                       : [ '<25>{#g/alphysNeutralSweat}* ... the future might depend on it.' ])
                 ])
         ]
      },
      overworld: {
         ...
         topdesk1: () =>
            SAVE.data.b.svr || world.bad_lizard > 1 || world.genocide
      ...
      trivia: {
         ...
         spycamera1: () =>
            SAVE.data.b.svr
               ? [ '<32>{#p/human}* (The display appears to be completely offline.)' ]
               : SAVE.data.n.plot === 72
               ? [ '<32>{#p/basic}* This monitor is still calibrated to follow your movement for some reason.' ]
               : [
         ...
         coresign2: () =>
            SAVE.data.b.svr
               ? [
                    '<32>{#p/human}* (The sign describes the number of consecutive accident-free days there have been here.)',
                    "<25>{#p/asriel1}{#f/3}* They haven't actually had a single accident."
                 ]
               : [ '<32>{#p/basic}* "Good work, everyone! There have been 36524 accident-free days in a row."' ],
         coresign3: () =>
            SAVE.data.b.svr
               ? [
         ...
         a_drakemom: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : SAVE.data.b.s_state_chilldrake
                  ? [
                       "<32>{#p/basic}{#npc/a}* So listen up, you know my son Stardrake? He isn't feeling too hot.",
   ...
   b_opponent_glyde: {
      ...
      turn6e: [ "<20>{#p/basic}{#e/bpants/12}I don't work for you anymore. Get lost." ],
   ...
   b_opponent_mettaton2: {
      ...
      turnTalk5: () =>
         world.bad_robot
            ? [
                 "<20>{#p/mettaton}{#e/mettaton/17}{#a.la/9}{#a.ra/10}But just you watch.\nI'll tear that rotten organ right out of your body!"
              ]
            : SAVE.data.b.a_state_hapstablook
            ? [ "<20>{#p/mettaton}I wonder what you'd do in my place." ]
            : iFancyYourVilliany()
      ...
      turnTalk6: () =>
         world.bad_robot
            ...
            ? [
                 ...
                 '<20>{#p/mettaton}... then, perhaps a heart to heart will do us some good.'
              ]
      ...
      turnTalk8: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [ '<20>{#p/mettaton}Even if it never amounted to much.' ]
            : iFancyYourVilliany()
      ...
      turnTalk11: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [ '<20>{#p/mettaton}... but maybe this whole thing was a bad idea.' ]
            : iFancyYourVilliany()
      ...
      turnTalk12: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [
                 "<20>{#p/mettaton}I guess it must've taken courage...",
      ...
      turnTalk13: () =>
         world.bad_robot
            ? [
                 '<20>{#p/mettaton}{#e/mettaton/26}{#a.la/8}{#a.ra/8}... geez.',
                 "<20>{#e/mettaton/25}{#a.la/8}{#a.ra/8}You really are an annoying little bug, aren't you?"
              ]
            : SAVE.data.b.a_state_hapstablook
            ? [ '<20>{#p/mettaton}S... still, how can I trust them after all they did?' ]
      ...
      turnTalk14: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [ "<20>{#p/mettaton}I d-don't... know what to feel..." ]
            : iFancyYourVilliany()
      ...
      turnTalk15: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [ '<20>{#p/mettaton}Could it be that they really me... meant all that?' ]
            : iFancyYourVilliany()
      ...
      turnTalk16: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [ "<20>{#p/mettaton}Are they tr... truly sorry for what they've done?" ]
            : iFancyYourVilliany()
      ...
      epiphany: [
         ...
         () =>
            world.meanie
               ...
               : SAVE.data.b.oops
               ? // befriend
                 [ "<08>{#p/basic}{~}It's okay..", '<08>{#p/basic}{~}We can be friends..' ]
               : // hug
   ...
   i_tvm_radio: {
      ...
      use: () =>
         !world.genocide && battler.target?.opponent.metadata.reactTVM
            ? []
            : SAVE.data.b.freedom || game.room[0] === '_' // NO-TRANSLATE
   ...
   n_shop_gossip: {
      ...
      itemPurchasePrompt: () =>
         evac()
            ...
            : 'Buy it for\n$(x)G?',
      itemUnavailable: () =>
         evac() ? '<09>{#p/basic}Nothing left.' : "<09>{#p/basic}{#k/5/1}{@fill:#d4bbff}We're all sold out!\nMee-YOW!",
      menu: () =>
         evac() ? [ 'Take', 'Steal', 'Read', 'Exit' ] : [ 'Buy', world.meanie ? 'Steal' : 'Sell', 'Talk', 'Exit' ],
