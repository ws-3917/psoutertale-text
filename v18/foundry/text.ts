...
import { antiAteThreshold, battler, choicer, pager, roomKills, world } from '../systems/framework';
...
export function dogecon () {
   return world.dead_canine || dogex();
}
...
const text = {
   a_foundry: {
      ...
      darktoriel3: [ '<25>{#p/toriel}{#f/5}* ... huh?\n* You wanted me to call... Sans?', '<25>{#f/1}* I can try...' ],
      darktoriel4a: [
      ...
      blookyard1: pager.create(
         ...
         () =>
            SAVE.storage.inventory.contents.includes('tvm_mewmew') // NO-TRANSLATE
               ...
               : 48 <= SAVE.data.n.plot
               ? [
                    '<32>{#p/napstablook}* oh... you came back...',
                    '<32>* dang, you sure get around',
                    '<32>* i mean...',
                    '<32>* i guess i do too...',
      ...
      boots1: [ '<32>{#p/human}* (You got the Hoverboots.)', choicer.create('* (Equip the Hoverboots?)', 'Yes', 'No') ],
      ...
      candy1: () =>
         SAVE.data.b.svr
            ? [
                 ...
                 choicer.create('* (What will you make?)', 'Licorice', 'Water', 'Rations', 'Nothing')
              ]
            : [
      ...
      fallenfish: [ "<32>{#p/basic}* She's in shock." ],
      ...
      npcinter: {
         grandmuffdarkened: pager.create(
            ...
            () =>
               SAVE.data.n.state_foundry_muffet === 2
                  ? [
                       ...(world.bullied_area('f') // NO-TRANSLATE
                          ? [
         ...
         f_echo4: () =>
            SAVE.flag.n.pacifist_marker_bully > 3
               ? [
                    '<32>{#s/echostart}{#p/event}{#npc/a}* Signal start...',
                    '<32>{#p/basic}* (We were all there to see the force field go down.)',
                    "<32>* (We'd been told something like that could happen, but when we got there...)",
                    '<32>* (The same talking star who told us that... was holding monsters hostage.)',
         ...
         f_echo9: () =>
            SAVE.flag.n.pacifist_marker_bully > 3
               ...
               ? [
                    ...
                    "<32>{#p/basic}* (Geez, you're even more ruthless than I am when it comes to him!)",
         ...
         f_echoAbyss6: () =>
            SAVE.data.n.plot === 72
               ? [
                    ...
                    '<32>* This could be a kind of "seperate plane" where we\'re held before...',
         ...
         f_echoAbyss8: () =>
            SAVE.data.n.plot === 72
               ? [
                    '<32>{#s/echostart}{#p/event}{#npc/a}* Signal start...',
                    '<32>{#p/basic}* My name is Dr. Roman.\n* Royal scientist, and trusted associate of the crown.',
                    "<32>{#p/alphys}* Dr. Roman?\n* But you're...",
                    '<32>{#p/basic}* My name is Dr. Roman.\n* Royal scientist, and trusted associate of the crown.',
                    "<32>{#p/alphys}* He's repeating...\n* It must just be the Dr. Roman in everyone's memory.",
                    '<32>{#s/echostop}{#p/event}{#npc}* Signal stop.',
         ...
         f_temmie4: () =>
            SAVE.data.n.plot === 72
               ...
               : SAVE.data.s.state_foundry_deathroom === 'f_village' || world.genocide || 30 <= world.trueKills // NO-TRANSLATE
               ? [
                    [ '<32>{*}{#p/tem}{#i/5}{#s.stop}* I know what you did.', '{*}{#s.resume}{%}' ],
                    [ '<32>{*}{#p/tem}{#i/5}{#s.stop}* ...', '{*}{#s.resume}{%}' ]
      ...
      run2a: [ '<32>{#p/undyne}* ...', '<32>{#p/undyne}* This better be good.' ],
      run2b: [ '<32>{#p/undyne}* (Ugh...)' ],
                 ...
                 ...(SAVE.data.b.svr
                    ? [
                         [
                            ...
                            "<25>{#f/17}* Don't you know anything about quantum field theory?",
                            '<25>{#f/15}* I once spent months trying to prove it...',
                            "<25>{#f/13}* ... didn't get anywhere."
                         ],
                         [
                    ...
                    : [ "<32>{#p/basic}* It's a series of notes on quantum field theory." ])
              ],
      secretcallA: [
      ...
      sleeper: () =>
         SAVE.data.b.svr
            ? [ '<32>{#p/human}* (This sentry station strikes you as rather excessive.)' ]
            : world.darker
            ? [ "<32>{#p/basic}* It's a sentry station." ]
            : [ "<32>{#p/basic}* Sans's third sentry station.\n* What's the point of all these things, anyway?" ],
      sleepersans: [ "<32>{#p/basic}* He's fast asleep." ],
      ...
      spookydate0x: pager.create(
         ...
         [ "<25>{#p/sans}{#f/2}* keep it up, and maybe i'll even take you out for dinner." ]
      ),
      spookydate0y: [
      ...
      spookydate0: pager.create(
         ...
         [ '<25>{#p/sans}{#f/2}* maybe later we can even go out for dinner.' ]
      ),
      spookydate1: pager.create(
         0,
         [
            '<25>{#p/sans}* so i heard you made up with my bro...\n* the great papyrus.',
            '<25>{#f/2}* well, i consider that a great victory.',
            "<26>{#f/0}* whaddya say we celebrate the occasion at grillby's?",
            "<26>{#f/3}* getting in papyrus's good books earns you a spot in mine, y'know?",
      ...
      spookydate14b: [
         ...
         '<25>{#f/0}* i was so impressed with what i saw, it inspired me to become a sentry.',
      ...
      temstatue: () =>
         SAVE.data.b.svr
            ? [
                 '<32>{#p/human}* (You pull the switch behind the statue.)',
      ...
      sanscall2: () => [
         ...
         ...(world.population === 0
            ? [
                 "<25>{#f/0}* in the meantime, you shouldn't have any more trouble.",
            ...
            ? [
                 ...
                 '<25>{#f/3}* the area ahead of you is being evacuated as we speak.',
                 "<25>{#f/2}* hmm... i wonder if anyone's still out there."
              ]
            : geno()
            ? [
            ...
            ? [
                 ...
                 "<25>{#f/3}* rumor has it, someone's been roughing everyone up pretty bad."
              ]
            : [
                 '<25>{#f/0}* in the meantime, just be careful who you talk to.',
      ...
      trivia: {
         ghostparty1: pager.create(
            0,
            [
               "<32>{#p/finalghost}* Hello there.\n* It is I... the Outlands dummy.\n* I'm back to being a ghost now.",
               "<32>* Sorry if I come off strange, I don't think too much about how I talk to people.",
               ...
               "<32>{#p/basic}{#e/maddummy/1}* A song I wish I didn't make.",
               '<32>{#p/finalghost}* Oh?\n* YOU made this?',
               '<32>{#p/basic}* ...',
               '<32>{#e/maddummy/0}* Unfortunately.',
               "<32>{#p/finalghost}* ... I can see why you'd want to forget about it."
            ],
            [ "<32>{#p/finalghost}* They're looking to move past their violent ways." ]
         ),
         ghostparty2: [
            '<32>{#p/basic}* This whole "Mad Dummy" routine is getting boring.',
            "<32>* I've been thinking of finding a new body...",
            '<32>* Something like... a robo-girl, or a digi-woman...',
            '<32>* ... maybe even a Mew Mew doll?'
         ],
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                       ...
                       ...(ghostpartyCondition()
                          ? [
                               "<32>{#p/basic}{#e/maddummy/1}* We're ghosts, so we don't really need a couch.",
                               '<32>{#e/maddummy/0}* We just thought the room looked better with one in it.',
                               '<32>{#p/mettaton}* OF COURSE!\n* ANY GOOD LIVING SPACE REQUIRES AT LEAST ONE COUCH.',
                               '<32>{#p/finalghost}* I had no idea.\n* Seems like an oddly specific requirement to me.'
                            ]
                          : [])
                    ],
            () =>
         ...
         f_doge3: () =>
            SAVE.data.b.svr
               ...
               : [
                    ...
                    '<32>* "A monster with a human SOUL... a horrible being with unfathomable power."',
                    ...(world.goatbro && SAVE.flag.n.ga_asrielBeast++ < 1
                       ? [ '<25>{#p/asriel2}{#f/10}* A horrible being, eh?' ]
                       : [])
                 ],
         f_doge5: () =>
            SAVE.data.b.svr
         ...
         f_trash2: () =>
            SAVE.data.b.svr
               ...
               : [
                    ...
                    '<32>* ... describing them as makers of neither war, nor peace.'
                 ],
         f_trash3: () =>
            SAVE.data.b.svr
         ...
         f_undynedummy: () =>
            SAVE.data.n.plot === 72
               ? [
                    ...
                    '<32>* The name "Mad Dummy" hasn\'t suited me for a long time.',
                    '<32>* I wonder if Alphys could make me a new body...',
                    "<32>* ... knowing her, she'll probably make a replica of her Mew Mew doll."
                 ]
         ...
         hapstacouch: () =>
            SAVE.data.b.svr
               ...
               : [
                    "<32>{#p/basic}* Another couch, another awful temptation... you're so tired after all this traveling.",
         ...
         unddate: () => [
            ...
            ...(SAVE.data.n.plot > 64.1
               ...
               : [
                    ...
                    "<32>* It's been a while since I've... had a good laugh.",
                    '<32>* So... thanks.',
                    '<32>* ... now then, where to next?'
                 ])
         ],
         undyne1: [
      ...
      unddate4: () =>
         SAVE.data.b.undyne_respecc
            ? [
                 ...
                 '<18>{#p/papyrus}{#f/5}...',
                 '<25>{#p/undyne}{#f/1}* Come on, come inside!'
              ]
            : [
                 "<25>{#p/undyne}{#f/1}* Hi, I don't think we've...",
                 '<25>{#f/4}* ...',
      ...
      unddate62: () =>
         SAVE.data.b.undyne_respecc
            ? [
                 '<25>{#p/undyne}{#f/10}* ...',
                 '<25>{#f/9}* ... we should probably get out of this flaming house, first.',
                 '<25>{#f/16}* How about that?'
              ]
            : [
                 '<25>{#p/undyne}{#f/10}* ...',
      ...
      undyne1c: () =>
         ...
         world.edgy || (world.population_area('s') <= 0 && !world.bullied_area('s')) // NO-TRANSLATE
      ...
      watercooler1: () => [
         ...(SAVE.data.b.svr ? [] : [ "<32>{#p/basic}* It's a cooler full of electro- dampening fluid." ]),
   ...
   b_opponent_woshua: {
      ...
      touchText1: [ '<32>{#p/basic}* Skrubbington recoils from your touch.' ],
      touchText2: [ '<32>{#p/human}* (You give Skrubbington a friendly pat.)' ],
      cleanText1: [
   ...
   b_opponent_doge: {
      ...
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ...
            ? [ '<32>{#p/human}* (You flirt with Doge.)', '<32>{#p/basic}* Doge giggles playfully.' ]
            ...
            : world.flirt < 10
            ? [ '<32>{#p/human}* (You flirt with Doge.)', '<32>{#p/basic}* Doge tries not to react in any strong way.' ]
      ...
      act_flirt3: [
         ...
         '<32>* Thoroughly embarrased, Doge flees the scene...'
      ],
      batheText: [
      ...
      turnTalk9: () =>
         world.goatbro
            ...
            ? [
                 ...
                 '<11>{#p/basic}{~}Along with Canis Maximus, it led the unit well.',
                 '<11>{#p/basic}{~}But now...'
              ]
            : dogex()
            ? [ '<11>{#p/basic}{~}...' ]
      ...
      walkTextLate: [ "<32>{#p/human}* (You offer to take Doge on a walk, but she's already dried herself up for you.)" ],
   ...
   b_opponent_dateundyne: {
      ...
      flirtStatus0: [ '<33>{#p/story}* In this case, FIGHTING' ],
      ...
      cutscene2d: [
         "<20>{#e/undyne/11}I don't know what that was, but...",
         "<20>{#e/undyne/3}... something's really going wrong here.",
         "<20>{#e/undyne/4}There's no way you'd want to kill me after all this... right?",
         '<20>{#e/undyne/11}...\nYou humans...',
         '<20>{#e/undyne/40}You humans really are disgusting.'
      ]
   },
   ...
   i_goggles: {
      ...
      drop: [ '<32>{#p/human}* (You throw away the AR Goggles.)' ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ '<32>{#p/human}* (6 DF.)' ]
            : [ '<32>{#p/basic}* "AR Goggles" (6 DF)\n* Expand your reality! Makes you invincible longer.' ],
      name: 'AR Goggles',
      use: [ '<32>{#p/human}* (You wear the AR Goggles.)' ]
   },
   i_goggles_x: {
      battle: {
   ...
   i_quiche: {
      ...
      name: 'Cheesecake',
      use: [ '<32>{#p/human}* (You eat the Cheesecake.)' ]
   },
   i_rations: {
      battle: {
   ...
   n_shop_tem: {
      ...
      item: (armorprice: number) =>
         SAVE.data.n.plot === 72
            ? [
                 ...
                 '0G - free flake!!',
                 '0G - free flake!!',
                 SAVE.data.b.item_temyarmor || SAVE.flag.n.pacifist_marker_bully > 3
      ...
      itemPurchasePrompt: (free: boolean) =>
         free || SAVE.flag.n.pacifist_marker_bully > 3 ? 'Take it?' : 'Buy it for\n$(x)G?',
      itemSellPrompt: 'Sell it for\n$(x)G?',
      itemUnavailable: () =>
         SAVE.flag.n.pacifist_marker_bully > 3 ? '<09>{#p/basic}Nothing left.' : '<09>{#p/tem}{#k/2}no more item...',
   ...
   n_shop_tortoise: {
      ...
      item: () =>
         SAVE.flag.n.pacifist_marker_bully > 3
            ? [ '0G - Datapad?', '0G - AR Goggles?', '0G - Nebula Tea', '0G - Tree Sap', 'Exit' ]
            : world.genocide ||
              (world.population === 0 && !world.bullied) ||
              SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE
            ? [ '45G - Datapad?', '45G - AR Goggles?', '16G - Nebula Tea', '25G - Tree Sap', 'Exit' ]
            : SAVE.data.n.plot === 72
            ? [
                 SAVE.data.b.item_padd ? '25G - Datapad?' : '35G - Datapad',
                 SAVE.data.b.item_goggles ? '25G - AR Goggles?' : '35G - AR Goggles',
                 '5G - Nebula Tea',
                 '5G - Tree Sap',
                 'Exit'
              ]
            : [
                 ...
                 SAVE.data.b.item_goggles ? '45G - AR Goggles?' : '55G - AR Goggles',
                 '16G - Nebula Tea',
                 '25G - Tree Sap',
                 'Exit'
              ],
      itemInfo: () => [
         SAVE.data.b.item_padd || world.genocide || (world.population < 6 && !world.bullied)
            ? 'Weapon: 0AT\n($(x) AT)\nJust a bit\ninvincible.'
            : 'Weapon: 2AT\n($(x) AT)\nInvincible\nlonger.',
         SAVE.data.b.item_goggles || world.genocide || (world.population < 6 && !world.bullied)
            ? 'Armor: 4DF\n($(x) DF)\nJust a bit\ninvincible.'
            : 'Armor: 6DF\n($(x) DF)\nInvincible\nlonger.',
         'Heals 15HP\nSPEED\nup in\nbattle.',
         'Heals 35HP\nMade from\na real\ntree.'
      ...
      itemPrompt: () =>
         world.genocide || (world.population === 0 && !world.bullied) || SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE
      ...
      itemPurchasePrompt: () => (SAVE.flag.n.pacifist_marker_bully > 3 ? 'Take it?' : 'Buy it for\n$(x)G?'),
      menu: () =>
         SAVE.flag.n.pacifist_marker_bully > 3
            ? [ 'Take', 'Steal', 'Read', 'Exit' ]
            : [ 'Buy', world.meanie ? 'Steal' : 'Sell', 'Talk', 'Exit' ],
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE
            ? [ 'Your Fate', '(Threaten)', '(Fight)', 'Undyne', 'Exit' ]
            : world.population === 0 && !world.bullied
         ...
         () =>
            SAVE.data.n.plot === 72
               ? [
                    ...
                    '<32>{#k/0}* Though, they kinda wanted to stay with me in particular anyway.',
            ...
            SAVE.data.n.plot === 72
               ...
               ? world.genocide
                  ...
                  ? [
                       ...
                       '<32>{#k/3}* Killing her in front of my shop like that...',
   ...
   s_save_foundry: {
      ...
      f_battle: {
         name: 'Foundry - Bridge',
         text: () =>
            SAVE.data.n.state_foundry_undyne > 0 || SAVE.flag.n.pacifist_marker_bully > 3
      ...
      f_sans: {
         ...
         text: () =>
            world.dead_skeleton || SAVE.flag.n.pacifist_marker_bully > 3
               ? [
