...
export default {
   a_outlands: {
      ...
      fireplace1: () =>
         SAVE.data.b.svr
            ? [
                 ...
                 choicer.create('* (Crawl inside?)', 'Да', 'Нет')
              ]
            : [
                 ...
                 ...(world.darker
                    ? []
                    : [ '<32>* You could probably crawl in.', choicer.create('* (Crawl inside?)', 'Да', 'Нет') ])
              ],
      ...
      chair1e: () => [
         ...
         choicer.create('{#n1!}* (Read the book?)', 'Да', 'Нет')
      ],
      ...
      chair2a1: () => [
         ...
         choicer.create('{#n1!}* (Have breakfast?)', 'Да', 'Нет')
      ],
      ...
      danger_puzzle4: () => [
         ...
         choicer.create('* (Solve the riddle?)', 'Да', 'Нет')
      ],
      danger_puzzle5a: [
      ...
      twinkly1: [
         "<25>{#p/twinkly}{#f/5}* Приветик!\n* Я {@fill=#ff0}МЕРЦИК{@fill=#fff}.\n* {@fill=#ff0}ЗВЕЗДА{@fill=#fff}{@fill=#ff0}МЕРЦИК{@fill=#fff}!"
      ],
      twinkly2: [
         '<25>{#f/5}* Что принесло тебя в аванпост, путешественник?',
         '<25>{#f/5}* ...',
         "<25>{#f/8}* Вы потерялись, не так ли...",
