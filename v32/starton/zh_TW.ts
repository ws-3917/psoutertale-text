...
export default {
   a_starton: {
      ...
      papcomputer1: pager.create(
         ...
         () => [
            ...
            SAVE.data.b.svr
               ...
               : "<32>{#p/basic}* 電腦的瀏覽器\n  打開了一個\n  社交媒體網站。",
            choicer.create("* （登入Papyrus的賬號嗎？）", "是", "否")
         ],
         () => [
            SAVE.data.b.svr
               ? "<32>{#p/human}* (You move towards the computer...)"
      ...
      sansbook1: ["<32>{#p/basic}* 這是本關於非歐幾里德幾何的書。\n* 寫著「ALPHYS」的名字。"],
   ...
   b_opponent_papyrus: {
      ...
      flirtStatus5: ["<32>{#p/story}* Papyrus正在想著\n  sexy rectangles。"],
      ...
      flirtStatus11: ["<32>{#p/story}* ... 他還在想他的sexy rectangles."],
      ...
      turnTalk1a: ["<15>{#p/papyrus}{#f/20}瞧著吧！"],
