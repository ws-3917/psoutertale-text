...
export default {
   a_aerialis: {
      ...
      story: {
         ...
         cooker4a: [ '<32>{#p/mettaton}* 好极了！', '<32>* NOW, IF I MAY...' ],
         cooker4b: [ '<32>{#p/mettaton}* OKAY!', "<32>* 我们要用这些东西..." ],
         cooker5: () =>
            iFancyYourVilliany()
         ...
         cooker16e: () => [
            ...
            ...(iFancyYourVilliany()
               ...
               : [ '<32>* SO, UNTIL NEXT TIME...', '<32>* 让我们祝愿人类平安无事。' ])
         ],
         cooker16f: [
            '<32>{#p/basic}* Huh??',
         ...
         cooker17c: () => [
            ...
            ...(iFancyYourVilliany()
               ...
               : [ '<32>* SO, UNTIL NEXT TIME...', '<32>* 再见了各位！' ])
         ],
         cooker17d: [
               ...
               : [
                    ...
                    ...(world.dead_skeleton
                       ...
                       : [
                            ...
                            '<25>{#g/sansWink}* he gets nervous around you, 镁塔顿.'
                         ])
                 ],
         moneyVote3b: () =>
            iRespeccYourVilliany()
         ...
         moneyVote4a2: [ "<32>{#p/mettaton}* SO YOU'RE -NOT- VOTING FOR ANYONE, THEN.", '<32>* 好的。' ],
         moneyVote4a3: () => [
         ...
         moneyVote5c: () =>
            SAVE.data.n.state_foundry_muffet === 1
               ...
               : [
                    ...
                    '<25>{#f/4}* Voting for 纳普斯特 might hurt their feelings...',
         ...
         moneyItem2: {
            ...
            c: [ '<32>{#p/mettaton}* 哇，250G！', "<32>{#p/mettaton}* WHO WOULD'VE THOUGHT!?" ],
            d: () =>
               SAVE.data.n.state_foundry_muffet === 1
                  ? [
         ...
         moneyFinal1: () => [
            iRespeccYourVilliany()
               ...
               : '<32>{#p/mettaton}* AT LEAST THEY\'RE HAPPY.\n* AND FOR THE RECORD, IT\'S \"镁塔顿,\" NOT \"METATRON.\"',
         ...
         napchat0: [ '<32>{#p/human}* (You gave the 喵喵 Doll to 纳普斯特.)' ],
         napchat1: () =>
            SAVE.data.n.state_foundry_undyne === 1
               ...
               : [
                    ...
                    ...(world.bad_lizard === 1
                       ...
                       : [
                            ...
                            '<25>{#g/alphysSideSad}* About the puzzles, and about 镁塔顿, and...',
                            '<25>{#g/alphysHaveSomeCompassion}* ...',
         ...
         opera38: [
            ...
            '<32>* Remember what happened with 托丽尔?',
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                       ...
                       '<32>* \"Queen 托丽尔 has abandoned the throne over a few rushed words from 艾斯戈尔.\"',
      ...
      npc: {
         ...
         a_dresslion: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : SAVE.data.n.plot < 60
                  ? [
                       "<32>{#p/basic}{#npc/a}* As 镁塔顿's costume designer, it's my job to get him the right outfit.",
               ...
               SAVE.data.n.plot === 72
                  ...
                  ? iFancyYourVilliany()
                     ...
                     : [
                          ...
                          [ '<32>{#p/basic}{#npc/a}* Or maybe 镁塔 just went a little easy on ya.' ]
                       ][SAVE.data.n.state_aerialis_crafterresult]
                  : [
         ...
         a_greenfire: pager.create(
            ...
            () =>
               SAVE.data.n.plot < 56
                  ? [
                       ...
                       "<32>* I'm just really looking forward to 镁塔's next show!",
            ...
            () =>
               SAVE.data.n.plot < 56
                  ? [ '<32>{#p/basic}* 镁塔顿 usually has a schedule, but he forgot to make one this time.' ]
                  : SAVE.data.n.plot < 68
            ...
            () =>
               SAVE.data.b.killed_mettaton
                  ...
                  ? [
                       ...
                       "<32>{#p/basic}* Did ya know 镁塔顿's actually made of it??\n* Huhehehaw!"
                    ]
                  : [
                       "<32>{#p/basic}* I'm a reporter!\n* Today's news story is about death 'n' destruction!",
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  ? [
                       ...
                       "<32>* Y'know.\n* Before 镁塔顿 decided to rebuild the whole thing.",
         ...
         a_pyrope: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                       '<32>{#p/basic}{#npc/a}* 迷你火山 and I make up the rap group \"热火朝天.\"',
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                       ...
                       "<32>* 星儿's mom over there is the best... she can beat anyone!"
                    ],
            () =>
               SAVE.data.n.plot === 72
         ...
         a_diamond1: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : SAVE.data.n.plot < 68
                  ? [
                       "<32>{#p/basic}{#npc/a}* We came to see 镁塔顿's grand finale, but...",
                       ...(iFancyYourVilliany()
                          ? [
         ...
         a_diamond2: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  ? [
                       ...
                       iFancyYourVilliany()
                          ? '<32>* The final showdown between 镁塔顿 and the human villain, $(moniker2)...'
                          : '<32>* The final showdown between 镁塔顿 and his human star...',
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : SAVE.data.n.plot < 68
                  ? [ "<32>{#p/basic}{#npc/a}* I'm rooting for 镁塔顿!" ]
                  : SAVE.data.b.killed_mettaton
      ...
      elevator1: () => [
         choicer.create('* （你想去哪里？）', '取消', '核心入口', '核心出口', 'The Citadel')
      ],
      elevatorStory1: () => [ choicer.create('* （你想去哪里？）', '核心入口', '取消') ],
      elevator2: () => [
         choicer.create('* （你想去哪里？）', '空境', '取消', '核心出口', 'The Citadel')
      ],
      elevatorStory2: () => [ choicer.create('* （你想去哪里？）', '空境', '取消') ],
      elevator3: () => [
         choicer.create('* （你想去哪里？）', '空境', '核心入口', '取消', 'The Citadel')
      ],
      elevatorStory3: () => [ choicer.create('* （你想去哪里？）', 'The Citadel', '取消') ],
      elevator4: () => [
      ...
      dinnerdate11: () => [
         ...
         '<25>{#f/0}* oh, and she also had a ton of weird stuff to say about 艾斯戈尔.',
               ...
               SAVE.data.n.state_foundry_undyne
                  ...
                  : [
                       iFancyYourVilliany()
                          ...
                          : 'still cant believe 镁塔顿 wanted me to fight them???', 
                       'they seem... nice?' 
                    ][SAVE.data.n.bad_lizard]
         },
         alphys3: {
      ...
      sell1: () =>
         world.runaway
            ...
            : [
                 ...
                 "<30>{#k/7}* Hmm...\n* Why don't you try selling that to 布莱蒂 and 凯蒂?",
      ...
      sell1: () =>
         adultEvac()
            ...
            : [
                 ...
                 {
                    b: "<16>{#k/2/8}* We don't.\n* Really need.\n* Anything.",
                    c: "<16>{#k/1/7}* Wait! I'll pay 1000G if you get 镁塔顿 to autograph my butt!"
                 }
              ],
      sell2: () =>
         adultEvac()
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 ...
                 [ 'Alphys', '§fill=#ff0§Royal Scientist (NEW)', '§fill=#ff0§艾斯戈尔 (NEW)', 'Asgore' ][
      ...
      talkText: [
         () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    {
                       b: "<16>{#k/0/0}* I'm 布莱蒂, and this is my best friend, 凯蒂.",
                       c: "<16>* I'm 凯蒂, and this is my best friend, 布莱蒂.",
                       s: true
                    },
                    {
               ...
               : [
                    [
                       ...
                       ...(SAVE.data.b.killed_mettaton
                          ...
                          : [
                               {
                                  b: '<16>{#k/2/1}* So like, originally, 镁塔顿 was in charge here, right?',
                    ...
                    [
                       ...
                       {
                          b: '<16>{#k/2/5}* 凯蒂, we would have said no.',
                          c: '',
                          s: true
                       },
                       {
                       ...
                       {
                          b: "<16>{#k/5/6}* 凯蒂, don't you have ANY standards?",
                          c: '',
                          s: true
                       },
                       {
            ...
            SAVE.data.n.plot === 72
               ...
               : [
                    ...
                    [
                       ...
                       {
                          b: '<16>{#k/4/0}* So like... OBVIOUSLY 艾斯戈尔 made her the royal scientist.',
                    ...
                    [
                       ...
                       {
                          b: "<16>{#k/2/0}* So like, here's the thing about 艾斯戈尔...",
                       ...
                       ...[
                          [
                             ...
                             },
                             {
                                ...
                                c: "<16>{#k/2/6}* Yeah, didn't 艾斯戈尔, like, not even want one to begin with?"
                             }
                          ],
                          [
                             {
         ...
         text: () =>
            SAVE.data.n.plot < 65
               ? SAVE.data.b.a_state_hapstablook
                  ...
                  : [ "<32>{#p/human}* (镁塔顿's ludicrous hijinks fill you with determination.)" ]
               : SAVE.data.n.plot < 68
      ...
      a_core_checkpoint: {
         ...
         text: () =>
            SAVE.data.b.ubershortcut
               ...
               : SAVE.data.n.plot < 68
               ? [ "<32>{#p/human}* (The anticipation of 镁塔顿's grand finale fills you with determination.)" ]
               : SAVE.data.n.plot === 72
               ? [
