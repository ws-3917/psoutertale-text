...
export default {
   a_citadel: {
      ...
      overworld: {
         ...
         giftbox1a: () => [
            ...(SAVE.data.b.svr ? [] : [ "<32>{#p/basic}* 里面有一把武器。" ]),
            choicer.create('* （打开盒子吗？）', '是', '否')
         ],
         giftbox1b: () => [
            ...(SAVE.data.b.svr ? [] : [ "<32>{#p/basic}* 里面有一件防具。" ]),
            choicer.create('* （打开盒子吗？）', '是', '否')
         ],
         giftbox2a: () => [
            '<32>{#p/human}* （你带走了“大熊座”。）',
            ...
            SAVE.data.n.plot === 72 && !SAVE.data.b.svr && !world.runaway
               ...
               : [
                    ...
                    ...(SAVE.data.b.svr
                       ...
                       : [
                            '<32>{#p/basic}* 真可怕！',
                            "<33>{#p/basic}* 这是Asgore的内衣抽屉。\n* 出人意料地干净。",
                            '<33>{#p/basic}* ...大部分都是粉色，手工编织的，\n  上面缝着“我的老爹”的字样。'
                         ])
                 ]
      }
   },
