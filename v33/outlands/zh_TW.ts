...
export default {
   a_outlands: {
            ...
            () =>
               SAVE.data.b.napsta_performance
                  ? [
                       ...
                       choicer.create("{#n1!}* (Buy the Super Starwalker 1 for 5G?)", "是", "否")
                    ]
                  : [
                       ...(world.postnoot
                          ? [
                       ...
                       "<32>* 感興趣嗎？\n* 我只收10G。",
                       choicer.create("{#n1!}* (Buy the Super Starwalker 1 for 10G?)", "是", "否")
                    ],
            () =>
               SAVE.data.b.napsta_performance
                  ? [
      ...
      steaksale: {
         ...
         b: () => [
            ...
            choicer.create("* (Buy the Sizzli Steak for 20G?)", "是", "否")
         ],
         ...
         c: () => [
            ...
            choicer.create("* (Buy the Fizzli Soda for 5G?)", "是", "否")
         ],
   ...
   b_opponent_toriel: {
      ...
      criminal2: [ "<20>{#p/asriel2}{#f/3}歡迎回來，$(name)。", "<20>{#f/1}Ready to pick up where we last left off?" ],
