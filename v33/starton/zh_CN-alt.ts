...
export default {
   a_starton: {
      ...
      candy1: () => [
         SAVE.data.b.svr
            ...
            : "<32>{#p/basic}* 这是一台专门售卖\n  高档洋梅的自动售货机。",
         choicer.create("* (Buy the Exoberries for 8G?)", "是", "否")
      ],
      ...
      nicecreamPrompt1: [ choicer.create("* (Buy the Ice Dream for $(x)G?)", "是", "否") ],
      ...
      papyrusFinal7: [
         ...
         "<18>{#f/5}我们要不要就\n不战斗了...",
         "<18>{#f/5}...我直接\n放你走呢？",
         choicer.create("* （你要怎么回答？）", "放我走吧", "咱们再战")
      ],
   ...
   b_opponent_papyrus: {
      ...
      flirtStatus11: [ "<32>{#p/story}* ... 他还在想“方”“色”法\n  变得出名。" ],
      hurtStatus: [ "<32>{#p/story}* 帕派瑞斯 濒临失败。" ],
