...
[ "特別鳴謝 由§fill=#ff0§Mavis與朋友們§fill=#fff§提供" ]
   ...
   general: {
      ...
      lv: "LV",
      mystery1: "§mystify=愛國敬業誠信友善勤奮謙虛寬容堅韌樂觀溫和冷靜沉著自信果斷理性耐心細心勇敢熱情同情責任創新謹慎慷慨積極善良仁慈正義智慧毅力§啥玩意§mystify=§",
      mystery2: "{@mystify=愛國敬業誠信友善勤奮謙虛寬容堅韌樂觀溫和冷靜沉著自信果斷理性耐心細心勇敢熱情同情責任創新謹慎慷慨積極善良仁慈正義智慧毅力}啥玩意{@mystify=}",
      mystery2l: "{@mystify=愛國敬業誠信友善勤奮謙虛寬容堅韌樂觀溫和冷靜沉著自信果斷理性耐心細心勇敢熱情同情責任創新謹慎慷慨積極善良仁慈正義智慧毅力}啥玩意{@mystify=}",
      mystery2u: "{@mystify=愛國敬業誠信友善勤奮謙虛寬容堅韌樂觀溫和冷靜沉著自信果斷理性耐心細心勇敢熱情同情責任創新謹慎慷慨積極善良仁慈正義智慧毅力}啥玩意{@mystify=}",
      no: "否",
      nominal: "§fill=#0f0§正常",
      percent: "$(x)%",
      player: "玩家",
   ...
   menu: {
      ...
      story1: [ "<24>{#p/storyteller}Long ago, two species ruled the solar system: HUMANS and MONSTERS.{^60}{}" ],
      story2: [ "<24>As time passed, a war broke out between the two species.{^60}{}" ],
      story3: [ "<24>After the MONSTERS' home planet was destroyed, HUMANS declared victory.{^60}{}" ],
      story4: [ "<24>The remaining MONSTERS were banished to an abandoned outpost.{^60}{}" ],
      story5: [ "<24>A powerful force field was erected, and the MONSTERS were sealed in.{^60}{}" ],
      story6: [ "<24>Many years later.{^8}.{^8}.{^60}{}" ],
      story7: [ "<#24>     EBOTT SECTOR     \n         251X{^60}{}" ],
      story8: [ "<24>Tales speak of a place from which spacecraft never return.{^60}{}" ],
      story9: [ "<24>{^120}{}" ],
      story10: [ "<24>{^120}{}" ],
      story11: [ "<24>{^60}{}" ]
   },
