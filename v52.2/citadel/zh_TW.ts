...
export default {
   a_citadel: {
      ...
      genotext: {
         ...
         coretext2: [ '<32>{#p/basic}{#s/spiderLaugh}* 哈啊...', '<32>{#p/basic}* 一起再加把勁~' ],
      ...
      story: {
         ...
         bad15: [
            ...
            [ "<99>{*}{#p/twinkly}If you don't end this now...", "{*}終有一天，我會回來。" ],
            ...
            [ '<99>{*}{#p/twinkly}...?' ],
            [ '<99>{*}{#p/twinkly}... why?' ],
            [ '<99>{*}{#p/twinkly}... why are you being...', '{*}{#p/twinkly}...要對我這麼好？' ],
   ...
   b_opponent_asriel: {
      ...
      turnTalk13: (fluff: boolean) =>
         fluff
            ? [
                 ...
                 "<20>{*}{#p/asriel3}{#e/asriel/5}<20>{*}{#p/asriel3}{#e/asriel/5}現在...\n是時候徹底抹去\n這條時間軸了！"
              ]
            : [
                 '<20>{*}{#p/asriel3}{#e/asriel/0}胡鬧到此為止！',
                 "<20>{*}{#p/asriel3}{#e/asriel/5}現在，是時候徹底抹去\n這條時間軸了！"
              ],
      turnTalk14: [
      ...
      saveTalk8: [
         ...
         '<20>{*}{#p/asriel3}{#e/asriel/12}{#i/4}{@random=1.2/1.2}讓我贏吧！！！'
      ],
   ...
   b_opponent_final: {
      ...
      friend91: [ '<20>{#p/asriel1}哈囉！', '<20>你在那裡嗎，$(name)？', "<20>是我啊，你最好的朋友：" ],
