...
export default {
   a_starton: {
      ...
      aussie: pager.create(
         ...
         () =>
            SAVE.data.n.state_starton_trashprogress < 1
               ? [ "<25>{#p/sans}{#f/0}* 來嘛，過來看看。", "<25>{#f/2}* it's right up there, bucko." ]
      ...
      trashhunt3: () => [
         ...
         ...(SAVE.storage.inventory.size < 8
            ? [ "<32>{#s/equip}{#p/human}* （你獲得了玉狗聖劍。）", "<25>{#p/sans}{#f/2}* use it wisely." ]
            : [
                 "<32>{#p/human}* （你帶的東西太多了。）",
