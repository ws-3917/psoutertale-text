...
export default {
         ...
         s_spagnote: () =>
            SAVE.data.b.svr
               ...
               ? [
                    ...
                    '<32>* \"Ну.\"\n* \"Оказывается, в этом-то и есть смысл.\"',
                    '<32>* \"Я бы на твоём месте был с ним поосторожнее...\"',
                    '<32>* \"Потому что чем больше времени ты тратишь на попытки...\"',
                    '<32>* \"тем больше у меня времени на подготовку к следующей головоломке.\"',
                    '<#23>  «Ты шутишь».\n  Санс'
                 ]
               : [
                    "<32>{#p/basic}* Это записка от Папируса...",
               ...
               SAVE.data.b.svr
                  ? [
                       ...
                       [
                          '<26>{#p/asriel1}{#f/13}* После $(name) прибыв на место, они попытались убедить нас, что являются дипломатами.',
                          "<25>{#f/17}* К счастью, даже они не могли так хорошо врать.",
                          '<25>{#f/15}* Представь, насколько хуже могло бы быть, если бы им поверили...'
                       ],
                       [
                          "<26>{#p/asriel1}{#f/17}* Я рад, что ты не лжец, Фриск.",
                          "<25>{#f/20}* У меня и так достаточно трудностей в жизни.",
                          '<25>{#f/13}* ... эх, прости.\n* Эта тема возникла как из-под земли.',
                          '<26>{#f/13}* Я прошу прощения за это.'
                       ],
                       [ '<26>{#p/asriel1}{#f/17}* Жизнь иногда любит бросать в тебя кривые шары...' ]
                    ][Math.min(asrielinter.s_tree++, 3)]
                  : world.darker
                  ? [ '<32>{#p/basic}* ...' ]
                  : SAVE.data.n.plot === 72
   ...
   b_opponent_lesserdog: {
      ...
      status6: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Малый Пёс.' ] : [ '<32>{#p/story}* Canis Minor is overstimulated.' ],
      status7: () =>
         world.goatbro
            ? [ '<32>{#p/asriel2}* Малый Пёс.' ]
            : [ '<32>{#p/story}* Canis Minor shows no signs of stopping.' ],
      status8: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Малый Пёс.' ] : [ '<32>{#p/story}* Canis Minor is lowering.' ],
      status9: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Малый Пёс.' ] : [ '<32>{#p/story}* Canis Minor learns to code.' ],
      status10: () =>
         world.goatbro
            ? [ '<32>{#p/asriel2}* Малый Пёс.' ]
            : [ "<32>{#p/story}* Canis Minor is whining because it can't see you." ],
      status11: () => (world.goatbro ? [ '<32>{#p/asriel2}* Малый Пёс.' ] : [ '<32>{#p/story}* Hello there.' ]),
      status12: () =>
         world.goatbro
            ? [ '<32>{#p/asriel2}* Малый Пёс.' ]
   ...
   b_opponent_dogaressa: {
      ...
      loneStatus: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Один остался.' ] : [ '<32>{#p/story}* Dogamy is brokenhearted.' ],
   ...
   b_opponent_greatdog: {
      ...
      hurtStatus: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Почти мёртв.' ] : [ '<32>{#p/story}* Canis Major is panting slowly.' ],
      ignoreStatus1: () =>
         world.goatbro
      ...
      petStatus4: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* Она уязвима." ] : [ '<32>{#p/story}* Canis Major is contented.' ],
