import { adultEvac, burger, calm_lizard, childEvac, glade, iRespeccYourVilliany } from '../../code/aerialis/extras';
   ...
   a_aerialis: {
      ...
      story: {
            ...
            ...[
               ...
               [
                  ...
                  ...(SAVE.data.n.state_foundry_undyne > 0
                     ? [ "<25>{#f/13}* Even the death of...", "<25>{#f/13}* ..." ]
         ...
         end7: () =>
            SAVE.data.b.killed_mettaton
               ...
               : [
                    ...
                    "<25>{#p/alphys}{#g/alphysCutscene2}* He's fused, but only with the control chip inside."
                 ],
         end8: [
         ...
         end10: () => [
            ...
            SAVE.data.b.a_state_hapstablook
               ? "<32>* I should probably go pay my family a visit."
               : SAVE.data.n.state_starton_papyrus === 1
               ? "<32>* I'm not really sure what I'm going to do now."
               ...
               SAVE.data.n.plot === 72
                  ...
                  : [
                       ...
                       SAVE.data.b.killed_mettaton
                          ...
                          : world.genocide
                          ? "<32>* The the lights went off a while ago, so I could probably go back in..."
            ...
            SAVE.data.n.plot === 72
               ...
               : [
                    [
                       ...
                       "<32>{#k/4}* My boss pushed me around for far too long, and I wasted a whole year of my short life not telling him \"no.\"",
