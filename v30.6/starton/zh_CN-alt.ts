...
export default {
   a_starton: {
      ...
      sans6: [
         ...
         "<25>{#p/sans}* 嘿，别伤心嘛...\n",
         "<25>* {@fill=#ff0}反{@fill=#fff}正，我有{@fill=#ff0}重{@fill=#fff}磅武器\n  来助你一臂之{@fill=#ff0}力{@fill=#fff}。"
      ],
      sans7: [
   ...
   b_opponent_doggo: {
      ...
      normaStatus: () => (world.goatbro ? ["<32>{#p/asriel2}* 遁狗。"] : ["<32>{#p/story}* Doggo knows you're here."]),
      pet: () => [
         "<32>{#p/human}* （你摸了摸遁狗。）",
         ...(world.goatbro
            ? [
      ...
      status1: () => (world.goatbro ? ["<32>{#p/asriel2}* 遁狗。"] : ["<32>{#p/story}* Doggo blocks the way!"]),
      sussy: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 遁狗。"] : ["<32>{#p/basic}* Doggo is too suspicious of your actions."]
   },
   b_opponent_lesserdog: {
      ...
      status0: () => (world.goatbro ? ["<32>{#p/asriel2}* 小犬座。"] : ["<32>{#p/story}* Canis Minor appears."]),
      status1: () =>
         world.goatbro
            ? ["<32>{#p/asriel2}* 小犬座。"]
      ...
      status5: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 小犬座。"] : ["<32>{#p/story}* Canis Minor is barking excitedly."],
      status6: () =>
   ...
   b_opponent_greatdog: {
      ...
      closeStatus: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 大犬座。"] : ["<32>{#p/story}* Canis Major seeks affection."],
      ...
      ignoreStatus2: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 大犬座。"] : ["<32>{#p/story}* Canis Major is making puppy-dog eyes."],
      name: "* Canis Major",
      ...
      petStatus2: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 大犬座。"] : ["<32>{#p/story}* Canis Major wants some TLC."],
      petStatus3: () =>
      ...
      status0: () => (world.goatbro ? ["<32>{#p/asriel2}* 大犬座。"] : ["<32>{#p/story}* Canis Major appears."]),
      status1: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 大犬座。"] : ["<32>{#p/story}* Canis Major is watching you intently."],
      status2: () =>
         world.goatbro
            ? ["<32>{#p/asriel2}* 大犬座。"]
