...
export default {
   ...
   a_common: {
         ...
         ...(!SAVE.flag.b._skip
            ...
            : !SAVE.flag.b._call
               ...
               : SAVE.data.n.plot_pmcheck === 0 && phone.of("pms").display() && pms().length > 0
                  ...
                  : []),
         ...(!SAVE.flag.b._getg
            ? ["<25>{#x1}{#p/event}Bark!\n{#x1}{#p/event}Bark!", "<25>{#p/basic}(Shocking!)\n(You never acquired any G!)"]
            : !SAVE.flag.b._useg
      ...
      neutral2: [
         ...
         "<18>{#p/papyrus}{#f/6}...",
         "<18>{#p/papyrus}{#f/5}TRUTH BETOLD... IT HASN'T BEEN EASY FOR US.",
   ...
   b_opponent_maddummy: {
      ...
      gladStatus2: ["<32>{#p/story}* Glad Dummy正規劃著\n  今後的美好人生。"],
      gladStatus3: ["<32>{#p/story}* Glad Dummy好像很滿足。"],
