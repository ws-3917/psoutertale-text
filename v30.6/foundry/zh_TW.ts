...
export default {
   a_foundry: {
            ...
            SAVE.flag.n.genocide_milestone < 5
               ? SAVE.flag.n.ga_asrielStutter < 1
                  ? [
                     ...
                     "<25>{#p/asriel2}{#f/7}* Asgore，誰都不能分割\n  我和$(name)之間的紐帶。\n* 你不是不知道。",
      ...
      undynefinal2c2: () => [
         ...
         "<25>{#x2}* 不知道你怎麼想他的...",
         "<25>{#f/18}* 他很古怪，\n  他很天真，\n  他很自戀...",
         "<25>{#f/20}{#x3}* 但是，Papyrus絕不會\n  錯過任何一次報到。",
         "<25>{#f/18}{#x4}* 而且，不管幾點鐘給他打電話...",
         "<25>{#f/20}{#x5}* 他都絕不會響鈴兩次\n  還不接。",
         "<25>* ...",
         "<25>{#f/18}{#x6}* 現在，他不在了。",
         "<25>{#f/22}{#x7}* 他的兄弟，也不見了。",
         "<25>* ...",
         "<25>{#f/18}* 告訴我，你把他怎麼了？",
         "<25>{#f/11}{#x8}* 你把他 怎{^4} 麼{^4} 了{^4}？",
   ...
   b_opponent_undyne: {
      ...
      earlyChallenge: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/3}想{@fill=#f00}硬碰硬{@fill=#000}，是嗎？",
               "<20>{#e/undyne/2}成全你。"
            ]
            : respecc()
               ? [
      ...
      turnTalkA2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? ["<20>{#p/undyne}{#e/undyne/2}我給你講個故事吧。"]
            : respecc()
      ...
      turnTalkA3: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/2}從我努力訓練，\n夢想當上皇家守衛\n講起吧。",
               "<20>{#p/undyne}{#e/undyne/2}那時，並非一帆風順。"
            ]
            : respecc()
      ...
      turnTalkA6a: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/11}渴望成為皇家守衛，\n但舉步維艱...",
               "<20>{#e/undyne/3}我哀嚎著，多麼渴望\n有人聽到我的心聲。"
            ]
      ...
      turnTalkB6: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/4}我再怎麼逞強，\n用盡所有力氣...",
               "<20>{#e/undyne/11}但缺乏他那種品質，\n我到底沒法像他那樣。"
            ]
            : respecc()
         ...
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               world.trueKills > 9
                  ...
                  : "<20>{#p/undyne}{#e/undyne/11}現在他離去了...",
               "<20>{#p/undyne}{#e/undyne/2}那我給你的仁慈...",
      ...
      turnTalkC2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/2}你知道嗎，Alphys\n告訴我人類充滿決心...",
               "<20>{#p/undyne}{#e/undyne/1}不過你的決心\n也只能幫你走到這了，\n呵呵。"
            ]
            : respecc()
               ? [
