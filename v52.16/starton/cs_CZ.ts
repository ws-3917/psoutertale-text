...
export default {
   a_starton: {
      ...
      telescopeMeetup2: [
         ...
         '<25>{#f/7}* Když jsem se naposledy díval do dalekohledu, viděl jsem zatracenou SUPERNOVU!'
      ],
      telescopeMeetup3: [
         '<25>{#p/kidd}{#f/3}* Zde.\n*Vezmi si tohle.',
         '<32>{#s/equip}{#p/human}* (Prémiový členský poukaz byl přidán do vašeho svazku klíčů.)',
         '<25>{#p/kidd}{#f/7}* Nyní můžete použít JAKÝKOLI dalekohled, dokonce i ty „prémiové“!',
         '<25>{#f/1}* Ta krátká kostra mi jich předtím dala spoustu.',
      ...
      jukebox2: () => [
         ...
         choicer.create('* (Stop playback?)', 'Ano', 'Ne')
      ],
