...
export default {
   a_aerialis: {
      ...
      trivia: {
         ...
         corenote5: [
            "<32>{#p/basic}* 一段錄音，標著「鎂塔頓」。",
            "<32>{#p/human}* （你按下了播放鍵...）",
            "<32>{#p/alphys}* 一開始，和你相處不怎麼愉快。 \n  不過沒有你，我走不到今天這一步。 ",
            "<32>* 鎂塔頓，如果你在聽...\n  我想說，你是個十足的美人。",
      ...
      genotext: {
         ...
         core7b: [
            "<25>{#p/asriel2}{#f/3}* 原來是鎂塔頓。 \n* 就在裡面等著我們呢。 ",
            "<25>{#f/10}* 只看得清他的背影...",
            "<25>{#f/6}* 咱悄悄溜到他身後，\n  興許能打他個措手不及。"
         ],
         core7c: [ "<25>{#p/asriel2}{#f/7}* 你知道該做什麼。" ],
         core8a: [
            "<32>{#p/mettaton}* 真覺得我會輕易放你們離開嗎？",
            "<25>{#p/asriel2}{#f/8}* ...\n* 少跟我拐彎抹角。 \n* 你當然不會放我們走。 ",
            "<25>{#p/asriel2}{#f/7}* 這毫無意義，\n  你早晚都會死。"
         ],
         core8aX: () => [
            "<32>{#p/mettaton}* 真覺得我會輕易放你們離開嗎？",
         ...
         core8b: [
            "<25>{#p/asriel2}{#f/4}* 喂，我說...\n  你拋棄了你的家人...",
            "<25>{#f/3}* 等會也快變成\n  沒人要的零件了...",
            "<25>{#f/1}* 還不考慮下他們的感受嗎？",
            "<32>{#p/mettaton}* 知道我在做什麼，\n  他們肯定會以我為榮的。",
            "<32>* ...至於你呢？",
            "<32>* 那就不好說了。",
   ...
   b_opponent_mettaton2: {
      ...
      neointro: [
         "<20>{*}{#p/mettaton}你現在是橙色的了。{^30}{%}",
         "<20>{*}{#e/mettaton/4}那就是我的攻擊。{^30}{%}",
         "<20>{*}{#e/mettaton/12}...嘿，玩得開心點嘛。 \n誰說戰鬥中不行呢？{^30}{%}",
         "<20>{*}{#e/mettaton/0}Now, be a good darling and press [Z] to explode.{^30}{%}",
         "<20>{*}{#e/mettaton/0}不過，要小心喔...{^30}{%}",
         "<20>{*}{#e/mettaton/0}The more you do it, the slower you'll move.{^30}{%}",
         "<20>{*}{#e/mettaton/12}...說得夠多了。{^30}{%}",
         "<20>{*}{#e/mettaton/4}是時候送你們入土了。{^30}{%}"
      ],
      mettahero1: [
