...
export default {
   ...
   c_call_toriel: <Partial<CosmosKeyed<CosmosProvider<string[]>, string>>>{
      ...
      w_puzzle1: [
         ...
         '<25>{#f/5}* Bunu kurmamı sağlayan bilim adamı artık aramızda değil...',
      ...
      w_blooky: () =>
         SAVE.data.b.killed_mettaton
            ...
            : [
                 ...
                 '<25>{#f/1}* Görünüşe göre bu işte senin de parmağın var...?',
      ...
      w_courtyard: [
         ...
         '<25>{#f/1}* Buraya gelen her insan ile bunu düzeltmeyi düşündüm...',
      ...
      w_alley3: [
         ...
         '<25>{#f/5}* Yalnızca kendi ahmak arzularım doğrultusunda hareket ediyordum.',
