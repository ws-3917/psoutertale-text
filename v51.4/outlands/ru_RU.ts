...
export default {
   a_outlands: {
      ...
      steaksale: {
         ...
         b1: [ '<32>{#p/human}{#n1!}* (You got the Sizzli Steak.)', '<32>{#p/basic}{#n1}* Отличный выбор, красавчик ;)' ],
         ...
         c1: [ '<32>{#p/human}{#n1!}* (You got the Fizzli Soda.)', "<32>{#p/basic}{#n1}* Осторожно, он сладкий ;)" ],
      ...
      trivia: {
         ...
         w_ta_frame: () =>
            SAVE.data.b.svr
               ...
               : [ '<32>{#p/basic}* Пустая фоторамка.', "<32>* There's not much else to say." ],
         w_ta_paper: () =>
            SAVE.data.b.svr
               ? [
