         ...
         moneyItem3: {
            ...
            d: () =>
               iRespeccYourVilliany()
                  ...
                  : [ '<32>{#p/mettaton}{#z0}* BLOOKY！', '<32>* 我很荣幸能把这份礼物\n  送给你。' ],
            e: () =>
               iFancyYourVilliany()
                  ? [
   ...
   n_shop_gossip: {
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 '关于你们两个',
                 SAVE.data.n.plot < 68 ? '旧货铺' : SAVE.data.b.killed_mettaton ? 'Mettaton' : 'Grand Finale',
