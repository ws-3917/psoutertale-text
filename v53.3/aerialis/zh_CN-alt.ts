...
export default {
   a_aerialis: {
      ...
      hotelfood0: () =>
         SAVE.data.b.svr
            ? [
                 ...
                 choicer.create('* （拿走食物吗？）', '是', '否')
              ]
            : [ "<33>{#p/basic}* 这是某种神秘的食物。", choicer.create('* （拿走食物吗？）', '是', '否') ],
      hotelfood1: () => [
         '<32>{#p/human}* （你拿走了神秘食物。）',
      ...
      story: {
         ...
         rg1b2: () =>
            world.bad_lizard > 1
               ...
               : [ '<32>{#p/basic}{#x1}* 我和我男朋友到处都找遍了！{#x3}' ],
         rg1c: () =>
            world.bad_lizard > 1
               ? [ '<33>{#p/basic}{#x2}* 该死，老兄。\n* 我想我们，就，\n  可能得杀掉他们才行。{#x3}' ]
               : [
                    '<32>{#p/basic}{#x1}* 你还好吗，孩子？{#x3}',
                    "<32>{#x1}* 你表现得，就，挺奇怪的...{#x3}",
                    '<32>{#x1}* 你知道的，\n  就是你完全“不跟我们说话”的\n  样子...{#x3}',
                    '<32>{#x1}* 所以，呃...{#x3}'
                 ],
         rg1d1: () =>
         ...
         barricade1: () => [
            '<32>{#p/event}* 铃铃，铃铃...',
            "<25>{#p/alphys}{#g/alphysSideSad}* 我感觉你应该过不去...",
            '<25>{#g/alphysSmileSweat}* 我看看能不能帮到你。',
            '<32>{#p/human}* （有谁在狂敲键盘的声音。）',
            '<25>{#p/alphys}{#g/alphysNervousLaugh}* 安保系统... 什-什么？',
            '<32>{#p/human}* （又传来了一阵敲键盘的声音。）',
            '<32>{#p/human}* （...）',
            '<32>{#p/human}* （敲键盘的声音停下来了。）',
            "<25>{#p/alphys}{#g/alphysWelp}* 看来... 我们得\n  回答安保问题了。",
            "<25>{#g/alphysGarbo}* 镁塔顿的安保问题...",
            '<25>{#g/alphysNeutralSweat}* 你... 知道什么关于\n  镁塔顿的有用的信息吗？',
            '<25>{#g/alphysTheFactIs}* ...应该不知道吧，\n  毕竟你才刚见过他...',
            "<25>{#g/alphysUhButHeresTheDeal}* 好吧，呃，\n  你应该知道第一个\n  问题的答案。",
            '<25>{|}{#g/alphysIDK}* “谁最喜- {%}',
            ...(world.postnoot
               ? []
               : [
                    "<25>{#g/alphysWTF}* 天啊他果然用这个\n  当安保问题了。",
         ...
         barricade1b1: [
            ...
            '<25>{#g/alphysFR}* 我才不喜欢镁塔顿呢。',
            "<25>{#g/alphysCutscene2}* 试试... 艾斯戈尔。"
         ],
         barricade1b2: [ '<25>{#p/alphys}{#g/alphysSmileSweat}* 嗯... 好吧。' ],
         barricade1b3: () => [
            '<25>{#p/alphys}{#g/alphysNervousLaugh}* 你确定？',
            '<25>{#p/alphys}{#x1}* ...',
            ...(SAVE.data.n.state_starton_papyrus === 1
               ? [
                    '<25>{#p/alphys}{#g/alphysSideSad}* 哦，看来回答正确了。',
                    '<25>{#g/alphysHaveSomeCompassion}* ...'
                 ]
               : [
                    '<25>{#p/alphys}{#g/alphysWelp}* 哇哦，看来答对了。',
                    '<25>{#g/alphysFR}* ...',
                    "<25>{#g/alphysFR}* 这还真是个\n  关于帕派瑞斯的\n  奇妙的事实。",
                    '<25>{#p/alphys}{#g/alphysUhButHeresTheDeal}* 但没事！！'
                 ])
         ],
         barricade1b4: () => [
         ...
         barricade2: () => [
            '<32>{#p/event}* 铃铃，铃铃...',
            '<25>{#p/alphys}{#g/alphysCutscene2}* 好，接下来的\n  这个问题是...',
            '<25>{|}{#g/alphysCutscene1}* “镁塔顿最成- {%}',
            '<25>{#g/alphysGarbo}* 他是认真的吗？',
            '<25>{#g/alphysGarboCenter}* 不是吧。',
            '<25>{#g/alphysWelp}* “镁塔顿最成功的\n   节目是哪个？”',
            choicer.create('* （你要怎么回答？）', '镁塔美妆', '镁塔烹饪', '镁塔科技', '镁塔卫视')
         ],
         barricade2b1: [
            "<25>{#p/alphys}{#g/alphysCutscene2}* 没错... 这个应该就是\n  正确答案。",
         ...
         barricade2b3: [
            '<25>{#p/alphys}{#g/alphysFR}* ...',
            "<25>{#g/alphysFR}* 我就当你没回答过吧。",
            "<25>{#g/alphysHellYeah}* 出技术问题了该找的是我，\n  这不是共识吗？",
            '<25>{#g/alphysHellYeah}* ...',
            "<25>{#g/alphysWelp}* 你觉得... 镁塔顿的\n  烹饪节目怎么样？"
         ],
         barricade2b4: [
            '<25>{#p/alphys}{#g/alphysWorried}* 我反正不知道...',
            "<25>{#g/alphysWelp}* 最近镁塔顿的电视节目\n  收视率都不太好。",
            '<25>{#g/alphysWTF}{#x1}* ...',
            '<25>{#g/alphysWTF2}* 答对了！？',
            '<25>{#g/alphysCutscene3}* ...你是怎么知道这些的？',
            '<25>{#g/alphysUhButHeresTheDeal}* 好，就剩一个了！'
         ],
         barricade3: () => [
            '<32>{#p/event}* 铃铃，铃铃...',
         ...
         barricade3b2: [
            ...
            '<25>{#g/alphysNeutralSweat}* 还是说你打算\n  告诉别人！？',
            '<25>{#g/alphysNeutralSweat}* ...',
         ...
         barricade4: () => [
            '<32>{#p/event}* 铃铃，铃铃...',
            '<25>{#p/alphys}{#g/alphysSideSad}* 怎么又来了...',
            '<25>{#g/alphysSideSad}* ...',
            "<25>{#g/alphysWelp}* 等下，我还登录着\n  镁塔顿的账号呢。",
            '<25>{#g/alphysNervousLaugh}* 我应该可以直-直接就\n  解锁的！',
            '<32>{|}{#p/human}* （打字的声音又开始响- {%}',
            '<25>{#p/alphys}{#g/alphysHellYeah}{#x1}* 搞定！',
            '<25>{#g/alphysWelp}* ...',
            "<25>{#g/alphysGarboCenter}* 我真希望我不用再干一遍\n  这种事情了。",
            ...(SAVE.data.b.failshow
               ...
               : [
                    '<25>{#g/alphysTheFactIs}* 哦，还-还有，呃，\n  关于那个喵喵玩偶...',
                    '<25>* 那个...',
                    "<25>{#g/alphysUhButHeresTheDeal}* 实际上，\n  那都不是你的东西，\n  所以完全不要紧。",
                    '<25>{|}{#g/alphysCutscene3}* 总之就是电梯见啦拜拜拜- {%}'
                 ]),
            '<32>{#s/equip}{#p/event}* 滴...'
         ],
         puzzleReaction1: [
         ...
         cooker12: () =>
            SAVE.data.n.state_foundry_undyne > 0
               ...
               : [
                    ...
                    '<25>{#g/alphysCutscene1}* 我有个方法，\n  可以帮你飞过去！',
                    "<25>{#g/alphysNervousLaugh}* 虽然...其实...",
         ...
         moneyIntro6b: () =>
            SAVE.data.b.f_state_kidd_betray ? [ '<25>{#p/kidd}{#f/3}* Hey, guys.' ] : [ '<25>{#p/kidd}{#f/1}* 哟！' ],
         moneyIntro7: [
         ...
         moneyChat3: () =>
            world.scared_ghost
               ? [ "<32>{#p/napstablook}* 到你了。", "<32>{#p/human}* (但你没什么可说的。)" ]
               : [
                    '<32>{#p/napstablook}* 呃......',
                    '<32>* 你可以开始讲了？',
                    "<32>{#p/human}* (但你没什么可说的。)"
         ...
         moneyVote5x2b: [ '<32>{#p/human}* （你感觉你的罪孽\n  爬上了脊背。）' ],
         moneyVote6a: () =>
            iRespeccYourVilliany()
         ...
         moneyFinal3: [ '<32>{#p/mettaton}* 哈哈哈，很有吸引力吧？', '<32>{#p/mettaton}{#z2}* 我们找到这东西的位置\n  是在...' ],
         moneyFinal4: () => [
            ...(SAVE.data.n.state_foundry_undyne === 1
               ? [
                    '<32>{#p/event}* 铃铃，铃铃...',
               ...
               : [
                    '<32>{#p/event}* 铃铃，铃铃...',
                    "<25>{#p/alphys}{#g/alphysOhGodNo}{#z0}* 嘿-嘿！\n  你不能把这个东西送出去，\n  我... 那是我的！",
                    '<32>{#p/mettaton}* 哦，你知道了啊？',
                    "<32>* 我向你道歉。\n* 我完全不知情。\n* 但是...",
                    '<25>{#p/alphys}{#g/alphysWTF2}* 但是？？？',
                    "<32>{#p/mettaton}* 恐怕已经来不及了，\n  艾菲斯博士..."
                 ]),
            '<32>{#z3}* 选手们已经燃起希望了。',
            '<25>{#p/alphys}{#g/alphysWTF}{#z0}* 你认真的吗？',
            '<25>{|}{#p/alphys}{#g/alphysCutscene3}* 我花了好几个月的\n  时间找- {%}'
         ],
         moneyFinal5: [
            '<32>{#p/mettaton}* 哦不。\n* 通话好像断开了。',
            '<32>* 可怜的艾菲斯博士。\n* 她的喵喵玩偶要\n  拱手相让给别人了。',
         ...
         moneyItem3: {
            ...
            b: [
               '<32>{#p/mettaton}* 两边都决定好了...',
               '<32>{#p/mettaton}{#z3}* 那么谁会赢得大奖呢？',
               '<32>{#p/mettaton}{#z0}* 结。\n* 果。\n* 就是...'
            ],
            ...
            d: () =>
               iRespeccYourVilliany()
                  ...
                  : [ '<32>{#p/mettaton}{#z0}* 小幽！', '<32>* 我很荣幸能把这份礼物\n  送给你。' ],
            e: () =>
               iFancyYourVilliany()
                  ? [
                       '<32>{#p/mettaton}{#z0}* 恭喜你，$(moniker3u)。',
                       '<32>{#p/mettaton}* 我很荣幸能把这份礼物\n  送给你。'
                    ]
                  : [ '<32>{#p/mettaton}{#z0}* 人类！', '<32>* 我很荣幸能把这份礼物\n  送给你。' ],
            f: () =>
               iRespeccYourVilliany()
                  ? [
                       '<32>{#p/mettaton}{#z0}* 怪物小孩！',
         ...
         opera1: () =>
            SAVE.data.n.state_foundry_undyne === 1
               ...
               : [
                    '<25>{#p/alphys}{#g/alphysNervousLaugh}* 啊，你到了！',
                    ...(world.bad_lizard === 1
                       ? [
         ...
         opera4: () =>
            world.genocide
               ...
               : [
                    "<25>{#p/alphys}{#g/alphysCutscene1}* 好了，我们到了！",
         ...
         opera8: [ '<32>{#p/basic}{#x1}* ...人类？{#x3}', '<32>{#x1}* 什么人类？{#x3}' ],
         opera9: [
         ...
         opera15: () =>
            iFancyYourVilliany()
               ? [ '<32>{#p/mettaton}* 你会是...', '<32>* 我梦中的克星吗...？' ]
               : [ '<32>{#p/mettaton}* 你会是...', '<32>* 我的真爱吗...？' ],
         opera16: [
            '<25>{*}{#p/alphys}{#g/alphysGarbo}* 你到底要在这里对那人类\n  搞什么名堂...{^30}{%}',
            '<32>{*}{#p/mettaton}{#x1}* 没看见吗？{^30}{%}',
            "<32>{*}{#x2}* 我要在这里演出啊。{^30}{%}",
         ...
         opera17: () =>
            world.genocide ? '朋|友|啊...' : iFancyYourVilliany() ? 'Oh |how |sad...' : '爱|人|啊...',
         opera18: () =>
            world.genocide
         ...
         opera20a: () =>
            iFancyYourVilliany()
               ...
               : [ '<25>{*}{#p/alphys}{#g/alphysWelp}* 你别说，\n  效果还不错...{^40}{%}' ],
         opera21: () =>
            world.genocide ? 'But |be|fore...' : iFancyYourVilliany() ? "I'll |ad|mit..." : '人|类|必...',
         opera22: () =>
            world.genocide
               ? 'I |kill |you |dead...'
               : iFancyYourVilliany()
               ...
               : '应|住|远|方...',
         opera23: () =>
            world.genocide ? "Let's |re|hearse..." : iFancyYourVilliany() ? "But |you're |just..." : '即|使|将...',
         opera24: () =>
            world.genocide
               ? "The |life |you've |led..."
               : iFancyYourVilliany()
         ...
         opera25a: () =>
            iFancyYourVilliany()
               ? [ '<25>{*}{#p/alphys}{#g/alphysGarboCenter}* 我的老天爷啊。{^40}{%}' ]
               : [ '<25>{*}{#p/alphys}{#g/alphysCutscene1}* 樱花花瓣...！{^40}{%}' ],
         opera26: () =>
            world.genocide
               ? 'We |were |con|vinced...'
               : iFancyYourVilliany()
         ...
         opera28a: () =>
            iFancyYourVilliany()
               ...
               : [ "<25>{*}{#p/alphys}{#g/alphysGarbo}* 哦，原来如此吗。{^40}{%}" ],
         opera29: () => (world.genocide ? 'Then |one |day...' : '悲|戚|戚...'),
         opera30: () => (world.genocide ? 'You |lost |your |way...' : "你|要|死|掉..."),
         opera31: () => (world.genocide ? 'Now |my |friends... ' : '哭|哭|哭...'),
         opera31a: [ '<25>{*}{#p/alphys}{#g/alphysCutscene3}* 我们明白...{^40}{%}' ],
         opera32: () =>
            world.genocide
               ? "Let's |bring |this\n|to |an |end."
               : iFancyYourVilliany()
         ...
         opera33: () =>
            iFancyYourVilliany()
               ? [ '<32>{#p/mettaton}* 太糟了。', '<32>{#p/mettaton}* TOO BAD YOU HAD TO GO AND PLAY THE VILLAIN.' ]
               : [ '<32>{#p/mettaton}* 好悲伤。', "<32>{#p/mettaton}* 好悲伤，你就要被流放了。" ],
         opera34: () =>
            !world.badder_lizard
               ? [
                    '<25>{#p/alphys}{#g/alphysGarboCenter}* 你完事了？',
                    '<32>{#p/mettaton}{#x1}* 诶，不要着急...',
                    '<32>{|}{#x2}* 我还得- {%}'
                 ]
         ...
         opera35: () => [
            ...(SAVE.data.b.killed_glyde
               ...
               : [
                    ...(!world.badder_lizard
                       ? [ '<25>{#p/alphys}{#g/alphysWelp}* 所-所以...\n  你还要怎么样？', '<32>{#p/mettaton}{#x0}* 还要怎么样？' ]
                       : []),
                    '<32>{#p/mettaton}{#x0}* 好吧，虽然我很想把\n  这一期演完...',
                    '<32>{#x2}* 相信我，亲爱的，\n  我真的很想...'
                 ]),
            ...(world.bad_robot
               ? [
      ...
      overworld: {
         ...
         exofountain1: () => [
            SAVE.data.b.svr
               ? '<32>{#p/human}* （你有种想从潘趣酒喷泉里\n  喝一口的冲动。）'
               : '<32>{#p/basic}* 这个奢华的喷泉里\n  全是洋梅潘趣酒。',
            choicer.create('* （喝一口吗？）', '是', '否')
         ],
         exofountain2a: [ '<32>{#p/human}* （你决定不喝。）' ],
         exofountain2b: () => [
            '<32>{#p/human}* （你喝了喷泉中的酒。）\n* （HP已回满。）',
         ...
         a_wishflower: pager.create(
            ...
            (power = false) =>
               SAVE.data.b.svr
                  ...
                  : [ "<32>{#p/basic}* 这是一株蒲公罂。", power ? '{*}{#d.sysx}{%}' : '{*}{#d.sys}{%}' ],
            pager.create(
               2,
               (power = false) =>
                  SAVE.data.b.svr
         ...
         puzzlestop1a: pager.create(
            ...
            () =>
               SAVE.data.n.state_foundry_undyne !== 1
                  ? [
                       '<32>{#s/phone}{#p/event}* 铃铃，铃铃...',
                       '<25>{#p/alphys}{#g/alphysShocked}* 哇啊，快停下！！',
      ...
      npc: {
         ...
         a_pyrope: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ? world.population < 2
                     ? [ "<32>{#p/basic}{#npc/a}* 不用担心。", '<32>* We can forgive your brutish ways.' ]
                     : [ "<32>{#p/basic}{#npc/a}* 不用担心。", '<32>* Our flows are ALL above board.' ]
      ...
      dinnerdate1: pager.create(
         ...
         () => [
            "<25>{#p/sans}* 嘿，\n  我听说了你要来这里。",
            '<25>{#p/sans}{#f/2}* 介意和我一起\n  吃顿饭吗？',
            choicer.create('* （共进晚餐吗？）', '是', '否')
         ],
         () => [ '<25>{#p/sans}{#f/2}* 改主意了吗？', choicer.create('* （共进晚餐吗？）', '是', '否') ]
      ),
      ...
      dinnerdate2b: [ '<25>{#p/sans}{#p/sans}{#f/0}* 赞。' ],
      ...
      core1: [
         '<32>{#p/event}* 铃铃，铃铃...',
         '<25>{#p/alphys}{#g/alphysNeutralSweat}* ...你-你们好。',
   ...
   b_group_aerialis: {
      ...
      pyropeTsundere: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* The hot-headed army arrives.' ] : [ "<32>{#p/story}* 一支烈焰骑兵队！" ],
   ...
   b_opponent_pyrope: {
      ...
      idleTalk1: [ '<08>{#p/basic}{~}管他什么烈焰\n在燃烧', '<08>{#p/basic}{~}我就这样无畏\n且骄傲！' ],
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 ...
                 postSIGMA()
                    ? 'Power Outage'
                    : [ 'Where We Are', '§fill=#ff0§Glyde (NEW)', '老滑头' ][Math.min(SAVE.data.n.shop_bpants_hub, 2)],
                 'Your Future',
                 '离开'
              ],
      talkPrompt: () =>
   ...
   n_shop_gossip: {
      ...
      itemPrompt: '<99>{#p/basic}{#k/0/9}{@fill=#d4bbff}你应该把\n我们所有\n存货全都\n买下来！',
      itemPurchase: [
      ...
      menuPrompt1: '<23>{#p/basic}{#k/0/0}{@fill=#ffbbdc}* 来好好看看吧！',
      menuPrompt2: '<23>{#p/basic}{#k/0/0}{@fill=#ffbbdc}* 不用着急什么的。',
      menuPrompt3: () =>
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 '关于你们两个',
                 SAVE.data.n.plot < 68 ? '旧货铺' : SAVE.data.b.killed_mettaton ? '镁塔顿' : 'Grand Finale',
                 [ '这地方的所有权', '§fill=#ff0§Burgie（新）', 'Burgie' ][Math.min(SAVE.data.n.shop_gossip_hub, 2)],
