...
export default {
   ...
   a_common: {
      ...
      neutral0 () {
         ...
         if (world.bad_robot) {
            if (!dundyne) {
               if (royals < 2) {
                  ...
                  addB([
                     ...
                     "<25>{#p/undyne}{#f/16}* We'd take a shuttle past the forcefield, hunt you down...",
                  ...
                  if (!dpapyrus) {
                     addB([
                        ...
                        "<25>{#p/papyrus}{#f/6}UNDYNE!?\nARE YOU OKAY!?",
                        "<25>{#p/alphys}{#f/2}* ...!?",
                        "<25>{#p/undyne}{#f/13}* Huh??\n* What are YOU doing here?",
                        "<25>{#p/papyrus}{#f/5}WELL... I HEARD A LOT OF SCREAMING.\nAND SHOUTING.",
                        "<25>{#p/papyrus}{#f/6}I WAS WORRIED ABOUT YOU.",
                        "<25>{#p/undyne}{#f/14}* Aw, thanks Papyrus.\n* How considerate of you.",
                        "<25>{#p/papyrus}{#f/0}OH, YOU'RE WELCOME!",
                        "<25>{#p/undyne}{#f/7}* Maybe NEXT time, don't sneak onto SOMEONE ELSE'S SHUTTLE!!!",
                        "<25>{#p/papyrus}{#f/6}I-I'M SORRY, I WAS CURIOUS, OKAY??",
                        "<25>{#p/papyrus}{#f/5}I JUST WENT TO LOOK, AND THE NEXT THING I KNEW...",
                        "<25>{#p/papyrus}{#f/6}THE SHUTTLE STARTED FLYING OFF THE OUTPOST!",
                        "<25>{#p/papyrus}{#f/4}BELIEVE ME, I WOULD'VE RATHER STAYED BEHIND.",
                  ...
                  addB([
                     ...
                     "<25>{#p/alphys}{#f/24}* Turns out Mettaton was being stupid and wasted it all to fight you.",
               ...
               if (!dpapyrus || royals === 1) {
                  ...
                  if (!dtoriel) {
                     addB([
                        ...
                        "<25>{#p/sans}{#f/3}* but she wasn't having it in the slighest.",
                  ...
                  if (!dpapyrus) {
                     ...
                     if (royals === 1) {
                        ...
                        if (!ddoggo) {
                           ...
                           addB([
                              ...
                              "<18>{#p/papyrus}{#f/6}AS IT TURNS OUT, A SHORT-NECKED DOG WANTED MY ATTENTION!",
                              "<18>{#p/papyrus}{#f/5}I WAS QUITE CONFUSED AT FIRST...",
                           ...
                           addB([
                              ...
                              "<18>{#p/papyrus}{#f/6}AS IT TURNS OUT, TWO DOGS WITH AXES HAD WAILED ON IT!",
                           ...
                           addB([
                              ...
                              "<18>{#p/papyrus}{#f/5}SO, TO ACCOMEDATE THE TOWERING, ARMORED KNIGHT...",
                     ...
                     if (!ddoggo) {
                        ...
                        addB([
                           "<25>{#p/alphys}{#f/6}* Yeah, it can get ancy at times, but it's done well overall.",
                  ...
                  addB([
                     ...
                     "<25>{#p/sans}{#f/3}* well, that's just a theory.",
                     "<25>{#p/sans}{#f/2}* and not related to games in any way.",
                     "<25>{#p/alphys}{#f/17}* Uh, not to interrupt, but... it's your move.",
                     "<25>{#p/sans}{#f/0}* huh?",
                     "<25>{#p/alphys}{#f/5}* The game, it's... all in your hands now.",
                     "<25>{#p/sans}{#f/3}* ... i see.",
                     ...
                     "<25>{#p/sans}{#f/3}* if this call ever reaches you...",
                     "<25>{#p/sans}{#f/0}* please... you can't let another human come here.",
                     "<25>{#p/sans}{#f/0}* our lives don't mean anything anymore.",
                     "<25>{#p/sans}{#f/3}* there's no point to any of it.",
                     "<25>{#p/sans}{#f/0}* if mew mew were to take another human soul...",
                     "<25>{#p/sans}{#f/0}* she would surely- {%}",
                     "<32>{#s/equip}{#p/event}* 滴..."
                  ]);
               } else {
                  k = "dark_charles";
            ...
            if (dmettaton) {
               ...
               if (SAVE.data.b.ubershortcut) {
                  addB([
                     ...
                     "<32>{#p/mettaton}* THE PEOPLE WANT HUMANS DEAD, AND I CAN'T SAY I BLAME THEM."
                  ]);
                  if (!dtoriel) {
                     addB([
                        "<32>{#p/mettaton}* EVEN THE FORMER QUEEN TORIEL COULDN'T CONVINCE PEOPLE TO CALM DOWN WHEN SHE RETURNED.",
                        "<32>{#p/mettaton}* AND ALPHYS... WASN'T IN THE MOOD TO PLAY POLITICS."
                     ]);
                  }
               } else if (!dundyne) {
                  addB([
                  ...
                  if (!dtoriel) {
                     addB([
                        "<32>{#p/mettaton}* EVEN THE FORMER QUEEN TORIEL COULDN'T CONVINCE PEOPLE TO CALM DOWN WHEN SHE RETURNED.",
                        "<32>{#p/mettaton}* LET ALONE UNDYNE HERSELF."
                     ]);
                  }
               } else if (!dtoriel) {
                  addB([
               ...
               addB([
                  ...
                  "<32>{#p/napstablook}* ever since he told me about his identity, i've been looking after him..."
               ]);
            ...
            addB([
               ...
               "<25>{#p/sans}{#f/0}* suffice it to say, we made some changes.",
            ...
            addB([
               ...
               "<25>{#p/sans}{#f/3}* she can be... quick to make big decisons."
            ]);
            if (dmettaton) {
               addB([
                  "<25>{#p/sans}{#f/0}* and what she did recently... really wasn't great.",
                  "<18>{#p/papyrus}{#f/6}HUH!?\nWHAT'D SHE DO?",
                  "<25>{#p/sans}{#f/3}* recently, some of mettaton's biggest fans came to her...",
                  "<25>{#p/sans}{#f/0}* asking her to put on a memorial show.",
                  "<26>{#p/sans}{#f/0}* i liked the idea.\n* it'd give people something to care about.",
                  "<25>{#p/sans}{#f/0}* but, she was never really a big fan of his, so...",
                  "<25>{#p/sans}{#f/3}* she shot the proposal down out of spite.",
                  "<18>{#p/papyrus}{#f/7}... UGH, IF SHE WON'T DO IT, THEN -I- WILL!",
                  "<25>{#p/sans}{#f/0}* wait, really?\n* that's a pretty big commitment, bro.",
                  "<18>{#p/papyrus}{#f/4}I WAS A FAN OF HIS TOO, YOU KNOW."
               ]);
            } else {
               addB([
            ...
            if (!dundyne) {
               ...
               if (SAVE.data.b.w_state_lateleave) {
                  ...
                  if (royals < 2) {
                     ...
                     addB([
                        ...
                        "<26>{#p/toriel}{#f/13}* The Royal Guard has helped to keep the outpost in check, but...",
                  ...
                  if (dmettaton) {
                     ...
                     addB([
                        ...
                        "<25>{#p/toriel}{#f/1}* If I had simply posessed the courage to leave sooner..."
                     ]);
                     if (hkills === 0) {
                        addB([
               ...
               if (dmettaton) {
                  addB([
                     ...
                     "<32>{#p/basic}{#s/spiderLaugh}* Your poor thing~\n* You don't need to concern yourself with that!",
            ...
            if (SAVE.data.b.undyne_respecc) {
               ...
               addB([
                  ...
                  "<25>{#p/undyne}{#f/9}* I doubt the Royal Guard'll ever be as strong as it once was."
               ]);
            }
            addB([
      ...
      neutral1: [
         "<32>{#p/human}* (You take a deep breath.)",
         ...
         "<32>{#p/human}* (You try to apologize, but you can't find seem to the right words.)",
         ...
         "<32>{#p/human}* (You ask Sans why he's only bringing this up now.)",
         ...
         "<32>{#p/human}* (You get the sense that you should pay attention.)\n* (You focus on Sans's voice.)",
         ...
         "<25>{#p/sans}{#f/3}* the more i wondered, the more i realized...",
         "<25>{#p/sans}{#f/0}* the answer to that question was \"no.\"",
         "<32>{#p/human}* (Your eyes widen.)\n* (A sense of shock fills your entire body.)",
         "<25>{#p/sans}{#f/0}* the more i think about it, buddo...",
         "<25>{#p/sans}{#f/0}* the harder it is to believe you were in control back then.",
         "<32>{#p/human}* (You know that what Sans is saying is true.)\n* (You try not to cry.)",
         "<25>{#p/sans}{#f/3}* looking back, you always seemed so cold...",
         "<25>{#p/sans}{#f/3}* never showing much emotion or care for those around you.",
         "<25>{#p/sans}{#f/0}* and yet, you can't seem to stay away from us now.",
         ...
         "<32>{#p/human}* (...)\n* (Despite your mood, you smile a little at Sans's joke.)",
      ...
      neutral2: [
         ...
         "<25>{#p/asgore}{#f/25}* Then I am greateful to have saved your life.",
         ...
         "<18>{#p/papyrus}{#f/6}...",
         "<18>{#p/papyrus}{#f/5}TRUTH BETOLD... A LOT OF PEOPLE ARE STILL UPSET.",
         "<18>{#p/papyrus}{#f/5}THEY STILL BLAME YOU FOR EVERYTHING THAT HAPPENED.",
         "<18>{#p/papyrus}{#f/6}ASGORE'S DOING HIS BEST TO CALM THEM, BUT...",
         "<18>{#p/papyrus}{#f/5}IT MIGHT BE A WHILE BEFORE HE SUCCEEDS.",
         "<18>{#p/papyrus}{#f/0}AND YET, I KNOW HE'S CAPABLE.\nI BELIEVE IN HIM!",
         ...
         "<18>{#p/papyrus}{#f/0}HE LOST THE RIGHT TO HAVE ME STILL BELIEVE IN HIM.",
   ...
   b_act: {
      ...
      asgore: "* 艾斯戈爾",
      asriel: "* 艾斯利爾",
      asrieldreemurr: "§fill:#ff7f7f§§swirl:2,1,1.05,1§§hue§* 艾斯利爾·逐夢",
      bathe: "* 洗澡",
      beckon: "* 招呼過來",
      bedtime: "* 睡覺時間",
      berate: "* Berate",
   ...
   b_opponent_maddummy: {
      ...
      gladStatus1: [ "<32>{#p/story}* Glad Dummy很慶幸自己來了這裡。" ],
