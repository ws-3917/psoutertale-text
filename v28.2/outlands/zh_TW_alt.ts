...
export default {
   a_outlands: {
      ...
      chair3: () =>
         SAVE.data.b.svr
            ...
            : world.darker
            ? [ "<32>{#p/basic}* 一把扶椅。" ]
            : [ "<32>{#p/basic}* 一把舒適的扶椅。", "<32>* 大小正好適合託麗爾。" ],
         ...
         a: () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    ...
                    "<32>* 工人們承諾很快就會恢復正常，但真實情況看起來並不樂觀。",
                    "<32>* 如-如果這附近現在有人，請趕緊過來幫忙..."
                 ]
      },
      torieldanger: {
      ...
      twinkly20: [
         "<20>不要害怕，孩子。",
         "<20>我是{@fill:#003cff}託麗爾{@fill:#000}，\n{@fill:#f00}外域{@fill:#000}的管理員。",
         "<20>我每天都會來看看\n有沒有人被困在這裡。",
         "<20>跟我來，孩子。\n我有很多東西要教你。"
      ],
      twinkly21: [
         ...
         "<25>{#f/1}* 受傷了嗎？",
         "<25>{#f/0}* ...\n* 請原諒我問了這麼多問題。",
         "<25>{#f/0}* 我是{@fill:#003cff}託麗爾{@fill:#000}，\n  {@fill:#f00}外域{@fill:#000}的管理員。",
         "<26>{#f/0}* 我每天都會來看看\n  有沒有人被困在這裡。",
         "<25>{#f/0}* 跟我來，孩子。\n* 我有很多東西要教你。"
      ],
   ...
   b_opponent_froggit: {
      ...
      act_threat2: [
         ...
         "<32>{#p/basic}* 這讓蛙吉特想起了你先前的恐嚇，所以他決定撒腿跑路。"
      ],
      act_compliment: [
   ...
   c_call_outlands: {
      ...
      hello: [
         ...
         [
            ...
            "<25>{#f/0}* 對不起。\n* 我應該給你找些事情做的。",
            "<25>{#f/1}* 試著放空大腦盡情想象，來分散你的注意力，如何？",
            "<25>{#f/0}* 假裝你是一名...戰鬥機飛行員！",
            "<25>{#f/1}* 上下旋轉，左右搖擺，以光速做著橫滾側翻...",
            "<25>{#f/1}* 能模仿我試著做一遍嗎？"
         ],
         [
            "<25>{#p/toriel}{#f/5}* 你好，小傢伙。",
            "<25>{#f/9}* 我很抱歉，因為我已經沒什麼東西可說了。",
            "<25>{#f/1}* 但我很高興能聽到你的聲音..."
         ]
      ],
