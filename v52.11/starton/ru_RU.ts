...
export default {
   ...
   b_opponent_stardrake: {
      act_check: () =>
         world.goatbro
            ...
            : SAVE.data.b.s_state_chilldrake
            ? [ '<33>{#p/story}* Чилдрейк - ATK 12 DEF 7\n* Бунтует против всего!!!\n* В поисках Звезды.' ]
            : [ '<32>{#p/story}* Стардрейк - ATK 12 DEF 7\n* Этот комик-подросток борется за то, чтобы удержать пленную аудиторию.' ],
      act_check2: () =>
         SAVE.data.b.s_state_chilldrake
            ? [ '<32>{#p/story}* ЧИЛДРЕЙК - ATK 12 DEF 7\n* Бунтует против всего!!\n* Ищет выход.' ]
   ...
   b_opponent_mouse: {
      ...
      hurtStatus: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Почти мёртв.' ] : [ '<32>{#p/story}* Whizkarat is nearing demise.' ],
