...
export default {
   ...
   // TODO: add respect variant
   /*
      *Oh my god...
      *THAT WAS IT!?
      *Your attack was actually really freaking powerful!
      *It.. honestly kinda hurts. Ouch.
      *Guess that's what happens when I underestimate my opponents.
      *..But given your battle style this whole time, should I really be surprised?

      *Heh, you know what?
      *I don't actually want to hurt you.
      *At first, I despised your ways of fighting, the way it affected how you treat friends.
      *It felt like a stupid saccharine schtick, but...
      *The way you hit me right now, it...
      *It proves to me you're a worthy opponent.
      *Now I know you aren't just some wimpy loser.
      *You're someone with a passion for fighting as great as mine!
      *Almost like him...

      *...
      *Listen, human.
      *It seems that you and Asgore are destined to meet.
      *Knowing him... He probably doesn't want to fight you, at all.
      *If you can, just talk to him.
      *Use your voice instead of your fists.
      *I know it'll be weird for you, but I'm sure you two can work something out.
      *If somehow, a meaner human ends up here... I'll take THEIR soul instead of yours.
      *That makes sense, right? Fuhuhu.
      *Oh, and if you DO hurt Asgore... I'll take the human SOULs... cross the Force field...
      *And we'll beat the hell out of eachother like we never have before!
      *That's what Warriors do, right?
      *Fuhuhu!
      *Now let's get the hell out of this flaming house!

      *Well, that was fun, huh?
      *We'll have to spar again another time!
   ...
   */
   ...
   n_shop_tem: {
      ...
      itemPurchasePrompt: (free: boolean) => (free || world.runaway ? 'Take it?' : 'Buy it for\n$(x)G?'),
      itemSellPrompt: 'Sell it for\n$(x)G?',
      itemUnavailable: () => (world.runaway ? '<09>{#p/basic}Nothing left.' : '<09>{#p/tem}{#k/2}no more item...'),
