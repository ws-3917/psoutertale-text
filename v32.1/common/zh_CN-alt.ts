...
export default {
   ...
   a_common: {
         ...
         if (world.bad_robot) {
            if (!dundyne) {
               ...
               if (!dpapyrus || royals === 1) {
                  ...
                  addB([
                     ...
                     "{#p/sans}{#f/3}* well, that's just a theory.",
                     "{#p/sans}{#f/2}* and not related to games in any way.",
                     "{#p/alphys}{#f/17}* Uh, not to interrupt, but... it's your move.",
                     "{#p/sans}{#f/0}* huh?",
                     "{#p/alphys}{#f/5}* The game, it's... all in your hands now.",
                     "{#p/sans}{#f/3}* ... i see.",
                     ...
                     "{#p/sans}{#f/3}* if this call ever reaches you...",
                     "{#p/sans}{#f/0}* please... you can't let another human come here.",
                     "{#p/sans}{#f/0}* our lives don't mean anything anymore.",
                     "{#p/sans}{#f/3}* there's no point to any of it.",
                     "{#p/sans}{#f/0}* if mew mew were to take another human soul...",
                     "{#p/sans}{#f/0}* she would surely- {%}",
                     "{#s/equip}{#p/event}* Click..."
                  ]);
               } else {
            ...
            if (SAVE.data.b.undyne_respecc) {
               addB([
                  ...
                  "{#p/undyne}{#f/14}* I doubt the Royal Guard'll expand again any time soon.",
               ...
               addB([
                  ...
                  "{#p/undyne}{#f/9}* I doubt the Royal Guard'll ever be as strong as it once was."
               ]);
            }
            addB([
            ...
            addB(["{#p/alphys}{#f/8}* So that's something.", "<26>{#p/undyne}{#f/16}* Heh, tell me about it..."]);
      ...
      neutral1: [
         "{#p/human}* (You take a deep breath.)",
      ...
      balcony34a2: ["{#p/asriel1}{#f/15}* ... did you just...", "<33>{#p/basic}* Asriel.\n* They said the thing."],
      balcony35a1: [
