...
export default {
   a_foundry: {
      locketseller: [
         "{#p/basic}* ...",
         "{#p/basic}* I'm going to pretend you didn't just sell that locket."
      ],
      ...
      quicksolve4: ["{#p/human}* (You access the terminal.)", "{#p/basic}* \"Enter override code!\""],
      quicksolve5: [
         "{#p/basic}* ...",
         ...
         SAVE.data.b.svr
            ...
            : [
               ...
               ...(world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                  ? ["{#p/kidd}{#f/2}* Ooh... what's that?", "{#f/1}* That thing must be, like, REALLY old."]
                  : [])
            ],
      ...
      blooksnail1: pager.create(
         ...
         ["{#p/napstablook}* did you change your mind?", choicer.create("* (Play the game?)", "是", "否")]
      ),
      blooksnail1i: [
            ...
            SAVE.storage.inventory.contents.includes('tvm_mewmew') // NO-TRANSLATE
               ...
               : 65 <= SAVE.data.n.plot
                  ? SAVE.data.b.a_state_hapstablook
                     ...
                     : ["{#p/napstablook}* it is what it is..."]
                  : 63 <= SAVE.data.n.plot && SAVE.data.b.a_state_hapstablook
                     ? ["<33>{#p/napstablook}* don't worry, they're alright...", "* at least, i hope so......"]
                     : 60 <= SAVE.data.n.plot
      ...
      boots1: ["{#p/human}* (You got the Hoverboots.)", choicer.create("* （穿上悬浮靴吗？）", "是", "否")],
         ...
         SAVE.data.b.svr
            ...
            : world.darker
               ...
               : [
                  ...
                  "* The switch isn't stuck, it's just out of order.\n* Oh wait."
               ],
      quiche1: () =>
         SAVE.data.b.svr
            ? [
      ...
      spookydate23: [
         ...
         "{#f/8}* be sure to grab your food on the way out.",
      ...
      telescopeX: pager.create(
         ...
         ["{#p/sans}{#f/2}* wanna try my telescope?", choicer.create("* (What do you say?)", "是", "否")]
      ),
      telescopeY: () =>
         SAVE.data.b.voucher
   ...
   b_opponent_shyren: {
      ...
      encourage4: () =>
         SAVE.data.n.state_foundry_muffet === 1
            ...
            : ["{#p/kidding}* One last time, one last time, one last time!"],
      ...
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ...
            : battler.volatile[0].vars.pet
               ? ["{#p/human}* (You flirt with Doge.)", "{#p/basic}* Doge giggles playfully."]
               : battler.volatile[0].sparable
                  ...
                  : world.flirt < 10
                     ? ["{#p/human}* (You flirt with Doge.)", "{#p/basic}* Doge tries not to react in any strong way."]
   ...
   b_opponent_undyne: {
      ...
      randStatus10: () =>
         respecc() ? ["{#p/story}* Smells like talapia."] : ["{#p/story}* Smells like sushi."],
      ...
      deterStatus5: ["{#p/story}* Undyne closes her eyes."],
