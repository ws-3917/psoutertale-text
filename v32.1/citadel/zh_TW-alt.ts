...
export default {
   a_citadel: {
      youvedoneitnow: [
         [
            "{*}{#p/human}* (You feel a darkness gathering inside of you.){^40}{%}",
            "{*}{#p/human}* (You wish it were all just a bad dream.){^40}{%}"
         ],
         [
            "{*}{#p/human}* (You try your best to fight it, but nothing happens.){^40}{%}",
            "{*}{#p/human}* (You wish desperately that you could break free.){^40}{%}"
         ],
         [
            "{*}{#p/human}* (You call out for help, but nobody comes.){^40}{%}",
            "{*}{#p/human}* (You wish you could make this all just go away.){^40}{%}"
         ],
         [
            "{*}{#p/human}* (...){^40}{%}",
            "{*}{#p/human}* (You take a deep breath, and ready yourself for the end.){^40}{%}"
         ],
         ["{*}{#p/human}* (...){^40}{%}", "{*}{#p/human}* (You know what must be done.){^40}{%}"]
      ],
      hypertext: {
         count: "REBOOT IN $(x)",
      ...
      genotext: {
         ...
         respawn0: () =>
            [
               [
                  [
                     "{#p/asriel2}{#f/15}* You probably should've saved our progress after we left Starton.",
                     "{#p/asriel2}{#f/16}* Just saying."
                  ],
                  [
                     "{#p/asriel2}{#f/15}* You probably should've saved our progress after we killed Undyne.",
                     "{#p/asriel2}{#f/16}* Just saying."
                  ],
                  [
                     "{#p/asriel2}{#f/15}* You probably should've saved our progress after we left Aerialis.",
                     "{#p/asriel2}{#f/16}* Just saying."
                  ],
                  [
      ...
      story: {
            ...
            SAVE.flag.n.neutral_twinkly_choice === 0
               ? [
                  ...
                  ...(world.trueKills > 0 || SAVE.data.n.state_foundry_undyne === 1
                     ? [
                        "{*}{#e/twinkly/14}It's not as if you had a standard to uphold...",
                        [
                           "{*}{#e/twinkly/17}Not after you left someone to die.",
                           "{*}{#e/twinkly/17}Not after you killed a monster along the way.",
                           "{*}{#e/twinkly/17}Not after you killed a couple monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed a few monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed several monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed several monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed several monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed those monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed those monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed those monsters along the way.",
                           "{*}{#e/twinkly/17}Not after you killed all those monsters along the way."
                        ][Math.min(world.trueKills, 10)],
                        "{*}{#e/twinkly/0}...",
                        ...(1 <= SAVE.flag.n.killed_sans
                           ? [
                              "{*}{#e/twinkly/0}Do you really think I'm worth more time than them?",
                              "{*}{#e/twinkly/2}Is that why you went along with everything we did before?",
                              "{*}{#e/twinkly/3}..."
                           ]
                           : [
                              "{*}{#e/twinkly/0}Did you really think sparing me would somehow make up for it?",
                              "{*}{#e/twinkly/2}Were you just that desperate to redeem yourself?",
                              "{*}{#e/twinkly/3}..."
                           ]),
                        "{*}{#e/twinkly/0}... say."
                     ]
                  ...
                  ...(world.trueKills > 0 || SAVE.data.n.state_foundry_undyne === 1
                     ? [
                        ...
                        "{*}{#e/twinkly/17}Then, and only then, will you get your so-called \"happy ending.\"",
                        "{*}{#e/twinkly/20}So, what'll it be?",
                        "{*}{#e/twinkly/20}Will you prove yourself to me?",
                        "{*}{#e/twinkly/17}Or will you suffer for the rest of eternity?",
                        "{*}{#e/twinkly/15}Hee hee hee.",
                        "{*}{#e/twinkly/18}Either way, I'm interested!"
                     ]
                     : [
               ...
               : [
                  ...
                  ...(world.trueKills > 0 || SAVE.data.n.state_foundry_undyne === 1
                     ...
                     : [
                        "{*}{#e/twinkly/2}Was it truly necessary to kill me after sparing everyone...?",
                        "{*}{#e/twinkly/3}You...",
                        ...(1 <= SAVE.flag.n.killed_sans
                           ? [
         ...
         asgoreStory1: [
            "{*}{#p/asgore}{#f/6}* A long time ago, a human child crash- landed in the Foundry.{~}",
            "{*}{#p/asgore}{#f/6}* Injured, they called out for help.{~}"
         ],
         asgoreStory1r: ["{#p/basic}* ...{%40}", "{#p/basic}* I'm sorry, partner.{%40}"],
         asgoreStory2: [
         ...
         clover3: [
            "{#p/human}{#v/6}{@fill=#faff29}* It's unlikely we'll be aware of what happened here.",
         ...
         returnofchara4: [
            ...
            "* ... only kidding.",
            "* I'll let you get the rest you need, partner.",
      ...
      overworld: {
         ...
         statusterminal1: [
            "{#p/human}* (You access the terminal.)",
         ...
         ca_floartex: () =>
            [
               ...
               [
                  ...
                  "{#p/human}{#v/5}{@fill=#00c000}* I don't even have an avatar to move around with.",
      ...
      trivia: {
         ...
         warningsign: () =>
            SAVE.data.b.svr
               ...
               : SAVE.data.n.plot === 72 || world.postnoot || SAVE.data.b.backdoor
                  ? ["{#p/human}* (You access the terminal.)", "{#p/basic}* \"No further action required.\""]
                  : [
                     "{#p/human}* (You access the terminal.)",
         ...
         cf1_echo1: [
            ...
            "{@fill=#003cff}* That old coot rambling on and on about his royal science duties...",
         ...
         cf2_spidertable: () =>
            [
               ...
               ["{#p/human}* (You place your hands on the teapot.)", "<33>{#p/human}* (It seems eager to boil.)"],
               []
            ][cf2_state.time],
   ...
   b_opponent_alphys: {
      ...
      status1d: ["{#p/asriel2}* Don't you think she looks tired?"],
