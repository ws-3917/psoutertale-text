...
export default {
   a_starton: {
      ...
      genotext: {
         ...
         asriel30d: () =>
            [
               ["{#p/asriel2}{#f/3}* Ready yourself, $(name).", "<26>{#f/4}* 這兒可是安黛因的地盤。"],
      ...
      innkeep1b: pager.create(
         ...
         ["{#p/basic}{#npc/a}* Changed your mind?", choicer.create("* （再訂一間房嗎？）", "是", "否")]
      ),
      ...
      maze6: pager.create(
         ...
         () => (world.edgy ? ["{#p/sans}{#f/0}* seriously?"] : ["<18>{#p/papyrus}{#x2}{#f/7}快回來！！"])
      ),
      maze7: [
         [
            "<18>{#p/papyrus}你是怕火嗎？？",
      ...
      note: () =>
         world.runaway
            ...
            : SAVE.data.n.plot === 72
               ...
               : ["{#p/basic}* There's a note here.", "<33>{#p/basic}* 「請不要傷害我的家人。」"],
      sell1: () =>
         world.population === 0 || world.runaway
