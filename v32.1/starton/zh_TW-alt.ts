...
export default {
   a_starton: {
      ...
      shockpapyrus0c: [
         "<15>{#p/papyrus}{#e/papyrus/20}衫斯，你快來看看！",
      ...
      doggo3: pager.create(
         0,
         [ "<32>{#p/basic}* 你好？\n* 有人在嗎...？" ],
         [ "<32>{#p/basic}* 你們兩個是在整我嗎？\n* 真好笑啊，夥計。" ],
         [ "<32>{#p/basic}* Big lug?\n* Is that you?\n* Come on..." ],
         [ "<32>{#p/basic}* 嗯，看來並不是那個\n  高個子骷髏...\n* 他太吵了。" ],
         [ "<32>{#p/basic}* 趕緊給我停下，無論你是誰！！！" ],
         [ "<32>{#p/basic}* ..." ]
      ),
      ...
      genotext: {
         ...
         papyrusSolo2a: [
            ...
            "<25>{#f/7}* 眼下我們是不是該\n  就地投降才好呢？",
            "<18>{#p/papyrus}{#f/31}...",
            "<25>{#p/asriel2}{#f/4}* 先說明瞭，你這股努力的勁兒\n  確實令我佩服。",
            "<25>{#f/3}* 但我們自有打算。",
      ...
      innkeep1b: pager.create(
         ...
         [
            ...
            choicer.create("* （再訂一間房嗎？）", "是", "否")
         ],
         [ "<32>{#p/basic}{#npc/a}* 改變主意了嗎？", choicer.create("* （再訂一間房嗎？）", "是", "否") ]
      ),
      ...
      maze6: pager.create(
         ...
         () =>
            world.edgy
               ...
               : [ "<18>{#p/papyrus}{#x2}{#f/7}你在往哪裡走呢！？" ],
         () => (world.edgy ? [ "<25>{#p/sans}{#f/0}* seriously?" ] : [ "<18>{#p/papyrus}{#x2}{#f/7}快回來！！" ])
      ),
      maze7: [
         [
            "<18>{#p/papyrus}你是怕火嗎？？",
      ...
      nicecreamPurchase: [ "<32>{#p/basic}* 給你！\n* 祝你有個超級棒的一天！" ],
      ...
      npcinter: {
         ...
         t_icewolf: () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    "<32>{#p/basic}{#npc/a}* Ice Wolf在思考為什麼自己沒有冰\n  可扔的時候，Ice Wolf還叫\n  Ice Wolf。",
                    "<32>* Ice Wolf很疑惑。"
                 ],
      ...
      objinter: {
         ...
         spagtable2: [ "<32>{#p/human}* （你拿走了義大利麵。）" ],
      ...
      papdate5: pager.create(
         ...
         [ "<18>{#p/papyrus}{#f/6}準備開始了嗎？", choicer.create("* （你要怎麼回答？）", "是", "否") ]
      ),
      papdate5a: () => [
         SAVE.data.b.flirt_papyrus
            ? "<18>{#p/papyrus}好！！！\n約會開始！！！"
      ...
      papdate6: () => [
         SAVE.data.b.flirt_papyrus
            ? "<32>{#p/story}µµµµµµµµµµ 約會 µµ 開始！"
            : "<32>{#p/story}µµµµµµµµµµ 消遣 µµ 開始！"
      ],
      papdate7: () => [
      ...
      papdate29: [ "<15>{#p/papyrus}{#f/20}你知道這是\n什麼嗎？" ],
      papdate30: [ choicer.create("* （你知道這是什麼嗎？）", "是", "否") ],
      papdate31a: [
      ...
      sansbook1: [ "<32>{#p/basic}* 這是本關於非歐幾裡德幾何的書。\n* 寫著「艾菲斯」的名字。" ],
      sansbook2: [ choicer.create("* （要看看裡面嗎？）", "是", "否") ],
         ...
         s_bridge: pager.create(
            ...
            () =>
               world.edgy
                  ...
                  : [
                       "<25>{#p/sans}{#f/3}* 我不知道現在我兄弟\n  要幹什麼去了。",
                       "<25>{#f/0}* 如果我是你，\n  我會確保自己理解\n  {@fill=#ff993d}橙色攻擊{@fill=#fff}。"
                    ],
            () =>
               world.edgy
                  ? [
      ...
      trivia: {
         ...
         s_puzzle1_sign: () =>
            SAVE.data.b.svr
               ...
               : [ "<32>{#p/basic}* 「按順序觸發每一條電路。」" ],
         s_puzzle2_sign: () =>
            SAVE.data.b.svr
               ? [ "<32>{#p/human}* （這個告示牌點出瞭解謎思路。）" ]
               : [ "<32>{#p/basic}* 「從左邊開始。」" ],
         s_puzzle3_note: () =>
            SAVE.data.b.svr
   ...
   b_group_starton: {
      dogs: () => (world.goatbro ? [ "<32>{#p/asriel2}* Dogamy and Dogaressa." ] : [ "<32>{#p/story}* Dogi向你發起攻擊！" ]),
      spacetopJerry: () =>
         world.goatbro
   ...
   b_opponent_lesserdog: {
      ...
      status4: () => (world.goatbro ? [ "<32>{#p/asriel2}* 小犬座。" ] : [ "<32>{#p/story}* Smells like dog chow." ]),
      status5: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 小犬座。" ] : [ "<32>{#p/story}* 小犬座在興奮地汪汪叫。" ],
      status6: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 小犬座。" ] : [ "<32>{#p/story}* Canis Minor is overstimulated." ],
      status7: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 小犬座。" ]
            : [ "<32>{#p/story}* Canis Minor shows no signs of stopping." ],
      status8: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 小犬座。" ] : [ "<32>{#p/story}* Canis Minor is lowering." ],
      status9: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 小犬座。" ] : [ "<32>{#p/story}* Canis Minor learns to code." ],
      status10: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 小犬座。" ]
            : [ "<32>{#p/story}* Canis Minor is whining because it can't see you." ],
      status11: () => (world.goatbro ? [ "<32>{#p/asriel2}* 小犬座。" ] : [ "<32>{#p/story}* Hello there." ]),
      status12: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 小犬座。" ]
   ...
   b_opponent_dogamy: {
      act_check: () =>
         world.goatbro
            ...
            : [ "<32>{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的老公。\n* 只認識他聞到的東西。" ],
      act_check2: [ "<32>{#p/story}* 狗來米 - 14攻擊 5防禦\n* 新近喪偶。\n* 只認識失去老婆的痛苦。" ],
      act_check3: [ "<32>{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的老公。\n* 認識的東西比先前更多了。" ],
      act_check4: [ "<32>{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的丈夫。\n* 並不介意分享...？" ],
      act_check5: [ "<32>{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的老公。\n* 並不介意離開...？" ],
      fetchText: [
         "<32>{#p/human}* （你將扳手扔了出去。）\n* （狗狗們跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）"
      ],
      fetchTextLone: () => [
      ...
      flirtTextLone: [ "<32>{#p/human}* （你對狗來米調情。）", "<32>{#p/basic}* 狗來米的表情沒有發生變化。" ],
      loneStatus: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 只剩一個了。" ]
            : [ "<32>{#p/story}* 狗媳兒一心想要踢\n  人類的尾巴。" ],
   ...
   b_opponent_papyrus: {
      ...
      flirt2: [
         "<32>{#p/human}* （你的回復是？）{!}µµµ我沒有\nµµµµ我會做µµµµµµµµ任何\nµµµµ義大利麵µµµµµµ可取之處{#c/0/4/2}"
      ],
      ...
      flirtStatus5: [ "<32>{#p/story}* 帕派瑞斯正在想「方」「色」法\n  變得出名。" ],
      ...
      flirtStatus11: [ "<32>{#p/story}* ... 他還在想「方」「色」法\n  變得出名。" ],
      hurtStatus: [ "<32>{#p/story}* 帕派瑞斯 瀕臨失敗。" ],
      ...
      insult3: [ "<32>{#p/human}* （你試著辱罵，但無濟於事。）\n* （看來行動並不會使這場戰鬥\n  升溫。）" ],
      ...
      specialStatus3: [ "<32>{#p/story}* 帕派瑞斯將所有思緒都拋之腦後。" ],
      specialStatus4: [ "<32>{#p/story}* 帕派瑞斯發覺自己有些缺乏思緒，\n又把它帶回來了。" ],
      ...
      talkText: [
         ...
         () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    "<32>{#p/napstablook}{#k/2}* 你想了解關於幽靈的一些事嗎？",
                    "<32>{#k/0}* 嗯，我所知道的幽靈只有我自己\n  和我的三個表親...",
                    "<32>{#k/3}* 當然，還有你背後的那一個",
                    "<32>{#k/1}* 除此之外，我就沒什麼可以說了",
                    "<32>{#k/0}* 沒有宿體融合的我們，\n  只能勉強... 維持存在。",
                    "<32>{#k/0}* 嗯, 我懂...\n* 這特質確實很有趣..."
                 ],
         () =>
