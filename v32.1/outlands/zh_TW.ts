...
export default {
   a_outlands: {
      ...
      fireplace1: () =>
         SAVE.data.b.svr
            ...
            : [
               ...
               ...(world.darker
                  ? []
                  : ["* You could probably crawl in.", choicer.create("* （爬進去嗎？）", "是", "否")])
            ],
      ...
      asriel2b: ["{#p/asriel2}{#f/1}* Ready?", choicer.create("* （跟上他嗎？）", "是", "否")],
      ...
      food: () => [
         ...(SAVE.data.n.state_wastelands_mash === 2
            ...
            : ["{#p/toriel}* Breakfast is ready!", "<26>* 我給你做了一盤焗蝸牛。"]),
      ...
      halo: {
         a: ["{#p/human}* (You got the Halo.)", choicer.create("* （戴上光環嗎？）", "是", "否")],
         b: ["{#p/human}* (You're carrying too much to take that.)"]
      },
      indie1: () => [
         ...([1, 5].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
