...
export default {
   a_outlands: {
      ...
      chair2d2: [
         ...
         "<32>{#p/human}{#n1!}* （你该怎么说？）{!}\nµµµµµµµµµµµµµµµµµµ怎样才能\nµµµµµµµµ抱歉µµµµµµ离开外域{#c/0/8/2}"
      ],
      chair2d3: [
      ...
      chair2d4: [
         ...
         "<32>{#p/human}{#n1!}* （你该怎么说？）{!}\nµµµµµµµµµµµµµµµµµµµµ怎样才能\nµµµµµµ没事了µµµµµµµµ离开外域{#c/0/6/4}"
      ],
      ...
      trivia: {
         ...
         w_puzzle2: () =>
            SAVE.data.b.svr
               ...
               ? [
                    "<32>{#p/basic}* “最后的边境宛若深邃的海洋。”",
                    "<32>* \"Navigating its waters should NEVER require solving badly designed puzzles!\""
                 ]
               : [
                    "<32>{#p/basic}* “最后的边境宛若深邃的海洋。”",
                    "<32>{#p/basic}* “待其{@fill=#ff993d}浪潮齐平{@fill=#fff}之时，便是{@fill=#00a2e8}迈向未知{@fill=#fff}\n  之日。”"
                 ],
         w_puzzle3_view: () =>
            SAVE.data.b.svr
   ...
   b_opponent_toriel: {
      ...
      death2: [
         "<11>{#p/toriel}{#f/21}{#v/1}{#i/3}{#x1}{@random=1.1/1.1}呃啊...",
         "<11>{#v/1}{#i/6}{#x3}{@random=1.1/1.1}本以为，自己\n努力保护的人，\n是你...",
         "<11>{#v/1}{#i/6}{#x4}{@random=1.1/1.1}...",
         "<11>{#v/2}{#i/9}{#x2}{@random=1.1/1.1}哈...\n哈...",
         "<11>{#v/2}{#i/9}{#x1}{@random=1.1/1.1}现在看来，\n年轻人...",
         "<11>{#v/3}{#i/12}{#x2}{@random=1.2/1.2}我真正保护的，\n是他们啊..."
      ],
      death3: [
         "<11>{#p/toriel}{#f/21}{#v/1}{#i/3}{#x1}{@random=1.1/1.1}呃啊...",
