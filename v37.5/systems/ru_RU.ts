...
export default {
   battle: {
      ...
      victory1: ">{#p/story}* ПОБЕДА!\n* Награда $(x) ОП и $(y)З.",
      victory2: ">{#p/story}* ПОБЕДА!\n* Награда $(x) ОП и $(y)З.\n* Ваш УР повысился."
   },
   ...
   menu: {
      ...
      story1: [">{#p/storyteller}Давным-давно, два вида правили солнечной системой: ЛЮДИ и МОНСТРЫ.{^35}{}"],
      story2: [">Со временем, между ними разрослась война.{^35}{}"],
      story3: [">Когда родная планета МОНСТРОВ была уничтожена, ЛЮДИ объявили победу.{^35}{}"],
      story4: [">Оставшихся МОНСТРОВ изгнали на заброшенный аванпост.{^35}{}"],
      story5: [">Мощный силовой барьер был возведён, и МОНСТРОВ запечатали в нём.{^35}{}"],
      story6: [">Много лет спустя.{^8}.{^8}.{^35}{}"],
      story7: ["#     СЕКТОР ЭБОТТ     \n         251X{^35}{}"],
      story8: [">Легенды гласят, что космические корабли никогда не возвращаются оттуда.{^35}{}"],
      story9: [">{^100}{}"],
      story10: [">{^100}{}"],
      story11: [">{^35}{}"]
   },
