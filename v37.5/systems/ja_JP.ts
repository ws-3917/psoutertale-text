...
export default {
   battle: {
      ...
      victory1: ">{#p/story}＊ YOU WIN！\n＊ $(x)EXPと$(y)ゴールドを　かくとく。",
      victory2: ">{#p/story}＊ YOU WIN！\n＊ $(x)EXPと$(y)ゴールドを　かくとく。\n＊ LOVEが　あがった。"
   },
   ...
   menu: {
      ...
      story1: [">{#p/storyteller}むかしむかし　たいようけいには\nニンゲンと　モンスターという\n2つのしゅぞくが　いました。{^35}{}"],
      story2: [">ときが　たつにつれ\n2つのしゅぞくの　あいだに\nせんそうが　おきました。{^35}{}"],
      story3: [">そして　モンスターたちの　母星を　はかいされたすえ　ニンゲンが　しょうりしました。{^35}{}"],
      story4: [">のこりの　モンスターたちは　ほうきされた　ぜんしょうきちに　ついほうされた。{^35}{}"],
      story5: [">ニンゲンは　きょうりょくな\nフォース　フィールドで\nモンスターたちを　とじこめました。{^35}{}"],
      story6: [">それから　さらに\nながい　ときが　ながれ…{^8}…{^8}…{^35}{}"],
      story7: ["#   イビト　セクター   \n       251X年{^35}{}"],
      story8: [">それは　「うちゅうきは\nにどと　もどらない」といわれる\nてんせつのセクターでした。{^35}{}"],
      story9: [">{^100}{}"],
