...
export default {
   ...
   menu: {
      ...
      story1: [">{#p/storyteller}Long ago, two species ruled the solar system: HUMANS and MONSTERS.{^35}{}"],
      story2: [">As time passed, a war broke out between the two species.{^35}{}"],
      story3: [">After the MONSTERS' home planet was destroyed, HUMANS declared victory.{^35}{}"],
      story4: [">The remaining MONSTERS were banished to an abandoned outpost.{^35}{}"],
      story5: [">A powerful force field was erected, and the MONSTERS were sealed in.{^35}{}"],
      story6: [">Many years later.{^8}.{^8}.{^35}{}"],
      story7: ["#     EBOTT SECTOR     \n         251X{^35}{}"],
      story8: [">Tales speak of a place from which spacecraft never return.{^35}{}"],
      story9: [">{^100}{}"],
      story10: [">{^100}{}"],
      story11: [">{^35}{}"]
   },
