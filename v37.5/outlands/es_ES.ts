...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         d15: [
            ...
            ">* They'd attack people, or worse, make them... disappear.",
            ">* But not Frisk.",
      ...
      asriel0: [
         ">{#p/asriel2}{#f/5}* ... but that's okay, I know you'll be there on time!",
         ">{#p/asriel2}{#f/1}* You wouldn't want to let me down, would you?"
      ],
      asriel1: () =>
         [
            [
               ">{#p/asriel2}{#f/2}* Sorry about that, I had to use Toriel's phone to call someone.",
               ">{#p/asriel2}{#f/1}* Don't worry...\n* You'll find out why soon enough.",
               ">{#p/asriel2}{#f/2}* ... hee hee hee.\n* I'll be waiting for you up ahead."
            ],
            [">{#p/asriel2}{#f/4}* I'll be waiting for you up ahead."],
            [">{#p/asriel2}{#f/3}* ..."]
         ][Math.min(SAVE.flag.n.ga_asrielNegative1++, 1)],
      asriel2: () => [
         ">{#p/asriel2}{#f/1}* Ready, $(name)?",
      ...
      chair1f: pager.create(
         ...
         [">{#p/toriel}{#n1}{#f/5}* I shall remain here, as I always have..."]
      ),
      chair2a1: () => [
      ...
      chair2c6: [
         ...
         ">{#f/5}* \"'I cannot find you a date, I know no one else' said the monster.\"",
      ...
      dummy8: [
         ...
         ">{#f/1}* By escaping, you have avoided any potential conflict...",
      ...
      food: () => [
         ...(SAVE.data.n.state_wastelands_mash === 2
            ...
            : [">{#p/toriel}* Breakfast is ready!", ">* I have prepared a plate of fried snails for you."]),
      ...
      front4: () => [
         ...
         ...(SAVE.data.n.state_wastelands_mash === 1
            ? [
               world.bullied
                  ? ">{#f/3}* In other news, that little white dog has raided my kitchen again."
         ...
         ...([1, 5].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? [
               early
                  ...
                  : ">{#p/toriel}{#g/torielTired}* ... impatient, are we?",
      ...
      plot_call: {
         ...
         c: [
            ...
            ">{#f/5}* ...",
            ">{#f/5}* I suppose humans cannot even be allergic to monster food.",
            ">{#f/0}* Hee hee.\n* Forget I asked!"
         ],
         d: [
            ">{#p/event}* Ring, ring...",
      ...
      runaway1: [
         ...
         [">{#p/toriel}{#f/5}* The gravity is low here.\n* You will float away."],
      ...
      runaway7b: [
         ...
         ">{#p/human}* (You hear footsteps fading into the distance.)"
      ],
      silencio: {
         a: pager.create(
            0,
      ...
      socks2: () =>
         world.meanie
            ? [">{#p/human}* (You make a mess of the socks.)"]
            : [
      ...
      supervisor: {
         ...
         b: [
            ...
            ">* i've been experimenting with my style lately, so...",
      ...
      terminal: {
         a: () =>
            postSIGMA()
               ? [">{#p/human}* (You activate the terminal, but there's no incoming message.)"]
               : SAVE.data.n.plot === 72
                  ? !world.runaway
                     ? [
                        ">{#p/human}* (You activate the terminal and play the incoming message.)",
      ...
      securefield: [">{#p/basic}* There is a security field here.\n* It is active."],
      trivia: {
         ...
         w_froggit: () =>
            SAVE.data.n.plot === 72
               ...
               : [
                  ...
                  ">* (If you {@fill=#ff0}ACT{@fill=#fff} a certain way or {@fill=#3f00ff}FIGHT{@fill=#fff} until you almost defeat them...)",
         ...
         w_kitchenwall: () =>
            SAVE.data.n.plot === 9
               ? [">{#p/toriel}{#f/1}* Patience, my child!"]
               : [">{#p/toriel}{#f/1}* This may take a while..."],
         w_lobby1: () =>
            SAVE.data.b.svr
         ...
         w_th_table2: () =>
            SAVE.data.b.svr
               ...
               : world.darker
                  ? [
                     ">{#p/human}* (You look under the table and find a deck of cards.)",
                     ">{#p/basic}* It's just not worth your time."
                  ]
                  : SAVE.data.n.plot === 72
                     ? [
                        ">{#p/human}* (You look under the table and find a deck of cards.)",
                     ...
                     : [
                        ">{#p/human}* (You look under the table and find a deck of cards.)",
                        ">{#p/basic}* They're holographic, of course."
                     ],
         w_tk_counter: () =>
            SAVE.data.b.svr
               ? [
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...
                     ">* \"But what if one of our own attacked instead...?\"",
            ...
            SAVE.data.b.svr
               ...
               : [
                  ...
                  ...(world.goatbro && SAVE.flag.n.ga_asrielOutlands7++ < 1
                     ? [">{#p/asriel2}{#f/8}* How grossly sentimental."]
                     : [])
               ]
      },
      piecheck: () =>
      ...
      twinkly10: [
         ">{#f/5}See that heart? That's your SOUL, the very culmination of your being!",
         ">{#f/5}Your SOUL is an important part of you, and needs LOVE to sustain itself."
      ],
      twinkly11: [
         ">{*}{#x2}{#f/5}Out here, LOVE is shared through... {#f/8}little white... {#f/11}'happiness shards.'",
         ">{*}{#f/5}To get you started on the right path, I'll share some of my own LOVE.",
         ">{*}{#f/5}Try to get as many as you can!{^20}{*}{#x1}{%}"
      ],
      twinkly12: [
         ">{*}{#f/8}Whoops, I think you might've missed them...",
         ">{*}{#f/5}But that's okay!",
         ">{*}{#x2}{#f/10}Here, have some more.{^20}{*}{#x1}{%}"
      ],
      twinkly13: [
         ">{*}{#f/12}What the-... are you braindead or something??",
         ">{*}{#x2}RUN. INTO. THE. BULLETS!!!{^20}{*}{#x1}{^999}"
      ],
      twinkly14: "RUN. INTO. THE. happiness shards~",
      twinkly15: [
         ">{#v/1}Hee hee hee...",
         ">In this world, it's KILL or BE killed.",
         ">Imagine, a SOUL like yours crash-landing on my doorstep...",
         ">Did you really think I'd pass up such a golden opportunity?"
      ],
      twinkly16: [
         ">{#f/7}Nah, you know what's going on here, don'tcha?",
         ">You just wanted to torment little old Twinkly, didn'tcha?",
         ">Golly... you must have no idea who you're messing with.",
         ">{#f/11}Hee hee hee..."
      ],
      twinkly17: [">{#v/1}We'll just have to cut straight to the point, won't we?", ">Hee hee hee..."],
      twinkly18: [">{*}{#f/2}{#v/1}{@random=1.1/1.1}DIE.{^20}{%}"],
      twinkly19: [">{#p/toriel}What a terrible creature, torturing such a poor, innocent youth..."],
      twinkly20: [
         ">Have no fear, little one.",
         ">I am {@fill=#003cff}TORIEL{@fill=#000}, overseer of the {@fill=#f00}OUTLANDS{@fill=#000}.",
         ">I come by every day to check for those who have been stranded here.",
      ...
      twinkly21: [
         ...
         ">{#f/0}* I come by every day to check for those who\n  have been stranded here.",
         ">{#f/0}* Follow me, child.\n* There is much I intend to teach you."
      ],
   ...
   b_opponent_froggit: {
      ...
      confuseText: [">{#p/basic}{~}Ribbit, ribbit?"],
      flirtText: [">{#p/basic}{~}(Blushes deeply.)\nRibbit.."],
      idleText1: [">{#p/basic}{~}Ribbit, ribbit."],
      idleText2: [">{#p/basic}{~}Croak, croak."],
      idleText3: [">{#p/basic}{~}Hop, hop."],
      idleText4: [">{#p/basic}{~}Meow."],
      mercyStatus: [">{#p/story}* Froggit seems reluctant to fight you."],
      name: "* Froggit",
      meanText: [">{#p/basic}{~}(Shiver, shake.)\nRibbit.."],
      niceText: [">{#p/basic}{~}(Blushes softly.)\nRibbit.."],
   ...
   b_opponent_whimsun: {
      ...
      idleTalk1: [">{#p/basic}{~}Why is this so hard.."],
      idleTalk2: [">{#p/basic}{~}Please help me.."],
      idleTalk3: [">{#p/basic}{~}I'm scared.."],
      idleTalk4: [">{#p/basic}{~}I can't do this.."],
      idleTalk5: [">{#p/basic}{~}\x00*sniff sniff*"],
      name: "* Flutterlyte",
   ...
   b_opponent_loox: {
      ...
      checkTalk1: [">{#p/basic}{~}Do you dare to stare?"],
      dontDeny1: [">{#p/basic}{~}Look who changed their mind."],
      dontTalk1: [">{#p/basic}{~}The gaze\nis\nstrong\nwith\nthis one."],
      flirtDeny1: [">{#p/basic}{~}How tsundere of you."],
      flirtTalk1: [">{#p/basic}{~}What? N-no way!"],
      hurtStatus: [">{#p/story}* Oculoux is watering."],
      idleTalk1: [">{#p/basic}{~}I've got my eye on you."],
      idleTalk2: [">{#p/basic}{~}Don't tell me what to do."],
      idleTalk3: [">{#p/basic}{~}Staring is caring."],
      idleTalk4: [">{#p/basic}{~}What an eyesore."],
      idleTalk5: [">{#p/basic}{~}How about a staring contest?"],
      name: "* Oculoux",
      pickTalk1: [">{#p/basic}{~}How dare you question our way of life!"],
   ...
   b_opponent_migosp: {
      ...
      groupTalk1: [">{#p/basic}FILTHY SINGLE MINDER\n.."],
      groupTalk2: [">{#p/basic}OBEY THE OVERMIND\n.."],
      groupTalk3: [">{#p/basic}LEGION! WE ARE LEGION!"],
      groupTalk4: [">{#p/basic}HEED THE SWARM\n.."],
      groupTalk5: [">{#p/basic}IN UNISON, NOW\n.."],
      groupTalk6: [">{#p/basic}I DON'T CARE."],
      name: "* Silente",
      ...
      soloTalk1: [">{#p/basic}{~}Bein' me is the best!"],
      soloTalk2: [">{#p/basic}{~}La la~ Just be your- self~"],
      soloTalk3: [">{#p/basic}{~}Nothin' like alone time!"],
      soloTalk4: [">{#p/basic}{~}Mmm, cha cha cha!"],
      soloTalk5: [">{#p/basic}{~}Swing your arms, baby~"]
   },
   b_opponent_mushy: {
      act_challenge: [
         ">{#p/human}* (You challenge Mushy to a duel.)",
         ">{#p/story}* Mushy's SPEED up for this turn!"
      ],
      ...
      challengeTalk1: [">{#p/basic}{~}Let's see what you got."],
      challengeTalk2: [">{#p/basic}{~}Think you can take me?"],
      flirtStatus1: [">{#p/story}* Mushy, the confused and the aroused."],
      flirtTalk1: [">{#p/basic}{~}H-hey, knock it off!"],
      hurtStatus: [">{#p/story}* Mushy makes a last stand."],
      idleTalk1: [">{#p/basic}{~}Bang!\nBang!\nBang!"],
      idleTalk2: [">{#p/basic}{~}Saddle up!"],
      idleTalk3: [">{#p/basic}{~}All in a day's."],
      name: "* Mushy",
      ...
      tauntTalk1: [">{#p/basic}{~}As if that'll work on me."]
   },
   b_opponent_napstablook: {
      ...
      awkwardTalk: [">{#p/napstablook}{~}uh..."],
      checkTalk: [">{#p/napstablook}{~}that's me..."],
      ...
      cheerTalk2: [">{#p/napstablook}{~}heh heh..."],
      cheerTalk3: [
         ">{*}{#p/napstablook}{~}let me {#x1}try...{^20}{#x2}{^20}{%}",
         ">{*}{#p/napstablook}{~}i call it {#x3}'dapper blook'{^40}{%}",
         ">{*}{#p/napstablook}{~}do you like it?{^40}{%}"
      ],
      cheerTalk4: [">{#p/napstablook}{~}oh gee....."],
      consoleTalk1: [">{#p/napstablook}{~}yeah, yeah..."],
      consoleTalk2: [">{#p/napstablook}{~}not buying it..."],
      consoleTalk3: [">{#p/napstablook}{~}you're not sorry..."],
      deadTalk: [
         ">{#p/napstablook}{~}umm... you do know you can't kill ghosts, right...",
      ...
      flirtTalk1: [">{#p/napstablook}{~}i'd just weigh you down"],
      flirtTalk2: [">{#p/napstablook}{~}oh.....\ni've heard that one....."],
      flirtTalk3: [">{#p/napstablook}{~}uh... you really think so?"],
      flirtTalk4: [">{#p/napstablook}{~}oh, you're serious...", ">{~}oh no....."],
      idleTalk1: [">{#p/napstablook}{~}i'm fine, thanks"],
      idleTalk2: [">{#p/napstablook}{~}just pluggin along..."],
      idleTalk3: [">{#p/napstablook}{~}just doing my thing..."],
      insultTalk1: [">{#p/napstablook}{~}i knew it..."],
      insultTalk2: [">{#p/napstablook}{~}whatever..."],
      insultTalk3: [">{#p/napstablook}{~}say what you will..."],
      insultTalk4: [">{#p/napstablook}{~}let it all out..."],
      name: "* Napstablook",
      silentTalk: [">{#p/napstablook}{~}..."],
      sincere: [">{#p/human}* (You flirtatiously comment on Napstablook's top hat.)"],
      sincereTalk: [">{#p/napstablook}{~}heh... thanks"],
   ...
   b_opponent_toriel: {
      ...
      spannerTalk: [">{#p/toriel}{#f/22}That will accomplish nothing, my child."],
      ...
      criminal1: (reveal: boolean) => [
         ">{#p/asriel2}{#f/3}Howdy, $(name).",
         ">{#f/1}It's good to be back.",
         ">{#f/2}What's that?\nYou didn't expect to see me again?",
         ">{#f/13}...\nOh, $(name)...",
         ...(reveal
            ? [">{#f/1}I've been waiting for this for a long time."]
            : [
               ">{#f/15}I've been trapped inside a star for so long, I...",
               ">{#f/15}...",
               ">{#f/16}Well, that's not important now.",
               ">{#f/1}What matters is that things are back to how they should be."
            ]),
         ">{#f/1}Hee hee hee...",
         ">{#f/2}I know you're empty inside, just like me.",
         ">{#f/5}We're still inseparable after all these years...",
         ">{#f/1}Listen.\nI have a plan that'll bring us closer than ever.",
         ">{#f/1}With me, you, and our stolen SOULs...",
         ">{#f/1}Let's destroy everything on this wretched outpost.",
         ">{#f/2}Anyone who dares to stand in the way of our perfect future...",
         ">{#f/1}Let's turn 'em all to dust."
      ],
      criminal2: [">{#p/asriel2}{#f/3}Welcome back, $(name).", ">{#f/1}Ready to pick up where we last left off?"],
      criminal3: [">{#p/asriel2}{#f/3}Well then.", ">{#f/3}...", ">{#f/4}Let's just get going."],
      cutscene1: [
      ...
      cutscene2: [
         ...
         ">{#p/basic}* But things aren't the same as they were a hundred years ago.",
         ">{#p/basic}* You're only ignorant about it because you're too afraid to go see for yourself.",
         ">{#p/toriel}{#f/13}* ...",
      ...
      death1: [
         ">{#p/toriel}{#f/21}{#v/1}{#i/3}{#x1}{@random=1.1/1.1}Urgh...",
         ">{#v/1}{#i/3}{#x1}{@random=1.1/1.1}To strike me down at my weakest moment...",
         ">{#v/1}{#i/3}{#x1}{@random=1.1/1.1}...",
         ">{#v/2}{#i/4}{#x2}{@random=1.1/1.1}Ha...\nHa...",
         ">{#v/2}{#i/4}{#x2}{@random=1.1/1.1}It seems, young one...",
         ">{#v/3}{#i/5}{#x2}{@random=1.2/1.2}I was a fool for trusting you... all along..."
      ],
      death2: [
         ">{#p/toriel}{#f/21}{#v/1}{#i/3}{#x1}{@random=1.1/1.1}Urgh...",
         ">{#v/1}{#i/3}{#x3}{@random=1.1/1.1}To think I was protecting you from them...",
         ">{#v/1}{#i/3}{#x4}{@random=1.1/1.1}...",
         ">{#v/2}{#i/4}{#x2}{@random=1.1/1.1}Ha...\nHa...",
         ">{#v/2}{#i/4}{#x1}{@random=1.1/1.1}It seems, young one...",
         ">{#v/3}{#i/5}{#x2}{@random=1.2/1.2}I was actually protecting them... from you..."
      ],
      death3: [
         ">{#p/toriel}{#f/21}{#v/1}{#i/3}{#x1}{@random=1.1/1.1}Urgh...",
         ">{#v/1}{#i/3}{#x1}{@random=1.1/1.1}You are stronger than I thought...",
         ">{#v/1}{#i/3}{#x3}{@random=1.1/1.1}Listen to me, young one...",
         ">{#v/1}{#i/3}{#x3}{@random=1.1/1.1}In a few moments, I will turn to dust...",
         ">{#v/1}{#i/3}{#x3}{@random=1.1/1.1}When that happens, you must take my SOUL...",
         ">{#v/1}{#i/3}{#x1}{@random=1.1/1.1}It is the only real way you can escape this place.",
         ">{#v/2}{#i/4}{#x3}{@random=1.1/1.1}You cannot... allow ASGORE's plan to... succeed...",
         ">{#v/2}{#i/4}{#x1}{@random=1.1/1.1}...",
         ">{#v/3}{#i/5}{#x2}{@random=1.2/1.2}My child...",
         ">{#v/3}{#i/5}{#x4}{@random=1.2/1.2}Be good... won't you?"
      ],
      magic1: [">{#p/asriel2}{#f/3}Follow me."],
      name: "* Toriel",
      spareTalk1: [">{#p/toriel}{#f/11}..."],
      spareTalk2: [">{#p/toriel}{#f/11}...\n..."],
      spareTalk3: [">{#p/toriel}{#f/11}...\n...\n..."],
      spareTalk4: [">{#p/toriel}{#f/17}...?"],
      spareTalk5: [">{#p/toriel}{#f/17}What are you doing?"],
      spareTalk6: [">{#p/toriel}{#f/17}..."],
      spareTalk7: [">{#p/toriel}{#f/17}What are you trying to prove?"],
      spareTalk8: [">{#p/toriel}{#f/17}..."],
      spareTalk9: [">{#p/toriel}{#f/12}Fight me or leave!"],
      spareTalk10: [">{#p/toriel}{#f/12}Stop looking at me that way!"],
      spareTalk11: [">{#p/toriel}{#f/12}Go away!"],
      spareTalk12: [">{#p/toriel}{#f/13}..."],
      spareTalk13: [">{#p/toriel}{#f/13}...\n..."],
      spareTalk14: [">{#p/toriel}{#f/13}...\n...\n..."],
      spareTalk15: [
         ">{#p/toriel}{#f/13}I know you want to go home...",
         ">{#p/toriel}{#f/9}But you may die trying to get there."
      ],
      spareTalk16: [">{#p/toriel}{#f/14}So please... go back the other way."],
      spareTalk17: [
         ">{#p/toriel}{#f/13}I know we do not have much...",
         ">{#p/toriel}{#f/10}But we can still have a good life."
      ],
      spareTalk18: [
         ">{#p/toriel}{#f/13}You and I, like a family...",
         ">{#p/toriel}{#f/10}Does that not sound good?"
      ],
      spareTalk19: [">{#p/toriel}{#f/21}..."],
      spareTalk20: [">{#p/toriel}{#f/18}Why are you making this so difficult?"],
      spareTalk21: [">{#p/toriel}{#f/21}..."],
      spareTalk22: [">{#p/toriel}{#f/18}Please, just...", ">{#p/toriel}{#f/9}Go back the other way."],
      spareTalk23: [">{#p/toriel}{#f/21}..."],
      spareTalk24: [">{#p/toriel}{#f/18}Oh, child..."],
      spareTalk28b: [
         ">{#p/toriel}{#f/9}Maybe it was foolish of me...",
         ">{#f/13}Trying to stop you like this...",
         ">{#f/9}Maybe I should have just let you go."
      ],
      spareTalk28c: [">{#p/toriel}{#f/17}...?", ">{#f/17}Why are you calling out for \"$(name)?\""],
   ...
   i_water: {
      ...
      use: () => [
         ...
         ...(SAVE.data.b.ufokinwotm8 ? [] : [">{#p/human}* (You're filled with hydration.)"])
      ]
   },
   i_chocolate: {
      battle: {
   ...
   i_spacesuit: {
      ...
      name: "Worn Spacesuit",
      use: [">{#p/human}* (After using its last heal-pak, the Worn Spacesuit fell apart.)"]
   },
   i_spanner: {
      battle: {
