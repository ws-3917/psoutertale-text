...
export default {
   a_outlands: {
      ...
      nosleep: [">{#p/human}* (Что-то прервало ваш сон.)"],
      noequip: [">{#p/human}* (Вы решили не оснащать.)"],
      finaltext: {
      ...
      stargum1: () =>
         SAVE.data.b.svr
            ? [
               ">{#p/human}* (Вы увидели жвачку, приклеенную к комиксу...)",
      ...
      stargum2: [">{#p/human}* (Вы решили не грызть.)"],
      stargum3: [">{#p/human}* (Вы восстановили $(x) ОЗ.)"],
      stargum4: [">{#p/human}* (ОЗ полностью восстановлено.)"],
      fireplace1: () =>
         SAVE.data.b.svr
            ? [
            ...
            : [
               ...
               ...(world.darker
                  ? []
                  : [">* You could probably crawl in.", choicer.create("* (Crawl inside?)", "Да", "Нет")])
            ],
      ...
      asriel2b: () => [">{#p/asriel2}{#f/1}* Ready?", choicer.create("* (Follow Him?)", "Да", "Нет")],
      ...
      halo: {
         a: () => [">{#p/human}* (You got the Halo.)", choicer.create("* (Equip the Halo?)", "Да", "Нет")],
         b: [">{#p/human}* (You're carrying too much to take that.)"]
      },
      indie1: () => [
         ...([1, 5].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
      ...
      twinkly1: [
         ">{#p/twinkly}{#f/5}* Приветик!\n* Я {@fill=#ff0}МЕРЦИК{@fill=#fff}.\n* {@fill=#ff0}ЗВЕЗДА{@fill=#fff}{@fill=#ff0}МЕРЦИК{@fill=#fff}!"
      ],
      twinkly2: [
         ">{#f/5}* Что принесло тебя в аванпост, путешественник?",
         ">{#f/5}* ...",
         ">{#f/8}* Вы потерялись, не так ли...",
         ">{#f/5}* Ну, хорошо что я с тобой!",
         ">{#f/8}* Я уже давно не в лучшей форме, но...",
         ">{#f/5}* ... кому-то нужно объяснить тебе как тут всё работает!",
         ">{#f/10}* Полагаю, старому доброму мне придётся это сделать.",
         ">{#f/5}* Давай начнём, ладно?"
      ],
      twinkly3: [
         ">{#f/7}* Но ты это уже ЗНАЛ, не так ли?",
         ">{#f/8}* ...",
         ">{#f/5}* Ну, мне все ещё предстоит показать тебе основы.",
         ">* Давай начнём, ладно?"
      ],
      twinkly4: [
         ">{#p/twinkly}{#f/6}* Всё, с меня хватит.",
         ">{#f/8}* Если ты хочешь продолжать сбрасывать, то пожалуйста...",
         ">{#f/6}* Делай что хочешь.",
         ">{#f/7}* Но не ожидай, что легко проскользнёшь мимо меня."
      ],
      twinkly5: [">{#p/twinkly}{#f/6}* Нет ли у тебя дел поважнее?"],
      twinkly6: [
         ">{#p/twinkly}{#f/6}* Хех, сразу сбросили после первого ранения?",
         ">{#f/7}* Как жалко."
      ],
      twinkly6a: [
         ">{#p/twinkly}{#f/11}* Как будто я забуду, что вы сделали...",
         ">{#f/7}* Грязный уклонист осколков."
      ],
      twinkly7: [">{#p/twinkly}{#f/7}* Я могу играть в эту игру хоть весь день, тупица."],
      twinkly8: [">{#f/11}* В любом случаи, раз вы уже знаете что будет дальше...{%15}"],
      twinkly9: [
         ">{#p/twinkly}{#f/6}* Приветик.",
         ">* Похоже меня сожгут если я останусь на долго.",
         ">{#f/8}* Ах, как жаль...",
         ">{#f/7}* Я собирался повеселиться как следует.",
         ">{#f/6}* ...",
         ">{#f/5}* Ну, увидимся!"
      ],
      twinkly9a: [
         ">{#p/twinkly}{#f/12}{#v/0}* Какого ЧЁРТА ты делаешь, $(name)?",
         ">{#f/12}{#v/0}* У нас был весь аванпост на коленях!"
      ],
      twinkly9a1: [">{#f/6}{#v/0}* Нам нужно было лишь следовать плану."],
      twinkly9a2: [
         ">{#f/6}{#v/0}* Нам нужно было лишь пройти через Литцех...",
         ">* Прикончить стражу...",
         ">* И дойти до Цитадели!"
      ],
      twinkly9a3: [
         ">{#f/6}{#v/0}* Нам нужно было лишь прикончить стражу...",
         ">* И дойти до Цитадели!"
      ],
      twinkly9a4: [
         ">{#f/6}{#v/0}* Нам нужно было лишь УБИТЬ того тупого робота...",
         ">* И дойти до Цитадели!"
      ],
      twinkly9a5: [">{#f/6}{#v/0}* Нам нужно было лишь пройти через Цитадель!"],
      twinkly9a6: [">{#f/6}{#v/0}* All we had to do was KILL that nerdy trashbag!"],
      twinkly9a7: [">{#f/6}{#v/0}* All we had to do was walk to the end!", ">* Мы были так близки!"],
      twinkly9a8: [">{#f/8}{#v/0}* Трус..."],
      twinkly9b: [
         ">{#p/twinkly}{#f/5}* $(name)...?",
      ...
      twinkly10: [
         ">{#f/5}Видишь это сердечко? Это твоя ДУША, сама кульминация твоего бытия!",
         ">{#f/5}Твоя ДУША это важная часть тебя, и ей нужен УР чтобы обеспечить себя."
      ],
      twinkly11: [
         ">{*}{#x2}{#f/5}Здесь, УР делятся через... {#f/8}маленькие, белые... {#f/11}'осколки счастья.'",
         ">{*}{#f/5}Чтобы направить тебя на верный путь, я поделюсь частью своего УР.",
         ">{*}{#f/5}Попробуй поймать по-больше осколков!{^20}{*}{#x1}{%}"
      ],
      twinkly12: [
         ">{*}{#f/8}Упс, полагаю вы их пропустили...",
         ">{*}{#f/5}Но не беда!",
         ">{*}{#x2}{#f/10}Вот, держи ещё.{^20}{*}{#x1}{%}"
      ],
      twinkly13: [
         ">{*}{#f/12}Какого-... ты безмозглый или что??",
         ">{*}{#x2}БЕГИ. В. ПУЛИ!!!{^20}{*}{#x1}{^999}"
      ],
      twinkly14: "БЕГИ. В. осколки счастья~",
      twinkly15: [
         ">{#v/1}Хи-хи-хи...",
         ">В этом мире, УБЕЙ или БУДЕШЬ убит.",
         ">Представь, ДУША подобная твоей, приземлившаяся к моей двери...",
         ">Человек, ты реально думал что я пропущу такую возможность?"
      ],
      twinkly16: [
         ">{#f/7}Не, ты знаешь что тут происходит, не так ли?",
         ">Вы лишь хотели помучить бедного старенького Мерцика, не так ли?",
         ">Божечки... ты действительно не знаешь, кому ты мешаешь.",
         ">{#f/11}Хи-хи-хи..."
      ],
      twinkly17: [">{#v/1}Перейдём к сути, ладно?", ">Хи-хи-хи..."],
      twinkly18: [">{*}{#f/2}{#v/1}{@random=1.1/1.1}УМРИ.{^20}{%}"],
      twinkly19: [">{#p/toriel}Что за ужасное создание мучает бедное, невинное дитя..."],
      twinkly20: [
         ">Не бойся, дитя.",
         ">Я {@fill=#003cff}ТОРИЕЛЬ{@fill=#000}, смотрительница {@fill=#f00}ЗАПРЕДЕЛЬЯ{@fill=#000}.",
         ...
         text: () =>
            world.runaway
               ? [
                  ...
                  ">{#p/human}* (ОЗ полностью восстановлено.)"
               ]
               : SAVE.data.n.plot < 48
                  ? [
