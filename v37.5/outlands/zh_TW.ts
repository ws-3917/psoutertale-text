...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         d3: [">{#p/basic}* Asriel，是我啊，你最好的朋友...", ">{#p/basic}* 還記得我嗎？"],
         d4: [
            ">{#p/asriel1}{#f/25}* ...！",
            ">{#f/25}* $(name)...？",
            ">{#f/13}* 可是... 你...",
         ...
         d13: [">{#p/basic}* 別傷心，Asriel。", ">* 沒必要逼自己覺得\n  我是個好人。"],
         ...
         d30: [">{#p/asriel1}{#f/15}* ...？"],
         d31: [">{#p/basic}* ...是你，Asriel。", ">* 是你一直在支撐我活下去。"],
         d32: [
         ...
         d46: [">{#p/asriel1}{#f/25}* Frisk，你在那裡嗎？", ">{#f/22}* 拜託了... 醒來吧..."],
      ...
      asrielDiary: [
         ...
         [
            ">{#p/human}* （你翻到第二頁...）",
            ">{#p/asriel1}{#v/2}* 「azzy的日計 克ㄌㄧˋ504年」",
            ">* 「媽咪說 我ㄧㄥ該 把日期 寫在上面\n   不然 其他人 不知到\n   我 那天寫的 日計。」",
            ">* 「我的星星花 還是沒有ㄎㄞ\n   但是 爹地說 馬上就會ㄎㄞ的」",
            ">* 「我想 在我的ㄈㄤˊ間\n   安一ㄕㄢˋ 窗戶 可是 爹地說\n   有ㄍㄨㄢˇ子 就安不了。」",
            ">* 「但是 可以在 客ㄊㄧㄥ\n   為我 安一ㄕㄢˋ 窗戶」",
         ...
         [
            ">{#p/human}* （你翻到第三頁...）\n* （看起來，兩年過去了。）",
            ">{#p/asriel1}{#v/2}* 「Azzy的日記，克歷506年 3月」",
            ">* 「我今天在番玩具的時候\n   找到了日記 打算多寫一點。」",
            ">* 「好像上一次 我忘記在日記裡\n   寫上日期了。」",
            ">* 「對了 我之前播ㄓㄨㄥˋ的 星星花\n   長出來一點了。」",
            ">* 「但是今天 我和朋友打架了 從那之後\n   我們再沒有ㄐㄧㄤˇ過話。」",
         ...
         [
            ">{#p/human}* （你翻到第四頁...）",
            ">{#p/asriel1}{#v/2}* 「Azzy的日記，克曆506年3月」",
            ">* 「我和朋友 聊了一下，\n   朋友不生我的氣了\n   太好了。」",
            ">* 「今天 媽咪和我 到外面看星空\n   我們看到了流星。」",
            ">* 「媽咪讓我許個原...\n   我希望 有一天\n   我能在這裡見到人ㄌㄟˋ。」",
            ">* 「爹地和媽咪給我ㄐㄧㄤˇ了\n   很多他們的故事...」",
         ...
         [
            ">{#p/human}* （你翻到了第六頁...）\n* （看起來，又過去了好幾年。）",
            ">{#p/asriel1}{#v/1}* 「Azzy的日記，克歷510年8月」",
            ">* 「感覺自己寫日記，\n   總是寫不了多久就放棄了。」",
            ">* 「今天偶然間又翻出了日記本，\n   打算再多寫一點。」",
            ">* 「過去幾年，過的都挺不錯的。\n   我上了學，學到了很多知識。」",
            ">* 「我學會了加減乘除，\n   學會了打字上網。」",
         ...
         [
            ">{#p/human}* （你翻到了第九頁...\n   看起來，又過去了兩天。）",
            ">{#p/asriel1}{#v/1}* 「Azzy的日記，克歷510年9月」",
            ">* 「昨天，我見到了真正的人類。\n   那人類的飛船一頭撞到了\n   我家附近的垃圾站。」",
            ">* 「我將其從廢墟中拉了出來，\n   那人類對我道了謝。」",
            ">* 「我都沒想到有一天\n   居然真的見到了人類。」",
            ">* 「而且，人類{#p/basic}隞亥{#p/asriel1}{#v/1}儘{#p/basic}隤哈哈哈azzy\n   你真是個大混球閗睃{#p/asriel1}{#v/1}憛{#p/basic}烾{#p/asriel1}{#v/1}鈭蝣{#p/basic}摮{#p/asriel1}{#v/1}㛖」",
            ">* 「好，現在我躲到被窩裡\n   $(name)應該沒法再亂寫亂畫了。」",
            ">* 「有時，$(name)會稍微有點淘氣，\n   不過我不介意。」",
            ">* 「媽媽讓$(name)進入戰鬥，\n   發現$(name)的心心是紅色的，\n   方向也是反的。」",
            ">* 「多個能每天陪我聊天的夥伴\n   真是太棒了。」"
      ...
      exitfail1: (lateleave: boolean, sleep: boolean) =>
         world.postnoot
            ...
            : [
               sleep
                  ? ">{#p/basic}* 當你在Toriel的家裡睡下後，\n  她隨即摧毀了離開外域\n  唯一的出口。"
                  : ">{#p/basic}* 在你回到Toriel家後，\n  她隨即摧毀了離開外域\n  唯一的出口。",
               ...(outlandsKills() > 10
                  ? [
                     ">* 日子一天天過去，\n  她很快就發現\n  許多怪物都是因你而死。",
                     ">* 她徹底陷入了絕望。\n  萬念俱灰，最後...",
         ...
         w_toriel_toriel: () => [
            ...
            toriSV()
               ? SAVE.data.n.plot < 17.001
                  ? ">{#p/basic}* 聽起來Toriel在哭..."
                  : ">{#p/basic}* 聽起來Toriel睡著了..."
               : ">{#p/basic}* 聽起來Toriel在寫東西..."
         ],
         w_tt_bed: () =>
            SAVE.data.b.svr
            ...
            SAVE.data.b.svr
               ...
               : world.darker
                  ...
                  : SAVE.data.n.plot === 72
                     ...
                     : [">{#p/basic}* Toriel的專用閱讀椅。", ">* 懶骨頭的味道撲面而來。"],
      ...
      tutorial_puzzle3: [">{#p/toriel}* 非常好，小傢伙！\n* 非常棒。"],
      ...
      tutorial_puzzle8a: [">{#p/toriel}* 答案不在我身上，小傢伙。"],
      ...
      twinkly19: [">{#p/toriel}真是個殘忍的傢伙，\n居然折磨這麼一個\n弱小無助的孩子..."],
      twinkly20: [
         ">不要害怕，孩子。",
         ">我是{@fill=#003cff}TORIEL{@fill=#000}，\n{@fill=#f00}外域{@fill=#000}的管理員。",
         ">我每天都會來看看\n有沒有人被困在這裡。",
         ">跟我來，孩子。\n我有很多東西要教你。"
      ],
      twinkly21: [
         ...
         ">{#f/1}* 受傷了嗎？",
         ">{#f/0}* ...\n* 請原諒我問了這麼多問題。",
         ">{#f/0}* 我是{@fill=#003cff}TORIEL{@fill=#000}，\n  {@fill=#f00}外域{@fill=#000}的管理員。",
         ">{#f/0}* 我每天都會來看看\n  有沒有人被困在這裡。",
         ">{#f/0}* 跟我來，孩子。\n* 我有很多東西要教你。"
      ],
      twinkly22: [">{#f/0}* 跟我來。"],
   ...
   b_opponent_froggit: {
      act_check: [">{#p/story}* FROGGIT - 攻擊4 防禦5\n* 這隻怪物的生活並不輕鬆。"],
      act_check2: [">{#p/story}* FROGGIT - 攻擊4 防禦5\n* 這隻怪物的生活逐漸向好。"],
      act_check3: [">{#p/story}* FROGGIT - 攻擊4 防禦5\n* 這隻怪物的生活仍不好過。"],
      act_check4: [">{#p/story}* FROGGIT - 攻擊4 防禦5\n* 這隻怪物的生活渾渾噩噩。"],
      act_check5: [">{#p/story}* FROGGIT - 攻擊4 防禦5\n* 這隻怪物的生活頗為愜意。"],
      act_threat: [
         ">{#p/human}* （你對Froggit發出威脅。）",
         ">{#p/basic}* 但Froggit並不明白你在說什麼..."
      ],
      act_threat2: [
         ">{#p/human}* （你再一次對Froggit發出威脅。）",
         ">{#p/basic}* Froggit想起了\n  你先前的恐嚇，\n  決定撒腿跑路。"
      ],
      act_compliment: [
         ">{#p/human}* （你稱讚了Froggit一番。）",
         ">{#p/basic}* 但Froggit並不明白你在說什麼..."
      ],
      act_flirt: [
         ">{#p/human}* （你對Froggit調情。）",
      ...
      idleText4: [">{#p/basic}{~}喵。"],
      mercyStatus: [">{#p/story}* Froggit似乎不願意和你戰鬥了。"],
      name: "* Froggit",
      meanText: [">{#p/basic}{~}（縮縮，\n抖抖。）\n呱呱.."],
      niceText: [">{#p/basic}{~}（臉微微\n泛紅。）\n呱呱.."],
      perilStatus: [">{#p/story}* Froggit正試圖逃跑。"],
      status1: [">{#p/story}* Froggit蹦了過來！"],
      status2: [">{#p/story}* 戰場瀰漫著曜菊的芬芳。"],
      status3: [">{#p/story}* Froggit看起來並不知道\n  自己為什麼在這裡。"],
      status4: [">{#p/story}* Froggit跳來跳去。"]
   },
   b_opponent_whimsun: {
   ...
   b_opponent_mushy: {
      act_challenge: [
         ">{#p/human}* （你向Mushy發起決鬥挑戰。）",
         ">{#p/story}* Mushy本回合的攻擊速度加快！"
      ],
      act_check: [">{#p/story}* MUSHY - 攻擊6 防禦6\n* 是星際牛仔的忠實粉絲。\n  也是一位槍術高手。"],
      act_check2: [">{#p/story}* MUSHY - 攻擊6 防禦6\n* 是星際牛仔的忠實粉絲。\n  包括性感牛仔。"],
      act_check3: [">{#p/story}* MUSHY - 攻擊6 防禦6\n* 在拼盡全力之後，\n  這個槍手對你的印象\n  已是刻骨銘心。"],
      act_flirt: [">{#p/human}* （你向Mushy調情。）"],
      act_taunt: [">{#p/human}* （你對著Mushy一通嘲諷。）"],
      challengeStatus: [">{#p/story}* Mushy正等著你的下個挑戰。"],
      challengeTalk1: [">{#p/basic}{~}讓我\n見識一下\n你有什麼\n能耐。"],
      challengeTalk2: [">{#p/basic}{~}是想著\n要把我\n打敗嗎？"],
      flirtStatus1: [">{#p/story}* Mushy既困惑又興奮。"],
      flirtTalk1: [">{#p/basic}{~}嘿，\n別-別鬧了！"],
      hurtStatus: [">{#p/story}* Mushy準備拼死一搏。"],
      idleTalk1: [">{#p/basic}{~}砰！\n砰！\n砰！"],
      idleTalk2: [">{#p/basic}{~}上馬！"],
      idleTalk3: [">{#p/basic}{~}不足為懼。"],
      name: "* Mushy",
      spareStatus: [">{#p/story}* Mushy淺鞠一躬，以表敬意。"],
      status1: [">{#p/story}* 剎那間，Mushy已至！"],
      status2: [">{#p/story}* Mushy稍微調整了一下姿勢。"],
      status3: [">{#p/story}* Mushy正為這場盛大的對決做準備。"],
      status4: [">{#p/story}* Mushy伸手向腰，直奔槍套。"],
      status5: [">{#p/story}* 聞起來像雨後泥土的氣息。"],
      tauntStatus1: [">{#p/story}* Mushy假裝沒聽到你的嘲諷。"],
      tauntTalk1: [">{#p/basic}{~}雕蟲小技，\n能奈我何？"]
   },
   b_opponent_napstablook: {
      act_check: [">{#p/story}* NAPSTABLOOK - 攻擊10 防禦255\n* 這位是Napstablook。"],
      act_check2: [
         ">{#p/story}* NAPSTABLOOK - 攻擊10 防禦255\n* 看起來它完全不想呆在這裡。"
      ],
      act_check3: [">{#p/story}* NAPSTABLOOK - 攻擊10 防禦255\n* 已經有許久沒像這樣感到希望了..."],
      act_check4: [">{#p/story}* NAPSTABLOOK - 攻擊10 防禦255\n* 浪漫的緊張氣氛空前高漲。"],
      awkwardTalk: [">{#p/napstablook}{~}呃..."],
      checkTalk: [">{#p/napstablook}{~}是我..."],
      cheer0: [">{#p/human}* （你試圖安慰Napstablook。）"],
      cheer1: [">{#p/human}* （你給Napstablook一個\n  耐心的微笑。）"],
      cheer2: [">{#p/human}* （你給Napstablook講了一個\n  小小的笑話。）"],
      cheer3: [">{#p/human}* （你讚美Napstablook的大禮帽。）"],
      ...
      flirt1: [">{#p/human}* （你對Napstablook調情。）"],
      flirt2: [">{#p/human}* （你向Napstablook用\n  最好的方式搭訕。）"],
      flirt3: [">{#p/human}* （你由衷地誇讚Napstablook。）"],
      flirt4: [">{#p/human}* （你向Napstablook表露\n  你對它的感覺。）"],
      ...
      sincere: [">{#p/human}* （你對Napstablook的大禮帽\n  發表了曖昧的評論。）"],
      sincereTalk: [">{#p/napstablook}{~}嘿... 謝謝"],
      status1: [">{#p/story}* Napstablook來了。"],
      status2: [">{#p/story}* Napstablook看起來好受了一點。"],
      status3: [">{#p/story}* Napstablook想給你展示些什麼。"],
      status3a: [">{#p/story}* Napstablook等待著你的回應。"],
      status4: [">{#p/story}* Napstablook的眼睛閃閃發光。"],
      status5: [">{#p/story}* Napstablook顯然不確定\n  該怎麼應對這種情況。"],
      status5a: [">{#p/story}* Napstablook正在質疑自己的存在。"],
      status6: [">{#p/story}* Napstablook正在伺機而動。"],
      status7: [">{#p/story}* Napstablook正在等待\n  你下一步的行動。"],
      status8: [">{#p/story}* Napstablook正凝視著遠方。"],
      status9: [">{#p/story}* Napstablook希望它自己不在這裡。"],
      status10: [">{#p/story}* Napstablook正在盡力將你忽視。"],
      suck: [">{#p/human}* （你告訴Napstablook\n  它的帽子很難看。）"],
      threat: [">{#p/human}* （你威脅Napstablook。）"]
   },
   b_opponent_toriel: {
      spannerText: [">{#p/human}* （你把扳手丟了出去。）\n* （Toriel撿起扳手，還給了你。）"],
      spannerTalk: [">{#p/toriel}{#f/22}孩子，扔扳手\n解決不了\n任何問題。"],
      spannerTalkRepeat: [">{#p/toriel}{#f/22}..."],
      act_check: [">{#p/story}* TORIEL - 攻擊80 防禦80\n* 最了解你的人。"],
      act_check2: [">{#p/story}* TORIEL - 攻擊80 防禦80\n* 看起來有所克制。"],
      act_check3: [">{#p/story}* TORIEL - 攻擊80 防禦80\n* 看起來心不在焉。"],
      act_check4: [">{#p/story}* TORIEL - 攻擊80 防禦80\n* 只想把最好的給你。"],
      act_check5: [">{#p/story}* TORIEL - 攻擊80 防禦80\n* 覺得你很「天真可愛」。"],
      precrime: [">{#p/asriel2}..."],
      ...
      status1: [">{#p/story}* Toriel現在正站在你面前。"],
      status2: [">{#p/story}* Toriel準備著魔法攻擊。"],
      status3: [">{#p/story}* Toriel表現得很冷漠。"],
      status4: [">{#p/story}* Toriel看穿了你。"],
      status5: [">{#p/story}* ..."],
      assistStatus: [">{#p/basic}* 肯定有其他辦法的..."],
      talk1: [">{#p/human}* （你請求Toriel讓你過去。）\n* （沒有效果。）"],
      talk2: [">{#p/human}* （你問Toriel為什麼要這麼做。）\n* （她的身體輕輕顫抖了一下。）"],
      talk3: [">{#p/human}* （你求Toriel停下。）\n* （她猶豫了。）"],
      talk4: [
         ">{#p/human}* （你再次求Toriel停下。）",
         ">{#p/basic}* ...也許這麼做對她來說風險太大了。"
      ],
      talk5: [">{#p/human}* （你衝Toriel大喊。）\n* （她閉上眼睛，深吸一口氣。）"],
      talk6: [
         ">{#p/human}* （你再次衝Toriel大喊。）",
