...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         d3: [">{#p/basic}* Asriel，是我啊，你最好的朋友...", ">{#p/basic}* 还记得我吗？"],
         d4: [
            ">{#p/asriel1}{#f/25}* ...！",
            ">{#f/25}* $(name)...？",
            ">{#f/13}* 可是... 你...",
         ...
         d13: [">{#p/basic}* 别伤心，Asriel。", ">* 没必要逼自己觉得\n  我是个好人。"],
         ...
         d30: [">{#p/asriel1}{#f/15}* ...？"],
         d31: [">{#p/basic}* ...是你，Asriel。", ">* 是你一直在支撑我活下去。"],
         d32: [
         ...
         d46: [">{#p/asriel1}{#f/25}* Frisk，你在那里吗？", ">{#f/22}* 拜托了... 醒来吧..."],
      ...
      asrielDiary: [
         ...
         [
            ">{#p/human}* （你翻到第二页...）",
            ">{#p/asriel1}{#v/2}* “azzy的日计 kè历 504年”",
         ...
         [
            ">{#p/human}* （你翻到第三页...）\n* （看起来，两年过去了。）",
            ">{#p/asriel1}{#v/2}* “Azzy的日记，克历506年 3月”",
            ">* “我今天在 fān 我的玩具时\n   找到了日记\n   xiǎng 多写一点”",
            ">* “好像上次 日qī\n   我 wàng 了写月”",
            ">* “对了 我之前 bō 种的星星花\n   长出来一点了”",
            ">* “但是 今天我和 朋友打jià了\n   tā不理我了。”",
         ...
         [
            ">{#p/human}* （你翻到第四页...）",
            ">{#p/asriel1}{#v/2}* “Azzy的日记，克历506年3月”",
            ">* “我和朋友 liáo了一下，\n   朋友不生我的气了，\n   太好了。”",
            ">* “今天，妈妈和我到外面看星空。\n   我们看到了liú星。”",
            ">* “妈妈让我许个原，\n   我希望...\n   有一天，我能在这里见到人lèi。”",
            ">* “妈妈和爸爸给我讲了\n   很多他们的故是...”",
         ...
         [
            ">{#p/human}* （你翻到了第六页...）\n* （看起来，又过去了好几年。）",
            ">{#p/asriel1}{#v/1}* “Azzy的日记，克历510年8月”",
            ">* “感觉自己写日记，\n   总是写不了多久就放弃了。”",
            ">* “今天偶然间又翻出了日记本，\n   打算再多写一点。”",
            ">* “过去几年，过的都挺不错的。\n   我上了学，学到了很多知识。”",
            ">* “我学会了加减乘除，\n   学会了打字上网。”",
         ...
         [
            ">{#p/human}* （你翻到了第九页...\n   看起来，又过去了两天。）",
            ">{#p/asriel1}{#v/1}* “Azzy的日记，克历510年9月”",
            ">* “昨天，我见到了真正的人类。\n   那人类的飞船一头撞到了\n   我家附近的垃圾站。”",
            ">* “我将其从废墟中拉了出来，\n   那人类对我道了谢。”",
            ">* “我都没想到有一天\n   居然真的见到了人类。”",
            ">* “而且，人类{#p/basic}闂彞{#p/asriel1}{#v/1}瓠{#p/basic}監哈哈哈azzy\n   你真是个大hún求掓{#p/asriel1}{#v/1}銊簦{#p/basic}燹{#p/asriel1}{#v/1}瀲{#p/basic}潏{#p/asriel1}{#v/1}甕”",
            ">* “好，现在我躲到被窝里\n   $(name)应该没法再乱写乱画了。”",
            ">* “有时，$(name)会稍微有点淘气，\n   不过我不介意。”",
            ">* “妈妈让$(name)进入战斗，\n   发现$(name)的心心是红色的，\n   方向也是反的。”",
            ">* “多个能每天陪我聊天的伙伴\n   真是太棒了。”"
      ...
      exitfail1: (lateleave: boolean, sleep: boolean) =>
         world.postnoot
            ...
            : [
               sleep
                  ? ">{#p/basic}* 当你在Toriel的家里睡下后，\n  她随即摧毁了离开外域\n  唯一的出口。"
                  : ">{#p/basic}* 在你回到Toriel家后，\n  她随即摧毁了离开外域\n  唯一的出口。",
               ...(outlandsKills() > 10
                  ? [
                     ">* 日子一天天过去，\n  她很快就发现\n  许多怪物都是因你而死。",
                     ">* 她彻底陷入了绝望。\n  万念俱灰，最后...",
         ...
         w_toriel_toriel: () => [
            ...
            toriSV()
               ? SAVE.data.n.plot < 17.001
                  ? ">{#p/basic}* 听起来Toriel在哭..."
                  : ">{#p/basic}* 听起来Toriel睡着了..."
               : ">{#p/basic}* 听起来Toriel在写东西..."
         ],
         w_tt_bed: () =>
            SAVE.data.b.svr
            ...
            SAVE.data.b.svr
               ...
               : world.darker
                  ...
                  : SAVE.data.n.plot === 72
                     ...
                     : [">{#p/basic}* Toriel的专用阅读椅。", ">* 懒骨头的味道扑面而来。"],
   ...
   b_opponent_froggit: {
      act_check: [">{#p/story}* FROGGIT - 攻击4 防御5\n* 这只怪物的生活并不轻松。"],
      act_check2: [">{#p/story}* FROGGIT - 攻击4 防御5\n* 这只怪物的生活逐渐向好。"],
      act_check3: [">{#p/story}* FROGGIT - 攻击4 防御5\n* 这只怪物的生活仍不好过。"],
      act_check4: [">{#p/story}* FROGGIT - 攻击4 防御5\n* 这只怪物的生活浑浑噩噩。"],
      act_check5: [">{#p/story}* FROGGIT - 攻击4 防御5\n* 这只怪物的生活颇为惬意。"],
      act_threat: [
         ">{#p/human}* （你对Froggit发出威胁。）",
         ">{#p/basic}* 但Froggit并不明白你在说什么..."
      ],
      act_threat2: [
         ">{#p/human}* （你再一次对Froggit发出威胁。）",
         ">{#p/basic}* Froggit想起了\n  你先前的恐吓，\n  决定撒腿跑路。"
      ],
      act_compliment: [
         ">{#p/human}* （你称赞了Froggit一番。）",
         ">{#p/basic}* 但Froggit并不明白你在说什么..."
      ],
      act_flirt: [
         ">{#p/human}* （你对Froggit调情。）",
      ...
      idleText4: [">{#p/basic}{~}喵。"],
      mercyStatus: [">{#p/story}* Froggit似乎不愿意和你战斗了。"],
      name: "* Froggit",
      meanText: [">{#p/basic}{~}（缩缩，\n抖抖。）\n呱呱.."],
      niceText: [">{#p/basic}{~}（脸微微\n泛红。）\n呱呱.."],
      perilStatus: [">{#p/story}* Froggit正试图逃跑。"],
      status1: [">{#p/story}* Froggit蹦了过来！"],
      status2: [">{#p/story}* 战场弥漫着曜菊的芬芳。"],
      status3: [">{#p/story}* Froggit看起来并不知道\n  自己为什么在这里。"],
      status4: [">{#p/story}* Froggit跳来跳去。"]
   },
   b_opponent_whimsun: {
   ...
   b_opponent_mushy: {
      act_challenge: [
         ">{#p/human}* （你向Mushy发起决斗挑战。）",
         ">{#p/story}* Mushy本回合的攻击速度加快！"
      ],
      act_check: [">{#p/story}* MUSHY - 攻击6 防御6\n* 是星际牛仔的忠实粉丝。\n  也是一位枪术高手。"],
      act_check2: [">{#p/story}* MUSHY - 攻击6 防御6\n* 是星际牛仔的忠实粉丝。\n  包括性感牛仔。"],
      act_check3: [">{#p/story}* MUSHY - 攻击6 防御6\n* 在拼尽全力之后，\n  这个枪手对你的印象\n  已是刻骨铭心。"],
      act_flirt: [">{#p/human}* （你向Mushy调情。）"],
      act_taunt: [">{#p/human}* （你对着Mushy一通嘲讽。）"],
      challengeStatus: [">{#p/story}* Mushy正等着你的下个挑战。"],
      challengeTalk1: [">{#p/basic}{~}让我\n见识一下\n你有什么\n能耐。"],
      challengeTalk2: [">{#p/basic}{~}是想着\n要把我\n打败吗？"],
      flirtStatus1: [">{#p/story}* Mushy既困惑又兴奋。"],
      flirtTalk1: [">{#p/basic}{~}嘿，\n别-别闹了！"],
      hurtStatus: [">{#p/story}* Mushy准备拼死一搏。"],
      idleTalk1: [">{#p/basic}{~}砰！\n砰！\n砰！"],
      idleTalk2: [">{#p/basic}{~}上马！"],
      idleTalk3: [">{#p/basic}{~}不足为惧。"],
      name: "* Mushy",
      spareStatus: [">{#p/story}* Mushy浅鞠一躬，以表敬意。"],
      status1: [">{#p/story}* 刹那间，Mushy已至！"],
      status2: [">{#p/story}* Mushy稍微调整了一下姿势。"],
      status3: [">{#p/story}* Mushy正为这场盛大的对决做准备。"],
      status4: [">{#p/story}* Mushy伸手向腰，直奔枪套。"],
      status5: [">{#p/story}* 闻起来像雨后泥土的气息。"],
      tauntStatus1: [">{#p/story}* Mushy假装没听到你的嘲讽。"],
      tauntTalk1: [">{#p/basic}{~}雕虫小技，\n能奈我何？"]
   },
   b_opponent_napstablook: {
      act_check: [">{#p/story}* NAPSTABLOOK - 攻击10 防御255\n* 这位是Napstablook。"],
      act_check2: [
         ">{#p/story}* NAPSTABLOOK - 攻击10 防御255\n* 看起来它完全不想呆在这里。"
      ],
      act_check3: [">{#p/story}* NAPSTABLOOK - 攻击10 防御255\n* 已经有许久没像这样感到希望了..."],
      act_check4: [">{#p/story}* NAPSTABLOOK - 攻击10 防御255\n* 浪漫的紧张气氛空前高涨。"],
      awkwardTalk: [">{#p/napstablook}{~}呃..."],
      checkTalk: [">{#p/napstablook}{~}是我..."],
      cheer0: [">{#p/human}* （你试图安慰Napstablook。）"],
      cheer1: [">{#p/human}* （你给Napstablook一个\n  耐心的微笑。）"],
      cheer2: [">{#p/human}* （你给Napstablook讲了一个\n  小小的笑话。）"],
      cheer3: [">{#p/human}* （你赞美Napstablook的大礼帽。）"],
      ...
      flirt1: [">{#p/human}* （你对Napstablook调情。）"],
      flirt2: [">{#p/human}* （你向Napstablook用\n  最好的方式搭讪。）"],
      flirt3: [">{#p/human}* （你由衷地夸赞Napstablook。）"],
      ...
      sincere: [">{#p/human}* （你对Napstablook的大礼帽\n  发表了暧昧的评论。）"],
      sincereTalk: [">{#p/napstablook}{~}嘿... 谢谢"],
      status1: [">{#p/story}* Napstablook来了。"],
      status2: [">{#p/story}* Napstablook看起来好受了一点。"],
      status3: [">{#p/story}* Napstablook想给你展示些什么。"],
      status3a: [">{#p/story}* Napstablook等待着你的回应。"],
      status4: [">{#p/story}* Napstablook的眼睛闪闪发光。"],
      status5: [">{#p/story}* Napstablook显然不确定\n  该怎么应对这种情况。"],
      status5a: [">{#p/story}* Napstablook正在质疑自己的存在。"],
      status6: [">{#p/story}* Napstablook正在伺机而动。"],
      status7: [">{#p/story}* Napstablook正在等待\n  你下一步的行动。"],
      status8: [">{#p/story}* Napstablook正凝视着远方。"],
      status9: [">{#p/story}* Napstablook希望它自己不在这里。"],
      status10: [">{#p/story}* Napstablook正在尽力将你忽视。"],
      suck: [">{#p/human}* （你告诉Napstablook\n  它的帽子很难看。）"],
      threat: [">{#p/human}* （你威胁Napstablook。）"]
   },
   b_opponent_toriel: {
      spannerText: [">{#p/human}* （你把扳手丢了出去。）\n* （Toriel捡起扳手，还给了你。）"],
      spannerTalk: [">{#p/toriel}{#f/22}孩子，扔扳手\n解决不了\n任何问题。"],
      spannerTalkRepeat: [">{#p/toriel}{#f/22}..."],
      act_check: [">{#p/story}* TORIEL - 攻击80 防御80\n* 最了解你的人。"],
      act_check2: [">{#p/story}* TORIEL - 攻击80 防御80\n* 看起来有所克制。"],
      act_check3: [">{#p/story}* TORIEL - 攻击80 防御80\n* 看起来心不在焉。"],
      act_check4: [">{#p/story}* TORIEL - 攻击80 防御80\n* 只想把最好的给你。"],
      act_check5: [">{#p/story}* TORIEL - 攻击80 防御80\n* 觉得你很“天真可爱”。"],
      precrime: [">{#p/asriel2}..."],
      ...
      status1: [">{#p/story}* Toriel现在正站在你面前。"],
      status2: [">{#p/story}* Toriel准备着魔法攻击。"],
      status3: [">{#p/story}* Toriel表现得很冷漠。"],
      status4: [">{#p/story}* Toriel看穿了你。"],
      status5: [">{#p/story}* ..."],
      assistStatus: [">{#p/basic}* 肯定有其他办法的..."],
      talk1: [">{#p/human}* （你请求Toriel让你过去。）\n* （没有效果。）"],
      talk2: [">{#p/human}* （你问Toriel为什么要这么做。）\n* （她的身体轻轻颤抖了一下。）"],
      talk3: [">{#p/human}* （你求Toriel停下。）\n* （她犹豫了。）"],
      talk4: [
         ">{#p/human}* （你再次求Toriel停下。）",
         ">{#p/basic}* ...也许这么做对她来说风险太大了。"
      ],
      talk5: [">{#p/human}* （你冲Toriel大喊。）\n* （她闭上眼睛，深吸一口气。）"],
      talk6: [
         ">{#p/human}* （你再次冲Toriel大喊。）",
