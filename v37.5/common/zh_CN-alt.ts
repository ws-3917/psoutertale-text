...
export default {
   ...
   a_common: {
      bullybed: [
         ...
         [
            ">{#p/human}* （你找到了之前乘坐的飞船。）\n* （它已经彻底被毁。）",
            ">{#p/human}* （你试图寻找怪物留下的飞船。）",
            ">{#p/human}* （但似乎...\n  哪怕一艘，都没给你留下。）"
         ],
         [
            ">{#p/human}* （你去了实验室，\n  希望能找到飞船的蓝图和部件。）",
            ">{#p/human}* （蓝图还在，部件也有剩余...）",
            ">{#p/human}* （然而，此时核心能量已所剩无几。\n  无法让你发射飞船。）"
         ],
         [
            ">{#p/human}* （你试图重置。）\n* （什么都没发生。）",
            ">{#p/human}* （你再次尝试重置。）",
         ...
         [
            ">{#p/human}* （绝望之中，你拨了托丽尔的号码。）\n* （没有回应。）",
            ">{#p/human}* （你又给帕派瑞斯，安黛因打电话...）",
            ">{#p/human}* （没有回应。）"
         ],
         [
            ">{#p/human}* (...)",
            ">{#p/human}* （你已经不记得在这里度过了多久。）",
            ">{#p/human}* （几个星期？几个月？几年？）\n* （无从得知。）",
            ">{#p/human}* （你把核心的能量消耗调至最低...）",
            ">{#p/human}* （即便如此，终有一天也会用尽。）"
         ],
         [
            ">{#p/human}* （重力逐渐消失。）",
            ">{#p/human}* （温度开始下降。）",
            ">{#p/human}* （大气层即将解体。）",
            ">{#p/human}* （没有了能量，前哨站将无法生存。）"
         ],
         [
            ">{#p/human}* （不知为何，你感到平静。）",
            ">{#p/human}* （你平静地接受了自己的死亡。）",
            ">{#p/human}* （既然不可避免，那就随它去吧。）",
            ">{#p/human}* （空气即将消散。）\n* （最后一刻，你回忆起自己的旅程。）",
            ">{#p/human}* （从你离开人类世界的那一天，\n  一直到怪物重获自由的那一天。）"
         ],
         [
            ">{#p/human}* （空气彻底消失。）",
            ">{#p/human}* （你开始窒息。）",
      ...
      save1: ">{#p/human}{@fill=#f00}* （还剩下$(x)个。）",
      save2: ">{#p/human}{@fill=#f00}* （决心。）",
      save3: ">{#p/human}{@fill=#3f00ff}* （还剩下$(x)个。）",
      save4: ">{#p/human}{@fill=#3f00ff}* （决心。）",
   ...
   b_opponent_dummy: {
      act_check: [">{#p/story}* 训练人偶 - 攻击0 防御0\n* 壳中幽灵，祝君安宁。"],
      act_flirt: [
         ">{#p/human}* （你向人偶调情。）",
         ">{#p/basic}* 它的反应和你想的完全一样。",
         ">* 托丽尔强忍住不笑。"
      ],
      ...
      bored: [">{#p/basic}* 人偶厌倦了你意味不明的把戏。"],
      hugged: [">{#p/basic}* 人偶不知为何... 脸红了。"],
      name: "* 训练人偶",
      slapped: [">{#p/basic}* 突然...！"],
      status1: [">{#p/story}* 你遭遇了训练人偶。"],
      status2: [">{#p/story}* 人偶看起来有些厌倦了。"],
      status3: [">{#p/story}* 人偶看起来好像迷失了自我。"],
      status4: [">{#p/story}* 人偶差点要倒下了。"],
      talk: [">{#p/basic}{#i/20}{~}.....{}"]
   },
   b_opponent_maddummy: {
      ...
      act_check: () =>
         16 <= SAVE.data.n.kills_wastelands
            ? [">{#p/story}* 开心人偶 - 攻击0 防御0\n* 它的梦想成真啦！"]
            : [">{#p/story}* 愤怒人偶 - 攻击30 防御255\n* 免疫一切物理攻击。"],
      act_flirt: () =>
         16 <= SAVE.data.n.kills_wastelands
            ? [
               ">{#p/human}* （你向开心人偶调情。）",
               ">{#p/basic}* 它正沉浸在梦想成真的喜悦之中，\n  没听到你的话。"
            ]
            : [">{#p/human}* （你向愤怒人偶调情。）", ">* 它的反应跟你想的完全一样。"],
      act_hug: () =>
         16 <= SAVE.data.n.kills_wastelands
            ? [">{#p/human}* （你抱了抱开心人偶。）"]
            : [">{#p/human}* （你抱了抱愤怒人偶。）"],
      ...
      gladTalk1: [">{#p/basic}{~}谢啦！"],
      gladTalk2: [">{#p/basic}{~}谢谢你！"],
      gladTalk3: [">{#p/basic}{~}你真棒！"],
      gladTalk4: [">{#p/basic}{~}真不错！"],
      gladTalk5: [">{#p/basic}{~}好！"],
      gladTalk6: [">{#p/basic}{~}..."],
      hugTalk1: () =>
         16 <= SAVE.data.n.kills_wastelands
      ...
      gladStatus1: [">{#p/story}* 开心人偶很庆幸自己来了这里。"],
      gladStatus2: [">{#p/story}* 开心人偶正规划着\n  今后的美好人生。"],
      gladStatus3: [">{#p/story}* 开心人偶看起来很满足。"],
   ...
   b_opponent_moldsmal: {
      ...
      act_check0: [">{#p/asriel2}* Gelatini，没脑子的粘球。\n* 有什么好说的？"],
      act_check: [">{#p/story}* GELATINI - 攻击6 防御0\n* 典型印象：身段妖娆气质好，\n  就是没大脑..."],
      act_check2: [">{#p/story}* GELATINI - 攻击6 防御0\n* 应季的色彩令它更为迷人。"],
      act_check3: [">{#p/story}* GELATINI - 攻击6 防御0\n* 与你所喜欢的类型相同。\n* 刻板印象的那种。"],
      act_check4: [">{#p/story}* GELATINI - 攻击6 防御0\n* 这位超级模特早已辉煌不再。"],
      act_flirt: [
         ">{#p/human}* （你扭动着你的臀部。）\n* （Gelatini用扭动回应你。）",
         ">{#p/basic}* 真是有意义的交流！"
      ],
      act_imitate: [
         ">{#p/human}* （你轻轻地拍了拍Gelatini。）\n* （它的身体变色了。）",
         ">{#p/basic}* 这是Gelatini高兴时的颜色！"
      ],
      act_slap: [
         ">{#p/human}* （你使劲地给了Galatini一巴掌。）",
         ">{#p/basic}* Gelatini身体发生凹陷，\n  但不久便恢复原形。"
      ],
      act_slap2: [
         ">{#p/human}* （你用尽全身力气扇了Gelatini\n  一巴掌。）",
         ">{#p/basic}* Gelatini的根基被动摇了！"
      ],
      act_slap3: [
         ">{#p/human}* （你用尽全身力气扇了Gelatini\n  一巴掌。）",
         ">{#p/basic}* Gelatini逃离了现场！"
      ],
      idleTalk1: [">{#p/basic}{~}吐泡泡.."],
      idleTalk2: [">{#p/basic}{~}挤挤.."],
      idleTalk3: [">{#p/basic}{~}\x00*黏液声*"],
      name: "* Gelatini",
      perilStatus: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ? [">{#p/kidding}* 这可不是什么好事..."]
            : [">{#p/story}* Gelatini已经开始腐烂了。"],
      sexyChat: [">{#p/basic}{~}\x00*性感\n扭动*"],
      status1: () =>
         world.goatbro ? [">{#p/asriel2}* Gelatini把身体挺成正方形。"] : [">{#p/story}* 一对Gelatini跳了过来。"],
      status2: () =>
         world.goatbro
            ? [">{#p/asriel2}* Gelatini。"]
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? [">{#p/kidding}* 嘘... 它在思考！"]
               : [">{#p/story}* Gelatini静静地凝结着。"],
      status3: () =>
         world.goatbro ? [">{#p/asriel2}* Gelatini。"] : [">{#p/story}* Gelatini乐观地等待着。"],
      status4: () =>
         world.goatbro
            ? [">{#p/asriel2}* Gelatini。"]
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? [">{#p/kidding}* 这里一个泡泡，那里一个泡泡..."]
      ...
      status5: () =>
         world.goatbro
            ...
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? [">{#p/kidding}* 你知道，\n  Gelatini到底是用什么做的吗？"]
               : [">{#p/story}* 空气中飘来阵阵青柠果冻的清香。"],
      status6: [">{#p/story}* 现在，只剩一个了。"],
      status8: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ? [">{#p/kidding}* 只剩我们仨啦！"]
            : [">{#p/story}* 这只Gelatini只能独自吐泡泡了。"]
   },
   b_opponent_spacetop: {
      epiphany: [
      ...
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Astro Serf，宇航员，渴望引人注目。\n* 除了自己的天线，他什么都不在乎。"]
      ...
      act_compliment: [">{#p/human}* （你告诉Astro Serf说它\n  有一根很棒的天线。）"],
      ...
      createStatus1: () =>
         world.goatbro
            ...
            : [">{#p/story}* Astro Serf小心翼翼地确定着\n  你有没有看它的天线。"],
      createStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* Astro Serf."] : [">{#p/story}* Astro Serf被打动了。"],
      ...
      act_create: () =>
         [
            [">{#p/human}* （你开始设计自己的天线。）", ">{#p/basic}* 但... 怎么设计？"],
            [">{#p/human}* （你做好了天线，\n  把它戴了上去。）"],
            [
               ">{#p/human}* （你开始做另一根天线。）",
               ">{#p/basic}* Astro Serf不知道该如何应对，\n  跑掉了。"
            ]
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 离死不远了。"] : [">{#p/story}* Astro Serf's suit is loose."],
      idleTalk1: [">{#p/basic}{~}Where's YOUR antenna?"],
      idleTalk2: [">{#p/basic}{~}你的脑袋\n看起来..\n光秃秃的"],
      ...
      randStatus3: [">{#p/story}* Astro Serf在考虑配一件衣服。"],
      randStatus4: [">{#p/story}* 闻起来像锂。"],
      status1: [">{#p/story}* Astro Serf struts into view."],
      stealTalk1: [">{#p/basic}{~}I KNEW IT!!!\nTHIEF!!"],
      stealTalk2: [">{#p/basic}{~}时尚警察\n快救我\n啊！！！"],
      act_steal: () =>
   ...
   b_opponent_space: {
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 也要去见阎王了。"] : [">{#p/story}* It's disintegrating."],
      idleTalk1: [">{#p/basic}{~}I..\nI.."],
   ...
   b_party_kidd: {
      mkNobody: [">{#p/kidd}{#f/4}* 周围怎么一个人也没有，\n  是我的错觉吗..."],
      mkDeath1: [
         ">{#p/kidding}* 呃...",
         ">* 对手为啥是这样消失的呢？",
         ">* 嗯... 我们打了对手。\n  估计太害怕，就传送走了。\n* 哈哈，肯定是的。"
      ],
      mkDeath2: [">{#p/kidding}* 又消失了？", ">* 该死，为啥我没有\n  这么酷的传送器呢！？"],
      ...
      mkBully2: [">{#p/kidding}* 那位也...！", ">* 我们打得那么狠吗...？"],
      mkBully3: [">{#p/kidding}* ..."],
      mkBully1OW: [
         ">{#p/kidd}{#f/4}* 呃...",
      ...
      mkBully2OW: [">{#p/kidd}{#f/7}* 那位也...！", ">{#f/4}* 我们打得那么狠吗...？"],
      mkBully3OW: [">{#p/kidd}{#f/4}* ..."],
      mkShyrenDeath: [">{#p/kidd}{#f/4}* 嘿...", ">{#p/kidd}{#f/1}* 大家都去哪了？"],
      mkMagic1: [
         ">{#p/kidding}* 哟... 我还不会释放很酷的魔法...",
         ">{#p/kidding}* 不过，嗯... 我可以帮你疗伤！"
      ],
      mkMagic2a: [">{#p/kidding}* 治疗术！"],
      mkMagic2b: [">{#p/kidding}* 健康与你同在！"],
      mkMagic2c: [">{#p/kidding}* 看好了！"],
      mkNope: [">{#p/kidding}* 不要再让我战斗了..."],
      mkTurn1: [">{#p/kidding}* 帮帮我，我从来没战斗过！\n* 我要怎么做！？"],
      mkTurn2: [">{#p/kidding}* 呃... 帮我！"],
      mkTurn3: [">{#p/kidding}* 我... 我好像会了。"],
      mkTurnAct1: [">{#p/kidding}* 哦！哦！", ">* 我知道要怎么行动！", ">* 看好了...！"],
      mkWeaken1: [">{#p/kidding}* 真的要这么做吗...？\n* 对手好像不喜欢这样...", ">* ..."],
      mkWeaken2: [">{#p/kidding}* 这么做真的好吗...？", ">* ..."],
      ...
      mkTurnFight2a: [">{#p/kidding}* 好吧... 那我试试..."],
      mkTurnFight2b: [">{#p/kidding}* 哦，好...", ">* 那我就饶恕他们吧！"],
      mkTurnFight3a: [">* 呀哈...！"],
      mkTurnFight3b: [">* 嘿呀...！"],
      mkTurnFight3c: [">* 我打！"],
      mkTurnMercy1: [">{#p/kidding}* 仁慈？\n* 让我饶恕对手吗？", ">{#p/kidding}* 哈哈，容易！"],
   ...
   c_call_common: {
      start: ">{#s/phone}{#p/event}* 拨号中...",
      end: ">{#s/equip}{#p/event}* 滴...",
      nobody0: [">{#p/human}* （受到太多信号干扰了。）"],
      nobody1: [">{#p/human}* （没有回应。）"],
      nobody2: [">{#p/basic}* ...但是谁也没有来。"],
      nobody3: [">{#p/human}* （没有信号。）"],
      nobody4: [
