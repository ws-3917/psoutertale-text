...
export default {
   ...
   a_common: {
      bullybed: [
         ...
         [
            ">{#p/human}* （你找遍了每個角落，\n  希望能發現生命的跡象。）\n* （一無所獲。）",
            ">{#p/human}* （你找了一遍，一遍，又一遍...）",
            ">{#p/human}* （一無所獲。）"
         ],
         [
            ">{#p/human}* （你找到了之前乘坐的飛船。）\n* （它已經徹底被毀。）",
            ">{#p/human}* （你試圖尋找怪物留下的飛船。）",
            ">{#p/human}* （但似乎...\n  哪怕一艘，都沒給你留下。）"
         ],
         [
            ">{#p/human}* （你去了實驗室，\n  希望能找到飛船的藍圖和部件。）",
            ">{#p/human}* （藍圖還在，部件也有剩餘...）",
            ">{#p/human}* （然而，此時核心能量已所剩無幾。\n  無法讓你發射飛船。）"
         ],
         [
            ">{#p/human}* （你試圖重置。）\n* （什麼都沒發生。）",
            ">{#p/human}* （你再次嘗試重置。）",
         ...
         [
            ">{#p/human}* （絕望之中，你撥了Toriel的號碼。）\n* （沒有回應。）",
            ">{#p/human}* （你又給Papyrus，Undyne打電話...）",
            ">{#p/human}* （沒有回應。）"
         ],
         [
            ">{#p/human}* (...)",
            ">{#p/human}* （你已經不記得在這裡度過了多久。）",
            ">{#p/human}* （幾個星期？幾個月？幾年？）\n* （無從得知。）",
            ">{#p/human}* （你把核心的能量消耗調至最低...）",
            ">{#p/human}* （即便如此，終有一天也會用盡。）"
         ],
         [
            ">{#p/human}* （重力逐漸消失。）",
            ">{#p/human}* （溫度開始下降。）",
            ">{#p/human}* （大氣層即將解體。）",
            ">{#p/human}* （沒有了能量，前哨站將無法生存。）"
         ],
         [
            ">{#p/human}* （不知為何，你感到平靜。）",
            ">{#p/human}* （你平靜地接受了自己的死亡。）",
            ">{#p/human}* （既然不可避免，那就隨它去吧。）",
            ">{#p/human}* （空氣即將消散。）\n* （最後一刻，你回憶起自己的旅程。）",
            ">{#p/human}* （從你離開人類世界的那一天，\n  一直到怪物重獲自由的那一天。）"
         ],
         [
            ">{#p/human}* （空氣徹底消失。）",
            ">{#p/human}* （你開始窒息。）",
      ...
      lastblook1: [
         ...
         () => [">{#p/basic}* The ghost is still here.", choicer.create("* (Lay down next to it?)", "是", "否")]
      ],
      ...
      save1: ">{#p/human}{@fill=#f00}* （還剩下$(x)個。）",
      save2: ">{#p/human}{@fill=#f00}* （決心。）",
      save3: ">{#p/human}{@fill=#3f00ff}* （還剩下$(x)個。）",
      save4: ">{#p/human}{@fill=#3f00ff}* （決心。）",
   ...
   b_opponent_dummy: {
      act_check: [">{#p/story}* 訓練人偶 - 攻擊0 防禦0\n* 殼中幽靈，祝君安寧。"],
      act_flirt: [
         ">{#p/human}* （你向人偶調情。）",
         ">{#p/basic}* 它的反應和你想的完全一樣。",
         ">* Toriel強忍住不笑。"
      ],
      act_hug: [">{#p/human}* （你抱了抱人偶。）"],
      act_slap: [">{#p/human}* （你扇了人偶一巴掌。）"],
      act_talk: [
         ">{#p/human}* （你跟人偶聊了幾句。）",
         ">{#p/basic}* 它好像不怎麼健談。",
         ">* Toriel看起來很高興。"
      ],
      bored: [">{#p/basic}* 人偶厭倦了你意味不明的把戲。"],
      hugged: [">{#p/basic}* 人偶不知為何... 臉紅了。"],
      name: "* 訓練人偶",
      slapped: [">{#p/basic}* 突然...！"],
      status1: [">{#p/story}* 你遭遇了訓練人偶。"],
      status2: [">{#p/story}* 人偶看起來有些厭倦了。"],
      status3: [">{#p/story}* 人偶看起來好像迷失了自我。"],
      status4: [">{#p/story}* 人偶差點要倒下了。"],
      talk: [">{#p/basic}{#i/20}{~}.....{}"]
   },
   b_opponent_maddummy: {
      ...
      act_check: () =>
         16 <= SAVE.data.n.kills_wastelands
            ? [">{#p/story}* 開心人偶 - 攻擊0 防禦0\n* 它的夢想成真啦！"]
            : [">{#p/story}* 憤怒人偶 - 攻擊30 防禦255\n* 免疫一切物理攻擊。"],
      act_flirt: () =>
         16 <= SAVE.data.n.kills_wastelands
            ? [
               ">{#p/human}* （你向開心人偶調情。）",
               ">{#p/basic}* 它正沉浸在夢想成真的喜悅之中，\n  沒聽到你的話。"
            ]
            : [">{#p/human}* （你向憤怒人偶調情。）", ">* 它的反應跟你想的完全一樣。"],
      act_hug: () =>
         16 <= SAVE.data.n.kills_wastelands
            ? [">{#p/human}* （你抱了抱開心人偶。）"]
            : [">{#p/human}* （你抱了抱憤怒人偶。）"],
      ...
      gladTalk1: [">{#p/basic}{~}謝啦！"],
      gladTalk2: [">{#p/basic}{~}謝謝你！"],
      gladTalk3: [">{#p/basic}{~}你真棒！"],
      gladTalk4: [">{#p/basic}{~}真不錯！"],
      gladTalk5: [">{#p/basic}{~}好！"],
      gladTalk6: [">{#p/basic}{~}..."],
      hugTalk1: () =>
         16 <= SAVE.data.n.kills_wastelands
            ...
            : SAVE.data.n.state_wastelands_dummy === 4
               ? [">{#p/basic}{~}{#x4}搞什麼？\n不要啊！！"]
               : [">{#p/basic}{~}{#x3}別-別..！\n我有\n接觸\n恐懼症！"],
      hugTalk2: [">{#p/basic}{~}{#x4}快停下！"],
      hugTalk3: [">{#p/basic}{~}{#x2}少來這套！！"],
      hugTalk4: [">{#p/basic}{~}{#x3}..."],
      ...
      gladStatus1: [">{#p/story}* 開心人偶很慶幸自己來了這裡。"],
      gladStatus2: [">{#p/story}* 開心人偶正規劃著\n  今後的美好人生。"],
      gladStatus3: [">{#p/story}* 開心人偶看起來很滿足。"],
   ...
   b_opponent_moldsmal: {
      ...
      act_check0: [">{#p/asriel2}* Gelatini，沒腦子的粘球。\n* 有什麼好說的？"],
      act_check: [">{#p/story}* GELATINI - 攻擊6 防禦0\n* 典型印象：身段妖嬈氣質好，\n  就是沒大腦..."],
      act_check2: [">{#p/story}* GELATINI - 攻擊6 防禦0\n* 應季的色彩令它更為迷人。"],
      act_check3: [">{#p/story}* GELATINI - 攻擊6 防禦0\n* 與你所喜歡的類別相同。\n* 刻板印象的那種。"],
      act_check4: [">{#p/story}* GELATINI - 攻擊6 防禦0\n* 這位超級模特早已輝煌不再。"],
      act_flirt: [
         ">{#p/human}* （你扭動著你的臀部。）\n* （Gelatini用扭動回應你。）",
         ">{#p/basic}* 真是有意義的交流！"
      ],
      act_imitate: [
         ">{#p/human}* （你輕輕地拍了拍Gelatini。）\n* （它的身體變色了。）",
         ">{#p/basic}* 這是Gelatini高興時的顏色！"
      ],
      act_slap: [
         ">{#p/human}* （你使勁地給了Galatini一巴掌。）",
         ">{#p/basic}* Gelatini身體發生凹陷，\n  但不久便恢復原形。"
      ],
      act_slap2: [
         ">{#p/human}* （你用盡全身力氣扇了Gelatini\n  一巴掌。）",
         ">{#p/basic}* Gelatini的根基被動搖了！"
      ],
      act_slap3: [
         ">{#p/human}* （你用盡全身力氣扇了Gelatini\n  一巴掌。）",
         ">{#p/basic}* Gelatini逃離了現場！"
      ],
      idleTalk1: [">{#p/basic}{~}吐泡泡.."],
      idleTalk2: [">{#p/basic}{~}擠擠.."],
      idleTalk3: [">{#p/basic}{~}\x00*黏液聲*"],
      name: "* Gelatini",
      perilStatus: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ? [">{#p/kidding}* 這可不是什麼好事..."]
            : [">{#p/story}* Gelatini已經開始腐爛了。"],
      sexyChat: [">{#p/basic}{~}\x00*性感\n扭動*"],
      status1: () =>
         world.goatbro ? [">{#p/asriel2}* Gelatini把身體挺成正方形。"] : [">{#p/story}* 一對Gelatini跳了過來。"],
      status2: () =>
         world.goatbro
            ? [">{#p/asriel2}* Gelatini。"]
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? [">{#p/kidding}* 噓... 它在思考！"]
               : [">{#p/story}* Gelatini靜靜地凝結著。"],
      status3: () =>
         world.goatbro ? [">{#p/asriel2}* Gelatini。"] : [">{#p/story}* Gelatini樂觀地等待著。"],
      status4: () =>
         world.goatbro
            ? [">{#p/asriel2}* Gelatini。"]
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? [">{#p/kidding}* 這裡一個泡泡，那裡一個泡泡..."]
               : [">{#p/story}* Gelatini正在沉思。"],
      status5: () =>
         world.goatbro
            ? [">{#p/asriel2}* Gelatini。"]
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? [">{#p/kidding}* 你知道，\n  Gelatini到底是用什麼做的嗎？"]
               : [">{#p/story}* 空氣中飄來陣陣青檸果凍的清香。"],
      status6: [">{#p/story}* 現在，只剩一個了。"],
      status8: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ? [">{#p/kidding}* 只剩我們仨啦！"]
            : [">{#p/story}* 這隻Gelatini只能獨自吐泡泡了。"]
   },
   b_opponent_spacetop: {
      epiphany: [
      ...
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Astro Serf，太空人，渴望引人注目。\n* 除了自己的天線，他什麼都不在乎。"]
      ...
      act_compliment: [">{#p/human}* （你告訴Astro Serf說它\n  有一根很棒的天線。）"],
      act_flirt: [">{#p/human}* (You flirt with Astro Serf.)"],
      complimentTalk1: [">{#p/basic}{~}DUH!\nWho DOESN'T know?"],
      complimentTalk2: [">{#p/basic}{~}嫉妒了？\n真糟！"],
      createStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* Astro Serf."]
            : [">{#p/story}* Astro Serf小心翼翼地確定著\n  你有沒有看它的天線。"],
      createStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* Astro Serf."] : [">{#p/story}* Astro Serf被打動了。"],
      createTalk1: [">{#p/basic}{~}喂！！！\n我的天線\n在頭上呢。"],
      createTalk2: [">{#p/basic}{~}What?\nWhat are you doing?"],
      createTalk3: [">{#p/basic}{~}But.. it can't be..!"],
      createTalk4: [">{#p/basic}{~}Woah..\nHow did you do that??"],
      createTalk5: [">{#p/basic}{~}你在做..\n你自己的\n天線？"],
      act_create: () =>
         [
            [">{#p/human}* （你開始設計自己的天線。）", ">{#p/basic}* 但... 怎麼設計？"],
            [">{#p/human}* （你做好了天線，\n  把它戴了上去。）"],
            [
               ">{#p/human}* （你開始做另一根天線。）",
               ">{#p/basic}* Astro Serf不知道該如何應對，\n  跑掉了。"
            ]
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 離死不遠了。"] : [">{#p/story}* Astro Serf's suit is loose."],
      idleTalk1: [">{#p/basic}{~}Where's YOUR antenna?"],
      idleTalk2: [">{#p/basic}{~}你的腦袋\n看起來..\n光禿禿的"],
      ...
      randStatus3: [">{#p/story}* Astro Serf在考慮配一件衣服。"],
      randStatus4: [">{#p/story}* 聞起來像鋰。"],
      status1: [">{#p/story}* Astro Serf struts into view."],
      stealTalk1: [">{#p/basic}{~}I KNEW IT!!!\nTHIEF!!"],
      stealTalk2: [">{#p/basic}{~}時尚警察\n快救我\n啊！！！"],
      act_steal: () =>
   ...
   b_opponent_space: {
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 也要去見閻王了。"] : [">{#p/story}* It's disintegrating."],
      idleTalk1: [">{#p/basic}{~}I..\nI.."],
   ...
   b_party_kidd: {
      mkNobody: [">{#p/kidd}{#f/4}* 周圍怎麼一個人也沒有，\n  是我的錯覺嗎..."],
      mkDeath1: [
         ">{#p/kidding}* 呃...",
         ">* 對手為啥是這樣消失的呢？",
         ">* 嗯... 我們打了對手。\n  估計太害怕，就傳送走了。\n* 哈哈，肯定是的。"
      ],
      mkDeath2: [">{#p/kidding}* 又消失了？", ">* 該死，為啥我沒有\n  這麼酷的傳送器呢！？"],
      mkDeath3: [">{#p/kidding}* 消失了..."],
      mkDeath4: [">{#p/kidding}* ..."],
      mkDeath1OW: [
         ">{#p/kidd}{#f/4}* 呃...",
         ">* 對手為啥是這樣消失的呢？",
      ...
      mkBully2: [">{#p/kidding}* 那位也...！", ">* 我們打得那麼狠嗎...？"],
      mkBully3: [">{#p/kidding}* ..."],
      mkBully1OW: [
         ">{#p/kidd}{#f/4}* 呃...",
      ...
      mkBully2OW: [">{#p/kidd}{#f/7}* 那位也...！", ">{#f/4}* 我們打得那麼狠嗎...？"],
      mkBully3OW: [">{#p/kidd}{#f/4}* ..."],
      mkShyrenDeath: [">{#p/kidd}{#f/4}* 嘿...", ">{#p/kidd}{#f/1}* 大家都去哪了？"],
      mkMagic1: [
         ">{#p/kidding}* 喲... 我還不會釋放很酷的魔法...",
         ">{#p/kidding}* 不過，嗯... 我可以幫你療傷！"
      ],
      mkMagic2a: [">{#p/kidding}* 治療術！"],
      mkMagic2b: [">{#p/kidding}* 健康與你同在！"],
      mkMagic2c: [">{#p/kidding}* 看好了！"],
      mkNope: [">{#p/kidding}* 不要再讓我戰鬥了..."],
      mkTurn1: [">{#p/kidding}* 幫幫我，我從來沒戰鬥過！\n* 我要怎麼做！？"],
      mkTurn2: [">{#p/kidding}* 呃... 幫我！"],
      mkTurn3: [">{#p/kidding}* 我... 我好像會了。"],
      mkTurnAct1: [">{#p/kidding}* 喔！喔！", ">* 我知道要怎麼行動！", ">* 看好了...！"],
      mkWeaken1: [">{#p/kidding}* 真的要這麼做嗎...？\n* 對手好像不喜歡這樣...", ">* ..."],
      mkWeaken2: [">{#p/kidding}* 這麼做真的好嗎...？", ">* ..."],
      mkWeaken3a: [">{#p/kidding}* 呃..."],
      mkWeaken3b: [">{#p/kidding}* 嗯..."],
      mkWeaken3c: [">{#p/kidding}* 呃..."],
      ...
      mkTurnFight2a: [">{#p/kidding}* 好吧... 那我試試..."],
      mkTurnFight2b: [">{#p/kidding}* 喔，好...", ">* 那我就饒恕他們吧！"],
      mkTurnFight3a: [">* 呀哈...！"],
      mkTurnFight3b: [">* 嘿呀...！"],
      mkTurnFight3c: [">* 我打！"],
      mkTurnMercy1: [">{#p/kidding}* 仁慈？\n* 讓我饒恕對手嗎？", ">{#p/kidding}* 哈哈，容易！"],
   ...
   c_call_common: {
      start: ">{#s/phone}{#p/event}* 撥號中...",
      end: ">{#s/equip}{#p/event}* 滴...",
      nobody0: [">{#p/human}* （受到太多訊號幹擾了。）"],
      nobody1: [">{#p/human}* （沒有回應。）"],
      nobody2: [">{#p/basic}* ...但是誰也沒有來。"],
      nobody3: [">{#p/human}* （沒有訊號。）"],
      nobody4: [
