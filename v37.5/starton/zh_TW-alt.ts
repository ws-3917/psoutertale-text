...
export default {
   a_starton: {
      telescope1: () => [
         ...(SAVE.data.b.svr ? [] : [">{#p/basic}* 標準規格的長焦望遠鏡，皇家出品。\n* 251X年前後製成。"]),
         choicer.create("* （使用望遠鏡？）", "是", "否")
      ],
      telescopeMeetup1: [">{#p/kidd}{#f/2}* 你在看星星嗎？"],
      telescopeMeetup2: [
         ">{#p/kidd}{#f/1}* 喲... 我打賭\n  你肯定看到了很酷的東西。",
         ">{#f/7}* 上次我用望遠鏡的時候，\n  我甚至看到了一顆超新星！"
      ],
      ...
      telescopeMeetup4: [
         ">{#p/kidd}{#f/3}* 總之，我剛才給了你一張券。",
         ">{#f/1}* 希望你能看到更酷的東西！"
      ],
      telescopeMeetup5: [">{#p/kidd}{#f/1}* 我要回鎮上了！"],
      telescope2: () =>
         SAVE.data.b.svr
            ? [">{#p/asriel1}{#f/17}* 看到什麼喜歡的東西了嗎？"]
      ...
      notv: [">{#p/basic}* 沒什麼好看的。"],
      nicecreamScoreReaction1a: [">{#p/basic}* 第一次嘗試還不錯..."],
      nicecreamScoreReaction1b: [">{#p/basic}* 第一次嘗試還不錯。"],
      ...
      nicecreamScoreReaction4a: [">{#p/basic}* 看起來你真的很擅長..."],
      nicecreamScoreReaction4b: [">{#p/basic}* 看起來你真的很擅長。"],
      nicecreamScoreReaction5a: [">{#p/basic}* 你打破了你的紀錄...？"],
      nicecreamScoreReaction5b: [">{#p/basic}* 看，新紀錄！"],
      nicecreamScoreReaction6a: [">{#p/basic}* 有那麼一瞬間，我以為你打破了記錄..."],
      nicecreamScoreReaction6b: [
         ">{#p/basic}* 哇喔，你差點就破紀錄了！\n* 你能堅持下去嗎？"
      ],
      nicecreamScoreReaction7a: [">{#p/basic}* 看起來你需要一些練習..."],
      nicecreamScoreReaction7b: [">{#p/basic}* 看起來你需要一些練習。"],
      nicecreamScoreReaction8a: [">{#p/basic}* 更好了..."],
      nicecreamScoreReaction8b: [">{#p/basic}* 這才像話。"],
      nicecreamScoreReaction9a: [
         ">{#p/basic}* 你第一次嘗試就打破了紀錄...？\n* 世界上竟然..."
      ],
      nicecreamScoreReaction9b: [">{#p/basic}* 你第一次嘗試就打破了紀錄...？\n* 你真是個天才！"],
      nicecreamScoreReaction10a: [">{#p/basic}* 就第一次嘗試來說，這已經很好了..."],
      nicecreamScoreReaction10b: [">{#p/basic}* 就第一次嘗試來說，這已經很好了！"],
      nicecreamScoreReaction11a: [">{#p/basic}* 就要快了..."],
      nicecreamScoreReaction11b: [">{#p/basic}* 天哪，你幾乎快破紀錄了...\n* 你能做到的！"],
      noteleport: [">{#p/human}* （似乎是沒電了。）"],
      evac: [">{#p/human}* （你感覺周圍的怪物越來越少了。）"],
      shopclosed: [">{#p/human}* （但是沒什麼可做的了。）"],
      ...
      jukebox1x1: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* （但是你不能放你不知道的音樂。）"]
            : [">{#p/basic}* 封面中一個詭異的DJ在人群中演奏。\n* 你看不出來是什麼音樂。"],
      jukebox1x2: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* （但是你不能放你不知道的音樂。）"]
            : [">{#p/basic}* 封面中一個幽靈一樣的DJ在電腦前。\n* 你看不出來是什麼音樂。"],
      jukebox1x3: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* （但是你不能放你不知道的音樂。）"]
            : [
               ">{#p/basic}* 封面中是一隻被垃圾包圍著的小白狗。\n* 你看不出來是什麼音樂。"
            ],
      jukebox1y: [">{*}{#p/human}* （你選擇了一張光碟...）{^40}{%}"],
      jukebox2: () => [
         SAVE.data.b.svr
            ? ">{#p/human}* （聽起來像是一首正在播放的音樂。）"
            : [
               ">{#p/basic}* 現在播放的是「曲目01」",
               ">{#p/basic}* 現在播放的是「曲目02」",
               ">{#p/basic}* 現在播放的是「曲目03」"
      ...
      jukebox3a1: [">{#p/basic}{#npc/a}* 這就對了！"],
      jukebox3a2: [">{#p/basic}{#npc/a}* （我們都喜歡這種音樂。）"],
      jukebox3b: [">{#p/basic}{#npc/a}* 這音樂在舞蹈俱樂部裡面流行嗎？"],
      jukebox3c: [
         ">{#p/basic}* ...\n* ...\n* ...",
         ">{#npc/a}* 烤爾比說他曾經在哪聽過這首歌。"
      ],
      jukebox3d: [
         ">{#p/basic}{#npc/a}* 你肯定很懂音樂，孩子...",
         ">* You must be really tasty."
      ],
      shockpapyrus0a: [
         ">{#p/papyrus}{#e/papyrus/27}我克-\n這裡發生啥了？？",
         ">{#p/papyrus}{#e/papyrus/21}剛才我在陽臺，\n有個電話打過來\n叫我來這...",
         ">{#p/papyrus}{#e/papyrus/19}結果就看到你倆！？",
         ">{#p/papyrus}{#e/papyrus/14}告訴你們，我可是\n皇家衛隊的預備隊員！",
         ">{#p/papyrus}{#e/papyrus/15}不管你倆\n想幹什麼..."
      ],
      shockpapyrus0b: [
         ">{#p/papyrus}{#e/papyrus/24}...等等，這個聲音...",
         ">{#p/papyrus}{#e/papyrus/22}原來喊我來這的\n就是你啊！？"
      ],
      shockpapyrus0c: [
         ">{#p/papyrus}{#e/papyrus/20}...對！\n這就說得通了！",
         ">{#p/papyrus}{#e/papyrus/10}那...\n很高興認識你。",
         ">{#p/papyrus}{#e/papyrus/24}說實話，\n你長得有點像...",
         ">{#p/papyrus}{#e/papyrus/20}...嘿，等一下！！",
         ">{#p/papyrus}{#e/papyrus/22}你帶了個【人類】\n過來嗎！？！？",
         ">{#p/papyrus}{#e/papyrus/10}哇！！\n今天好事連連啊！！",
         ">{#p/papyrus}{#e/papyrus/20}話說回來，\n你喊我來這幹嘛呢？"
      ],
      shockpapyrus1: () =>
         [
            [
               ">{#p/asriel2}* 準備好了嗎，$(name)？",
      ...
      shockpapyrus2d: [">{#p/asriel2}* 戰鬥... 真是不二之選。", ">{#p/asriel2}* 嘻嘻嘻..."],
      sansDeath1: [">{#p/papyrus}{#e/papyrus/27}衫斯！\n你受傷了！"],
      sansDeath2: [">{#p/sans}帕派瑞斯，\n我不是讓你待在家裡嗎？", "{*}{#e/papyrus/21}{%}"],
      sansDeath3: [">{#p/sans}...別擔心，兄弟。\n這只是我最喜歡的\n雅莫萬用醬。", "{*}{#e/papyrus/26}{%}"],
      ...
      fast_food1: () => [
         SAVE.data.b.fryz
            ? ">{#p/human}{#npc}* （你拿走了烈焰烤爾比。）"
            : ">{#p/human}{#npc}* （你拿走了小漢堡。）"
      ],
      fast_food2: [">{#p/human}{#npc}* （你帶的東西太多了。）"],
      aussie: pager.create(
         0,
         () =>
            SAVE.data.n.state_starton_trashprogress < 1
               ? [
                  ...
                  ">{#f/0}* 你問我是什麼意思？",
                  ">{#f/3}* 嗯。",
                  ">{#f/2}* 你馬上就{@fill=#003cff}知道{@fill=#fff}了。"
               ]
               : [">{#p/sans}{#f/0}* 歡迎回來。", ">{#f/2}* 準備好知道等待你的\n  是什麼了嗎？"],
         () =>
            SAVE.data.n.state_starton_trashprogress < 1
               ? [">{#p/sans}{#f/0}* 來嘛，過來看看。", ">{#f/2}* 就在上面呢，小鬼頭。"]
               : [">{#p/sans}{#f/2}* 就在上面呢，小鬼頭。"],
         () =>
      ...
      trashhunt3: () => [
         ...
         ...(SAVE.storage.inventory.size < 8
            ? [">{#s/equip}{#p/human}* （你獲得了玉狗聖劍。）", ">{#p/sans}{#f/2}* 好好用它。"]
            : [
               ">{#p/human}* （你帶的東西太多了。）",
               ">{#p/sans}{#f/3}* 沒空間了，嗯？",
               ">{#p/sans}{#f/2}* 沒關係。\n* 等你有空間了，\n  就來我房間拿。"
      ...
      sanscab1: () => [
         ...(SAVE.data.b.svr ? [] : [">{#p/basic}* 信封裡有個奇怪的遙控器。"]),
         ">{#s/equip}{#p/human}* （重力轉換器遙控器被添加到了\n  你的鑰匙串上。）"
      ],
      sanscab2: () =>
         SAVE.data.b.svr
            ...
            : [">{#p/basic}* 只是個空信封。"],
      sanscab3: () => [
         ...(SAVE.data.b.svr ? [] : [">{#p/basic}* 信封裡有個奇怪的... 東西。"]),
         SAVE.storage.inventory.size < 8
            ? ">{#s/equip}{#p/human}* （你獲得了玉狗聖劍。）"
            : ">{#p/human}* （你帶的東西太多了。）"
      ],
      cream_get: [">{#p/human}* （你得到了冰意靈。）"],
      cream_deny: [">{#p/basic}* 空無一物。"],
      cream_full: [">{#p/human}* （你帶的東西太多了。）"],
      cream_get_archive: [
         ">{#p/human}* (You reach into the cart.)",
         ">{#p/human}{#s/equip}* （你得到了冰意靈。）"
      ],
      ...
      emptytable2: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* (The table strikes you as being rather lonesome.)"]
            : [">{#p/basic}* 一張孤零零的桌子。\n* 上面有毛髮的味道。"],
      balcony0: () => [">{#p/papyrus}ENJOYING THE VIEW?", choicer.create("* （你要怎麼回答？）", "是", "否")],
      balcony1: [
      ...
      beddoor1: [">{#p/basic}{#npc/a}* 如果你想訂房間，\n  你得先問我一聲。"],
      beddoor2: [">{#p/basic}{#npc/a}* 如果你還想訂房間，\n  你得先問我一聲。"],
      ...
      candy4: [">{#p/human}* （你買了一個洋梅。）"],
      candy5: [">{#p/human}* （你決定先不買。）"],
      capstation1: [
         ">{#p/human}* （你看了眼崗哨後面，\n  發現了一把鑰匙。）",
         ">{#s/equip}{#p/human}* （你把生鏽的鑰匙\n  掛到了鑰匙串上。）",
         ">* （打開「手機」來查看\n  所有獲得的鑰匙。）"
      ],
      capstation2: [">{#p/human}* （你看了眼崗哨後面。）", ">{#p/basic}* 沒有新東西。"],
      crossword0: () =>
         world.edgy
            ? [
               ">{#p/sans}* 喔，你來了。",
               ">{#p/sans}{#f/2}* 如果你喜歡上一個謎題的話，\n  估計這個也能合你胃口。"
            ]
            : [
               ">{#p/papyrus}{#f/9}人類！！",
               ">{#f/9}你已經看到\n我的謎題了。",
      ...
      crossword4a: pager.create(0, [">{#p/sans}* 嘿，你要去哪，小子？"], [">{#p/sans}* 回來。"]),
      crossword4b: pager.create(0, [">{#p/sans}* 你認真？\n* 也沒那麼難吧。"], [">{#p/sans}* 你認真？"]),
      crossword5a: [
         ">{#p/sans}* 感謝你為了安撫我兄弟\n  回答說「數獨更難」。",
         ">{#f/4}* 昨天他還試圖「破解」\n  星象圖，結果被難住了呢。"
      ],
      ...
      genotext: {
         ...
         asriel2: () =>
            [
               [">{#p/asriel2}{#f/2}* 哎，前面站著的，\n  不是偉大的帕派瑞斯嗎？"],
               [">{#p/asriel2}{#f/3}* 嗯... 再來一次吧。"]
            ][Math.min(SAVE.flag.n.killed_sans, 1)],
         asriel3: () =>
            [
               [">{#p/asriel2}{#f/1}* 咱們去做個「自我介紹」，\n  怎麼樣？"],
               [">{#p/asriel2}{#f/4}* 你知道該幹什麼。"]
            ][Math.min(SAVE.flag.n.killed_sans, 1)],
         asriel4: [">{*}{#p/asriel2}{#f/5}* 哈囉！{^5}{%}"],
         asriel5: [">{*}{#p/papyrus}{#f/1}幹啥- {%}"],
         asriel6: () =>
            [
               [
               ...
               [">{#p/asriel2}{#f/16}* 呃，好吧。\n* ...之後你來動手。"],
               [">{#p/asriel2}{#f/15}* 那麼... 前進吧？"],
               [">{#p/asriel2}{#f/15}* ..."]
            ][Math.min(SAVE.flag.n.ga_asriel6++, 3)],
         asriel9: [">{#p/asriel2}{#f/8}* 噓，等一下，\n  看看他會做些什麼。"],
         asriel10: () =>
            [
               [
                  ">{#p/asriel2}{#f/15}* 哇，\n  帕派瑞斯這麼頹廢的樣子...",
         ...
         asriel17: () =>
            [[">{#p/asriel2}{#f/16}* 天吶，$(name)...\n  有些怪物就是聽不懂話。"], [">{#p/asriel2}{#f/4}* 切。"]][
            Math.min(SAVE.flag.n.ga_asriel17++, 1)
            ],
         asriel24: () =>
            [[">{#p/asriel2}{#f/4}* 真是浪費時間。"], [">{#p/asriel2}{#f/3}* 呵呵。"]][
         ...
         asriel29: () =>
            [
               ...
               [">{#p/asriel2}{#f/13}* 哎呀，這蠢骷髏\n  又白白送死了。"],
               [
                  ">{#p/asriel2}{#f/13}* 俗話說，好鐵要經三回爐。",
                  ">{#f/16}* 但很遺憾，他一回就不行了。"
               ],
               [
                  ">{#p/asriel2}{#f/6}* 你已經殺了他四次了。",
                  ">{#f/8}* 看來你很享受這種快感啊..."
               ],
               [">{#p/asriel2}{#f/15}* 又來...？"]
         ...
         asriel30b: [
            ">{#p/asgore}{#f/1}* 你就沒有更重要的事可做嗎？",
            ">{#p/asriel2}{#f/8}* ...",
            ">{|}{#p/asgore}{#f/3}* 聽著，兒子，我只是- {%}",
            ">{#p/asriel2}{#f/7}* 我不是你兒子。\n* 我早就不是你兒子了。",
            ">{#p/asgore}{#f/2}* ...",
            ">{#p/asgore}{#f/1}* 好吧，艾斯利爾。\n* 你知不知道自己\n  正變成什麼樣？",
            ">{#f/2}* 鐵石心腸，罪不可赦...",
            ">{#p/asriel2}{#f/8}* 哼，別裝的好像\n  你很在乎我似的，爹。",
            ">{#p/asgore}{#f/5}* ...",
            ">{#p/asriel2}{#f/9}* 不好意思，\n  剛不該叫你「爹」的，\n  艾斯戈爾。",
            ">{#f/1}* 真是抱歉。",
            ">{#p/asgore}{#f/3}* ...\n* 開玩笑吧...",
         ...
         asriel30c: [">{*}{#p/asgore}{#f/8}* 艾斯利爾，求你別走！\n* 我只是想幫你！{^999}"],
         asriel30d: () =>
            [
               [">{#p/asriel2}{#f/3}* 做好準備，$(name)。", ">{#f/4}* 這兒可是安黛因的地盤。"],
               [">{#p/asriel2}{#f/4}* 帶路吧。"]
         ...
         papyrusSolo1a: [
            ...
            ">{#f/5}應該是的吧？",
            ">{#f/32}捏...\n安黛因總算會...",
            ">{#p/papyrus}{#f/31}我能加入皇家衛隊了...",
            ">{#f/5}你會以我為榮的吧？",
            ">{#p/asriel2}{#f/3}* 你騙不了自己的，帕派瑞斯。\n* 他已經死了。",
            ">{|}{#p/papyrus}{#f/5}可是- {%}",
            ">{#p/asriel2}{#f/3}* 夠了。\n* 你再怎麼使勁呼喚，\n  他也聽不見的。",
            ">{#p/papyrus}{#f/6}不會的...\n衫斯他...",
            ">{#f/31}他向我承諾過的...",
         ...
         papyrusSolo2a: [
            ...
            ">{#f/7}我們的王子竟然\n殺了我兄弟，\n真是難以置信！",
            ">{|}{#p/asriel2}{#f/8}* 其實你才是我們原本想- {%}",
            ">{#p/papyrus}{#f/7}真是夠了！！",
            ">{#f/7}你出賣集體，背叛同胞！",
            ">{#f/7}為了啥呢！？",
            ">{#f/7}就為了取悅自己嗎？",
            ">{#p/asriel2}{#f/16}* 對啊，帕派瑞斯。\n* 就是因為這麼做很爽。",
            ">{#p/papyrus}{#f/7}扯淡！！！",
            ">{#p/papyrus}{#f/4}還有你，人類...",
            ">{#f/7}別以為我不知道\n事態會怎麼發展。",
            ">{#f/7}顯而易見，你才是主謀。",
            ">{#p/asriel2}{#f/8}* 你真有眼力。",
            ">{#f/7}* 眼下我們是不是該\n  就地投降才好呢？",
            ">{#p/papyrus}{#f/31}...",
            ">{#p/asriel2}{#f/4}* 先說明了，你這股努力的勁兒\n  確實令我佩服。",
            ">{#f/3}* 但我們自有打算。",
            ">{#p/papyrus}{#f/4}你要知道，安黛因可能\n正盯著我們呢。",
            ">{#p/asriel2}{#f/3}* 你想說什麼？",
            ">{#f/4}* ...告訴你，帕派瑞斯，\n  你和其他人做什麼，\n  跟我們都毫無關係。",
            ">{#f/1}* 只要在一起，\n  誰都無法把我們分開。",
            ">{#p/papyrus}{#f/7}...我呸！！"
         ],
         papyrusSolo3: [">{#p/asriel2}{#f/3}* 哈囉！"],
         papyrusSolo3a: () => [
            ">{#p/papyrus}{#f/31}你知道嗎...",
            ">{#f/31}我偶然聽到艾菲斯博士\n自言自語...",
            ">{#f/5}從她的話中我聽到個詞，\n好像是「時間回溯」？",
            ">{|}{#f/32}{#x1}我不確定，但好像你們- {%}",
            ">{#p/asriel2}{#f/6}* 沒門。",
            ">{|}{#p/papyrus}{#f/6}但她說了你們能- {%}",
            ...(SAVE.flag.n.genocide_milestone < 5
               ? [">{#p/asriel2}{#f/6}* 沒門。"]
               : SAVE.flag.n.genocide_milestone < 6
                  ? [">{#p/asriel2}{#f/6}* 沒門，不過我要是那麼做的話\n  她會很高興的。"]
                  : [">{#p/asriel2}{#f/6}* 沒門，反正她最後\n  也要跟著去見閻王。"]),
         ...
         papyrusSolo4a: [
            ...
            ">{#f/5}一個有著這般\n純潔心靈的怪物...",
            ">{#f/31}...怎麼會\n徹底墮入黑暗呢？",
            ">{#p/asriel2}{#f/1}* 你真想知道嗎？",
            ">{#p/papyrus}{#f/3}...",
            ">{#f/3}對...",
            ">{#p/asriel2}{#f/10}* 你確實是真心想知道嗎？",
            ">{#p/papyrus}{#f/31}對。",
            ">{#p/asriel2}{#f/3}* 說大點聲。",
            ">{#p/papyrus}{#f/5}對！",
            ">{#p/asriel2}{#f/1}* 對我說，洋求我\n  把梅說的都告訴你。",
            ">{#p/papyrus}{#f/7}好！洋求你把梅說的\n都告訴我吧！該死！",
            ">{#p/asriel2}{#f/1}* 嘻嘻嘻...",
            ">{#f/1}* 那好，就讓我來告訴你吧。",
            ">{#f/15}* 其實答案很簡單...",
            ">{#p/papyrus}{#f/4}我的天哪，快說吧..."
         ],
         papyrusSolo4b: [
         ...
         papyrusSolo4d: [
            ...
            ">{#f/7}那個滿嘴謊話的，還是你。",
            ">{#f/9}但是我，帕派瑞斯...",
            ">{#f/9}總算認清了{@fill=#f00}真相{@fill=#fff}。",
            ">{#p/asriel2}{#f/13}* 喔？\n* 真相是什麼呢？"
         ],
         papyrusSolo4e: [">{#p/papyrus}{#f/34}你才不是{@fill=#f00}艾斯利爾{@fill=#fff}。"],
         papyrusSolo4f: [
            ">{#f/5}{@fill=#f00}艾斯利爾{@fill=#fff}絕不可能\n幹出這種事！",
            ">{#f/31}因為，{@fill=#f00}艾斯利爾{@fill=#fff}心地善良，",
            ">{#f/5}信賴同胞...",
            ">{#f/31}比誰都相信人類！",
            ">{#f/4}而你呢...",
            ">{#f/7}你不過是個為了\n一己私慾利用人類的\n卑鄙小人！",
      ...
      innkeep1a: pager.create(
         0,
         () => [
            ">{#p/basic}{#npc/a}* 歡迎來到星光旅館！\n* 星港的一流旅館！",
            ">* 每住宿一晚花費60G。",
            choicer.create("* （訂一間房嗎？）", "訂", "不訂")
         ],
         () => [
            ">{#p/basic}{#npc/a}* 改變主意了嗎？",
            ">* 記住了，一個晚上60G。",
            choicer.create("* （訂一間房嗎？）", "訂", "不訂")
         ]
      ),
      innkeep1b: pager.create(
         ...
         () => [">{#p/basic}{#npc/a}* 改變主意了嗎？", choicer.create("* （再訂一間房嗎？）", "訂", "不訂")]
      ),
      ...
      innkeep2b: [">{#p/basic}{#npc/a}* 這是你的房間鑰匙。\n* 小心別著涼！"],
      ...
      kidd1: pager.create(
         ...
         [">{#p/kidd}{#f/1}* 喲，近來可好？"],
         [">{#p/kidd}{#f/1}* 嘿，嘿！"],
         [">{#p/kidd}{#f/1}* 很高興見到你，哈哈。"],
         [">{#p/kidd}{#f/1}* 哇，老兄，怎麼了嗎？"]
      ),
      kidd2: pager.create(
         0,
         () =>
            game.room === 's_town1' // NO-TRANSLATE
               ...
               : [
                  ">{#p/kidd}{#f/7}* 等下，你也讀書的嗎！？",
                  ">{#p/kidd}{#f/1}* 那個圖書倌教會了我所有\n  關於怪物歷史的知識！",
                  ">{#p/kidd}{#f/3}* 我無法想像在一顆星球上\n  生活會怎麼樣..."
               ],
         () =>
            game.room === 's_town1' // NO-TRANSLATE

               ? [">{#p/kidd}{#f/1}* 我尋思著那個矮個子骷髏\n  有沒有成年。"]
               : [">{#p/kidd}{#f/3}* 你有在星球上生活過嗎？"]
      ),
      marriage1: [
         ">{#p/basic}* 什麼味道？\n* （我怎麼沒聞到？）",
         ">* 如果你是這個味道...\n* （...證明你的氣味！）"
      ...
      maze2a: [
         ">{#x4}{#f/9}從來沒有一個工匠\n做的陷阱可以跟我的\n相提並論！",
         ">{#f/0}可以讓人無法抗拒！",
         ">{#x1}{#p/sans}{#f/2}* 也許你才是那個讓人\n  無法抗拒的人。",
         ">{#p/papyrus}{#f/1}真的嗎！？"
      ],
      maze2b: [
         ">{#x4}{#f/9}沒有人類能解開由\n偉大的帕派瑞斯\n所製作的謎題！",
         ">{#x1}{#p/sans}{#f/4}* 也沒人有機會去解，兄弟。",
         ">{#p/papyrus}{#x3}{#f/7}呃啊，這不是重點！！"
      ],
      maze3: [">{#x1}{#f/0}不論如何，\n我把這個謎題叫做..."],
      maze3a: [
         ">「火焰之牆」！！",
         ">{#p/sans}* 你直接叫它「火牆」\n  不就行了嗎？\n* 這樣多省事。",
         ">{#p/papyrus}{#f/4}艾菲斯博士會覺得\n我用錯詞了的。",
         ">{#p/sans}* 我不太確定，兄弟。\n  她真的很喜歡那種東西。\n  實際上...",
         ">{#f/2}* 這裡畢竟是個\n  {@fill=#ff0}熱火{@fill=#fff}朝天的地方。"
      ],
      maze4: [">{#p/papyrus}{#x3}{#f/7}別說了，衫斯！！"],
      maze5: () =>
         world.edgy
            ? [
               ">{#p/sans}{#f/0}* 這是「火牆」。",
               ...
               ">{#p/sans}* 到達對面，你就過關了。",
               ">{#p/sans}* 很簡單，對吧？",
               ">{#p/sans}{#f/3}* 不過，我之前親自嘗試過\n  這個謎題，只能說...",
               ">{#p/sans}{#f/2}* 它可沒你想得那麼簡單。"
            ]
            : [
               ">{#p/papyrus}...總之，\n這個謎題背後的想法\n其實非常簡單。",
               ">因為你應該做的...",
      ...
      maze6: pager.create(
         ...
         () =>
            world.edgy
               ...
               : [">{#p/papyrus}{#x2}{#f/7}你往哪裡走呢！？"],
         () => (world.edgy ? [">{#p/sans}{#f/0}* 真要走？"] : [">{#p/papyrus}{#x2}{#f/7}快回來！！"])
      ),
      maze7: [
         [
            ">{#p/papyrus}你是怕火嗎？？",
      ...
      nicecreamSc3: () => [
         ">{#p/basic}* 冰意靈！\n* 能點燃你內心的冰凍甜品！",
         SAVE.data.b.s_state_million ? ">* For you, 6G!" : ">* 現在只賣12G。"
      ],
      ...
      nicecreamFree1: [">{#p/basic}* 告訴你一個好訊息，\n  第一根棒冰，免費送你。"],
      nicecreamFree2: [">{#p/basic}* 希望你喜歡..."],
      nicecreamReturnWithGoods: [">{#p/basic}* 沒關係，\n  你隨時都可以回來買。"],
      nicecreamReturnWithNeeds: [">{#p/basic}* 喔，沒關係的。", ">* 晚點再來啊，孩子！"],
      nicecreamPurchase: [">{#p/basic}* 給你！\n* 祝你有個超級棒的一天！"],
      nicecreamGet: [">{#s/equip}{#p/human}* （你得到了冰意靈。）"],
      nicecreamK1a: [">{#p/kidd}{#f/1}* 喲，可以給我來一根\n  冰意靈嗎？"],
      nicecreamK1b: [">{#p/basic}* 當然沒問題，孩子。\n* 只要你有錢的話，"],
      nicecreamK1c: [">{#p/kidd}{#f/2}* （噓，把這個給他。）"],
      nicecreamK1d: [
         ">{#p/kidd}{#f/7}* Yo, they got free Ice Dreams here!?",
         ">{#p/kidd}{#f/1}* Get me one too!"
      ],
      nicecreamK2: [">{#p/basic}* 你... 你是從哪裡\n  拿到這個的？"],
      nicecreamK3a: [">* 沒-沒問題，孩子...\n  給你！"],
      nicecreamK3b: [
         ">{#s/equip}{#p/human}* （你把冰意靈遞給了怪物小孩。）",
         ">{#p/kidd}{#f/7}* 太棒了！！！"
      ],
      ...
      npcinter: {
         ...
         s_genokid: pager.create(
            ...
            () =>
               world.genocide
                  ? [
                     ">{#p/kidd}{#f/3}{#npc/a}* 剛才，有個小孩走過來\n  往我腦袋裡插了什麼東西。",
                     ">{#f/3}* 之後，他就去鑄廠了，\n  說要去「增強訊號」。",
                     ">{#f/4}* ...有些小孩真是奇怪。"
                  ]
                  : [
                     ">{#p/kidd}{#f/3}{#npc/a}* 喲，大家都去逃難了。",
                     ">{#f/3}* 我說，成年人有時候\n  就是這麼蠢，哈哈...",
                     ">{#f/1}* 他們難道不知道\n  安黛因會保護我們嗎！？"
                  ],
            () =>
               world.genocide
                  ? [">{#p/kidd}{#f/7}{#npc/a}* 不過，你可不奇怪，\n  而且長得超酷的！"]
                  : [">{#p/kidd}{#f/1}{#npc/a}* 安黛因就是我們的堅實後盾！"]
         ),
         ...
         l_cupjake: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                     ">{#p/basic}{#npc/a}* 這裡有一本{@fill=#f00}奇怪的書{@fill=#fff}，\n  它會隨機出現和消失...",
                     ">* 但那位可愛的女士\n  似乎總是妨礙我去拿！",
                     ">* 你知道該怎麼樣\n  才能把她嚇跑嗎？"
                  ],
            () =>
               ...
               SAVE.data.n.plot === 72
                  ...
                  : roomKills().s_greater > 0
                     ...
                     : 30 <= SAVE.data.n.plot
                        ...
                        : [
                           [">{#p/basic}{#npc/a}* 對那狗狗來說挺糟糕吧，嗯？"],
                           [">{#p/basic}{#npc/a}* 對那狗狗來說很糟糕吧，嗯？"],
      ...
      objinter: {
         ...
         ctower1: () =>
            SAVE.data.b.s_state_mathpass
               ...
               : [">{#p/basic}* 不能使用了。"],
         microwave0: [">{#p/human}* （你看了看微波爐的後面...）", ">{#p/basic}* 沒什麼有用的東西。"],
         microwave1: () =>
            SAVE.data.b.svr
               ? [
                  ">{#p/human}* （你看了看微波爐的後面...）",
                  ">{#s/equip}{#p/human}* （你按下了開關。）"
               ]
               : [
                  ">{#p/human}* （你看了看微波爐的後面...）",
                  ">{#p/basic}* 這裡有個開關...",
         ...
         microwave2: () =>
            SAVE.data.b.svr
               ...
               : [">{#p/human}* （你看了看微波爐的後面...）", ">{#p/basic}* 沒有新東西。"],
         microwave3: () =>
            SAVE.data.b.svr
         ...
         microwave4: () => [
            ">{#p/basic}* 它似乎在投射某種重力場。",
            ...(SAVE.data.b.oops ? [">{#p/basic}* 我有點好奇... \n  這附近有沒有開關什麼的..."] : [])
         ],
         papmail1: () =>
            SAVE.data.b.svr
         ...
         papmail2: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [">{#p/human}* （你往裡看了一眼...）", ">{#p/basic}* 空的。"]
         ),
         papmail3: [">{#p/human}* （你決定不再看了。）"],
         puzzlechip: () =>
            SAVE.data.b.svr
               ? [">{#p/human}* (But you already completed this puzzle beforehand.)"]
               : [">{#p/basic}* The terminal is now in an unlocked state."],
         spagtable0: [">{#p/basic}* 一個沒用過的盤子。"],
         spagtable1: [
            ">{#p/human}* （你凝視著令人垂涎的\n  義大利麵。）",
            ">{#p/human}* （似乎是夠不到它了。）"
         ],
         spagtable2: [">{#p/human}* （你得到了義大利麵。）"],
         spagtable2b: [">{#p/human}* （你帶的東西太多，裝不下它了。）"],
         spagtable3: () =>
            SAVE.data.b.svr
      ...
      papcouch2: [">{#p/human}* （你決定什麼也不拿。）"],
      papcouch3: [">{#p/human}* （你找到了10G。）"],
      papcouch3a: [
         ">{#p/papyrus}{#f/1}你在幫我們\n清理沙發！？",
         ">{#p/papyrus}{#f/5}你真的徹頭徹尾的\n是個善良的人...",
         ">{#p/papyrus}{#f/6}多麼慷慨！！！"
      ],
      paproom1: [
         ">{#p/papyrus}{#f/6}WHAT!?\nHOW DID YOU...",
      ...
      papdate3a: [">{#p/papyrus}{#f/6}哇！當個好主人\n可真是個體力活！"],
      papdate3b: [
         ">{#p/papyrus}{#f/5}哇，我感覺不到\n我的腿了...",
         ">{#f/0}那肯定證明了\n我是個好主人！！！"
      ],
      papdate4: pager.create(
         ...
         () => [">{#p/papyrus}READY?", choicer.create("* （你要怎麼回答？）", "是", "否")]
      ),
      papdate4a: [">{#p/papyrus}好，我們進去吧！"],
      ...
      papdate5: pager.create(
         ...
         () => [">{#p/papyrus}{#f/6}準備開始了嗎？", choicer.create("* （你要怎麼回答？）", "開始吧", "再等等")]
      ),
      papdate5a: () => [
         SAVE.data.b.flirt_papyrus
            ? ">{#p/papyrus}好！！！\n約會開始！！！"
      ...
      papdate7: () => [
         ">{#p/papyrus}{#f/10}我們！！",
         SAVE.data.b.flirt_papyrus ? ">{#f/20}開始約會了！！" : ">{#f/20}開始消遣了！！",
         ">{#f/24}我實際上之前\n從來沒做過\n這種事。",
         ">{#f/10}但別擔心！！！",
         ">{#f/20}我的（個人）詞典裡\n可是有「準備」\n這個詞的！"
      ],
      ...
      papdate15a1: [">{#f/24}我想，這意味著\n是時候開始\n第三步了..."],
      papdate15b: [">{#p/papyrus}{#f/21}喔...", ">{#f/27}還-還好，\n上面只說了\n要邀請。"],
      papdate15c: [">{#f/24}那無論如何，\n是時候開始\n第三步了..."],
      ...
      papdate21: [">{#p/papyrus}{#f/15}你覺得我的\n秘密穿搭\n怎麼樣？"],
      papdate22: () => [choicer.create("* （你要怎麼回答？）", "很棒", "很差勁")],
      papdate23a: [">{#p/papyrus}{#f/13}不！！！", ">{#f/13}發自內心的\n讚美...！"],
      papdate23b: [">{#p/papyrus}{#f/13}不！！！", ">{#f/13}雖然是批評，\n但是好誠實...！"],
      papdate24: [
         ">{#p/papyrus}{#f/24}然而...",
      ...
      papdate29: [">{#p/papyrus}{#f/20}你知道【這】是\n什麼嗎？"],
      ...
      papdate33a: () => [
         ...
         ...(SAVE.data.n.state_papyrus_spaghet === 1
            ? [">{#p/basic}* 帕派瑞斯看起來也吃得很開心。"]
            : [])
      ],
      papdate34a: () => [
         ">{#p/papyrus}{#f/10}多麼充滿激情的\n表達！！",
         SAVE.data.b.flirt_papyrus
            ? ">{#f/12}你肯定真心愛著\n我的廚藝！"
            : ">{#f/12}你肯定真心喜歡\n我的廚藝！",
         ...[
      ...
      papdate38: () => [
         ">{#p/papyrus}{@random=1.1/1.1}人類。\n一切都清晰明了了。",
         SAVE.data.b.flirt_papyrus
            ? ">{@random=1.1/1.1}你已經痴狂地\n愛上了我。"
            : ">{@random=1.1/1.1}你已經完全\n被我迷住了。",
         ">{@random=1.1/1.1}你做的每一件事。\n你說的每一個字。",
         ">{@random=1.1/1.1}一切的一切\n都是為了我。",
         ">{@random=1.1/1.1}人類。\n我也想讓你，\n感到快樂。",
         ">{@random=1.1/1.1}現在輪到我\n來表達我的\n感情了...",
         ">{@random=1.1/1.1}輪到我來告訴你\n我的真心話了。"
      ],
      papdate39: () =>
         SAVE.data.b.flirt_papyrus
            ? [
      ...
      pappuzzle2a: [">而且不用我的幫忙\n你就解開了！！！"],
      pappuzzle2b: [">而且根本沒用我\n幫你太多\n你就解開了！"],
      pappuzzle2c: [">雖然需要一點鼓勵，\n但你真的做到了！"],
      pappuzzle2d: [
         ">你一定跟我一樣\n很在意謎題吧！",
         ">那麼，我覺得你肯定\n會愛上下個謎題的！",
         ">可能對你而言\n都算太簡單了！！",
      ...
      papsink2: [">{#p/papyrus}{#f/8}不！是那條狗！"],
      papsink3: [">{#p/papyrus}{#f/31}喔，好可憐\n好可憐的小狗狗...", ">{#f/9}給你，嘗嘗我的\n特殊攻擊！"],
      papsink4: [">{#p/papyrus}哇！！！\n它喜歡誒！！！"],
      papsink5: [">{#p/papyrus}{#f/7}衫斯！", ">別再用配樂\n打擾我的生活了！！"],
      papsink6: [">{#p/papyrus}{#f/4}現在那條狗\n在我的攻擊下\n消失了。", ">喔好吧..."],
      papsolu1: [
         ">{#p/papyrus}看起來你需要\n一個提示。",
         ">{#f/4}嗯...",
         ">{#f/0}喏，我會注意\n這幾條電路的。",
      ...
      papsolu4: [">{#p/papyrus}{#f/4}你忘記我給你的\n解法了嗎...？"],
      ...
      papyrus6x1: [">{#p/papyrus}{#f/5}人-人類？\n你就是那個人類嗎...？"],
      papyrus6x2: [
         ">{#p/papyrus}{#e/papyrus/20}我的天哪！\n我終於見到你啦！",
         ">{#p/papyrus}{#f/0}自打聽說你來了星港，\n我就夢想著能見你一面！",
         ">{#p/papyrus}{#f/4}...你問，\n為啥衫斯沒跟我\n在一起？",
         ">{#p/papyrus}{#f/6}唉，我有理由懷疑...",
         ">{#p/papyrus}{#f/5}...他好像\n刻意想讓我躲著你。",
         ">{#p/papyrus}{#f/7}真不愧是他！！！",
         ">{#p/papyrus}{#f/0}但是，\n只要你不說，我不說~",
         ">{#p/papyrus}{#f/9}那懶骨頭\n就甭想知道【一丁點】\n咱們的「地下情誼」！"
      ...
      papyrus6x3: [
         ">{#p/papyrus}{#f/5}不過，我現在得走了。\n絕不能讓他發現\n我偷偷溜出來了。",
         ">{|}{#p/papyrus}{#f/9}待會見，人-{%}"
      ],
      papyrus6x4: [">{#p/without}* ...帕派瑞斯？"],
      papyrus6: () => [
         ">{#p/papyrus}{#f/9}人類！！",
      ...
      papyrusFinal4: (b: boolean) =>
         world.edgy || world.killed0
            ? [
               ">{#p/papyrus}{#f/0}哇！\n你做到了！",
               ">{#p/papyrus}{#f/5}沒有動用任何暴力！",
               ">{#p/papyrus}{#f/6}其實，\n剛才我有點害怕...",
               ">{#p/papyrus}{#f/0}不過沒關係！\n你已經重回正軌啦！",
               ">{#p/papyrus}{#f/8}我為你驕傲，人類！",
               ">{#p/papyrus}{#f/4}...等等，我是不是\n該抓你來著？",
               ">{#p/papyrus}{#f/0}嗨，隨它去吧。",
               ">{#p/papyrus}{#f/0}只要你能成為最棒的自己，\n我就滿足啦。",
               ">{#p/papyrus}{#f/5}過去的事，\n就讓它成為{@fill=#ff0}骨{@fill=#fff}事吧，\n好嗎？",
               ">{#p/papyrus}{#f/9}我還要告訴你\n怎麼離開這裡！"
            ]
            : [
               ">{#p/papyrus}{#f/5}扭嗚呼呼...",
               ...(b
      ...
      papyrusFinal4f1: [">{#f/9}歡迎過來\n跟我一起玩！！！"],
      papyrusFinal4f2: [">{#f/9}歡迎過來\n跟我約會！！！"],
      papyrusFinal4f3: [">{#f/9}歡迎過來\n跟我打個招呼！！！"],
      papyrusFinal4g: [">捏嘿嘿嘿\n嘿嘿嘿！！！"],
      papyrusFinal5: [
         ">{#p/papyrus}{#f/5}喔，那個人類\n到哪裡去了呢...",
         ">{#f/4}...\n等等。",
         ">{#f/1}就在我面前！！！",
         ">{#f/0}你好啊！\n我還在擔心你\n是不是迷路了呢！",
         ">看到你了，我就\n可以鬆口氣了...",
      ...
      papyrusFinal8a: [">{#p/papyrus}{#f/0}那麼，\n咱們開始吧！"],
      puzzle3: () => [
         ">{#p/human}* （你激活了終端。）",
         ">{#p/basic}* 屏幕上顯示著一條歷史修改記錄。",
         world.edgy
            ? ">* 「最新圖案修改者：艾菲斯」"
            : ">* 「最新圖案修改者：\n   酷炫骷髏95」",
         ...(!world.goatbro || SAVE.flag.n.genocide_milestone < 5 || SAVE.flag.n.ga_asrielAlphysCom1++ > 0
            ? []
            : [">{#p/asriel2}{#f/13}* 她真是沒完沒了地為難我們..."]),
         ">{#p/basic}* 「要查看圖案嗎？」",
      ...
      robot2: () => [
         ...
         ...(world.goatbro && SAVE.flag.n.ga_asriel98++ < 1
            ? [
               ">{#p/asriel2}{#f/9}* 嘿，真是個\n  可愛又天真的小東西。",
               ">{#p/asriel2}{#f/13}* 天真到對自己的命運\n  一無所知。"
            ]
            : [])
      ],
      robot3: [">{#p/basic}* 看起來你還沒有給我預留足夠的空間。"],
      robot4: () => [
         ">{#p/basic}* 好吧。\n* 那麼，祝你旅途愉快。",
         ...(world.goatbro && SAVE.flag.n.ga_asriel98++ < 1
            ? [
      ...
      robot11: [">{#p/basic}* 我真傻，為啥之前那麼輕易\n  就把心掏給你呢？"],
      robot12: [">{#p/basic}* 滾！"],
      sans1: [
         ">{#p/darksans}{#i/4}* {@spacing=4/0}{#i/x2}人類。",
         ">* {@spacing=4/0}難道你不知道{@spacing=}\n  {@spacing=4/0}怎麼和新朋友{@spacing=}\n  {@spacing=4/0}打招呼嗎？",
         ">* {@spacing=4/0}轉過身來{@spacing=}\n  {@spacing=4/0}和我握手。"
      ],
      sans2: () => [
         ...(world.edgy
            ? [
               ">{#p/sans}{#f/0}* 嘿，幹嘛露出這種表情？",
               ">{#p/sans}{#f/2}* ...不喜歡放屁墊的把戲嗎？",
               ">{#f/0}* ...沒關係，人各有志嘛。"
            ]
            : [">{#p/sans}{#f/4}* 嘿嘿... 沒有什麼能比\n  一個放屁墊把戲更好的了。"]),
         ">{#f/0}* 總之，你是個人類，對吧？",
         ">{#f/5}* 真酷。",
         ">{#f/0}* 我是衫斯。\n* 骷髏衫斯。",
         ">{#f/3}* 作為一名皇家哨兵，\n  現在我本該去抓捕人類的。",
      ...
      sans5: [
         ...
         ">{#p/sans}* 嗯...",
         ">{#f/2}* 沒準這個玩意可以\n  幫到你呢。",
         ">{#p/papyrus}{#x3}{#f/7}衫斯，那根本沒用！\n你這個懶骨頭！",
         ">{#x1}{#f/5}你明明知道，\n你能做的遠不止這些，\n但是...",
         ">{#x2}{#f/7}你還是選擇\n整天無所事事！",
         ">{#x1}{#f/5}難道你不想... \n從生活中得到更多嗎？",
         ">{#p/sans}* 嘿，放輕鬆點。\n* 我的心裡可裝著\n  一大堆事務呢。",
         ">{#f/4}* 你甚至可以說我...",
         ">{#f/2}* 早已{@fill=#ff0}星{@fill=#fff}懷遠志了？"
      ],
      sans6: [
         ">{#p/papyrus}{#x3}{#f/7}衫斯！！",
         ">{#p/sans}{#f/5}* 拜託。\n* 你明明就在笑。",
         ">{#p/papyrus}{#x2}{#f/7}我確實笑了！\n極其鄙視的那種！",
         ">{#x1}{#f/4}（嘆氣...）",
         ">{#f/5}為什麼像我這樣\n偉大的人...",
         ">為了得到認可\n需要做這麼多破事？？",
         ">{#p/sans}* 嘿，別傷心嘛...",
      ...
      sansbook1: [">{#p/basic}* 這是本關於非歐幾何的書。\n* 寫著「艾菲斯」的名字。"],
      sansbook2: () => [choicer.create("* （要看看裡面嗎？）", "看看", "算了")],
      sansbook3: [">{#p/human}* （你往書裡面看...）"],
      sansbook4: [">{#p/basic}* 幾何學書裡面夾著一本\n  笑話書。"],
      sansbook5: [">{#p/basic}* 笑話書裡面夾著\n  另一本幾何學書。"],
      sansbook6: [">{#p/basic}* 幾何學書裡面夾著\n  另一本笑話書。"],
      sansbook7: [">{#p/basic}* 是另一本幾何學書。"],
      sansbook8: [">{#p/basic}* 是另一本笑話書。"],
      sansbook9: [">{#p/human}* （你決定不再看了。）"],
      sansbook10: () => [
         ">{#p/basic}* 這是衫斯留的字條。",
         ">{#p/without}* 「這麼認真幹什麼？」\n* 「這就只是個爛笑話。」",
         ">{#p/without}* 「呵...」",
         ">{#p/without}* 「別看得太入迷了。」",
         ...(SAVE.data.b.oops ? [] : [">{#p/basic}* ...這是我經歷過的\n  最爛的笑話。"])
      ],
      sansinter: {
         s_sans: pager.create(
            0,
            ...
            () =>
               world.edgy
                  ? [
                     ">{#p/sans}{#f/3}* ...",
                     ">{*}{#p/darksans}{#f/1}{#i/5}{#s.stop}* 別給臉不要臉。",
                     "{*}{#s.resume}{%}"
                  ]
                  : [">{#p/sans}* 信我的。"],
         ...
         s_papyrus: pager.create(
            ...
            [
               ...
               ">* 如果看到了{@fill=#ff993d}橙色攻擊{@fill=#fff}，\n  你如果不動，就會受傷。",
               ">{#f/3}* 有種簡單的方式\n  可以幫助你記住。",
               ">{#f/0}* 想像一下燒紅的煤炭。\n* 你肯定不會站在\n  那種東西上吧？",
               ">* 煤炭質地比較堅硬。\n* 所以不妨換成骨質煤炭來想。",
               ">{#f/2}* 非常簡單，對吧？\n* 記得戰鬥的時候想想\n  發熱的骨質煤炭吧。"
            ...
            () =>
               world.edgy
                  ...
                  : world.killed5
                     ...
                     : [">{#p/sans}{#f/2}* 喔，順帶再複習下{@fill=#00a2e8}藍色攻擊{@fill=#fff}。"],
            () =>
               world.edgy
                  ? [">{#p/sans}{#f/3}* 就是這樣。"]
                  : world.killed5
            ...
            ? 6 <= world.population
               ...
               : world.bullied
                  ...
                  : [
                     ...
                     ">* 你要是不小心\n  遇到了我的兄弟...",
                     ">{#f/3}* ...",
                     ">{*}{#p/darksans}{#f/1}{#i/5}{#s.stop}* 敢動他一下試試。",
                     "{*}{#s.resume}{%}"
                  ]
            : 6 <= world.population
               ? [
            ...
            SAVE.data.b.svr
               ...
               : [
                  ...
                  ...(world.genocide || world.runaway
                     ? [
                        ">{#p/papyrus}{#f/30}「求你不要毀掉我的哨站。」",
                        ">「我費了好大功夫才搭好它，\n要是它垮了，我會很傷心的。」",
                        ">「...以上。」",
                        ">（「註：我還想再寫點，\n但是沒地方了。」）"
                     ]
                     : [
                        ">{#p/papyrus}{#f/30}「你仔細打量眼前這個\n精心製作的哨站，心想...」",
                        ">「是哪位能工巧匠，\n才能做出這樣的哨站呢？」",
                        ">「我敢說，肯定是出自那個\n超-有名的皇家守衛之手！」",
                        SAVE.data.n.plot === 72
         ...
         SAVE.data.b.svr
            ...
            : world.darker
               ...
               : SAVE.data.n.plot < 31
                  ...
                  : SAVE.data.n.plot === 72
                     ? [">{#p/basic}* 衫斯的哨站...", ">* The quality of this investment hasn't changed a bit."]
                     : [">{#p/basic}* 衫斯的哨站...", ">* A poor investment in hindsight."],
      ...
      whew1: () =>
         [
            ...
            [
               ...
               choicer.create("* （你該怎麼辦？）", "Nothing", "Sleep")
            ],
            [
      ...
      trivia: {
         ...
         s_paptrash: pager.create(
            ...
            ...[
               () => [
                  ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                     ? [
                        ">{#p/papyrus}{#f/9}我都不知道你還\n喜歡撿垃圾！",
                        ">{#f/0}艾菲斯博士會\n對你很感興趣的。"
                     ]
                     : []),
                  world.darker ? ">{#p/basic}* 一個垃圾桶。" : ">{#p/basic}* 這是個「閃亮」垃圾桶。"
               ],
               pager.create(
                  1,
                  ...[
                     [
                        ">{#p/basic}* 之所以說這個垃圾桶「閃亮」，\n  是因為它的一邊就寫著\n  「閃亮」兩個字。"
                     ],
                     [">{#p/basic}* 一個「閃亮」星仔\n  對一個「閃亮」垃圾桶。\n* 你還能有什麼想知道的。"],
                     [">{#p/basic}* 小鎮這一帶中\n  最「閃亮」的垃圾桶。"],
                     [">{#p/basic}* 這麼說來，\n  也可以是別的某一帶。"],
                     ...
                     [">{#p/basic}* ...\n* 我說過...\n* 你等一下..."],
                     [">{#p/basic}* 這是個「閃亮」垃圾桶。"]
                  ].map(lines => () => world.darker ? [">{#p/basic}* 一個垃圾桶。"] : lines)
               )
            ].map(
               p => () =>
                  SAVE.data.b.svr
               ...
               : SAVE.data.n.state_starton_greatdog === 2
                  ...
                  : world.genocide || world.edgy || world.darker
                     ...
                     : SAVE.data.n.plot === 72
                        ...
                        : [">{#p/basic}* 多麼小巧的狗屋啊！", ">{#p/basic}* 裡面應該比外面看起來大。"],
         s_doghouse_sign: () =>
            SAVE.data.b.svr
         ...
         s_dogstandC: () =>
            SAVE.data.b.svr
               ...
               : world.genocide
                  ? [
                     ">{#p/basic}* 地板上，是一封寫著「果斷撤離」的\n  皇家守衛籤名信。",
                     ">{#p/basic}* 信上的「果」字幾乎都被啃掉了..."
                  ]
                  : [
                     ">{#p/basic}* 在裡面的地板上\n  放著一封關於統一制服尺寸的\n  皇家守衛籤名信，",
                     ">{#p/basic}* 上面全是爪印。"
         ...
         s_grillbys_beegstool: () =>
            SAVE.data.b.svr
               ...
               : world.darker
                  ? [">{#p/basic}* 另一把高腳凳。"]
                  : [">{#p/basic}* 一把高腳凳...", ">* 高度剛好適合衫斯。"],
         s_grillbys_drinks: () =>
            SAVE.data.b.svr
               ? [">{#p/human}* (You can't make out what's under the tray table...)"]
               : SAVE.data.n.plot === 72
                  ? [">{#p/basic}* 一張摺疊式餐桌。", ">* The camera on the underside has been taken away."]
                  : [">{#p/basic}* 一張摺疊式餐桌。", ">* 下面藏了個攝像頭。"],
         s_grillbys_shelf: () =>
            SAVE.data.b.svr
               ? [
                  [
         ...
         s_sr_treadmill: [">{#p/basic}* 這是一臺跑步機。", ">{#p/basic}* 這是它的最高設定了。"],
         s_sr_lamp: [
            ">{#p/basic}* 這是一盞檯燈，\n  裡面掛著一張大字條。",
            ">{#p/papyrusnt}「抱歉，我把你在這裡用的\n手電筒拿回去了。」",
            ">{#p/papyrusnt}「不是說我介意你用\n我的東西...」",
            ">{#p/papyrusnt}「但你用這種不正常的\n方式用就完全沒有\n道理了！」",
            ">{#p/papyrusnt}「我不知道你是怎麼想的，\n但據我所知...」",
            ">{#p/papyrusnt}「手電筒算不上燈泡！！」"
         ],
         s_sc_book: [
            ">{#p/basic}* 這是皇家實驗室的舊日誌。",
            ">{#p/human}* （你翻到了打開的那頁...）",
            ">{#p/basic}* 「活動日誌，克歷615年7月」",
            ">* 「我們已經從樹林中\n   挑選到了理想的對象。」",
            ">* 「試驗物質的準備工作\n   將在未來幾天結束。」",
            ">* 「很快，實驗對象就會\n   進行注射。」",
            ">* 「這樣一來，我們就比以往任何時候\n   都更接近自由...」"
         ...
         s_redbook: () =>
            SAVE.data.b.svr
               ...
               : [
                  ">{#p/basic}* 一個書架。",
                  ">{#p/human}* （你取下了那本紅皮書...）",
                  ">{#p/basic}* 「人怪大戰進入到白熱化階段時，\n   皇家軍隊成立了一個秘密組織。」",
                  ">{#p/basic}* 「也就是所謂的『特種武器』研發部，\n   專門用來搞實驗研究。」",
                  ">{#p/basic}* 「他們造出了許多『戰鬥利器』，\n   但實戰效果都是微乎其微。」",
                  ">{#p/basic}* 「只有一個例外，\n   它就是被稱作『頓悟』的魔法捲軸。」",
                  ">{#p/basic}* 「這捲軸的力量超乎尋常，\n   即使用來對付人類也過於危險。」",
                  ">{#p/basic}* 「結果，捲軸被從內部鎖死，\n   並很快封存起來。」",
                  ">{#p/basic}* 「傳說，有人把它送上了\n   開往前哨站的運輸船。」",
                  ">{#p/basic}* 「如果傳說屬實，\n   那麼它現在位於何處？」\n* 「又該如何解開枷鎖？」",
                  ">{#p/basic}* 「但願，以上疑問永埋塵土之下，\n   湮沒無聞。」",
                  ">{#p/human}* （你把書放回了書架。）"
               ],
         s_sansbox: () =>
            SAVE.data.b.svr
   ...
   b_group_starton: {
      dogs: () => (world.goatbro ? [">{#p/asriel2}* Dogamy and Dogaressa."] : [">{#p/story}* Dogi向你發起攻擊！"]),
      spacetopJerry: () =>
         world.goatbro
            ? [">{#p/asriel2}* 俗氣的帽子再配上沒譜的夥計。"]
            : [">{#p/story}* Astro Serf閒逛過來了！\n* 傑瑞也來了。"],
      stardrakeSpacetop: () =>
         world.goatbro
            ? [">{#p/asriel2}* 笨蛋青年兩人組。"]
      ...
      stardrakeSpacetop2b: () =>
         world.goatbro ? [">{#p/asriel2}* 只剩一個了。"] : [">{#p/story}* Astro Serf remains steady."],
      stardrakeSpacetop2c: () =>
         world.goatbro ? [">{#p/asriel2}* 只剩一個了。"] : [">{#p/story}* Just Astro now."],
      stardrakeSpacetop2d: () => (world.goatbro ? [">{#p/asriel2}* 傑瑞。"] : [">{#p/story}* 傑瑞。"]),
      stardrakeSpacetopJerry: () =>
         world.goatbro
            ...
            : SAVE.data.b.spared_jerry
               ...
               : SAVE.data.b.s_state_chilldrake
                  ? [">{#p/story}* Astro Serf和Chilldrake嘆著氣\n  來和你對峙了。\n* 傑瑞。"]
                  : [">{#p/story}* Astro Serf和星鐵龍嘆著氣\n  來和你對峙了。\n* 傑瑞。"],
      ...
      stardrakeSpacetopJerry2b: () =>
         world.goatbro ? [">{#p/asriel2}* 還剩下兩個。"] : [">{#p/story}* Astro Serf remains steady.\n* Jerry."],
   ...
   b_opponent_stardrake: {
      ...
      name: () => (SAVE.data.b.s_state_chilldrake ? "* Chilldrake" : "* 星鐵龍"),
      punTalk1: () =>
         SAVE.data.b.s_state_chilldrake
   ...
   b_opponent_jerry: {
      ...
      genoStatus: [">{#p/asriel2}* 傑瑞。"],
      hurtStatus: () => (world.goatbro ? [">{#p/asriel2}* 離死不遠了。"] : [">{#p/story}* Jerry is wounded."]),
      idleTalk1: () =>
         SAVE.data.b.spared_jerry
   ...
   b_opponent_mouse: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Whizkarat，流浪貓。\n* 早已活得渾渾噩噩。"]
            : [">{#p/story}* WHIZKARAT - 攻擊16 防禦8\n* 這隻以城為家的時髦的貓\n  只想過簡單的生活。"],
      act_check2: [
      ...
      disownStatus: () =>
         world.goatbro ? [">{#p/asriel2}* Whizkarat."] : [">{#p/story}* Whizkarat逐漸變得不再冷靜。"],
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 離死不遠了。"] : [">{#p/story}* Whizkarat is nearing demise."],
      ...
      randStatus3: [">{#p/story}* Whizkarat正試圖裝成\n  自己很小的樣子。"],
      randStatus4: [">{#p/story}* Smells like top-twenty-cheese."],
      remindStatus: () =>
         world.goatbro
            ? [">{#p/asriel2}* Whizkarat."]
            : [">{#p/story}* Whizkarat只需要一點\n  小小的幫助。"],
      remindTalk1: [">{#p/basic}{~}住在\n洞裡，\n是嗎..？"],
      remindTalk2: [">{#p/basic}{~}會像\n玩具\n吱吱叫，\n是嗎..？"],
      remindTalk3: [">{#p/basic}{~}從現在\n開始，\n我應該像\n老鼠一樣\n生活。"],
      safeStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* Whizkarat has found its way."],
      safeTalk1: [">{#p/basic}{~}Wonder- ful..."],
      safeTalk2: [">{#p/basic}{~}Simply splen- did..."],
      status1: [">{#p/story}* Whizkarat來了！"]
   },
   b_opponent_doggo: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 遁狗，一條不順眼的狗。\n* 這個蠢貨怎麼又上崗了？"]
            : [">{#p/story}* 遁狗 - 攻擊13 防禦7\n* 一點風吹草動便能讓它興奮。\n* 喜好之一：擁抱。"],
      act_check2: [">{#p/story}* 遁狗 - 攻擊13 防禦7\n* 甚至難以看見它自己..."],
      act_check3: [">{#p/story}* 遁狗 - 攻擊13 防禦7\n* 一隻非常興奮的狗，\n  正在享受其所好。"],
      act_check4: [">{#p/story}* 遁狗 - 攻擊13 防禦7\n* 在你眼裡，這隻狗在生活中\n  非常地孤獨。"],
      act_flirt: () => [">{#p/human}* （你對遁狗調情。）"],
      act_cuddle: () => [">{#p/human}* （你緊緊地抱住遁狗。）"],
      fetch: () => [
         ">{#p/human}* （你將扳手扔了出去。）\n* （狗狗跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）"
      ],
      ...
      flirt1: [">{#p/basic}{~}（情不自禁\n地臉紅）"],
      invisStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* 遁狗找不到你了。"],
      name: "* 遁狗",
      fetchStatus: [">{#p/story}* 遁狗喜歡巡迴遊戲！"],
      fetchpet: [">{#p/human}* （但是遁狗忙於尋找扳手，\n  沒時間讓你摸。）"],
      fetchflirt: [">{#p/human}* （但是遁狗忙於尋找扳手，\n  沒時間聽你說話。）"],
      fetchcuddle: [">{#p/human}* （但是遁狗忙於尋找扳手，\n  沒時間讓你抱。）"],
      normaStatus: () => (world.goatbro ? [">{#p/asriel2}* 遁狗。"] : [">{#p/story}* 遁狗知道你在這裡。"]),
      pet: () => [
         ">{#p/human}* （你摸了摸遁狗。）",
         ...(world.goatbro
            ? [
      ...
      petStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* 遁狗已經被摸過了。"],
      petTalk1: [">{#p/basic}{~}啥！！！\n我被摸了！"],
      ...
      status1: () => (world.goatbro ? [">{#p/asriel2}* 遁狗。"] : [">{#p/story}* 遁狗擋住了去路！"]),
      sussy: () =>
         world.goatbro ? [">{#p/asriel2}* 遁狗。"] : [">{#p/basic}* 遁狗對你的行動\n  十分戒備。"]
   },
   b_opponent_lesserdog: {
      ...
      petTalk2: [">{#p/basic}{~}（輕微的\n犬叫聲）"],
      petTalk3: [">{#p/basic}{~}(Wag wag)"],
      petTalk4: [">{#p/basic}{~}（想著吃的）"],
      petTalk5: [">{#p/basic}{~}（喘氣！\n喘氣！）"],
      ...
      petText1: () => [">{#p/human}* （你只是稍微抬了下手。）", ">{#p/basic}* 好興奮喔！"],
      petText2: () => [
         ">{#p/human}* （你輕輕地摸了一下狗子。）",
         ">{#p/basic}* 它已經興奮過頭了...",
         ...(world.goatbro ? [">{#p/asriel2}* 狗子們還真喜歡被摸啊。"] : [])
      ],
      petText3: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 它仰起頭，迎向你的手心。",
         ...(world.goatbro ? [">{#p/asriel2}* 夠了，你都摸過它了。\n* 真沒必要繼續摸了。"] : [])
      ],
      petText4: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 真是只好狗狗。",
         ...(world.goatbro ? [">{#p/asriel2}* 繼續摸它有必要嗎？"] : [])
      ],
      petText5: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 它的興奮永無止境...",
         ...(world.goatbro ? [">{#p/asriel2}* 沒必要繼續摸了。"] : [])
      ],
      petText6: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 會心一摸！\n* 狗子的興奮度增加了。",
         ...(world.goatbro ? [">{#p/asriel2}* 天吶，$(name)。"] : [])
      ],
      petText7: () => [
         ">{#p/human}* （你得跳起來才摸得到狗子了。）",
         ...(world.goatbro ? [">{#p/asriel2}* 我們不能以摸狗為生。"] : [])
      ],
      petText8: () => [
         ">{#p/human}* （你想摸摸小犬座，\n  結果，連夠都夠不到。）",
         ">{#p/basic}* 不過它還是更加興奮了。",
         ...(world.goatbro ? [">{#p/asriel2}* 我們真要摸一整天狗嗎...？"] : [])
      ],
      petText9: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 根本沒法停下這場鬧劇。",
      ...
      petText10: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 不積跬步，無以至千裡。\n  不積小摸，無以得巨狗。",
         ...(world.goatbro ? [">{#p/asriel2}* 為啥要在這浪費時間？"] : [])
      ],
      petText11: () => [
         ">{#p/human}* （你呼喚著小犬座，\n  然而它已經聽不到你說話了。）",
         ...(world.goatbro ? [">{#p/asriel2}* 這下好了。\n* 再也別想夠著它了。"] : [])
      ],
      petText12: () => [">{#p/basic}* ...", ...(world.goatbro ? [">{#p/asriel2}* ？？？"] : [])],
      petText13: () => [
         ">{#p/human}* （你又夠得著小犬座了。）",
         ...(world.goatbro ? [">{#p/asriel2}* 你跟我開玩笑呢是吧？"] : [])
      ],
      petText14: () => [">{#p/human}* （你摸了摸小犬座。）"],
      petText15: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 你可能有什麼毛病。"
      ],
      petText16: () => [
         ">{#p/human}* （你沒摸著小犬座，\n  但它很看好你的努力。）",
         ...(world.goatbro ? [">{#p/asriel2}* 給我停下。"] : [])
      ],
      petText17: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* * 節制擼狗，人人有責。",
         ...(world.goatbro ? [">{#p/asriel2}* 請你停下。"] : [])
      ],
      petText18: () => [
         ">{#p/human}* （你摸了摸小犬座。）",
         ">{#p/basic}* 鬧劇還在繼續。",
      ...
      petText19: () => [
         ">{#p/human}* （你夠不著小犬座了。）",
         ...(world.goatbro ? [">{#p/asriel2}* 好了，該結束了。\n* 趕緊殺了這個蠢貨。"] : [])
      ],
      petText20: () => [
         ">{#p/human}* （開玩笑吧。）",
         ">{#p/basic}* ...開玩笑吧。",
         ...(world.goatbro ? [">{#p/asriel2}* 開玩笑吧..."] : [])
      ],
      statusX: [">{#p/asriel2}* 不堪一擊。"],
      status0: () => (world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* 小犬座出現了。"]),
      status1: () =>
         world.goatbro
            ? [">{#p/asriel2}* 小犬座。"]
      ...
      status4: () => (world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* Smells like dog chow."]),
      status5: () =>
         world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* 小犬座在興奮地汪汪叫。"],
      status6: () =>
         world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* Canis Minor is overstimulated."],
      status7: () =>
         world.goatbro
            ? [">{#p/asriel2}* 小犬座。"]
            : [">{#p/story}* Canis Minor shows no signs of stopping."],
      status8: () =>
         world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* Canis Minor is lowering."],
      status9: () =>
         world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* Canis Minor learns to code."],
      status10: () =>
         world.goatbro
            ? [">{#p/asriel2}* 小犬座。"]
            : [">{#p/story}* Canis Minor is whining because it can't see you."],
      status11: () => (world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* Hello there."]),
      status12: () =>
         world.goatbro
            ? [">{#p/asriel2}* 小犬座。"]
   ...
   b_opponent_dogamy: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 狗來米，一條廢狗。\n* 純靠他的瘋狗老婆過活。"]
            : [">{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的老公。\n* 只認識他聞到的東西。"],
      act_check2: [">{#p/story}* 狗來米 - 14攻擊 5防禦\n* 新近喪偶。\n* 只認識失去老婆的痛苦。"],
      act_check3: [">{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的老公。\n* 認識的東西比先前更多了。"],
      act_check4: [">{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的丈夫。\n* 並不介意分享...？"],
      act_check5: [">{#p/story}* 狗來米 - 14攻擊 5防禦\n* 狗媳兒的老公。\n* 並不介意離開...？"],
      fetchText: [
         ">{#p/human}* （你將扳手扔了出去。）\n* （狗狗們跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）"
      ],
      fetchTextLone: () => [
         ">{#p/human}* （你將扳手扔了出去。）\n* （但狗來米沒有理它，\n  任由其滾落到了邊緣。）",
         ...(world.goatbro && SAVE.flag.n.ga_asrielSpannerComment++ < 1 ? [">{#p/asriel2}* 預料到了。"] : [])
      ],
      flirtTalk1: [">{#p/basic}{~}啊！\n但是為啥\n...！？"],
      flirtTalk2: [">{#p/basic}{~}愛無處不在？"],
      flirtTalk3: [">{#p/basic}{~}你剛才..."],
      flirtTalk4: [">{#p/basic}{~}這隻小狗在\n幹什麼？"],
      flirtText: [
         ">{#p/human}* （你對狗來米調情。）",
         ">{#p/basic}* 你的... 資訊素，\n  傳到了狗來米的鼻子上。"
      ],
      flirtTextLone: [">{#p/human}* （你對狗來米調情。）", ">{#p/basic}* 狗來米的表情沒有發生變化。"],
      loneStatus: () =>
         world.goatbro
            ? [">{#p/asriel2}* 只剩一個了。"]
            : [">{#p/story}* 狗媳兒一心想要踢\n  人類的尾巴。"],
      loneTalk1: [">{#p/basic}{~}汪嗚！"],
      loneTalk2: [">{#p/basic}{~}嗚——"],
      loneTalk3: [">{#p/basic}{~}嗷嗚..."],
      name: "* 狗來米",
      fetchStatus: [">{#p/story}* 已婚的狗喜歡巡迴遊戲！"],
      fetchStatusX: [">{#p/story}* 狗狗們的思緒正指數增長！"],
      otherPet: [">{#p/basic}{~}..."],
      petNeedStatus: () =>
         world.goatbro
      ...
      petStatus: () =>
         world.goatbro
            ? [">{#p/asriel2}* 不堪一擊。"]
            : [">{#p/story}* 狗狗們的思緒增加了！"],
      petTalk1: [">{#p/basic}{~}手拿開，\n你這個\n該死的\n人類。"],
      petTalk1x: [">{#p/basic}{~}手拿開，\n你這隻\n奇怪的\n小狗。"],
      petTalk2: [">{#p/basic}{~}哇！！！\n來自另一隻\n小狗的撫摸\n！！！"],
      petTalk3: [">{#p/basic}{~}停下！\n別碰她！"],
      petTalk4: [">{#p/basic}{~}那我呢\n......"],
      petTalk5: [">{#p/basic}{~}謝謝你..."],
      petText: [">{#p/human}* （你撫摸了狗來米。）"],
      petTextLone: [">{#p/human}* （你嘗試撫摸狗來米，\n  但他畏懼地縮起自己的頭。）"],
      randTalk1: () =>
         world.goatbro
      ...
      resmellTextLone: [">{#p/human}* （你讓狗來米聞聞你，\n  但他連鼻子都沒抬一下。）"],
      rollStatus: () =>
         world.goatbro
            ? [">{#p/asriel2}* 你會把衣服弄髒的，$(name)。"]
            : [">{#p/story}* 狗狗們也許想重新聞聞你。"],
      rollText: () => [
         ">{#p/human}* （你在泥裡打了幾個滾。）\n* （這泥好像是合成的。）",
         ">{#p/basic}* 你的氣味有變化了...",
         ...(world.goatbro ? [">{#p/asriel2}* 你在做什麼。"] : [])
      ],
      rollText2: [
         ">{#p/human}* （你在泥裡打了幾個滾。）\n* （這泥好像是合成的。）",
         ">{#p/basic}* 你的氣味已經變了。"
   ...
   b_opponent_dogaressa: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 狗媳兒，一條瘋狗。\n* 沒了她老公，分分鐘發瘋。"]
            : [">{#p/story}* 狗媳兒 - 14攻擊 5防禦\n* 這隻小狗認為她丈夫很可愛。\n  僅限於氣味的那種？"],
      act_check2: [">{#p/story}* 狗媳兒 - 14攻擊 5防禦\n* 這隻小狗非常想念她的老公\n  僅限於被殺掉後的那種？"],
      act_check3: [">{#p/story}* 狗媳兒 - 14攻擊 5防禦\n* 對這隻小狗來說\n  事態進展得很順利。"],
      act_check4: [
         ">{#p/story}* 狗媳兒 - 14攻擊 5防禦\n* 這隻小狗發覺可愛的東西\n  不只有她老公。"
      ],
      ...
      flirtTextLone: [
         ">{#p/human}* （你對狗媳兒調情。）",
         ">{#p/basic}* 狗媳兒的表情沒有發生變化。"
      ],
      loneStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 只剩一個了。"] : [">{#p/story}* Dogamy is brokenhearted."],
      ...
      petText: [">{#p/human}* （你撫摸了狗媳兒。）"],
      petTextLone: [">{#p/human}* （你試圖撫摸狗媳兒，\n  但她只是對你低吼。）"],
      ...
      rollTextLone: () => [
         ">{#p/human}* （你在狗來米的塵埃裡打了幾個滾。）",
         ">{#p/basic}* Dogarassa更瘋狂了。",
         ...(world.goatbro ? [">{#p/asriel2}* ..."] : [])
      ],
   ...
   b_opponent_greatdog: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座，一條傻狗。\n* 這群狗裡面，\n  屬它頭腦簡單，四肢發達。"]
            : [">{#p/story}* 大犬座 - 15攻擊 8防禦\n* 太過興奮，以至於將\n  戰鬥當作兒戲。"],
      act_check2: [">{#p/story}* 大犬座 - 15攻擊 8防禦\n* 渴望著關愛與照顧..."],
      act_check3: [">{#p/story}* 大犬座 - 15攻擊 8防禦\n* 已經累到虛脫了。"],
      act_flirt: [
         ">{#p/human}* （你對大犬座調情。）",
         ">{#p/basic}* 大犬座尷尬地歪著頭。"
      ],
      beckonText: [
         ">{#p/human}* （你叫了叫大犬座。）",
         ">{#p/basic}* 它躍向你，甩了你滿臉口水。"
      ],
      closeStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座渴望著關愛。"],
      closeText: [">{#p/human}* （你叫了叫大犬座。）\n* （但狗狗只是豎了豎耳朵。）"],
      doneText: [">{#p/basic}* 大犬座覺得你太無趣了。"],
      fetch: () =>
         world.goatbro
            ? [
               ">{#p/human}* （你扔出扳手。）\n* （大犬座把它吸收進自己的身體，\n  然後若無其事地繼續玩耍。）",
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 離死不遠了。"] : [">{#p/story}* 大犬座正緩緩地喘著氣。"],
      ignoreStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 大犬座只是想要一些關愛。"],
      ignoreStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座正在賣萌。"],
      name: "* 大犬座",
      fetchStatus: [">{#p/story}* 大犬座喜歡巡迴遊戲！"],
      petStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 大犬座正用前爪拍打著地面。"],
      petStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座想要溫柔的關愛。"],
      petStatus3: () =>
         world.goatbro ? [">{#p/asriel2}* ..."] : [">{#p/story}* 撫摸能量，百分之四十！"],
      petStatus4: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* 大犬座非常滿足。"],
      petText0: [">{#p/human}* （但是大犬座離你太遠了，\n  你摸不著它。）"],
      petText1: [
         ">{#p/human}* （大犬座享受著你的撫摸，\n  它把整個身子都蜷縮在你的腿上。）",
         ">* （它太舒服了，呼呼睡著了。）",
         ">* （狗子打呼著，打呼著...）",
      ...
      playText3: [">{#p/basic}* 大犬座精疲力盡，\n  不想再玩了。"],
      playText4: [">{#p/human}* （但是大犬座已經開始在玩\n  巡迴遊戲了。）"],
      status0: () => (world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座出現了。"]),
      status1: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座正緊緊地注視著你。"],
      status2: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 大犬座正等待你的指令。"],
      status3: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 有股鮮榨小狗汁的味道。"],
      waitText: [">{#p/basic}* 大犬座逐漸向你靠近。"]
   },
   b_opponent_papyrus: {
      act_flirt: [">{#p/human}* （你向帕派瑞斯調情。）"],
      act_insult: [">{#p/human}* （你罵了帕派瑞斯一頓。）"],
      ...
      act_check: () =>
         world.genocide
            ? [">{#p/story}* 帕派瑞斯 - 攻擊3 防禦3\n* 亡兄之弟。"]
            : papreal()
               ? [">{#p/story}* 帕派瑞斯 - 攻擊3 防禦3\n* 依然相信著你。"]
               : [">{#p/story}* 帕派瑞斯 - 攻擊20 防禦20\n* 喜歡說「捏嘿嘿！」"],
      act_check2: [">{#p/story}* 帕派瑞斯 - 攻擊20 防禦20\n* 一切都很順利。"],
      act_check3: [">{#p/story}* 帕派瑞斯 - 攻擊20 防禦20\n* 最最最仁慈的衛兵！"],
      capture1: [
      ...
      death1: () =>
         world.genocide
            ? [">{#p/papyrus}{#f/27}不...\n不-不..."]
            : [">{#p/papyrus}{#f/21}呃，我沒想到\n會這樣..."],
      death2: () =>
         world.genocide
            ? [">{#p/papyrus}{#f/21}衫斯，我...", ">{#f/33}{@random=1.1/1.1}我讓你失望了..."]
            : papreal()
               ? [
                  ">{#p/papyrus}{#f/27}...盡-儘管如此，\n我仍然相信你！",
                  ">{#p/papyrus}{#f/21}只要你努力，\n肯定能變得更好...",
                  ">{#p/papyrus}{#f/27}我-我保證...！"
               ]
               : [">{#p/papyrus}{#f/27}...幸-幸好，\n我的頭還在！"],
      dots: [">{#p/basic}* ..."],
      flirt0: [">{#p/basic}* Cute."],
      ...
      flirt3a: [">{#p/papyrus}{#f/24}這種\n自信的品格... \n讓我想到了..."],
      flirt3b: [">{#p/papyrus}{#f/24}這種\n謙遜的品格...\n讓我想到了..."],
      flirt4: [
         ">{#f/22}我自己！！！",
         ">{#f/10}你完美地\n貼合了我的\n所有標準！！！",
         ">{#f/27}我想這意味著...\n我必須和你來場\n約會了？"
      ],
      flirt5: [">{#p/papyrus}{#f/20}約會的事\n還是等到我抓住\n你之後再談吧！"],
      flirt6: [">{#p/human}* （你試著調情，但無濟於事。）\n* （看來行動並不會使這場戰鬥\n  升溫。）"],
      flirt7: [">{#p/human}* （但帕派瑞斯現在忙於戰鬥，\n  沒時間聽你說話。）"],
      flirtStatus1: [">{#p/story}* 帕派瑞斯正在為約會考慮\n  要穿什麼。"],
      flirtStatus2: [">{#p/story}* 帕派瑞斯往他耳後拍了些\n  骨龍水。"],
      flirtStatus3: [">{#p/story}* 帕派瑞斯正在為約會考慮\n  要煮什麼。"],
      flirtStatus4: [">{#p/story}* 帕派瑞斯往他耳後拍了些\n  番茄醬。"],
      flirtStatus5: [">{#p/story}* 帕派瑞斯正在想{@fill=#ff0}方色{@fill=#fff}法\n  變得出名。"],
      flirtStatus6: [">{#p/story}* 帕派瑞斯往他耳後拍了些\n  鎂塔牌面霜。"],
      flirtStatus7: [">{#p/story}* 帕派瑞斯往他耳後拍了些\n  鎂塔牌動漫粉。"],
      flirtStatus8: [">{#p/story}* 帕派瑞斯往他耳後拍了些\n  鎂塔牌可愛汁。"],
      flirtStatus9: [">{#p/story}* 帕派瑞斯意識到他沒有耳朵。"],
      flirtStatus10: [">{#p/story}* 帕派瑞斯頭上隨便貼了一些藥膏。"],
      flirtStatus11: [">{#p/story}* ...他還在想{@fill=#ff0}方色{@fill=#fff}法\n  變得出名。"],
      hurtStatus: [">{#p/story}* 帕派瑞斯要被打敗了。"],
      ...
      insult3: [">{#p/human}* （你試著辱罵，但無濟於事。）\n* （看來行動並不會使這場戰鬥\n  升溫。）"],
      insult4: [">{#p/human}* （但帕派瑞斯現在忙於戰鬥，\n  沒時間聽你說話。）"],
      name: "* 帕派瑞斯",
      randomStatus1: [">{#p/story}* 帕派瑞斯正在準備一記\n  骨頭攻擊。"],
      randomStatus2: [">{#p/story}* 帕派瑞斯準備了一記非骨頭攻擊，\n  然後花了一分鐘的時間來糾正錯誤。"],
      randomStatus3: [">{#p/story}* 帕派瑞斯正在做飯。"],
      randomStatus4: [">{#p/story}* 帕派瑞斯悄悄說了一句「捏嘿嘿！」"],
      randomStatus5: [">{#p/story}* 帕派瑞斯正在左右搖晃他的骨頭。"],
      randomStatus6: [">{#p/story}* 帕派瑞斯正在努力扮酷。"],
      randomStatus7: [">{#p/story}* 帕派瑞斯正在考慮他的選擇。"],
      randomStatus8: [">{#p/story}* 骨頭的氣味。"],
      randomStatus9: [">{#p/story}* 帕派瑞斯想起了\n  衫斯講過的一段笑話，\n  忍不住笑了幾下。"],
      spaghetti1: () => [
         ">{#p/papyrus}{#f/12}我的義大利麵！",
      ...
      specialStatus1: [">{#p/story}* 特殊攻擊。"],
      specialStatus2: [">{#p/story}* 帕派瑞斯正全力以赴。"],
      specialStatus3: [">{#p/story}* 帕派瑞斯將所有邏輯都拋之腦後。"],
      specialStatus4: [">{#p/story}* 帕派瑞斯發覺自己有些缺乏邏輯，\n  又把它撈回來了。"],
      specialStatus5: [">{#p/story}* 帕派瑞斯汗流浹背。"],
      specialStatus6: [">{#p/story}* 帕派瑞斯已經束手無策了。"],
      status1: [">{#p/story}* 帕派瑞斯正在饒恕你。"],
      status2: [">{#p/story}* 帕派瑞斯擋住了去路！"],
      turnTalk0a: [">{#p/papyrus}{#f/24}SO, YOU'RE SERIOUS..."],
      turnTalk0b: [">{#p/papyrus}{#f/24}看來，\n你不想戰鬥..."],
      turnTalk0c: [">{#p/papyrus}{#f/20}那就讓我看看\n你會如何應對\n我傳說中的\n『藍色攻擊！』"],
      turnTalk0x: [
         ">{#p/papyrus}{#f/10}你現在是\n藍色的了。",
         ">{#f/10}那就是\n我的攻擊！",
         ">{#f/20}捏嘿嘿嘿嘿嘿\n嘿嘿嘿！！！"
      ...
      turnTalk6: () =>
         world.postnoot
            ? [">{#p/papyrus}{#f/20}以及在皇家衛隊\n的一席之地！"]
            : [">{#p/papyrus}{#f/20}帕派瑞斯:\n皇家衛隊成員！"],
      turnTalk7: [">{#p/papyrus}{#f/10}安黛因一定會\n為我感到驕傲！！"],
      turnTalk8: [">{#p/papyrus}{#f/20}國王會在首塔\n為我建造一座\n雕像！！！"],
      turnTalk9: [">{#p/papyrus}{#f/10}... 我也會\n讓我兄弟\n擁有一座的。"],
      turnTalk10: [">{#p/papyrus}{#f/27}我們將會收穫\n眾多崇拜者！！\n但是..."],
      turnTalk11a: [">{#p/papyrus}{#f/20}我又如何知道\n人們是否真心\n喜歡我呢？？？"],
      turnTalk11b: [">{#p/papyrus}{#f/20}會有人像你一樣\n喜歡我嗎？"],
      turnTalk12: [">{#p/papyrus}{#f/21}像你這樣的人\n真是很少見..."],
      turnTalk13a: [">{#p/papyrus}{#f/21}我不覺得他們\n會輕易放你走..."],
      turnTalk13b: [">{#p/papyrus}{#f/21}再想約會\n估計會很難..."],
      turnTalk14: [">{#p/papyrus}{#f/26}如果你被抓到，\n然後送走的話。"],
      turnTalk15: [">{#p/papyrus}{#f/17}呃...\n管他呢！\n放棄吧！！"],
      turnTalk16: [">{#p/papyrus}{#f/15}要麼放棄，要麼... \n就準備面對我的\n{@fill=#f00}特殊攻擊{@fill=#000}！"],
      turnTalk17: [">{#p/papyrus}{#f/20}沒錯！！！\n待會我就要使用\n我的{@fill=#f00}特殊攻擊{@fill=#000}了！"],
      turnTalk18: [
      ...
      turnTalk20: [">{#p/papyrus}{#f/20}特殊攻擊，\n阿爾法編陣！"],
      turnTalk21: [">{#p/papyrus}{#f/20}特殊攻擊，\n貝塔編陣！"],
      turnTalk22: [">{#p/papyrus}{#f/20}特殊攻擊，\n伽馬編陣！"],
      turnTalk23: [">{#p/papyrus}{#f/20}特殊攻擊，\n德爾塔編陣！"],
      turnTalk24: [
         ">{#p/papyrus}{#f/27}哇塞！\n你也太強了吧！",
         ">{#f/20}但我可不怕！\n我不會被你的\n實力嚇倒！",
         ">{#f/14}... 特殊攻擊...",
         ">{#f/17}{@fill=#f00}西格瑪{@fill=#000}編陣！！！"
      ],
      turnTalk24x: [
         ">{#p/papyrus}{#f/27}行吧...！ *喘氣*\n很明顯... 你不能！\n*喘氣* 打敗我！",
         ">{#f/15}沒錯！！！\n我看見你被嚇得\n全身發抖了！！",
         ">{#f/20}我，偉大的帕派瑞斯，\n選擇給予你\n憐憫！！",
         ">{#f/20}我會{@fill=#f00}饒恕你{@fill=#000}，\n人類！！！",
         ">{#f/10}現在是你接受\n我{@fill=#f00}仁慈{@fill=#000}的機會了。"
      ],
      idleTalk: [">{#p/papyrus}{#f/20}..."],
      idleTalkBullied: [">{#p/papyrus}{#f/27}..."],
      secretFlirt1: [">{#p/papyrus}{#f/27}你盼著能伴我左右...\n直到永遠？", ">{#p/papyrus}{#f/21}呃..."],
      secretFlirt2: [
         ">{#p/papyrus}{#f/27}有人想拆散我們？",
         ">{#p/papyrus}{#f/21}是誰呢..."
      ],
      secretFlirt2x: [
      ...
      secretFlirt8: [
         ...
         ">{#p/papyrus}{#f/15}別擔心，人類！\n一切盡在\n帕派瑞斯的掌控之中！"
      ],
      secretInsult1: [">{#p/papyrus}{#f/27}呃... 大可不必？？？"],
      secretInsult2: [">{#p/papyrus}{#f/21}蠢貨... \n我好像在哪聽過..."],
      secretInsult2x: [
      ...
      secretInsult3: [">{#p/papyrus}{#f/29}搞什麼..."],
      secretInsult3x: [
      ...
      secretInsult4: [">{#p/papyrus}{#f/27}你罵我沒腦子，\n沒懂你啥意思..."],
      secretInsult4x: [
      ...
      secretInsult6: [
         ...
         ">{#p/papyrus}{#f/21}蠢貨...",
         ">{#p/papyrus}{#f/21}星辰大海...",
         ">{#p/papyrus}{#f/20}有顆星星，閃閃，\n他也喜歡叫人「蠢貨」！",
         ">{#p/papyrus}{#f/25}我...",
         ">{#p/papyrus}{#f/22}我才反應過來\n是怎麼回事！",
         ">{#p/papyrus}{#f/20}那個「艾斯利爾」好像\n也喜歡罵人蠢貨！",
         ">{#p/papyrus}{#f/24}也就是說...",
         ">{#p/papyrus}{#f/22}你剛說的「星辰」\n肯定就是指他！",
         ">{#p/papyrus}{#f/19}他肯定幹了啥，\n害【我】表現得\n像個蠢貨！"
      ],
      secretInsult6x: [
      ...
      sparableInsult2: [">{#p/papyrus}{#f/21}人類..."],
      sparableInsult2x: [">{#p/papyrus}{#f/15}你可以的...！"],
      sparableInsult3: [">{#p/papyrus}{#f/21}..."]
   },
   b_opponent_shockasgore: {
      act_check: [">{#p/asriel2}* 艾斯戈爾。\n* 親手葬送自己家園的昏君。"],
      act_hug: [">{#p/human}* （你想抱抱艾斯戈爾...）"],
      hugText: [">{#p/human}* （...但你的身體直接穿了過去。）", ">{#p/asriel2}* ...啊？"],
      foodText: [">{#p/asgore}{#f/5}那是..."],
      idleText1: [">{#p/asgore}{#f/1}開玩笑吧..."],
      idleText2: [">{#p/asgore}{#f/1}一定要\n訴諸暴力嗎？"],
      idleText3: [">{#p/asgore}{#f/1}為什麼不能\n和平解決呢？"],
      idleText4: [">{#p/asgore}{#f/1}真的有必要嗎？"],
      stickText: [
         ">{#p/human}* （你朝艾斯戈爾扔出扳手。）\n* （扳手直接穿過了他的身體。）",
         ">{#p/asriel2}* ...啊？"
      ],
   ...
   i_eye: {
      ...
      drop: [">{#p/human}* （你把力場護盾扔掉了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* （7防禦。）"]
            : [">{#p/basic}* 「力場護盾」 （7防禦）\n* 可隨身攜帶的力場發射器。"],
      name: "力場護盾",
      use: [">{#p/human}* （你啟動了力場護盾。）"]
   },
   i_eye_x: {
      battle: {
         description: "可隨身攜帶的力場發射器，\n但能量不足。",
   ...
   i_pop: {
      ...
      drop: [">{#p/human}* （你把渦旋棒棒糖扔掉了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* （11 HP。）"]
            : [
               ">{#p/basic}* 「渦旋棒棒糖」 回復11 HP\n* 可改變主觀時間流速。\n* 僅在戰鬥中有效。"
            ],
      name: "渦旋棒棒糖",
      use: () => [
   ...
   i_swirl: {
      ...
      drop: [">{#p/human}* （你把光彩漩渦扔掉了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* （22 HP。）"]
            : [">{#p/basic}* 「光彩漩渦」 回復22 HP\n* 一個五彩斑斕的發光瑞士卷。"],
      name: "光彩漩渦",
      use: [">{#p/human}* （你吃掉了光彩漩渦。）"]
   },
   i_voidy: {
      battle: {
      ...
      use: () =>
         battler.active
            ? [">{#p/human}* （你使用了聖所。）", ">{#p/human}* （戰鬥中使用無效。）"]
            : [">{#p/human}* （你使用了聖所。）"]
   },
   i_corndog_sword: {
      battle: {
      ...
      drop: [">{#p/human}* （你想扔掉玉狗聖劍...）", ">{#p/human}* （...但是它拒絕了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* （你覺得還是不要思考\n  這玩意怎麼工作的比較好。）"]
            : [">{#p/basic}* 絕對是獨一無二的武器。"],
   ...
   i_burgerz: {
      ...
      drop: [">{#p/human}* （你把小漢堡全扔掉了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* （15 HP。共有三個。）"]
            : [">{#p/basic}* 「小漢堡」 回復15 HP\n* 很像普通漢堡，只是小了一些。\n* 共有三個。"],
      name: "三隻小漢堡",
      use: [">{#p/human}* （你吃掉了一個小漢堡。）"]
   },
   i_burgerz_use1: {
      battle: {
   ...
   n_shop_blook: {
      exit: [">{#p/napstablook}{#k/0}* 喔... 你要走了...", ">{#k/1}* 好吧，下次再見，也許吧..."],
      item: () =>
         blookGone()
            ? [
               "§fill=#808080§---- 售罄 ----",
      ...
      itemPurchase: [
         ">{#p/napstablook}{#k/3}嘿... 謝謝你...",
         ">{#p/napstablook}{#k/0}不買也沒\n關係的...",
         ">{#p/napstablook}{#k/0}對不起...\n錢不夠...",
         ">{#p/human}（你帶的\n東西\n太多了。）"
      ],
      itemPurchasePrompt: () => (blookGone() ? "偷走嗎？" : "花$(x)G\n買它嗎？"),
      itemUnavailable: () =>
         blookGone() ? ">{#p/basic}空無一物。" : ">{#p/napstablook}{#k/0}喔... 這個\n賣光了...",
      menu: () =>
         blookGone() ? ["拿取", "偷竊", "閱讀", "離開"] : ["購買", world.meanie ? "偷竊" : "出售", "交談", "離開"],
      menuPrompt1: () =>
         [
            ">{#p/napstablook}{#k/3}* 來隨便看看吧...",
            ">{#p/napstablook}{#k/3}* 希望這裡有你想要的東西...",
            ">{#p/napstablook}{#k/3}* 來隨便看看吧...\n  不想也行...\n  一切由你...",
            ">{#p/napstablook}{#k/3}* 來隨便看看...\n* 也許吧...",
            ">{#p/napstablook}{#k/3}* 來隨便看看吧...\n  不想也行...\n  一切由你..."
         ][Math.min(SAVE.data.n.state_wastelands_napstablook, 4)],
      menuPrompt2: ">{#p/napstablook}{#k/0}* 你可以隨時離開這裡... ",
      menuPrompt3: () =>
         world.bulrun ? ">{#p/basic}* ...但是人們都逃走了。" : ">{#p/basic}* ...但是誰也沒有來。",
      note: () =>
         ['f_blooky', 'f_napstablook'].includes(SAVE.data.s.state_foundry_deathroom) // NO-TRANSLATE
            ...
            ? [">{#p/basic}* 沒有人給你留字條。"]
            : SAVE.data.b.killed_mettaton
               ? [">{#p/basic}* 這裡有一張字條。", ">{#p/napstablook}* 「都是你的錯...」"]
               : world.runaway
                  ? [">{#p/basic}* 這裡有一張字條。", ">{#p/napstablook}* 「我們別無選擇...」"]
                  : [">{#p/basic}* 這裡有一張字條。", ">{#p/napstablook}* 「對不起，我得走了...」"],
      sell1: () =>
         blookGone()
            ? [">{#p/human}* （你從櫃檯後面拿走了42G。）"]
            : world.meanie
               ? [
                  ">{#p/napstablook}{#k/2}* 喔... \n  你想偷我的東西...",
                  ">{#p/napstablook}{#k/5}* 你肯定很需要錢...",
                  SAVE.data.b.item_voidy
                     ? ">{#k/0}* 對不起...\n  我唯一的收入還是你剛給的錢..."
                     : ">{#k/0}* 對不起...\n  我很窮，沒錢給你..."
               ]
               : [
                  ">{#p/napstablook}{#k/2}* 喔... 你是想賣掉一些東西嗎",
                  ">{#k/0}* 我不清楚我能不能買下\n  所有東西...\n  抱歉..."
               ],
      sell2: () =>
         blookGone()
      ...
      talkPrompt: ">{#p/napstablook}{#k/1}喔，\n想和我\n聊天嗎？",
      talkText: [
         () =>
            SAVE.data.n.plot === 72
               ? [
                  ">{#p/napstablook}{#k/3}* 喔，你好啊...",
   ...
   n_shop_hare: {
      ...
      note: () =>
         world.runaway
            ? [">{#p/basic}* 這裡有一張字條。", ">{#p/basic}* 「請你別跟過來。」"]
            : SAVE.data.n.plot === 72
               ? [">{#p/basic}* 這裡有一張字條。", ">{#p/basic}* 「對不起，我不敢回去。」"]
               : [">{#p/basic}* 這裡有一張字條。", ">{#p/basic}* 「請不要傷害我的家人。」"],
      sell1: () =>
         world.population === 0 || world.runaway
            ? [">{#p/human}* （你從櫃檯後面拿走了758G。）"]
            : world.meanie
               ? [
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      s_start: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                  ">{#p/undyne}{#f/1}* 比如呢？",
                  ">{#p/papyrus}{#f/0}比如我和衫斯\n之前開懸浮車比賽！",
                  ">{#p/papyrus}{#f/5}我們在路上飛馳，\n並肩賽車..."
               ]),
            ">{#f/4}可惜，不管我\n多努力嘗試...",
            ...(solo()
               ? [
      ...
      s_sans: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                  ">{#p/papyrus}{#f/5}...我還有什麼\n可說的嗎？",
                  ">{#p/undyne}{#f/17}* 帕派瑞斯，你有沒有...\n  呃... 往上看過？",
                  ">{#p/papyrus}{#f/6}什麼！？",
                  ">{#p/papyrus}{#f/7}你知道我沒時間\n那樣子的！",
                  ">{#p/undyne}{#f/1}* 但你根本沒想抓任何人。",
                  ">{#p/papyrus}{#f/6}我-我當然想！\n只是... 不是你想的\n那樣！！"
               ])
         ],
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/4}「特務」和「叛賊」...",
                  ">{#p/papyrus}{#f/1}...難不成我兄弟\n其實是只烏賊！？"
               ]
               : [">{#p/papyrus}{#f/4}這哨站是...\n方形的。"]
      ),
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                  ...
                  ">{#p/undyne}{#f/1}* 他可能只是想讓你\n  多陪陪他。"
               ])
         ],
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/0}有趣的事實吧？",
                  ">{#f/0}如果把我們的\n旋轉速度\n疊加起來...",
                  ">{#f/0}結果實際上就是\n零了。",
                  ">{#f/4}...因為我們總是\n朝相反的方向轉。"
               ]
      ...
      s_papyrus: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ? [">{#f/0}我打算加入\n皇家守衛後再建\n更多這種東西。"]
               : [
                  ">{#p/undyne}{#f/1}* 你知道嗎，我之前\n  考慮過把你的「哨站」\n  翻新一下...",
                  ">{#f/14}* 就當做...\n  一個驚喜禮物！",
                  ">{#p/papyrus}{#f/4}你說啥？",
                  ">{#p/undyne}{#f/12}* 但是，呃，\n  那樣就破壞完美了。",
                  ">{#p/papyrus}{#f/5}你說完美？",
                  ">{#p/papyrus}{#f/6}但是你之前說過\n事情總是可以\n變得更好的！",
                  ">{|}{#p/undyne}{#f/17}* 呃... 是這樣沒錯啦！\n* 我的意思是- {%}",
                  ">{#p/papyrus}幾乎完美。\n這樣說可以吧。",
                  ">{#p/undyne}{#f/12}* 說得好。"
               ])
         ],
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/4}我希望衫斯能\n幫我找到更好的\n建材。",
                  ">{#f/6}紙箱子頂多\n就這樣了！！"
               ]
               : [">{#p/papyrus}人類，謝謝你...", ">可以當我\n幾乎完美的\n朋友。"]
      ),
      s_doggo: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ? []
               : [
                  ">{#p/undyne}{#f/16}* 啊對，我還記得\n  那件事...",
                  ">{#f/22}* 他，呃...\n* 他在想...",
                  ">{#p/papyrus}{#f/5}想什麼...？",
                  ">{#p/undyne}{#f/9}* ...謝謝你一直支援它。",
                  ">{#f/16}* 沒有你，它可能就...",
                  ">{#p/papyrus}{#f/6}啥？\n可能怎麼樣？？",
      ...
      s_robot: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/5}作為一個建築機器人\n生活一定很艱難吧。",
            ">{#f/5}對那些智能\n比較人工的傢夥\n好一點。",
            ...(solo()
               ? []
               : [
                  ">{#p/undyne}{#f/16}* 是啊... 尤其是一個\n  住在前哨站的機器人。",
                  ">{#p/undyne}{#f/9}* 我覺得我們\n  都知道原因。",
                  ">{#p/papyrus}{#f/5}太不幸了。",
                  ">{#p/undyne}{#f/17}* 但是，嘿！\n* 也不全是壞事！！",
                  ">{#p/undyne}{#f/14}* 畢竟，他們的晶片\n  可以直接轉移到\n  一臺新電腦上。",
                  ">{#p/papyrus}{#f/0}喔！喔！\n我應該懂了！",
                  ">{#f/0}這樣他們就可以\n上域外網了！",
                  ">{#f/0}還有天文\n觀測網路！",
                  ">{#f/0}還有更多更多！"
      ...
      s_backrooms: pager.create(
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/4}是某種「廚房」...", ">{#f/5}現在他們只把這裡\n當成玩私人紙牌\n遊戲的地方了。"]
               : [
      ...
      s_bonehouse: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}還有什麼地方能\n比我家更好呢！",
            ">{#p/papyrus}{#f/0}我們有超高水槽...\n還有寵物月巖...",
            ">{#p/papyrus}{#f/9}甚至還有個陽臺，\n多適合戶外生活！",
            ">{#f/0}我基本只有在這\n才會有家的感覺。",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/0}我以前說過，\n我還要再說一遍。",
                  ">{#p/papyrus}{#f/9}讀！\n標！！\n牌！！！",
                  ">{#p/papyrus}{#f/4}注意我的感嘆號\n用得越來越多。",
                  ">{#p/papyrus}{#f/7}意思就是說這\n非常重要！！！！"
               ]
               : [
      ...
      f_telescope: pager.create(
         ...
         [">{#p/papyrus}{#f/4}愛搞惡作劇的人\n總會把事情搞複雜..."]
      ),
      f_bird: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/9}最是聲名狼藉的。",
            ">{#f/9}最是無所畏懼的。",
            ">{#f/9}最是一往無前的。",
            ">{#f/9}怪物。\n神話。\n傳說...",
            ">{#f/9}那隻黃色的鳥。",
      ...
      f_path: pager.create(
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/6}趁著還有機會，\n好好欣賞風景吧！"]
               : [">{#p/papyrus}{#f/6}JUST BE CAREFUL!"]
      ),
      f_view: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}你肯定是一個\n很會一心多用的人！",
            ">{#f/4}因為只有像你\n這樣的人...",
            ">{#f/5}才會在【那種】美景\n附近還想著打電話\n給別人。",
            ...(solo()
               ? []
      ...
      f_tunnel: pager.create(
         ...
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/4}上次我們甚至找到了\n一幅骨頭畫...",
                  ">{#p/papyrus}{#f/5}就是稍微有點\n髒而已！！"
               ]
                  ...
                  : SAVE.data.n.plot_date < 2
                     ...
                     : SAVE.data.n.plot_date < 2.1
                        ? [
                           ...
                           ">{#p/undyne}{#f/14}* 你可別打包票！"
                        ]
                        : [
                           ">{#p/papyrus}{#f/0}請叫我「消遣雜務工」。",
                           ">{#f/4}我雖然沒辦法\n修補你的家...",
                           ">{#f/9}但我還可以幫你\n「補上」美好的一天！"
                        ]
      ),
      ...
      f_prespear: pager.create(
         ...
         () => [
            ">{#p/papyrus}{#f/4}如果我是你，\n我會小心這個房間...",
            ">{#p/papyrus}{#f/5}安黛因經常來這裡，\n威嚴地站在附近。",
            ">{#p/papyrus}{#f/6}她不止一次嚇到過我！",
            ...(solo()
               ? [">{#p/papyrus}{#f/5}即使我讓自己\n很容易被當成靶子。"]
               : [
         ...
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/4}喔，還有不知道從哪裡\n冒出來的長矛陷阱。",
                  ">{#p/papyrus}{#f/5}也小心點那些。"
               ]
      ...
      f_spear: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}穿過這個房間\n所花的時間...",
            ">{#p/papyrus}{#f/5}...好像哪次都不一樣。",
            ">{#p/papyrus}{#f/4}有的時候很長，\n有的時候就不一樣...",
            ">{#p/papyrus}{#f/4}有的時候我穿\n圓點圖案的衣服。",
            ">{#p/papyrus}{#f/0}不管怎麼解釋好像\n都說不通。",
            ...(solo()
               ? [">{#p/papyrus}{#f/0}說的是我剛才那句。"]
               : [
      ...
      f_battle: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}在這個房間裡，\n你會看到\n安黛因的巨塔。",
            ">{#p/papyrus}{#f/9}那是由一顆古老\n小行星的殘骸\n做成的！",
            ">{#f/5}她總是在上面擺姿勢...",
            ">{#f/4}然後喃喃自語...",
            ...(solo()
               ? []
      ...
      f_napstablook: pager.create(
         ...
         () =>
            SAVE.data.n.plot <= 48.1 && SAVE.data.n.state_foundry_blookdate < 2
               ? [
                  ">{#p/papyrus}{#f/0}所以你跟一個幽靈\n交上朋友了。",
                  ">{#p/papyrus}{#f/1}你交友的範圍是不是\n有點太寬泛了！？！？",
                  ...(solo()
                     ? [">{#p/papyrus}{#f/6}你的實力真的\n太讓人害怕了！！"]
                     : [
   ...
   s_save_starton: {
      ...
      s_spaghetti: {
         ...
         text: () =>
            [
               [">{#p/human}* （一盤違反物理定律的義大利麵\n  使你充滿了決心。）"],
               [
                  ">{#p/human}* （現在，這盤義大利麵\n  也遵循物理規律了。）",
                  ">{#p/human}* （這使你充滿了決心。）"
               ],
               [">{#p/human}* （義大利麵沒了。）", ">{#p/human}* （這使你充滿了決心。）"]
            ][trueSpaghettiState()]
      },
      s_town1: {
         name: "星港 - 小鎮",
