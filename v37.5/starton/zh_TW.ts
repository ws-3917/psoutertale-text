...
export default {
   a_starton: {
      ...
      genotext: {
         ...
         asriel30c: [">{*}{#p/asgore}{#f/8}* Asriel，求你別走！\n* 我只是想幫你！{^999}"],
         asriel30d: () =>
            [
               [">{#p/asriel2}{#f/3}* 做好準備，$(name)。", ">{#f/4}* 這兒可是Undyne的地盤。"],
               [">{#p/asriel2}{#f/4}* 帶路吧。"]
         ...
         papyrusSolo4f: [
            ">{#f/5}{@fill=#f00}ASRIEL{@fill=#fff}絕不可能\n幹出這種事！",
            ">{#f/31}因為，{@fill=#f00}ASRIEL{@fill=#fff}心地善良，",
            ">{#f/5}信賴同胞...",
            ">{#f/31}比誰都相信人類！",
            ">{#f/4}而你呢...",
            ">{#f/7}你不過是個為了\n一己私慾利用人類的\n卑鄙小人！",
      ...
      maze3a: [
         ">「火焰之牆」！！",
         ">{#p/sans}* 你直接叫它「火牆」\n  不就行了嗎？\n* 這樣多省事。",
         ">{#p/papyrus}{#f/4}ALPHYS博士會覺得\n我用錯詞了的。",
         ">{#p/sans}* 我不太確定，兄弟。\n  她真的很喜歡那種東西。\n  實際上...",
         ">{#f/2}* 這裡畢竟是個\n  {@fill=#ff0}熱火{@fill=#fff}朝天的地方。"
      ],
      maze4: [">{#p/papyrus}{#x3}{#f/7}別說了，SANS！！"],
      maze5: () =>
         world.edgy
            ? [
               ">{#p/sans}{#f/0}* 這是「火牆」。",
         ...
         s_genokid: pager.create(
            ...
            () =>
               world.genocide
                  ...
                  : [">{#p/kidd}{#f/1}{#npc/a}* Undyne就是我們的堅實後盾！"]
         ),
      ...
      papsink5: [">{#p/papyrus}{#f/7}SANS！", ">別再用配樂\n打擾我的生活了！！"],
         ...
         world.goatbro
            ...
            : SAVE.data.b.spared_jerry
               ...
               : SAVE.data.b.s_state_chilldrake
                  ...
                  : [">{#p/story}* Astro Serf和Stardrake嘆著氣\n  來和你對峙了。\n* Jerry。"],
   ...
   b_opponent_jerry: {
      act_check: () =>
         SAVE.data.b.spared_jerry
            ...
            : world.goatbro
               ? [
                  ">{#p/asriel2}* Jerry，公認的傻帽。\n* 他就是個不折不扣的廢物， 一文不值。"
               ]
               : [">{#p/story}* JERRY - 攻擊0 防禦30\n* 大家都認識Jerry。\n* 會延長攻擊時間。"],
      act_flirt: () =>
         SAVE.data.b.spared_jerry
   ...
   b_opponent_doggo: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Doggo，一條不順眼的狗。\n* 這個蠢貨怎麼又上崗了？"]
            : [">{#p/story}* DOGGO - 攻擊13 防禦7\n* 一點風吹草動便能讓它興奮。\n* 喜好之一：擁抱。"],
      act_check2: [">{#p/story}* DOGGO - 攻擊13 防禦7\n* 甚至難以看見它自己..."],
      act_check3: [">{#p/story}* DOGGO - 攻擊13 防禦7\n* 一隻非常興奮的狗，\n  正在享受其所好。"],
      act_check4: [">{#p/story}* DOGGO - 攻擊13 防禦7\n* 在你眼裡，這隻狗在生活中\n  非常地孤獨。"],
      act_flirt: () => [">{#p/human}* （你對Doggo調情。）"],
      act_cuddle: () => [">{#p/human}* （你緊緊地抱住Doggo。）"],
      fetch: () => [
         ">{#p/human}* （你將扳手扔了出去。）\n* （狗狗跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）"
      ],
      ...
      flirt1: [">{#p/basic}{~}（情不自禁\n地臉紅）"],
      invisStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* Doggo找不到你了。"],
      name: "* Doggo",
      fetchStatus: [">{#p/story}* Doggo喜歡巡迴遊戲！"],
      fetchpet: [">{#p/human}* （但是Doggo忙於尋找扳手，\n  沒時間讓你摸。）"],
      fetchflirt: [">{#p/human}* （但是Doggo忙於尋找扳手，\n  沒時間聽你說話。）"],
      fetchcuddle: [">{#p/human}* （但是Doggo忙於尋找扳手，\n  沒時間讓你抱。）"],
      normaStatus: () => (world.goatbro ? [">{#p/asriel2}* Doggo。"] : [">{#p/story}* Doggo知道你在這裡。"]),
      pet: () => [
         ">{#p/human}* （你摸了摸Doggo。）",
         ...(world.goatbro
            ? [
      ...
      petStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* Doggo已經被摸過了。"],
      petTalk1: [">{#p/basic}{~}啥！！！\n我被摸了！"],
      ...
      status1: () => (world.goatbro ? [">{#p/asriel2}* Doggo。"] : [">{#p/story}* Doggo擋住了去路！"]),
      sussy: () =>
         world.goatbro ? [">{#p/asriel2}* Doggo。"] : [">{#p/basic}* Doggo對你的行動\n  十分戒備。"]
   },
   b_opponent_lesserdog: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Canis Minor，一條蠢狗。\n* 估計他都不知道自己為啥在這。"]
      ...
      status0: () => (world.goatbro ? [">{#p/asriel2}* Canis Minor。"] : [">{#p/story}* Canis Minor出現了。"]),
      status1: () =>
         world.goatbro
      ...
      status5: () =>
         world.goatbro ? [">{#p/asriel2}* Canis Minor。"] : [">{#p/story}* Canis Minor在興奮地汪汪叫。"],
      status6: () =>
   ...
   b_opponent_dogamy: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Dogamy，一條廢狗。\n* 純靠他的瘋狗老婆過活。"]
            : [">{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的老公。\n* 只認識他聞到的東西。"],
      act_check2: [">{#p/story}* DOGAMY - 14攻擊 5防禦\n* 新近喪偶。\n* 只認識失去老婆的痛苦。"],
      act_check3: [">{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的老公。\n* 認識的東西比先前更多了。"],
      act_check4: [">{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的丈夫。\n* 並不介意分享...？"],
      act_check5: [">{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的老公。\n* 並不介意離開...？"],
      fetchText: [
         ">{#p/human}* （你將扳手扔了出去。）\n* （狗狗們跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）"
      ],
      fetchTextLone: () => [
      ...
      flirtTextLone: [">{#p/human}* （你對Dogamy調情。）", ">{#p/basic}* Dogamy的表情沒有發生變化。"],
      loneStatus: () =>
         world.goatbro
            ? [">{#p/asriel2}* 只剩一個了。"]
      ...
      petText: [">{#p/human}* （你撫摸了Dogamy。）"],
      petTextLone: [">{#p/human}* （你嘗試撫摸Dogamy，\n  但他畏懼地縮起自己的頭。）"],
      randTalk1: () =>
         world.goatbro
      ...
      resmellTextLone: [">{#p/human}* （你讓Dogamy聞聞你，\n  但他連鼻子都沒抬一下。）"],
      rollStatus: () =>
         world.goatbro
   ...
   b_opponent_dogaressa: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Dogaressa，一條瘋狗。\n* 沒了她老公，分分鐘發瘋。"]
            : [">{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 這隻小狗認為她丈夫很可愛。\n  僅限於氣味的那種？"],
      act_check2: [">{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 這隻小狗非常想念她的老公\n  僅限於被殺掉後的那種？"],
      act_check3: [">{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 對這隻小狗來說\n  事態進展得很順利。"],
      act_check4: [
         ">{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 這隻小狗發覺可愛的東西\n  不只有她老公。"
      ],
      ...
      flirtText: [
         ">{#p/human}* （你對Dogaressa調情。）",
         ">{#p/basic}* 你的... 資訊素，\n  傳到了Dogaressa的鼻子上。"
      ],
      flirtTextLone: [
         ">{#p/human}* （你對Dogaressa調情。）",
         ">{#p/basic}* Dogaressa的表情沒有發生變化。"
      ],
      loneStatus: () =>
      ...
      petText: [">{#p/human}* （你撫摸了Dogaressa。）"],
      petTextLone: [">{#p/human}* （你試圖撫摸Dogaressa，\n  但她只是對你低吼。）"],
      ...
      resmellTextLone: [
         ">{#p/human}* （你激勵Dogaressa來聞聞你，\n  她用鼻子使勁在你臉上\n  蹭來蹭去。）"
      ],
      rollTextLone: () => [
         ">{#p/human}* （你在Dogamy的塵埃裡打了幾個滾。）",
   ...
   b_opponent_greatdog: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Canis Major，一條傻狗。\n* 這群狗裡面，\n  屬它頭腦簡單，四肢發達。"]
            : [">{#p/story}* CANIS MAJOR - 15攻擊 8防禦\n* 太過興奮，以至於將\n  戰鬥當作兒戲。"],
      act_check2: [">{#p/story}* CANIS MAJOR - 15攻擊 8防禦\n* 渴望著關愛與照顧..."],
      act_check3: [">{#p/story}* CANIS MAJOR - 15攻擊 8防禦\n* 已經累到虛脫了。"],
      act_flirt: [
         ">{#p/human}* （你對Canis Major調情。）",
         ">{#p/basic}* Canis Major尷尬地歪著頭。"
      ],
      beckonText: [
      ...
      closeStatus: () =>
         world.goatbro ? [">{#p/asriel2}* Canis Major。"] : [">{#p/story}* Canis Major渴望著關愛。"],
      closeText: [">{#p/human}* （你叫了叫Canis Major。）\n* （但狗狗只是豎了豎耳朵。）"],
      doneText: [">{#p/basic}* Canis Major覺得你太無趣了。"],
      fetch: () =>
         world.goatbro
            ? [
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 離死不遠了。"] : [">{#p/story}* Canis Major正緩緩地喘著氣。"],
      ignoreStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* Canis Major。"]
            : [">{#p/story}* Canis Major只是想要一些關愛。"],
      ignoreStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* Canis Major。"] : [">{#p/story}* Canis Major正在賣萌。"],
      name: "* Canis Major",
      fetchStatus: [">{#p/story}* Canis Major喜歡巡迴遊戲！"],
      petStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* Canis Major。"]
            : [">{#p/story}* Canis Major正用前爪拍打著地面。"],
      petStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* Canis Major。"] : [">{#p/story}* Canis Major想要溫柔的關愛。"],
      petStatus3: () =>
         world.goatbro ? [">{#p/asriel2}* ..."] : [">{#p/story}* 撫摸能量，百分之四十！"],
      petStatus4: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一擊。"] : [">{#p/story}* Canis Major非常滿足。"],
      petText0: [">{#p/human}* （但是Canis Major離你太遠了，\n  你摸不著它。）"],
      petText1: [
         ">{#p/human}* （Canis Major享受著你的撫摸，\n  它把整個身子都蜷縮在你的腿上。）",
         ">* （它太舒服了，呼呼睡著了。）",
         ">* （狗子打呼著，打呼著...）",
         ">* （...然後它醒了。）",
         ">{#p/basic}* Canis Major的興奮度\n  毫無徵兆地增加了！"
      ],
      petText2: [
         ">{#p/human}* （你想摸摸狗子...）",
         ">* （...然而它的興奮能量\n  形成了一個反撫摸能量場。）"
      ...
      petText5: [
         ">{#p/human}* （你揉了揉狗狗的肚皮。）",
         ">{#p/basic}* Canis Major幸福地嗚叫著。"
      ],
      playText1: [">{#p/human}* （但Canis Major不夠興奮，\n  不能和你一起玩。）"],
      playText2: [
         ">{#p/human}* （你變幻出了全息影像，想\n  讓狗狗去追趕它。）",
         ">* （最終，全息影像無法聚合，\n  自動消散了。）",
         ">* （Canis Major收集了這個區域\n  殘存的所有能量，並將其\n  帶還給你。）",
         ">{#p/basic}* 疲憊的Canis Major把頭\n  靠在了你身邊..."
      ],
      playText3: [">{#p/basic}* Canis Major精疲力盡，\n  不想再玩了。"],
      playText4: [">{#p/human}* （但是Canis Major已經開始在玩\n  巡迴遊戲了。）"],
      status0: () => (world.goatbro ? [">{#p/asriel2}* Canis Major。"] : [">{#p/story}* Canis Major出現了。"]),
      status1: () =>
         world.goatbro ? [">{#p/asriel2}* Canis Major。"] : [">{#p/story}* Canis Major正緊緊地注視著你。"],
      status2: () =>
         world.goatbro
            ? [">{#p/asriel2}* Canis Major。"]
      ...
      status3: () =>
         world.goatbro
            ? [">{#p/asriel2}* Canis Major。"]
            : [">{#p/story}* 有股鮮榨小狗汁的味道。"],
      waitText: [">{#p/basic}* Canis Major逐漸向你靠近。"]
   },
   b_opponent_papyrus: {
      act_flirt: [">{#p/human}* （你向Papyrus調情。）"],
      act_insult: [">{#p/human}* （你罵了Papyrus一頓。）"],
      ...
      act_check: () =>
         world.genocide
            ? [">{#p/story}* PAPYRUS - 攻擊3 防禦3\n* 亡兄之弟。"]
            : papreal()
               ? [">{#p/story}* PAPYRUS - 攻擊3 防禦3\n* 依然相信著你。"]
               : [">{#p/story}* PAPYRUS - 攻擊20 防禦20\n* 喜歡說「捏嘿嘿！」"],
      act_check2: [">{#p/story}* PAPYRUS - 攻擊20 防禦20\n* 一切都很順利。"],
      act_check3: [">{#p/story}* PAPYRUS - 攻擊20 防禦20\n* 最最最仁慈的衛兵！"],
      capture1: [
      ...
      death2: () =>
         world.genocide
            ? [">{#p/papyrus}{#f/21}SANS，我...", ">{#f/33}{@random=1.1/1.1}我讓你失望了..."]
            : papreal()
               ? [
      ...
      flirt7: [">{#p/human}* （但Papyrus現在忙於戰鬥，\n  沒時間聽你說話。）"],
      flirtStatus1: [">{#p/story}* Papyrus正在為約會考慮\n  要穿什麼。"],
      flirtStatus2: [">{#p/story}* Papyrus往他耳後拍了些\n  骨龍水。"],
      flirtStatus3: [">{#p/story}* Papyrus正在為約會考慮\n  要煮什麼。"],
      flirtStatus4: [">{#p/story}* Papyrus往他耳後拍了些\n  番茄醬。"],
      flirtStatus5: [">{#p/story}* Papyrus正在想{@fill=#ff0}方色{@fill=#fff}法\n  變得出名。"],
      flirtStatus6: [">{#p/story}* Papyrus往他耳後拍了些\n  MTT牌面霜。"],
      flirtStatus7: [">{#p/story}* Papyrus往他耳後拍了些\n  MTT牌動漫粉。"],
      flirtStatus8: [">{#p/story}* Papyrus往他耳後拍了些\n  MTT牌可愛汁。"],
      flirtStatus9: [">{#p/story}* Papyrus意識到他沒有耳朵。"],
      flirtStatus10: [">{#p/story}* Papyrus頭上隨便貼了一些藥膏。"],
      flirtStatus11: [">{#p/story}* ...他還在想{@fill=#ff0}方色{@fill=#fff}法\n  變得出名。"],
      hurtStatus: [">{#p/story}* Papyrus要被打敗了。"],
      ...
      insult4: [">{#p/human}* （但Papyrus現在忙於戰鬥，\n  沒時間聽你說話。）"],
      name: "* Papyrus",
      randomStatus1: [">{#p/story}* Papyrus正在準備一記\n  骨頭攻擊。"],
      randomStatus2: [">{#p/story}* Papyrus準備了一記非骨頭攻擊，\n  然後花了一分鐘的時間來糾正錯誤。"],
      randomStatus3: [">{#p/story}* Papyrus正在做飯。"],
      randomStatus4: [">{#p/story}* Papyrus悄悄說了一句「捏嘿嘿！」"],
      randomStatus5: [">{#p/story}* Papyrus正在左右搖晃他的骨頭。"],
      randomStatus6: [">{#p/story}* Papyrus正在努力扮酷。"],
      randomStatus7: [">{#p/story}* Papyrus正在考慮他的選擇。"],
      ...
      specialStatus3: [">{#p/story}* Papyrus將所有邏輯都拋之腦後。"],
      specialStatus4: [">{#p/story}* Papyrus發覺自己有些缺乏邏輯，\n  又把它撈回來了。"],
      specialStatus5: [">{#p/story}* Papyrus汗流浹背。"],
      specialStatus6: [">{#p/story}* Papyrus已經束手無策了。"],
      status1: [">{#p/story}* Papyrus正在饒恕你。"],
      status2: [">{#p/story}* Papyrus擋住了去路！"],
      ...
      turnTalk6: () =>
         world.postnoot
            ...
            : [">{#p/papyrus}{#f/20}PAPYRUS:\n皇家衛隊成員！"],
      turnTalk7: [">{#p/papyrus}{#f/10}UNDYNE一定會\n為我感到驕傲！！"],
      ...
      secretInsult6: [
         ...
         ">{#p/papyrus}{#f/21}蠢貨...",
         ">{#p/papyrus}{#f/21}星辰大海...",
         ">{#p/papyrus}{#f/20}有顆星星，TWINKLY，\n他也喜歡叫人「蠢貨」！",
         ">{#p/papyrus}{#f/25}我...",
         ">{#p/papyrus}{#f/22}我才反應過來\n是怎麼回事！",
         ">{#p/papyrus}{#f/20}那個「ASRIEL」好像\n也喜歡罵人蠢貨！",
         ">{#p/papyrus}{#f/24}也就是說...",
