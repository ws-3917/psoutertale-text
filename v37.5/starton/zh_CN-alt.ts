...
export default {
   a_starton: {
      ...
      genotext: {
         ...
         asriel30c: [">{*}{#p/asgore}{#f/8}* 艾斯利尔，求你别走！\n* 我只是想帮你！{^999}"],
         asriel30d: () =>
            [
               [">{#p/asriel2}{#f/3}* 做好准备，$(name)。", ">{#f/4}* 这儿可是安黛因的地盘。"],
               [">{#p/asriel2}{#f/4}* 带路吧。"]
         ...
         papyrusSolo4e: [">{#p/papyrus}{#f/34}你才不是{@fill=#f00}艾斯利尔{@fill=#fff}。"],
         papyrusSolo4f: [
            ">{#f/5}{@fill=#f00}艾斯利尔{@fill=#fff}绝不可能\n干出这种事！",
            ">{#f/31}因为，{@fill=#f00}艾斯利尔{@fill=#fff}心地善良，",
            ">{#f/5}信赖同胞...",
            ">{#f/31}比谁都相信人类！",
            ">{#f/4}而你呢...",
            ">{#f/7}你不过是个为了\n一己私欲利用人类的\n卑鄙小人！",
      ...
      maze3a: [
         ">“火焰之墙”！！",
         ">{#p/sans}* 你直接叫它“火墙”\n  不就行了吗？\n* 这样多省事。",
         ">{#p/papyrus}{#f/4}艾菲斯博士会觉得\n我用错词了的。",
         ">{#p/sans}* 我不太确定，兄弟。\n  她真的很喜欢那种东西。\n  实际上...",
         ">{#f/2}* 这里毕竟是个\n  {@fill=#ff0}热火{@fill=#fff}朝天的地方。"
      ],
      maze4: [">{#p/papyrus}{#x3}{#f/7}别说了，衫斯！！"],
      maze5: () =>
         world.edgy
            ? [
               ">{#p/sans}{#f/0}* 这是“火墙”。",
      ...
      papsink5: [">{#p/papyrus}{#f/7}衫斯！", ">别再用配乐\n打扰我的生活了！！"],
   ...
   b_group_starton: {
      ...
      stardrakeSpacetop2d: () => (world.goatbro ? [">{#p/asriel2}* 杰瑞。"] : [">{#p/story}* 杰瑞。"]),
   ...
   b_opponent_doggo: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 遁狗，一条不顺眼的狗。\n* 这个蠢货怎么又上岗了？"]
            : [">{#p/story}* 遁狗 - 攻击13 防御7\n* 一点风吹草动便能让它兴奋。\n* 喜好之一：拥抱。"],
      act_check2: [">{#p/story}* 遁狗 - 攻击13 防御7\n* 甚至难以看见它自己..."],
      act_check3: [">{#p/story}* 遁狗 - 攻击13 防御7\n* 一只非常兴奋的狗，\n  正在享受其所好。"],
      act_check4: [">{#p/story}* 遁狗 - 攻击13 防御7\n* 在你眼里，这只狗在生活中\n  非常地孤独。"],
      act_flirt: () => [">{#p/human}* （你对遁狗调情。）"],
      act_cuddle: () => [">{#p/human}* （你紧紧地抱住遁狗。）"],
      fetch: () => [
         ">{#p/human}* （你将扳手扔了出去。）\n* （狗狗跑出去捡了回来。）\n* （你们就这样玩了一会巡回游戏。）"
      ],
      ...
      flirt1: [">{#p/basic}{~}（情不自禁\n地脸红）"],
      invisStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一击。"] : [">{#p/story}* 遁狗找不到你了。"],
      name: "* 遁狗",
      fetchStatus: [">{#p/story}* 遁狗喜欢巡回游戏！"],
      fetchpet: [">{#p/human}* （但是遁狗忙于寻找扳手，\n  没时间让你摸。）"],
      fetchflirt: [">{#p/human}* （但是遁狗忙于寻找扳手，\n  没时间听你说话。）"],
      fetchcuddle: [">{#p/human}* （但是遁狗忙于寻找扳手，\n  没时间让你抱。）"],
      normaStatus: () => (world.goatbro ? [">{#p/asriel2}* 遁狗。"] : [">{#p/story}* 遁狗知道你在这里。"]),
      pet: () => [
         ">{#p/human}* （你摸了摸遁狗。）",
         ...(world.goatbro
            ? [
      ...
      petStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一击。"] : [">{#p/story}* 遁狗已经被摸过了。"],
      petTalk1: [">{#p/basic}{~}啥！！！\n我被摸了！"],
      ...
      status1: () => (world.goatbro ? [">{#p/asriel2}* 遁狗。"] : [">{#p/story}* 遁狗挡住了去路！"]),
      sussy: () =>
         world.goatbro ? [">{#p/asriel2}* 遁狗。"] : [">{#p/basic}* 遁狗对你的行动\n  十分戒备。"]
   },
   b_opponent_lesserdog: {
      ...
      status0: () => (world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* 小犬座出现了。"]),
      status1: () =>
         world.goatbro
            ? [">{#p/asriel2}* 小犬座。"]
      ...
      status5: () =>
         world.goatbro ? [">{#p/asriel2}* 小犬座。"] : [">{#p/story}* 小犬座在兴奋地汪汪叫。"],
      status6: () =>
   ...
   b_opponent_dogamy: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 狗来米，一条废狗。\n* 纯靠他的疯狗老婆过活。"]
            : [">{#p/story}* 狗来米 - 14攻击 5防御\n* 狗媳儿的老公。\n* 只认识他闻到的东西。"],
      act_check2: [">{#p/story}* 狗来米 - 14攻击 5防御\n* 新近丧偶。\n* 只认识失去老婆的痛苦。"],
      act_check3: [">{#p/story}* 狗来米 - 14攻击 5防御\n* 狗媳儿的老公。\n* 认识的东西比先前更多了。"],
      act_check4: [">{#p/story}* 狗来米 - 14攻击 5防御\n* 狗媳儿的丈夫。\n* 并不介意分享...？"],
      act_check5: [">{#p/story}* 狗来米 - 14攻击 5防御\n* 狗媳儿的老公。\n* 并不介意离开...？"],
      fetchText: [
         ">{#p/human}* （你将扳手扔了出去。）\n* （狗狗们跑出去捡了回来。）\n* （你们就这样玩了一会巡回游戏。）"
      ],
      fetchTextLone: () => [
      ...
      flirtTextLone: [">{#p/human}* （你对狗来米调情。）", ">{#p/basic}* 狗来米的表情没有发生变化。"],
      loneStatus: () =>
         world.goatbro
            ? [">{#p/asriel2}* 只剩一个了。"]
            : [">{#p/story}* 狗媳儿一心想要踢\n  人类的尾巴。"],
      ...
      petText: [">{#p/human}* （你抚摸了狗来米。）"],
      petTextLone: [">{#p/human}* （你尝试抚摸狗来米，\n  但他畏惧地缩起自己的头。）"],
      randTalk1: () =>
         world.goatbro
      ...
      resmellTextLone: [">{#p/human}* （你让狗来米闻闻你，\n  但他连鼻子都没抬一下。）"],
      rollStatus: () =>
         world.goatbro
   ...
   b_opponent_dogaressa: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 狗媳儿，一条疯狗。\n* 没了她老公，分分钟发疯。"]
            : [">{#p/story}* 狗媳儿 - 14攻击 5防御\n* 这只小狗认为她丈夫很可爱。\n  仅限于气味的那种？"],
      act_check2: [">{#p/story}* 狗媳儿 - 14攻击 5防御\n* 这只小狗非常想念她的老公\n  仅限于被杀掉后的那种？"],
      act_check3: [">{#p/story}* 狗媳儿 - 14攻击 5防御\n* 对这只小狗来说\n  事态进展得很顺利。"],
      act_check4: [
         ">{#p/story}* 狗媳儿 - 14攻击 5防御\n* 这只小狗发觉可爱的东西\n  不只有她老公。"
      ],
      ...
      petText: [">{#p/human}* （你抚摸了狗媳儿。）"],
      petTextLone: [">{#p/human}* （你试图抚摸狗媳儿，\n  但她只是对你低吼。）"],
   ...
   b_opponent_greatdog: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座，一条傻狗。\n* 这群狗里面，\n  属它头脑简单，四肢发达。"]
            : [">{#p/story}* 大犬座 - 15攻击 8防御\n* 太过兴奋，以至于将\n  战斗当作儿戏。"],
      act_check2: [">{#p/story}* 大犬座 - 15攻击 8防御\n* 渴望着关爱与照顾..."],
      act_check3: [">{#p/story}* 大犬座 - 15攻击 8防御\n* 已经累到虚脱了。"],
      act_flirt: [
         ">{#p/human}* （你对大犬座调情。）",
         ">{#p/basic}* 大犬座尴尬地歪着头。"
      ],
      ...
      closeStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座渴望着关爱。"],
      closeText: [">{#p/human}* （你叫了叫大犬座。）\n* （但狗狗只是竖了竖耳朵。）"],
      doneText: [">{#p/basic}* 大犬座觉得你太无趣了。"],
      fetch: () =>
         world.goatbro
            ? [
               ">{#p/human}* （你扔出扳手。）\n* （大犬座把它吸收进自己的身体，\n  然后若无其事地继续玩耍。）",
      ...
      hurtStatus: () =>
         world.goatbro ? [">{#p/asriel2}* 离死不远了。"] : [">{#p/story}* 大犬座正缓缓地喘着气。"],
      ignoreStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 大犬座只是想要一些关爱。"],
      ignoreStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座正在卖萌。"],
      name: "* 大犬座",
      fetchStatus: [">{#p/story}* 大犬座喜欢巡回游戏！"],
      petStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 大犬座正用前爪拍打着地面。"],
      petStatus2: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座想要温柔的关爱。"],
      petStatus3: () =>
         world.goatbro ? [">{#p/asriel2}* ..."] : [">{#p/story}* 抚摸能量，百分之四十！"],
      petStatus4: () =>
         world.goatbro ? [">{#p/asriel2}* 不堪一击。"] : [">{#p/story}* 大犬座非常满足。"],
      petText0: [">{#p/human}* （但是大犬座离你太远了，\n  你摸不着它。）"],
      petText1: [
         ">{#p/human}* （大犬座享受着你的抚摸，\n  它把整个身子都蜷缩在你的腿上。）",
         ">* （它太舒服了，呼呼睡着了。）",
         ">* （狗子打呼着，打呼着...）",
      ...
      playText3: [">{#p/basic}* 大犬座精疲力尽，\n  不想再玩了。"],
      playText4: [">{#p/human}* （但是大犬座已经开始在玩\n  巡回游戏了。）"],
      status0: () => (world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座出现了。"]),
      status1: () =>
         world.goatbro ? [">{#p/asriel2}* 大犬座。"] : [">{#p/story}* 大犬座正紧紧地注视着你。"],
      status2: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 大犬座正等待你的指令。"],
      status3: () =>
         world.goatbro
            ? [">{#p/asriel2}* 大犬座。"]
            : [">{#p/story}* 有股鲜榨小狗汁的味道。"],
      waitText: [">{#p/basic}* 大犬座逐渐向你靠近。"]
   },
   b_opponent_papyrus: {
      act_flirt: [">{#p/human}* （你向帕派瑞斯调情。）"],
      act_insult: [">{#p/human}* （你骂了帕派瑞斯一顿。）"],
      ...
      act_check: () =>
         world.genocide
            ? [">{#p/story}* 帕派瑞斯 - 攻击3 防御3\n* 亡兄之弟。"]
            : papreal()
               ? [">{#p/story}* 帕派瑞斯 - 攻击3 防御3\n* 依然相信着你。"]
               : [">{#p/story}* 帕派瑞斯 - 攻击20 防御20\n* 喜欢说“捏嘿嘿！”"],
      act_check2: [">{#p/story}* 帕派瑞斯 - 攻击20 防御20\n* 一切都很顺利。"],
      act_check3: [">{#p/story}* 帕派瑞斯 - 攻击20 防御20\n* 最最最仁慈的卫兵！"],
      capture1: [
      ...
      death2: () =>
         world.genocide
            ? [">{#p/papyrus}{#f/21}衫斯，我...", ">{#f/33}{@random=1.1/1.1}我让你失望了..."]
            : papreal()
               ? [
      ...
      flirt7: [">{#p/human}* （但帕派瑞斯现在忙于战斗，\n  没时间听你说话。）"],
      flirtStatus1: [">{#p/story}* 帕派瑞斯正在为约会考虑\n  要穿什么。"],
      flirtStatus2: [">{#p/story}* 帕派瑞斯往他耳后拍了些\n  骨龙水。"],
      flirtStatus3: [">{#p/story}* 帕派瑞斯正在为约会考虑\n  要煮什么。"],
      flirtStatus4: [">{#p/story}* 帕派瑞斯往他耳后拍了些\n  番茄酱。"],
      flirtStatus5: [">{#p/story}* 帕派瑞斯正在想{@fill=#ff0}方色{@fill=#fff}法\n  变得出名。"],
      flirtStatus6: [">{#p/story}* 帕派瑞斯往他耳后拍了些\n  镁塔牌面霜。"],
      flirtStatus7: [">{#p/story}* 帕派瑞斯往他耳后拍了些\n  镁塔牌动漫粉。"],
      flirtStatus8: [">{#p/story}* 帕派瑞斯往他耳后拍了些\n  镁塔牌可爱汁。"],
      flirtStatus9: [">{#p/story}* 帕派瑞斯意识到他没有耳朵。"],
      flirtStatus10: [">{#p/story}* 帕派瑞斯头上随便贴了一些药膏。"],
      flirtStatus11: [">{#p/story}* ...他还在想{@fill=#ff0}方色{@fill=#fff}法\n  变得出名。"],
      hurtStatus: [">{#p/story}* 帕派瑞斯要被打败了。"],
      ...
      insult4: [">{#p/human}* （但帕派瑞斯现在忙于战斗，\n  没时间听你说话。）"],
      name: "* 帕派瑞斯",
      randomStatus1: [">{#p/story}* 帕派瑞斯正在准备一记\n  骨头攻击。"],
      randomStatus2: [">{#p/story}* 帕派瑞斯准备了一记非骨头攻击，\n  然后花了一分钟的时间来纠正错误。"],
      randomStatus3: [">{#p/story}* 帕派瑞斯正在做饭。"],
      randomStatus4: [">{#p/story}* 帕派瑞斯悄悄说了一句“捏嘿嘿！”"],
      randomStatus5: [">{#p/story}* 帕派瑞斯正在左右摇晃他的骨头。"],
      randomStatus6: [">{#p/story}* 帕派瑞斯正在努力扮酷。"],
      randomStatus7: [">{#p/story}* 帕派瑞斯正在考虑他的选择。"],
      ...
      specialStatus3: [">{#p/story}* 帕派瑞斯将所有逻辑都抛之脑后。"],
      specialStatus4: [">{#p/story}* 帕派瑞斯发觉自己有些缺乏逻辑，\n  又把它捞回来了。"],
      specialStatus5: [">{#p/story}* 帕派瑞斯汗流浃背。"],
      specialStatus6: [">{#p/story}* 帕派瑞斯已经束手无策了。"],
      status1: [">{#p/story}* 帕派瑞斯正在饶恕你。"],
      status2: [">{#p/story}* 帕派瑞斯挡住了去路！"],
      ...
      turnTalk6: () =>
         world.postnoot
            ...
            : [">{#p/papyrus}{#f/20}帕派瑞斯:\n皇家卫队成员！"],
      turnTalk7: [">{#p/papyrus}{#f/10}安黛因一定会\n为我感到骄傲！！"],
      ...
      secretInsult6: [
         ...
         ">{#p/papyrus}{#f/21}蠢货...",
         ">{#p/papyrus}{#f/21}星辰大海...",
         ">{#p/papyrus}{#f/20}有颗星星，闪闪，\n他也喜欢叫人“蠢货”！",
         ">{#p/papyrus}{#f/25}我...",
         ">{#p/papyrus}{#f/22}我才反应过来\n是怎么回事！",
         ">{#p/papyrus}{#f/20}那个“艾斯利尔”好像\n也喜欢骂人蠢货！",
         ">{#p/papyrus}{#f/24}也就是说...",
   ...
   b_opponent_shockasgore: {
      act_check: [">{#p/asriel2}* 艾斯戈尔。\n* 亲手葬送自己家园的昏君。"],
      act_hug: [">{#p/human}* （你想抱抱艾斯戈尔...）"],
