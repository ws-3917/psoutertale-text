...
export default {
   a_starton: {
      ...
      nicecreamScoreReaction4a: ['>{#p/basic}* You seem pretty good at this...'],
      ...
      jukebox0: [">{#p/basic}* It's out of service."],
      jukebox1: () => [
         SAVE.data.b.svr
      ...
      jukebox1x2: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* (But you couldn't play a song you didn't know yet.)"]
            : [">{#p/basic}* The cover depicts a spooky DJ at their computer.\n* You can't know this song."],
      jukebox1x3: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* (But you couldn't play a song you didn't know yet.)"]
            : [
      ...
      shockpapyrus0a: [
         '>{#p/papyrus}{#e/papyrus/27}WHAT ON KRIOS IS GOING ON HERE??',
         '>{#p/papyrus}{#e/papyrus/21}I ANSWER A PHONE CALL FROM MY BALCONY...',
         '>{#p/papyrus}{#e/papyrus/19}AND THIS IS WHERE IT LEADS ME!?',
         ">{#p/papyrus}{#e/papyrus/14}I'LL HAVE YOU KNOW, I'M A SHOE-IN FOR THE ROYAL GUARD.",
         '>{#p/papyrus}{#e/papyrus/15}SO, WHATEVER YOU TWO ARE PLANNING...'
      ],
      shockpapyrus0b: [
         '>{#p/papyrus}{#e/papyrus/24}... WAIT, THAT VOICE...',
         '>{#p/papyrus}{#e/papyrus/22}ARE YOU THE ONE WHO CALLED ME ON THE PHONE EARLIER!?'
      ],
      shockpapyrus0c: [
         '>{#p/papyrus}{#e/papyrus/20}... OF COURSE!\nTHAT EXPLAINS EVERYTHING!',
         ">{#p/papyrus}{#e/papyrus/10}WELL THEN.\nI'M GLAD TO HAVE FINALLY MET YOU.",
         '>{#p/papyrus}{#e/papyrus/24}TO BE HONEST, YOU KIND OF REMIND ME OF...',
         '>{#p/papyrus}{#e/papyrus/20}... HEY, WAIT A SECOND!!',
         '>{#p/papyrus}{#e/papyrus/22}DID YOU BRING A -HUMAN- WITH YOU!?!?',
         '>{#p/papyrus}{#e/papyrus/10}WOWIE!!\nTHIS JUST GETS BETTER AND BETTER!!',
         '>{#p/papyrus}{#e/papyrus/20}SO, WHAT ARE WE DOING HERE ANYWAY?'
      ],
      shockpapyrus1: () =>
         [
            [
      ...
      shockpapyrus2c: [
         ...
         '>{#p/asriel2}* The force that rips them apart.'
      ],
      shockpapyrus2d: ['>{#p/asriel2}* Fight... the ideal choice.', '>{#p/asriel2}* Hee hee hee...'],
      sansDeath1: [">{#p/papyrus}{#e/papyrus/27}SANS!\nYOU'RE HURT!"],
      sansDeath2: [">{#p/sans}papyrus, didn't i tell you to stay at home?", '{*}{#e/papyrus/21}{%}'],
      sansDeath3: [">{#p/sans}... don't worry bro, it's just yamok sauce.", '{*}{#e/papyrus/26}{%}'],
      sansDeath4: [">{#p/papyrus}{#e/papyrus/21}BUT YOU'RE HURT..."],
      sansDeath5: [
         ">{#p/sans}yeah, that's what happens when you act on instinct.",
         '>{#p/sans}... not much i can do about it now.',
         '{*}{#e/papyrus/21}{%}'
      ],
      sansDeath6: [
         '>{#p/sans}so...',
         ...
         '>...',
         '>just...',
         ">promise me you'll be fine without me, bro.",
         ">promise me you'll be g-{^5}great.",
         '>...',
         '>after all...'
      ],
      sansDeath7: [">{|}{#p/sans}you're the... great p-{^5}papyrus.{^20}{%}"],
      sansDeath8: ['>{#p/papyrus}{#e/papyrus/33}N-NO...{^40}{%}'],
      fast_food1: () => [
         SAVE.data.b.fryz
      ...
      emptytable2: () =>
         SAVE.data.b.svr
            ? ['>{#p/human}* (The table strikes you as being rather lonesome.)']
            : [">{#p/basic}* It's just a lonely table.\n* Smells like hair."],
      balcony0: () => ['>{#p/papyrus}ENJOYING THE VIEW?', choicer.create('* (What do you say?)', 'Yes', 'No')],
      balcony1: [
      ...
      crossword0: () =>
         world.edgy
            ...
            : [
               '>{#p/papyrus}{#f/9}HUMAN!!',
               '>{#f/9}YOU HAVE SEEN MY PUZZLES.',
               '>{#f/4}BUT WHAT YOU ARE ABOUT TO SEE IS...'
            ],
      crossword1: () =>
         world.edgy
            ? [
      ...
      crossword2: (check: boolean) =>
         world.edgy
            ...
            : [
               ...
               '>{#p/papyrus}{#f/1}WHAT!? KAKURO!?',
               ">{#f/9}I CAN'T BELIEVE YOU SAID THAT!!",
               '>{#f/4}IN MY OPINION...',
               '>{#f/0}SUDOKU IS EASILY THE HARDEST.',
               '>{#p/sans}* what? really, dude?\n* that easy-peasy number shuffle?',
               ">{#f/4}* that's for baby bones.",
               '>{#p/papyrus}{#f/4}UN. BELIEVABLE.',
               '>{#f/9}HUMAN!!!\nSOLVE THIS DISPUTE!',
      ...
      crossword3a: [
         ...
         '>IF THEY ALSO FIND SUDOKU SO DIFFICULT!',
         '>{#f/9}NYEH! HEH! HEH HEH!'
      ],
      crossword3b: [
         '>{#p/papyrus}{#f/9}YOU TWO ARE WEIRD!',
         '>{#f/0}KAKURO PUZZLES ARE SO EASY.',
         ">IT'S THE SAME SOLUTION EVERY TIME.",
         '>{#f/4}I JUST FILL ALL THE BOXES IN WITH THE LETTER "Z"...',
         '>{#f/4}BECAUSE EVERY TIME I LOOK AT A KAKURO...',
         '>{#f/9}ALL I CAN DO IS SNORE!!!'
      ],
      crossword3c: [
      ...
      genotext: {
         ...
         asriel5: ['>{*}{#p/papyrus}{#f/1}WHAT THE- {%}'],
         asriel6: () =>
            [
               [
                  '>{#p/asriel2}{#f/13}* ... $(name), do you...',
                  '>{#f/17}* Do you think you could take over from here?',
                  ">{#f/15}* Not that anything's wrong with me, but...",
                  ">{#f/16}* I just think you'd be better at this than I am.",
         ...
         asriel26: () =>
            [
               [
                  ">{#p/asriel2}{#f/3}* Well, that's the canine unit gone.",
                  '>{#p/asriel2}{#f/4}* Only one bridge left between us and town.',
                  '>{#f/1}* ... stay behind me.'
               ],
            ...
            [
               SAVE.data.b.papyrus_secret
                  ...
                  : [
                     ...
                     ">{#f/1}* We've got bigger fish to fry."
                  ],
         ...
         asriel30b: [
            ...
            '>{#p/asriel2}{#f/8}* ...',
            '>{|}{#p/asgore}{#f/3}* Look, son, I simply- {%}',
         ...
         asriel30d: () =>
            [
               ['>{#p/asriel2}{#f/3}* Ready yourself, $(name).', ">{#f/4}* This is Undyne's domain."],
         ...
         papyrusSolo1a: [
            ...
            ">{#f/5}IT IS, ISN'T IT?",
            '>{#f/32}NYEH...\nUNDYNE WILL FINALLY...',
            ">{#p/papyrus}{#f/31}I'LL GET TO JOIN THE ROYAL GUARD...",
            ">{#f/5}DOESN'T THAT MAKE YOU HAPPY?",
            ...
            ">{#p/papyrus}{#f/6}BUT IT CAN'T BE...\nSANS, HE...",
            '>{#f/31}HE PROMISED...',
            ">{#p/asriel2}{#f/8}* That bonehead is the LAST person I'd trust to keep a promise.",
            ">{#f/9}* Not that I'm any better.", // he smirks when he says this
            '>{#p/papyrus}{#f/31}...',
            ">{#f/3}I'M SORRY.\nI HAVE TO GO..."
         ],
         papyrusSolo2a: [
            '>{#p/papyrus}{#f/31}WELL, I JUST GOT BACK FROM UNDYNE...',
            '>{#f/31}SHE TELLS ME THE KING HAS AN OFFER FOR YOU.',
            '>{#p/asriel2}{#f/6}* ...',
            '>{#p/papyrus}{#f/3}HIS EXACT WORDS WERE "I WANT TO SEE MY SON."',
            '>{#f/7}...',
            // i can't believe it's not butter
            ">{#f/7}I CAN'T BELIEVE THE PRINCE KILLED MY BROTHER!",
            '>{|}{#p/asriel2}{#f/8}* Actually, it was you we were trying to- {%}',
            '>{#p/papyrus}{#f/7}ENOUGH!!',
            '>{#f/7}YOU BETRAYED YOUR OWN SOCIETY!\nYOUR OWN PEOPLE!',
            '>{#f/7}AND FOR WHAT!?',
            '>{#f/7}A PETTY ATTEMPT AT SELF-AMUSEMENT?',
            ">{#p/asriel2}{#f/16}* Yes, Papyrus.\n* That's exactly what this is for.",
            '>{#p/papyrus}{#f/7}... UGH!!',
            '>{#p/papyrus}{#f/4}AS FOR YOU, HUMAN...',
            ">{#f/7}DON'T THINK I CAN'T SEE WHAT'S GOING ON.",
            ">{#f/7}IT'S OBVIOUS YOU'RE THE ONE CALLING THE SHOTS!",
            ...
            ">{#p/papyrus}{#f/4}JUST SO YOU KNOW, UNDYNE'S PROBABLY WATCHING US.",
            ...
            '>{#p/papyrus}{#f/7}WHATEVER!!!'
         ],
         papyrusSolo3: ['>{#p/asriel2}{#f/3}* Howdy.'],
         papyrusSolo3a: () => [
            '>{#p/papyrus}{#f/31}YOU KNOW...',
            '>{#f/31}I OVERHEARD DR. ALPHYS TALKING...',
            '>{#f/5}AND SHE MENTIONED SOMETHING LIKE "TURN BACK TIME?"',
            ">{|}{#f/32}{#x1}I CAN'T BE SURE, BUT IT SOUNDS LIKE- {%}",
            '>{#p/asriel2}{#f/6}* No.',
            '>{|}{#p/papyrus}{#f/6}BUT SHE SAID YOU MIGHT BE ABLE TO- {%}',
            ...
            '>{#p/papyrus}{#f/31}BUT, IF YOU REALLY CAN ERASE WHAT HAPPENED...',
            '>{#f/5}THEN WHY NOT?',
            ">{#f/31}A-AND, IN THE NEXT TIMELINE... I'LL TAKE HIS PLACE.",
            ">{#f/3}THEN HE WOULDN'T HAVE TO DIE, RIGHT?",
            ">{#p/asriel2}{#f/6}* ...\n* Trust me, I've already seen that timeline.",
            ">{#f/7}* It's BORING.",
            '>{#p/papyrus}{#f/3}...',
            '>{#f/6}BUT WHAT IF I SHOW YOU THIS PUZZLE?',
            '>{#f/32}IT MIGHT HELP TO ALLEVIATE YOUR BOREDOM...',
            '>{#p/asriel2}{#f/15}* ...',
            '>{#p/asriel2}{#f/15}* If it makes you feel better, I guess.',
            '>{#p/papyrus}OH... OH!',
            ">{#f/0}THAT'S GREAT!!",
            ">{#f/0}YOU'RE ALREADY CHANGING YOUR MIND!!",
            '>{#p/asriel2}{#f/8}* ...',
            '>{#p/papyrus}{#f/6}...',
            '>{|}{#f/5}WELL, HERE ARE THE RULES OF THE- {%}',
            '>{#p/asriel2}{#f/7}* We already know the rules, idiot.',
            '>{#p/papyrus}{#f/31}... OH...',
            '>{#f/6}UH, WELL THEN!!\nWITHOUT FURTHER ADO...',
            ">{#f/9}LET'S FIND OUT WHAT OUR RANDOM NUMBER WILL BE!!"
         ],
         papyrusSolo4a: [
            ...
            '>{#p/papyrus}{#f/31}...',
            '>{#f/31}WHY?',
            '>{#f/31}WHY WOULD YOU DO THIS?',
            ">{#f/3}MONSTERS AREN'T SUPPOSED TO BE LIKE THIS...",
            ">{#f/5}WHERE'S YOUR LOVE?\nYOUR COMPASSION?",
            '>{#f/31}YOUR... MERCY...',
            '>{#p/asriel2}{#f/2}* ...\n* Oh, you sweet stellar star child...',
            '>{#f/1}* I lost those things a LONG time ago.',
            ">{#p/papyrus}{#f/31}BUT...\nI DON'T GET IT...",
            '>{#f/5}HOW CAN A MONSTER SO PURE OF MIND...',
            '>{#f/31}... BE TURNED SO COMPLETELY TO THE DARK SIDE?',
         ...
         papyrusSolo4c: ['>{#p/papyrus}{#f/31}I...', '>{#f/3}... NO...'],
         papyrusSolo4d: [
            ">{#p/papyrus}{#f/7}NO, YOU'RE WRONG.",
            ">{#f/7}YOU ARE THE ONE WHO'S BEEN TRYING TO BRING ME DOWN.",
            ">{#f/7}YOU ARE THE ONE WHO'S FED ME LIE AFTER LIE.",
            '>{#f/9}BUT I, PAPYRUS...',
            '>{#f/9}FINALLY UNDERSTAND THE {@fill=#f00}REAL TRUTH{@fill=#fff}.',
            ">{#p/asriel2}{#f/13}* Oh?\n* And what's that?"
         ],
         papyrusSolo4e: [">{#p/papyrus}{#f/34}YOU'RE NOT {@fill=#f00}ASRIEL{@fill=#fff}."],
         papyrusSolo4f: [
            '>{#f/31}{@fill=#f00}ASRIEL{@fill=#fff} WOULD NEVER ACT LIKE THIS.',
            '>{#f/5}{@fill=#f00}ASRIEL{@fill=#fff} WAS A KIND SOUL.',
            '>{#f/5}{@fill=#f00}ASRIEL{@fill=#fff} BELIEVED IN PEOPLE...',
            '>{#f/31}HE BELIEVED IN HUMANITY BEFORE ANYONE ELSE DID.',
            '>{#f/4}YOU, ON THE OTHER HAND...',
            '>{#f/7}YOU JUST WANT TO USE THEM FOR YOUR OWN ENDS!',
            ">{#f/4}AND FRANKLY, I DON'T CARE WHAT YOU HAVE TO SAY.",
            '>{#f/9}I STILL HAVE HOPE FOR THAT HUMAN.',
      ...
      maze1: () =>
         world.edgy
            ...
            : [
               ...
               '>MY BROTHER AND I HAVE CREATED MANY PUZZLES.',
               '>{#f/9}ARE YOU UP FOR THE CHALLENGE, HUMAN!?',
               choicer.create('* (What do you say?)', 'Yes', 'No'),
               '>{#p/papyrus}CORRECT ANSWER!\nFOR YOU SEE...'
            ],
      maze2a: [
         '>{#x4}{#f/9}NO CRAFTSMAN HAS EVER MADE TRAPS AS FINE AS ME!',
         ">{#f/0}THEY'RE PRACTICALLY IRRESISTIBLE!",
         ">{#x1}{#p/sans}{#f/2}* maybe you're the one who's irresistible.",
         '>{#p/papyrus}{#f/1}REALLY!?'
      ],
      maze2b: [
         '>{#x4}{#f/9}NO HUMAN HAS EVER BESTED A PUZZLE BY THE GREAT PAPYRUS!',
         '>{#x1}{#p/sans}{#f/4}* no human has even had the chance to, bro.',
         ">{#p/papyrus}{#x3}{#f/7}UGH, THAT'S BESIDES THE POINT!!"
      ],
      maze3: ['>{#x1}{#f/0}ANYWAY, THIS HERE IS WHAT I LIKE TO CALL...'],
      maze3a: [
         '>"THE WALL OF FIRE!!"',
         '>{#p/sans}* couldn\'t you just call it "the firewall?"\n* it\'d save time.',
         ">{#p/papyrus}{#f/4}DR. ALPHYS WOULD THINK I'M MIS- USING THE TERM.",
         ">{#p/sans}* i dunno bro, she's really into that kinda stuff. in fact...",
         ">{#f/2}* i bet she'd find it {@fill=#ff0}hot{@fill=#fff}."
      ],
      maze4: ['>{#p/papyrus}{#x3}{#f/7}NOT NOW, SANS!!'],
      maze5: () =>
         world.edgy
            ? [
            ...
            : [
               '>{#p/papyrus}... ANYWAY, THE IDEA BEHIND THIS PUZZLE IS SIMPLE.',
               '>BECAUSE ALL YOU HAVE TO DO...',
               '>{#f/9}IS MAKE IT TO THE OTHER SIDE!!',
               '>{#f/0}GOOD LUCK!!\nNYEH HEH HEH!!'
            ],
      maze6: pager.create(
         0,
         () =>
            world.edgy
               ...
               : [">{#p/papyrus}{#x2}{#f/7}WHERE DO YOU THINK YOU'RE GOING!?"],
         () => (world.edgy ? ['>{#p/sans}{#f/0}* seriously?'] : ['>{#p/papyrus}{#x2}{#f/7}GET BACK HERE!!'])
      ),
      maze7: [
         [
            '>{#p/papyrus}ARE YOU AFRAID OF THE FLAMES??',
            ">{#f/4}DON'T WORRY, THEY CAN'T ACTUALLY\nHARM YOU.",
            '>{#f/0}AS SANS WOULD SAY, THEY\'RE JUST "PLEASANTLY WARM."',
            '>{#p/sans}* actually, i picked that saying up from a friend.',
            '>{#p/papyrus}{#f/4}... OH.'
         ],
         [
            '>{#p/papyrus}ARE YOU ANXIOUS ABOUT FAILING THE PUZZLE??',
            ">IF THAT'S THE CASE, THEN YOU MUST KNOW...",
            '>{#x4}{#f/9}I, THE GREAT PAPYRUS, WOULD NOT JUDGE YOU FOR IT!',
            '>{#f/0}AS EVERY STAR CHEF KNOWS, THE THOUGHT IS WHAT COUNTS.',
            '>{#x1}SO GO ON, DO TRY YOUR BEST!'
         ],
         [
            '>{#p/papyrus}{#f/4}(SANS, WHAT IS THE HUMAN DOING??)',
            '>{#p/sans}* they could just be studying the pattern.',
            '>{#p/papyrus}{#f/4}(OH, TRUE.)',
            '>{#f/9}IN THAT CASE, PROCEED WHEN READY!'
         ]
      ],
      maze8: () =>
         world.edgy
            ...
            : [
               ...
               ">{#f/9}IT SEEMS YOU'VE BEEN JAPED BY THE GREAT PAPYRUS!",
               '>{#f/0}BUT FRET NOT!',
               '>FOR YOU SEE, MY TRAPS ARE NO SLOUCH.',
               ">{#f/9}YOU CAN'T BE BLAMED FOR FAILING ONE SO EASILY!!"
            ],
      maze9: () =>
         world.edgy
      ...
      maze10: () =>
         world.edgy
            ...
            : [
               '>{#f/4}IN ANY CASE...',
               '>{#f/0}I AM EXCITED FOR WHAT COMES NEXT!',
               '>{#f/4}A PUZZLE SO CONFOUNDING...',
               ">{#f/1}EVEN TERRESTRIA HERSELF COULDN'T SOLVE IT!!!",
               ...
               '>{#p/papyrus}{#f/7}{#x3}I GET THE POINT!!'
            ],
      maze11: ['>{#p/papyrus}{#f/7}SANS, WE HAVE PUZZLES TO PREPARE!!', '>COME ON!'],
         ...
         l_kakurolady: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                     '>{#p/basic}{#npc/a}* (Cough, cough.)',
                     '>* Back in school, teachers gave us spot-the-difference puzzles when we ran out of work.',
                     '>* I thought they were a waste of time.\n* But look at me now...',
                     ">* I'm the number-one spot-the- difference artist on the outpost!"
                  ],
            () =>
               SAVE.data.n.plot === 72
                  ? [
               ...
               SAVE.data.n.plot === 72
                  ...
                  : [
                     ...
                     ...(31 <= SAVE.data.n.plot &&
                        ...
                        ? [
                           '>{#p/papyrus}{#f/0}HOW NICE OF YOU TO CHECK MY MAIL!',
                           ">{#p/papyrus}{#f/4}THANKFULLY, I'VE ALREADY COLLECTED IT ALL."
                        ]
                        : [])
                  ],
            () =>
         ...
         () =>
            SAVE.data.b.svr
               ...
               : [
                  ...
                  ...(roomready()
                     ? [
                        '>{#p/papyrus}SOME OF MY FAVORITE BOOKS ARE ON THAT SHELF.',
                        '>{#f/4}LIKE "ADVANCED PUZZLE CONSTRUCTS FOR BRIGHT MINDS."',
                        '>{#f/0}AND ANOTHER FAVORITE OF MINE?',
                        '>{#f/4}"PEEK-A-BOO WITH FLUFFY BUNNY."',
                        '>{#f/8}THE ENDING ALWAYS GETS ME!'
                     ]
                     : [])
               ],
         () =>
      ...
      papbooks2: pager.create(
         ...
         () =>
            world.runaway
               ? [
                  '>{#p/human}* (You pick out a book...)',
                  '>{#p/papyrusnt}"DEAR DAIRY, THE FORCE FIELD HAS BEEN DESTROYED."',
               ...
               : SAVE.data.n.plot === 72
                  ...
                  : [
                     '>{#p/human}* (You pick out a book...)',
                     '>{#p/papyrusnt}"DEAR DAIRY, SANS HAS JUST BEEN MADE AN OFFICIAL ROYAL SENTRY."',
                     '>"AT FIRST, I WAS CONFUSED AT HIM..."',
                     '>"AFTER ALL, WHY WOULD SOMEBODY SO LAZY WANT TO TAKE THIS ON?"',
                     '>"WELL, I DECIDED NOT TO QUESTION IT."',
                     '>"THE TRUTH IS, I COULDN\'T BE MORE PROUD OF HIM!!!"',
                     '>"ONLY TIME WILL TELL WHAT GREAT THINGS THIS BRINGS FORTH."',
                     '>{#p/human}* (You put the book back on the shelf.)'
                  ]
      ),
         ...
         () =>
            postSIGMA()
               ...
               : [
                  ...(roomready()
                     ? [
                        ">{#p/papyrus}THE OUTERNET!\nI'M QUITE POPULAR THERE.",
                        ">{#f/4}I'M JUST A DOZEN AWAY...",
                        '>{#f/0}FROM A DOUBLE- DIGIT FOLLOWER COUNT!'
                     ]
                     : []),
                  SAVE.data.b.svr
      ...
      papcouch3a: [
         ">{#p/papyrus}{#f/1}YOU'RE CLEANING OUT THE COUCH FOR US!?",
         '>{#p/papyrus}{#f/5}AND OUT OF NOTHING BUT THE KINDNESS OF YOUR HEART...',
         '>{#p/papyrus}{#f/6}SUCH GENEROSITY!!!'
      ],
      paproom1: [
         '>{#p/papyrus}{#f/6}WHAT!?\nHOW DID YOU...',
      ...
      papdate0: () => [
         SAVE.data.b.flirt_papyrus
            ? ">{#p/papyrus}{#f/5}WOWIE, YOU'RE SO EAGER TO DATE..."
            : ">{#p/papyrus}{#f/5}WOWIE, YOU'RE SO EAGER TO HANG OUT WITH ME...",
         ">{#f/5}THAT YOU'RE TRYING TO GO IN MY HOUSE AHEAD OF ME!",
         ">{#f/6}THAT'S DEDICATION!"
      ],
      papdate1x: pager.create(
         0,
         [
            '>{#p/papyrus}{#f/0}HELLO, HUMAN!',
            '>{#f/5}I HOPE EVERYTHING IS ALRIGHT.',
            '>{#f/6}FEEL FREE TO TAKE A WALK AROUND TOWN...',
            '>{#f/0}... OR A LOOK IN MY HOUSE!'
         ],
         [">{#p/papyrus}{#f/4}JUST BE SURE TO AVOID SANS'S ROOM."]
      ),
      papdate1: () => [
         SAVE.data.b.flirt_papyrus
            ? '>{#p/papyrus}SO YOU CAME BACK TO HAVE A DATE WITH ME!'
            : '>{#p/papyrus}SO YOU CAME BACK TO SEE ME!',
         ...(world.dead_dog || world.population < 6
            ? [
               ">{#f/0}THAT'S GREAT!!",
               ">{#f/5}TRUTH BE TOLD, IT'S BEEN A LITTLE LONELY TODAY...",
               '>{#f/5}A LOT OF PEOPLE ARE STRANGELY ABSENT...',
               ">{#f/0}BUT YOU'RE STILL HERE!!",
               '>{#f/0}THAT MEANS SOMETHING, RIGHT??'
            ]
            : ['>{#f/4}YOU MUST BE REALLY SERIOUS ABOUT THIS...']),
         ">{#f/5}I'LL HAVE TO TAKE YOU SOMEPLACE REALLY SPECIAL...",
         '>{#f/0}A PLACE I LIKE TO SPEND A LOT OF TIME!!!'
      ],
      papdate2: ['>{#p/papyrus}MY HOUSE!!!'],
      papdate3: pager.create(
         0,
         ['>{#p/papyrus}WELCOME TO SCENIC MY HOUSE!', '>ENJOY AND TAKE YOUR TIME!!!'],
         [">{#p/papyrus}WHEN YOU'RE DONE, HEAD UPSTAIRS TO MY ROOM!"]
      ),
      papdate3a: ['>{#p/papyrus}{#f/6}WOW! BEING A GOOD HOST IS A REAL WORKOUT!'],
      papdate3b: [
         ">{#p/papyrus}{#f/5}WOWIE, I CAN'T FEEL MY LEGS...",
         ">{#f/0}THAT MUST MEAN I'M BEING A GREAT HOST!!!"
      ],
      papdate4: pager.create(
         0,
         () => [
            ">{#p/papyrus}THAT'S MY ROOM!",
            ">{#f/4}IF YOU'VE FINISHED LOOKING AROUND, WE COULD GO IN AND...",
            '>{#f/4}AND...',
            SAVE.data.b.flirt_papyrus
               ? '>{#f/9}DO WHATEVER PEOPLE DO WHEN THEY DATE!'
               : '>{#f/9}"HANG OUT" LIKE A PAIR OF VERY COOL FRIENDS!',
            choicer.create('* (What do you say?)', 'Yes', 'No')
         ],
         () => ['>{#p/papyrus}READY?', choicer.create('* (What do you say?)', 'Yes', 'No')]
      ),
      papdate4a: [">{#p/papyrus}OKAY, LET'S GO!"],
      papdate4b: [">{#p/papyrus}I'LL KEEP WAITING HERE THEN!"],
      papdate5: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}SO, UM...',
            ">{#f/5}IF YOU'VE SEEN EVERYTHING...",
            SAVE.data.b.flirt_papyrus
               ? '>{#f/6}DO YOU WANT TO START DATING?'
               : '>{#f/6}DO YOU WANT TO START HANGING OUT?',
            choicer.create('* (What do you say?)', 'Yes', 'No')
         ],
         () => ['>{#p/papyrus}{#f/6}READY TO START?', choicer.create('* (What do you say?)', 'Yes', 'No')]
      ),
      papdate5a: () => [
         SAVE.data.b.flirt_papyrus
            ? '>{#p/papyrus}OKAY!!!\nDATING START!!!'
      ...
      papdate5b: [">{#p/papyrus}TAKE YOUR TIME, I'LL WAIT FOR YOU."],
      papdate6: () => [
         SAVE.data.b.flirt_papyrus
      ...
      papdate7: () => [
         '>{#p/papyrus}{#f/10}HERE WE ARE!!',
         SAVE.data.b.flirt_papyrus ? '>{#f/20}ON OUR DATE!!' : '>{#f/20}HANGING OUT!!',
         ">{#f/24}I'VE ACTUALLY NEVER DONE THIS BEFORE.",
         ">{#f/10}BUT DON'T WORRY!!!",
         '>{#f/20}PREPARATION IS MY (UNOFFICIAL) LAST NAME!'
      ],
      papdate8: () => [
         '>{#f/20}WHAT DO I HAVE HERE, YOU ASK?',
         SAVE.data.b.flirt_papyrus
            ? '>{#p/papyrus}{#f/10}AN OFFICIAL DATING GUIDE, STRAIGHT FROM THE LIBRARBY!'
            : '>{#p/papyrus}{#f/10}AN OFFICIAL HANGOUT GUIDE, STRAIGHT FROM THE LIBRARBY!',
         ">{#f/20}WITH THIS, WE'RE BOUND TO HAVE A GREAT TIME!"
      ],
      papdate9: () => [
         ">{#p/papyrus}{#f/25}LET'S SEE...",
         SAVE.data.b.flirt_papyrus
            ? '>{#f/25}STEP ONE: PRESS C OR CTRL TO OPEN THE {@fill=#f00}DATING HUD{@fill=#000}.'
            : '>{#f/25}STEP ONE: PRESS C OR CTRL TO OPEN THE {@fill=#f00}FRIENDSHIP HUD{@fill=#000}.'
      ],
      papdate10: () => [
         '>{#p/papyrus}{#f/24}... WAIT.',
         '>{#f/22}YOU ALREADY DID THAT!?!?',
         SAVE.data.b.flirt_papyrus
            ? '>{#f/11}WOWIE, YOU MUST REALLY LOVE ME!'
            : '>{#f/11}WOWIE, YOU MUST REALLY LIKE ME!',
         ">{#f/10}IT'S ONTO STEP TWO, THEN!"
      ],
      papdate11: [
         '>{#p/papyrus}{#f/24}...',
         ">{#f/24}EH, WE DIDN'T NEED IT ANYWAY.",
         '>{#f/20}ONTO STEP TWO!'
      ],
      papdate12: [
         '>{#p/papyrus}{#f/11}WOWIE, I FEEL SO INFORMED!',
         ">{#f/24}IN FACT, I THINK WE'RE READY FOR STEP TWO..."
      ],
      papdate13: () => [
         SAVE.data.b.flirt_papyrus
            ? '>{#p/papyrus}{#f/25}STEP TWO: ASK THEM ON A DATE.'
            : '>{#p/papyrus}{#f/25}STEP TWO: ASK THEM TO HANG OUT.'
      ],
      papdate13a: () => [
         '>{#f/24}"AHEM."',
         '>{#f/20}HUMAN!\nI, THE GREAT PAPYRUS...',
         SAVE.data.b.flirt_papyrus
            ? '>{#f/10}WOULD LIKE TO GO ON A DATE WITH YOU!'
            : '>{#f/10}WOULD LIKE TO HANG OUT WITH YOU!'
      ],
      papdate14: () => [choicer.create('* (What do you say?)', 'Yes', 'No')],
      papdate15a: ['>{#p/papyrus}{#f/12}R-REALLY???', '>{#f/11}WOWIE!!!'],
      papdate15a1: [">{#f/24}I GUESS THAT MEANS IT'S TIME FOR STEP THREE..."],
      papdate15b: ['>{#p/papyrus}{#f/21}OH...', '>{#f/27}F-FORTUNATELY, IT ONLY SAYS TO ASK.'],
      papdate15c: [">{#f/24}WELL ANYWAY, IT'S TIME FOR STEP THREE..."],
      papdate16: ['>{#p/papyrus}{#f/25}STEP THREE: PUT ON NICE CLOTHES TO SHOW YOU CARE.'],
      papdate16a: ['>{#p/papyrus}{#f/24}...', '>{#f/24}WAIT A SECOND.'],
      papdate17: () => [
         '>{#f/24}NICE CLOTHES...',
         (
            {
               spacesuit: ">{#f/26}THAT OLD SPACESUIT YOU'RE WEARING...",
               halo: '>{#f/26}THAT FANCY HALO ON YOUR HEAD...',
               eye: '>{#f/26}THAT FORCE FIELD AROUND YOU...',
               eye_x: '>{#f/26}THAT FORCE FIELD AROUND YOU...',
               temyarmor: ">{#f/26}THAT ARMOR YOU'RE WEARING...",
               goggles: '>{#f/26}THAT GADGET ON YOUR HEAD...',
               goggles_x: '>{#f/26}THAT GADGET ON YOUR HEAD...',
         ...
         )[SAVE.data.s.armor] || '>{#f/26}THAT THING ON YOUR BODY...',
         ">{#f/20}YOU'RE WEARING CLOTHING RIGHT NOW!!!",
         '>{#f/24}AND NOT ONLY THAT...',
         '>{#f/20}EARLIER TODAY, YOU WERE ALSO WEARING CLOTHING!'
      ],
      papdate17a: () => [
         '>{#f/12}NO...!\nCOULD IT BE???',
         SAVE.data.b.flirt_papyrus
            ? '>{#f/13}HAVE YOU WANTED TO DATE ME FROM THE VERY BEGINNING???'
            : '>{#f/13}HAVE YOU WANTED TO BEFRIEND ME FROM THE VERY BEGINNING???'
      ],
      papdate18a: () => [
         '>{#p/papyrus}{#f/22}NO!!',
         '>{#f/22}YOU PLANNED IT ALL!!!',
         ...(SAVE.data.b.flirt_papyrus
            ? [
               '>{#f/22}YOU MIGHT EVEN BE BETTER AT DATING THAN I AM!!!',
               '>N-NOOOO!!!\nYOUR {@fill=#003cff}DATING POWER{@fill=#000}...!!!'
            ]
            : [
               '>{#f/22}YOU MIGHT EVEN BE BETTER AT HANGING OUT THAN I AM!!!',
      ...
      papdate19: ['>{#p/papyrus}{#f/15}NYEH!', '>{#f/15}NYEH HEH HEH!!!'],
      papdate20: () => [
         ">{#p/papyrus}{#f/15}DON'T THINK YOU'VE BESTED ME YET!",
         '>{#f/20}I, THE GREAT PAPYRUS...',
         SAVE.data.b.flirt_papyrus
            ? '>{#f/20}HAVE NEVER BEEN BEATEN AT DATING...'
            : '>{#f/20}HAVE NEVER BEEN BEATEN AT HANGING OUT...',
         '>{#f/15}AND I NEVER WILL!!',
         '>{#f/10}I CAN EASILY KEEP UP WITH YOU!!!',
         '>{#f/24}IN FACT...',
         '>{#f/20}I ALWAYS WEAR MY "SPECIAL" CLOTHES...',
         '>{#f/20}UNDERNEATH MY REGULAR ONES!!',
         '>{#f/15}BEHOLD!!'
      ],
      papdate21: ['>{#p/papyrus}{#f/15}WHAT DO YOU THINK OF MY SECRET STYLE?'],
      papdate22: () => [choicer.create('* (What do you say?)', 'It rocks', 'It sucks')],
      papdate23a: ['>{#p/papyrus}{#f/13}NO!!!', '>{#f/13}A GENUINE COMPLIMENT...!'],
      papdate23b: ['>{#p/papyrus}{#f/13}NO!!!', '>{#f/13}A CRITICAL, YET HONEST REVIEW...!'],
      papdate24: [
         '>{#p/papyrus}{#f/24}HOWEVER...',
         ">{#f/20}YOU DON'T TRULY UNDERSTAND THE {@fill=#f00}HIDDEN POWER{@fill=#000} OF THIS OUTFIT!",
         '>{#f/26}THEREFORE...'
      ],
      papdate24a: () => [
         '>{#f/15}WHAT YOU JUST SAID IS INVALID!!',
         SAVE.data.b.flirt_papyrus
            ? ">{#f/15}THIS DATE WON'T ESCALATE ANY FURTHER!"
            : ">{#f/15}THIS HANGOUT WON'T ESCALATE ANY FURTHER!",
         '>{#f/24}UNLESS...',
         '>{#f/20}YOU CAN FIND MY {@fill=#f00}SECRET{@fill=#000}.',
         ">{#f/15}BUT THAT WON'T HAPPEN!!"
      ],
      papdate24b: '* Move and inspect with [Z].',
      papdate25: [
         // yes this is a reference to the bees disappearing line from journey's end shutu-
         '>{#p/papyrus}{#f/21}THE WIG ON MY HEAD...?',
         '>{#f/16}THE WIG ON MY HEAD.',
         '>{#f/10}THE WIG... ON MY HEAD!!!',
      ...
      papdate25b: [
         '>{#p/papyrus}{#f/26}THIS SHIRT DIDN\'T ORIGINALLY SAY "STELLAR..."',
         '>{#f/20}BUT I IMPROVED IT!',
         '>{#f/10}EXPERT TIP: ALL CLOTHING CAN BE IMPROVED THIS WAY.',
         ">{#f/20}... BUT THAT'S NOT A SECRET!\nTRY AGAIN!"
      ],
      papdate25c: [
         '>{#p/papyrus}{#f/24}I SEE, I SEE.',
         '>{#f/24}YOU LIKE FEELING MY ARM- PILLOWS WITH A FLOATING HEART.',
         ">{#f/20}BUT WHO DOESN'T!?\nTRY AGAIN!"
      ],
      papdate25d: [
         ">{#p/papyrus}{#f/13}HOLDING MY HAND SO I'LL TELL YOU THE ANSWER...?",
         '>{#f/14}N-NO, I MUST RESIST!!',
         '>{#f/20}TRY AGAIN!'
      ],
      papdate25e: [
      ...
      papdate25f: [
         '>{#p/papyrus}{#f/24}THIS "DRIP" MAY BE UNDE- FEET-ABLE...',
         '>{#f/20}BUT EXPECTING A SECRET HERE IS TOTALLY UNREASONABLE!',
         '>{#f/20}TRY AGAIN!'
      ],
      papdate25g: [
         '>{#p/papyrus}{#f/20}AH YES, MY TOP-OF-THE-LINE SPORTSWEAR!',
         ">{#f/24}YOU WON'T FIND ANY SECRETS HERE, THOUGH, BECAUSE...",
         ">{#f/20}I DON'T HAVE ANY POCKETS TO HIDE THEM IN!!!",
         '>{#f/20}TRY AGAIN!'
      ],
      papdate25h: () => [
         '>{#p/papyrus}{#f/24}MY SHOULDERS...',
         '>{#f/10}ARE YOU ASKING FOR A PIGGYBACK RIDE??',
         SAVE.data.b.flirt_papyrus
            ? ">{#f/24}WELL, I'D GIVE IT TO YOU IF WE WEREN'T SO BUSY DATING."
            : ">{#f/24}WELL, I'D GIVE IT TO YOU IF WE WEREN'T SO BUSY HANGING OUT.",
         '>{#f/20}BUT WE ARE!\nSO TRY AGAIN!'
      ],
      papdate25i: [
         '>{#p/papyrus}{#f/14}SERIOUSLY??',
         ">{#f/19}I'M NOT JUST GOING TO -TELL- YOU THE SECRET...",
         ">{#f/20}YOU'LL HAVE TO TRY A LITTLE HARDER THAN THAT!"
      ],
      papdate25j: () =>
         calcLV() > 2
            ? [
      ...
      papdate26: () => [
         '>{#p/papyrus}{#f/27}W-WELL THEN...',
         '>{#f/27}YOU FOUND MY SECRET!',
         '>{#f/24}I SUPPOSE I HAVE NO CHOICE BUT TO ADMIT THE TRUTH.',
         ">{#f/24}IT'S A PRESENT...",
         ['>{#f/27}A PRESENT J-JUST FOR YOU!!!', '>{#f/27}A PRESENT FOR US TO SHARE!!!'][
      ...
      papdate28: [
         ">{#p/papyrus}{#f/21}YOU WON'T EVEN HARM MY DELICATE WRAPPING??",
         '>{#f/27}N-NO... THAT TECHNIQUE...',
         ">{#f/13}IT'S TOO MUCH!",
         '>{#f/14}B-BUT... AHA!\nCOUNTERATTACK!',
         ">{#f/15}I'LL OPEN THE PRESENT MYSELF!!"
      ],
      papdate29: ['>{#p/papyrus}{#f/20}DO YOU KNOW WHAT -THIS- IS?'],
      papdate30: () => [choicer.create('* (Do you know what it is?)', 'Yes', 'No')],
      papdate31a: [
         '>{#p/papyrus}{#f/26}SPAGHETTI.',
         ">{#f/24}THAT'S PROBABLY WHAT YOU'RE THINKING, ISN'T IT?",
         '>{#f/20}RIGHT!',
         '>{#f/15}BUT OH-SO-WRONG!'
      ],
      papdate31b: [
         ">{#p/papyrus}{#f/20}NYEH HEH HEH!\nTHAT'S RIGHT.",
         '>{#p/papyrus}{#f/15}YOU HAVE NO IDEA!',
         '>{#f/24}THOUGH THIS APPEARS TO BE SPAGHETTI...'
      ],
      papdate32: () => [
         ">{#p/papyrus}{#f/20}THIS ISN'T ANY PLAIN OL' PASTA!",
         ">{#f/20}THIS IS AN ARTISAN'S WORK!",
         '>{#f/24}SILKEN SPA- GHETTI, FINELY AGED IN A TIME DILATION UNIT.',
         '>{#f/20}THEN PREPARED BY ME, MASTER CHEF PAPYRUS!',
         ">{#f/15}HUMAN!!!\nIT'S TIME TO END THIS!!",
         ">THERE'S NO WAY THIS CAN GO ANY FURTHER!",
         ...[[">{#f/20}LET'S EAT THIS SPAGHETTI TOGETHER!!!"], ['>{#f/20}FEAST UPON MY ULTIMATE TECHNIQUE!!!']][
         (SAVE.data.n.state_papyrus_spaghet + 1) % 2
         ]
      ],
      ...
      papdate34a: () => [
         '>{#p/papyrus}{#f/10}WHAT A PASSIONATE EXPRESSION!!!',
         SAVE.data.b.flirt_papyrus
            ? '>{#f/12}YOU MUST REALLY LOVE MY COOKING!'
            : '>{#f/12}YOU MUST REALLY LIKE MY COOKING!',
         ...[
            [
               '>{#f/24}WELL, I DID TOO...',
               SAVE.data.b.flirt_papyrus
                  ? '>{#f/20}BUT I THINK YOU LOVED IT EVEN MORE THAN ME!!!'
                  : '>{#f/20}BUT I THINK YOU LIKED IT EVEN MORE THAN ME!!!'
            ],
            ['>{#f/10}AND BY EXTENSION, ME!', '>{#f/20}MAYBE EVEN MORE THAN I DO!!!']
         ][(SAVE.data.n.state_papyrus_spaghet + 1) % 2],
         ">{#f/27}BUT... THAT'S IMPOSSIBLE...!",
         '>{#f/12}HOW DID YOU DO THAT!?!?'
      ],
      papdate34b: () => [
         '>{#p/papyrus}{#f/21}YOU MEAN...',
         ">{#f/18}YOU'RE LETTING ME HAVE IT INSTEAD?",
         ...[
            [
               '>{#f/24}I THOUGHT WHEN YOU SAID YOU WERE SHARING...',
               '>{#f/20}YOU WOULD AT LEAST WANT A LITTLE FOR YOURSELF.',
               '>{#f/27}BUT NO, ALL THIS TIME...',
               '>{#f/12}YOU WANTED ME, -ME-, TO HAVE IT ALL!!!'
            ],
            [
               '>{#f/21}EVEN AFTER WHAT YOU SAID BEFORE...',
               '>{#f/21}ABOUT WANTING MY SPAGHETTI FOR YOURSELF...',
               '>{#f/27}AT THE VERY PRECIPICE OF YOUR SATISFACTION, YOU...',
               '>{#f/12}YOU GAVE IT ALL UP FOR ME???'
            ]
         ][(SAVE.data.n.state_papyrus_spaghet + 1) % 2]
      ],
      papdate35: ['>{*}{#p/papyrus}{#f/22}AUGH!!!{%15}'],
      papdate36: ['>{*}{#p/papyrus}{#f/22}URRRGH!!!{%15}'],
      papdate37: ['>{*}{#p/papyrus}{#f/22}NOOOOOOOO!!!{%15}'],
      papdate38: () => [
         ">{#p/papyrus}{@random=1.1/1.1}HUMAN.\nIT'S CLEAR NOW.",
         SAVE.data.b.flirt_papyrus
            ? ">{@random=1.1/1.1}YOU'RE MADLY IN LOVE WITH ME."
            : ">{@random=1.1/1.1}YOU'RE COMPLETELY OBSESSED WITH ME.",
         '>{@random=1.1/1.1}EVERYTHING YOU DO.\nEVERYTHING YOU SAY.',
         ">{@random=1.1/1.1}IT'S ALL BEEN FOR MY SAKE.",
         '>{@random=1.1/1.1}HUMAN.\nI WANT YOU TO BE HAPPY, TOO.',
         ">{@random=1.1/1.1}IT'S TIME FOR ME TO EXPRESS MY FEELINGS...",
         ">{@random=1.1/1.1}IT'S TIME I TOLD YOU THE TRUTH."
      ],
      papdate39: () =>
         SAVE.data.b.flirt_papyrus
            ? [
               '>{#f/21}HUMAN, THE TRUTH IS...',
               ">{#f/21}I JUST DON'T LIKE YOU THE WAY YOU LIKE ME.",
               '>{#f/24}ROMANTICALLY, I MEAN.',
               '>{#f/27}I MEAN, I TRIED VERY HARD TO!',
               '>{#f/27}I THOUGHT THAT BECAUSE YOU HAD FLIRTED WITH ME...',
               '>{#f/27}THAT I WAS SUPPOSED TO GO ON A DATE WITH YOU.',
               '>{#f/10}THEN, ON OUR DATE, FEELINGS WOULD BLOSSOM FORTH!!!',
               '>{#f/20}I WOULD BE ABLE TO MATCH YOUR PASSION FOR ME!',
               '>{#f/21}BUT ALAS...\nI, THE GREAT PAPYRUS...',
               '>{#f/21}HAVE FAILED.',
               '>{#f/21}I FEEL JUST THE SAME AS BEFORE.',
               '>{#f/27}AND THE WORST PART IS, BY DATING YOU...',
               '>{#f/22}I HAVE ONLY DRAWN YOU DEEPER INTO YOUR LOVE!',
               '>{#f/21}A DARK PRISON OF PASSION FROM WHICH THERE IS NO ESCAPE.',
               '>{#f/27}HOW COULD I HAVE DONE THIS TO MY DEAR FRIEND...?',
               '>{#f/27}...',
               '>{#f/27}... NO...'
            ]
            : ['>{#f/24}HUMAN, THE TRUTH IS...'],
      papdate39a: () => [
         ...(SAVE.data.b.flirt_papyrus
            ? [
               ">{#f/20}NO!\nTHAT'S WRONG!",
               ">{#f/17}I CAN'T FAIL AT ANYTHING!!!",
               ">{#f/20}HUMAN!!!\nI'LL HELP YOU THROUGH THESE TRYING TIMES!!!",
               ">{#f/24}I'LL KEEP BEING YOUR COOL FRIEND...",
               '>{#f/20}AND WE CAN FORGET THIS EVER HAPPENED.',
               '>{#f/10}AFTER ALL, YOU, TOO, ARE VERY GREAT.',
               '>{#f/20}IT WOULD BE TRAGIC TO LOSE YOUR FRIENDSHIP!',
               '>{#f/21}SO, PLEASE....',
               ">{#f/21}DON'T CRY BECAUSE I CAN'T KISS YOU.",
               ">{#f/19}BESIDES, I DON'T EVEN HAVE LIPS!!!",
               ...(SAVE.data.n.plot < 48
                  ? [
                     ">{#f/10}AND HEY, SOMEDAY, YOU'LL FIND SOMEONE JUST AS GREAT.",
                     ">{#f/24}WELL, NO.\nTHAT'S NOT TRUE.",
                     ">{#f/20}BUT I'LL HELP YOU SETTLE FOR SECOND BEST!!!"
                  ]
         ...
         '>{#f/20}NYEH HEH HEH HEH HEH!!!'
      ],
      papdate40: () => [
         '>{#f/24}OH, AND IF YOU EVER NEED TO REACH ME...',
         ">{#f/10}HERE'S MY {@fill=#f00}PHONE NUMBER{@fill=#000}.",
         '>{#f/11}FEEL FREE TO CALL ME AT ANY TIME!',
         ...(SAVE.data.b.flirt_papyrus
            ? [
               '>{#f/24}PLATONICALLY, OF COURSE.',
               ...(SAVE.data.n.plot < 48
                  ? ['>{#f/10}WELL, GOTTA GO!']
      ...
      pappuzzle1: [
         '>{#p/papyrus}{#f/0}HUMAN!',
         '>{#f/0}THIS NEXT PUZZLE IS ONE OF MY FAVORITES.',
         ">{#f/4}IT'S LIKE MY BROTHER'S COTTON BALL COLLECTION...",
         '>{#f/0}AN ODDLY SATISFYING SERIES OF OBJECTS!',
         ">{#f/9}I'LL -TRY- NOT TO GIVE AWAY THE SOLUTION."
      ],
      pappuzzle1a: ['>{#p/papyrus}{#f/0}HAVE AT IT!'],
      pappuzzle1b: [
      ...
      pappuzzle2: ['>{#p/papyrus}WOW!\nYOU SOLVED IT!!'],
      pappuzzle2a: ['>AND YOU DID IT ALL WITHOUT MY HELP!!!'],
      pappuzzle2b: [">AND I DIDN'T EVEN HAVE TO HELP YOU THAT MUCH!"],
      pappuzzle2c: ['>IT TOOK A BIT OF ENCOURAGEMENT, BUT YOU REALLY DID IT!'],
      pappuzzle2d: [
      ...
      papsink1: [
         '>{#p/papyrus}{#f/9}IMPRESSED?\nI INCREASED THE HEIGHT OF MY SINK.',
         '>{#f/0}NOW I CAN FIT MORE BONES UNDER IT!\nTAKE A LOOKSY!'
      ],
      papsink2: ['>{#p/papyrus}{#f/8}NOO, THE DOG!'],
      papsink3: ['>{#p/papyrus}{#f/31}OH, YOU POOR, POOR PUPPY...', '>{#f/9}HERE, HAVE MY SPECIAL ATTACK!'],
      papsink4: ['>{#p/papyrus}WOW!!!\nIT LOVES IT!!!'],
      papsink5: ['>{#p/papyrus}{#f/7}SANS!', '>STOP PLAGUING MY LIFE WITH INCIDENTAL MUSIC!!'],
      papsink6: ['>{#p/papyrus}{#f/4}AND NOW THE DOG HAS DISAPPEARED WITH MY ATTACK.', '>OH WELL...'],
      papsolu1: [
         '>{#p/papyrus}YOU LOOK LIKE YOU NEED A HINT.',
         '>{#f/4}HMM...',
         ">{#f/0}WELL, I'D PAY ATTENTION TO THE CIRCUITS.",
         ">{#f/0}BUT THAT'S JUST ME."
      ],
      papsolu2: [
         '>{#p/papyrus}{#f/5}STILL CONFUSED?',
         '>{#f/5}UM... MAYBE...',
         '>{#f/6}USE THE CIRCUITS AS A GUIDE TO THE SEQUENCE???',
         ">{#f/5}I'M TRYING VERY HARD NOT TO SPOIL IT..."
      ],
      papsolu3: [
         '>{#p/papyrus}{#f/6}STILL???',
         '>{#f/0}I MEAN, I COULD TOTALLY GIVE YOU THE SOLUTION.',
         ">{#f/4}I DON'T WANT TO SPOIL THE FUN, THOUGH..."
      ],
      papsolu3a: () => [
         '>{#p/papyrus}{#f/9}DO YOU ABSOLUTELY, DAPSOLUTELY WANT THE SOLUTION???',
         choicer.create('* (What do you say?)', 'Yes', 'No')
      ],
      papsolu3a1: [
         '>{#p/papyrus}THE! SOLUTION! IS!',
         '>{#f/4}(PLEASE IMAGINE A DRUMROLL IN YOUR HEAD...)',
         '>{#f/0}... THAT HOLO-TREE NEXT TO THE LAMP ON YOUR RIGHT!',
         '>CHECK IT OUTIE!!!'
      ],
      papsolu3a2: [
         ">{#p/papyrus}WOW... YOU'RE TRULY A PUZZLE PASSIONEER!",
         ">I'M ENTHUSED BY YOUR ENTHUSIASM!",
         '>YOU CAN DO IT, HUMAN!!!'
      ],
      papsolu4: [">{#p/papyrus}{#f/4}DON'T YOU REMEMBER THE SOLUTION I GAVE YOU...?"],
      papsolu5: ['>{#f/0}{#p/papyrus}ALMOST DONE!\nONLY ONE CIRCUIT LEFT TO ACTIVATE!'],
      papspaghet1: (take: boolean) => [
         '>{#p/papyrus}{#f/1}WHAT!?\nHOW DID YOU AVOID MY TRAP?',
         '>{#f/4}AND, MORE IMPORTANTLY...',
         '>{#f/0}IS THERE ANY LEFT FOR ME???',
      ...
      papspaghet2a: [
         ">{#f/5}YOU'D RESIST THE FLAVOR OF MY HOME- COOKED PASTA...",
         '>{#f/6}JUST SO YOU COULD SHARE IT WITH ME???',
         '>{#f/9}WELL THEN!!',
         '>FRET NOT HUMAN!\nFOR I, MASTER CHEF PAPYRUS...',
         '>WILL MAKE US ALL THE PASTA WE COULD EVER WANT!',
         '>{#f/0}HEH HEH HEH HEH HEH HEH NYEH!'
      ],
      papspaghet2b: [
         '>{#f/5}WOWIE...',
         '>{#f/6}FEW HAVE EVER ENJOYED MY COOKING LIKE THAT BEFORE...',
         '>{#f/9}WELL THEN!!',
         '>FRET NOT HUMAN!\nFOR I, MASTER CHEF PAPYRUS...',
      ...
      paptv: pager.create(
         ...
         () => [
            ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
               ? [">{#p/papyrus}OOH, IT'S MY FAVORITE TV SHOW!"]
               : []),
            ...(SAVE.data.n.plot < 67.1
               ? ['>{#p/mettaton}* "STAY TUNED FOR A NEW PROGRAM!"']
               : SAVE.data.b.killed_mettaton
            ...
            ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
               ? [
                  ...
                  '>{#f/4}THIS IS JUST A BAD EPISODE.',
                  ">{#f/7}DON'T JUDGE ME!!!"
               ]
               : [])
         ],
      ...
      papyrus1: ['>{#p/papyrus}SO, AS I WAS SAYING ABOUT UNDYNE...'],
      papyrus2: [
         '>{#p/papyrus}SANS!!\nOH MY GOD!!\nIS THAT...',
         '>A HUMAN!?!?',
      ...
      papyrus3: [
         ...
         '>{#p/papyrus}{#f/0}... SANS, WE FINALLY DID IT!',
         '>{#f/9}UNDYNE -HAS- TO LET ME INTO THE ROYAL GUARD NOW!!!',
         '>{#f/6}WE JUST HAVE TO...',
         '>{#f/5}TO...',
         '>{#f/4}...',
         ">{#f/4}I'M FORGETTING SOMETHING.",
         '>{#p/sans}{#f/2}* the speech, remember?',
         '>{#p/papyrus}{#f/4}OH, RIGHT.\n..."AHEM."',
         ">{#f/9}HUMAN! YOU MAY THINK YOU'RE SAFE OUT HERE...",
         '>{#f/9}BUT I, THE GREAT PAPYRUS, INTEND TO CHANGE THAT!',
         ">{#f/4}FIRST, I'LL DAZZLE YOU WITH DR. ALPHYS' PUZZLES...",
         '>{#f/4}AND THEN, WHEN YOU LEAST EXPECT IT...',
         '>{#f/9}WHAM!\nCAPTURED!\nOFF TO THE CITADEL!',
         '>{#f/9}OUR BATTLE WILL BE AS LEGENDARY AS THEY COME!',
         '>{#f/4}IN ANY CASE...',
         '>{#f/9}CONTINUE... ONLY IF YOU DARE!!!'
      ],
      papyrus4: ['>{#f/0}NYEH HEH HEH HEH HEH HEH HEH HEH!!!'],
      papyrus5: [
         '>{#p/sans}* well, that went well.',
         ">* don't sweat it, bud.",
         ">{#f/2}* i'll keep an eyesocket out for ya."
      ],
      papyrus6x1: ['>{#p/papyrus}{#f/5}H-HUMAN?\nIS THAT YOU...?'],
      papyrus6x2: [
         ">{#p/papyrus}{#f/1}OH MY GOD!!!\nIT REALLY IS YOU, ISN'T IT!?!?",
         ">{#p/papyrus}{#f/0}I'VE BEEN EXCITED TO MEET YOU SINCE I HEARD ABOUT YOU!",
         ">{#p/papyrus}{#f/4}... AS FOR WHY I'M ONLY HERE NOW?",
         '>{#p/papyrus}{#f/6}WELL, I HAVE REASON TO BELIEVE...',
         '>{#p/papyrus}{#f/5}... MY BROTHER HAS BEEN TRYING TO KEEP YOU FROM ME.',
         '>{#p/papyrus}{#f/7}TYPICAL!!!',
         '>{#p/papyrus}{#f/0}BUT OUR LITTLE ALLIANCE CAN BE OUR LITTLE SECRET.',
         ">{#p/papyrus}{#f/9}HE DOESN'T HAVE TO KNOW A -DAMN- THING ABOUT IT!"
      ],
      papyrus6x3: [
         ">{#p/papyrus}{#f/5}GUESS I BETTER GO BEFORE HE FINDS OUT I'M HERE.",
         ">{|}{#p/papyrus}{#f/9}I'LL CATCH UP WITH YOU SOON, HU- {%}"
      ],
      ...
      papyrus6: () => [
         ...
         world.nootflags.has('s_puzzle2')
            ...
            : '>{#f/4}YOU MAY HAVE PASSED MY OTHER CHALLENGES.',
         ">{#f/9}BUT NOW YOU WILL SURELY MEET YOUR WIT'S END!",
         '>FOR YOU SEE, THIS PUZZLE WAS MADE BY NONE OTHER...',
         '>{#f/0}THAN THE AMAZING DR. ALPHYS!',
         '>THE RULES ARE QUITE SIMPLE, REALLY.',
         '>THIS DISPLAY WILL READ OUT A NUMBER AT RANDOM.',
         '>{#f/9}... THE NUMBER OF SECONDS UNTIL YOU CAN PASS!',
         '>{#f/0}IF THE NUMBER IS ODD, YOU MUST DODGE PROJECTILES.',
         '>NUMBERS ENDING IN 1 GIVE YOU STAR- SHAPED ONES...',
         '>NUMBERS ENDING IN 3 GIVE YOU MOON- SHAPED ONES...',
         '>{#f/4}5 GIVES YOU COMETS, 7 GIVES YOU QUASARS...',
         ">{#f/9}AND IF IT ENDS IN A 9, IT'S ENTIRELY RANDOM!",
         '>{#f/0}IF THE NUMBER IS PRIME, THE GRAVITY WILL FLIP.',
         ">{#f/4}(ALTHOUGH, PRIMES BELOW TEN DON'T OFTEN TRIGGER IT.)",
         '>{#f/0}IF THE NUMBER IS EVEN, YOU WILL BE FINE AT FIRST...',
         '>{#f/9}BUT RANDOM MONSTER ENCOUNTERS WILL OCCUR!',
         '>ALSO, POWERS OF TWO WILL DOUBLE THE FREQUENCY!!',
         '>{#f/0}IF THE NUMBER REPEATS THE SAME DIGIT TWICE...',
         '>{#f/0}THE WAIT TIME WILL BE MULTIPLIED BY SAID DIGIT!',
         '>{#f/0}IF THE NUMBER IS A RUN, I.E. 1-2-3...',
         '>{#f/0}THE ROOM WILL SHAKE, CAUSING YOU TO STUMBLE!',
         '>{#f/0}AND IF THE NUMBER CONTAINS A 4 AT ALL...',
         '>{#f/9}SANS WILL RANDOMLY LEVITATE YOU WITH BLUE MAGIC!',
         ">{#p/sans}{#f/6}* check it out, it's my special yellow eye.",
         '>{#p/papyrus}{#f/7}NOT NOW, SANS!!',
         '>{#p/sans}* oh, heheh.\n* guess i got a little {@fill=#ff0}carried away{@fill=#fff}, huh?',
         '>{#p/papyrus}{#f/4}YEAH, YEAH...',
         '>{#f/9}WELL!\nDO YOU UNDERSTAND THE EXPLANATION?',
         choicer.create('* (What do you say?)', 'Yes', 'No')
      ],
      papyrus7: () => [
         ">{#p/papyrus}{#f/9}WELL, LET'S REVIEW THEN!",
         '>{#f/0}THIS DISPLAY GENERATES A RANDOM NUMBER OF SECONDS.',
         '>AKA, HOW LONG YOU MUST WAIT TO PASS THROUGH.',
         '>ODD NUMBERS MEAN DODGING PROJECTILES.',
         ">THE NUMBER'S LAST DIGIT DETERMINES THE TYPE.",
         '>1 FOR STARS, 3 FOR MOONS, 5 FOR QUASARS, 7 FOR...',
         '>{#f/5}WAIT, WHICH NUMBER WAS FOR QUASARS AGAIN??',
         '>{#f/9}UH, WELL, IF IT ENDS IN 9, THE TYPE IS RANDOM!',
         '>{#f/0}PRIME NUMBERS SHIFT THE GRAVITY AROUND...',
         '>{#f/0}EVEN NUMBERS TRIGGER RANDOM ENCOUNTERS...',
         '>{#f/5}WAIT, DID I SAY THE GRAVITY SHIFTS!?,',
         '>{#f/7}UGH, I MEANT TO SAY IT FLIPS!!',
         '>{#f/0}BUT POWERS OF TWO DOUBLE THE ENCOUNTER RATE.',
         '>RUNS CAUSE THE ROOM TO SHAKE, AND 4 MEANS...',
         '>{#f/6}UH, I THINK I FORGOT WHAT 4 MEANS.',
      ...
      papyrus8: [
         '>{#p/papyrus}{#f/9}WELL... THEN...',
         ">{#f/9}YOU KNOW WHAT, I'LL LEAVE THE INSTRUCTIONS HERE!",
         '>{#f/0}THEN, YOU CAN READ THEM AT YOUR OWN PACE.',
         '>GOOD LUCK, HUMAN!!',
         '>{#f/5}NYEH... HEH HEH...'
      ],
      papyrus9: [
         '>{#p/papyrus}{#f/9}AWESOME SAUCE!',
         '>{#f/9}WELL, WITHOUT FURTHER ADO...',
         ">LET'S FIND OUT WHAT OUR RANDOM NUMBER WILL BE!!"
      ],
      papyrus10: [
         '>{#p/papyrus}{#f/9}HUMAN!',
         '>{#f/9}ARE YOU READY FOR YOUR GREATEST CHALLENGE YET?',
         '>{#f/9}INTRODUCING... THE GAUNTLET OF DEADLY TERROR!'
      ],
      papyrus11: [
         '>{#p/papyrus}{#f/9}ONCE I GIVE THE WORD, IT WILL FULLY ACTIVATE!',
         '>LASERS WILL FIRE!\nCOILS WILL CHARGE!\nBLADES WILL SLICE!',
         '>ALL IN A PRECISE AND TACTICAL MANNER!',
         '>{#f/4}WITHOUT PERFECT ACCURACY, YOU WILL SURELY FAIL.',
         '>{#f/9}NOW!!!\nARE YOU READY!?!?',
         '>BECAUSE!',
         '>I!',
         '>AM!',
      ...
      papyrus12: [
         ...
         '>{#p/papyrus}{#f/7}ANY SECOND NOW!'
      ],
      papyrus13: [
         '>{#p/sans}* ready when you are.',
         '>{#p/papyrus}{#f/6}I...',
         ">{#f/6}I'M STARTING TO THINK THAT...",
         '>{#f/6}MAYBE...',
         '>{#f/6}THIS CHALLENGE...',
         '>{#f/6}...',
         '>{#f/4}... WAS A BIT OF A BAD IDEA.',
         '>{#f/5}TO THINK I CREATED SUCH A HARMFUL CHALLENGE...',
         '>{#f/9}BUT, HAVE NO FEAR!',
         '>{#f/9}I AM A SKELETON WITH STANDARDS!',
         '>{#f/4}AND, FRANKLY, A CHALLENGE YOU CANNOT SURVIVE...',
         '>{#f/7}IS A CHALLENGE FAR TOO CONTRIVED!',
         '>AWAY IT GOES!!'
      ],
      papyrus14: [
         '>{#p/papyrus}{#f/7}WHAT ARE YOU LOOKING AT!?',
         '>{#f/9}THIS WAS ANOTHER DECISIVE VICTORY FOR PAPYRUS!!',
         '>NYEH!',
         '>HEH!',
         '>{#f/4}...',
         '>... HEH?'
      ...
      papyrusFinal2: () =>
         world.genocide
            ? [
               '>THE SADNESS OF LOSING SOMEONE SPECIAL.',
               '>THE GUILT OF NOT BEING ABLE TO SAVE THEM.',
               '>THE DESIRE TO SEE THEM ONE LAST TIME.',
               '>THESE FEELINGS...'
            ]
            : papreal()
               ? [
                  '>THE STRESS OF KNOWING SO MANY PEOPLE HAVE BEEN KILLED.',
                  ">THE HOPELESSNESS OF THINKING YOU CAN'T DO ANYTHING TO STOP IT.",
                  '>THE DESIRE TO MAKE A CHANGE FOR THE BETTER.',
                  '>THESE FEELINGS...'
               ]
               : [
      ...
      papyrusFinal3: () =>
         world.genocide || papreal()
            ? [
               '>{#f/31}THEY MUST BE WHAT YOU ARE FEELING, RIGHT NOW.',
               '>{#f/32}I CAN HARDLY IMAGINE WHAT THAT MUST FEEL LIKE...',
               '>{#f/6}AFTER ALL, I AM VERY... GREAT...',
               '>{#f/32}{#x1}...',
               '>{#f/31}DESPITE EVERYTHING THAT HAS HAPPENED, I STILL...',
               '>{#f/5}I STILL BELIEVE IN YOU, HUMAN.',
               '>{#f/31}I KNOW YOU CAN DO BETTER.',
               '>{#f/31}I KNOW YOU HAVE IT IN YOU TO CHANGE.',
               ...(world.genocide
                  ? [">{#f/4}NO MATTER WHAT RIDICULOUS THING 'ASRIEL' SAYS..."]
                  : ['>{#f/5}NO MATTER HOW IRREDEEMABLE YOU THINK YOU ARE...']),
               ">{#f/6}{#x2}I KNOW, DEEP DOWN, THERE'S STILL GOOD IN YOU!",
               '>{#f/0}SO LET ME HELP YOU FIND THAT GOODNESS.',
               '>{#f/0}LET ME HELP YOU DISCOVER YOUR TRUE POTENTIAL.',
               '>{#f/4}AND MOST OF ALL...',
               '>{#f/9}LET ME SHOW YOU THAT YOU CAN STILL BE GREAT!!!',
               '>{#f/0}I, PAPYRUS, WELCOME YOU WITH OPEN ARMS!'
            ]
            : [
               '>{#f/0}THEY MUST BE WHAT YOU ARE FEELING RIGHT NOW!!',
               '>{#f/4}I CAN HARDLY IMAGINE WHAT THAT MUST FEEL LIKE.',
               '>{#f/4}AFTER ALL, I AM VERY GREAT.',
               '>I NEVER WONDER WHAT HAVING MANY FRIENDS IS LIKE.',
               '>{#f/5}I PITY YOU, LONELY HUMAN...',
               '>{#f/0}BUT WORRY NOT!!!\nYOU SHALL BE LONELY NO LONGER!',
               '>{#f/9}FOR I, THE GREAT PAPYRUS, WILL BE YOUR...',
               '>{#f/5}{#x1}...',
               '>NO...',
               '>{#f/7}{#x2}NO, THIS IS ALL WRONG!',
               '>I CAN\'T BE YOUR "FRIEND..."',
               '>YOU ARE A HUMAN!\nI MUST CAPTURE YOU!!!',
               '>{#f/9}THEN, I CAN FULFILL MY LIFELONG DREAM!!!',
               '>POWERFUL!\nPOPULAR!\nPRESTIGIOUS!!!',
               ">THAT'S PAPYRUS!!!",
               '>{#f/4}THE NEWEST MEMBER...',
               '>{#f/9}OF THE ROYAL GUARD!!!'
            ],
      papyrusFinal4: (b: boolean) =>
         world.edgy || world.killed0
            ? [
               '>{#p/papyrus}{#f/0}WOWIE!\nYOU DID IT!',
               ">{#p/papyrus}{#f/5}YOU DIDN'T DO A VIOLENCE!",
               '>{#p/papyrus}{#f/6}TO BE HONEST, I WAS A LITTLE AFRAID...',
               ">{#p/papyrus}{#f/0}BUT YOU'RE ALREADY TAKING STEPS TO REDEEM YOURSELF!",
               ">{#p/papyrus}{#f/8}I'M SO PROUD OF YOU, HUMAN!",
               ">{#p/papyrus}{#f/4}... WAIT, WASN'T I SUPPOSED TO CAPTURE YOU?",
               ">{#p/papyrus}{#f/0}OH WELL.\nIT'S NOT IMPORTANT RIGHT NOW.",
               '>{#p/papyrus}{#f/0}I JUST WANT YOU TO BE THE BEST PERSON YOU CAN BE.',
               ">{#p/papyrus}{#f/5}LET'S LET BYBONES BE BYBONES, HUH?",
               ">{#p/papyrus}{#f/9}I'LL EVEN GIVE YOU DIRECTIONS TO THE EXIT!"
            ]
            : [
               '>{#p/papyrus}{#f/5}NYOO HOO HOO...',
               ...(b
                  ? [">I WASN'T STRONG ENOUGH TO STOP YOU..."]
                  : [">I CAN'T EVEN STOP SOMEONE AS WEAK AS YOU..."]),
               ">{#f/7}UNDYNE'S GOING TO BE DISAPPOINTED!",
               ">{#f/5}I'LL NEVER JOIN THE ROYAL GUARD... AND...",
               '>{#f/7}MY FRIEND QUANTITY WILL REMAIN STAGNANT!',
      ...
      papyrusFinal4a1: (b: boolean) =>
         b
            ...
            : [
               '>{#p/papyrus}{#f/1}REALLY!?\nYOU WANT TO BE FRIENDS WITH ME???',
               '>{#f/6}WELL THEN...\nI GUESS...',
               '>{#f/0}I CAN MAKE AN ALLOWANCE FOR YOU!'
            ],
      papyrusFinal4a2: (b: boolean) =>
         b
            ? [
               '>{#p/papyrus}{#f/5}HUH? ARE YOU... TRYING TO BERATE ME???',
               ">{#f/6}YOU THINK I'M NOT STRONG ENOUGH TO BE YOUR FRIEND?",
               '>{#f/5}... N-NO...',
               '>{#f/7}NO, WHAT AM I SAYING!!\nOF COURSE I AM!',
               ">{#f/9}AND... I'LL PROVE IT BY BEING YOUR FRIEND ANYWAY!"
            ]
            : [
               '>{#p/papyrus}{#f/1}HUH? WHY WOULD YOU BERATE YOURSELF SO LOUDLY???',
               '>{#f/4}IS IT BECAUSE...',
               ">{#f/7}YOU DON'T THINK YOU'RE GOOD ENOUGH TO BE MY FRIEND?",
               ">{#f/9}NO, YOU'RE GREAT!\nI'LL BE YOUR FRIEND!!!"
            ],
      papyrusFinal4b1: [
         '>{#f/0}WOWIE!!',
         '>I FOUND A NEW FRIEND!!!',
         '>{#f/4}AND WHO KNEW THAT ALL I NEEDED TO DO IT...'
      ],
      papyrusFinal4b2: [
         '>{#f/0}WOWIE!!',
         ">{#f/0}WE HAVEN'T EVEN HAD OUR FIRST DATE...",
         ">{#f/0}AND I'VE ALREADY MANAGED TO HIT THE FRIEND ZONE!!!",
         '>{#f/4}WHO KNEW THAT ALL I HAD TO DO...'
      ],
      papyrusFinal4c1: [
         '>{#f/0}WAS TO GIVE PEOPLE AWFUL PUZZLES AND THEN FIGHT THEM?',
         '>YOU TAUGHT ME A LOT, HUMAN.',
         '>{#f/9}I HEREBY GRANT YOU PERMISSION TO PASS THROUGH!',
         ">{#f/0}AND I'LL GIVE YOU DIRECTIONS TO THE EXIT."
      ],
      papyrusFinal4c2: [
         '>CONTINUE FORWARD UNTIL YOU REACH THE CITADEL.',
         '>THEN, HOP IN A CRAFT AND CROSS THE {@fill=#ff0}FORCE FIELD{@fill=#fff}.',
         ">{#f/4}THAT'S THE THING TRAPPING US ALL ON THE OUTPOST.",
         '>ANYONE CAN ENTER THROUGH IT, BUT NOBODY CAN EXIT...',
         '>{#f/9}... EXCEPT SOMEONE WITH A POWERFUL SOUL.',
         '>{#f/0}LIKE YOU!!!'
      ],
      papyrusFinal4d: [
         '>{#f/4}OH, I ALMOST FORGOT TO MENTION.',
         '>TO REACH THE EXIT, YOU WILL HAVE TO PASS...',
         '>{#f/7}BY {@fill=#ff0}THE KING{@fill=#fff}.',
         '>{@fill=#ff0}THE KING OF ALL MONSTERS...',
         '>{@fill=#ff0}HE IS...',
         '>{@fill=#ff0}{#f/6}... WELL...'
      ],
      papyrusFinal4e: [
         ">{#f/0}HE'S A BIG FUZZY PUSHOVER!!!",
         '>EVERYBODY LOVES THAT GUY.',
         '>{#f/4}I AM CERTAIN IF YOU JUST SAY...',
         '>"EXCUSE ME, MR. DREEMURR... CAN I PLEASE GO HOME?"',
         ">{#f/0}HE'LL GUIDE YOU OVER TO THE LAUNCH BAY HIMSELF!",
         ">{#f/9}ANYWAY!!!\nTHAT'S ENOUGH TALKING!!!",
         ">{#f/0}I'LL BE AT HOME BEING A COOL FRIEND."
      ],
      papyrusFinal4f1: ['>{#f/9}FEEL FREE TO COME BY AND HANG OUT!!!'],
      papyrusFinal4f2: ['>{#f/9}FEEL FREE TO COME BY AND HAVE THAT DATE!!!'],
      papyrusFinal4f3: ['>{#f/9}FEEL FREE TO COME BY AND SAY HELLO!!!'],
      papyrusFinal4g: ['>NYEH HEH HEH HEH HEH HEH HEH!!!'],
      papyrusFinal5: [
         '>{#p/papyrus}{#f/5}OH, WHERE COULD THAT HUMAN HAVE GONE...',
         '>{#f/4}...\nWAIT.',
         ">{#f/1}IT'S RIGHT IN FRONT OF ME!!!",
         '>{#f/0}HELLO! I WAS WORRIED THAT YOU HAD GOTTEN LOST!',
         ">IT SURE IS A RELIEF TO SEE THAT YOU'RE HERE...",
         '>{#f/7}...\nWAIT A SECOND!!!',
         ">YOU'RE NOT SUPPOSED TO ESCAPE!!!",
         '>GET BACK THERE!!!'
      ],
      papyrusFinal6: [
         '>{#p/papyrus}{#f/4}BACK AGAIN, EH?',
         ">{#f/5}I SUPPOSE IT'S MY FAULT...",
         ...
         '>{#f/0}WELL... I UNDERSTAND.',
         '>{#f/0}PAPYRUS IS HUNGRY, TOO!',
         '>{#f/7}HUNGRY FOR JUSTICE!'
      ],
      papyrusFinal7: () => [
         ">{#p/papyrus}{#f/1}YOU'RE BACK AGAIN!?!?",
         '>{#f/4}I FINALLY REALIZE THE TRUE REASON WHY.',
         '>{#f/5}YOU...',
         '>YOU JUST MISS SEEING MY FACE SO MUCH...',
         '>{#f/6}I...',
         ">{#f/31}I'M NOT SURE I CAN FIGHT SOMEONE WHO FEELS THIS WAY.",
         ">{#f/4}NOT TO MENTION, I'M GETTING TIRED OF CAPTURING YOU.",
         '>{#f/5}WOULD YOU LIKE TO PASS THROUGH...',
         '>{#f/5}... WITHOUT A BATTLE?',
         choicer.create('* (What do you say?)', 'Yes', 'No')
      ],
      papyrusFinal7a: ['>{#p/papyrus}{#f/31}...\nOKAY...', ">{#f/3}I GUESS I'LL ACCEPT MY FAILURE."],
      papyrusFinal7b: ['>{#p/papyrus}{#f/4}WELL, IF YOU SAY SO, THEN...', '>{#f/9}BY ALL MEANS!!!'],
      papyrusFinal8: () => [
         '>{#p/papyrus}{#f/1}AGAIN??',
         '>{#f/4}... WELL, OKAY...',
         '>{#f/9}WILL YOU FORGO THE BATTLE THIS TIME??',
         choicer.create('* (What do you say?)', 'Yes', 'No')
      ],
      papyrusFinal8a: ['>{#p/papyrus}{#f/0}OKAY, HERE WE GO!'],
      puzzle3: () => [
         '>{#p/human}* (You activate the terminal.)',
      ...
      sans1: [
         '>{#p/darksans}{#i/4}* {@spacing=2.25/0}Human.',
         ">* {@spacing=2.25/0}Don't you know how to{@spacing=}\n  {@spacing=2.25/0}greet a new pal?",
         '>* {@spacing=2.25/0}Turn around and shake{@spacing=}\n  {@spacing=2.25/0}my hand.'
      ],
      sans2: () => [
         ...(world.edgy
            ? [
      ...
      sans5: [
         '>{#p/papyrus}{#x2}{#f/7}YOU KNOW WHAT "SUP," BROTHER!',
         '>YOU HAVE PUZZLES TO ATTEND TO!',
         ">I'VE GIVEN YOU PLENTY OF LEEWAY, BUT STILL...",
         '>YOU SIT AROUND AND DO NOTHING ALL DAY!',
         ...
         '>{#x2}IF A HUMAN COMES THROUGH HERE, I WANT TO BE READY!',
         '>I MUST BE THE ONE!\nI WILL BE THE ONE!',
         '>{#x1}{#f/9}I WILL FINALLY CAPTURE A HUMAN!',
         '>{#x4}{#f/0}THEN I, THE GREAT PAPYRUS...',
         '>WILL GET ALL THE THINGS I UTTERLY DESERVE!',
         '>RESPECT...\nRECOGNITION...',
         '>{#f/9}I WILL FINALLY BE ABLE TO JOIN THE ROYAL GUARD!',
         '>{#p/sans}* hmm...',
         '>{#f/2}* maybe this gadget will help you.',
         ">{#p/papyrus}{#x3}{#f/7}SANS, THAT WON'T DO ANYTHING!\nYOU LAZYBONES!",
         '>{#x1}{#f/5}YOU KNOW, YOU ARE CAPABLE OF SO MUCH MORE, YET...',
         '>{#x2}{#f/7}YOU CHOOSE TO SIT AROUND AND DO NOTHING ALL DAY!',
         ">{#x1}{#f/5}DON'T YOU WANT... MORE, OUT OF LIFE?",
      ...
      sans6: [
         ...
         ">{#p/sans}{#f/5}* come on.\n* you're smiling.",
         '>{#p/papyrus}{#x2}{#f/7}I AM AND I UTTERLY DESPISE IT!',
         '>{#x1}{#f/4}(SIGH...)',
         '>{#f/5}WHY DOES SOMEONE\nAS GREAT AS MYSELF...',
      ...
      sans7: [
         '>{#p/papyrus}{#x2}{#f/7}UGH!!',
         '>{#x1}{#f/4}I WILL ATTEND TO MY PUZZLES...',
         '>{#f/7}AS FOR YOUR WORK?',
         '>{#f/4}I EXPECT YOU TO DO A MORE...',
         '>{#f/9}{@fill=#ff0}"STELLAR"{@fill=#fff} JOB FROM NOW ON!!!',
         '>{#f/0}NYEHEHEHEHEHE\nHEHEHEHEHEHEH!!'
      ],
      sans8: ['>{#p/papyrus}HEH!'],
      ...
      sansbook10: () => [
         ...
         '>{#p/without}* "heh..."',
         '>{#p/without}* "don\'t read into it too deeply."',
      ...
      sansinter: {
         ...
         s_jenga: pager.create(
            ...
            [">{#p/sans}{#f/2}* ... the man up top's a sucker for spaghetti."]
         ),
            ...
            () =>
               world.edgy
                  ...
                  : world.killed5
                     ...
                     : ['>{#p/sans}{#f/0}* all sorts of attacks.']
         )
      },
      sansbredgey: () =>
         world.edgy
            ...
            SAVE.data.b.svr
               ...
               : [
                  ...
                  ...(world.genocide || world.runaway
                     ? [
                        '>{#p/papyrus}{#f/30}"PLEASE DO NOT DESTROY MY SENTRY STATION."',
                        '>"I WORKED VERY HARD ON IT, AND IT\'D BE A SHAME IF IT WERE RUINED."',
                        '>"... THAT IS ALL."',
                        '>("NOTE: I WOULD HAVE SAID MORE, BUT THERE\'S NOT ENOUGH ROOM.")'
                     ]
                     : [
                        '>{#p/papyrus}{#f/30}"YOU OBSERVE THE WELL- CRAFTED SENTRY STATION."',
            ...
            : world.darker
               ...
               : SAVE.data.n.plot < 31
                  ...
                  : SAVE.data.n.plot === 72
                     ...
                     : [">{#p/basic}* Sans's sentry station...", '>* A poor investment in hindsight.'],
      ...
      trivia: {
         ...
         ntower: () =>
            SAVE.data.b.svr
               ...
               : SAVE.data.b.s_state_puzzlenote || (!world.genocide && world.edgy)
                  ...
                  : postSIGMA()
                     ? [">{#p/basic}* It's out of service."]
                     : ['>{#p/basic}* What an unfortunate outcome.'],
         s_secret_sign: () =>
            SAVE.data.b.svr
         ...
         s_bh_cottonball: () =>
            SAVE.data.b.svr
               ...
               : [
                  ...
                  '>{#p/without}* "ok."',
                  '>{#p/papyrusnt}"DON\'T PUT IT BACK DOWN!"\n"MOVE IT!"',
                  '>{#p/without}* "ok."',
                  '>{#p/papyrusnt}"YOU MOVED IT TWO MICRONS!"\n"MOVE IT TO YOUR ROOM!"',
                  '>{#p/without}* "ok."',
                  '>{#p/papyrusnt}"AND DON\'T BRING IT BACK!"',
                  '>{#p/without}* "ok."',
                  '>{#p/papyrusnt}"IT\'S STILL HERE!"',
                  '>{#p/without}* "didn\'t you just say not to bring it back to my room?"',
                  '>{#p/papyrusnt}"FORGET IT!"'
               ],
         s_paptrash: pager.create(
            ...
            ...[
               () => [
                  ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                     ? [
                        ">{#p/papyrus}{#f/9}I DIDN'T KNOW YOU WERE A FAN OF GARBAGE-HUNTING!",
                        '>{#f/0}DR. ALPHYS WOULD LIKE TO KNOW YOUR NUMBER.'
                     ]
                     : []),
               ...
               pager.create(
                  ...
                  ...[
                     ...
                     [">{#p/basic}* You might even say I'm feeling... otherworldly."],
                        ...
                        : [
                           ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                              ? [
                                 ...
                                 '>{#f/0}PLEASE, FEEL FREE TO PERUSE MY CULINARY ARTSHOW.'
                              ]
                              : []),
               ...
               SAVE.data.b.svr
                  ...
                  : world.runaway
                     ...
                     : SAVE.data.n.plot === 72
                        ...
                        : [
                           ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                              ? [">{#p/papyrus}GREAT FRIDGE, ISN'T IT?"]
                              : []),
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                        ? [
                           '>{#p/papyrus}AH YES, THE DINING TABLE.',
                           '>{#f/5}WE USED TO KEEP A PET MOON ROCK THERE...',
                           '>{#f/7}UNTIL ONE DAY, IT TOTALLY VANISHED!',
                           '>{#f/4}AT FIRST, I BLAMED THAT MEDDLING CANINE...',
                           '>{#f/7}BUT THEN I FOUND THAT SANS HAD USED IT TO TEST HIS...',
                           '>{#f/6}HIS... ACTUALLY USEFUL GADGET.\nWOWIE...',
                           ">{#f/0}YOU KNOW WHAT, I'LL GIVE IT TO HIM.",
                           '>{#f/0}HE GENUINELY TRIED PUTTING EFFORT INTO SOMETHING.',
                           '>{#f/4}EVEN IF IT COST US A VALUABLE MOON ROCK.',
                           ">{#f/0}YEAH!!\n'E' FOR EFFORT!!"
                        ]
                        : []),
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...
                     ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                        ? [
                           '>{#p/papyrus}MY BROTHER ALWAYS GOES OUT TO EAT.',
                           ">{#f/4}BUT RECENTLY, HE TRIED 'BAKING' SOMETHING...",
                           '>{#f/5}I THINK IT WAS... A CHEESECAKE?',
                           ">{#f/6}I'M NOT QUITE SURE."
                        ]
                        : [])
                  ],
            () =>
         ...
         s_sr_lamp: [
            ...
            '>{#p/papyrusnt}"SORRY, BUT I TOOK BACK THE FLASHLIGHT YOU WERE USING HERE."',
            '>{#p/papyrusnt}"IT\'S NOT THAT I MIND YOU USING MY PROPERTY..."',
            '>{#p/papyrusnt}"BUT USING IT IN SUCH AN IMPROPER WAY IS ENTIRELY UNJUSTIFIED!"',
            '>{#p/papyrusnt}"I DON\'T KNOW ABOUT YOU, BUT THE LAST TIME I CHECKED..."',
            '>{#p/papyrusnt}"A FLASHLIGHT DID NOT COUNT AS NOT A LIGHTBULB!!"'
         ],
         s_sc_book: [
         ...
         s_sc_diagram: () => [
            ...
            '>{#p/basic}* A forcefield polarity inverter, a wormhole aperture stabilizer, and a monster-bound human SOUL.',
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...
                     ...(roomready()
                        ? [
                           ">{#p/papyrus}THAT'S MY BED!",
                           '>{#f/4}IF I EVER GET TO EXPLORE THE STARS...',
                           ">{#f/0}I'D LIKE TO CRUISE DOWN A LONG INTER- STELLAR HIGHWAY.",
                           '>STATIC IN MY HAIR, STARLIGHT ON MY SKIN...',
                           ">{#f/4}OF COURSE, THAT'S JUST A DREAM.",
                           '>{#f/0}SO INSTEAD I CRUISE WHILE I SNOOZE.'
                        ]
                        : [])
                  ],
            () =>
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...
                     ...(roomready()
                        ? [
                           '>{#p/papyrus}HEY, THOSE ARE ALL THE ATTACKS I USED ON YOU.',
                           '>GREAT MEMORIES, HUH?',
                           '>SEEMS LIKE IT WAS ONLY YESTERDAY...',
                           '>{#f/4}EVEN THOUGH IT BASICALLY JUST HAPPENED.'
                        ]
                        : [])
                  ],
            () =>
         ...
         s_pr_papcloset: pager.create(
            ...
            () => [
               ...
               ...(roomready()
                  ? [
                     ">{#p/papyrus}DON'T WORRY, THE CLOSET IS SKELETON-FREE.",
                     ">{#f/4}UNLESS I'M CHANGING, OF COURSE."
                  ]
                  : [])
            ],
            () => [
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...
                     ...(roomready()
                        ? [
                           ">{#p/papyrus}ISN'T THAT POSTER NEATO?",
                           '>UNDYNE FOUND IT ON A TRASH RUN.',
                           '>{#f/4}IT HAD A SKULL AND CROSSBONES ON IT AT FIRST...',
                           '>{#f/9}BUT I THOUGHT OF SOMETHING BETTER!'
                        ]
                        : [])
                  ],
            () =>
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                     ...
                     ...(roomready()
                        ? [
                           '>{#p/papyrus}AH, YES, ACTION FIGURES.',
                           '>A GREAT REFERENCE FOR THEORETICAL BATTLE SCENARIOS.',
                           '>{#f/4}BUT HOW DO I HAVE SO MANY?',
                           '>{#f/6}WELL, UMM...\nTHE KING GAVE THEM TO ME AS A GIFT...',
                           '>{#f/5}A GIFT I TRULY WISH I COULD REPAY HIM FOR.'
                        ]
                        : [])
                  ],
            () =>
               ...
               : world.postnoot && world.nootflags.has('s_puzzle3') // NO-TRANSLATE
                  ...
                  : !world.genocide && world.edgy
                     ...
                     : [
                        ...
                        '>{#p/papyrus}{#f/30}"HUMAN!! THIS PUZZLE IS NOT AS IT SEEMS."',
                        '>"WHILE I WAS WAITING FOR YOU, I TRIED TO MODIFY IT..."',
                        '>"TO MAKE THE PATTERN RESEMBLE MY FACE, OF COURSE!"',
                        '>"BUT SOMETHING WENT WRONG..."',
                        '>"ALL I COULD CREATE WAS A LOUSY ARROW SHAPE!!!"',
                        '>"(IN OTHER WORDS, YOU WILL HAVE TO SOLVE IT YOURSELF.)"',
         ...
         s_trapnote: () =>
            [
               [
                  ">{#p/basic}* It's a note from Papyrus...",
                  '>{#p/papyrus}{#f/30}"SORRY, I HAVE TO LOCK YOU IN THE GUEST ROOM UNTIL UNDYNE ARRIVES."',
      ...
      vegetoid: pager.create(
         ...
         () => [
            ...
            '>{#p/basic}* Are they even a real monster...?'
         ],
         () => [
            SAVE.data.n.plot === 72
   ...
   b_opponent_stardrake: {
      ...
      idleTalk3: () =>
         SAVE.data.b.s_state_chilldrake
            ...
            : ['>{#p/basic}{~}Haven\'t seen home in "light- years.."'],
      idleTalk4: () =>
         SAVE.data.b.s_state_chilldrake
   ...
   b_opponent_jerry: {
      ...
      idleTalk1: () =>
         SAVE.data.b.spared_jerry
            ...
            : [">{#p/basic}{~}Aren't you guys BORED?"],
      idleTalk2: () =>
         SAVE.data.b.spared_jerry
            ? ['>{#p/basic}{~}Can we do this more often??']
            : ['>{#p/basic}{~}Why are we doing this?'],
      idleTalk3: () =>
         SAVE.data.b.spared_jerry
      ...
      idleTalkSolo2: () =>
         SAVE.data.b.spared_jerry
            ...
            : ['>{#p/basic}{~}So like, what are you even doing?'],
      idleTalkSolo3: () =>
         SAVE.data.b.spared_jerry
   ...
   b_opponent_mouse: {
      ...
      disownTalk1: ['>{#p/basic}{~}Keep your paws off me..!'],
      ...
      initTalk3: ['>{#p/basic}{~}The si- tuation is not ideal.'],
      ...
      remindTalk1: ['>{#p/basic}{~}Live in holes, do they..?'],
      remindTalk2: ['>{#p/basic}{~}Squeak like toys, do they..?'],
      remindTalk3: ['>{#p/basic}{~}From now on, I shall live as a mouse.'],
      safeStatus: () =>
   ...
   b_opponent_doggo: {
      ...
      fetchTalk: pager.create(
         0,
         ['>{#p/basic}{~}HUH!! A FUN WRENCH APPEARS!'],
         ['>{#p/basic}{~}HUH!! THERE IT IS AGAIN!']
      ),
      fetchTalkX1: [">{#p/basic}{~}WHERE'D IT GO!?"],
      fetchTalkX2: [">{#p/basic}{~}WHERE'S MY WRENCH NOW!?"],
      flirt1: ['>{#p/basic}{~}(Blushes uncontrol- lably)'],
      invisStatus: () =>
      ...
      query1: ['>{#p/basic}{~}No escape!'],
      query2: [">{*}{#p/basic}{~}Ha!\nIt moved!\nIt couldn't NOT move!{^30}{%}"],
      query3: ['>{#p/basic}{~}Will it move this time?'],
   ...
   b_opponent_lesserdog: {
      ...
      petTalk2: ['>{#p/basic}{~}(Tiny bark)'],
      petTalk3: ['>{#p/basic}{~}(Wag wag)'],
      petTalk4: ['>{#p/basic}{~}(Thinks of food)'],
      petTalk5: ['>{#p/basic}{~}(Pant! Pant!)'],
   ...
   b_opponent_dogamy: {
      ...
      flirtTalk2: ['>{#p/basic}{~}Love is in the air?'],
      flirtTalk3: [">{#p/basic}{~}You didn't just..."],
      flirtTalk4: [">{#p/basic}{~}What's the puppy doing?"],
      flirtText: [
      ...
      loneTalk1: ['>{#p/basic}{~}Whine.'],
      loneTalk2: ['>{#p/basic}{~}Whimper.'],
      loneTalk3: ['>{#p/basic}{~}Shake.'],
      name: '* Dogamy',
      ...
      petTalk1: ['>{#p/basic}{~}Paws off you smelly human.'],
      petTalk1x: ['>{#p/basic}{~}Paws off you weird puppy.'],
      petTalk2: ['>{#p/basic}{~}Wow!!!\nPet by another pup!!!'],
      petTalk3: [">{#p/basic}{~}Stop!\nDon't touch her!"],
      petTalk4: ['>{#p/basic}{~}What\nabout\nme......'],
      petTalk5: ['>{#p/basic}{~}Thank\nyou...'],
      ...
      rollText2: [
         '>{#p/human}* (You roll around in the dirt.)\n* (It appears to be synthetic.)',
         '>{#p/basic}* Your scent has already changed.'
      ],
      rollTextLone: () => [
   ...
   b_opponent_dogaressa: {
      ...
      resmellTextLone: [
         '>{#p/human}* (You encourage Dogaressa to sniff you, and she forcefully shoves her snout in your face.)'
      ],
      rollTextLone: () => [
   ...
   b_opponent_papyrus: {
      ...
      spannerTalk4: ['>{#p/papyrus}{#f/20}NYEH HEH HEH!'],
      ...
      capture1: [
         ...
         '>{#f/20}NYEH HEH HEH HEH HEH HEH HEH!!!'
      ],
      capture2: [
      ...
      checkTalk: ['>{#p/papyrus}{#f/20}NYEH HEH HEH!'],
      death1: () =>
         world.genocide
            ? ['>{#p/papyrus}{#f/27}N...\nN-NO...']
            : [">{#p/papyrus}{#f/21}WELL, THAT'S NOT WHAT I WAS EXPECTING..."],
      death2: () =>
         world.genocide
            ? ['>{#p/papyrus}{#f/21}SANS, I...', '>{#f/33}{@random=1.1/1.1}I FAILED YOU...']
            : papreal()
               ? [
                  '>{#p/papyrus}{#f/27}... B-BUT I STILL BELIEVE IN YOU!',
                  '>{#p/papyrus}{#f/21}I KNOW... YOU CAN DO BETTER...',
                  '>{#p/papyrus}{#f/27}IF YOU JUST TRY...!'
               ]
               : ['>{#p/papyrus}{#f/27}... A-AT LEAST I STILL HAVE MY HEAD!'],
      dots: ['>{#p/basic}* ...'],
      flirt0: ['>{#p/basic}* Cute.'],
      flirt1: [
         '>{#p/papyrus}{#f/20}WHAT!?\nF-F-FLIRTING!?',
         '>SO YOU FINALLY REVEAL YOUR {@fill=#f00}ULTIMATE FEELINGS{@fill=#000}!',
         ">W-WELL!\nI'M A SKELETON WITH VERY HIGH STANDARDS!!!",
         '>WHAT CAN YOU DO IN RETURN FOR MY AFFECTION???'
      ],
      flirt2: [
         '>{#p/human}* (Your reply?){!}§shift=24§I have\n§shift=32§I can make§shift=32§zero redeeming\n§shift=32§spaghetti§shift=40§qualities{#c/0/4/2}'
      ],
      flirt3a: ['>{#p/papyrus}{#f/24}THAT CONFIDENCE... IT REMINDS ME OF...'],
      flirt3b: ['>{#p/papyrus}{#f/24}THAT HUMILITY... IT REMINDS ME OF...'],
      flirt4: [
         '>{#f/22}MYSELF!!!',
         ">{#f/10}YOU'RE MEETING ALL MY STANDARDS!!!",
         '>{#f/27}I GUESS THIS MEANS I HAVE TO GO ON A DATE WITH YOU...?'
      ],
      flirt5: [">{#p/papyrus}{#f/20}LET'S DATE L-LATER!!\nAFTER I CAPTURE YOU!"],
      ...
      turnTalk0b: [">{#p/papyrus}{#f/24}SO, YOU WON'T FIGHT..."],
      turnTalk0c: [">{#p/papyrus}{#f/20}THEN LET'S SEE HOW YOU HANDLE MY FABLED 'BLUE ATTACK!'"],
      turnTalk0x: [
         ">{#p/papyrus}{#f/10}YOU'RE BLUE NOW.",
         ">{#f/10}THAT'S MY ATTACK!",
         '>{#f/20}NYEH HEH HEH HEH HEH HEH HEH HEH HEH!!!'
      ],
      turnTalk1a: ['>{#p/papyrus}{#f/20}BEHOLD!'],
      turnTalk1b: ['>{#p/papyrus}{#f/20}HMMM... I WONDER WHAT I SHOULD WEAR...'],
      turnTalk2a: ['>{#p/papyrus}{#f/20}HOW HIGH CAN YOU JUMP?'],
      turnTalk2b: [">{#p/papyrus}{#f/22}WHAT!?\nI'M NOT THINKING ABOUT THE DATE!!"],
      turnTalk3: () =>
         world.postnoot
            ? ['>{#p/papyrus}{#f/21}... IS IT JUST ME, OR DOES THE AIR SEEM A LITTLE WEIRD?']
            : [">{#p/papyrus}{#f/20}YEAH!\nDON'T MAKE ME USE MY {@fill=#f00}SPECIAL ATTACK{@fill=#000}!"],
      turnTalk4: () =>
         world.postnoot
            ? [">{#p/papyrus}{#f/20}OH WELL.\nI'M SURE IT'S NOTHING."]
            : ['>{#p/papyrus}{#f/20}I CAN ALMOST TASTE MY FUTURE POPULARITY!!!'],
      turnTalk5: () =>
         world.postnoot
            ? ['>{#p/papyrus}{#f/20}BESIDES, I SEE MARINARA SAUCE IN MY FUTURE!']
            : ['>{#p/papyrus}{#f/20}PAPYRUS: UNPARALLELED SPAGHETTORE!'],
      turnTalk6: () =>
         world.postnoot
            ? ['>{#p/papyrus}{#f/20}AND A POSITION IN THE ELITE SQUAD!']
            : ['>{#p/papyrus}{#f/20}PAPYRUS: ELITE SQUAD MEMBER!'],
      turnTalk7: ['>{#p/papyrus}{#f/10}UNDYNE WILL BE REALLY PROUD OF ME!!'],
      turnTalk8: ['>{#p/papyrus}{#f/20}THE KING WILL BUILD A STATUE OF ME IN THE CITADEL!!!'],
      turnTalk9: [">{#p/papyrus}{#f/10}... AND I'LL MAKE SURE MY BROTHER GETS ONE TOO."],
      turnTalk10: [">{#p/papyrus}{#f/27}WE'LL HAVE LOTS OF ADMIRERS!!\nBUT..."],
      turnTalk11a: ['>{#p/papyrus}{#f/20}HOW WILL I KNOW IF PEOPLE SINCERELY LIKE ME???'],
      turnTalk11b: ['>{#p/papyrus}{#f/20}WILL ANYONE LIKE ME LIKE YOU DO?'],
      turnTalk12: ['>{#p/papyrus}{#f/21}SOMEONE LIKE YOU IS REALLY RARE...'],
      turnTalk13a: [">{#p/papyrus}{#f/21}I DON'T THINK THEY'LL LET YOU GO..."],
      turnTalk13b: ['>{#p/papyrus}{#f/21}AND DATING MIGHT BE KIND OF HARD...'],
      turnTalk14: [">{#p/papyrus}{#f/26}AFTER YOU'RE CAPTURED AND SENT AWAY."],
      turnTalk15: ['>{#p/papyrus}{#f/17}URGH... WHO CARES!\nGIVE UP!!'],
      turnTalk16: ['>{#p/papyrus}{#f/15}GIVE UP OR FACE MY... {@fill=#f00}SPECIAL ATTACK{@fill=#000}!'],
      turnTalk17: ['>{#p/papyrus}{#f/20}YEAH!!!\nVERY SOON I WILL USE MY {@fill=#f00}SPECIAL ATTACK{@fill=#000}!'],
      turnTalk18: [
         '>{#p/papyrus}{#f/20}THIS IS YOUR LAST CHANCE... BEFORE MY {@fill=#f00}SPECIAL ATTACK{@fill=#000}!'
      ],
      turnTalk19: ['>{#p/papyrus}{#f/20}BEHOLD...!\nMY {@fill=#f00}SPECIAL ATTACK{@fill=#000}!'],
      turnTalk19x: [
         '>{#p/papyrus}{#f/15}NYEH HEH HEH!',
         '>{#f/20}NO HUMAN HAS EVER BESTED MY {@fill=#f00}SPECIAL ATTACK{@fill=#000} BEFORE!',
         '>{#f/20}PREPARE TO BE CAPTURED, ONCE AND FOR ALL!'
      ],
      turnTalk20: ['>{#p/papyrus}{#f/20}SPECIAL ATTACK, FORMATION ALPHA!!'],
      turnTalk21: ['>{#p/papyrus}{#f/20}SPECIAL ATTACK, FORMATION BETA!!'],
      turnTalk22: ['>{#p/papyrus}{#f/20}SPECIAL ATTACK, FORMATION GAMMA!!'],
      turnTalk23: ['>{#p/papyrus}{#f/20}SPECIAL ATTACK, FORMATION DELTA!!'],
      turnTalk24: [
         '>{#p/papyrus}{#f/27}WOWIE!\nARE YOU STRONG!',
         '>{#f/20}BUT NO FEAR!\nI WILL NOT BE DETERRED BY YOUR STRENGTH!',
         '>{#f/14}... SPECIAL ATTACK...',
         '>{#f/17}FORMATION {@fill=#f00}SIGMA{@fill=#000}!!!'
      ],
      turnTalk24x: [
         ">{#p/papyrus}{#f/27}WELL...! *HUFF* IT'S CLEAR... YOU CAN'T! *HUFF* BEAT ME!",
         '>{#f/15}YEAH!!! I CAN SEE YOU SHAKING IN YOUR BOOTS!!',
         '>{#f/20}I, THE GREAT PAPYRUS, ELECT TO GRANT YOU PITY!!',
         '>{#f/20}I WILL {@fill=#f00}SPARE YOU{@fill=#000}, HUMAN!!!',
         ">{#f/10}NOW'S YOUR CHANCE TO ACCEPT MY {@fill=#f00}MERCY{@fill=#000}."
      ],
      idleTalk: ['>{#p/papyrus}{#f/20}...'],
      idleTalkBullied: ['>{#p/papyrus}{#f/27}...'],
      secretFlirt1: ['>{#p/papyrus}{#f/27}YOU WISH TO REMAIN WITH ME... FOREVER?', '>{#p/papyrus}{#f/21}HMM...'],
      secretFlirt2: [
         '>{#p/papyrus}{#f/27}SOMETHING IS TRYING TO TEAR OUR LOVE APART?',
         '>{#p/papyrus}{#f/21}I WONDER...'
      ],
      secretFlirt2x: [
      ...
      secretFlirt3: [
         ">{#p/papyrus}{#f/25}UH, I DON'T THINK WE'VE GOTTEN -THAT- FAR YET...",
         '>{#p/papyrus}{#f/15}... BUT WE CAN SURE TRY LATER!'
      ],
      secretFlirt3x: [">{#p/papyrus}{#f/27}WAIT, ARE -YOU- THE ONE WHO'S TRYING TO TEAR OUR LOVE APART?"],
      secretFlirt4: ['>{#p/papyrus}{#f/24}WAIT, ARE YOU SUGGESTING SOME KIND OF... LOVE TRIANGLE???'],
      secretFlirt4x: [
      ...
      secretFlirt6: [
         '>{#p/papyrus}{#f/14}WAIT... I THINK I GET IT NOW!',
      ...
      secretFlirt7: [
         ...
         '>{#p/papyrus}{#f/20}NYEH HEH HEH HEH HEH HEH HEH HEH HEH HEH!'
      ],
      secretFlirt8: [
         ...
         ">{#p/papyrus}{#f/15}DON'T WORRY, HUMAN!\nPAPYRUS HAS THIS UNDER CONTROL!"
      ],
      secretInsult1: ['>{#p/papyrus}{#f/27}UH... THANKS???'],
      secretInsult2: ['>{#p/papyrus}{#f/21}IDIOT... WHERE HAVE I HEARD THAT BEFORE...'],
      secretInsult2x: [
      ...
      secretInsult3: ['>{#p/papyrus}{#f/29}NOW WHAT...'],
      secretInsult3x: [
      ...
      secretInsult4: [">{#p/papyrus}{#f/27}I'M NOT SMART ENOUGH TO REALIZE WHAT'S GOING ON...?"],
      secretInsult4x: [
      ...
      secretInsult5: [
         '>{#p/papyrus}{#f/27}HUH? SHOOT FOR THE STARS INSTEAD OF SHOOTING MYSELF?',
         '>{#p/papyrus}{#f/17}BUT WHAT DOES IT MEAN...!'
      ],
      secretInsult5x: [
      ...
      secretInsult6: [
         '>{#p/papyrus}{#f/14}WAIT... I THINK I GET IT NOW!',
         '>{#p/papyrus}{#f/21}IDIOT...',
         '>{#p/papyrus}{#f/21}SHOOT FOR THE STARS...',
         '>{#p/papyrus}{#f/20}TWINKLY WAS A STAR, AND HE LOVED TO CALL PEOPLE IDIOTS!',
         '>{#p/papyrus}{#f/25}OBLIVIOUS...',
         ">{#p/papyrus}{#f/22}I'VE BEEN OBLIVIOUS THIS WHOLE TIME!",
         '>{#p/papyrus}{#f/20}THAT "ASRIEL" FELLOW SEEMS TO LOVE CALLING PEOPLE IDIOTS AS WELL!',
         '>{#p/papyrus}{#f/24}WHICH MEANS...',
         '>{#p/papyrus}{#f/22}THE "STAR" IN THIS SCENARIO MUST BE HIM!',
         '>{#p/papyrus}{#f/19}HE MUST HAVE DONE SOMETHING TO MAKE -ME- LOOK LIKE AN IDIOT!'
      ],
      secretInsult6x: [
      ...
      secretInsult7: [
         ...
         '>{#p/papyrus}{#f/20}I, PAPYRUS, WILL MAKE SURE HE NEVER FINDS ME AGAIN!',
         ">{#p/papyrus}{#f/15}DON'T WORRY, HUMAN!\nPAPYRUS HAS THIS UNDER CONTROL!"
      ],
      sparableFlirt1: [
         ">{#p/papyrus}{#f/27}YOU'RE SUPPOSED TO BE SPARING, NOT FLIRTING!",
         '>{#f/14}I MUST RESIST!'
      ],
      sparableFlirt1x: [
         '>{#p/papyrus}{#f/27}HUH?\nFLIRTING, AT A TIME LIKE THIS?',
         ">{#f/14}WELL, THAT'S ONE WAY TO REDEEM YOURSELF!"
      ],
      sparableFlirt2: ['>{#p/papyrus}{#f/14}N-NO...!'],
      sparableFlirt2x: ['>{#p/papyrus}{#f/14}A-AH...!'],
      sparableFlirt3: ['>{#p/papyrus}{#f/14}...'],
      sparableInsult1: [
         ">{#p/papyrus}{#f/20}HEY, THERE'S NO NEED TO INSULT YOURSELF!",
         '>{#f/21}I KNOW YOU DID YOUR BEST...'
      ],
      sparableInsult1x: [
         ">{#p/papyrus}{#f/20}HEY, THERE'S NO NEED TO INSULT YOURSELF!",
         ">{#f/15}YOU'RE HERE TO BETTER YOURSELF, REMEMBER?"
      ],
      sparableInsult2: ['>{#p/papyrus}{#f/21}HUMAN...'],
      sparableInsult2x: ['>{#p/papyrus}{#f/15}COME ON...!'],
   ...
   b_opponent_shockasgore: {
      ...
      foodText: ['>{#p/asgore}{#f/5}Is that...'],
      idleText1: ['>{#p/asgore}{#f/1}Really now...'],
      idleText2: ['>{#p/asgore}{#f/1}Must we resort to violence?'],
      idleText3: ['>{#p/asgore}{#f/1}Can we not settle this peacefully?'],
      idleText4: ['>{#p/asgore}{#f/1}Is this really necessary?'],
      stickText: [
      ...
      miss: [
         '>{#p/asgore}{#f/2}...',
         '>{#f/1}I am not really here, Asriel.',
         ">{#f/2}It's just a projection."
      ],
      name: '* Asgore',
   ...
   n_shop_blook: {
      ...
      itemPrompt: '>{#p/napstablook}{#k/3}see anything you like?',
      itemPurchase: [
         '>{#p/napstablook}{#k/3}heh... thank you...',
         ">{#p/napstablook}{#k/0}you don't have to buy it...",
         '>{#p/napstablook}{#k/0}sorry... not enough g...',
         ">{#p/human}(You're carrying too much.)"
      ],
      itemPurchasePrompt: () => (blookGone() ? 'Take it?' : 'Buy it for\n$(x)G?'),
      itemUnavailable: () =>
         blookGone() ? '>{#p/basic}Nothing left.' : ">{#p/napstablook}{#k/0}oh... i don't have any more...",
      menu: () =>
         blookGone() ? ['Take', 'Steal', 'Read', 'Exit'] : ['Buy', world.meanie ? 'Steal' : 'Sell', 'Talk', 'Exit'],
      menuPrompt1: () =>
         [
            '>{#p/napstablook}{#k/3}* have a look around...',
            ">{#p/napstablook}{#k/3}* i hope you find what you're looking for...",
            ">{#p/napstablook}{#k/3}* have a look around... or not... it's your choice...",
            '>{#p/napstablook}{#k/3}* have a look around, i guess...',
            ">{#p/napstablook}{#k/3}* have a look around... or not... it's your choice..."
         ][Math.min(SAVE.data.n.state_wastelands_napstablook, 4)],
      menuPrompt2: '>{#p/napstablook}{#k/0}* feel free to leave at any time...',
      menuPrompt3: () =>
         world.bulrun ? '>{#p/basic}* ... but everybody ran.' : '>{#p/basic}* ... but nobody came.',
      note: () =>
      ...
      sell1: () =>
         blookGone()
            ? ['>{#p/human}* (You took 42G from behind the counter.)']
            : world.meanie
               ? [
                  ">{#p/napstablook}{#k/2}* oh... you're trying to steal from me...",
                  '>{#p/napstablook}{#k/5}* you must really need it...',
                  SAVE.data.b.item_voidy
                     ? ">{#k/0}* i'm so sorry... the only money i have came from you..."
                     : ">{#k/0}* i'm so sorry... i don't have much to give..."
               ]
               : [
                  '>{#p/napstablook}{#k/2}* oh... you wanted to sell something',
                  ">{#k/0}* i don't know if i can afford to buy anything... sorry..."
               ],
      sell2: () =>
         blookGone()
            ...
            : world.meanie
               ? [
                  ">{#p/napstablook}{#k/5}* um...\n* i can't give you anything of real value...",
                  ">{#p/napstablook}{#k/0}* i know... it's pretty sad"
               ]
               : [
                  '>{#p/napstablook}{#k/5}* um... you could ask my cousin about selling...',
                  '>{#k/0}* they live with undyne, i think'
               ],
      talk: (name: string) =>
         SAVE.data.n.plot === 72
      ...
      talkPrompt: '>{#p/napstablook}{#k/1}oh, you wanna chat?',
      talkText: [
         () =>
            SAVE.data.n.plot === 72
               ? [
   ...
   n_shop_hare: {
      ...
      itemPrompt: '>{#p/basic}{#k/0}What would you like to buy?',
      itemPurchase: [
         '>{#p/basic}{#k/4}Thanks for your purchase.',
         '>{#p/basic}{#k/7}Just looking?',
         ">{#p/basic}{#k/5}That's not enough money.",
         ">{#p/human}(You're carrying too much.)"
      ],
      ...
      menuPrompt1: '>{#p/basic}{#k/0}* Hello, traveler.\n* How can I help you?',
      menuPrompt2: '>{#p/basic}{#k/0}* Take your time.',
      menuPrompt3: () =>
         world.bulrun ? '>{#p/basic}* ... but everybody ran.' : '>{#p/basic}* ... but nobody came.',
      note: () =>
         world.runaway
            ...
            : SAVE.data.n.plot === 72
               ? [">{#p/basic}* There's a note here.", '>{#p/basic}* "I\'m sorry I couldn\'t come back."']
               : [">{#p/basic}* There's a note here.", '>{#p/basic}* "Please don\'t hurt my family."'],
      sell1: () =>
         world.population === 0 || world.runaway
            ? ['>{#p/human}* (You took 758G from behind the counter.)']
            : world.meanie
               ? [
               ...
               : [
                  ...
                  ">{#k/3}* I don't know how it works where you come from... but...",
                  ">* If I started spending money on old wrenches and used spacesuits, I'd be out of business in a jiffy!"
               ],
      sell2: () =>
         world.population === 0 || world.runaway
            ? ['>{#p/basic}* Nothing left.']
      ...
      talkPrompt: '>{#p/basic}{#k/0}Care to chat?',
      talkText: [
         () =>
            SAVE.data.n.plot === 72
               ? [
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      s_start: pager.create(
         0,
         () => [
            '>{#p/papyrus}AH, THAT LONELY ROAD AT THE EDGE OF STARTON.',
            '>{#f/5}IT MIGHT SEEM A LITTLE LARGE AND EMPTY, BUT...',
            '>{#f/0}I HAVE MANY FOND MEMORIES OF IT!',
            ...(solo()
               ? [
                  '>{#f/0}FOR EXAMPLE, BACK WHEN WE WERE BABY BONES...',
                  '>{#f/0}SANS AND I WOULD RACE OUR HOVERCARS SIDE BY SIDE.'
               ]
               : [
                  '>{#p/undyne}{#f/1}* Like what?',
                  '>{#p/papyrus}{#f/0}LIKE THE WAY SANS AND I USED TO RACE OUR HOVERCARS!',
                  ">{#p/papyrus}{#f/5}WE'D FLY DOWN THE ROAD, RACING SIDE BY SIDE..."
               ]),
            '>{#f/4}UNFORTUNATELY, NO MATTER HOW HARD I TRIED...',
            ...(solo()
               ? [
                  '>{#f/7}HE WOULD ALWAYS BE WAITING AT THE FINISH LINE!',
                  '>{#f/5}YOU CAN IMAGINE MY FRUSTRATION.'
               ]
               : [
                  ...
                  '>{#p/papyrus}{#f/4}OH, TRUST ME.\nI KNOW IT ALL TOO WELL.',
                  ">{#f/7}I REALLY WISH HE WOULDN'T CHEAT ON THINGS LIKE THAT!",
                  '>{#f/7}IT RUINS THE GAME FOR EVERYONE ELSE.',
         ...
         () => [
            '>{#p/papyrus}{#f/5}SANS HAS... ALWAYS BEEN ONE TO TAKE SHORTCUTS.',
            ...(solo()
               ? ['>{#f/4}I SUSPECT THAT PLAYED A PART IN HIS VICTORIES.']
               : [">{#f/4}IT'S PRACTICALLY A LAW OF NATURE AT THIS POINT."])
         ]
      ),
      s_sans: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}AND THIS HERE IS SANS'S SENTRY STATION.",
            '>{#p/papyrus}{#f/5}...',
            ...(solo()
               ? [
                  '>{#f/5}I HEARD HIM TALKING THE OTHER DAY...',
                  '>{#f/6}... ABOUT HELPING SOMEONE AVOID THE OTHER GUARDS.',
                  ">{#f/5}I CAN'T BE SURE, BUT FROM HOW IT SOUNDS...",
                  ">{#f/5}THERE'S... A CHANCE MY BROTHER MIGHT BE A MOLE.",
                  '>{#f/4}...',
                  '>{#f/4}... OR WOULD THAT BE CALLED A RAT?'
               ]
               : [
                  '>{#p/papyrus}{#f/5}... WHAT MORE CAN I SAY?',
                  ">{#p/undyne}{#f/17}* Papyrus, don't you ever look... well, up?",
                  '>{#p/papyrus}{#f/6}WHAT!?',
                  ">{#p/papyrus}{#f/7}YOU KNOW I DON'T HAVE TIME FOR THAT!",
                  ">{#p/undyne}{#f/1}* But you're not even trying to capture anybody.",
                  '>{#p/papyrus}{#f/6}S-SURE I AM!\nJUST... NOT WHO YOU THINK!!'
               ])
         ],
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/4}WAIT...',
                  '>{#p/papyrus}{#f/1}... HAS MY BROTHER BEEN A MOLE-RAT THIS WHOLE TIME!?'
               ]
               : [">{#p/papyrus}{#f/4}IT'S SOMEONE... RECTANGULAR."]
      ),
      s_crossroads: pager.create(
         0,
         () => [
            '>{#p/papyrus}RECENTLY, PEOPLE HAVE BEEN LEAVING NOTES OUTSIDE.',
            '>DREAMS, WISHES, OFFERS OF ROMANCE...',
            ...(solo()
               ? [
                  ">{#f/9}PERSONALLY, I THINK IT'S EXCELLENT!",
                  ">{#f/0}IT'S GREAT TO SEE PEOPLE MAKING AN EFFORT.",
                  '>{#f/4}AS FOR MY BROTHER, WELL...',
                  ">{#f/4}HE THINKS THEY'RE ALL JUST BEING LUNAR-TICKS."
               ]
               : [
                  '>...',
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}I WONDER WHAT LIFE WOULD BE LIKE WITH A MOON IN ORBIT.']
               : [">{#p/papyrus}DON'T YOU HAVE ANY HOPES AND DREAMS TO SHARE?"]
      ),
      s_human: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}ABOUT THAT GRAND SPEECH OF MINE...',
            '>{#f/0}COINCIDENTALLY, I FIRST PRACTICED IT IN THIS VERY ROOM.',
            '>{#f/9}AND WITH SANS, NO LESS!',
            ...(solo()
               ? ['>{#f/5}BUT WE ARGUED ABOUT WHICH WAY WE SHOULD STAND.']
               : [
                  ">{#p/undyne}{#f/14}* I'm sure you had no arguments whatsoever.",
                  '>{#p/papyrus}{#f/0}OH, ON THE CONTRARY.',
                  '>{#f/0}WE ARGUED CONSTANTLY WITH EACH OTHER!'
               ]),
            ">{#f/4}I'D ROTATE ONE WAY, AND SAY THAT WAS BETTER...",
            ">{#f/4}THEN HE'D TURN, AND SAY HIS WAY WAS BEST.",
            '>{#f/6}AS WE ARGUED, WE EACH ROTATED FASTER AND FASTER.',
            ...(solo()
               ? [">{#f/0}IT'S SINCE BECOME A RITUAL FOR US."]
               : [
                  '>{#p/undyne}{#f/1}* ... that explains what I saw outside my house earlier.',
                  '>{#p/papyrus}{#f/1}YOU SAW THAT!?',
                  '>{#f/6}UH, WAIT, I CAN EXPLAIN...',
                  '>{#f/5}I MEAN, SANS WAS JUST WORRIED ABOUT... UH...',
                  ">{#f/6}... WORRIED THAT I'M SPENDING TOO MUCH TIME THERE!",
                  '>{#f/6}YEAH!!',
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/0}FUN FACT.',
                  '>{#f/0}IF YOU TOTAL UP OUR ROTATION SPEED...',
                  ">{#f/0}IT'D ACTUALLY COME OUT TO ZERO.",
                  '>{#f/4}... WE ALWAYS SPIN IN THE OPPOSITE DIRECTION.'
               ]
               : [
                  '>{#p/papyrus}{#f/0}FAMILY TIME IS IMPORTANT, AFTER ALL.',
                  '>{#f/9}SOMETIMES, IT EVEN NECESSITATES USING FLIGHT MAGIC!'
               ]
      ),
      s_papyrus: pager.create(
         0,
         () => [
            ...
            '>{#f/0}NOT ONLY AM I GREAT AT PUZZLES...',
            ">{#f/9}I'M ALSO AN ESTEEMED ARCHITECT!!!",
            ...(solo()
               ? ['>{#f/0}I PLAN TO BUILD MORE WHEN I JOIN THE ROYAL GUARD.']
               : [
                  '>{#p/undyne}{#f/1}* Y\'know, I WAS thinking of renovating your "sentry station..."',
                  '>{#f/14}* Like... a surprise gift!',
                  '>{#p/papyrus}{#f/4}YOU WHAT?',
                  ">{#p/undyne}{#f/12}* But, uh, that'd be messing with perfection.",
                  '>{#p/papyrus}{#f/5}PERFECTION, YOU SAY?',
                  '>{#p/papyrus}{#f/6}BUT YOU ONCE SAID THINGS CAN ALWAYS BE IMPROVED!',
                  '>{|}{#p/undyne}{#f/17}* Well... yes!\n* I just meant that- {%}',
                  '>{#p/papyrus}ALMOST-PERFECTION.\nHOW ABOUT WE JUST CALL IT THAT.',
         ...
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/4}I'M HOPING SANS CAN HELP ME FIND BETTER MATERIALS.",
                  '>{#f/6}BOXES CAN ONLY TAKE YOU SO FAR!!'
               ]
               : ['>{#p/papyrus}THANK YOU, HUMAN...', '>FOR BEING MY ALMOST-PERFECT FRIEND.']
      ),
      s_doggo: pager.create(
         0,
         () => [
            '>{#p/papyrus}THE SENTRY STATION OF DOGGO...',
            '>{#f/5}ONE DAY, AFTER AN INCIDENT WITH THE OTHER DOGS...',
            ">{#f/5}HE TOLD ME HE DIDN'T FEEL AT HOME ANYMORE.",
            '>{#f/0}SO I GAVE HIM A HUG, AND TOLD HIM TO TALK IT OUT.',
            '>{#f/4}OF COURSE, THE CANINE UNIT ARE A REASONABLE BUNCH.',
            ">{#f/0}IT'S NO SURPRISE THINGS TURNED OUT JUST FINE!",
            ...(solo()
               ? []
               : [
                  '>{#p/undyne}{#f/16}* Oh yeah, I remember that incident...',
                  '>{#f/22}* He, uh...\n* He was thinking of...',
                  '>{#p/papyrus}{#f/5}THINKING OF...?',
                  ...
                  '>{#p/papyrus}{#f/0}OH, OKAY.',
                  '>{#f/5}I GUESS THAT WOULD BE PRETTY BAD...'
               ])
         ],
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/0}KINDNESS REALLY -IS- A VIRTUE!']
               : ['>{#p/papyrus}{#f/9}NO DOG LEAVES THE ROYAL GUARD UNDER MY WATCH!']
      ),
      s_robot: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}LIFE AS A BUILDER BOT MUST BE TOUGH.',
            '>{#f/5}BE NICE TO THOSE WHOSE INTELLIGENCE IS ARTIFICIAL.',
            ...(solo()
               ? []
               : [
                  '>{#p/undyne}{#f/16}* Yeah... especially as a robot living on the outpost these days.',
                  '>{#p/undyne}{#f/9}* I think we both know why that is.',
                  '>{#p/papyrus}{#f/5}UNFORTUNATELY.',
                  ">{#p/undyne}{#f/17}* But hey!\n* It's not all bad!!",
                  '>{#p/undyne}{#f/14}* After all, their chip could just be moved to a new computer.',
                  '>{#p/papyrus}{#f/0}OH! OH!\nI THINK I GET IT!',
                  ">{#f/0}THEN THEY'D BE ABLE TO ACCESS THE OUTERNET!",
                  '>{#f/0}AND THE TELESCOPE NETWORK!',
                  '>{#f/0}AND SO MUCH MORE!'
               ])
         ],
         () =>
            solo()
               ? [">{#p/papyrus}{#f/5}YOU NEVER KNOW HOW LONG THEY'VE BEEN ALONE!!"]
               : [
                  ">{#p/papyrus}{#f/0}I WONDER IF THEY'D BE ABLE TO SEE MY BROWSER HISTORY.",
                  '>{#f/4}ALL THOSE RAW PASTA PHOTOS...'
               ]
      ),
      s_maze: () => [
         '>{#p/papyrus}{#f/5}YES, YES, I KNOW MY PUZZLES CAN BE DIFFICULT...',
         ...(SAVE.data.b.papyrus_fire
            ? [
               '>{#f/9}BUT JUST THINK OF IT LIKE A LEARNING EXPERIENCE!',
               '>{#f/0}A TEST OF CHARACTER RATHER THAN SKILL.',
               ...(solo()
                  ? []
                  : [
                     '>{#p/undyne}{#f/1}* Huh?\n* What happened?',
      ...
      s_dogs: pager.create(
         0,
         () => [
            '>{#p/papyrus}THE SENTRY STATION OF DOGAMY AND DOGARESSA...',
            '>{#f/0}SOMETIMES I WONDER WHAT MARRYING DOGS MUST FEEL LIKE.',
            ">{#f/4}THOUGH, I'LL NEVER HAVE TO KNOW, BECAUSE...",
            ">{#f/9}THE ONLY THING I'D MARRY IS A VERY HANDSOME SKELETON!",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/6}WHAT!?!?\nWE CAN'T MARRY!!",
                  ...(SAVE.data.b.flirt_papyrus
                     ? [">{#f/0}WE AGREED THAT IT WOULDN'T WORK OUT, REMEMBER?"]
                     : [
      ...
      s_lesser: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}THIS ROOM USED TO BE CONNECTED WITH A BRIDGE.',
            '>{#f/4}TWO HALVES, JOINED AT THE CENTERPOINT...',
            '>{#f/9}LIKE THE SOULS OF TWO VERY INTREPID SKELETONS!',
            ...(solo()
               ? [
                  '>{#f/5}...',
                  ">{#f/5}I DON'T KNOW EXACTLY WHAT SANS IS THINKING NOW...",
                  ">{#f/4}BUT I'D IMAGINE IT HAS A LOT TO DO WITH CONDIMENTS.",
                  ">{#f/5}IF ONLY HE'D STOP OBSESSING OVER THEM...",
                  '>{#f/7}THEN, I WOULDN\'T HAVE TO "YAMOK" HIM FOR IT!!'
               ]
               : [
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/5}I WISH I HAD MORE TO SAY...',
                  ">{#f/4}BUT I CAN'T STOP THINKING ABOUT CONDIMENTS."
               ]
               : [
      ...
      s_bros: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/4}THOSE SPOT-THE- DIFFERENCE PUZZLES SANS LIKES...',
            '>{#f/5}WELL, THE ONES I USED TO SOLVE WERE STRAIGHTFORWARD.',
            ">{#f/7}BUT LATELY, THEY'VE BECOME NIGH IMPOSSIBLE!",
            '>{#f/4}SHORT OF SCANNING THE IMAGE PIXEL FOR PIXEL...',
            ">{#f/7}THERE'S NO WAY ANYONE COULD SOLVE THEM!",
            ...(solo()
               ? [">{#f/7}IT'S RIDICULOUS!"]
               : [
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/4}ARE YOU ASKING FOR MY HELP?',
                  '>{#f/7}WELL, FORGET IT!',
                  ">{#f/0}UNFAIR PUZZLES AREN'T WORTH SOLVING, ANYWAY."
               ]
               : [
      ...
      s_spaghetti: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}SOME SAY THE MICROWAVE IN THAT ROOM...',
            '>{#f/0}HAS A SO-CALLED "HIDDEN FUNCTION."',
            '>{#f/5}THAT, UNBEKNOWNST TO MOST...',
            '>{#f/4}ITS "MICRO" WAVES ARE IN FACT... GRAVITATIONAL.',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/0}IF ONLY THERE WAS A WAY TO TURN IT OFF.']
               : [
      ...
      s_puzzle1: pager.create(
         0,
         () => [
            '>{#p/papyrus}HMMM... THE SOLUTION TO THIS ONE...?',
            '>{#f/5}WELL, SOMETIMES I JUST STEP OVER THE LASERS.',
            '>{#f/0}SO, ONE SOLUTION IS TO BE TALL AND HANDSOME!',
            ...(solo()
               ? [">{#f/4}... DEFINITELY DON'T DO THIS IF YOU'RE TOO SMALL."]
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/4}I'M SOLVING IT AS WE SPEAK..."]
               : [
                  '>{#p/papyrus}{#f/5}HMM...',
      ...
      s_puzzle2: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/4}I'VE BEEN TOLD THERE'S A TRICK TO THESE PUZZLES...",
            ">{#f/5}INVOLVING WHAT'S DISPLAYED ON THE TILES.",
            '>{#f/6}... AND HERE I THOUGHT IT WAS A GUESSING GAME!',
            '>{#f/0}I GUESS YOU LEARN SOMETHING NEW EVERY DAY.',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/4}WAIT, THAT'S MY BROTHER'S LINE..."]
               : [
      ...
      s_jenga: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/5}AT FIRST, THIS PUZZLE'S OUTCOME DISAPPOINTED ME...",
            '>{#f/4}BUT THEN, I REALIZED...',
            '>{#f/0}THE CHANCES OF WHAT HAPPENED WERE SO LOW...',
            '>{#f/9}... THAT WE MAY BE THE ONLY ONES TO EVER SEE IT!!',
            '>{#f/0}HOW LUCKY YOU MUST FEEL RIGHT NOW.',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}LUCK IS ON OUR SIDE TODAY, HUMAN!']
               : ['>{#p/papyrus}JOKE OR NOT, IT WAS STILL PRETTY LUCKY, HUH?']
      ),
      s_pacing: pager.create(
         0,
         () => [
            '>{#p/papyrus}THE SENTRY STATION OF CANIS MINOR.',
            '>{#f/4}ALSO THE FAVORED SPOT OF THOSE MOON ROCK SALESFOLK.',
            '>{#f/5}HMM... I WONDER WHAT THESE ROCKS ARE MADE OF.',
            ">{#f/4}THEY CAN'T BE MADE OF MOONS, BECAUSE...",
            '>{#f/7}MOONS ARE JUST BIG ROCKS ANYWAY!',
            '>{#f/5}DOES THAT MEAN MOONS ARE MOON ROCKS THEMSELVES?',
            '>{#f/5}WHERE DOES "MOON" END AND "MOON ROCK" BEGIN?',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}PERHAPS US MORTALS ARE NOT WORTHY OF SUCH KNOWLEDGE.']
      ...
      s_puzzle3: pager.create(
         ...
         [
            ...
            '>{#f/5}...',
            ">{#f/4}LET'S NOT TALK ABOUT THIS PUZZLE."
         ],
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}...']
      ...
      s_greater: pager.create(
         0,
         () => [
            '>{#p/papyrus}THE SENTRY STATION OF CANIS MAJOR...',
            '>{#f/5}THAT DOG HAS A HEART OF GOLD- PRESSED LATINUM.',
            '>{#f/4}IF ONLY -I- WAS IN THE ROYAL GUARD...',
            ">{#f/0}THEN, I'D BE ABLE TO REPAY IT FOR ITS KINDNESS!",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/5}IT'S TOO BAD I MIGHT NEVER BE A ROYAL GUARD."]
               : ['>{#p/papyrus}{#f/7}NOTHING WILL EVER REPLACE FACE-TO- FACE CONVERSATION!']
      ),
      s_math: pager.create(
         0,
         () => [
            '>{#p/papyrus}MATH -HAS- ALWAYS BEEN A PET PEEVE OF MINE.',
            '>{#f/5}CALCULUS THIS, GEOMETRY THAT...',
            '>{#f/4}WHATEVER HAPPENED TO COUNTING ON YOUR FINGERBONES?',
            '>{#f/7}ALL THE "ADVANCED" MATH IS TOTALLY UNNECESSARY!',
            ...(solo()
               ? []
               : [
         ...
         () => [
            '>{#p/papyrus}{#f/0}IF YOU REALLY WANT HELP WITH ADVANCED MATH...',
            ...(solo()
               ? [
                  ">{#f/0}THERE'S NOBODY BETTER THAN DR. ALPHYS!!",
                  ">{#f/4}THEY SAY SHE'S LIKE A LIVING CALCULATOR...",
                  '>{#f/0}AND A VERY SCIENTIFIC ONE AT THAT!'
               ]
               : [
      ...
      s_bridge: pager.create(
         0,
         () => [
            '>{#p/papyrus}REMEMBER THE "GAUNTLET OF DEADLY TERROR?"',
            '>{#f/4}BELIEVE IT OR NOT, IT HAS A SECRET SEVENTH WEAPON...',
            ">{#f/6}WHICH WOULD'VE TRULY TAKEN YOUR BREATH AWAY!",
            ...(solo()
               ? ['>{#f/5}...']
               : [
      ...
      s_town1: pager.create(
         0,
         () => [
            '>{#p/papyrus}STARTON TOWN: THE NORTH SIDE!',
            ">{#f/5}A SIDE I DON'T SPEND MUCH TIME ON.",
            '>{#f/4}SANS, ON THE OTHER HAND...',
            ...(solo()
               ? ['>{#f/4}... WELL, YOU CAN PROBABLY GUESS WHY HE DOES.']
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/0}IT HAS SOMETHING TO DO WITH GRILLBY'S."]
               : [
      ...
      s_taxi: pager.create(
         ...
         () => [
            ...(SAVE.data.n.plot < 65
               ? [
                  '>{#p/papyrus}{#f/0}IS THE TAXI OUT YET TODAY?',
                  '>{#f/5}HMM... IT TENDS TO COME OUT IN THE LATER HOURS.'
               ]
               : [
                  '>{#f/0}I HEARD THE TAXI IS FINALLY OUT!',
                  ">{#f/5}HMM... THAT MUST MEAN WE'RE IN THE LATER HOURS."
               ]),
            '>{#f/6}AS FOR HOW TO TELL THE LATER HOURS FROM EARLIER ONES?',
            ...(solo()
               ? [">{#f/4}... I'LL GET BACK TO YOU ON THAT."]
               : [
      ...
      s_town2: pager.create(
         0,
         () => [
            '>{#p/papyrus}STARTON TOWN: THE SOUTH SIDE!',
            '>{#f/4}OR AS I LIKE TO CALL IT...',
            '>{#f/9}THE BEST SIDE IN THE COSMOS!',
            ...(solo()
               ? []
               : [
         ...
         [
            ">{#p/papyrus}{#f/4}IT'S NO WONDER A FRIENDLY GHOST SET UP SHOP HERE...",
            ">{#f/9}WHO WOULDN'T WANT TO BE IN PROXIMITY OF SUCH GREATNESS?",
            ">{#f/0}I CERTAINLY COULDN'T RESIST."
         ]
      ),
      s_battle: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/9}STANDING AT THE SITE OF OUR LEGENDARY BATTLE?',
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/4}THEY'LL HAVE TO PUT IT IN A MUSEUM SOMEDAY..."]
               : [
      ...
      s_exit: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/4}CAREFUL NOW...',
            '>{#f/0}THAT DOOR THERE IS THE ENTRANCE TO THE FOUNDRY.',
            '>{#f/5}ONLY DARKNESS AWAITS YOU IN SUCH A PLACE.',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/6}DID I MENTION THE DARKNESS THAT AWAITS YOU?']
               : [
      ...
      s_grillbys: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/5}SO... GRILLBY'S.",
            '>{#f/5}IS IT TRUE THEY INSTALLED A YAMOK SAUCE MACHINE...',
            ">{#f/6}JUST TO SATISFY MY BROTHER'S OUTRAGEOUS WHIMS?",
            ...(solo()
               ? []
               : [
            ...
            '>{#f/4}...',
            '>{#f/4}I NORMALLY HAVE HOPE FOR OUR KIND, BUT...',
            '>{#f/4}NOT WHEN IT COMES TO THINGS LIKE THIS.',
            '>{#f/5}... STILL.',
            ">{#f/5}IT'S NICE THAT THEY FINALLY FIXED THE JUKEBOX.",
            ...(solo()
               ? []
               : [
         ...
         () => [
            '>{#p/papyrus}{#f/0}TRACK THREE IS MY PERSONAL FAVORITE.',
      ...
      s_backrooms: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/4}SINCE THEY STARTED USING REPLICATORS HERE...',
            ">{#f/5}I HAVEN'T BEEN SURE HOW TO FEEL ABOUT IT.",
            '>{#f/0}ON ONE HAND, THE NEW FOOD IS WAY MORE HEALTHY.',
            ">{#f/7}ON THE OTHER HAND, THEY'VE ABANDONED COOKING ENTIRELY!",
            ">{#f/4}SEE THIS ROOM YOU'RE STANDING IN RIGHT NOW?",
            '>{#f/7}GUESS WHAT THIS USED TO BE!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}SOME "KITCHEN..."', '>{#f/5}NOW THEY JUST USE IT FOR PRIVATE CARD GAMES.']
               : [
      ...
      s_bonehouse: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}WHAT BETTER PLACE TO BE THAN MY HOUSE!',
            ">{#p/papyrus}{#f/0}WE'VE GOT EXTRA- TALL SINKS...\nPET MOON ROCKS...",
            '>{#p/papyrus}{#f/9}AND EVEN A BALCONY, PRIME FOR OUTDOOR LIVING!',
            ">{#f/0}IT'S PRACTICALLY THE ONLY PLACE I FEEL AT HOME.",
            ...(solo()
               ? []
               : [
         ...
         () => [
            '>{#p/papyrus}{#f/0}I WONDER WHAT HUMANS CALL HOME THESE DAYS.',
            '>{#p/papyrus}{#f/4}LAST I HEARD, THEY WERE STILL LIVING ON EARTH...',
            ...(solo()
               ? []
               : [
      ...
      s_papyrusroom: pager.create(
         ...
         () =>
            SAVE.data.n.plot_date < 1.1
               ? [
                  '>{#p/papyrus}WOW, IT ONLY TOOK YOU FOUR SECONDS TO CALL ME!',
                  '>YOU MUST BE VERY DESPERATE FOR MY HELP!!!',
                  ">{#f/9}BUT DO NOT FEAR.\nTHIS IS PAPYRUS'S HOTFUL HELPLINE!",
                  '>{#f/9}JUST DESCRIBE YOUR LOCATION, AND...',
                  '>{#f/4}... WAIT.',
                  ">{#f/6}YOU'RE STILL IN MY ROOM??",
                  '>{#f/5}...',
                  '>{#f/5}HAVE YOU HEARD OF SOMETHING CALLED A... DOOR?',
                  ">{#f/6}DON'T WORRY!!\nI'LL DRAW A DIAGRAM FOR YOU!"
               ]
               : SAVE.data.n.plot_date < 1.2
                  ? [
                     ">{#p/papyrus}{#f/1}WHAT??\nI THOUGHT YOU'D LEFT MY ROOM!!",
                     ">{#f/4}WE'LL HAVE TO START OVER FROM SQUARE ONE...",
                     '>{#f/5}FIRST, DO YOU KNOW WHO PAPYRUS IS!?'
                  ]
                  : [
         ...
         () =>
            SAVE.data.n.plot_date < 1.1
               ? [">{#p/papyrus}{#f/6}HOLD UP!\nI'M STILL DRAWING!"]
               : SAVE.data.n.plot_date < 1.2
                  ? ['>{#p/papyrus}{#f/1}DO -I- KNOW WHO PAPYRUS IS!?!?']
                  : [
                     ...(solo()
                        ? [
      ...
      s_innterior: pager.create(
         0,
         () => [
            ">{#p/papyrus}THE INN'S A GREAT PLACE TO STAY.",
            '>{#p/papyrus}THE BEDS ARE NICE, AND THE INN KEEPER IS EVEN NICER.',
            '>{#f/5}BUT MOST OF ALL, I LIKE THE PHOTO ON THE WALL...',
            ">{#f/0}IT'S A REMINDER OF WHAT MONSTERS ARE TRULY CAPABLE OF.",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/5}IF ONLY WE COULD TRAVEL BACK IN TIME...']
               : [
      ...
      s_beddinng: pager.create(
         0,
         () => [
            '>{#p/papyrus}ONCE IN A WHILE, SANS WILL READ ME A BEDTIME STORY.',
            '>{#f/5}HAVE YOU EVER HEARD OF "GENEROUS MONSTER?"',
            '>{#f/6}SANS READ IT TO ME LAST NIGHT, AND...',
         ...
         [
            ">{#p/papyrus}{#f/4}NEXT TIME, I'M HAVING SANS READ A HAPPY STORY.",
            '>{#f/6}WITH AN -ACTUAL- HAPPY ENDING!',
            '>{#f/5}WHERE EVERYBODY COMES AWAY SATISFIED!!',
            '>{#f/7}AND WHERE NOBODY HAS TO DIE OR SAY GOODBYE!!!'
         ]
      ),
      s_librarby: pager.create(
         ...
         () => [
            ...
            ">{#p/papyrus}{#f/0}(YOU CAN CALL ME BACK WHEN YOU'RE OUT, THOUGH!)",
            ...(solo() ? [] : ['>{|}{#p/undyne}{#f/8}* YEAHHHH MAKE SOME NOI- {%}'])
         ],
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}(REALLY...)']
               : [
      ...
      f_start: pager.create(
         0,
         () => [
            '>{#p/papyrus}BEHOLD THE OMINOUS ATMOSPHERE OF THE FACTORY.',
            '>{#f/4}THEY SAY THERE ARE MONSTERS LIVING IN THE PIPES...',
            ">{#f/0}AND THEY'D BE ABSOLUTELY RIGHT!",
            '>{#f/5}SOME MONSTERS DO PREFER A DANK AND DIRTY ENVIRONMENT.',
            ...(solo()
               ? ['>{#f/6}UNLIKE ME!!']
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/0}I PREFER THE SANITARY SIDE OF LIVING.']
               : ['>{#p/papyrus}{#f/6}BE CAREFUL WHERE YOU JUNGLE GYM.']
      ),
      f_sans: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}MY BROTHER HAS A STATION HERE.',
            '>{#f/4}INDEED, HE MANS TWO STATIONS AT THE SAME TIME.',
            ">{#f/0}AMAZING, ISN'T HE?",
            '>{#f/0}HE SLACKS OFF TWICE AS MUCH AS NORMAL!!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/5}WE WAKEFUL FOLK COULD ONLY DREAM OF SUCH SLOTH...']
               : [
      ...
      f_corridor: pager.create(
         0,
         () => [
            ">{#p/papyrus}WHAT'S IN YOUR DIMENSIONAL BOX?",
            ">{#f/4}ACTUALLY, DON'T TELL ME.",
            ">{#f/7}THAT'D BE A BLATANT VIOLATION OF YOUR PRIVACY!",
            ...(solo()
               ? []
               : SAVE.data.b.undyne_respecc
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}... AT LEAST TELL ME IT\'S NOT "DOG RESIDUE."']
               : [
      ...
      f_doge: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/4}THEY SAY IT'S BEST TO LET SLEEPING DOGS LIE...",
            '>{#f/7}BUT, TRUTHFULLY, I DISAGREE!',
            '>{#f/5}AFTER ALL...',
            '>{#f/6}A GOOD DOG SHOULD VALUE HONESTY ABOVE ALL ELSE!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}IF ONLY THE DOG UNDER MY SINK HAD SUCH PRIORITIES...']
               : ['>{#p/papyrus}{#f/0}WHEN IN DOUBT, JUST TALK IT OUT.', '>{#p/papyrus}{#f/9}WORKS EVERY TIME!']
      ),
      f_puzzle1: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}WATCH OUT FOR THE ANCIENT HUMAN PYLON PUZZLES!',
            '>{#f/4}THOUGH RUDIMENTARY IN THEIR METHOD OF CONSTRUCTION...',
            '>{#f/6}THEIR DESIGN IS NOTHING SHORT OF PERPLEXING!',
            ...(solo()
               ? [">{#f/5}IT'S A WONDER WE MONSTERS CAN SOLVE THEM AT ALL."]
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/0}I WONDER IF HUMANS STRUGGLE WITH MONSTER PUZZLES.']
               : ['>{#p/papyrus}{#f/0}HEH! NOT ALL HUMANS ARE BAD!']
      ),
      f_quiche: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}MY BROTHER CAME BY HERE THE OTHER DAY...',
            '>{#f/5}SAYING HE HAD TO DROP SOMETHING OFF.',
            '>{#f/5}I ASKED HIM ABOUT IT, AND HE ISSUED ME A CHALLENGE...',
            '>{#f/4}A RIDDLE ABOUT A VERY "CHEESY" JOKE.',
            ...(solo()
               ? []
               : [
         ...
         [">{#p/papyrus}{#f/6}I'LL GET BACK TO YOU WITH THE ANSWER SOON!"]
      ),
      f_puzzle2: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}MORE OFTEN THAN NOT, A PUZZLE MAY BE UNSOLVABLE...',
            ">{#f/5}IF YOU DON'T TAKE THE TIME TO READ THE SIGNS.",
            ">{#f/6}YOU'D THINK INTUITION WOULD BE ENOUGH, BUT... NO!",
            ...(solo()
               ? [">{#f/5}... I'VE BEEN EMBARRASSED THIS WAY MANY TIMES..."]
               : [
         ...
         () =>
            solo()
               ? [
                  ">{#p/papyrus}{#f/0}I'VE SAID IT BEFORE, AND I'LL SAY IT AGAIN.",
                  '>{#p/papyrus}{#f/9}READ!\nTHOSE!!\nSIGNS!!!',
                  '>{#p/papyrus}{#f/4}AND DO NOTE THE RISING EXCLAMATION POINT COUNT.',
                  ">{#p/papyrus}{#f/7}IT MEANS IT'S VERY IMPORTANT!!!!"
               ]
               : [
      ...
      f_story1: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}SIGNAL STARS ARE PRETTY NEAT, HUH?',
            '>{#f/5}THOUGH, THEY ONLY RESET PERIODICALLY.',
            '>{#f/4}UNTIL THEN, ONLY A SINGLE MESSAGE IS SAVED...',
            ...(solo()
               ? []
               : [
         ...
         [">{#p/papyrus}{#f/4}THIS PHONE CALL -PROBABLY- WON'T BE RECORDED."]
      ),
      f_prechase: pager.create(
         ...
         () =>
            SAVE.data.n.plot < 37.11
               ...
               : SAVE.data.n.plot < 48
                  ? [
                     '>{#p/papyrus}THERE USED TO BE A BRIDGE HERE, BUT IT COLLAPSED.',
                     ">{#f/5}HOPEFULLY THEY'LL BUILD A NEW ONE SOON...",
                     '>{#f/6}RIDING ON A FLIMSY FLOATING PLATFORM IS FEAR-INDUCING!'
                  ]
                  : [
         ...
         [
            '>{#p/papyrus}{#f/0}NOTHING QUITE LIKE THE SAFETY AND SECURITY...',
            '>{#f/0}OF A SOLID, STABLE, SOUNDLY- DESIGNED BRIDGE.',
            '>{#f/9}A TRUE TESTAMENT TO SUPERB ENGINEERING!!'
         ]
      ),
      f_chase: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}THE FIRST TIME I SAW THIS ROOM, I WAS TRULY AMAZED.',
            ">{#f/4}SO MUCH SO, THAT I COULDN'T FIND MY WAY OUT.",
            '>{#f/6}... NOT TO MENTION THE TRAPS!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/5}I FIND IT BEST TO STEER CLEAR OF SCARY MAZE GAMES.']
               : [
      ...
      f_entrance: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}YOU'RE AT THE ENTRANCE TO WHAT'S KNOWN AS...",
            '>{#f/9}THE "DARK ZONE."',
            ">{#f/4}YOU WOULDN'T BELIEVE HOW IT GOT ITS NAME...",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}SPOILER ALERT...', ">{#p/papyrus}{#f/4}... IT'S VERY DARK INSIDE."]
               : [">{#p/papyrus}{#f/0}AREN'T THINGS BETTER WHEN YOU UNDERSTAND THEM?"]
      ),
      f_lobby: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/6}I TOTALLY... CAN'T REACH YOU... AT THE MOMENT!",
            ">{#f/6}THE CALL... IT'S DEFINITELY... GLITCHING OUT!",
            ...(solo()
               ? [
                  '>{#f/6}...',
                  ">{#f/4}OKAY, I ADMIT IT'S NOT REALLY DOING THAT.",
                  '>{#f/0}... BUT THAT TABLE CERTAINLY IS!'
               ]
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/5}REALLY, THOUGH.\nWHAT'S WITH THAT THING, ANYWAY?"]
               : [">{#p/papyrus}{#f/4}IT'S ENCOURAGING UNDYNE TO MAKE CHEESE PUNS."]
      ),
      f_error: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}ON A DIRECT ROUTE FROM THE BEGINNING OF STARTON...',
            '>{#f/0}TO THE END OF THE FIRST FLOOR IN AERIALIS...',
            '>{#f/0}THAT ROOM MARKS THE HALFWAY POINT OF YOUR JOURNEY.',
            '>{#f/5}... WHEREVER YOU INTEND GO NEXT...',
            '>{#f/6}YOUR JOURNEY IS AT -LEAST- HALFWAY OVER NOW!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/5}HALFWAY OVER...']
               : [">{#p/papyrus}{#f/9}HERE'S TO THE LONG JOURNEY AHEAD!"]
      ),
      f_telescope: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}MY BROTHER RUNS A TELESCOPE BUSINESS HERE.',
            '>{#p/papyrus}{#f/5}SUBSCRIPTIONS, MEMBERSHIPS, SIGN- UPS, VOUCHERS...',
            ">{#f/6}IT'S AN ENDLESS MAZE OF TERMS AND CONDITIONS!",
            ...(solo()
               ? [
                  '>{#f/5}I DID ONCE TRY TO ENROLL, BUT...',
                  ">{#f/4}EVEN I HAVE LIMITS TO WHAT I'M WILLING TO ENDURE."
               ]
               : [
         ...
         ['>{#p/papyrus}{#f/4}LEAVE IT TO A PRANKSTER TO MAKE THINGS TRICKY...']
      ),
      f_bird: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/9}THE MOST INFAMOUS.',
            '>{#f/9}THE MOST FEARLESS.',
            '>{#f/9}THE MOST BRAVESTEST.',
            '>{#f/9}THE MONSTER.\nTHE MYTH.\nTHE LEGEND...',
            '>{#f/9}THE YELLOW BIRD.',
            ...(SAVE.data.n.plot < 42
               ? [
               ...
               : solo()
                  ? ['>{#f/4}... NOT LIKE WE HAVE ANY OTHER WAY TO CROSS THE GAP.']
                  : [
         ...
         () =>
            SAVE.data.n.plot < 42
               ...
               : [
                  '>{#p/papyrus}{#f/0}TRUST ME, THE GAP IS EVEN LONGER THAN IT SEEMS.',
                  '>{#f/4}AND POSSIBLY NON- EUCLIDIAN.',
                  ...(solo()
                     ? []
                     : [
      ...
      f_stand: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}LEGEND HAS IT...',
            '>THE LOCAL ICE CREAM GUY HANDS OUT POSTCARDS.',
            '>{#f/4}SOURCES SAY THESE "POSTCARDS" HAVE UNSPOKEN POWER...',
            '>{#f/9}... TO UNLOCK MORE TASTY TREATS!',
            ...(solo()
               ? []
               : [
         ...
         [
            '>{#p/papyrus}{#f/0}I WONDER WHAT OTHER POWERS THESE POSTCARDS HAVE.',
            '>{#f/4}THEY DO TEND TO RUN OUT QUITE SPEEDILY...'
         ]
      ),
      f_abyss: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}WE LOOK UPON THIS WINDING PATH FULL OF SIGNAL STARS...',
            '>{#f/4}AND WE DEEM IT "NORMAL."',
            '>{#f/0}YOU KNOW WHAT ELSE IS "NORMAL?"',
            '>{#f/0}THE FACT THAT THIS PHONE CALL EVEN GETS DOWN THERE!',
            '>{#f/6}TOTALLY NORMAL!!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/6}I'M DEFINITELY NOT BEING SARCASTIC!!"]
               : [">{#p/papyrus}{#f/4}SARCASM TRAINING'S -TOTALLY- THE EASIEST THING EVER."]
      ),
      f_muffet: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}I WAS SURFING THE WEB THE OTHER DAY...',
            ">{#f/6}TURNS OUT SPIDER SILK IS STRONGER THAN YOU'D THINK!",
            '>{#f/4}WHICH WEB WAS I SURFING, YOU ASK?',
            ...(solo()
               ? [">{#f/4}... YOU PROBABLY DON'T WANT TO KNOW."]
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/4}IT WASN'T ON THE COMPUTER, THAT'S FOR SURE."]
      ...
      f_statue: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/4}A MYSTERIOUS STATUE...',
            '>{#p/papyrus}{#f/4}OUT IN THE MIDDLE OF THE FACTORY...',
            '>{#p/papyrus}{#f/6}... I WONDER WHAT THIS COULD MEAN!',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/4}BREAKING NEWS.',
                  '>{#f/4}MYSTERIOUS STATUE IS MYSTERIOUS.',
                  ">{#f/6}WHO WOULD'VE THOUGHT!!"
               ]
               : [
      ...
      f_piano: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}IF ONLY THERE EXISTED A ROOM...',
            '>WHERE I COULD EXPRESS MYSELF THROUGH MUSIC.',
            '>A LONELY ROOM, SEPARATED FROM CIVILIZATION...',
            '>WITH NAUGHT BUT A SINGLE PIANO AT ITS CENTER...',
            ...(solo()
               ? [">{#f/0}... OH WAIT!\nTHAT'S THIS ROOM!"]
               : [
         ...
         ['>{#p/papyrus}NEXT TIME I COME HERE, I SHOULD WRITE A MUSICAL.', '>IT\'D BE CALLED "STORY OF PAPYRUS."']
      ),
      f_artifact: pager.create(
         0,
         () => [
            ">{#p/papyrus}I DON'T THINK I'VE EVER BEEN IN THIS ROOM BEFORE.",
            ">{#f/6}WHAT'S IT LIKE?\nARE THERE UNTOLD TREASURES ABOUND?",
            '>{#f/4}FOR THE RECORD, THAT QUESTION WAS RHETORICAL.',
            ">{#f/7}I'D RATHER FIND OUT FOR MYSELF!",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/6}NO SPOILERS!!!']
               : [">{#p/papyrus}{#f/4}AND THAT'S NOT EVEN HIS MOST IMPRESSIVE FEAT."]
      ),
      f_path: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}KEEP GOING, AND YOU'LL WITNESS THE CITADEL.",
            ">{#f/4}YOU CAN'T NORMALLY SEE IT FROM SO FAR AWAY, BUT...",
            '>{#f/5}SOMETHING ABOUT THAT ONE ROOM...',
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/6}ENJOY THE VIEW WHILE YOU STILL CAN!']
               : ['>{#p/papyrus}{#f/6}JUST BE CAREFUL!']
      ),
      f_view: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}YOU MUST BE A VERY GREAT MULTITASKER!',
            ">{#f/4}IT'D TAKE ONE TO WANT TO CALL SOMEONE...",
            '>{#f/5}WITH A VIEW LIKE -THAT- NEARBY.',
            ...(solo()
               ? []
               : [
      ...
      f_plank: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/5}UNFORTUNATELY, THERE'S NOT A LOT TO SAY HERE.",
            '>{#f/4}APART FROM THE BRIDGE TO NOWHERE I HEARD ABOUT...',
            '>{#f/5}IT REALLY IS JUST A DEAD END.',
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/5}PERHAPS YOU COULD CALL BACK SOMEWHERE ELSE?']
               : ['>{#p/papyrus}{#f/4}SO THERE -WAS- SOMETHING TO SAY HERE...']
      ),
      f_tunnel: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}AH... THE TRASH DEPOSITORY.',
            '>{#f/0}A GREAT PLACE TO DISPOSE OF UNDESIRABLE ITEMS.',
            '>{#f/4}OR, ALTERNATIVELY...',
            '>{#f/9}A GREAT PLACE TO FIND TREASURE AT NO PERSONAL COST!',
            ...(solo()
               ? ['>{#f/0}I COME HERE WITH SANS SOMETIMES TO DO THAT.']
               : [
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/4}LAST TIME, WE EVEN MANAGED TO FIND A BONE PAINTING...',
                  '>{#p/papyrus}{#f/5}THAT WAS ONLY SLIGHTLY DIRTY!!'
               ]
      ...
      f_chute: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}ON THE FLOOR HERE LAY THREE TABLETS.',
            '>{#f/0}ONE ABOUT STARLINGS, ONE ABOUT WORMHOLES...',
            '>{#f/4}AND ONE CONTAINING SCI-FI ANIME.',
            ">{#f/0}PERSONALLY, -I- THINK THEY'RE ALL CONNECTED.",
            '>{#f/5}NO DOUBT STARLINGS GOT HERE VIA THE WORMHOLE...',
            '>{#f/5}AS FORETOLD BY THAT SCI-FI ANIME SERIES.',
            ">{#f/6}IT'S THE ONLY WAY TO EXPLAIN IT ALL AT ONCE!",
            ...(solo()
               ? []
               : [
      ...
      f_dummy: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}DON'T LOOK PAST THE HIDDEN PATH...",
            '>{#f/5}CLOSE YOUR EYES, WALK STRAIGHT...',
            ">{#f/5}AND FACE THE TEMMIES' WRATH.",
            ">{#f/4}... IT'S A RIDDLE I'VE HEARD ABOUT THIS PLACE.",
            ...(solo()
               ? []
               : [
      ...
      f_hub: pager.create(
         0,
         () => [
            '>{#p/papyrus}IF YOU SEE A SHOP, YOU SHOULD STOP...',
            '>{#f/4}DROP, AND ROLL...',
            '>{#f/0}INTO SOME GREAT DEALS!!',
            ...(solo()
               ? [
                  ">{#f/9}BECAUSE WE'RE HAVING A FIRE SALE!!",
                  '>{#f/5}AT MY IMAGINARY STORE, WHICH SELLS FLAMES.'
               ]
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/5}IT'S YET ANOTHER DREAM OF MINE..."]
               : [
      ...
      f_undyne: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}THAT'S UNDYNE'S HOUSE.",
            ...(SAVE.data.n.plot < 48 || world.trueKills > 0
               ? ['>{#f/9}THE IDEAL PLACE TO LEARN HOW TO COOK!']
               : SAVE.data.n.plot_date < 1.3
                  ...
                  : SAVE.data.n.plot_date < 2
                     ...
                     : SAVE.data.n.plot_date < 2.1
                        ? [
                           ">{#f/6}... YOU'RE STILL AT UNDYNE'S HOUSE??",
                           ">{#f/5}SHE, UH, HASN'T EVEN MET UP WITH ME YET.",
                           '>{#f/4}MAYBE LEAVE THE ROOM AND...',
                           '>{|}{#f/1}... {%}',
                           '>{#p/undyne}{#f/12}* Huff... puff...!',
                           ">{#f/8}* YEAH!!!\n* That's MY HOUSE!!!",
                           ">{#p/papyrus}{#f/6}UH, HI UNDYNE!\nHOW'D YOU GET HERE SO FAST?",
                           '>{#p/undyne}{#f/17}I RAN.',
                           '>{#p/papyrus}{#f/1}WHAT??\nTHEN YOU MUST HAVE SOMETHING...',
                           '>{#f/9}EXTREMELY COOL TO SAY ABOUT YOUR HOUSE!!!',
                           '>{#p/undyne}{#f/14}* Nope!!!'
                        ]
                        : [
                           '>{#f/4}AT LEAST IT WAS, UNTIL...',
         ...
         () =>
            SAVE.data.n.plot < 48 || world.trueKills > 0
               ? [
                  '>{#p/papyrus}{#f/0}PRO TIP: WHEN COOKING WITH UNDYNE...',
                  '>{#f/4}IF SHE STARTS ASSAULTING THE VEGGIES...',
                  ">{#f/5}... IT'S TIME TO BAIL."
               ]
               : SAVE.data.n.plot_date < 1.3
                  ...
                  : SAVE.data.n.plot_date < 2
                     ...
                     : SAVE.data.n.plot_date < 2.1
                        ? [
                           ">{#p/papyrus}{#f/0}I'M SURE SHE'LL COME UP WITH SOMETHING SOON.",
                           ">{#p/undyne}{#f/14}* Don't bet on it!"
                        ]
                        : [
                           '>{#p/papyrus}{#f/0}JUST CALL ME THE "HANGOUT HANDYMAN."',
                           '>{#f/4}I MAY NOT BE ABLE TO REPAIR YOUR HOUSE...',
                           '>{#f/9}BUT I CAN STILL "FIX YOU UP" A REALLY GREAT DAY!'
                        ]
      ),
      f_blooky: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}PERHAPS ONE DAY, I'LL LIVE THE QUIET LIFE.",
            '>{#f/5}RAISING SNAILS, PRODUCING MUSIC...',
            '>{#f/6}BEING SAD AND NOT LETTING ANYONE CHEER ME UP...',
            ">{#f/5}ON SECOND THOUGHT, MAYBE THAT ISN'T FOR ME.",
            ...(solo()
               ? []
               : [
         ...
         [
            ">{#p/papyrus}{#f/0}ALAS, I'M MUCH MORE SUITED AS A CHEERER-UPPER.",
            '>{#f/5}... RATHER THAN SOMEONE WHO NEEDS CHEERING UP.'
         ]
      ),
      f_snail: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/4}I'VE HEARD THERE'S A WAY TO BEAT THIS GAME...",
            '>{#f/0}SOMETHING ABOUT OFFERING "TIMELY ENCOURAGEMENT."',
            '>{#f/5}TIMELY ENCOURAGEMENT...',
            ">{#f/4}AS IF THERE'S ENCOURAGEMENT THAT -ISN'T- TIMELY.",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/5}I SUPPOSE TOO MUCH COULD BE OVERWHELMING...']
      ...
      f_prepuzzle: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/5}I OFTEN WONDER WHY THE HUMANS HAD TO TRAP US HERE.',
            '>{#f/5}I GET THAT THEY WERE AFRAID OF US, BUT...',
            ">{#f/6}COULDN'T THEY HAVE JUST RUN AWAY!?",
            '>{#f/6}OR, EVEN BETTER, TALK TO US ABOUT IT!!',
            ...(solo()
               ? [">{#f/5}IT'S UNFORTUNATE THEY NEVER THOUGHT OF THOSE THINGS."]
               : [
         ...
         ['>{#p/papyrus}{#f/0}AT LEAST -I- WAS ABLE TO THINK OF THOSE THINGS!!']
      ),
      f_puzzle3: pager.create(
         0,
         ...[
            () => [
               '>{#p/papyrus}{#f/6}I CALL MYSELF A MASTER OF PUZZLES GALORE, BUT...',
               '>{#f/5}I NEED TO COME CLEAN ABOUT THIS ONE.',
               ">{#f/4}... I'VE NEVER SOLVED THIS PUZZLE FOR REALSIES.",
               ">{#f/6}WAIT!!\nDON'T JUDGE ME TOO HARSHLY!!",
               '>{#f/4}... THEY SHUT IT OFF BEFORE I COULD EVEN TRY.',
               ...(solo()
                  ? []
                  : [
      ...
      f_prespear: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/4}IF I WERE YOU, I WOULD BE WARY OF THIS ROOM...',
            '>{#p/papyrus}{#f/5}UNDYNE OFTEN COMES HERE TO STAND MENACINGLY NEARBY.',
            ">{#p/papyrus}{#f/6}SHE'S STARTLED ME ON MORE THAN A FEW OCCASIONS!",
            ...(solo()
               ? ['>{#p/papyrus}{#f/5}EVEN IF I DID MAKE MYSELF AN EASY TARGET.']
               : [
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/4}OH, AND THE SPEAR TRAPS THAT COME OUT OF NOWHERE.',
                  '>{#p/papyrus}{#f/5}WATCH OUT FOR THOSE TOO.'
               ]
      ...
      f_spear: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}THE TIME IT TAKES TO TRAVEL ACROSS THIS ROOM...',
            '>{#p/papyrus}{#f/5}... NEVER SEEMS TO BE THE SAME.',
            ">{#p/papyrus}{#f/4}SOMETIMES IT'S LONG, SOMETIMES IT'S NOT...",
            '>{#p/papyrus}{#f/4}AND SOMETIMES I WEAR POLKA-DOTS.',
            ">{#p/papyrus}{#f/0}EITHER WAY, IT DOESN'T REALLY MAKE SENSE.",
            ...(solo()
               ? ['>{#p/papyrus}{#f/0}MUCH LIKE WHAT I JUST SAID.']
               : [
         ...
         () =>
            solo()
               ? ['>{#p/papyrus}{#f/4}DID I NOT MENTION THE POLKA-DOTS?']
               : [">{#p/papyrus}{#f/4}IT'S A CONSPIRACY SPANNING THE WHOLE OF THE COSMOS..."]
      ),
      f_corner: pager.create(
         0,
         () => [
            '>{#p/papyrus}{#f/0}THERE ARE PLENTY OF PLACES IN THE FACTORY...',
            '>{#f/0}... WHICH ARE ONLY ACCESSIBLE VIA JUMPING.',
            '>{#f/9}FOR EXAMPLE, THE TWO SIDE PATHS IN THIS VERY ROOM!',
            ...(solo()
               ? [
                  ">{#f/4}I'VE BEEN TOLD HUMANS CAN JUMP QUITE HIGH, SO...",
                  ">{#f/0}YOU SHOULDN'T HAVE ANY ISSUE REACHING THEM."
               ]
               : [
      ...
      f_story2: pager.create(
         ...
         () => [
            ...
            '>{#f/5}THOUGH, THEY ONLY RESET PERIODICALLY.',
            '>{#f/4}UNTIL THEN...',
            ">{#f/6}WAIT, ISN'T THERE A ROOM LIKE THIS SOMEWHERE ELSE!?",
            ...(solo()
               ? []
               : [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/5}I SWEAR I'M JUST REPEATING MYSELF SOMETIMES."]
               : [">{#p/papyrus}{#f/5}SOMETIMES I WONDER IF WE'RE ALL JUST GOING IN CIRCLES."]
      ),
      f_pacing: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}THERE'S GENUINELY NOTHING TO SAY ABOUT THIS ROOM.",
            '>{#f/4}ITS EXISTENCE ONLY SERVES TO MAKE YOU WALK FURTHER.',
            '>{#f/5}TO MAKE EVERY STEP TOWARDS THE EXIT...',
            '>{#f/4}FULL OF UTTER, UNENDING SUSPENSE.',
      ...
      f_battle: pager.create(
         0,
         () => [
            ">{#p/papyrus}{#f/0}IN THIS ROOM, YOU WILL FIND UNDYNE'S GIANT TOWER.",
            '>{#p/papyrus}{#f/9}MADE FROM THE REMNANTS OF AN OLD ASTEROID!',
            ">{#f/5}SHE'S ALWAYS POSING ATOP IT...",
            '>{#f/4}MUMBLING SOMETHING TO HERSELF...',
            ...(solo()
               ? []
               : SAVE.data.b.undyne_respecc
                  ? [
         ...
         () =>
            solo()
               ? [">{#p/papyrus}{#f/0}I THINK IT'S SOMETHING SHE HAS TO MEMORIZE."]
               : ['>{#p/papyrus}{#f/9}FOR THE RECORD, I LOVE A GOOD PRE- PLANNED SPEECH!!']
      ),
      f_exit: pager.create(
         0,
         () => [
            '>{#p/papyrus}THIS FLUID TANK WAS SPECIFICALLY PUT HERE...',
            '>{#f/0}BECAUSE A CERTAIN ROYAL GUARD CAPTAIN...',
            ">{#f/4}THINKS IT'S SAFE TO TAKE HER GIANT JETPACK...",
            '>{#f/5}INTO AN AREA RIFE WITH STATIC ELECTRICITY.',
            ...(solo()
               ? ['>{#f/6}... ABSORBING IT ALL WOULD BE VERY, VERY DANGEROUS!!']
               : [
         ...
         () =>
            solo()
               ? [
                  '>{#p/papyrus}{#f/0}I ONLY HAVE ONE WORD FOR THAT GUARD CAPTAIN.',
                  '>{#f/4}AND THAT WORD IS "WATCH WHERE YOU\'RE GOING."'
               ]
      ...
      f_napstablook: pager.create(
         ...
         () =>
            SAVE.data.n.plot <= 48.1 && SAVE.data.n.state_foundry_blookdate < 2
               ? [
                  ">{#p/papyrus}{#f/0}SO YOU'RE MAKING FRIENDS WITH A GHOST.",
                  '>{#p/papyrus}{#f/1}IS THERE NOTHING BEYOND YOUR GRASP OF FRIENDSHIP!?!?',
                  ...(solo()
                     ? ['>{#p/papyrus}{#f/6}YOUR POWER LEVEL IS ALMOST FRIGHTENING!!']
                     : [
         ...
         () =>
            SAVE.data.n.plot <= 48.1 && SAVE.data.n.state_foundry_blookdate < 2
               ? solo()
                  ? ['>{#p/papyrus}{#f/5}JUST WATCH OUT FOR THE ECTOPLASM.']
                  : [
