...
export default {
   a_foundry: {
      ...
      darktoriel1: [
         ">{#p/human}* （你抓住了Toriel的手。）",
         ">{#p/toriel}{#f/2}* 噢天哪...！\n* F-frisk，是你嗎？",
         ">{#f/1}* 在這裡見到你真不容易..."
      ],
      darktoriel2: [
         ">{#p/toriel}{#f/9}* 我向你道歉。你肯定在到處找我。",
      ...
      darktoriel5a: [
         ">{#p/toriel}{#f/5}* ...嗯？\n* 你還有話要跟我說？",
         ">{#p/human}* （你重複Toriel在Archive Six中\n  給你的建議。）",
         ">{#p/toriel}{#f/2}* ...",
         ">{#f/1}* 這些話...",
         ">{#f/1}* 你怎麼可能聽過...？",
         ">{#f/0}* 我上次那麼說已經是一個世紀前了。",
      ...
      darktoriel5b: [">{#p/toriel}{#f/1}* 嗯，現在該走了。"],
      darktoriel6: [
         ">{#f/5}* 運輸船快出發了，我不能錯過。",
         ">{#f/9}* 然而，現在，我必須收集我的想法。",
         ">{#f/1}* ...謝謝你的好意，Frisk。\n* 你是最棒的。"
      ...
      darktoriel7: () =>
         SAVE.data.b.c_state_secret1_used
            ? [
               ">{#p/toriel}{#f/10}* 別擔心，Frisk。\n* 我會沒事的。",
               ">{#f/1}* 運輸船上見。\n* 好嗎？"
            ]
            : [
               ">{#p/toriel}{#f/5}* Frisk，你得給我時間處理一下。",
               ">{#f/1}* 運輸船上見。\n* 好嗎？"
            ],
      ghostpartymusic1: [
      ...
      quicksolve4: [">{#p/human}* （你激活了終端。）", ">{#p/basic}* \"Enter override code!\""],
      quicksolve5: [
         ">{#p/basic}* ...",
      ...
      artifact1: [">{#p/human}* （你獲得了傳說中的神器。）"],
      artifact2: [">{#p/human}* （你帶的東西太多，裝不下它了。）"],
      artifact3: () =>
         SAVE.data.b.svr
      ...
      tome4: () => [
         choicer.create(
            ...
            "Spare",
            world.meanie ? "Bully" : world.flirt > 9 ? "調情" : SAVE.data.b.oops ? "Befriend" : "擁抱",
            "Kill",
            "Take Gold"
         )
      ],
      ...
      astrofood3: [">{#p/human}* （你帶的東西太多了。）"],
      astrofood4: () => [">{#p/human}* （你不打算這麼做。）"],
      astrofood5: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* (But you couldn't find anything inside.)"]
            : [">{#p/basic}* 箱子是空的。"],
      bird1: () => [
         ...(SAVE.data.b.svr ? [] : [">{#p/basic}* 這隻小鳥想帶你\n  穿過這道溝。"]),
      ...
      blookdate3: () => [
         ">{#p/napstablook}* 這是一份幽靈三明治...",
         ">* 你想嘗嘗嗎...",
         choicer.create("* （咬一口嗎？）", "是", "否")
      ],
      blookdate4a: [
         ">{#p/human}* （你試著咬了一口幽靈三明治。）",
         ">{#p/human}* （你的身體穿過了它。）",
         ">{#p/napstablook}* 喔...",
         ">* 當做什麼都沒發生吧..."
      ],
      blookdate4b: [">{#p/napstablook}* 喔..........."],
      blookdate5: () => [
         ">{#p/napstablook}* 美餐一頓後，\n  我喜歡躺在地上，\n  感覺自己像是垃圾一樣...",
         ">* 這是個家族傳統...",
         ">* 你想不想...\n* ...也來試試...？",
      ...
      blookdate6b: [">{#p/napstablook}* 喔......................", ">* i'll just be outside then"],
      blookdate7: [
         ">{#p/napstablook}* 我們開始吧...\n* 一直躺著不要動就好。",
         ">* 所以...\n* 你要想起來了的話，\n  動起來就好，大概。"
      ],
      blookdate8: [">{#p/napstablook}* 嗨，感覺不錯...", ">* 謝謝你..."],
      ...
      blookmusic3b: [">{#p/napstablook}* 天，這氛圍...", ">* 讓我全身都開始顫抖"],
      blookmusic3c: [
         ">{#p/napstablook}* 這首稍微有點慢...",
         ">* 但一旦你聽進狀態，\n  就會感覺很好聽"
      ],
      blookmusic3d: [
         ">{#p/napstablook}* 嘿...\n* 你真的很喜歡聽\n  那個舊歌單，嗯",
      ...
      blooksnail1: pager.create(
         0,
         () => [
            ">{#p/napstablook}* 你想玩個遊戲嗎？\n* 它叫做「雷霆蝸牛」。",
            ">* 幾隻蝸牛會賽跑，\n  然後如果黃色的蝸牛贏了，\n  你就贏了。",
            ">* 玩一次需要10G。",
            choicer.create("* （玩遊戲嗎？）", "是", "否")
         ],
         () => [">{#p/napstablook}* 你改變主意了嗎？", choicer.create("* （玩遊戲嗎？）", "是", "否")]
      ),
      blooksnail1i: () => [
         ">{#p/napstablook}* 你想再玩一次嗎？",
         choicer.create("* （玩遊戲嗎？）", "是", "否")
      ],
      blooksnail2a: [
      ...
      blooksorryX: [">{#p/napstablook}* 喔...........\n* ...........\n* ..........."],
      blooksorryY: [">{#p/napstablook}* ..."],
      blooktouch1: () =>
         world.sad_ghost
            ? [
               ">{#p/napstablook}* what do you want......",
               choicer.create("* （你要怎麼回答？）", "Sorry", "放棄")
            ]
            : [
               ">{#p/napstablook}* 喔，你需要什麼嗎？",
      ...
      blooktouch2c4: () => [
         ">{#p/napstablook}* 所以... 你感覺怎麼樣",
         choicer.create("* （你要怎麼回答？）", "好聽", "不好聽")
      ],
      blooktouch2c5a: [
         ">{#p/napstablook}* 聽起來... 還不錯？",
         ">* 喔-\n* 嗯... 謝謝你...",
         ">* 等...\n* 等我做完之後我會告訴你的！"
      ],
      blooktouch2c5b: [">{#p/napstablook}* 喔.........\n* 你應該是對的........."],
               ...
               : 65 <= SAVE.data.n.plot
                  ...
                  : 63 <= SAVE.data.n.plot && SAVE.data.b.a_state_hapstablook
                     ...
                     : 60 <= SAVE.data.n.plot
                        ...
                        : 49 <= SAVE.data.n.plot
                           ? [
                              ">{#p/napstablook}* 天，你真的跑來跑去的",
                              ">* 我是說...",
                              ">* 其實我也是...",
                              ">* 但是，我是沒有實體的，\n  所以對我來說不算\n  那麼令人印象深刻"
                           ]
                           : [
                              ">{#p/napstablook}* 歡迎來到幽靈家族的\n  蝸牛農場...",
                              ">* ...是的。\n* 我是這裡唯一的員工。",
                              ...(world.killed0
                                 ? [
                                    ">* hey, that's weird...",
                           ...
                           ? [
                              ...
                              ...(SAVE.data.n.state_aerialis_talentfails === 0
                                 ...
                                 : SAVE.data.n.state_aerialis_talentfails < 15
                                    ? [
                                       ">{#p/napstablook}* 即使你的表現不算完美，\n  你也做得很好",
                                       ">* mettaton的大多數參賽者\n  甚至都沒堅持到一半...",
                                       ">* 包括我......"
                                    ]
                                    : [
                                       ">{#p/napstablook}* 即使你的表現不是最好的，\n  我也能看出你已經盡力了",
                                       ">* 更何況，你堅持到了最後...",
                                       ">* 不像我......"
                                    ])
                           ]
      ...
      boots2: [">{#p/human}* （你帶的東西太多，裝不下它了。）"],
      bruh: [">{*}{#p/undyne}* 等會見。{^20}{%}"],
      candy1: () =>
         postSIGMA()
            ? [">{#p/basic}* It's out of service."]
            : SAVE.data.b.svr
               ? [
                  ...
                  choicer.create("* （你想合成什麼呢？）", "甘草糖", "Chisps", "口糧", "放棄")
               ]
               : [
                  ">{#p/basic}* 要用這臺機器合成什麼呢？",
                  choicer.create("* （你想合成什麼呢？）", "甘草糖", "Chisps", "口糧", "放棄")
               ],
      candy2: [">{#p/human}* （你買了$(x)。）"],
      candy3: () => [choicer.create(" * （花$(y)G來買$(x)嗎？）", "是", "否")],
      candy4: [">{#p/human}* （你的錢不夠。）"],
      candy5: [">{#p/human}* （你決定先不買。）"],
      candy6: [">{#p/human}* （你帶的東西太多了。）"],
      ...
      genotext: {
         asgoreFinal1: () =>
            SAVE.flag.n.genocide_milestone < 5
               ? SAVE.flag.n.ga_asrielStutter < 1
                  ? [
                     ">{#p/asgore}{#f/15}* 你到底還是選擇\n  與他為伍啊...",
                     ">{#p/asriel2}{#f/7}* Asgore，誰都不能分割\n  我和$(name)之間的紐帶。\n* 你不是不知道。",
                     ">{#p/asgore}{#f/15}* $(name)... 當-當然了。\n* 那... 你-你們帶著那個孩子\n  在幹什麼呢？",
                     ">{#p/asriel2}{#f/8}* 真是的，關你什麼事。",
                     ">{#p/asgore}{#f/15}* （呃... 我早該料到的...）",
                     ">{#p/asriel2}{#f/6}* 不過呢，總的來說...\n* 我們只是在這旅行。",
                     ">{#f/6}* 就我們三個。\n* 哎呀，我們沒邀請你呢，\n  意不意外。",
                     ">{#p/asgore}{#f/15}* 你看我-我像是\n  想受你邀請的樣子嗎？？",
                     ">{#p/asriel2}{#f/6}* 你說呢？",
                     ">{#p/asgore}{#f/15}* 呃，我只是想看看\n  你怎麼樣了。\n* 沒別的。",
                     ">{#p/asriel2}{#f/10}{#x1}* ...\n* 不對勁。",
                     ">{#p/asriel2}{#f/10}* Alphys博士？\n* ...是你吧？"
                  ]
                  : [
                     ">{#p/asgore}{#f/15}* 你到底還是選擇\n  與他為伍啊...",
                     ">{#p/asriel2}{#f/8}* ALPHYS，沒人能分割\n  我和$(name)間的紐帶。",
                     ">{#p/asriel2}{#f/7}* 不過你對這事完全沒數吧。"
                  ]
               : [
                  ">{#p/asgore}{#f/15}* 你到底還是選擇\n  與他為伍啊...",
                  ">{#p/asriel2}{#f/8}* ALPHYS，沒人能分割\n  我和$(name)間的紐帶。",
                  ...(SAVE.flag.n.ga_asrielQuestion < 1
                     ...
                     : [">{#p/asriel2}{#f/7}* 真以為你能阻止我們？"])
               ],
         asgoreFinal2: () =>
            SAVE.flag.n.genocide_milestone < 5
               ? [
                  ">{#p/alphys}{#g/alphysThatSucks}* ...騙不過你，嗯？",
                  ">{#p/asriel2}{#f/3}* 的確。",
                  ">{#p/alphys}{#g/alphysGarbo}* ...\n* 倒還算說了句實話。",
                  ">{#p/asriel2}{#f/13}* 看著好友死去，\n  你肯定急瘋了...",
                  ">{#p/asriel2}{#f/16}* 沒法和你感同身受呢。",
                  ">{#p/alphys}{#g/alphysIDK}* ...",
                  ">{#p/alphys}{#g/alphysNeutralSweat}* ...",
                  ">{#p/alphys}{#g/alphysNeutralSweat}* 這主意糟透了。",
                  ">{|}{#p/asriel2}{#f/8}* 你不會又想- {%}"
               ]
               : [
                  ">{#p/alphys}{#g/alphysOhGodNo}* 你說什麼？",
                  ">* 我...\n* 面對你，我-我哪來的勝算！",
                  ...(SAVE.flag.n.ga_asrielQuestion < 1
                     ? [">{#p/asriel2}{#f/10}* ...當真？", ">{#p/alphys}{#g/alphysIDK}* ..."]
                     : [">{#p/asriel2}{#f/7}* ..."]),
                  ">{#p/alphys}{#g/alphysNeutralSweat}* ...",
                  ">{#p/alphys}{#g/alphysNeutralSweat}* 這主意糟透了。"
               ],
         asgoreFinal3: () =>
            SAVE.flag.n.genocide_milestone < 5
               ? [">{#p/asriel2}{#f/7}* 真是個膽小鬼。"]
               : [
                  [">{#p/asriel2}{#f/15}* 呵... 看來我話說太早了。"],
                  [">{#p/asriel2}{#f/15}* 行吧。"]
         ...
         asgoreMK1: [
            ...
            ">{#f/2}* 真的不想承認，可...\n* 他實在陷得太深了。",
            ">{#f/2}* 我的兒子...\n  再也回不來了。",
            ">{#p/kidd}{#f/4}* 你們聊吧，我先不插嘴了...",
            ">{#p/asgore}{#f/1}* 沒關係，沒關係。\n  我快說完了。",
            ">{#f/1}* 人類，我剛說的話\n  往心裡去吧。",
            ">{#f/1}* 這我唯一的請求了。"
         ],
         asgoreMK2: [
         ...
         asriel32: [
            ...
            ">{#f/16}* 現在你不認我這個爹，\n  可你就是我的兒子啊...",
            ">{#f/15}* 儘管那是很久以前的事了。",
            ">{#p/asriel2}{#f/10}* 你到底想說啥？",
            ">{#p/asgore}{#f/12}* ...",
            ">{#p/asgore}{#f/12}* 唉... 究竟怎麼了？",
            ">{#f/12}* 為什麼... 我面前的這個你... \n  看著這麼陌生？",
            ">{#p/asriel2}{#f/6}* 你真想知道嗎？",
            ">{#p/asgore}{#f/7}* ...",
            ">{#p/asriel2}{#f/7}* 說實話。",
            ">{#p/asgore}{#f/1}* ...\n* 呃，不...\n* 我不太確定...",
            ">{#p/asriel2}{#f/8}* 切。\n* 這慫樣，才像我認識的\n  Asgore嘛。",
            ...
            ">{#p/asgore}{#f/12}* ...",
            ">{#p/asriel2}{#f/8}* ...",
            ">{#p/asgore}{#f/15}* 你知道嗎？我常常在想...\n  自己為何淪落到如此地步。",
            ">{#f/16}* 家園被毀，愛子離去，\n  只能被束縛在這片土地之上...",
            ">{#f/15}* 如今，前哨站危在旦夕，\n  我卻只能眼睜睜地看著。",
            ">{#p/asriel2}{#f/15}* 您老這是在向我尋求\n  獨到見解嗎？\n* 真是可悲...",
            ">{#f/16}* 就讓我給你個小小的忠告吧：\n* 下輩子，別再挑起戰爭了。",
            ">{#p/asgore}{#f/2}* ...",
            ">{#f/4}* 你...",
            ">{#f/2}* ...",
         ...
         asriel33: [">{#p/asriel2}{#f/10}* ...他這是要發火了？"],

         asriel34: [
            ">{#p/asriel2}{#f/3}* 我去處理點事，\n  你倆先作個伴。",
            ">{#p/kidd}{#f/3}* 你一會還回來嗎？\n* 還想聽你講更多\n  Undyne的軼事呢...",
            ">{#p/asriel2}{#f/4}* 說到做到。",
            ">{#f/1}* 別擔心，我去去就回。",
            ">{#p/kidd}{#f/4}* 好吧..."
         ...
         bombshell3: [
            ...
            ">{*}{@random=1.1/1.1}{#i/4}* 啊... 天-天吶..."
         ],
         bombshell4: [">{*}{@random=1.1/1.1}{#i/5}* 是我害死了你們..."],
         kidd1: [
            ">{#p/kidd}{#f/4}* 他叫你什麼來著？\n* $(name)... 是吧？",
            ">{#f/3}* 好，$(name)。\n  這話可別告訴他喔，\n  跟他在一塊...",
            ">{#f/4}* 我覺得很不自在。"
         ...
         kiddFinal3: () => [
            ...
            ...(SAVE.flag.n.ga_asrielKiddFinal3a < 1
               ...
               : []),
            ">{#p/kidd}{#f/9}* 因為...\n* 她... 比其他怪物都強...",
            ">{#f/12}* 她充滿了{@fill=#ff0}決心{@fill=#fff}...",
            ...(SAVE.flag.n.ga_asrielKiddFinal3a++ < 1
               ? [">{#p/asriel2}{#f/10}* 呃... 沒事吧？\n* （我的天，這小傢伙\n  說什麼胡話呢？）"]
               : SAVE.flag.n.undying > 0 && SAVE.flag.n.ga_asrielKiddFinal3b++ < 1
                  ? [">{#p/asriel2}{#f/8}* （他怎麼知道？）"]
                  : [">{#p/asriel2}{#f/10}* ..."])
         ],
         kiddFinal4: [">{#p/asriel2}{#f/6}* 她在那。"],
         kiddFinal5: [">{#f/6}* 給我上。", ">{#f/7}* ..."],
         kiddFinal6: [">{*}{#p/asriel2}{#f/14}{@random=1.1/1.1}{@fill=#f00}* 還不快去。{%100}"],
         kiddFinal7: [
            ">{#p/kidd}{#f/12}* ...",
            ">{#p/undyne}{#f/13}* 搞什麼？\n* 你來這幹嘛！？",
            ">{|}{#f/13}* 還有，你眼睛怎麼- {%}"
      ...
      goatreaction: () =>
         [
            [">{#p/asriel2}{#f/15}* 小心點，$(name)。"],
            [">{#p/asriel2}{#f/15}* $(name)..."],
            [">{#p/asriel2}{#f/15}* 開玩笑嗎？"],
            [">{#p/asriel2}{#f/15}* 我們可不想死在這，\n  $(name)..."],
            [">{#p/asriel2}{#f/16}* 我有點擔心了。"],
            [">{#p/asriel2}{#f/8}* 你是眼瞎還是有什麼毛病？"],
            [">{#p/asriel2}{#f/7}* 別鬧了！"],
            [">{#p/asriel2}{#f/7}* ..."]
      ...
      jumpsuit2: [">{#p/human}* （你帶的東西太多，裝不下它了。）"],
      kiddStatue: [
         ">{#p/kidd}{#f/1}* 喲，我記得這個地方！",
         ">{#f/3}* 我，呃，我媽媽帶我\n  來過一次，哈哈。",
         ">{#f/1}* 如果我們一人站在一邊的\n  開關上，燈就會亮起來。\n* 很厲害吧！？"
      ],
      kitchencall: () => [
         ...
         SAVE.data.n.plot === 72
            ...
            : world.meanie || SAVE.data.s.state_foundry_deathroom === 'f_village' // NO-TRANSLATE
               ...
               : SAVE.data.b.f_state_mushroomdance
                  ...
                  : [
                     ">{#p/basic}* 它代表了我被菌絲困在這裡，\n  所產生的內心的痛楚。",
                     ">* 我奮力地掙扎著。\n* 我竭力地想掙脫。\n* 可惜啊，無濟於事。"
                  ],
      musicbox: [
         ">{#p/asriel1}{#i/4}聽上去像是從這附近\n傳來的聲音...",
         ">啊！你的飛船墜毀了，\n是嗎...",
         ">你還好嗎？",
         ">來，我扶你起來...",
         ">...",
      ...
      npc86a: () => [
         ">{#p/basic}{#npc/a}* 檢測到陌生的能量訊號。",
         ">* 姓名... 未知。",
         ">* 關係狀態... 陌生人。",
         SAVE.data.n.plot < 42.1 ? ">* 上次互動... 暫無。" : ">* Last interaction... observed in battle.",
         ">* 處理中...\n* 處理中...\n* 處理中...",
         ">* 您好，陌生人。\n* 我叫8-6，是個\n  萬能送貨機器人。",
         ">* 這與我的預期功能相去甚遠，\n  但您現在願意完成\n  一份調查嗎？",
         choicer.create("* （你要怎麼回答？）", "是", "否")
      ...
      npc86c: [
         ">{#p/basic}* 謝謝您。\n* 您的選擇將深深地\n  銘刻在我的記憶體中。",
         ">{#p/basic}{#npc/a}* 您的關係狀態現已被\n  設定為「熟人」。"
      ],
      npc86d: () => [
         ">{#p/basic}{#npc/a}* 檢測到熟悉的能量訊號。",
         ">* 姓名... 未知。",
         ">* 關係狀態... 熟人。",
         ...
         ">* 處理中...\n* 處理中...\n* 處理中...",
         ">* 歡迎回來，熟人。\n* 您今天過得怎樣？",
         choicer.create("* （你要怎麼回答？）", "好聽", "不好聽", "一般", "不確定")
      ],
      npc86e: () => [
         ...[
            [">{#p/basic}{#npc/a}* 很好？\n* 很高興聽您這麼說。"],
                           ...
                           : SAVE.data.n.state_foundry_undyne === 2
                              ...
                              : 2 <= SAVE.data.n.plot_date
                                 ...
                                 : SAVE.data.n.plot > 47.2 && SAVE.data.n.plot_date > 1
                                    ? world.trueKills > 0
                                       ? [">{#p/basic}{#npc/a}* Papyrus在附近等著呢。", ">* Isn't he brave?"]
                                       : [">{#p/basic}{#npc/a}* Papyrus在附近等著呢。", ">* 想見見我的新鄰居去嗎？"]
                                    : [
                                       ">{#p/basic}{#npc/a}* 話說，我是從首塔過來\n  鑄廠這裡遊覽的。",
                                       ">* 我在那幾乎不認識任何人，\n  但在這，我已經遇到了\n  幾個友好的鄰居。",
                                       ">* 我覺得我短期內\n  不會離開這裡。"
                                    ],
            () =>
                  ...
                  : geno()
                     ? [
                        ...
                        ...(world.goatbro && SAVE.flag.n.ga_asrielEcho1++ < 1
                           ? [">{#p/asriel2}{#f/2}* 謝了，Undyne。\n* 要是還動不動碰上怪物，\n  我就真吃不消了。"]
                           : [])
                     ]
                     : [
                        ">{#s/echostart}{#p/event}{#npc/a}* 訊號開始...",
                        ">{#p/basic}* 我是鑄廠員工Skrubby。\n* 麻煩你檢查一下管道有無洩漏。",
                        ">{#p/alphys}* 喔- 呃... 抱-抱歉哈！\n* 我現在稍微有點忙！",
                        ">{#p/basic}* 好吧。\n* 我去叫Raddy來幫忙。\n* 真是謝謝您了。",
                        ">{#p/alphys}* 不-不用謝？？",
                        ">{#s/echostop}{#p/event}{#npc}* 訊號終止。"
         ...
         f_echoAbyss2: () =>
            SAVE.data.n.plot === 72
               ...
               : world.genocide
                  ? [
                     ">{#s/echostart}{#p/event}{#npc/a}* 訊號開始...",
                     ">{#p/papyrusnt}UNDYNE，在嗎？\n我兄弟他...\n他...",
                     ">{#p/undyne}* 他怎麼了，Papyrus？",
                     ">{#p/papyrusnt}...",
                     ">{#p/undyne}* Papyrus？",
                     ">{#s/echostop}{#p/event}{#npc}* 訊號終止。"
                  ]
                  : geno()
                     ...
                     : [
                        ">{#s/echostart}{#p/event}{#npc/a}* 訊號開始...",
                        ">{#p/radio}{#v/0}* 你說沒發生什麼大事！？\n* 你簡直是瘋了。",
                        ">{#p/alphys}* （嗯...）",
                        ">{#p/radio}{#v/0}* 來自鄰近星球的外星人\n  今天就要到達了！",
                        ">{#p/alphys}* （我還是讓它播下去吧。\n  誒嘿嘿。）",
                        ">{#s/echostop}{#p/event}{#npc}* 訊號終止。",
            ...
            SAVE.data.n.plot === 72
               ...
               : geno()
                  ...
                  : [
                     ...
                     ...(world.kiddo && !SAVE.data.b.f_state_dc_kidd4
                        ? ((SAVE.data.b.f_state_dc_kidd4 = true),
                           [">{#p/kidd}{#f/1}* Erogot？", ">{#f/1}* Erogot國王！？", ">{#f/3}* 天..."])
                        : [])
                  ],
         f_echoAbyss5: () =>
            SAVE.data.n.plot === 72
         ...
         f_echoAbyss8: () =>
            SAVE.data.n.plot === 72
               ...
               : world.genocide
                  ? [
                     ">{#s/echostart}{#p/event}{#npc/a}* 訊號開始...",
                     ">{#p/papyrusnt}我是PAPYRUS。\n聽到提示音後儘管留言！",
                     ">{#p/undyne}* 該死...",
                     ">{#p/undyne}* Papyrus，我真不該讓你遭這種罪。",
                     ">{#p/undyne}* 你們兄弟倆命不該如此。",
                     ">{#s/echostop}{#p/event}{#npc}* 訊號終止。"
                  ]
                  : geno()
            ...
            SAVE.data.n.plot === 72
               ...
               : world.genocide
                  ? [
                     ">{#s/echostart}{#p/event}{#npc/a}* 訊號開始...",
                     ">{#p/mettaton}* 博士啊...",
                     ">{#p/mettaton}* 我該料到你會就這麼逃跑的...",
                     ">{#p/mettaton}* ...\n* 該死...",
                     ">{#p/mettaton}* 你不明白嗎？",
                     ">{#p/mettaton}* 沒有你，我沒法完善\n  那些防禦部件啊...",
                     ">{#s/echostop}{#p/event}{#npc}* 訊號終止。"
                  ]
                  : geno()
                     ? [
                        ">{#s/echostart}{#p/event}{#npc/a}* 訊號開始...",
                        ">{#p/mettaton}* 唉，他們馬上就到了。\n* 不知道你會怎麼應對這種場面，\n  不過...",
                        ">{#p/mettaton}* 不管你在這堅守陣地，\n  還是打了退堂鼓...",
                        ">{#p/mettaton}* 我都會全力支援你。",
                        ">{#p/alphys}* ... ehehe...",
            ...
            () =>
               world.genocide
                  ...
                  : SAVE.data.n.plot === 33
                     ...
                     : [">{#p/kidd}{#npc/a}{#f/1}* 你先走吧。", ">{#f/1}* 我隨後就來！"]
         ),
                  ...
                  : SAVE.data.n.state_foundry_undyne !== 0
                     ...
                     : roomKills().f_telescope > 0
                        ...
                        : [
                           ">{#p/basic}{#npc/a}* 草是什麼？",
                           ...(world.genocide
                              ? [">* 它能找到你嗎？", ">* 它能吃掉你嗎？", ">* 它能殺掉你嗎？"]
                              : [">* 你能找到它嗎？", ">* 你能吃掉它嗎？", ">* 你能殺掉它嗎？"]),
                           ">* ...",
                           ">* 你是用草做成的嗎？"
                        ],
            () =>
      ...
      punchcard1: [">{#p/basic}* 箱子裡有一張明信片。"],
      punchcard2: [">{#p/basic}* 箱子裡有好幾張明信片。"],
      punchcard3: () => [choicer.create("* （拿一張明信片嗎？）", "是", "否")],
      punchcard4: [">{#p/human}* （你獲得了一張明信片。）"],
      punchcardX: () => [
         ">{#p/human}* (You can't make out what's in the box...)",
         choicer.create("* (Take something out?)", "是", "否")
      ],
      ...
      spider2: () =>
         badSpider()
            ? [">{#p/basic}* 黑暗中，有東西在前進。"]
            : [">{#p/basic}* 黑暗中，有人在走動。"],
      spider3: () => (badSpider() ? [">{#p/basic}* 它十分強大..."] : [">{#p/basic}* 那人十分好奇..."]),
      spider4: () =>
         badSpider() ? [">{#p/basic}* 它極其危險..."] : [">{#p/basic}* 那人神神秘秘..."],
      ...
      spookydate3: [">{#p/sans}* 這裡。\n* 我知道一條捷徑。"],
      spookydate4: [">{#p/sans}* 很快的捷徑，不是嗎？"],
      spookydate5: [">{#p/sans}* 嘿，各位。"],
      spookydate6: [">{#p/basic}* 好啊，Sans。\n{#x1}* 嘿呀，Sansy~"],
      spookydate7: [">{#p/basic}* 嘿，Sans。\n{#x1}* （嗨，Sans。）"],
      spookydate8: [">{#p/basic}* 我聽說你用烈焰燒烤把酒吧\n  給點燃了，是這樣嗎？"],
      spookydate9: [
         ">{#p/sans}{#f/3}* 嗯？\n* 不，那東西完全無害。",
         ">{#f/2}* 能讓這酒吧燃起來的\n  只有我的招牌幽默笑話。"
      ],
      ...
      spookydate10: [">{#p/sans}* 為什麼不過來坐一下呢，\n  夥計？"],
      spookydate11: [
         ">{#p/sans}* 嗷喲，小心你坐的地方。",
         ">{#f/2}* 有些怪咖會把放屁墊\n  放在座位上。",
         ">{#f/0}* ... 那麼，來點餐吧。\n* 你呲點啥？",
      ...
      spookydate12a: [">{#p/sans}* grillby，給我們來兩份\n  烈焰你自己。"],
      spookydate12b: [">{#p/sans}* grillby，給我們來兩份小漢堡。"],
      spookydate13: () => [
         ">{#p/sans}* 那麼，你覺得我兄弟的攻擊\n  咋樣？",
      ...
      spookydate17: [">{#p/sans}* 喔對了，我想問你點事來著。"],
      spookydate18: () => [
      ...
      spookydate19a: [
         ">{#p/sans}* 原來你都知道啊。",
         ">{#p/sans}* {@fill=#003cff}訊星{@fill=#fff}。"
      ],
      spookydate19b: [">{#p/sans}* 那麼，我來告訴你吧\n* 它叫{@fill=#003cff}訊星{@fill=#fff}。"],
      spookydate20: [
         ">* 工廠到處都是。",
         ">* 如果它們接收到一條訊息，\n  就會一遍又一遍地重複著...",
         ">{#f/3}* 怎樣？",
      ...
      temmiepat2a: [">{#p/human}* （你摸了摸temmie。）", ">{#p/tem}{#npc/a}* 嗚哇喔哇喔哇喔....."],
      temmiepat2b: [">{#p/tem}{#npc/a}* ...", ">{#p/tem}{#npc/a}* Go away."],
      temmiepat3a: [">{#p/human}* （你繼續摸temmie。）", ">{#p/tem}{#npc/a}* 嗚哇喔哇喔哇喔....."],
      ...
      trivia: {
         ...
         sleepingdogs: () =>
            world.darker
               ? [
                  ">{#p/basic}* 一隻站得筆挺的狗子睡得正香。",
                  ...(world.goatbro && SAVE.flag.n.ga_asrielDogepoke++ < 1
                     ? [">{#p/asriel2}{#f/10}* 不得不說，她就是這種貨色。"]
                     : [])
               ]
               : [
                  ">{#p/basic}* 這隻狗看起來像是睡著了，\n  但它的姿勢是一種極度的\n  戰備狀態。",
         ...
         f_trash: pager.create(
            1,
            [">{#p/basic}* 是垃圾。"],
            () => (world.darker ? [">{#p/basic}* 是垃圾。"] : [">{#p/basic}* 還是垃圾。"]),
            () => (world.darker ? [">{#p/basic}* 是垃圾。"] : [">{#p/basic}* 只是些垃圾..."]),
            () => (world.darker ? [">{#p/basic}* 是垃圾。"] : [">{#p/basic}* 垃圾就是垃圾。"]),
            () => (world.darker ? [">{#p/basic}* 是垃圾。"] : [">{#p/basic}* 垃圾形狀的垃圾。"]),
            () => (world.darker ? [">{#p/basic}* 是垃圾。"] : [">{#p/basic}* 真意外，這是垃圾。"]),
                                             ...
                                             : SAVE.data.b.f_state_dummypunch
                                                ...
                                                : SAVE.data.b.f_state_dummyhug
                                                   ...
                                                   : SAVE.data.b.f_state_dummytalk
                                                      ...
                                                      : [">{#p/basic}* 什麼。\n* 什麼？\n* 什-麼-！？", ">{#p/basic}* It's a living."],
         f_view: [">{#p/kidd}{#f/14}* Awesome..."],
         f_village_egg: () => [">{#p/basic}* 已經煮得過熟了。"],
         f_village_sign1: () =>
            SAVE.data.b.svr
      ...
      unddate0x: () =>
         world.trueKills > 0 || SAVE.data.n.state_foundry_undyne > 0
            ? [
               ">{#p/papyrus}{#f/0}UNDYNE現在不在這。",
               ">{#p/papyrus}{#f/4}你得像我經常做的那樣\n在這裡等她。"
            ]
            : [
               ">{#p/papyrus}{#f/0}好！\n準備好消遣了嗎？",
               choicer.create("* （和Undyne做朋友嗎？）", "是", "否")
      ...
      unddate1b: pager.create(
         0,
         [">{#p/papyrus}{#f/4}嗯... 還沒準備好嗎？", ">{#f/0}沒關係，慢慢來！"],
         [">{#p/papyrus}{#f/0}慢慢來！"]
      ),
      unddate2a: [">{#p/papyrus}{#f/4}嘶嘶...\n記得給她這個。"],
      unddate2b: [">{#f/0}她愛死這些東西了！"],
      unddate3: [
         ">{#p/undyne}{#f/14}* 嗨，Papyrus！",
         ">{#f/1}* 準備好你的超機密，\n  一對一訓練了嗎？",
         ">{#p/papyrus}當然啦！",
         ">{#f/9}我還帶了個\n朋友來！"
      ],
      ...
      unddate5: [">{#p/papyrus}給，UNDYNE。", ">我的朋友想\n送給你這個！"],
      unddate5x: [
      ...
      unddate13a1: [
         ">{#p/undyne}{#f/1}* 你想要點零食什麼的嗎？",
         ">{#f/1}* 讓我看看我的柜子裡\n  有什麼。"
      ],
      unddate13a2: [">{#p/undyne}{#f/1}* 啊... 這應該挺不錯的。"],
      unddate13a3: [">{#p/undyne}{#f/14}* 全都是你的...\n* 呋呼呼。"],
      unddate13a4a: [">{#p/human}* （你帶的東西太多了。）"],
      ...
      unddate18: () =>
         SAVE.data.b.undyne_respecc
            ? [">{#p/undyne}{#f/1}* 嗯，你需要什麼\n  指出來不就好了？", ">{#f/16}* 你可以用這根矛！"]
            : [
               ">{#p/undyne}{#f/12}* 嗯，你需要什麼\n  指出來不就好了？",
               ">{#f/12}* 你可以用這根矛！"
            ],
      unddate19x: "* 按←和→瞄準。\n* 按[Z]選定。",
      unddate19y: () => [
      ...
      unddate20: [
         ...
         pager.create(
            0,
            [
               ">{#p/undyne}{#f/17}* 你應該選一個\n  喝的東西？？",
               ">{#f/1}* 那個柜子裡只有零食。"
            ],
            [">{#p/undyne}{#f/1}* 真的，那個柜子裡\n  只有零食。\n* 沒有別的東西了！"],
            [">{#p/undyne}{#f/1}* 真的！"]
         ),
         pager.create(
            0,
         ...
         pager.create(
            0,
            [
               ">{#p/undyne}{#f/12}* 那個糖是用來\n  加在茶裡的。",
               ">{#f/7}* 我沒法給你盛一杯糖！"
            ],
            () =>
               SAVE.data.b.undyne_respecc
                  ? [">{#p/undyne}{#f/1}* 糖不可以，甜心。"]
                  : [">{#p/undyne}{#f/14}* 糖是加在茶裡的，\n  好嗎？"]
         ),
         pager.create(
            0,
            [
               ">{#p/undyne}{#f/1}* 啊... 洋梅潘趣酒。",
               ">{#f/14}* 我想，Papyrus喜歡這東西，\n  所以沒什麼問題。"
            ],
            [">{#p/undyne}{#f/17}* 你到底選不選這個？"]
         ),
         pager.create(
            0,
            [">{#p/undyne}{#f/14}* 沒什麼能比一杯\n  熱巧克力更棒了。"],
            [">{#p/undyne}{#f/17}* 熱巧克力，是吧？"]
         ),
         pager.create(0, [">{#p/undyne}{#f/14}* 茶，是吧？"], [">{#p/undyne}{#f/12}* 所以選茶，是嗎？"]),
         pager.create(
            0,
            [
               ">{#p/undyne}{#f/4}* 冰箱！？\n* 你想要一整臺冰箱！？",
         ...
         pager.create(
            ...
            [
               ">{#p/undyne}{#f/1}* 那把能量劍...",
               ">{#p/undyne}{#f/12}* 那是人類在戰爭中\n  用來對付我們的武器。",
               ">{#p/undyne}{#f/16}* ...算是，其中一把吧。"
            ],
            [">{#p/undyne}{#f/17}* 那東西不能給你。"]
         )
      ],
      unddate21: () => [choicer.create("* （要選這個喝嗎？）", "是", "否")],
      unddate22: [
         [">{#p/undyne}{#f/16}* 也... 行吧。"],
         [">{#p/undyne}{#f/1}* 來喝點果酒，補充水分吧！"],
         [">{#p/undyne}{#f/14}* 開始無與倫比的\n  熱可可時間吧！"],
         [">{#p/undyne}{#f/14}* 馬上給你上茶。"]
      ],
      unddate22x: [">{#p/undyne}{#f/12}* 還需要等一段時間\n  水才能沸騰。"],
      unddate22y: () => [
      ...
      unddate24: [
         [">{#p/undyne}{#f/12}* 好喝嗎...？"],
         [">{#p/undyne}{#f/12}* 小心喝，有點酸。"],
         [">{#p/undyne}{#f/14}* 小心喝，有點燙。"],
         [">{#p/undyne}{#f/14}* 小心喝，有點燙。"]
      ],
      unddate25: [
         () => [
         ...
         [
            ">{#p/undyne}{#f/17}* 也沒有那麼燙！！\n* 快點喝啊！",
            ">{#p/human}{#s/heal}* （你喝了一口熱巧克力。）",
            ">{#p/basic}* 燙得像火燒..."
         ],
         [
            ">{#p/undyne}{#f/17}* 也沒有那麼燙！！\n* 快點喝啊！",
      ...
      unddate28: () => [
         ...
         ...(SAVE.data.b.undyne_respecc
            ...
            : [">{#f/8}* 你倆都是軟蛋！", ">{#f/9}* ...某種意義上啦。"])
      ],
      unddate29: [
         ">{#p/undyne}{#f/16}* 知道嗎，我以前\n  是個非常衝動的孩子。",
         ">* 有一次，我為了\n  證明自己是最強的，\n  就去嘗試和ASGORE戰鬥。",
         ">{#f/17}* 重點是嘗試二字。",
         ">{#f/1}* 我壓根連一下\n  都打不中他！",
         ">* 更糟的是，從頭到尾，\n  他都不肯還手！",
      ...
      unddate31: () => [
         SAVE.data.b.undyne_respecc
            ? ">{#p/undyne}{#f/1}* 喔，抱歉，我講太多了..."
            : ">{#p/undyne}{#f/12}* 喔，抱歉，我講太多了..."
      ],
      unddate32: [
         [">{#f/12}* 你的水喝完了，是吧？"],
         [">{#f/12}* 你的潘趣酒喝完了，是吧？"],
      ...
      unddate34: [">{#p/undyne}{#f/17}* 等一下...", ">{#f/17}* Papyrus...\n* 他的烹飪課..."],
      unddate35: [
         ">{#p/undyne}{#f/17}* 他現在本該在\n  上課的！！！",
         ">{#f/11}* 如果他沒來\n  上課的話...",
         ">{#f/7}* 那只能用你來\n  代替他了！"
      ],
      unddate36: () =>
      ...
      unddate40: (res: number) => [
         ...(world.meanie && res === 1
            ? [
               SAVE.data.b.undyne_respecc
                  ? ">{#p/undyne}{#f/2}* 沒錯！！！\n* 這就是我認識的戰士！！"
                  : ">{#p/undyne}{#f/6}* 今天可真是歡騰啊，\n  是吧？",
               ">{#f/6}* 哈，我們過會再把這堆\n  弄到個碗裡去。"
            ]
            : [">{#p/undyne}{#f/6}* 呃，我們過會再把這堆\n  弄到個碗裡去。"]),
         ">{#f/2}* 但是現在！"
      ],
      unddate41: [
         ">{#p/undyne}{#f/1}* 我們把麵條加進去！",
         ">{#f/1}* 自家制的麵條最棒了，\n  所以我總是備一些。"
      ],
      ...
      unddate44: [">{#p/undyne}{#f/17}* 準備好了嗎？", ">{#f/1}* 來攪拌吧！"],
      unddate45: "* 連續按[Z]來攪拌！",
      unddate46: [">{*}{#p/undyne}{#f/17}* 用力攪！{^20}{%}"],
      unddate46x: [">{*}{#p/undyne}{#f/17}* 別光站著！{^20}{%}"],
      unddate47: [">{*}{#p/undyne}{#f/7}* 再用力一點！{^20}{%}"],
      unddate47x: [">{*}{#p/undyne}{#f/7}* 該死的！攪啊！{^20}{%}"],
      unddate48: [">{*}{#p/undyne}{#f/8}* 再用力！！！{^20}{%}"],
      unddate48x: [">{*}{#p/undyne}{#f/8}* 攪啊！！！{^20}{%}"],
      unddate49: [">{*}{#p/undyne}{#f/8}* 呃，放著我來-{^10}{%}"],
      ...
      unddate52: [">{#p/undyne}{#f/17}* 準備好了嗎？", ">{#f/1}* 開始吧！"],
      unddate53: "* 按住[→]開大火！",
      unddate53x: [">{*}{#p/undyne}{#f/8}* 你個蠢蛋！\n* 這個爐子只能\n  往一邊開火！！！{^20}{%}"],
      unddate54: [">{*}{#p/undyne}{#f/17}* 再熱一些！{^20}{%}"],
      unddate54x: [">{*}{#p/undyne}{#f/17}* 你在幹什麼？{^20}{%}"],
      unddate55: [">{*}{#p/undyne}{#f/7}* 再熱些！{^20}{%}"],
      unddate55x: [">{*}{#p/undyne}{#f/7}* 別再猶豫了！{^20}{%}"],
      unddate56: [">{*}{#p/undyne}{#f/8}* 再熱些！！！{^20}{%}"],
      unddate56x: [">{*}{#p/undyne}{#f/8}* 做就好了！！！{^20}{%}"],
      unddate57a: [">{*}{#p/undyne}{#f/17}* 呃，讓我來吧...{^10}{%}"],
      unddate57b: [">{*}{#p/undyne}{#f/17}* 看到了嗎，這就是你-{^20}{%}"],
      unddate58: [">{*}{#p/undyne}{#f/17}* 不，等下，有點太-{^10}{%}"],
      unddate59: [">{#p/undyne}{#f/14}* 啊。"],
      unddate60: [">{#p/undyne}{#f/14}* 啊，難怪Papyrus\n  廚藝再也沒有進步了。"],
      unddate61: [">{#p/undyne}{#f/12}* 然後做些什麼？\n* 去淘些垃圾？\n* 還是綁個腕帶？"],
      unddate62: () =>
         SAVE.data.b.undyne_respecc
            ? [
               ">{#p/undyne}{#f/10}* ...",
      ...
      unddate64: () =>
         SAVE.data.b.undyne_respecc
            ? [">{#p/undyne}{#f/17}* 來一場向銀河系證明\n  我們實力的最後一戰！！"]
            : [">{#p/undyne}{#f/17}* 這就意味著我能\n  毫不猶豫地幹掉你！"],
      unddate65: () => [
         ">{#p/undyne}{#f/12}* 好吧，還挺好玩的，\n  是吧？",
         SAVE.data.b.undyne_respecc
            ? ">{#f/8}* 我們下次再\n  找時間鬥一場！"
            : ">{#f/8}* 我們下次再約出去玩！",
         ">{#f/9}* 但是，呃，\n  我覺得該換個地方。",
      ...
      undyne1c: () =>
         ...
         world.edgy || (world.population_area('s') < 6 && !world.bullied_area('s')) // NO-TRANSLATE
            ...
            : [">{#p/papyrusnt}當-當然了！\n我當然跟人類戰鬥了！", ">我英勇地和那個人類\n戰鬥過了！"],
      undyne1d: [">{#p/papyrus}{#f/30}...什麼？\n我有沒有把人類抓住...？"],
      undyne1e: [">{#p/papyrus}{#f/30}這-這-這個...", ">沒有..."],
      undyne1f: () =>
         world.edgy || (world.population_area('s') < 6 && !world.bullied_area('s')) // NO-TRANSLATE

            ? [">{#p/papyrus}{#f/30}L-LIKE I SAID, IT'S COMPLICATED!"]
            : [">{#p/papyrus}{#f/30}我-我是說，\n我真的很努力了，\n但-但是，最終..."],
      undyne1g: () => [
         ">{#p/papyrus}{#f/30}...什-什麼？",
      ...
      undyne1j: [">{#p/kidd}{#f/1}* 喲！\n* 她就在那裡！"],
      undyne1k: [">{#p/kidd}{#f/7}* 等等... 你是個人類，\n  對吧？"],
      undyne1l: [">{*}{#p/kidd}{#f/7}* 快跑啊啊啊啊啊！{^20}{%}"],
      undyne1m: [">{#p/kidd}{#f/2}* 呼..."],
      undyne1n: [">{#p/kidd}{#f/1}* 呃，你可以從平臺上\n  下來了。"],
      undyne1o: [">{#p/kidd}{#f/4}* 她去哪了...？"],
      undyne1p: [">{#p/kidd}{#f/7}* 啊！{^10}{%}"],
      undyne1q: [">{#p/kidd}{#f/2}* 噓...\n  我感覺我們可以偷偷溜過去。\n* 快跟上我！"],
      undyne1r: [">{#p/kidd}{#f/4}* 這裡烏黑一片...", ">{#p/kidd}{#f/7}* ...但是我們得保持\n  前進！"],
      undyne1s: [">{#p/kidd}{#f/7}* 快躲進那叢便於藏身\n  的植物裡！"],
      undyne2a: [
         ">{#p/kidd}{#f/7}* 她... 她...",
         ">{#f/7}* 她摸到我了！！",
         ">{#f/4}* ...\n* 我們應該都算走運，\n  你說是吧？",
      ...
      undyne2ax: () => [
         ...
         ">{#f/1}* 哪兒都找不到她！！",
         ">{#f/3}* 你倆看到她了沒有？",
         ">{#p/asriel2}{#f/3}* 誰呀，Undyne嗎？",
         ">{#p/kidd}{#f/1}* 對呀！\n* 我找她找了好久！",
         ">{#p/asriel2}{#f/2}* （嘻嘻嘻...）",
         ">{#p/kidd}{#f/4}* 嗯？？",
         ">{#p/asriel2}{#f/4}* 沒事。",
         ">{#f/13}* 話說，想跟我們一塊走嗎？",
         ">{#p/kidd}{#f/3}* 你... 想讓我跟著你們？",
         ">{#p/asriel2}{#f/4}* 當然嘍，快來吧。\n* 超有趣的。",
         ">{#p/kidd}{#f/4}* 呃...\n* 我...",
         ...(SAVE.flag.n.genocide_milestone < 5
            ? [
               ">{#p/asriel2}{#f/15}* 嘿，你知道Alphys博士\n  喜歡Undyne的事嗎？",
               ">* 就是... 呃...\n  那種很親密的喜歡。"
            ]
            : [
               ">{#p/asriel2}{#f/9}* 嘿，你知道Alphys博士\n  其實比Undyne還強嗎？",
               ">{#f/5}* 只是她膽子太小，不敢動手！"
            ]),
         ">{#p/kidd}{#f/7}* 什麼？\n* 怎麼可能...",
         ">{#p/asriel2}{#f/1}* 呵，關於她倆...\n  我知道的還不止這些呢。",
         ">{#p/kidd}{#f/7}* 快告訴我！",
         ">{#p/asriel2}{#f/5}* 當然，當然...\n* 不過你得跟$(name)和我走\n  我才告訴你。",
         ">{#p/kidd}{#f/1}* 成交！\n* 哈哈。",
         ">{#f/2}* ..."
      ],
      undyne2b: [">{#p/kidd}{#f/1}* 喲，還等什麼呢？"],
      undyne2bx: [">{#p/kidd}{#f/1}* 出發吧！"],
      undyne2c: [
         ">{#f/3}* 嘿... 我知道我們剛\n  認識不久，但是...",
         ">{#f/4}* 我，其實，並不想讓\n  Undyne傷害你...",
         ">* ...",
      ...
      undyne2ex: [
         ...
         ">* 如果Undyne不在這，\n  誰來痛扁那些壞蛋，\n  保護大家呢？",
         ">{|}{#f/8}* 就是那些- {%}",
         ">{#p/asriel2}{#f/4}* 沒啥好擔心的。",
         ">{#f/3}* 而且，如果Undyne真像\n  你說的那麼多謀善斷...",
         ">{#f/4}* 那她就不會無緣無故離開，\n  對吧？\n* 她多聰明啊。",
         ">{#p/kidd}{#f/4}* 確實...\n* 你說得對...",
         ">{#p/kidd}{#f/2}* 對了，謝謝你們帶上我。",
         ">{#p/asriel2}{#f/10}* 是嗎...？\n* 我們還沒走兩步呢...",
         ">{#p/kidd}{#f/3}* 嗯，我很開心...\n* 不過，我還沒怎麼\n  離開過爹娘，所以...",
         ">{#p/asriel2}{#f/8}* 你還有爹娘？\n* 真新奇。",
         ">{#p/kidd}{#f/7}* 呃，我-我當然有啊，\n  誰沒爹娘啊？？",
         ">{#p/asriel2}{#f/16}* ...\n* 是是是。"
      ],
      undynefinal1a: () =>
         respecc()
      ...
      undynefinal1b: () => (respecc() ? [">{#p/undyne}* No..."] : [">{#p/undyne}* 你猜怎麼著？"]),
      undynefinal1c: () =>
         respecc() ? [">{*}{#p/undyne}{#i/2}* 我不！！{^999}"] : [">{*}{#p/undyne}{#i/2}* 去它的吧！！{^999}"],
      undynefinal1d: () =>
         respecc()
            ? [">{*}{#p/undyne}{#i/1}* 我怎麼能那樣居高臨下地\n  對你說話！！{^999}"]
            : [">{*}{#p/undyne}{#i/1}* 我幹嘛要告訴你那段故事！！{^999}"],
      undynefinal1e: () =>
         respecc()
            ? [">{*}{#p/undyne}{#i/1}* 明明你都光榮地戰鬥過了！！{^999}"]
            : [">{*}{#p/undyne}{#i/1}* 明明你馬上就得受死了！！{^999}"],
      ...
      undynefinal3: () => [
         ...(SAVE.data.n.state_starton_papyrus === 1
            ...
            : world.trueKills > 1
               ...
               : respecc()
                  ? [">{#p/undyne}{#f/1}* 那麼，好了...！", ">{#f/17}* It's time you met your one true equal!"]
                  : [">{#p/undyne}{#f/1}* 那麼，好了...！", ">{#f/17}* 別再想著逃走！"])
      ],
      undynefinal3x: [">{#f/7}{*}* 去死吧！！！{#x1}{^999}"],
      undynehouse1: [">{#p/basic}* 鎖住了。"],
      undynehouse2: () =>
            ...
            SAVE.data.n.state_foundry_muffet === 1
               ? [
                  SAVE.data.b.f_state_kidd_fight
                     ? ">{#p/kidd}{#f/4}* 雖然... 你讓我攻擊他們..."
                     : ">{#p/kidd}{#f/4}* 雖然... 一直是你在攻擊他們...",
                  ">{#p/kidd}{#f/8}* 但你真的...\n* ...真的打-打心裡想...\n* ...那麼做嗎...？"
               ]
               : [
                  ">{#p/kidd}{#f/2}* 有一天，那個矮個子骷髏\n  和他的兄弟來代課...",
                  ">{#p/kidd}{#f/2}* 還有，雖然是個秘密，\n  但是...",
                  ">{#f/1}* 他們讓我自己一個人\n  繞著前哨站飛！！"
               ],
         path3: () =>
            SAVE.data.n.state_foundry_muffet === 1
               ? [
                  ">{#p/kidd}{#f/4}* 我從沒想傷害任何人，\n  我只是...\n* 我...",
                  ">{#p/kidd}{#f/8}* 我只是想醒過來...\n* 好希望... 這只是場噩夢..."
               ]
               : [
                  ">{#p/kidd}{#f/1}* 也許有一天我會成為\n  一名真正的飛行員，\n  擁有自己的星際飛船。",
                  ">{#p/kidd}{#f/1}* 側面畫著火焰，\n  還有巨大的翅膀，\n  還有...",
                  ">{#p/kidd}{#f/6}* 天啊，肯定超酷的..."
               ],
         path4: () =>
      ...
      watercooler1: () => [
         ...(SAVE.data.b.svr
            ...
            : [
               ">{#p/basic}* 這是個裝滿電阻尼液的飲水機，\n  上面有一個奇怪的警告標籤。",
               ">{#p/basic}* 「僅用於消除可攜式\n  噴氣背包的靜電幹擾。」"
            ]),
         choicer.create("* （要接一杯嗎？）", "是", "否")
      ],
      watercooler2a: [">{#p/human}* （你現在拿著一杯電阻尼液。）"],
      watercooler2b: [">{#p/human}* （你決定不接。）"],
      watercooler3: () => [
         ...(SAVE.data.b.svr
            ? [">{#p/human}* (The label describes using this fluid only in a specific kind of emergency.)"]
            : [
   ...
   b_opponent_moldfake: {
      ...
      name: "* Gelatini",
      smalTalk: [">{#p/basic}{~}..."],
      status1: () => (world.goatbro ? [">{#p/asriel2}* Gelatini."] : [">{#p/story}* Gelatini出現了？"]),
      fakeStatus1: () =>
         world.goatbro
            ? [">{#p/asriel2}* Gelatini."]
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
   ...
   b_opponent_radtile: {
      ...
      hurtStatus: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ...
            : [">{#p/story}* Radtile的牙齒開始脫落了。"]
   },
   b_opponent_doge: {
      act_check: () =>
         world.goatbro
            ? [">{#p/asriel2}* Doge，一條冷血的狗。\n* 純純的工作機器。"]
            : [">{#p/story}* DOGE - ATK 14 DEF 10\n* Pronounced \"dohj.\" Soft j.\n* Member of the ELITE squad."],
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ? [">{#p/human}* （你向Doge調情。）", ">{#p/basic}* 她對這種拍須溜馬不屑一顧。"]
            : battler.volatile[0].vars.pet
               ? [">{#p/human}* （你向Doge調情。）", ">{#p/basic}* Doge smiles in return."]
               : battler.volatile[0].sparable
                  ...
                  : world.flirt < 10
                     ? [">{#p/human}* （你向Doge調情。）", ">{#p/basic}* Doge doesn't react in any strong way."]
                     : [">{#p/human}* （你向Doge調情。）", ">{#p/basic}* Doge is giving it her all to resist you."])
      ],
      act_flirt2: [
      ...
      status1: () => (world.goatbro ? [">{#p/asriel2}* Doge。"] : [">{#p/story}* Doge昂首闊步向你走來。"]),
   ...
   b_opponent_muffet: {
      act_check: [">{#p/story}* MUFFET - 攻擊39 防禦19\n* 全蜘蛛部落的女王。\n* 特戰隊志願兵。"],
      act_flirt: () => [
         ...(badSpider()
            ? [">{#p/human}* （你向Muffet調情。）\n* （Muffet狠狠瞪了你一眼。）"]
            : battler.volatile[0].sparable
      ...
      act_flirt3: [
         ">{#p/human}* （你鼓起勇氣，邀請Muffet\n  一同去野餐。）",
         ">{#p/basic}* Muffet嚕嚕笑了幾下...",
         ">* 然後又笑了幾聲...",
         ">* 她已經無法控制自己的情感了！\n* Muffet向你完美的調情能力屈服！",
         ">* ... 然後立即決定結束戰鬥，\n  以免讓她的蜘蛛同伴們蒙羞。",
         ">{#p/kidding}* ... 什麼？"
      ],
      flirtReaction1: [">{#p/basic}{~}真可愛啊~"],
      flirtReaction2: [">{#p/basic}{~}你人真好~"],
      flirtReaction3: [">{#p/basic}{~}啊呼呼~"],
      appeaseText: () =>
         world.dead_canine
            ? [
               ">{#p/human}* （你對Muffet提出異議。）\n* （Muffet再一次被你的話\n  所吸引。）",
      ...
      counterTextGeno: [
         ">{#p/human}* （你嘗試反駁Muffet。）",
         ">{#p/basic}* Muffet對自己的目標堅定不移。"
      ],
      counterTextLate: [">{#p/human}* （你嘗試反駁Muffet，\n  但她早已拿定了主意。）"],
      counterTextPost: [">{#p/human}* （但Muffet已經聽過了\n  你的駁論。）"],
      name: "* Muffet",
   ...
   b_opponent_undyne: {
      ...
      spaghetti2: () =>
         world.genocide
            ? [
               ...
               ">{#p/story}* Undyne的攻擊力提升了！\n* Undyne的防禦力下降了！"
            ]
            : [
               ">{#p/basic}* The smell reminds Undyne of someone she'll never see again...",
               ">{#p/story}* Undyne的防禦力下降了！"
            ],
      act_check: () =>
         world.genocide
      ...
      earlyChallenge: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/3}想跟我{@fill=#f00}硬碰硬{@fill=#000}，是嗎？",
               ">{#e/undyne/2}成全你。"
            ]
            : respecc()
               ? [
      ...
      earlyChallengeStatus: [">{#p/story}* 戰鬥局勢開始升溫。"],
      randStatus1: () =>
         respecc()
      ...
      papStatus1: [">{#p/story}* Undyne的眼角閃爍著淚光。"],
      papStatus2: [">{#p/story}* Undyne沉著臉，死死瞪著你。"],
      papStatus3: [">{#p/story}* Undyne想到了她的朋友，\n  用盡全力向地猛擊。"],
      papStatus4: [">{#p/story}* Undyne沒心情跟你胡鬧。"],
      papStatus5: [">{#p/story}* 金槍魚沙拉的味道撲面而來。"],
      ...
      turnTalkA4: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [">{#p/undyne}{#e/undyne/2}許多人反對我加入衛隊，\n包括我的家人。"]
            : respecc()
      ...
      turnTalkA5: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/3}後來，\n在一次訓練事故中，\n我瞎了左眼...",
               ">{#p/undyne}{#e/undyne/2}困難重重，無依無靠。"
            ]
            : [">{#p/undyne}{#e/undyne/5}NGAHHH!\nEnough warming up!"],
      turnTalkA6a: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/11}重重困難將我擊垮，\n每一步，都異常艱難。",
               ">{#e/undyne/3}我哀嚎著，多麼希望\n有人能聽到我的心聲。"
            ]
      ...
      turnTalkA6b: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ...
            : respecc()
               ? [">{#p/undyne}{#e/undyne/9}快啊！\n來打我吧！", ">{#e/undyne/7}Don't just stand there!"]
               : [
      ...
      turnTalkB1: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/2}我四處求援，\n卻徒勞無功。",
               ">{#e/undyne/3}突然，我聽到一個聲音\n呼喚著我的名字。"
            ]
            : respecc()
               ? [
      ...
      turnTalkB2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [">{#p/undyne}{#e/undyne/2}那時，Papyrus\n還只是個孩子。"]
            : respecc()
      ...
      turnTalkB3: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [">{#p/undyne}{#e/undyne/3}遇到危險，大多數小孩\n都會馬上逃跑...", ">{#e/undyne/4}但他不會。"]
            : respecc()
      ...
      turnTalkB6: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/4}即便我擁有再大的膽識，\n再多的力量...",
               ">{#e/undyne/11}也無法像他那樣，\n擁有純潔無瑕的心靈。"
            ]
            : respecc()
         ...
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               world.trueKills > 9
                  ...
                  : ">{#p/undyne}{#e/undyne/11}你斬碎了他的頭顱之時，\n也斬碎了僅存的仁慈。",
               ">{#p/undyne}{#e/undyne/2}而我能給你的\n全部「仁慈」...",
               ">{#p/undyne}{#e/undyne/1}就是讓你死得痛快點！"
            ]
            : respecc()
               ? [
      ...
      turnTalkC2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/2}Alphys告訴過我，\n人類充滿了決心...",
               ">{#p/undyne}{#e/undyne/1}呵呵，你那點破決心，\n也就只能送你到這了。"
            ]
            : respecc()
               ? [
      ...
      deterStatus1: [">{#p/story}* Undyne笑著，強裝自己沒事。"],
      deterStatus2: [">{#p/story}* Undyne的身體正一點一點融化。"],
      deterStatus3: [">{#p/story}* Undyne的身體已經化得\n  看不出形狀了。"],
      deterStatus4: [">{#p/story}* Undyne深吸了一口氣。"],
      ...
      challengeText4: [">{#p/human}* （你告訴Undyne，\n  你想來一場真正的對決。）"],
      challengeText5: [
         ">{#p/human}* (You tell Undyne her attacks are too easy.)",
      ...
      genoCutscene2: [">{#p/kidding}{#e/kidd/3}UNDYNE！！！", ">{#e/kidd/4}我...！"],
      genoCutscene3: [">{#p/undyne}{#e/undyne/1}小子...？"],
      genoCutscene3x: [
         ">{#p/undyne}{#e/undyne/4}嘿，不用說什麼...",
         ">{#e/kidd/7}小子，我沒事。",
         ">{#p/undyne}趕緊逃吧，好嗎？"
      ],
      genoCutscene4: [
      ...
      genoCutscene8: [">{#p/undyne}{#e/undyne/3}小傷，沒什麼大不了的..."],
      genoCutscene9: [
         ">{#e/undyne/4}聽著，我會幹翻這些混蛋。",
         ">你不用聽他們使喚了。",
         ">趕緊逃吧，好嗎？"
      ],
      genoCutscene10: [">{#e/kidd/8}{#p/kidding}..."],
      genoCutscene11: [">{#p/undyne}{#e/undyne/5}Alphys博士會照顧好你的。", ">{#e/undyne/6}逃啊！"],
      genoCutscene12a: [
      ...
      genoCutscene14: [
         ...
         ">{*}我們都有一個\n共同的目標。{^15}{%15}",
         ">{*}{#e/undyne/14}那就是戰勝你。{^15}{%15}",
         ">{*}{#e/undyne/13}人類。Asriel。\n...不，不管你們是誰。{^15}{%15}",
         ">{*}{#e/undyne/14}為了讓這星河存續下去...{^15}{%15}",
         ">{*}{#e/undyne/15}{@random=1.1/1.1}我，Undyne，\n會將你們徹底擊垮！{^15}{%15}"
      ],
      genoCutscene14x: [
         ">{#e/undyne/11}不...",
         ">{#e/undyne/12}不能就這麼結束...！",
         ">{#e/undyne/13}Everyone in the galaxy is counting on me!",
         ">{#e/undyne/14}我不能讓他們失望！"
      ],
      genoCutscene15: [">{*}{#p/undyne}{#v/1}你們還得再加把勁。{%20}"],
      genoCutscene15x: [">{#p/undyne}{#v/1}你們還得再加把勁！{%20}"],
      genoDeath1: [
      ...
      lowStatus5: [">{#p/story}* 有一瞬，長矛的攻勢停了下來。"],
      genoStatus1: [">{#p/asriel2}* 怎麼會..."],
      genoStatus2: [">{#p/asriel2}* 不..."],
      genoStatus3: [">{#p/asriel2}* 遊歷了這麼多條時間軸，\n  我也從沒見過她..."],
      genoStatus4: [">{#p/asriel2}* $(name)，光靠你打不過她。"],
      genoStatus5: [">{#p/asriel2}* ..."],
      trueGenoStatusX: () =>
         battler.volatile[0].vars.azzyAssist < 2
            ? [">{#p/asriel2}* Let's see how she likes THIS."]
            : [">{#p/asriel2}* 別忘了我們的戰術。"],
      trueGenoStatus1: [">{#p/asriel2}* 別走神了。"],
      trueGenoStatus2: [">{#p/asriel2}* 可別讓她唬到你了。"],
      trueGenoStatus3: [">{#p/asriel2}* 繼續攻擊就好..."],
      trueGenoStatus4: [">{#p/asriel2}* 她早晚會撐不住的。"],
      trueGenoStatus5: [">{#p/asriel2}* 勝利終將屬於我們。"],
      trueGenoStatusLow1: [">{#p/asriel2}* Almost dead...!"],
      trueGenoStatusLow2: [">{#p/asriel2}* ...加把勁！"],
      asrielExplain: () => [
         ...(battler.volatile[0].vars.azzyAssist < 2
            ? [">{#p/asriel2}{#f/4}$(name)，\n你的攻擊傷不到她。"]
            : [
      ...
      neutralFinalStatus: [">{#p/story}* Undyne充滿了決心。"]
   },
   b_opponent_dateundyne: {
      ...
      status1: [">{#p/story}* Undyne讓你先出招。"],
      act_check: [">{#p/story}* UNDYNE - 攻擊41 防禦21\n* 千真萬確的最終決戰\n  終於開始了！"],
      idleTalk1: [">{#p/undyne}{#e/undyne/9}讓我看看\n你的實力吧！"],
      idleTalk2: [">{#p/undyne}{#e/undyne/9}快啊！"],
      idleTalk3: [">{#p/undyne}{#e/undyne/9}怎麼，\n你怕了嗎？"],
      idleTalk4: [">{#p/undyne}{#e/undyne/9}你在等什麼？"],
      ...
      cutscene2: (fought: boolean) => [
         ...
         ">{#e/undyne/3}聽好了，人類。",
         ">{#f/undyne/0}看來你和\nAsgore\n命中注定\n難逃一戰。",
         SAVE.data.b.undyne_respecc ? ">{#e/undyne/3}不像你..." : ">{#e/undyne/3}以我對\n他的了解...",
         ">{#e/undyne/4}他大概\n並不想和你\n戰鬥。",
         ...(SAVE.data.b.undyne_respecc
            ? [
               ">{#e/undyne/0}如果可以，\n跟他聊聊。",
   ...
   i_goggles: {
      ...
      drop: [">{#p/human}* （你把AR眼鏡扔掉了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* （6防禦。）"]
            : [">{#p/basic}* 「AR眼鏡」 （6防禦）\n* 超越現實！\n  能為你提供更長的喘息時間。"],
      name: "AR眼鏡",
      use: [">{#p/human}* （你戴上了AR眼鏡。）"]
   },
   i_goggles_x: {
      battle: {
      ...
      use: () =>
         world.meanie
            ? [
               ...
               battler.active
                  ? `>{#p/story}* 你的攻擊力提升了${2 + battler.at_bonus}點！`
   ...
   i_tea: {
      ...
      use: () => [
         ...
         battler.active ? ">{#p/story}* 你的移速提升了1點！" : ">{#p/human}* (No effect outside of battle.)"
      ]
   },
   i_tzn: {
      battle: {
      ...
      use: () => [
         ...
         ...(world.meanie
            ? [
               ...
               battler.active
                  ? `>{#p/story}* 你的攻擊力提升了${4 + battler.at_bonus}點！`
                  : ">{#p/human}* (No effect outside of battle.)"
            ]
            : [])
      ]
   ...
   n_shop_tem: {
      ...
      itemUnavailable: () => (temgone() ? ">{#p/basic}空無一物。" : ">{#p/tem}{#k/2}no more item..."),
      itemRestricted: ">{#p/tem}{#k/2}這個我\n不收...",
      menu: () =>
         temgone() ? ["拿取", "偷竊", "閱讀", "離開"] : ["購買", world.meanie ? "偷竊" : "出售", "交談", "離開"],
      menuPrompt1: ">{#p/tem}{#k/0}* 你吼！\n* 歡銀光臨...\n* TEM百嚯店！！！",
      menuPrompt2: ">{#p/basic}* ...但是人們都逃走了。",
      sell1: [">{#p/tem}{#k/2}* 別哇！！！\n* 我滴錢錢，，，", ">{#p/tem}{#k/4}* 不許偷錢！！！"],
      sell2: [">{#p/tem}{#k/3}* 沒門。"],
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? "Your Future" : SAVE.data.b.colleg ? "關於Temmie盔甲" : "來個自我介紹",
         SAVE.data.n.plot === 72 ? "Temmie Secrets" : "Temmie的歷史",
         "關於這個商店",
         "離開"
      ],
            ...
            SAVE.data.n.plot === 72
               ...
               : SAVE.data.b.colleg
                  ? [
                     ...
                     ">{#k/3}* 如果尼{@fill=#ff0}輸了好多戰鬥{@fill=#fff}，\n  tem就費{@fill=#ff0}降低價格{@fill=#fff}！",
                     ...(armorprice() <= 1000
                        ? [
   ...
   n_shop_tortoise: {
      ...
      menuPrompt1: () =>
         SAVE.data.n.plot === 72
            ...
            : ">{#p/basic}{#k/0}* 來瞧瞧！\n* 我這有不少物美價廉的\n  廢品打算賣呢。",
      menuPrompt2: () =>
         SAVE.data.n.plot === 72 ? ">{#p/basic}{#k/0}* 哇哈哈。" : ">{#p/basic}{#k/0}* 別見外喔。",
      menuPrompt3: () =>
         world.genocide
            ? ">{#p/basic}{#k/3}* 小夥子，\n  你們幾個忙活啥呢？\n* 等等，當我沒問。\n  不關我的事，對吧？"
            : ">{#p/basic}{#k/2}* Wa ha ha...\n* So you came to see me.\n* What a riot!",
      menuPrompt4: ">{#p/basic}* ...但是人們都逃走了。",
      note: [">{#p/human}* （但沒有人給你留字條。）"],
      sell1: () =>
         world.runaway
            ? [">{#p/human}* （你從櫃檯後面拿走了1394G。）"]
            : world.genocide
               ? [
                  ">{#p/basic}{#k/4}* 哇哈哈...",
                  ">{#k/3}* 呵，先是把別人靈魂據為己有，\n  現在又想用同樣的手段\n  偷我的東西？",
               ...
               : world.genocide
                  ...
                  : world.killed0
                     ...
                     : 48 <= SAVE.data.n.plot && SAVE.data.n.state_foundry_undyne > 0
                        ...
                        : [
                           [
                              ">{#p/basic}{#k/0}* 我已經活了很久了。\n* 也許太久了。",
                              ">{#k/3}* 想當年，\n  人們稱我為「正義之劍」。",
                              ">{#k/2}* 那時，\n  我還是行星理事會的主席。",
                              ">{#k/1}* ...要不是該死的戰爭，\n  我今天可能還在\n  那個位置上。"
                           ],
                           [
                              ">{#p/basic}{#k/0}* 啊，是啊，就是那場戰爭。\n* 那場戰爭，\n  給我，給這裡每個人\n  都帶來了難以磨滅的創傷。",
                              ">{#k/4}* 每隔一段時間，\n  我們會收到報告...\n* 上面，全是為了保護家園\n  而壯烈犧牲的烈士。",
                              ">{#k/1}* 我至今還記得，小毛球國王\n  將一封封噩耗告知烈士家屬時，\n  他臉上的神情...",
                              ">{#k/1}* 眼神空洞，目光呆滯...\n* 孩子，這就是戰爭\n  給人帶來的影響。",
                              ">{#k/3}* 所以，我就退休了。"
