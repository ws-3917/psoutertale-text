...
export default {
   a_foundry: {
      ...
      darktoriel5a: [
         ">{#p/toriel}{#f/5}* ...嗯？\n* 你还有话要跟我说？",
         ">{#p/human}* （你重复Toriel在Archive Six中\n  给你的建议。）",
         ">{#p/toriel}{#f/2}* ...",
         ">{#f/1}* 这些话...",
         ">{#f/1}* 你怎么可能听过...？",
         ">{#f/0}* 我上次那么说已经是一个世纪前了。",
      ...
      darktoriel7: () =>
         SAVE.data.b.c_state_secret1_used
            ? [
               ">{#p/toriel}{#f/10}* 别担心，Frisk。\n* 我会没事的。",
               ">{#f/1}* 运输船上见。\n* 好吗？"
            ]
            : [
               ">{#p/toriel}{#f/5}* Frisk，你得给我时间处理一下。",
               ">{#f/1}* 运输船上见。\n* 好吗？"
            ],
      ghostpartymusic1: [
                           ...
                           : SAVE.data.n.state_foundry_undyne === 2
                              ...
                              : 2 <= SAVE.data.n.plot_date
                                 ...
                                 : SAVE.data.n.plot > 47.2 && SAVE.data.n.plot_date > 1
                                    ? world.trueKills > 0
                                       ? [">{#p/basic}{#npc/a}* Papyrus在附近等着呢。", ">* Isn't he brave?"]
                                       : [">{#p/basic}{#npc/a}* Papyrus在附近等着呢。", ">* 想见见我的新邻居去吗？"]
                                    : [
         ...
         f_echoAbyss2: () =>
            SAVE.data.n.plot === 72
               ...
               : world.genocide
                  ? [
                     ">{#s/echostart}{#p/event}{#npc/a}* 讯号开始...",
                     ">{#p/papyrusnt}UNDYNE，在吗？\n我兄弟他...\n他...",
                     ">{#p/undyne}* 他怎么了，Papyrus？",
                     ">{#p/papyrusnt}...",
                     ">{#p/undyne}* Papyrus？",
                     ">{#s/echostop}{#p/event}{#npc}* 讯号终止。"
                  ]
      ...
      spookydate1: pager.create(
         ...
         () => [
            ...
            ">{#f/0}* 我们去grillby's那庆祝一番，\n  咋样？",
            ">{#f/3}* 获得了papyrus的好感，你就\n  在我内心有了一席之地。",
      ...
      spookydate12a: [">{#p/sans}* grillby，给我们来两份\n  烈焰你自己。"],
      spookydate12b: [">{#p/sans}* grillby，给我们来两份小汉堡。"],
      spookydate13: () => [
         ">{#p/sans}* 那么，你觉得我兄弟的攻击\n  咋样？",
      ...
      temmiepat2a: [">{#p/human}* （你摸了摸temmie。）", ">{#p/tem}{#npc/a}* 呜哇哦哇哦哇哦....."],
      temmiepat2b: [">{#p/tem}{#npc/a}* ...", ">{#p/tem}{#npc/a}* Go away."],
      temmiepat3a: [">{#p/human}* （你继续摸temmie。）", ">{#p/tem}{#npc/a}* 呜哇哦哇哦哇哦....."],
      ...
      unddate5: [">{#p/papyrus}给，UNDYNE。", ">我的朋友想\n送给你这个！"],
      unddate5x: [
      ...
      unddate60: [">{#p/undyne}{#f/14}* 啊，难怪Papyrus\n  厨艺再也没有进步了。"],
   ...
   b_opponent_muffet: {
      act_check: [">{#p/story}* MUFFET - 攻击39 防御19\n* 全蜘蛛部落的女王。\n* 特战队志愿兵。"],
      act_flirt: () => [
         ...(badSpider()
            ? [">{#p/human}* （你向Muffet调情。）\n* （Muffet狠狠瞪了你一眼。）"]
            : battler.volatile[0].sparable
      ...
      act_flirt3: [
         ">{#p/human}* （你鼓起勇气，邀请Muffet\n  一同去野餐。）",
         ">{#p/basic}* Muffet咯咯笑了几下...",
         ">* 然后又笑了几声...",
         ">* 她已经无法控制自己的情感了！\n* Muffet向你完美的调情能力屈服！",
         ">* ... 然后立即决定结束战斗，\n  以免让她的蜘蛛同伴们蒙羞。",
         ">{#p/kidding}* ... 什么？"
      ...
      counterTextGeno: [
         ">{#p/human}* （你尝试反驳Muffet。）",
         ">{#p/basic}* Muffet对自己的目标坚定不移。"
      ],
      counterTextLate: [">{#p/human}* （你尝试反驳Muffet，\n  但她早已拿定了主意。）"],
      counterTextPost: [">{#p/human}* （但Muffet已经听过了\n  你的驳论。）"],
      name: "* Muffet",
   ...
   b_opponent_undyne: {
      ...
      spaghetti2: () =>
         world.genocide
            ? [
               ...
               ">{#p/story}* Undyne的攻击力提升了！\n* Undyne的防御力下降了！"
            ]
            : [
               ">{#p/basic}* The smell reminds Undyne of someone she'll never see again...",
               ">{#p/story}* Undyne的防御力下降了！"
            ],
      act_check: () =>
         world.genocide
      ...
      papStatus1: [">{#p/story}* Undyne的眼角闪烁着泪光。"],
      papStatus2: [">{#p/story}* Undyne沉着脸，死死瞪着你。"],
      papStatus3: [">{#p/story}* Undyne想到了她的朋友，\n  用尽全力向地猛击。"],
      papStatus4: [">{#p/story}* Undyne没心情跟你胡闹。"],
      ...
      turnTalkB2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [">{#p/undyne}{#e/undyne/2}那时，Papyrus\n还只是个孩子。"]
            : respecc()
      ...
      turnTalkC2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ">{#p/undyne}{#e/undyne/2}Alphys告诉过我，\n人类充满了决心...",
      ...
      deterStatus1: [">{#p/story}* Undyne笑着，强装自己没事。"],
      deterStatus2: [">{#p/story}* Undyne的身体正一点一点融化。"],
      deterStatus3: [">{#p/story}* Undyne的身体已经化得\n  看不出形状了。"],
      deterStatus4: [">{#p/story}* Undyne深吸了一口气。"],
      ...
      challengeText4: [">{#p/human}* （你告诉Undyne，\n  你想来一场真正的对决。）"],
      challengeText5: [
         ">{#p/human}* (You tell Undyne her attacks are too easy.)",
      ...
      genoCutscene11: [">{#p/undyne}{#e/undyne/5}Alphys博士会照顾好你的。", ">{#e/undyne/6}逃啊！"],
      genoCutscene12a: [
      ...
      neutralFinalStatus: [">{#p/story}* Undyne充满了决心。"]
   },
   b_opponent_dateundyne: {
      ...
      status1: [">{#p/story}* Undyne让你先出招。"],
      act_check: [">{#p/story}* UNDYNE - 攻击41 防御21\n* 千真万确的最终决战\n  终于开始了！"],
