...
export default {
   a_foundry: {
      ...
      darktoriel7: () =>
         SAVE.data.b.c_state_secret1_used
            ? [
               ">{#p/toriel}{#f/10}* 別擔心，弗裡斯克。\n* 我會沒事的。",
               ">{#f/1}* 運輸船上見。\n* 好嗎？"
            ]
            : [
               ">{#p/toriel}{#f/5}* 弗裡斯克，你得給我時間處理一下。",
               ">{#f/1}* 運輸船上見。\n* 好嗎？"
            ],
      ghostpartymusic1: [
      ...
      genotext: {
         ...
         asriel41: [">{#p/asriel2}{#f/3}* 回來吧，小傢夥。"],
                           ...
                           : SAVE.data.n.state_foundry_undyne === 2
                              ...
                              : 2 <= SAVE.data.n.plot_date
                                 ...
                                 : SAVE.data.n.plot > 47.2 && SAVE.data.n.plot_date > 1
                                    ? world.trueKills > 0
                                       ? [">{#p/basic}{#npc/a}* 帕派瑞斯在附近等著呢。", ">* Isn't he brave?"]
                                       : [">{#p/basic}{#npc/a}* 帕派瑞斯在附近等著呢。", ">* 想見見我的新鄰居去嗎？"]
                                    : [
      ...
      spookydate11: [
         ...
         ">{#f/2}* 有些怪咖會把放屁墊\n  放在座位上。",
         ">{#f/0}* ... 那麼，來點餐吧。\n* 你呲點啥？",
         ">{#p/human}* （你要怎麼回答？）{!}\n§shift=64§烈焰\n§shift=64§烤爾比§shift=56§小漢堡{#c/0/8/7}",
         ">{#p/sans}{#f/2}* 嘿，聽上去挺不錯。"
      ],
      spookydate12a: [">{#p/sans}* 烤爾比，給我們來兩份\n  烈焰你自己。"],
      spookydate12b: [">{#p/sans}* 烤爾比，給我們來兩份小漢堡。"],
      spookydate13: () => [
         ">{#p/sans}* 那麼，你覺得我兄弟的攻擊\n  咋樣？",
      ...
      temmiepat2a: [">{#p/human}* （你摸了摸提米。）", ">{#p/tem}{#npc/a}* 嗚哇喔哇喔哇喔....."],
      temmiepat2b: [">{#p/tem}{#npc/a}* ...", ">{#p/tem}{#npc/a}* Go away."],
      temmiepat3a: [">{#p/human}* （你繼續摸提米。）", ">{#p/tem}{#npc/a}* 嗚哇喔哇喔哇喔....."],
      ...
      unddate5: [">{#p/papyrus}給，安黛因。", ">我的朋友想\n送給你這個！"],
      unddate5x: [
      ...
      unddate60: [">{#p/undyne}{#f/14}* 啊，難怪帕派瑞斯\n  廚藝再也沒有進步了。"],
   ...
   b_opponent_muffet: {
      act_check: [">{#p/story}* 瑪菲特 - 攻擊39 防禦19\n* 全蜘蛛部落的女王。\n* 特戰隊志願兵。"],
      act_flirt: () => [
         ...(badSpider()
            ? [">{#p/human}* （你向瑪菲特調情。）\n* （瑪菲特狠狠瞪了你一眼。）"]
            : battler.volatile[0].sparable
      ...
      counterTextGeno: [
         ">{#p/human}* （你嘗試反駁瑪菲特。）",
         ">{#p/basic}* 瑪菲特對自己的目標堅定不移。"
      ],
      counterTextLate: [">{#p/human}* （你嘗試反駁瑪菲特，\n  但她早已拿定了主意。）"],
      counterTextPost: [">{#p/human}* （但瑪菲特已經聽過了\n  你的駁論。）"],
      name: "* 瑪菲特",
   ...
   b_opponent_undyne: {
      ...
      papStatus1: [">{#p/story}* 安黛因的眼角閃爍著淚光。"],
      papStatus2: [">{#p/story}* 安黛因沉著臉，死死瞪著你。"],
      papStatus3: [">{#p/story}* 安黛因想到了她的朋友，\n  用盡全力向地猛擊。"],
      papStatus4: [">{#p/story}* 安黛因沒心情跟你胡鬧。"],
      ...
      deterStatus1: [">{#p/story}* 安黛因笑著，強裝自己沒事。"],
      deterStatus2: [">{#p/story}* 安黛因的身體正一點一點融化。"],
      deterStatus3: [">{#p/story}* 安黛因的身體已經化得\n  看不出形狀了。"],
      deterStatus4: [">{#p/story}* 安黛因深吸了一口氣。"],
      ...
      genoCutscene11: [">{#p/undyne}{#e/undyne/5}艾菲斯博士會照顧好你的。", ">{#e/undyne/6}逃啊！"],
      genoCutscene12a: [
      ...
      neutralFinalStatus: [">{#p/story}* 安黛因充滿了決心。"]
   },
   b_opponent_dateundyne: {
      ...
      status1: [">{#p/story}* 安黛因讓你先出招。"],
      act_check: [">{#p/story}* 安黛因 - 攻擊41 防禦21\n* 千真萬確的最終決戰\n  終於開始了！"],
   ...
   n_shop_tem: {
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? "Your Future" : SAVE.data.b.colleg ? "關於提米盔甲" : "來個自我介紹",
         SAVE.data.n.plot === 72 ? "Temmie Secrets" : "提米的歷史",
         "關於這個商店",
         "離開"
      ],
