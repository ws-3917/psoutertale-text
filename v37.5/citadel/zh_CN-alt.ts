...
export default {
   ...
   b_opponent_alphys: {
      ...
      status3b: [">{#p/asriel2}* ...看来艾菲斯不准备防御了。\n* 抓住这个机会！"],
      ...
      done1: (b: boolean) =>
         b
            ...
            : [">{*}我要死在这了...\n是-是吗？{^40}{%}", ">{*}尽了全力，我还是...{^40}{%}"],
      done2: (b: boolean) =>
         b ? [">{*}{#p/alphys}我毫无胜算。{^40}{%}"] : [">{*}{#p/alphys}艾斯戈尔，我对不起你。{^40}{%}"]
   },
   b_opponent_archive1: {
   ...
   b_opponent_final: {
      ...
      friend92: ">{*}{#p/asriel3}{#v/1}{#i/12}艾斯利尔·逐梦{^10}{#p/event}{%}"
   },
