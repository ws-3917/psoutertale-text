...
export default {
   ...
   b_opponent_alphys: {
      ...
      status3b: [">{#p/asriel2}* ...看來艾菲斯不準備防禦了。\n* 抓住這個機會！"],
      ...
      done1: (b: boolean) =>
         b
            ...
            : [">{*}我要死在這了...\n是-是嗎？{^40}{%}", ">{*}盡了全力，我還是...{^40}{%}"],
      done2: (b: boolean) =>
         b ? [">{*}{#p/alphys}我毫無勝算。{^40}{%}"] : [">{*}{#p/alphys}艾斯戈爾，我對不起你。{^40}{%}"]
   },
   b_opponent_archive1: {
   ...
   b_opponent_final: {
      ...
      friend92: ">{*}{#p/asriel3}{#v/1}{#i/12}艾斯利爾·逐夢{^10}{#p/event}{%}"
   },
