...
export default {
   a_citadel: {
      ...
      hypertext: {
         ...
         cyan1: [
            ...
            ">{*}{@fill=#faff29}依靠{@wordify=耐心/勇氣/正直/毅力/善良/正義}耐心{@wordify=}，將會有望逃脫。",
         ...
         orange1: [
            ">{*}{#p/human}{#v/6}{@fill=#faff29}A lost SOUL calls out to you.",
            ">{*}{@fill=#faff29}憑藉{@wordify=勇氣/正直/毅力/善良/正義}勇氣{@wordify=}，或將擺脫束縛。",
         ...
         blue1: [
            ">{*}{#p/human}{#v/6}{@fill=#faff29}A lost SOUL calls out to you.",
            ">{*}{@fill=#faff29}堅守{@wordify=正直/毅力/善良/正義}正直{@wordify=}，必定能夠逃脫。",
         ...
         purple1: [
            ">{*}{#p/human}{#v/6}{@fill=#faff29}A lost SOUL calls out to you.",
            ">{*}{@fill=#faff29}擁有{@wordify=毅力/善良/正義}毅力{@wordify=}，定可擺脫束縛。",
         ...
         green1: [
            ">{*}{#p/human}{#v/6}{@fill=#faff29}A lost SOUL calls out to you.",
            ">{*}{@fill=#faff29}心懷{@wordify=善良/正義}善良{@wordify=}，終能衝破枷鎖。",
      ...
      genotext: {
         ...
         afterfight1: [">{#p/asriel2}{#f/8}* ...總算解決她了。"],
         afterfight2: () =>
            [
               [
         ...
         respawn6: () =>
            [
               [
                  ">{#p/asriel2}{#f/15}* $(name)。\n* 聽我說。",
                  ">{#p/asriel2}{#f/7}* 我們已經幹掉她了。",
                  ">{#p/asriel2}{#f/5}* 都這樣了，回溯時間幹嘛呢？"
               ],
               [">{#p/asriel2}{#f/7}* ...你逗我呢？"],
               [">{#p/asriel2}{#f/7}* ..."]
         ...
         respawnWitnessA: () =>
            [
               [">{#p/asriel2}{#f/9}* 怎麼回事？", ">{#p/asriel2}{#f/10}* ...誰攻擊了我們？"],
               [">{#p/asriel2}{#f/15}* 我們...", ">{#p/asriel2}{#f/10}* ...被一道電魔法擊中了？"],
               [
                  ">{#p/asriel2}{#f/3}* Alphys。\n* 肯定是她。",
                  ">{#p/asriel2}{#f/15}* 她原來沒逃跑嗎...",
                  ">{#p/asriel2}{#f/16}* 好吧，還算有點意思。"
               ]
            ][SAVE.flag.n.ga_asrielWitness++],
         respawnWitnessB: (wit: number) =>
            wit > 0
               ? [
                  ">{#p/asriel2}{#f/15}* 原來是Alphys...",
                  ">{#p/asriel2}{#f/16}* 好吧，還算有點意思。"
               ]
               : [
                  ">{#p/asriel2}{#f/15}* 她原來沒逃跑嗎...",
      ...
      overworld: {
         ...
         toomuch1: [">{#p/human}* （你帶的東西太多了。）"],
         toomuch2: [">{#p/human}* （你帶的東西太多，裝不下它了。）"],
   ...
   b_opponent_alphys: {
      ...
      name: "* Alphys",
      gotcha: [">{*}{#p/alphys}{#e/alphys/19}逮著你倆了。{^30}{%}"],
      ...
      status1r: [">{#p/asriel2}* 你知道該幹什麼。"],
      status1b: [">{#p/asriel2}* 她原來沒逃跑嗎...\n* 有意思。"],
      status1c: [">{#p/asriel2}* 你知道該幹什麼吧。"],
      status1d: [">{#p/asriel2}* 嗯...\n  她是不是看起來有點累了？"],
      status2a: [">{#p/asriel2}* Alphys，怎麼了？\n* 撐不住了？"],
      status2r1: [">{#p/asriel2}* Ugh, here we go..."],
      status2b: [">{#p/asriel2}* Go on, tell us your sob story."],
      status2c: [">{#p/asriel2}* 你竟然沒貫徹逃跑精神，\n  我可真驚訝呢。"],
      status2d: [">{#p/asriel2}* Thanks, Dr. Obvious."],
      status2e: [">{#p/asriel2}* ...？"],
      status2r2: [">{#p/asriel2}* Something's about to happen."],
      status3a: [">{#p/asriel2}* 好吧... 形勢嚴峻起來了。"],
      status3b: [">{#p/asriel2}* ...看來Alphys不準備防禦了。\n* 抓住這個機會！"],
      status3c: [">{#p/asriel2}* Hang in there, $(name)..."],
      turnTalk1a: [
         ">{#p/alphys}{#e/alphys/19}要是連一擊都扛不住，\n我怎麼可能來這？",
         ">{#p/alphys}{#e/alphys/23}看來我高估\n你們的智商了。"
      ],
      turnTalk1b: [
         ">{#p/alphys}{#e/alphys/19}無話可說了？",
         ">{#e/alphys/18}...那就我管我說，你們聽著吧。"
      ],
      turnTalk1c: [
         ">{#p/alphys}{#e/alphys/19}這就對了。\nAlphys。",
         ">{#e/alphys/18}因為，\n你有多少能耐，\n有多大的潛能...",
         ">{#e/alphys/19}只有你自己才清楚。"
      ],
      turnTalk1d: [
         ">{#p/alphys}{#e/alphys/19}儘管揮霍你那些\n珍貴的物品。",
         ">{#e/alphys/18}就那些東西，唬不到我。"
      ],
      turnTalk2: [
         ">{#p/alphys}{#e/alphys/19}...聽著。\n我研究人類文化很多年了。",
         ">{#e/alphys/19}你會選擇戰鬥到死，\n我一點也不奇怪。"
      ],
      turnTalk3: [
      ...
      turnTalk4: [
         ">{#p/alphys}{#e/alphys/51}或者說，\n你怕自己死了後，\n人類發現有沒有你都一樣。",
         ">{#e/alphys/17}喔。\n這還挺有詩意的。"
      ],
      turnTalk5: [
         ">{#p/alphys}{#e/alphys/16}就你找人類求安慰這事，\n我可沒責怪你的意思。",
         ">{#e/alphys/52}只是我可以\n用親身經歷告訴你...",
         ">{#e/alphys/19}隨著你在意的人死去，\n你會再次失去依靠。"
      ],
      turnTalk6: [
         ">{#p/alphys}{#e/alphys/23}但你倆不會懂的，\n對吧？",
         ">{#e/alphys/19}你們兩個罪惡滔天，\n又沒人攔得住你們，\n怎麼可能親身體會\n我們的痛苦呢？",
         ">{#e/alphys/22}沒說錯吧？"
      ],
      turnTalk7: [
         ">{#p/alphys}{#e/alphys/19}不是說我不關心這事。",
         ">{#e/alphys/52}...從那時算，\n有一陣子了，\n這一直是我的心結...",
         ">{#e/alphys/51}之前，\n我真覺得我能幫你。"
      ],
      turnTalk8: [
         ">{#p/alphys}{#e/alphys/52}畢竟是我讓那顆星星\n睜開了眼睛...",
         ">{#e/alphys/51}我覺得自己有辦法勸勸你。"
      ],
      turnTalk9: [
         ">{#p/alphys}{#e/alphys/19}...不過現在，\n我懂你們為什麼執迷不悟了。",
         ">{#e/alphys/18}我沒想錯的話，\n你們中肯定有人\n擁有那股力量...",
         ">{#e/alphys/19}那股可以回溯時間，\n逆天改命的力量..."
      ],
      turnTalk10: [
         ">{#p/alphys}{#f/alphys/18}果真如此的話，\n那其他人真得小心了。",
         ">{#e/alphys/23}一個人如果可以隨心所欲，\n還不用付出代價的話，\n那他就不太會\n在乎別人的感受。"
      ],
      turnTalk11: [">{#z1}{#p/alphys}{#e/alphys/21}...", ">{#e/alphys/39}給我會時間靜靜。"],
      broken: [">{*}{#p/alphys}{#e/alphys/45}謝謝了。{^20}{%}"],
      turnTalk12: [
         ">{#z2}{#p/alphys}{#e/alphys/7}Undyne犧牲後，\n我不知道自己能做什麼。",
         ">{#e/alphys/46}於是，我逃跑了。"
      ],
      turnTalk13: [
         ">{#p/alphys}{#e/alphys/47}可是越逃跑，\n我就對自己越失望。",
         ">{#e/alphys/48}難道我就這麼袖手旁觀，\n眼睜睜看著我族人民\n接連死去？"
      ],
      turnTalk14: [
         ">{#p/alphys}{#e/alphys/21}...這未免太絕情了。",
         ">{#e/alphys/39}更何況...",
         ">{#e/alphys/45}我怎麼自責\n都沒法改變現狀。"
      ],
      turnTalk15: [
         ">{#p/alphys}{#e/alphys/39}Undyne說你們會\n殺死這星河中的每個人...",
         ">{#e/alphys/40}但其實比她想的更糟吧？"
      ],
      turnTalk16: [
         ">{#z3}{#p/alphys}{#e/alphys/48}...",
         ">{#e/alphys/47}復活你們中的某人\n可能是我的過失，\n但你們犯下的罪行\n可不是。",
         ">{#e/alphys/38}我管你們打的什麼算盤，\n你們都得付出代價。",
         ">{*}{#z4}{#e/alphys/54}哪怕與此同時...{^10}{%}",
         ">{*}{#e/alphys/25}我會喪失理智！{^10}{%}"
      ],
      turnTalk17: [">{#p/alphys}{#e/alphys/25}接招！！"],
      turnTalk18: [">{#p/alphys}{#e/alphys/25}再嘗嘗這招！！"],
      turnTalk19: [">{#p/alphys}{#e/alphys/25}這招又如何！！"],
      ...
      done0: (b: boolean) =>
         b
            ? [">{*}{#p/alphys}{#e/alphys/42}不...{^40}{%}", ">{*}{#e/alphys/43}怎麼這麼快我就...{^40}{%}"]
            : [">{*}{#p/alphys}{#e/alphys/42}不...{^40}{%}", ">{*}{#e/alphys/43}你們...{^40}{%}"],
      done1: (b: boolean) =>
         b
            ? [">{*}沒-沒想到你們這麼強...{^40}{%}", ">{*}現在，我明白了，\n與你們為敵...{^40}{%}"]
            : [">{*}我要死在這了...\n是-是嗎？{^40}{%}", ">{*}盡了全力，我還是...{^40}{%}"],
      done2: (b: boolean) =>
         b ? [">{*}{#p/alphys}我毫無勝算。{^40}{%}"] : [">{*}{#p/alphys}Asgore，我對不起你。{^40}{%}"]
   },
   b_opponent_archive1: {
   ...
   b_opponent_asriel: {
      ...
      act_check: () =>
         SAVE.data.b.oops
            ...
            : [">{#p/story}* ASRIEL DREEMURR 攻擊{^2}\u221e{^1} 防禦{^2}\u221e{^1}\n* ..."],
      act_hope: [
      ...
      attackTalk1: [
         ">{*}{#p/asriel3}{#e/asriel/1}你... 怎麼可能...",
         ">{*}{#p/asriel3}{#e/asriel/3}...",
         ">{*}{#p/asriel3}{#e/asriel/2}呵呵呵... 以為自己很強\n強到可以超越神明，\n是嗎？",
         ">{*}{#p/asriel3}{#e/asriel/0}那，就來看看你\n能不能受得了這個！"
      ],
      attackTalk2: [
         ">{*}{#p/asriel3}{#e/asriel/3}...",
         ">{*}{#p/asriel3}{#e/asriel/1}以為區區這樣\n就能傷得了我？",
         ">{*}{#p/asriel3}{#e/asriel/0}我才是這裡的主宰！"
      ],
      attackTalk3: [
         ">{*}{#p/asriel3}{#e/asriel/2}...而且，\n就算你能打敗我...",
         ">{*}{#p/asriel3}{#e/asriel/3}你的朋友\n也會因你而死。",
         ">{*}{#p/asriel3}{#e/asriel/1}這就是你想要的嗎？\n永遠孤身一人？"
      ],
      attackTalk4: [
         ">{*}{#p/asriel3}{#e/asriel/3}快住手，$(name)...\n你這是在自殺！",
         ">{*}{#p/asriel3}{#e/asriel/5}沒明白嗎？",
         ">{*}{#p/asriel3}{#e/asriel/6}我認識的$(name)\n絕不會做這種蠢事！"
      ],
      attackTalk5: [
         ">{*}{#p/asriel3}{#e/asriel/4}...",
         ">{*}{#p/asriel3}{#e/asriel/6}聽我說，$(name)。",
         ">{*}{#p/asriel3}{#e/asriel/6}現在趕快住手。",
         ">{*}{#p/asriel3}{#e/asriel/9}否則...",
         ">{*}{#p/asriel3}{#e/asriel/7}你-你別逼我動真格！"
      ],
      attackTalk6: [
         ">{*}{#p/asriel3}{#e/asriel/9}$(name)，求求你...",
         ">{*}{#p/asriel3}{#e/asriel/7}你還沒明白\n自己在做什麼嗎？",
         ">{*}{#p/asriel3}{#e/asriel/8}It's not JUST that I want you to stop fighting me.",
         ">{*}{#p/asriel3}{#e/asriel/8}更重要的是...\n如果我被你打敗了...",
         ">{*}{#p/asriel3}{#e/asriel/7}我永遠，永遠\n都當不了你的對手了。",
         ">{*}{#p/asriel3}{#e/asriel/9}永遠也不會\n得到你的尊重！",
         ">{*}{#p/asriel3}{#e/asriel/10}{#i/3}{@random=1.1/1.1}該死，$(name)...\n你他媽的為什麼總要贏？"
      ],
