...
export default {
   a_citadel: {
      ...
      genotext: {
         ...
         afterfight1: [">{#p/asriel2}{#f/8}* ... finally."],
         afterfight2: () =>
            [
               [
         ...
         respawn6: () =>
            [
               [
                  ">{#p/asriel2}{#f/15}* $(name).\n* Listen to me.",
                  ">{#p/asriel2}{#f/7}* We literally HAD her.",
                  ">{#p/asriel2}{#f/5}* Why would you bring us back after that!?"
               ],
               [">{#p/asriel2}{#f/7}* ... you can't be serious right now."],
               [">{#p/asriel2}{#f/7}* ..."]
         ...
         respawnWitnessA: () =>
            [
               [">{#p/asriel2}{#f/9}* What was THAT?", ">{#p/asriel2}{#f/10}* ... WHO was that?"],
               [">{#p/asriel2}{#f/15}* We got hit with...", ">{#p/asriel2}{#f/10}* ... electricity magic?"],
               [
                  ">{#p/asriel2}{#f/3}* Alphys.\n* It's gotta be.",
                  ">{#p/asriel2}{#f/15}* So she didn't run away, then...",
                  ">{#p/asriel2}{#f/16}* Well, this should be interesting."
               ]
            ][SAVE.flag.n.ga_asrielWitness++],
         respawnWitnessB: (wit: number) =>
            wit > 0
               ? [
                  ">{#p/asriel2}{#f/15}* So it was Alphys, then...",
                  ">{#p/asriel2}{#f/16}* Well, this should be interesting."
               ]
               : [
                  ">{#p/asriel2}{#f/15}* So she didn't run away, then...",
         ...
         sad3: () =>
            world.runaway
               ? [
                  ...
                  ">{#f/22}* ... just the fact I'm still alive is probably less than I deserve.",
      ...
      overworld: {
         ...
         giftbox2a: () => [
            ">{#p/human}* (You got the Big Dipper.)",
         ...
         giftbox3: () =>
            SAVE.data.b.svr
               ...
               : [">{#p/basic}* It's empty."],
         giftbox4: [">{#p/human}* (You decide not to open.)"],
         tea0: () =>
            SAVE.data.b.svr
         ...
         tea1: [">{#p/human}* (You got the Starling Tea.)"],
         tea2: () =>
            SAVE.data.b.svr
         ...
         fridgetrap3: [">{#p/human}* (You decide not to take anything.)"],
         ...
         toomuch1: [">{#p/human}* (You're carrying too much.)"],
         toomuch2: [">{#p/human}* (You're carrying too much to take that.)"],
   ...
   b_opponent_alphys: {
      ...
      name: "* Alphys",
      gotcha: [">{*}{#p/alphys}{#e/alphys/19}Gotcha.{^30}{%}"],
      ...
      epiphaNOPE: [">{#p/alphys}{#e/alphys/19}Nice try."],
      statusX: [">{#p/asriel2}* ..."],
      statusY: [">{#p/asriel2}* She's almost dead!\n* Keep going!"],
      status1a: [">{#p/asriel2}* Alphys..."],
      status1r: [">{#p/asriel2}* You know what to do."],
      status1b: [">{#p/asriel2}* So she didn't run away, then...\n* Interesting."],
      status1c: [">{#p/asriel2}* Well, you know what to do."],
      status1d: [">{#p/asriel2}* Hmm... don't you think she looks tired?"],
      status2a: [">{#p/asriel2}* What's the matter, Alphys?\n* Can't keep up?"],
      status2r1: [">{#p/asriel2}* Ugh, here we go..."],
      status2b: [">{#p/asriel2}* Go on, tell us your sob story."],
      status2c: [">{#p/asriel2}* I'm surprised you're not still doing that right now."],
      status2d: [">{#p/asriel2}* Thanks, Dr. Obvious."],
      status2e: [">{#p/asriel2}* ...?"],
      status2r2: [">{#p/asriel2}* Something's about to happen."],
      status3a: [">{#p/asriel2}* Okay... things are starting to get serious now."],
      status3b: [">{#p/asriel2}* ... it looks like Alphys isn't trying to defend anymore.\n* Now's our chance!"],
      status3c: [">{#p/asriel2}* Hang in there, $(name)..."],
      turnTalk1a: [
         ">{#p/alphys}{#e/alphys/19}Did you think I'd fight you if I didn't know how to take a hit?",
         ">{#p/alphys}{#e/alphys/23}You must not be as smart as I thought."
      ],
      turnTalk1b: [
         ">{#p/alphys}{#e/alphys/19}Nothing to say?",
         ">{#e/alphys/18}... guess I'll be the one doing the talking, then."
      ],
      turnTalk1c: [
         ">{#p/alphys}{#e/alphys/19}That's right.\nAlphys.",
         ">{#e/alphys/18}Because nobody else sees things like I do.",
         ">{#e/alphys/19}Nobody else knows how dangerous you really are."
      ],
      turnTalk1d: [
         ">{#p/alphys}{#e/alphys/19}Use your precious ITEMs all you want.",
         ">{#e/alphys/18}It won't change what happens next."
      ],
      turnTalk2: [
         ">{#p/alphys}{#e/alphys/19}... look.\nI've studied human culture for years.",
         ">{#e/alphys/19}I'm not surprised you're the one doing all the fighting."
      ],
      turnTalk3: [
         ">{#p/alphys}{#e/alphys/18}But you, Asriel...\nYou use your human partner as a shield.",
         ">{#e/alphys/52}What's the matter?\nAfraid your stolen SOUL won't survive on its own?"
      ],
      turnTalk4: [
         ">{#p/alphys}{#e/alphys/51}Or maybe you're just afraid they'll go on without you if you die.",
         ">{#e/alphys/17}Well.\nTHAT'd be poetic."
      ],
      turnTalk5: [
         ">{#p/alphys}{#e/alphys/16}Not that I blame you for finding comfort in a human partner.",
         ">{#e/alphys/52}I can tell you from experience...",
         ">{#e/alphys/19}Things get lonely after everyone you care about is dead."
      ],
      turnTalk6: [
         ">{#p/alphys}{#e/alphys/23}But you two wouldn't know anything about THAT, right?",
         ">{#e/alphys/19}You're so menacing and unstoppable, you couldn't POSSIBLY be in pain yourselves.",
         ">{#e/alphys/22}Right?"
      ],
      turnTalk7: [
         ">{#p/alphys}{#e/alphys/19}Whatever.\nNot like I give a damn now anyway.",
         ">{#e/alphys/52}... which is a shame, since, for a while there...",
         ">{#e/alphys/51}I actually believed I could fix this."
      ],
      turnTalk8: [
         ">{#p/alphys}{#e/alphys/52}I thought that because I was the one who gave that star life...",
         ">{#e/alphys/51}I'd somehow be able to reason with you."
      ],
      turnTalk9: [
         ">{#p/alphys}{#e/alphys/19}... but I understand the truth, now.",
         ">{#e/alphys/18}That power...\nThe power to turn back time, to change fate...",
         ">{#e/alphys/19}Would I be wrong to assume that one of you has it?"
      ],
      turnTalk10: [
         ">{#p/alphys}{#f/alphys/18}If that's the case, then whoever DOESN'T have it should be careful.",
         ">{#e/alphys/23}People don't tend to care much for others when they can do whatever they want without consequences."
      ],
      turnTalk11: [">{#z1}{#p/alphys}{#e/alphys/21}...", ">{#e/alphys/39}I need a moment."],
      broken: [">{*}{#p/alphys}{#e/alphys/45}Thanks.{^20}{%}"],
      turnTalk12: [
         ">{#z2}{#p/alphys}{#e/alphys/7}After Undyne died, I didn't know what to do.",
         ">{#e/alphys/46}So I ran as fast and as far as I could."
      ],
      turnTalk13: [
         ">{#p/alphys}{#e/alphys/47}The more I ran, the more frustrated I became with myself.",
         ">{#e/alphys/48}How could I stand by and do NOTHING as I watched them die?"
      ],
      turnTalk14: [
         ">{#p/alphys}{#e/alphys/21}... it was all just a little too much.",
         ">{#e/alphys/39}Still, no matter how terrible I felt...",
         ">{#e/alphys/45}The reality of what had happened stayed the same."
      ],
      turnTalk15: [
         ">{#p/alphys}{#e/alphys/39}Undyne said you'd go on to kill everyone in the galaxy...",
         ">{#e/alphys/40}But it's worse than that, isn't it?"
      ],
      turnTalk16: [
         ">{#z3}{#p/alphys}{#e/alphys/48}...",
         ">{#e/alphys/47}I may have brought one of you back to life, but I'm not to blame for everything you've done.",
         ">{#e/alphys/38}Whatever it is you're planning, I won't let you get away with it.",
         ">{*}{#z4}{#e/alphys/54}Even if it means...!{^10}{%}",
         ">{*}{#e/alphys/25}Losing my sanity in the process!{^10}{%}"
      ],
      turnTalk17: [">{#p/alphys}{#e/alphys/25}Take THIS!!"],
      turnTalk18: [">{#p/alphys}{#e/alphys/25}Or THIS!!"],
      turnTalk19: [">{#p/alphys}{#e/alphys/25}How about THIS!!"],
      turnTalk20: [">{#p/alphys}{#e/alphys/24}Hahaha..."],
      turnTalk21: [">{#p/alphys}{#e/alphys/26}..."],
      turnTalk22: [">{#p/alphys}{#e/alphys/27}Come ON!!"],
      turnTalk23: [">{#p/alphys}{#e/alphys/27}..."],
      done0: (b: boolean) =>
         b
            ? [">{*}{#p/alphys}{#e/alphys/42}No...{^40}{%}", ">{*}{#e/alphys/43}How am I already...{^40}{%}"]
            : [">{*}{#p/alphys}{#e/alphys/42}No...{^40}{%}", ">{*}{#e/alphys/43}How did you...{^40}{%}"],
      done1: (b: boolean) =>
         b
            ? [">{*}I d-didn't think you'd be this strong...{^40}{%}", ">{*}But now, I realize...{^40}{%}"]
            : [">{*}I'm going to die here... a-aren't I?{^40}{%}", ">{*}After everything...{^40}{%}"],
      done2: (b: boolean) =>
         b ? [">{*}{#p/alphys}I never had a chance.{^40}{%}"] : [">{*}{#p/alphys}I'm sorry, Asgore.{^40}{%}"]
   },
   b_opponent_archive1: {
   ...
   b_opponent_asriel: {
      ...
      confrontation: [
         ">{#p/human}* (After bullying so many monsters, all throughout your journey...)",
         ">* (Something dormant, buried far, far down, awakens once again.)",
         ">* (A sense of fear within every monster on the outpost, instilled by humans long ago.)",
         ">* (The enemy who now stands before you has no right to be afraid of you...)",
         ">* (Yet, somehow, the combined fear of all those you've bullied...)",
         ">* (Has given you an opening you have no right to refuse.)",
         ">* (... there's only one option that makes sense to you now.)",
         ">* (There's only one thing left for you to do.)"
      ],
      attackTalk1: [
         ">{*}{#p/asriel3}{#e/asriel/1}Wh... how did you...",
         ">{*}{#p/asriel3}{#e/asriel/3}...",
         ">{*}{#p/asriel3}{#e/asriel/2}Heheheh... you think you're strong enough to overpower a god?",
         ">{*}{#p/asriel3}{#e/asriel/0}Well, let's see how you like THIS!"
      ],
      attackTalk2: [
         ">{*}{#p/asriel3}{#e/asriel/3}...",
         ">{*}{#p/asriel3}{#e/asriel/1}If you think that's gonna hurt me, you're wrong.",
         ">{*}{#p/asriel3}{#e/asriel/0}I'm still the one in control here!"
      ],
      attackTalk3: [
         ">{*}{#p/asriel3}{#e/asriel/2}... even if you COULD beat me...",
         ">{*}{#p/asriel3}{#e/asriel/3}In doing so, you'd kill your friends, too.",
         ">{*}{#p/asriel3}{#e/asriel/1}Is that what you want?\nTo be ALONE?"
      ],
      attackTalk4: [
         ">{*}{#p/asriel3}{#e/asriel/3}Come on, $(name)...\nThis is SUICIDE!",
         ">{*}{#p/asriel3}{#e/asriel/5}Don't you see that!?",
         ">{*}{#p/asriel3}{#e/asriel/6}The $(name) I know would never do something so STUPID!"
      ],
      attackTalk5: [
         ">{*}{#p/asriel3}{#e/asriel/4}...",
         ">{*}{#p/asriel3}{#e/asriel/6}Listen to me, $(name).",
         ">{*}{#p/asriel3}{#e/asriel/6}You have to stop what you're doing.",
         ">{*}{#p/asriel3}{#e/asriel/9}If you don't, I...",
         ">{*}{#p/asriel3}{#e/asriel/7}I-I'll be forced to do something even worse!"
      ],
      attackTalk6: [
         ">{*}{#p/asriel3}{#e/asriel/9}$(name), please...",
         ">{*}{#p/asriel3}{#e/asriel/7}You don't know what you're doing, okay?",
         ">{*}{#p/asriel3}{#e/asriel/8}It's not JUST that I want you to stop fighting me.",
         ">{*}{#p/asriel3}{#e/asriel/8}It's just that... if I let you beat me...",
         ">{*}{#p/asriel3}{#e/asriel/7}I wouldn't be your equal anymore.",
         ">{*}{#p/asriel3}{#e/asriel/9}I wouldn't be worthy of your respect!",
         ">{*}{#p/asriel3}{#e/asriel/10}{#i/3}{@random=1.1/1.1}Damn you, $(name)...\nWhy do you ALWAYS have to WIN!?"
      ],
      attackTalk7: [">{*}{#p/asriel3}{#e/asriel/11}{#i/4}..."],
      attackTalk7x: [">{*}{#p/asriel3}{#e/asriel/11}{#i/4}$(name), I..."],
      mercy_save2: [
      ...
      endTalk4: [">{*}{#p/asriel3}{#e/asriel/11}{#i/4}$(name), I..."],
   ...
   i_archive_rations: {
      ...
      info: [">{#p/human}* (5 HP.)"],
      name: "Rations",
      use: [">{#p/human}* (You eat the Rations.)"]
   },
   i_archive_tzn: {
      ...
      info: [">{#p/human}* (6 HP.)"],
      name: "Space Tofu",
      use: [">{#p/human}* (You ingest the Space Tofu.)"]
   },
   ...
   i_archive_healpak: {
      ...
      drop: [">{#p/human}* (You throw away the Heal-pak.)"],
      info: [">{#p/human}* (8 HP.)"],
      name: "Heal-pak",
      use: [">{#p/human}* (You use the Heal-pak.)"]
   },
   i_big_dipper: {
      battle: {
      ...
      drop: [">{#p/human}* (You throw away the Big Dipper.)"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* (15 AT.)"]
            : [">{#p/basic}* \"Big Dipper\" (15 AT)\n* A whacking spoon made with the finest alloy in the galaxy."],
      name: "Big Dipper",
      use: [">{#p/human}* (You equip the Big Dipper.)"]
   },
   i_heart_locket: {
      battle: {
      ...
      drop: () => [
         ">{#p/human}* (You threw away the Heart Locket.)",
         ...(SAVE.data.b.svr || world.darker || SAVE.data.b.ufokinwotm8
            ? []
            : [">{#p/basic}* ...", ">{#p/basic}* I'm going to pretend you didn't just do that."])
      ],
      info: () =>
         SAVE.data.b.svr
            ? [">{#p/human}* (15 DF.)"]
            : [">{#p/basic}* \"Heart Locket\" (15 DF)\n* It says \"Best Friends Forever.\""],
      name: "Heart Locket",
      use: [">{#p/human}* (You equip the Heart Locket.)"]
   },
   i_starling_tea: {
      battle: {
      ...
      drop: [">{#p/human}* (You throw away the Starling Tea.)"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [">{#p/human}* (99 HP.)"]
            : [">{#p/basic}* \"Starling Tea\" Heals 99 HP\n* A fine tea worthy of a king."],
      name: "Starling Tea",
      use: [">{#p/human}* (You drank the Starling Tea.)"]
   },
