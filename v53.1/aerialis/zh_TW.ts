   ...
   a_aerialis: {
      ...
      story: {
         ...
         barricade3b2: [
            ...
            '<25>{#g/alphysNeutralSweat}* 還是說你正打算\n  這麼做！？',
            '<25>{#g/alphysNeutralSweat}* ...',
         ...
         cooker4a: [ '<32>{#p/mettaton}* 好極了！', '<32>* 現在，請允許我...' ],
         cooker4b: [ '<32>{#p/mettaton}* 好的！', "<32>* 我們要用這些東西..." ],
         cooker5: () =>
            iFancyYourVilliany()
         ...
         cooker8b: () =>
            iFancyYourVilliany()
               ...
               : [
                    "<32>* 然後，為了增加緊張感，\n  你需要在{@fill=#ff0}九十秒{@fill=#fff}內跨越這條鴻溝..."
                 ],
         cooker9: () =>
            iFancyYourVilliany()
               ? [
               ...
               SAVE.data.n.state_foundry_muffet === 1 && SAVE.data.b.colleg
                  ? [
                       iFancyYourVilliany()
                          ...
                          : '<32>{#p/mettaton}* TEMMIE，由於你比人類早猜中...',
                       "<32>{#p/mettaton}* 恭喜!\n* 你贏得了屬於你自己的\n  老式地球收音機！",
                       '<32>{#p/tem}* 嗚哇喔哇喔哇喔.....'
                    ]
                  : [
                       iFancyYourVilliany()
                          ...
                          : '<32>{#p/mettaton}* BLOOKY，由於你比人類早猜中...',
                       "<32>{#p/mettaton}* 恭喜!\n* 你贏得了屬於你自己的\n  老式地球收音機！",
                       world.scared_ghost ? '<32>{#p/napstablook}* 酷' : '<32>{#p/napstablook}* 唔唔唔唔唔唔唔'
                    ],
            g: () => [
               SAVE.data.n.state_foundry_muffet === 1 && SAVE.data.b.colleg
                  ? iFancyYourVilliany()
                     ...
                     : '<32>{#p/mettaton}* 人類，由於你比TEMMIE早猜中...'
                  : iFancyYourVilliany()
                  ? '<32>{#p/mettaton}* WELL PLAYED, $(moniker3u).\n* SINCE YOU GUESSED BEFORE BLOOKY...'
                  : '<32>{#p/mettaton}* 人類，由於你比BLOOKY早猜中...',
               "<32>{#p/mettaton}* 恭喜!\n* 你贏得了屬於你自己的\n  老式地球收音機！"
            ]
         },
         moneyVote1: () => [
         ...
         moneyVote2a: () =>
            iRespeccYourVilliany()
               ...
               : world.dead_skeleton
               ? [ "<32>{#p/mettaton}* WELL, THAT'S ONE VOTE GONE.", '<32>{#p/mettaton}* BLOOKY，你想票掉誰呢？' ]
               : [
                    '<32>{#p/mettaton}* 嗯...',
                    '<32>* WHY \"ANNE?\"',
