...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         e5: [
            "<25>{#p/asriel1}{#f/13}* ... $(name)...\n* Eğer hâlâ oradaysan, dinliyorsan...",
      ...
      dummy1: [
         '<25>{#p/toriel}{#f/0}* Bir sonraki dersin diğer canavarlara karşılaşmayı içeriyor.',
         ...
         '<25>{#f/0}* ... böylece senin adına çatışmayı çözebilmem için bana fırsat verirsin.'
      ],
      ...
      dummy10: [
         ...
         '<25>{#f/0}* Her hâlükârda, bu dersi takdire şayan bir şekilde hallettin.',
      ...
      dummy12: [
         ...
         '<25>{#f/1}* Ancak gelecekte, akıllı olacak şey...',
         '<25>{#f/0}* ... başkalarını neredeyse öldürene kadar vurmamak olacaktır!',
      ...
      front1: [
         ...
         '<25>{#f/0}* Pekâlâ, ne yapabileceğime bir bakacağım.'
      ],
         ...
         ...(world.postnoot
            ? [
                 ...
                 world.nootflags.has('toriel') // NO-TRANSLATE
                    ...
                    ? '<25>{#f/1}* Atmosferik sistem hâlâ düzelmiş görünmüyor.'
      ...
      front4: () => [
         ...
         '<25>{#f/0}* Her hâlükârda, bana ihtiyacın olursa oturma odasında olacağım.'
      ],
      ...
      indie1b: () => [
         ...
         '<32>{#p/basic}* Eğer burada fikrini değiştirmeyi reddedersen, Toriel seni eve götürmeye karar verebilir.',
         choicer.create('* (Fikrini değiştirecek misin?)', 'Evet', 'Hayır')
      ],
      indie2a: [ '<25>{#p/toriel}{#f/1}* Pekâlâ...', '<25>{#f/0}* Bol şans!' ],
      ...
      indie4: () => [
         ...
         '<25>{#f/5}* Yapmam gereken önemli günlük işler var.',
         '<25>{#f/0}* Ben yokken, senden en iyi tutumunu korumanı bekliyorum.',
         '<25>{#f/1}* İlerideki bulmacaların açıklanacak yönleri var, ve...',
      ...
      plot_call: {
         ...
         b: () => [
            ...
            '<25>{#f/1}* Tabağında bulunuyor olsa yine de memnun olur muydun?',
            choicer.create('* (Ne diyeceksin?)', 'Evet', 'Hayır')
         ],
         b1: () => [
            3 <= SAVE.data.n.cell_insult
         ...
         c: [
            ...
            '<25>{#f/5}* ...',
            '<25>{#f/5}* Sanıyorum ki insanların canavar yiyeceklerine alerjisi olamaz bile.',
         ...
         d: [
            ...
            '<25>{#f/1}* Muhtemelen etrafa saçılmış bir sürü şey var...',
      ...
      return6: [
         '<25>{#p/toriel}{#f/1}* Pekâlâ, gidip turtaya bir bakmam lazım.',
      ...
      twinkly20: [
         ...
         '<20>Ben {@fill=#003cff}TORİEL{@fill=#000}, {@fill=#f00}OUTLANDS\'in{@fill=#000} idarecisiyim.',
         '<20>Her gün buraya uğrayıp kaza yapmış biri var mı diye kontrol ederim.',
