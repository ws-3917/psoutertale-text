...
export default {
   a_aerialis: {
      ...
      tvm2: [ '<32>{#p/human}* （你获得了一些烟花。）', '<32>{#p/basic}{#npc/a}* Hope you enjoy the fireworks!' ],
      ...
      story: {
         ...
         barricade3: () => [
            ...
            choicer.create('* （你要怎么回答？）', 'Model 42', 'Hapstablook', 'Aidrian', 'Mettaton') 
         ],
         barricade3b1: [
      ...
      elevator1: () => [
         choicer.create('* (Where would you like to go?)', 'Cancel', 'CORE Start', 'CORE End', '首塔')
      ],
      elevatorStory1: () => [ choicer.create('* (Where would you like to go?)', 'CORE Start', 'Cancel') ],
      elevator2: () => [
         choicer.create('* (Where would you like to go?)', 'Aerialis', 'Cancel', 'CORE End', '首塔')
      ],
      elevatorStory2: () => [ choicer.create('* (Where would you like to go?)', 'Aerialis', 'Cancel') ],
      elevator3: () => [
         choicer.create('* (Where would you like to go?)', 'Aerialis', 'CORE Start', 'Cancel', '首塔')
      ],
      elevatorStory3: () => [ choicer.create('* (Where would you like to go?)', '首塔', 'Cancel') ],
      elevator4: () => [
   ...
   b_group_aerialis: {
      ...
      rg: () => (world.goatbro ? [ '<32>{#p/asriel2}* 1号和2号守卫。' ] : [ '<32>{#p/story}* The Royal Guard attacks!' ]),
      spacetopTsundere: () =>
   ...
   b_opponent_rg01: {
      name: () => (world.bad_lizard > 1 ? '* 1号守卫' : '* 3号守卫'),
      epiphaNOPE: () =>
         world.bad_lizard > 1
   ...
   b_opponent_rg02: {
      name: () => (world.bad_lizard > 1 ? '* 2号守卫' : '* 4号守卫'),
      epiphaNOPE: () =>
         world.bad_lizard > 1
   ...
   i_old_gun: {
      ...
      use: () =>
         battler.active
            ? []
            : [ '<32>{#p/human}* (You took out the Stun Gun.)', '<32>{#p/human}* （战斗外使用无效。）' ]
   },
   i_old_bomb: {
      battle: {
         description: '无害的一次性武器。',
      ...
      use: () =>
         battler.active
            ? []
            : [ '<32>{#p/human}* (You took out the Sleep Bomb.)', '<32>{#p/human}* （战斗外使用无效。）' ]
   },
   i_old_spray: {
      battle: {
         description: '无害的一次性武器。',
      ...
      use: () =>
         battler.active
            ? []
            : [ '<32>{#p/human}* (You took out the Sugar Spray.)', '<32>{#p/human}* （战斗外使用无效。）' ]
   },
   i_corndog: {
      battle: {
   ...
   m_aerialis: {
      sidebarCellPms1: () => (world.bad_lizard < 2 ? '帖子（按时间排序）' : '私聊（按时间排序）'),
