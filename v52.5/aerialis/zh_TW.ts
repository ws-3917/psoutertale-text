...
export default {
   a_aerialis: {
      ...
      tvm2: [ '<32>{#p/human}* （你獲得了一些煙花。）', '<32>{#p/basic}{#npc/a}* Hope you enjoy the fireworks!' ],
      ...
      story: {
         ...
         barricade2: () => [
            ...
            choicer.create('* （你要怎麼回答？）', 'MTT美妝', 'MTT烹飪', 'MTT科技', 'MTT電視臺')
         ],
         barricade2b1: [
         ...
         barricade3: () => [
            ...
            choicer.create('* （你要怎麼回答？）', 'Model 42', 'Hapstablook', 'Aidrian', 'Mettaton') 
         ],
         barricade3b1: [
         ...
         moneyVote2a: () =>
            iRespeccYourVilliany()
               ...
               : world.dead_skeleton
               ? [ "<32>{#p/mettaton}* WELL, THAT'S ONE VOTE GONE.", '<32>{#p/mettaton}* 小幽，你想票掉誰呢？' ]
               : [
                    '<32>{#p/mettaton}* HMM...',
                    '<32>* WHY \"ANNE?\"',
   ...
   b_group_aerialis: {
      ...
      rg: () => (world.goatbro ? [ '<32>{#p/asriel2}* 1號和2號守衛。' ] : [ '<32>{#p/story}* The Royal Guard attacks!' ]),
      spacetopTsundere: () =>
   ...
   b_opponent_rg01: {
      name: () => (world.bad_lizard > 1 ? '* 1號守衛' : '* 3號守衛'),
      epiphaNOPE: () =>
         world.bad_lizard > 1
   ...
   b_opponent_rg02: {
      name: () => (world.bad_lizard > 1 ? '* 2號守衛' : '* 4號守衛'),
      epiphaNOPE: () =>
         world.bad_lizard > 1
   ...
   i_old_gun: {
      ...
      use: () =>
         battler.active
            ? []
            : [ '<32>{#p/human}* (You took out the Stun Gun.)', '<32>{#p/human}* （戰鬥外使用無效。）' ]
   },
   i_old_bomb: {
      battle: {
         description: '無害的一次性武器。',
      ...
      use: () =>
         battler.active
            ? []
            : [ '<32>{#p/human}* (You took out the Sleep Bomb.)', '<32>{#p/human}* （戰鬥外使用無效。）' ]
   },
   i_old_spray: {
      battle: {
         description: '無害的一次性武器。',
      ...
      use: () =>
         battler.active
            ? []
            : [ '<32>{#p/human}* (You took out the Sugar Spray.)', '<32>{#p/human}* （戰鬥外使用無效。）' ]
   },
   i_corndog: {
      battle: {
