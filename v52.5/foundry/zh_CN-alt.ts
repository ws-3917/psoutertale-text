...
export default {
   a_foundry: {
      ...
      genotext: {
         ...
         bombshell3: [
            ...
            '<32>{*}{@random=1.1/1.1}{#i/8}* 啊... 天-天呐...'
         ],
         bombshell4: [ "<32>{*}{@random=1.1/1.1}{#i/10}* 是我害死了你们..." ],
         kidd1: [
   ...
   b_opponent_doge: {
      ...
      petTextEarly: [ "<32>{#p/human}* （你尝试抚摸Doge，\n  但你现在还够不到她。）" ],
      petTextGeno: [
         '<32>{#p/human}* （你想摸摸Doge。）',
   ...
   b_opponent_muffet: {
      ...
      appeaseTextPost: [ "<32>{#p/human}* （但玛菲特不需要被再次安抚。）" ],
