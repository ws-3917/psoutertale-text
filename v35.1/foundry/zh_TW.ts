...
export default {
   a_foundry: {
      ...
      spookydate11: [
         ...
         "<25>{#f/2}* 有些怪咖會把放屁墊\n  放在座位上。",
         "<25>{#f/0}* ... 那麼，來點餐吧。\n* 你呲點啥？",
         "<99>{#p/human}* （你要怎麼回答？）{!}\n§shift=64§烈焰\n§shift=64§Grillbys§shift=56§漢堡{#c/0/8/7}",
         "<26>{#p/sans}{#f/2}* 嘿，聽上去挺不錯。"
      ],
      spookydate12a: [ "<25>{#p/sans}* grillby，給我們來兩份\n  烈焰的你。" ],
      spookydate12b: [ "<25>{#p/sans}* grillby，給我們來兩份漢堡。" ],
      spookydate13: [
