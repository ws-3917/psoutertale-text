...
export default {
   a_starton: {
      ...
      nicecreamK1b: [ "<32>{#p/basic}* 可以啊，孩子。\n* 只要你有錢的話。" ],
      ...
      trivia: {
         ...
         lamppost: () =>
            SAVE.data.b.svr
               ...
               : [ "<32>{#p/basic}* 一盞{@fill=#ff0}彈{@fill=#fff}燈。" ],
         ntower: () =>
            SAVE.data.b.svr
               ? [
                    [
   ...
   b_opponent_papyrus: {
      ...
      idleTalkBullied: [ "<25>{#p/papyrus}{#f/27}..." ],
