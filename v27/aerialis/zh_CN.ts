         ...
         alphys10: () =>
            iFancyYourVilliany()
               ? [
                    ...
                    SAVE.data.n.state_foundry_undyne > 0
                       ? "<25>{#p/alphys}{#f/1}* M-mettaton, wait!!\n* What are you..."
         ...
         cooker12: () =>
            SAVE.data.n.state_foundry_undyne > 0
               ? [
                    ...
                    "<25>{#f/5}* So... that phone you took from the lab...",
                    "<25>{#f/6}* Has a one-time use portable jetpack.",
                    "<25>{#f/10}* Maybe... now would be a good time to try it??"
                 ]
               : [
                    "<32>{#p/event}* Ring, ring...",
      ...
      overworld: {
         ...
         platformDeny: () => [
            ...
            ...(world.goatbro
               ...
               ? [ "<32>* ... maybe you could find one in the lab somewhere?" ]
               : [])
         ],
         lift: {
            elevatorStory1: () =>
