...
export default {
   ...
   disclaimer: {
      title: "- 游戏声明 -",
      content: "1.PS!OUTERTALE是Spacey_432制作的游戏，\n  PSOT汉化组负责中文翻译（以及“三角旅者”的翻译），\n  汉化交流群群号：797416533(QQ)\n2.中文翻译已完成40.6%，如果发现未翻译的文本或对话，\n  请耐心等待。所有多语言翻译中，中文进度是最快的。\n  所以尽量不要反馈对话没有翻译的问题。\n3.一些常见问题（比如“怎么把语言改成中文？”、\n  “怎么下载？”、“怎么解压游戏？”），\n  建议先查阅“Q群管家”，常见问题答案都在那里。\n  汉化组需要花更多时间推进汉化，接受bug反馈。\n  所以过于基础的问题可能不会解答。\n4.如果对游戏比较失望，不想继续测试或游玩，\n  您可以选择删除游戏，而不要辱骂我们和作者。\n  汉化组和作者都付出了很多努力，希望能相互理解。\n\n再次感谢您对本游戏与汉化组的支持，10秒后自动进入游戏。"
   },
   footerX: 0,
   itemEquipX: 0,
   itemUseX: 0,
