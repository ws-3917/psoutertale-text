   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      ...
      f_chute: pager.create(
         ...
         () => [
            ...
            "<18>{#p/papyrus}{#f/0}一臺是關於星星的，\n一臺是關於蟲洞的。",
            "<18>{#p/papyrus}{#f/4}還有一臺裡是\n科幻動漫。",
            "<18>{#p/papyrus}{#f/0}我【個人】覺得，\n這些東西都是有關聯的。",
            "<18>{#p/papyrus}{#f/5}毫無疑問，星星是\n通過蟲洞來的...",
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                    ...
                    "<25>{#p/undyne}{#f/10}* Most in the Royal Guard don't take his successor seriously, so...",
