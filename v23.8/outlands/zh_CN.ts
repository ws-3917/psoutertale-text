...
const text = {
   a_outlands: {
      ...
      finaltext: {
         ...
         d10: [ "<25>{#p/asriel1}{#f/13}* 但是...", "<25>{#f/15}* 你是怎么..." ],
         d11: [
            "<32>{#p/basic}* ...那重要吗？",
            "<32>* 你忘记我是对的，就像曾经那样。",
            "<32>* 真相就是，我一直都是个坏人...",
         ...
         d15: [
            ...
            "<32>* 但Frisk不是。",
            "<32>* 无论面对什么困难，他总是会展示仁慈和饶恕。",
            "<32>* 他证明了...我是错的。",
            "<32>* 而现在，正因如此，\n  我知道我不能再为我曾经\n  对你做过的事找借口了。",
            "<32>* 你所经历的一切，你所失去的一切...",
            "<32>* 都怪我。"
         ],
         d16: [ "<25>{#p/asriel1}{#f/13}* $(name)...", "<25>{#f/15}* 你注意到了吗？" ],
         d17: [
            "<32>{#p/basic}* ...是的。\n* 我感觉我注意到了。",
            "<32>* 自从我们死后，\n  这就是我的存在，Asirel...",
            "<32>* 然后...我还得告诉你个事。"
         ...
         d19: [
            "<32>{#p/basic}* 还记得我们穿过力场的时候吗？",
            "<32>* 到达旧家园遗迹时，被那些人类发现了？",
            "<32>* 我想用我的力量毁灭他们...\n  但是你阻止了我，还记得吗？"
         ],
         d20: [ "<25>{#p/asriel1}{#f/16}* ...是的。" ],
         d21: [
            "<32>{#p/basic}* 我当时不理解，但是...",
            "<32>* 现在我理解了。",
            "<32>* ...你阻止我...是为了防止我犯下更严重的错误。"
         ],
         d22: [ "<25>{#p/asriel1}{#f/15}* $(name)..." ],
         d23: [
            "<32>{#p/basic}* 如果没有你，前哨战可能就会在第二次战争中毁灭。",
            "<32>* 如果没有你，我本该拯救的那些怪物...",
            "<32>* ...就得和我们陪葬了。"
         ],
