...
const text = {
   a_outlands: {
      ...
      finaltext: {
         ...
         d10: [ "<25>{#p/asriel1}{#f/13}* 但是...", "<25>{#f/15}* 你是怎麼..." ],
         d11: [
            "<32>{#p/basic}* ...那重要嗎？",
            "<32>* 你忘記我是對的，就像曾經那樣。",
            "<32>* 真相就是，我一直都是個壞人...",
         ...
         d15: [
            ...
            "<32>* 但Frisk不是。",
            "<32>* 無論面對什麼困難，他總是會展示仁慈和饒恕。",
            "<32>* 他證明了...我是錯的。",
            "<32>* 而現在，正因如此，\n  我知道我不能再爲我曾經\n  對你做過的事找藉口了。",
            "<32>* 你所經歷的一切，你所失去的一切...",
            "<32>* 都怪我。"
         ],
         d16: [ "<25>{#p/asriel1}{#f/13}* $(name)...", "<25>{#f/15}* 你注意到了嗎？" ],
         d17: [
            "<32>{#p/basic}* ...是的。\n* 我感覺我注意到了。",
            "<32>* 自從我們死後，\n  這就是我的存在，Asirel...",
            "<32>* 然後...我還得告訴你個事。"
         ...
         d19: [
            "<32>{#p/basic}* 還記得我們穿過力場的時候嗎？",
            "<32>* 到達舊家園遺蹟時，被那些人類發現了？",
            "<32>* 我想用我的力量毀滅他們...\n  但是你阻止了我，還記得嗎？"
         ],
         d20: [ "<25>{#p/asriel1}{#f/16}* ...是的。" ],
         d21: [
            "<32>{#p/basic}* 我當時不理解，但是...",
            "<32>* 現在我理解了。",
            "<32>* ...你阻止我...是爲了防止我犯下更嚴重的錯誤。"
         ],
         d22: [ "<25>{#p/asriel1}{#f/15}* $(name)..." ],
         d23: [
            "<32>{#p/basic}* 如果沒有你，前哨戰可能就會在第二次戰爭中毀滅。",
            "<32>* 如果沒有你，我本該拯救的那些怪物...",
            "<32>* ...就得和我們陪葬了。"
         ],
         ...
         d46: [ "<25>{#p/asriel1}{#f/25}* Frisk，你在那裏嗎？", "<25>{#f/22}* 拜託了...醒來吧..." ],
      ...
      fireplace2c: [ "<25>{#p/toriel}{#f/1}{#npc/a}* 別在裏面待太久了..." ],
      ...
      noticedummy: [ "<25>{#p/asriel2}{#f/3}* ...", "<25>{#p/asriel2}{#f/10}* 這裏以前\n  應該有個人偶吧...？" ],
      afrog: {
         a: [
      ...
      chair2c5: [ "<25>{#p/toriel}{#f/1}{#n1}* 好，故事從這裏開始...", "<25>{#p/toriel}{#g/torielCompassionSmile}* ..." ],
      chair2c6: [
         "<25>{#f/1}{#n1}* “從前，有一隻怪物...”",
         "<25>{#f/0}* “這個怪物愛上了\n  一個小小的人類。”",
         "<25>{#f/1}* “每天，\n  這個人類都會去找她...”",
      ...
      fridgetrap: {
         a: () =>
            SAVE.data.b.svr
               ? []
               : world.darker
               ? [ "<32>{#p/basic}* 你對冰箱裏的東西不感興趣。" ]
               : [ "<32>{#p/basic}* 冰箱裏有一條新的巧克力棒。" ],
         b: () => [
      ...
      runaway1: [
         [ "<25>{#p/toriel}{#f/1}* 你是不是應該在屋裏玩呢？", "<25>{#f/0}* 來吧。" ],
      ...
      runaway6: [
         "<25>{#g/torielStraightUp}* 說實話... 我不敢離開這裏。",
         "<25>{#f/9}* 外面非常危險，那些怪物\n  足以威脅到你我的生命。",
      ...
      socks1: pager.create(0, () =>
         world.darker
            ? [ "<32>{#p/human}* （你往裏面瞅了瞅。）", "<32>{#p/basic}* 只是個放襪子的抽屜。" ]
            : [
                 "<32>{#p/human}* （你往裏面瞅了瞅。）",
                 "<32>{#p/basic}* 真羞人！\n* 這裏面全是Toriel收藏的襪子。\n* 有點亂...",
                 world.meanie
      ...
      securefield: [ "<33>{#p/basic}* 這裏有一道安保屏障。\n* 已被激活。" ],
      trivia: {
      ...
      tutorial_puzzle8b: [ "<25>{#p/toriel}* 剛纔怎麼做的，\n  再做一次就好。" ],
   ...
   b_opponent_toriel: {
      ...
      death2: [
         "<11>{#p/toriel}{#f/21}{#v/1}{#i/3}{#x1}{@random:1.1,1.1}呃啊...",
         "<11>{#v/1}{#i/3}{#x3}{@random:1.1,1.1}本{^2}以{^2}爲{^2}，{^2}自{^2}己\n努{^2}力{^2}保{^2}護{^2}的{^2}人{^2}，\n是{^2}你{^2}...",
      ...
      spareTalk20: [ "<11>{#p/toriel}{#f/18}你爲什麼\n要讓事情變得\n這麼難辦呢？" ],
      ...
      spareTalk28c: [ "<11>{#p/toriel}{#f/17}...？", "<11>{#f/17}你爲什麼喊\n  “$(name)”\n  的名字呢？" ],
