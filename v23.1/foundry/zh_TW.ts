...
const text = {
   a_foundry: {
      ...
      darktoriel5a: [
         "<25>{#p/toriel}{#f/5}* ...嗯？\n* 你還有話要跟我說？",
         "<32>{#p/human}* （你重複Toriel在Archive Six中\n  給你的建議。）",
         "<25>{#p/toriel}{#f/2}* ...",
         "<25>{#f/1}* 這些話...",
         "<25>{#f/1}* 你怎麼可能聽過...？",
      ...
      darktoriel7: () =>
         SAVE.data.b.c_state_secret1_used
            ...
            : [
                 "<25>{#p/toriel}{#f/5}* Frisk，你得給我時間處理一下。",
                 "<25>{#f/1}* 運輸船上見。\n* 好嗎？"
              ],
      ghostpartymusic1: [
      ...
      candy1: () =>
         SAVE.data.b.svr
            ? [
                 ...
                 choicer.create("* (What will you make?)", "甘草糖", "Water", "口糧", "Nothing")
              ]
            : [
      ...
      candy3: [ choicer.create("* （花$(x)G來買$(y)嗎？）", "是", "否") ],
   ...
   i_goggles: {
      ...
      drop: [ "<32>{#p/human}* （你把AR護目鏡扔掉了。）" ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ "<32>{#p/human}* (6 DF.)" ]
            : [ "<32>{#p/basic}* “AR護目鏡” （6防禦）\n* 超越現實！ \n  能為你提供更長的喘息時間。" ],
      name: "AR護目鏡",
   ...
   n_shop_tem: {
      ...
      itemUnavailable: () => (world.runaway ? "<09>{#p/basic}空無一物。" : "<09>{#p/tem}{#k/2}no more item..."),
      itemRestricted: "<09>{#p/tem}{#k/2}not for sale...",
      menu: () =>
         world.runaway ? [ "拿取", "偷竊", "閱讀", "Exit" ] : [ "購買", world.meanie ? "偷竊" : "出售", "交談", "Exit" ],
      ...
      talk: () => [
         SAVE.data.n.plot === 72 ? "Good News" : "哈拉",
   ...
   n_shop_tortoise: {
      ...
      item: () =>
         world.runaway
            ? [ "0G - Datapad?", "0G - AR護目鏡？", "0G - Nebula Tea", "0G - Tree Sap", "Exit" ]
            : world.genocide || world.killed0 || SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE

            ? [ "45G - Datapad?", "45G - AR護目鏡？", "16G - Nebula Tea", "25G - Tree Sap", "Exit" ]
            : SAVE.data.n.plot === 72
            ? [
                 SAVE.data.b.item_padd ? "25G - Datapad?" : "35G - Datapad",
                 SAVE.data.b.item_goggles ? "25G - AR護目鏡？" : "35G - AR護目鏡",
                 "5G - Nebula Tea",
                 "5G - Tree Sap",
                 "Exit"
              ]
            : [
                 ...
                 SAVE.data.b.item_goggles ? "45G - AR護目鏡？" : "55G - AR護目鏡",
                 "16G - Nebula Tea",
                 "25G - Tree Sap",
                 "Exit"
              ],
