...
const text = {
   a_starton: {
      ...
      sans1: [
         "<99>{#p/darksans}{#i/4}* {@spacing:2.25,0}人类。",
         "<99>* {@spacing:2.25,0}难道你不知道{@spacing:}\n  {@spacing:2.25,0}怎么和新朋友{@spacing:}\n  {@spacing:2.25,0}打招呼吗？",
         "<99>* {@spacing:2.25,0}转过身来{@spacing:}\n  {@spacing:2.25,0}和我握手。"
      ],
      sans2: () => [
         ...(world.edgy
            ? [
                 "<25>{#p/sans}{#f/0}* 你这表情是什么意思？",
                 "<25>{#p/sans}{#f/2}* ... 你不喜欢我放屁垫的把戏吗?",
                 "<25>{#f/0}* ... 这个东西嘛。\n* 每个人都有自己的看法。"
              ]
         ...
         "<25>{#f/5}* 那真的是酷毙了。",
         "<25>{#f/0}* 我是sans.\n* 骷髅sans.",
         "<25>{#f/3}* 作为一位皇家哨兵，我的职责是抓捕人类。",
         "<25>{#f/4}* 但是...你要知道...",
         ...(world.edgy
            ? [
                 "<25>{#f/2}* 我今天实在是懒得做这么多活了。",
                 "<25>{#f/0}* 至于我的兄弟嘛...",
                 "<25>{#f/5}* 他在成天捣鼓这件事。",
                 "<25>{#f/0}* 我花了三辈子的功夫才让他留在家里。"
              ]
            : [
      ...
      sans3: () =>
         world.edgy
            ? [
                 "<25>{#p/sans}* 我们到了。",
                 "<25>{#f/3}* 恐怕我当下无法展示太多东西了…",
                 "<25>{#f/2}* 不过如果你选择前行的话，我也许会给你展示一些东西。",
