...
const text = {
   a_starton: {
      ...
      sans1: [
         "<99>{#p/darksans}{#i/4}* {@spacing:2.25,0}人類。",
         "<99>* {@spacing:2.25,0}難道你不知道{@spacing:}\n  {@spacing:2.25,0}怎麼和新朋友{@spacing:}\n  {@spacing:2.25,0}打招呼嗎？",
         "<99>* {@spacing:2.25,0}轉過身來{@spacing:}\n  {@spacing:2.25,0}和我握手。"
      ],
      sans2: () => [
         ...(world.edgy
            ? [
                 "<25>{#p/sans}{#f/0}* 你這表情是什麼意思？",
                 "<25>{#p/sans}{#f/2}* ... 你不喜歡我放屁墊的把戲嗎?",
                 "<25>{#f/0}* ... 這個東西嘛。\n* 每個人都有自己的看法。"
              ]
         ...
         "<25>{#f/5}* 那真的是酷斃了。",
         "<25>{#f/0}* 我是sans.\n* 骷髏sans.",
         "<25>{#f/3}* 作為一位皇家哨兵，我的職責是抓捕人類。",
         "<25>{#f/4}* 但是...你要知道...",
         ...(world.edgy
            ? [
                 "<25>{#f/2}* 我今天實在是懶得做這麼多活了。",
                 "<25>{#f/0}* 至於我的兄弟嘛...",
                 "<25>{#f/5}* 他在成天搗鼓這件事。",
                 "<25>{#f/0}* 我花了三輩子的功夫才讓他留在家裡。"
              ]
            : [
      ...
      sans3: () =>
         world.edgy
            ? [
                 "<25>{#p/sans}* 我們到了。",
                 "<25>{#f/3}* 恐怕我當下無法展示太多東西了…",
                 "<25>{#f/2}* 不過如果你選擇前行的話，我也許會給你展示一些東西。",
