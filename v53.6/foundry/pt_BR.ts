...
export default {
   a_foundry: {
      locketseller: [ '<32>{#p/basic}* ...', "<32>{#p/basic}* Vou fingir que você não vendeu aquele medalhão." ],
      noequip: [ '<32>{#p/human}* (Você decide não equipar.)' ],
      darktoriel1: [
         "<32>{#p/human}* (Você agarra a mão de Toriel.)",
         '<25>{#p/toriel}{#f/2}* Oh meu...!\n* F-frisk, é você?',
         "<25>{#f/1}* É um pouco difícil de ver aqui..."
      ],
      darktoriel2: [
         '<25>{#p/toriel}{#f/9}* Peço desculpas. Você deve ter procurado por mim.',
         '<25>{#f/9}* Se você tentasse me ligar, meu telefone estava desligado.',
         '<25>{#f/13}* ...',
         '<25>{#f/13}* Sinto muito por tudo o que fiz, pequeno.',
         '<25>{#f/13}* Mesmo que você me perdoe, seria difícil aceitá-lo.',
         '<25>{#f/9}* Estou apenas começando a aceitar meu comportamento no passado.',
         '<25>{#f/10}* ...',
         '<25>{#f/10}* Suponho que seja bom vê-lo aqui.'
      ],
      darktoriel3: [
         '<25>{#p/toriel}{#f/5}* ... hm?\n* Você queria que eu ligasse... Sans?',
         '<25>{#f/1}* Deixe-me ligá-lo...'
      ],
      darktoriel4a: [
         '<32>{#s/phone}{#p/event}* Discando...',
         '<25>{#p/toriel}{#f/3}* ... Ah, certo.\n* Meu telefone não funciona muito bem aqui.'
      ],
      darktoriel4b: [
         '<25>{#f/4}* Terei de ir até lá e falar com ele eu mesmo.',
         '<25>{#f/5}* Er... Eu farei isso.\n* Mas não agora.',
         '<25>{#f/5}* ...'
      ],
      darktoriel5a: [
