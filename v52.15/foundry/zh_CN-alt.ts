...
export default {
            ...
            SAVE.data.n.plot === 72
               ...
               ? [
                    ...
                    ...(world.kiddo && !SAVE.data.b.f_state_dc_kidd9
                       ? ((SAVE.data.b.f_state_dc_kidd9 = true), [ '<25>{#p/kidd}{#f/4}* N该不会是那蜘蛛吧...' ])
                       : [])
                 ]
               : [
                    '<32>{#s/echostart}{#p/event}{#npc/a}* 讯号开始...',
   ...
   b_opponent_undyne: {
      ...
      death3: () =>
         helmetdyneAttack()
            ? [ '<20>{#p/undyne}{#e/undyne/46}...不。ゑ', '<20>{#e/undyne/43}还没完呢。ゑ' ]
            : [
   ...
   i_epiphany: {
      ...
      use: () =>
         battler.active
            ...
            : [ '<32>{#p/human}* （你展开了卷轴《顿悟》。）', '<32>{#p/human}* （无事发生。）ゑ' ]
   },
   i_astrofood: {
      battle: {
         description: '牙口不好的别吃。ゑ',
         name: '甘草糖'
      },
   ...
   i_tea: {
      ...
      use: () => [
         ...
         battler.active ? '<32>{#p/story}* 你的移速提升了1点！' : '<32>{#p/human}* （无事发生。）ゑ'
      ]
   },
   i_tzn: {
      battle: {
      ...
      use: () => [
         ...
         ...(world.meanie
            ? [
                 '<32>* （那味道让你有种特别的感觉...）',
                 battler.active
                    ? `<32>{#p/story}* 你的攻击力提升了${4 + battler.at_bonus}点！ゑ`
                    : '<32>{#p/human}* （无事发生。）ゑ'
              ]
            : [])
      ]
