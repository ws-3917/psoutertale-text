...
export default {
   a_citadel: {
      ...
      genotext: {
         ...
         afterfight1: [ "<25>{#p/asriel2}{#f/8}* ...总算解决她了。" ],
         afterfight2: () =>
            [
               [
   ...
   b_opponent_alphys: {
      ...
      status3a: [ "<32>{#p/asriel2}* 好吧... 形势严重起来了。" ],
      status3b: [ "<32>{#p/asriel2}* ...看来艾菲斯不准备防御了。\n* 抓住这个机会！" ],
      status3c: [ "<32>{#p/asriel2}* Hang in there, $(name)..." ],
      turnTalk1a: [
         "<20>{#p/alphys}{#e/alphys/19}要是连一击都扛不住，\n我怎么可能来这？",
         "<20>{#p/alphys}{#e/alphys/23}看来你们没我想的\n那么聪明。"
      ],
      turnTalk1b: [
      ...
      turnTalk15: [
         "<20>{#p/alphys}{#e/alphys/39}安黛因说你们会\n杀死这星河中的每个人...",
      ...
      done2: (b: boolean) =>
         b ? [ "<20>{*}{#p/alphys}我毫无胜算。{^40}{%}" ] : [ "<20>{*}{#p/alphys}艾斯戈尔，我对不起你。{^40}{%}" ]
   },
   b_opponent_archive1: {
