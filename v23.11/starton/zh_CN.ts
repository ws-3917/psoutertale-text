...
import systemsText from '../../code/systems/text';
...
const text = {
   a_starton: {
      telescope1: () => [
         ...(SAVE.data.b.svr ? [] : [ "<32>{#p/basic}* 标准规格的CITADEL长焦望远镜，\n  251X年前后制成。" ]),
         choicer.create("* （使用望远镜？）", "是", "否")
      ],
      telescopeMeetup1: [ "<25>{#p/kidd}{#f/2}* 你在看星星吗？" ],
      telescopeMeetup2: [
         "<25>{#p/kidd}{#f/1}* 哟... 我打赌你肯定看到了很酷的东西。",
         "<25>{#f/7}* 上次我用望远镜的时候，我甚至看到了一颗超新星！"
      ],
      telescopeMeetup3: [
         "<25>{#p/kidd}{#f/3}* 给。\n* 拿上这个。",
         "<32>{#s/equip}{#p/human}* (高级会员券被添加到了你的钥匙圈。)",
         "<25>{#p/kidd}{#f/7}* 现在你可以使用任何望远镜了，连“最高级”的都能用！",
         "<25>{#f/1}* 那个矮骷髅之前给了我好多这个。",
         "<25>{#f/2}* 他甚至花了很多钱送了我一些数字藏品...",
         "<25>{#f/1}* 我猜他真的很喜欢我，哈哈。"
      ],
      telescopeMeetup4: [
         "<25>{#p/kidd}{#f/3}* 总之，我刚才给了你一张票券。",
         "<25>{#f/1}* 希望你能看到更酷的东西！"
      ],
      ...
      telescope2: () =>
         SAVE.data.b.svr
            ...
            : ((SAVE.data.b.s_state_chargazer = true),
              [
                 "<32>{#p/basic}* ...",
                 "<32>* Asriel和我曾经就有一架这样的望远镜。",
                 "<32>* 我们随意指向天空，希望看到什么激动人心的东西...",
                 "<32>* ... 我们从来没看到过那么多。",
                 "<32>* 虽然这样，但是这对他来说似乎并不重要...",
                 "<32>* 我专注地向外看的时候，他仅仅是开心地和我在一起。",
                 "<32>* ...",
                 "<32>{#p/human}* (你听到一声叹息。)",
                 "<32>{#p/basic}* ... 呃，现在回到刚才的事吧。"
              ]),
            ...
            SAVE.data.n.plot === 72
               ...
               : [
                    ...
                    ...(2 <= SAVE.data.n.plot_date && SAVE.data.n.exp <= 0
                       ...
                       : SAVE.data.n.state_aerialis_royalguards === 0
                       ? [
                       ...
                       : [
                            ...
                            "<32>* My stock just can't keep up!"
                         ])
                 ],
         () =>
            SAVE.data.n.plot === 72
      ...
      papyrus7: [
         ...
         choicer.create("* （你要怎么回答？）", "Sure", "Even less")
      ],
      papyrus8: [
            ...
            SAVE.data.b.svr
               ...
               : [
                    ...
                    ...(world.genocide || world.runaway
                       ...
                       : [
                            "<23>{#p/papyrus}{#f/30}\"你在观察这个做工精良的哨站。\"",
                            "<23>\"谁会造这种东西呢，你想…\"",
                            "<23>\"我打赌一定是那个十分有名的守卫！\"",
                            SAVE.data.n.plot === 72
            ...
            ...[
               () => [
                  ...(dateready() && SAVE.data.n.state_starton_papyrus === 0
                     ...
                     : []),
                  world.darker ? "<32>{#p/basic}* 一个垃圾桶。" : "<32>{#p/basic}* It's a \"stellar\" trash can."
               ],
               pager.create(
                  1,
                  ...[
         ...
         s_dogs_sign: () =>
            SAVE.data.b.svr
               ...
               : [
                    ...
                    "<32>* “不可疑的气味 - 小狗”\n* “等级：{@fill:#003cff}蓝色{@fill:#fff}。”\n* “在地里打滚的气味。”",
                    world.runaway
                       ? "<32>* “古怪的气味 - 人类”\n* “等级：{@fill:#00c000}绿色{@fill:#fff}。”\n* “一旦看到，立马逃跑！”"
                       : SAVE.data.n.plot === 72
                       ? "<32>* “古怪的气味 - 人类”\n* “等级：{@fill:#00c000}绿色{@fill:#fff}。”\n* “不惧神明之力。”"
                       : SAVE.data.n.plot < 31
                       ? "<32>* “古怪的气味 - 人类”\n* “等级：{@fill:#00c000}绿色{@fill:#fff}。”\n* “不惜一切代价消灭！”"
   ...
   b_opponent_doggo: {
      ...
      petStatus: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 不堪一击。" ] : [ "<32>{#p/story}* Doggo has been pet." ],
   ...
   b_opponent_dogamy: {
      ...
      petTalk1: [ "<11>{#p/basic}{~}放开，你这个该死的人类。" ],
   ...
   b_opponent_greatdog: {
      ...
      hurtStatus: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 离死不远了。" ] : [ "<32>{#p/story}* Canis Major is panting slowly." ],
      ignoreStatus1: () =>
         world.goatbro
      ...
      petStatus4: () =>
         world.goatbro ? [ "<32>{#p/asriel2}* 不堪一击。" ] : [ "<32>{#p/story}* Canis Major is contented." ],
   ...
   b_opponent_papyrus: {
      ...
      death1: () =>
         world.genocide
            ? [ "<15>{#p/papyrus}{#f/27}不...\n不-不..." ]
            : [ "<15>{#p/papyrus}{#f/21}好吧，这并不是我想要的结果…" ],
      death2: () =>
         world.genocide
   ...
   i_blookpie: {
      ...
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ "<32>{#p/human}* （99 HP。）" ]
            : [ "<32>{#p/basic}* “Exoberry Pie” 回复 99 HP\n* 将新鲜洋梅浸润在果冻中制作而成。" ],
      name: "洋梅果冻派",
      use: () => [
   ...
   n_shop_blook: {
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ? [ "打招呼", "What Happened", SAVE.data.s.name || systemsText.general.mystery1, "The Future", "离开" ]
            : [
                 "打招呼",
                 "Ghosts",
                 "Sanctuary",
   ...
   n_shop_hare: {
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [ "打招呼", "What To Do Here", "Town History", "Your Life", "离开" ],
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                    ...
                    "<18>{#p/papyrus}{#f/6}YOU WHAT??",
                    "<25>{#p/undyne}{#f/12}* But, uh, that'd be messing with perfection.",
                    "<18>{#p/papyrus}{#f/4}PERFECTION, YOU SAY?",
      ...
      s_town1: pager.create(
         ...
         () => [
            ...
            "<18>{#f/5}A SIDE I DON'T SPENT MUCH TIME ON.",
            "<18>{#f/4}SANS, ON THE OTHER HAND...",
            ...(solo()
      ...
      s_innterior: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ? []
               : [
                    "<25>{#p/undyne}{#f/16}* It's also the most well-known photos of our old homeworld...",
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                    ...
                    "<25>{#p/undyne}{#f/8}* I just throw spears at the reciever and call it a day!",
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                    ...
                    "<18>{#p/papyrus}{#f/0}IF CATTY AND BRATTY CAN DO IT OUT IN SPACE...",
      ...
      f_prespear: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ? [ "<18>{#p/papyrus}{#f/5}EVEN IF I DID MAKE MYSELF EASY TARGET." ]
               : [
      ...
      a_rg1: pager.create(
         0,
         () => [
            "<18>{#p/papyrus}{#f/0}IT'S INCREDIBLE HOW THE GUARDS HERE...",
            ...
            ...(solo()
               ...
               : [
                    ...
                    "<18>{#p/papyrus}{#f/0}BUT THEY DIT IT EVENTUALLY, RIGHT?",
      ...
      a_rg2: pager.create(
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                    "<25>{#p/undyne}{#f/16}* Of course...",
                    "<18>{#p/papyrus}{#f/5}HUH?\nWHAT'S THE PROBLEM?",
                    "<25>{#p/undyne}{#f/1}* The royal scientist is meant to be the king's most trusted associate.",
                    "<25>{#f/16}* After Dr. Roman passed, though, we weren't ready to replace him.",
                    "<25>{#f/9}* Some of the older guards still haven't moved on.",
                    "<18>{#p/papyrus}{#f/5}OH...",
                    "<25>{#p/undyne}{#f/17}* Don't get me wrong.\n* Alphys is like, a REALLY great scientist.",
                    "<26>{#f/16}* But she's unweildy, and... she's still got lots to prove out there.",
                    "<18>{#p/papyrus}{#f/5}HOPEFULLY, IN TIME, THEY'LL COME TO RESPECT HER."
                 ])
         ],
         () =>
            solo()
         ...
         () => [
            ...
            ...(solo()
               ...
               : [
                    ...
                    "<18>{#p/papyrus}{#f/5}BESIDES, IF I WANTED TO PLAN ONE PROPERLY...",
