   ...
   a_common: {
      ...
      neutral1 () {
         return [
            ...
            "<32>{#p/human}* （...）",
            "<25>{#p/sans}{#f/0}* heh...\n* y'know, bud...",
            "<25>{#p/sans}{#f/0}* for someone who killed as many people as you did...",
            "<25>{#p/sans}{#f/3}* you seem awfully shy over the phone.",
            ...
            "<25>{#p/sans}{#f/0}* so, anyway, why am i only bringing that day up now?",
            ...
            "<25>{#p/sans}{#f/0}* i mean, for starters, none of the other humans were like you.",
