...
export default {
   a_citadel: {
      ...
      story: {
         ...
         asgoreStory18: () =>
            SAVE.data.b.killed_mettaton || world.bad_lizard > 1 || SAVE.data.n.state_foundry_undyne === 2
               ? [
      ...
      trivia: {
         ...
         bastion: pager.create(
            ...
            () => [
               ...
               ...(SAVE.data.n.plot < 71.2 && !SAVE.data.b.killed_mettaton && world.bad_lizard < 2 && SAVE.data.n.state_foundry_undyne !== 2
         ...
         bastionTerm: () =>
            SAVE.data.n.plot < 71.2 && world.bad_lizard < 2 && SAVE.data.n.state_foundry_undyne !== 2 && !SAVE.data.b.killed_mettaton
               ? []
               : [
