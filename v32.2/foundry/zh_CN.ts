...
export default {
   a_foundry: {
      ...
      blooktouch1: () =>
         world.sad_ghost
            ? [
                 ...
                 choicer.create("* （你要怎么回答？）", "Sorry", "Nothing")
              ]
            : [
                 "<32>{#p/napstablook}* oh, do you need anything?",
                 choicer.create("* （你要怎么回答？）", "Hug", "Sleep", "Music", "Nothing")
              ],
      blooktouch2a1: [
      ...
      blooktouch2c4: [
         ...
         choicer.create("* （你要怎么回答？）", "Good", "Bad")
      ],
      blooktouch2c5a: [
      ...
      npc86b: [
         ...
         choicer.create("* （你要怎么回答？）", "Red", "Green", "Blue", "Not sure")
      ],
      npc86c: [
      ...
      npc86d: () => [
         ...
         choicer.create("* （你要怎么回答？）", "Good", "Bad", "Neutral", "Not sure")
      ],
      npc86e: () => [
         ...[
      ...
      npc86f: () => [
         ...
         choicer.create("* （你要怎么回答？）", "Love", "Disgust", "None", "Not sure")
      ],
      npc86g: () =>
         [
            [
      ...
      spookydate1: pager.create(
         0,
         [
            "<25>{#p/sans}* 嘿，我听说你和我的兄弟和好了。\n* 就是那个伟大的papyrus。",
            "<25>{#f/2}* 嗯... \n  我觉得这也是一场\n  {@fill=#ff0}伟大的胜利{@fill=#fff}。",
            "<26>{#f/0}* 我们去grillby's那庆祝一番，咋样？",
            "<26>{#f/3}* 获得了papyrus的好感，你就\n  在我内心有了一席之地。",
      ...
      spookydate10: [ "<25>{#p/sans}* 为什么不过来做一下呢，伙计？" ],
      spookydate11: [
      ...
      spookydate12b: [ "<25>{#p/sans}* grillby，给我们来两份汉堡。" ],
      spookydate13: [
         "<25>{#p/sans}* 那么，你觉得我兄弟的攻击咋样？",
      ...
      spookydate16: [
         ...
         "<25>{#f/0}* 他的那些攻击设计就是很好的\n  例子。",
         "<25>{#f/3}* 不久前，papyrus去拜访了皇家卫队\n  队长...",
         "<25>{#f/0}* 并恳求她让他加入皇家卫队。",
         "<25>{#f/3}* 唉，她直接当着他的面把门\n  摔上了。\n* 经典的undyne式作风。",
         "<25>{#f/0}* 但几个小时后，当papyrus带着他的设计归来时...",
         "<25>{#f/0}* undyne大受震撼，所以她决\n  定给予他...",
         "<25>{#f/2}* ... 好吧，咱姑且叫做“军人般的训练”。"
      ],
      spookydate17: [ "<25>{#p/sans}* 哦对了，我想问你点事来着。" ],
      spookydate18: [
         "<25>{#p/sans}{#f/3}* 你曾听说过一种{@fill=#ff0}会说话的星星{@fill=#fff}\n  吗?",
         choicer.create("* （你要怎么回答？）", "是", "否")
      ],
      spookydate19a: [
         "<25>{#p/sans}* 原来你都知道啊。",
      ...
      telescopeX: pager.create(
         ...
         [ "<25>{#p/sans}{#f/2}* wanna try my telescope?", choicer.create("* （你要怎么回答？）", "是", "否") ]
      ),
      telescopeY: () =>
         SAVE.data.b.voucher
      ...
      unddate13: () => [
         ...
         choicer.create("* （你要怎么回答？）", "Hungry", "Book", "Home", "Nothing")
      ],
      unddate13a1: [
