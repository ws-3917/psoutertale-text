...
export default {
   a_foundry: {
      ...
      spookydate1: pager.create(
         ...
         [
            ...
            "<26>{#f/0}* 我們去grillby's那慶祝一番，咋樣？",
            "<26>{#f/3}* 獲得了papyrus的好感，你就\n  在我內心有了一席之地。",
      ...
      spookydate16: [
         ...
         "<25>{#f/3}* 不久前，papyrus去拜訪了皇家衛隊\n  隊長...",
         "<25>{#f/0}* 並懇求她讓他加入皇家衛隊。",
         "<25>{#f/3}* 唉，她直接當著他的面把門\n  摔上了。\n* 經典的undyne式作風。",
         "<25>{#f/0}* 但幾個小時後，當papyrus帶著他的設計歸來時...",
         "<25>{#f/0}* undyne大受震撼，所以她決\n  定給予他...",
   ...
   b_opponent_undyne: {
      ...
      deterStatus5: [ "<32>{#p/story}* Undyne閉上了眼睛。" ],
