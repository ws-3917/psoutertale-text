...
export default {
      ...
      papcomputer1: pager.create(
         ...
         () => [
            ...
            SAVE.data.b.svr
               ...
               : "<32>{#p/basic}* 電腦的瀏覽器\n  打開了一個\n  社交媒體網站。",
            choicer.create("* （登入Papyrus的賬戶嗎？）", "登入", "算了")
         ],
         () => [
            SAVE.data.b.svr
               ? "<32>{#p/human}* (You move towards the computer...)"
   ...
   b_opponent_doggo: {
      ...
      act_flirt: () => [ "<32>{#p/human}* （你對Doggo調情。）" ],
   ...
   b_opponent_dogamy: {
      act_check: () =>
         world.goatbro
            ...
            : [ "<32>{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的老公。\n* 只認識他聞到的東西。" ],
      act_check2: [ "<32>{#p/story}* DOGAMY - 14攻擊 5防禦\n* 新近喪偶。\n* 只認識失去老婆的痛苦。" ],
      act_check3: [ "<32>{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的老公。\n* 認識的東西比先前更多了。" ],
      act_check4: [ "<32>{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的丈夫。\n* 並不介意分享...？" ],
      act_check5: [ "<32>{#p/story}* DOGAMY - 14攻擊 5防禦\n* Dogaressa的老公。\n* 並不介意離開...？" ],
      fetchText: [
         "<32>{#p/human}* （你將扳手扔了出去。）\n* （狗狗們跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）"
      ],
      fetchTextLone: () => [
      ...
      flirtText: [
         "<32>{#p/human}* （你對Dogamy調情。）",
         "<32>{#p/basic}* 你的... 資訊素，\n  傳到了Dogamy的鼻子上。"
      ],
      flirtTextLone: [ "<32>{#p/human}* （你對Dogamy調情。）", "<32>{#p/basic}* Dogamy的表情沒有發生變化。" ],
      loneStatus: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 只剩一個了。" ]
   ...
   b_opponent_papyrus: {
      ...
      flirtStatus5: [ "<32>{#p/story}* Papyrus正在想「方」「色」法\n  變得出名。" ],
      ...
      hurtStatus: [ "<32>{#p/story}* Papyrus 瀕臨失敗。" ],
