...
export default {
   a_citadel: {
      ...
      story: {
         ...
         jspeech8: [
            ...
            "<25>{#f/0}* it's time...",
            "<25>{#p/sans}{#f/2}* you understood the {@fill:#003cff}real truth{@fill:#fff}."
         ],
   ...
   b_opponent_final: {
      ...
      friend67: (unique: string[]) => [
         ...
         ...(unique.find(k => k.startsWith('light')) && unique.find(k => k.startsWith('dark')) // NO-TRANSLATE
