...
const n_sidebarCellPms3 = {
   ...
   alphys2: {
      ...
      pm: () =>
         [
            "still can't believe mettaton wanted me to fight them, smh", 
            "not sure what to say except, they seem nice?" 
         ][save.data.n.bad_lizard]
   },
   alphys3: {
      author: "ALPHYS",
      pm: () =>
         [
            "anyway, imma be guiding them now :D\ngodddd this is so exciting aaaaaa", 
   ...
   alphys4: {
      ...
      pm: () =>
         [
            ...
            "do they not know theres ice cream at the rec center? uhhhhh" 
         ][save.data.n.bad_lizard]
   },
   alphys6: {
      author: "ALPHYS",
   ...
   alphys7: {
      ...
      pm: () =>
         save.data.n.state_aerialis_crafterresult === 0
            ? "ok imma be honest i have no idea how that worked out lol" 
            : save.data.n.bad_lizard < 1
               ? [
                  "shoulda known those bombs were just TV props lol", 
                  "is it just me or is mtt literally doing this stuff for no reason???", 
                  "well holy pepperoni that was close", 
                  "guys that was amazing, anyone who wasn't watching missed out big time" 
               ][save.data.n.state_aerialis_crafterresult - 1]
               : "welp, there goes my last portable one-time-use jetpack" 
   },
   alphys8: {
      author: "ALPHYS",
   ...
   alphys9: {
      ...
      pm: () =>
         [
            "HAVE I EVER???\nMAN THAT SHOW IS FREAKING EPIC!!!", 
            "anyone at all?" 
         ][save.data.n.bad_lizard]
   },
   alphys10: {
      ...
      pm: () =>
         [
            "woah undyne where did you come from!?!?", 
            "damn, guess not" 
         ][save.data.n.bad_lizard]
   },
   alphys11: {
      ...
      pm: () =>
         save.data.n.bad_lizard < 1
            ...
            : save.data.n.state_foundry_undyne > 0
               ...
               : "Sorry Alphys, I'd love to talk about Mew Mew, just not right now okay?" 
   },
   alphys12: {
   ...
   alphys13: {
      ...
      pm: () =>
         [
            "lemme guess, youre one of those mew mew starfire fans arent you", 
            "sigh..." 
         ][save.data.n.bad_lizard]
   },
   alphys14: {
   ...
   alphys15: {
      ...
      pm: () =>
         [
            "LOLLLLLLLLLLL SPACE VENTURE-\naverage starfire fan cant spell fr", 
            "really starting to regret not adding a block function to this thing fr" 
         ][save.data.n.bad_lizard]
   },
   alphys16: {
      author: "ALPHYS",
   ...
   a_aerialis: {
      ...
      story: {
         ...
         barricade3: [
            ...
            choicer.create("* (What do you say?)", -1, -1, "Model 97", "Hapstablook", "Adrian", "Mettaton") 
         ],
         barricade3b1: [
