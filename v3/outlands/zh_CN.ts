...
const text = {
   a_outlands: {
      stargum1: [
         ...
         choicer.create("* （嚼一块口香糖吗？）", 8, 7, "是", "否")
      ],
      stargum2: ["<25>{#p/human}* （你决定不嚼。）"],
      stargum3: ["<32>{#p/human}* (You ate the Gumbert.)"],
      fireplace1: [
         "<32>{#p/narrator}* Toriel's fireplace.\n* It's not too hot, just pleasantly warm.<32>{#p/narrator}* Toriel的壁炉。\n* 并不烫，而是很舒适的温暖。",
         "<32>* 你甚至可以爬进去。",
         choicer.create("* （爬进去吗？）", 8, 7, "是", "否")
      ],
      fireplace2a: ["<32>{#p/human}* （你决定不爬进去。）"],
      fireplace2b: () => [
         "<32>{#p/human}* （你爬进壁炉让温暖包围着你。）",
         "<32>{#p/human}* （你感到十分舒适。）",
         ...(world.azzie && save.flag.n.ga_asrielFireplace++ < 1
            ? ["<25>{#p/asriel2}{#f/15}* 我只是，呃，等着你出来..."]
            : [])
      ],
      ...
      noticereturn: [
         ...
         "<25>{#f/13}* ...",
         "<25>{#f/4}* 嗯，我想你知道你在做什么， $(name)。"
      ],
      noticestart: [
         "<25>{#p/asriel2}{#f/3}* 啊，这就是一切开始的地方。",
         "<25>{#p/asriel2}{#f/4}* We've certainly come far since then, haven't we, $(name)?"
      ],
      noticedummy: ["<25>{#p/asriel2}{#f/3}* ...", "<25>{#p/asriel2}{#f/10}* 这里以前应该有个人偶来着...？"],
      afrog: {
         a: [
            "<32>{#p/monster}{#n1}* 就在你我之间...",
            "<32>* 我刚才看到那位漂亮的女士从出租车上下来。",
            "<32>* 看起来她买了很多东西回家。",
            "<32>* 我问她这是用来干什么的，然后...",
      ...
      asriel2: [
         ...
         choicer.create("* (Follow Him?)", 8, 7, "否", "是")
      ],
      asriel2b: ["<25>{#p/asriel2}{#f/1}* Ready?", choicer.create("* (Follow Him?)", 8, 7, "否", "是")],
      ...
      blooky1: [
         ...
         choicer.create("* (Try to walk through it?)", 8, 7, "是", "否")
      ],
      blooky2: [
      ...
      chair1e: [
         ...
         choicer.create("{#n1!}* (Read the book?)", 8, 7, "是", "否")
      ],
      ...
      chair2a1: [
         ...
         choicer.create("{#n1!}* (Have breakfast?)", 8, 7, "是", "否")
      ],
      ...
      doorRed: {
         a: [
            ...
            choicer.create("* (Take a peek inside?)", 8, 7, "是", "否")
         ],
         a2: [
            "<32>{#p/human}* (You ring the buzzer...)",
      ...
      doorYellow: () => [
         "<32>{#p/human}* (You ring the buzzer...)",
         world.bullied ? "<32>{#p/narrator}* ...but everybody ran." : "<32>{#p/narrator}* ...但是谁也没有来。"
      ],
      ...
      dummy6: [
         "<25>{#p/toriel}{#f/2}* My child, the DUMMY is not for FIGHTing!<25>{#p/toriel}{#f/2}* 我的孩子，\n假人不是用来打的！",
         "<25>{#f/1}* We don't want to hurt anyone, do we?<25>{#f/1}* 我们可不想伤害任何人，\n对吗？",
         "<25>{#f/0}* 来吧 。"
      ],
      ...
      fridgetrap: {
         ...
         b: [
            ...
            choicer.create("* (Take the chocolate?)", 8, 7, "是", "否")
         ],
      ...
      indie1: [
         ...
         choicer.create("* (What do you say?)", 8, 7, "是", "否")
      ],
      indie1a: [
         "<25>{#p/toriel}{#f/1}* Are you sure?",
         "<25>{#f/5}* It is only a short distance away...",
         choicer.create("* (Change your mind?)", 8, 7, "是", "否")
      ],
      indie1b: [
         "<25>{#p/toriel}{#f/1}* Um...",
      ...
      lobby_puzzle1: [
         "<25>{#p/toriel}* Welcome to our humble outpost, innocent one.<25>{#p/toriel}* 欢迎来到我们简陋的前哨站，\n单纯的孩子。",
         "<25>{#f/1}* This place may seem strange to you now, but...<25>{#f/1}* 也许现在这个地方\n对你来说还很陌生，不过...",
         "<25>{#f/0}* With time, and a little guidance, you will grow accustomed to it.<25>{#f/0}* 随着时间推移，\n再加上一点指导，\n你会熟悉这里的。",
         "<25>* Before that can begin, however, we must make it to the next room.<25>* 不过在那之前，\n我们先得去下一个房间。",
         "<25>* Allow me to educate you in the operation of the OUTLANDS.<25>* 请让我指导你\n如何在遗迹中行动。"
      ],
      lobby_puzzle2: [
         "<25>{#p/toriel}* 这座老厂房里到处都是谜题。",
         "<25>{#f/1}* 这些迷题有易有难...",
         "<25>{#f/0}* One must still unlock them to move from room to room.<25>{#f/0}* 不过想要继续前进，\n就必须尽数解决它们。",
         "<25>* 请适应这些谜题的出现。"
      ],
      lobby_puzzle3: ["<25>{#p/toriel}* When you are ready, we may proceed.<25>{#p/toriel}* 等你准备好了,\n我们就可以继续前进了。"],
      loox: {
         a: [
      ...
      manana: {
         a: pager.create(
            ...
            [
               ...
               choicer.create("* (Buy the comic strip?)", 8, 7, "是", "否")
            ],
            [
      ...
      plot_call: {
         ...
         b: () => [
            ...
            choicer.create("* (What do you say?)", 8, 7, "否", "是")
         ],
      ...
      runaway1: [
         ["<25>{#p/toriel}{#f/1}* Should you not play at the house instead?", "<25>{#f/0}* 来吧 。"],
         ...
         [
            "<25>{#p/toriel}{#f/17}* ...",
            "<25>{#f/15}* I do not like the game you are playing." 
         ],
         ["<25>{#p/toriel}{#f/17}* ..."]
      ],
      runaway2: [
      ...
      socks1: pager.create("limit", () => [
         ...
         world.population < 7
            ? choicer.create("* (Make it messier?)", 8, 7, "否", "是")
            : choicer.create("* (Clean up the mess?)", 8, 7, "是", "否")
      ]),
      socks2: () =>
         world.population < 7
            ...
            : [
               ...
               ...(save.data.b.oops
                  ...
                  : [
                     ...
                     choicer.create("* (Pull the switch?)", 8, 7, "是", "否")
                  ])
            ],
      socks3: [
         "<32>{#p/narrator}* There's a switch hidden in the drawer here.",
      ...
      steaksale: {
         ...
         b: [
            ...
            choicer.create("* (Buy this item?)", 8, 7, "是", "否")
         ],
         b1: pager.create(
            "limit",
      ...
      supervisor: {
         a: pager.create(
            ...
            [
               ...
               choicer.create("* (Mention Napstablook?)", 8, 7, "是", "否")
            ],
            [
            ...
            : save.data.n.state_wastelands_mash > 0
               ...
               : world.population < 7
                  ? [
                     ...
                     choicer.create("* (Smash the pie?)", 8, 7, "否", "是")
                  ]
      ...
      tutorial_puzzle1: ["<25>{#p/toriel}* 有些谜题要是想通过的话..."],
      tutorial_puzzle2: [
         "<25>{#f/0}{#p/toriel}* 是一定需要另一个怪物的协助的。",
         "<25>{#f/0}* Now, try stepping on that switch to my left.<25>{#f/0}* 来，试着踩到\n我右手边的开关上。"
      ],
      tutorial_puzzle2a: ["<25>{#p/toriel}* 试着踩到我右手边的开关上。"],
      tutorial_puzzle3: ["<25>{#p/toriel}* Simple, right?\n* Let us move forward.<25>{#p/toriel}* 是不是很简单？\n*我们继续前进吧。"],
      tutorial_puzzle4: ["<25>* 来，轮到你了。"],
      tutorial_puzzle4a: ["<25>{#p/toriel}* 轮到你了。"],
      tutorial_puzzle5: ["<25>{#p/toriel}* Well done!\n* Only one row left.<25>{#p/toriel}* 你做得很棒！\n* 只剩下一排障碍了。"],
      tutorial_puzzle6: ["<25>{#p/toriel}* Yes, yes!\n* I am proud of you.<25>{#p/toriel}* 太棒了！\n* 我真为你感到骄傲。"],
      tutorial_puzzle7: ["<25>{#p/toriel}* 请跟我来下一个房间。"],
      tutorial_puzzle8: ["<25>{#p/toriel}{#f/1}* Go on..."],
      twinkly1: [
         "<25>{#p/twinkly}{#f/5}* Howdy!\n* I'm {@fill:#ff0}TWINKLY{@fill:#fff}.\n* {@fill:#ff0}TWINKLY{@fill:#fff} the {@fill:#ff0}STAR{@fill:#fff}!<25>{#p/twinkly}{#f/5}* 哈喽！\n* 我叫{@fill:#ff0}TWINKLY{@fill:#fff}。\n* 星界的{@fill:#ff0}闪亮明星{@fill:#fff}！"
      ],
      twinkly2: [
         "<25>{#f/5}* Can't say I've seen you before.<25>{#f/5}* 我得说，\n我在这一带没见过你。",
         "<25>{#f/5}* What brings you to the outpost, huh?<25>{#f/5}* 是哪阵风把你吹到\n这前哨站来的呢？",
         "<25>{#f/8}* ...",
         "<25>{#f/8}* 你是不是迷路了...",
         "<25>{#f/10}* Well, good thing I'm here for you!<25>{#f/10}* 好啦，算你走运，\n我会帮你的！",
      ...
      twinkly9: [
         "<25>{#p/twinkly}{#f/6}* 哈喽。",
         "<25>* Seems I'll be burned if I stick around.<25>* 感觉我再待下去\n就是引火上身了。",
         "<25>{#f/8}* 真是遗憾...",
         "<25>{#f/7}* 我本来想跟你好好玩玩的。",
         "<25>{#f/6}* ...",
         "<25>* 嗯哼。",
      ...
      twinkly10: [
         "<20>{#f/5}See that heart? That's your SOUL, the very culmination of your being!<20>{#f/5}看见这颗心了吗？\n这是你的灵魂，\n是你生命的精华所在！",
         "<20>{#f/10}Your SOUL is an important part of you. It needs LOVE to sustain itself.<20>{#f/10}你的灵魂是你\n不可或缺的一部分，\n你需要LOVE来维持\n它的存在。"
      ],
      twinkly11: [
         "<20>{*}{#f/5}Out here, LOVE is shared through... {#f/8}little white... {#f/11}'happiness shards.'<20>{*}{#f/5}在这太空，\nLOVE是通过...\n{#f/8}这些白色的...\n{#f/11}“幸福碎片”传递的。",
         "<20>{*}{#f/5}To get you started on the right path, I'll share some of my own LOVE.<20>{*}{#f/5}为了让你在正确的\n道路上启程，我会分你\n一点我自己的LOVE。",
         "<20>{*}{#f/10}Be ready, they tend to move fast.<20>{*}{#f/10}准备好，\n它们往往飞得很快。",
         "<20>{*}{#f/5}Just try to get as many as you can!{^20}{#x1}{%}<20>{*}{#f/5}能接多少就\n尽量接多少！{^20}{#x1}{%}"
      ],
      twinkly12: [
         "<20>{*}{#f/8}It looks like you... missed them?<20>{*}{#f/8}看起来... \n你好像没接住？",
         "<20>{*}{#f/11}呃... 但那没关系！",
         "<20>{*}{#f/5}{#x2}来，我再送你点！{^20}{#x1}{%}"
      ],
      twinkly13: [
         "<20>{*}{#f/12}What the-... a-are you braindead or something??<20>{*}{#f/12}搞什... 你-你是\n脑子坏了还是怎么了？？",
         "<20>{*}给. 我. 撞. {#x2}子弹！！{^20}{#x1}{^999}"
      ],
      twinkly14: "给. 我. 撞. 幸福碎片～",
      twinkly15: [
         "<20>{#v/1}嘻嘻嘻...",
         "<20>In this world, it's KILL or BE killed.<20>在这个世界中...\n不是杀人就是被杀。",
         "<20>You've given me a golden opportunity I can't refuse.<20>你可真是给了我个\n难以拒绝的大好机会啊。"
      ],
      twinkly16: [
         "<20>{#v/1}Nah, you know what's going on here, don'tcha?<20>{#v/1}啧，你知道会发生什么，\n对吧？",
         "<20>You just wanted to torment little old TWINKLY, didn'tcha?",
         "<20>嘻嘻嘻..."
      ],
      twinkly17: ["<20>{#v/1}We'll just have to cut straight to the point, won't we?<20>{#v/1}我们得直入主题了，\n好吗？", "<20>嘻嘻嘻..."],
      twinkly18: ["<20>{*}{@random:1.1,1.1}死吧。{^20}{%}"],
      twinkly19: ["<20>{#p/toriel}What a terrible creature, torturing such a poor, innocent youth...<20>{#p/toriel}真是个残忍的家伙，\n居然折磨这么一个\n弱小无助的孩子..."],
      twinkly20: [
         "<20>Ah, do not fear, little one. I am TORIEL, overseer of the OUTLANDS.<20>啊，不要害怕，孩子。\n我是托丽尔，\n外域的监督。",
         "<20>I come by every day to check for those who may have gotten stranded.<20>我每天都来这里看看\n有没有人受困。",
         "<20>Follow me, child. I will guide you through the outskirts.<20>跟我来，孩子。\n我会带你穿过这片郊区。"
      ],
      twinkly21: [
         "<25>{#p/toriel}{#f/1}* 哦天啊！你没事吧，小家伙？",
         "<25>{#f/0}* Please, do not fear.\n* I am TORIEL, overseer of the OUTLANDS.<25>{#f/0}* 请不要害怕。\n* 我是TORIEL，外域的监督。",
         "<25>* 我每天都来这里看看有没有人受困。",
         "<25>* Follow me, child.\n* I will guide you through the outskirts.<25>* 跟我来，孩子。\n* 我会带你穿过这片郊区。"
      ],
      twinkly22: ["<25>{#f/1}* 这边走。"],
      ...
      w_coffin2: pager.create(
         ...
         [
            ...
            choicer.create("* (Access the manifest?)", 8, 7, "是", "否")
         ],
         [
      ...
      w_coffin3: [choicer.create("* (Read the next page?)", 8, 7, "是", "否")],
   ...
   s_save: {
      ...
      w_entrance: {
         ...
         text: () =>
            save.data.n.plot < 48
               ? [
                  "<32>{#p/human}* (The industrious Outlands lies ahead, filling you with determination.)<32>{#p/human}* （繁忙的外域就在前方，\n这使你充满了决心。）",
                  "<32>{#p/human}* （HP完全回复了。）"
               ]
               : [
