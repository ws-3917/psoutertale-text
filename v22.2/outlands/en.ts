...
const text = {
   a_outlands: {
      secret1: () =>
         SAVE.data.n.plot === 72 && game.room === 'w_restricted' && !world.darker // NO-TRANSLATE
            ? [
      ...
      danger_puzzle1: () => [
         ...
         [ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy)
            ...
            : '<25>{#f/1}* Do you think you can solve it on your own?'
      ],
      danger_puzzle2: () =>
         world.darker
         ...
         ...([ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? [
                 early
                    ...
                    : '<25>{#p/toriel}{#g/torielTired}* ... feeling impatient?',
      ...
      socks7: () =>
         SAVE.data.b.svr
            ...
            : [
                 "<32>{#p/basic}* You came all this way just to revisit Toriel's sock drawer...?",
                 '<32>* I suppose it would have a significance to you.'
              ],
      steaksale: {
         a: pager.create(
            0,
      ...
      terminal: {
         a: () =>
            SAVE.data.n.plot === 72
               ? !world.runaway
                  ? [
                       '<32>{#p/human}* (You access the communications terminal and play the incoming message.)',
      ...
      trivia: {
         ...
         w_froggit: () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    ...
                    '<32>* (If you {@fill:#ff0}ACT{@fill:#fff} a certain way or {@fill:#ff0}FIGHT{@fill:#fff} until you almost defeat them...)',
         ...
         w_tf_window: () =>
            SAVE.data.b.svr
               ...
               : world.darker
               ? [ "<32>{#p/basic}* Staring into the abyss, you can't help but wonder what you could have done better." ]
               : SAVE.data.n.plot === 72
      ...
      tutorial_puzzle7: [ '<25>{#p/toriel}* I will wait here until you are ready to begin your next lesson.' ],
      ...
      twinkly18: [ '<20>{*}{#f/2}{@random:1.1,1.1}DIE.{^20}{%}' ],
   ...
   i_spacesuit: {
      ...
      drop: [ '<32>{#p/human}* (You throw away the Broken Spacesuit.)' ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
   ...
   c_call_toriel: <Partial<CosmosKeyed<CosmosProvider<string[]>, string>>>{
      ...
      s_dogs: [
         ...
         '<25>{#f/4}* That relationship must have some "interesting" motivations to it.',
   ...
   c_call_toriel_early: () =>
      game.room.startsWith('w_alley') // NO-TRANSLATE
   ...
   s_save_outlands: {
      ...
      w_froggit: {
         ...
         text: () =>
            world.runaway
               ? [
                    '<32>{#p/human}* (The air has turned foul, yet it fills you with determination.)',
                    '<32>{#p/human}* (HP fully restored.)'
                 ]
               : SAVE.data.b.svr
               ? [
                    '<32>{#p/human}* (The area has been cleared, but the air remains fresh.)',
