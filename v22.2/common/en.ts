import { SAVE, battler, choicer, pager, player, world } from '../../code/api';
...
const text = {
   ...
   a_common: {
      ...
      neutral1: () => [ '<32>{#s/phone}{#p/event}* Ring, ring...', '<32>{#s/equip}{#p/event}* Click...' ],
      neutral2: () => [ '<32>{#s/phone}{#p/event}* Ring, ring...', '<32>{#s/equip}{#p/event}* Click...' ],
      lastblook1: [
         () => [
            '<32>{#p/napstablook}* oh...\n* hey frisk......',
      ...
      end2: [
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* This is emergency program one.{^20}{%}',
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* A quantum fluctuation has been detected in the system.{^20}{%}',
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* Aborting automated self-destruct protocol.{^20}{%}'
      ],
      ...
      balcony13a: [
         ...
         "<25>{#p/kidd}{#f/1}* I don't even know what those are!",
         '<25>{#p/asriel1}{#f/15}* ...',
            ...
            SAVE.data.b.ufokinwotm8
               ...
               : [
                    ...(SAVE.data.b.svr
                       ...
                       : []),
                    ...(SAVE.data.b.ufokinwotm8 ? [] : [ '<32>{#p/basic}* But why...?' ])
                 ],
         x_bathrub: () =>
            SAVE.data.b.ufokinwotm8
   ...
   b_party_kidd: {
      ...
      mkTurnActRand1: (opponent: string) =>
         opponent === 'muffet' // TAG: NO-TRANSLATE
            ? [
            ...
            : opponent === 'shyren' // TAG: NO-TRANSLATE
            ? [
            ...
            : opponent === 'woshua' // TAG: NO-TRANSLATE
            ? [
      ...
      mkTurnActRand2: (opponent: string) =>
         opponent === 'muffet' // TAG: NO-TRANSLATE
            ...
            : opponent === 'radtile' // TAG: NO-TRANSLATE
            ? [
      ...
      mkTurnActRand4: (opponent: string) =>
         opponent === 'muffet' // TAG: NO-TRANSLATE
            ...
            : opponent === 'shyren' || opponent === 'radtile' // TAG: NO-TRANSLATE
