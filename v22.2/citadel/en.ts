...
const text = {
   a_citadel: {
      youvedoneitnow: [
         [
            '<32>{*}{#p/human}* (You feel a darkness gathering inside of you.){^40}{%}',
            '<32>{*}{#p/human}* (You wish it were all just a bad dream.){^40}{%}'
         ],
         [
            '<32>{*}{#p/human}* (You try your best to fight it, but nothing happens.){^40}{%}',
            '<32>{*}{#p/human}* (You wish desperately that you could break free.){^40}{%}'
         ],
         [
            '<32>{*}{#p/human}* (You call out for help, but nobody comes.){^40}{%}',
            '<32>{*}{#p/human}* (You wish you could make this all just go away.){^40}{%}'
         ],
         [
            '<32>{*}{#p/human}* (...){^40}{%}',
            '<32>{*}{#p/human}* (You take a deep breath, and ready yourself for the end.){^40}{%}'
         ],
         [ '<32>{*}{#p/human}* (...){^40}{%}', '<32>{*}{#p/human}* (You know what must be done.){^40}{%}' ]
      ],
      hypertext: {
         count: 'REBOOT IN $(x)',
         ...
         cyan1: [
            ...
            '{*}{@fill:#faff29}With {@mystify:PATIENCE}PATIENCE{@mystify:}, they may escape.',
         ...
         orange1: [
            '{*}{#p/human}{#v/6}{@fill:#faff29}A lost SOUL calls out to you.',
            '{*}{@fill:#faff29}With {@mystify:BRAVERY}BRAVERY{@mystify:}, they may escape.',
         ...
         blue1: [
            '{*}{#p/human}{#v/6}{@fill:#faff29}A lost SOUL calls out to you.',
            '{*}{@fill:#faff29}With {@mystify:INTEGRITY}INTEGRITY{@mystify:}, they can escape.',
         ...
         purple1: [
            '{*}{#p/human}{#v/6}{@fill:#faff29}A lost SOUL calls out to you.',
            '{*}{@fill:#faff29}With {@mystify:PERSEVERANCE}PERSEVERANCE{@mystify:}, they can escape.',
         ...
         green1: [
            '{*}{#p/human}{#v/6}{@fill:#faff29}A lost SOUL calls out to you.',
            '{*}{@fill:#faff29}With {@mystify:KINDNESS}KINDNESS{@mystify:}, they can escape.',
      ...
      genotext: {
         monologue: [
            ...
            (re: boolean) => [
               ...
               "<25>{#f/17}* She'd done so much for me in the past, after all...",
         ...
         coretext25: [
            ...
            '<25>{#p/asgore}{#f/2}* It is unfortunate, then, what happens to them next.',
            '<18>{#p/papyrus}{#f/6}WHAT ARE YOU TALKING ABOUT?',
            '<18>{#p/papyrus}{#f/7}...\nWHAT DID YOU DO?'
         ],
      ...
      npc: {
         ...
         picnic_papyrus: pager.create(
            0,
            [
               '<18>{#p/papyrus}{#f/0}HELLO THERE, FRISK!',
               ...
               "<25>{#p/sans}* that'd be a shame.\n* you might have to take it out early.",
               '<25>{#p/sans}{#f/2}* but hey, if it tastes bad, you can just put more seasoning on it.',
               '<25>{#p/sans}* that usually does the trick, right?',
               "<18>{#p/papyrus}{#f/4}SALT AND PEPPER CAN'T FIX ALL YOUR PROBLEMS, SANS.",
               "<18>{#f/7}AND BESIDES, THAT'D BE ENTIRELY DISHONEST!",
               "<25>{#p/sans}{#f/3}* yeah, i guess you're right."
            ],
            [
               "<18>{#p/papyrus}{#f/0}I'VE ALWAYS WONDERED WHAT THE BEST SEASONING IS.",
               '<18>{#f/4}SALT, PEPPER...\nANTI-GRAVITY POWDER...',
               '<18>{#f/9}THE POSSIBILITIES ARE... RATHER ZESTY!!',
               '<18>{#f/0}BUT MAYBE I SHOULD STICK TO THE BASICS FOR NOW.'
            ],
            [
               "<18>{#p/papyrus}{#f/0}{#npc/a}DON'T WORRY.",
               ...
               player.face !== 'up' // NO-TRANSLATE
                  ...
                  ? ((SAVE.data.b.c_state_secret3_used = true),
                    [
                       ...
                       '<32>{#p/human}* (You recite the scientific notes shared by Dr. Roman.)',
            ...
            () =>
               player.face !== 'up' // NO-TRANSLATE
                  ...
                  : [
                       ...
                       "<25>{#p/alphys}{#g/alphysFR}{#npc/a}* ... now, if you don't mind..."
                    ],
            () =>
               player.face !== 'up' // NO-TRANSLATE
                  ? []
      ...
      story: {
            ...
            SAVE.flag.n.neutral_twinkly_choice === 0
               ? [
                    ...
                    ...(world.trueKills > 0 || SAVE.data.n.state_foundry_undyne === 1
                       ? [
                            "<25>{*}{#e/twinkly/14}It's not as if you had a standard to uphold...",
                            [
                               '<25>{*}{#e/twinkly/17}Not after you left someone to die.',
                               '<25>{*}{#e/twinkly/17}Not after you killed a monster along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed a couple monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed a few monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed several monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed several monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed several monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed those monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed those monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed those monsters along the way.',
                               '<25>{*}{#e/twinkly/17}Not after you killed all those monsters along the way.'
                            ][Math.min(world.trueKills, 10)],
                            '<25>{*}{#e/twinkly/0}...',
                            ...(1 <= SAVE.flag.n.killed_sans
                               ? [
                                    "<25>{*}{#e/twinkly/0}Do you really think I'm worth more time than them?",
                                    '<25>{*}{#e/twinkly/2}Is that why you went along with everything we did before?',
                                    '<25>{*}{#e/twinkly/3}...'
                                 ]
                               : [
                                    '<25>{*}{#e/twinkly/0}Did you really think sparing me would somehow make up for it?',
                                    '<25>{*}{#e/twinkly/2}Were you just that desperate to redeem yourself?',
                                    '<25>{*}{#e/twinkly/3}...'
                                 ]),
                            '<25>{*}{#e/twinkly/0}... say.'
                         ]
                    ...
                    ...(world.trueKills > 0 || SAVE.data.n.state_foundry_undyne === 1
                       ? [
                            ...
                            '<25>{*}{#e/twinkly/17}Then, and only then, will you get your so-called "happy ending."',
                            "<25>{*}{#e/twinkly/20}So, what'll it be?",
                            '<25>{*}{#e/twinkly/20}Will you prove yourself to me?',
                            '<25>{*}{#e/twinkly/17}Or will you suffer for the rest of eternity?',
                            '<25>{*}{#e/twinkly/15}Hee hee hee.',
                            "<25>{*}{#e/twinkly/18}Either way, I'm interested!"
                         ]
                       : [
               ...
               : [
                    ...
                    ...(world.trueKills > 0 || SAVE.data.n.state_foundry_undyne === 1
                       ...
                       : [
                            '<25>{*}{#e/twinkly/2}Was it truly necessary to kill me after sparing everyone...?',
                            '<25>{*}{#e/twinkly/3}You...',
                            ...(1 <= SAVE.flag.n.killed_sans
                               ? [
         ...
         postnoot2: (rep: number, puzzlesolve: boolean, enemyweaken: boolean) => [
            ...((puzzlesolve || enemyweaken) && !SAVE.flag.b.neutral_reload_interloper
               ? [
                    '<25>{*}{#p/twinkly}{#f/19}{#e/twinkly/0}By the way...',
                    ...(puzzlesolve
                       ? [ '<25>{*}{#e/twinkly/0}You could thank me for solving those puzzles for you.' ]
                       : []),
                    ...(enemyweaken
                       ? [
                            puzzlesolve
                               ? '<25>{*}{#e/twinkly/0}Oh, and for screwing with the atmospheric system.'
                               : '<25>{*}{#e/twinkly/0}You could thank me for screwing with the atmospheric system.',
                            '<25>{*}{#e/twinkly/0}I figured, if you DID want to kill anyone...',
                            '<25>{*}{#e/twinkly/0}I might as well weaken your opposition to make it easier.'
                         ]
                       : []),
                    "<25>{*}{#e/twinkly/0}Wasn't that just so considerate of me?",
                    '<25>{*}{#e/twinkly/0}...'
                 ]
               : []),
            ...(rep < 1
         ...
         regret4: () => [
            ...
            ...(SAVE.data.b.w_state_secret || SAVE.data.b.w_state_diary
               ...
               : [
                    "<25>{*}{#e/twinkly/3}A room so insigificant, you probably didn't even know it was there.",
         ...
         asgoreStoryPre3: () => [
            '<25>{#p/asgore}{#f/7}* ...',
            ...(SAVE.flag.b._waaaaaooaaooooaaaaaaooohooohooohstooooryofunderrtaaaaale
               ? [
         ...
         asgoreStory1: [
            '<25>{*}{#p/asgore}{#f/6}* A long time ago, a human child crash- landed in the Foundry.{~}',
            '<25>{*}{#p/asgore}{#f/6}* Injured, they called out for help.{~}'
         ],
         asgoreStory1r: [ '<32>{#p/basic}* ...{%40}', "<32>{#p/basic}* I'm sorry, partner.{%40}" ],
         asgoreStory2: [
         ...
         asgoreStory8: [
            ...
            '<25>{*}{#p/asgore}{#f/4}* Hoping to see the legendary artifacts.{~}'
         ],
         ...
         jspeechU4: [
            ...
            '<25>{#f/2}* and by "they" i mean the royal guard he just became a member of.'
         ],
         jspeechU5: [
         ...
         jspeech2: () => [
            ...
            ...(world.flirt < world.flirt_state1.length
               ? [ '<25>{#f/3}* ...', '<25>{#f/0}* good luck, buddo.', "<26>{#f/2}* not that you'll need it." ]
               : [
                    '<25>{#f/3}* ... oh, right.\n* i almost forgot.',
         ...
         jspeech5a: [
            '<25>{#p/sans}{#f/3}* ...',
            "<25>{#f/0}* truthfully, it doesn't really matter what you thought.",
            "<25>* all that's important is that you were honest with yourself."
         ],

         /** play this variation if never judged before */
         jspeech5b1: [ '<25>{#p/sans}{#f/3}* what happens now...', '<25>{#f/0}* we leave up to you.' ],
         ...
         jspeech6b10: [
            ...
            '<25>{#f/0}* truth betold, if i had a chance to re-roll the dice...',
         ...
         jspeech6b11: [
            ...
            '<25>{#f/0}* truth betold, if i had a chance to turn back the clock...',
            "<25>{*}{#p/darksans}{#f/1}{#i/5}* I'd probably take it right about now.",
            "<25>{#p/sans}{#f/3}* ... but that's just me."
         ],
         ...
         jspeech6b12: [
            ...
            '<25>{#f/0}* truth betold, if i had a chance to start bakery-fresh...',
            "<25>{*}{#p/darksans}{#f/1}{#i/5}* I'd probably take it right about now.",
            "<25>{#p/sans}{#f/3}* ... but that's just me."
         ],
         ...
         jspeech7: [
            ...
            "<25>{#f/3}* you're always acting like you know what's going to happen.",
            "<25>{#f/3}* like you've seen it all before.",
            '<25>{#f/4}* so...\n* i have a request for you.',
            '<25>{#f/0}* i kind of have a {@fill:#ff0}secret codephrase{@fill:#fff} that only i know.',
            '<25>{#f/4}* so i know if someone tells it to me...',
            "<25>{#f/0}* they'll have to be a time traveler.",
            '<25>{#f/2}* crazy, right?',
            '<25>{#f/4}* anyway, here it is...',
            '<32>{#p/human}* (Sans whispered something to you.)',
            "<25>{#p/sans}{#f/0}* i'm counting on you to come back here and tell me that.",
            '<25>{#f/2}* see you later.'
         ],
         ...
         jspeech8: [
            ...
            "<25>{#f/2}* but it's also my secret codephrase.",
            "<25>{#f/3}* so, i guess you're qualified.",
            "<25>{#f/0}* here's the key to my room.",
            "<25>{#f/0}* it's time...",
            '<25>{#f/3}* you learned the truth.',
         ...
         choice0: [
            ...
            "<25>{#g/alphysSmileSweat}* Oh, uh, Asgore's waiting for you at the force field.",
            '<25>{#g/alphysNeutralSweat}* In case you were wondering.',
            "<25>{#g/alphysOhGodNo}* But, i-if you weren't!!\n* Then...",
            "<25>{#g/alphysTheFactIs}* Well, then I'm not sure why you're here...",
            "<25>{#g/alphysCutscene2}* ... anyway.\n* That's where he is."
         ],
         ...
         choice1a: () => [
            '<25>{#f/1}* For many years, I lamented that we would never reach the stars.',
            ...
            ...(world.bad_robot || world.trueKills > 29
               ...
               : world.bad_lizard > 0 || 2 <= world.alphys_percieved_kills
               ? [
                    '<25>{#f/1}* ...',
         ...
         choice1b: () =>
            world.bad_robot || world.trueKills > 29
               ? [
                    '<25>{#f/1}* In any case, I cannot ask you to enter the archive.',
               ...
               : [
                    [
                       '<25>{#f/6}* As the last to enter, you would act as a vessel.',
         ...
         clover3: [
            "<32>{#p/human}{#v/6}{@fill:#faff29}* It's unlikely we'll be aware of what happened here.",
                    ...
                    ...(SAVE.flag.n.killed_sans > 0
                       ? [
                            ...
                            ...(SAVE.data.b.oops
                               ? []
                               : [
                                    "<32>{#p/basic}* Yeah, I knew you wouldn't be that kind of person.\n* That'd be ridiculous."
                                 ]),
         ...
         epilogue1: () =>
            world.runaway
               ...
               : [
                    ...
                    "<25>{#p/sans}{#f/2}* careful bro, don't overcook it.",
                    "<18>{#p/papyrus}{#f/7}SANS!!!\nI KNOW WHAT I'M DOING!!!",
                    '<25>{#p/sans}{#f/0}* just making sure.',
                    "<18>{#p/papyrus}{#f/6}SO YEAH...\nTURNS OUT ASGORE'S A SPAGHETTI FAN.",
                    ...
                    '<25>{#p/sans}{#f/3}* your skills have certainly been on the rise lately, huh?',
                    '<18>{#p/papyrus}{#f/0}OH, ABSOLUTELY.\nBECAUSE UNTIL NOW...',
                    "<18>{#p/papyrus}{#f/4}I'VE NEVER SEEN A CUSTOMER GET PAST THE FIRST BITE.",
                    "<25>{#p/sans}{#f/0}* maybe THIS is how you'll get into the royal guard, papyrus.",
                    '<25>{#p/sans}{#f/0}* imagine...\n* royal chef papyrus...',
                    "<25>{#p/sans}{#f/2}* i'd be so proud of you.",
                    "<18>{#p/papyrus}{#f/8}SANS...!\nYOU'RE GOING TO MAKE ME CRY!",
                    '<25>{#p/sans}{#f/3}* i am?',
                    "<18>{#p/papyrus}{#f/7}THE CUSTOMERS WON'T WANT TEARS IN THEIR PASTA!",
                    '<18>{#p/papyrus}{#f/6}COME ON!',
         ...
         epilogue2: [
            '<25>{#p/sans}{#f/0}* so you finally woke up, huh?',
            ...
            "<25>{#f/2}* i was just gonna let ya sleep, but i guess they must've woke you up.",
            "<25>{#f/0}* ... anyway.\n* i've been looking for someone myself, y'know.",
            "<25>{#f/3}* you probably know her.\n* name's toriel.",
            '<25>{#f/0}* if you see her, or hear from her, tell her to call me.',
         ...
         hangar1: () =>
            SAVE.data.b.svr
               ...
               : [
                    ...
                    '<25>{#f/1}* Millions of unexplored worlds, some teaming with life...',
            ...
            SAVE.data.b.c_state_secret5_used
               ? SAVE.data.b.c_state_secret1_used
                  ? [
                       ...
                       '<25>{#p/toriel}{#f/3}* Besides, even if I DID want a family, it has been so long...',
                       ...
                       '<25>{#p/toriel}{#f/23}* ...',
                       '<25>{#p/toriel}{#f/23}* I will think about it.'
                    ]
                  : [
                       '<25>{#p/toriel}{#f/1}* ... Asgore, I...',
               ...
               : [ '<25>{#p/toriel}{#f/5}* ...' ],
         hangar9: [],
         hangarE: () => (SAVE.data.b.svr ? [ '<26>{#p/asriel1}{#f/17}* Ready?' ] : [ '<25>{#p/asgore}{#f/6}* Ready?' ]),
         ...
         returnofchara4: [
            ...
            '<32>* ... only kidding.',
            "<32>* I'll let you get the rest you need, partner.",
      ...
      overworld: {
         ...
         tea0: () =>
            SAVE.data.b.svr
               ? [ '<32>{#p/human}* (The note on the envelope pleads that you enjoy the tea.)' ]
               : [
         ...
         tea1: [ '<32>{#p/human}* (You got the Starling Flower Tea.)' ],
         tea2: () =>
            SAVE.data.b.svr
         ...
         ca_floartex: () =>
            [
               ...
               [
                  ...
                  "<32>{#p/human}{#v/5}{@fill:#00c000}* I don't even have an avatar to move around with.",
      ...
      trivia: {
         throne: () =>
            SAVE.data.b.svr
               ? [
                    ...
                    [
                       "<25>{#p/asriel1}{#f/16}* Actually, I do have a theory About Erogot's paintings.",
                       '<25>{#f/13}* You see, according to old homeworld legend...',
         ...
         warningsign: () =>
            SAVE.data.b.svr
               ...
               : SAVE.data.n.plot === 72 || instance('below', 'backdoor')?.object.objects[0].metadata.barrier !== true // NO-TRANSLATE
               ? [ '<32>{#p/human}* (You access the terminal.)', '<32>{#p/basic}* "No further action required."' ]
               : [
                    '<32>{#p/human}* (You access the terminal.)',
         ...
         partysans: pager.create(
            0,
            [
               "<25>{#p/sans}{#f/0}* papyrus's cooking has improved a lot lately.",
               '<18>{#p/papyrus}{#f/0}I KNOW, RIGHT?',
               "<25>{#p/sans}{#f/0}* but there's a lot that goes into a great meal.",
            ...
            [
               "<25>{#p/sans}{#f/0}* i'm not saying undyne meant to, but...\n* c'mon.",
               '<25>{#p/sans}{#f/3}* it would have been nice if she at least double- checked it.',
               "<25>{#p/sans}{#f/2}* even if playing it safe isn't her usual recipe for success."
            ],
            [ "<26>{#p/sans}{#f/3}* at least it's fixed now." ]
         ),
         ...
         ultranote: [
            ...
            '<32>* L-luckily, Papyrus thought to call Asgore once he had you in his "capture zone."',
            '<32>* Then, Asgore called ME, and... I picked you up.\n* Literally.',
            "<32>* We've shut down the elevator to keep the royal guards from coming after you.",
            "<32>* Well, actually, it's mainly j-just to stop Undyne...",
            "<32>* Papyrus must've told her about you at some point, and now she's looking for you...",
            "<32>* U-uh, anyway, once you're awake, you can find us just past Asgore's house.",
            '<32>* See you soon...?'
         ],
         garden: () =>
            SAVE.data.b.svr
         ...
         bastion: pager.create(
            ...
            () => [
               ...
               ...(SAVE.data.n.plot < 71.2 && !world.bad_robot && !world.genocide
         ...
         bastionTerm: () =>
            SAVE.data.n.plot < 71.2
               ? []
               : [
                    '<32>{#p/basic}* This terminal is used only to monitor the archive.',
                    '<32>* What else would it be for?'
                 ],
         alphysEnding: pager.create(
            0,
            () =>
               SAVE.data.n.bully < 15 && world.flirt_state1.length <= world.flirt
                  ? [
                       [
         ...
         cf1_echo1: [
            ...
            '<32>{@fill:#003cff}* That old coot rambling on and on about his royal science duties...',
               ...
               if (distance < 15) {
                  return [
                     [
                        ...
                        '<25>{#f/3}* i wonder what happened.'
                     ],
                     [ '<25>{#p/sans}{#f/2}* maybe she got lost?' ],
                     [ '<25>{#p/sans}{#f/2}* maybe she just had to take a nap.', '<25>{#p/sans}{#f/2}* i can relate.' ],
                     [
                        '<25>{#p/sans}{#f/2}* hey, are you following me around or something?',
         ...
         c_af_window: () =>
            SAVE.data.b.svr
               ? [ '<32>{#p/human}* (You stare graciously into the city beyond...)' ]
         ...
         c_ak_teacheck: () =>
            SAVE.data.b.svr
               ? [
                    [
                       "<25>{#p/asriel1}{#f/17}* Starling tea isn't the only kind Dad likes.",
                       '<25>{#f/17}* He once told me he first fell in love with tea as a kid.',
                       '<25>{#f/13}* Apparently...\n* He used to drink water.',
                       "<25>{#f/31}* Yeah, that stuff you're made of."
                    ],
                    [
                    ...
                    [
                       '<25>{#p/asriel1}{#f/13}* And by "ghost town," I mean a town full of... ghosts.',
                       '<25>{#f/17}* A town full of ghosts who had a fondness for tea.',
                       '<25>{#f/17}* Once Asgore was given some to try, he never looked back.'
                    ],
                    [ "<25>{#p/asriel1}{#f/17}* Dad's interest in starling tea is a more recent thing." ]
         ...
         c_ak_stove: () =>
            SAVE.data.b.svr
               ...
               : [ '<32>{#p/basic}* The stovetop is a little dirty, but not too much.' ],
         c_ak_trash: () =>
            SAVE.data.b.svr
         ...
         c_ah_mirror: () =>
            SAVE.data.b.svr
               ...
               ? [ '<32>{#p/basic}* ...' ]
               : calcLV() > 14
               ? [ '<32>{#p/basic}* Despite everything...', '<32>* ...', '<32>* ... is it really you?' ]
               ...
               i => () =>
                  SAVE.data.b.svr
                     ...
                     ? [
                          ...
                          '<32>* "Regarding the other humans, they have been adopted into monster families."',
                          '<32>* "Their ordeal in the archive was a tragedy, and one I hope they may recover from."',
                     ...
                     : [
                          [
                             ...
                             '<32>* "But there is nothing left to hope for now."',
                             '<32>* "Only pain remains."',
                          ...
                          [
                             ...
                             '<32>* "Dr. Roman and I are doing our best to ensure their safety, but it is a difficult task."',
                          ...
                          [
                             ...
                             '<32>* "Dr. Roman and I have the process of guiding them down to a science now."',
                          ...
                          [
                             ...
                             '<32>* "I write here not due to their arrival, but because Dr. Roman passed away shortly after."',
                             '<32>* "Thomas Nue-Roman."\n* "Your funeral service will take place in a few days."',
                             '<32>* "It is telling that even the brash youngling, Undyne, has prepared a speech for you."',
                             '<32>* "Your work has impacted every life on this outpost, and you will not be forgotten."',
                             ...(world.darker
                                ? []
                                : [ '<32>{#p/basic}* Papyrus, Undyne, and Alphys must have all been children...' ])
                          ],
                          [
                             '<32>{#p/human}* (You look to the next entry.)',
                             '<32>{#p/asgore}* "Asgore\'s diary, K-615.12"',
      ...
      neutral () {
         ...
         const dummyDead = SAVE.data.n.state_wastelands_dummy === 1;
         ...
         if (SAVE.data.b.ubershortcut) {
            // uber shortcut variant [undyne call]
         } else if (SAVE.data.b.ultrashortcut) {
            // ultra shortcut variant [papyrus call]
         } else if (world.bad_robot) {
            const overreaction = alphysKills < 20 && 3 <= royals;
            if (!undyneDead) {
               if (royals === 0) {
                  // dark neutral: lone captain variant [undyne call]
                  if (!torielDead) {
                     // toriel resists outlands takeover, but gets shunned (unpopular opinion)
                  }
               } else {
                  // dark neutral: undyne variant [undyne call]
                  if (overreaction) {
                     // undyne prevents outrage over alphys's overreaction
                  }
               }
            } else if (royals === 1 && !papyrusDead) {
               // dark neutral: therapist papyrus variant [papyrus call]
               if (!doggoDead) {
                  // doggo
               ...
               if (royals === 1) {
                  // last royal guard quits or joins alphys as a scientist
               }
               if (!papyrusDead) {
                  // sans and papyrus join alphys as scientists
               }
            } else if (overreaction) {
               if (!papyrusDead) {
            ...
            const fearsome = helmetdyne || 30 <= SAVE.data.n.bully;
            if (SAVE.data.b.w_state_lateleave) {
               if (undyneDead) {
                  if (fearsome) {
                     // light neutral runaway: fearsome buylly variant [toriel call]
                  } else {
                     // light neutral runaway: queen toriel variant [toriel call]
                  }
               } else {
                  // light neutral runaway: standard variant [alphys call]
                  if (fearsome) {
               ...
               if (!torielDead) {
                  // light neutral: queen toriel variant [alphys call]
                  if (fearsome) {
                     // toriel struggles to calm people down, but succeeds in the end
                  }
               } else if (!muffetDead) {
                  // light neutral: spider queen variant [muffet call]
                  if (fearsome) {
                     // muffet uses people's fear as a tool to control them more easily
                  }
               } else if (!papyrusDead) {
                  // light neutral: king papyrus variant [sans call]
                  if (fearsome) {
                     // papyrus encourages people to put aside their fears
                  }
                  ...
                  if (fearsome) {
                     // sans lets people calm down over time
                  }
               }
               ...
               // light neutral: grey variant [alphys call]
               if (fearsome) {
                  // undyne takes charge to calm people down
               }
            } else {
               ...
               if (fearsome) {
                  // terrestria calms people down by reminding them they're all still alive
               }
            }
         }

         btext.push('<32>{#s/equip}{#p/event}* Click...');
   ...
   b_opponent_alphys: {
      ...
      status1d: [ "<32>{#p/asriel2}* Don't you think she looks tired?" ],
   ...
   b_opponent_archive3: {
      name: () => (battler.volatile[0].sparable ? '* Dr. Roman' : '* 44722e20526f6d616e'),
      status0: [ '<32>{#p/human}* (44722e20526f6d616e takes control of the situation.)' ],
      status1: [ '<32>{#p/human}* (44722e20526f6d616e would like to run some tests on you.)' ],
      ...
      testStatus1: [ '<32>{#p/human}* (44722e20526f6d616e is ready to begin the next test.)' ],
      testStatus2: [ '<32>{#p/human}* (Dr. Roman has served his purpose in this world.)' ],

      act_notesE: [ "<32>{#p/human}* (But 44722e20526f6d616e wasn't ready to exchange notes.)" ],
      act_notesN: [ '<32>{#p/human}* (And Dr. Roman exchanged notes before fading away.)' ]
   },
   b_opponent_archive4: {
   ...
   b_opponent_asriel: {
      ...
      act_check2: () =>
         SAVE.flag.b.pacifist_marker_save1 && SAVE.flag.b.pacifist_marker_save2 && SAVE.flag.b.pacifist_marker_save3
            ? [ '<33>{#p/story}* ASRIEL DREEMURR - ATK{^2}\u1b39{^1} DEF\u1b39\n* ...' ]
            : SAVE.data.b.oops
      ...
      item: {
         tvm_mewmew: {
            ...
            talk: [
               ...
               [ '<11>{#p/alphys}{#e/alphys/8}Oh, so NOW you give it back to me.' ]
            ]
         },
         orange_soda: {
            text: [
         ...
         pager.create(
            ...
            () =>
               1 <= SAVE.flag.n.killed_sans
                  ...
                  : [ "<11>{#p/sans}why even try?\nit's not worth it." ],
            () =>
               1 <= SAVE.flag.n.killed_sans
                  ? [ "<11>{#p/sans}you've killed me before, haven't you?" ]
                  : [ '<11>{#p/sans}everything has its time, and everything dies.' ],
            () =>
               1 <= SAVE.flag.n.killed_sans
                  ? [ "<11>{#p/sans}you don't have the right to save us anymore." ]
                  : [ '<11>{#p/sans}are you really doing the right thing?' ]
         )
      ],
      item: {
         berry: {
         ...
         spaghetti: {
            ...
            talk: [
               ...
               [ '<11>{#p/sans}{#e/sans/2}that they did.' ]
            ]
         },
         corndog: {
            text: [
   ...
   b_opponent_final: {
      ...
      act_check: [
         '<32>{#p/story}* FORCE FIELD - ATK 0 DEF 255\n* Immovable meets unstoppable.\n* The end of the line.'
      ],
      status1: () =>
         SAVE.data.n.bully > 9
      ...
      friend32a: [
         ...
         "<20>{#p/mettaton}{#e/undyne/38}{#e/papyrus/21}IT'S JUST FOR PEOPLE LIKE PAPYRUS AND ME."
      ],
      ...
      friend66: () =>
         SAVE.flag.n.genocide_milestone < 7
            ? [
                 [
                    '<20>{#p/twinkly}{#e/twinkly/5}{#v/0}Howdy, everyone.',
                    "<20>{#e/twinkly/7}{#v/0}I'm Twinkly.",
                    '<20>{#e/twinkly/2}{#v/1}Twinkly the star.'
                 ],
                 [
      ...
      friend67: () => [
         ...
         ...(30 <= SAVE.data.n.bully
            ...
            : [
                 ...
                 '<20>{#e/twinkly/8}{#v/0}But no matter what, you chose to let them go...'
              ]),
         ...(1 <= SAVE.flag.n.killed_sans
            ? [
                 '<20>{#e/twinkly/8}{#v/0}...',
                 ...
                 ...(SAVE.data.b.oops ? [] : [ '<32>{#p/basic}* What?' ]),
                 ...
                 ...(SAVE.data.b.oops ? [] : [ '<32>{#p/basic}* ... uh...' ]),
