...
[ "特別鳴謝 由§fill=#ff0§Mavis與朋友們§fill=#fff§提供" ]
      ...
      langPrompt: "[UP or DOWN] to Select / [ENTER] to Confirm",
      ...
      title: "OUTERTALE (BETA V30)",
      title_timeline: "OUTERTALE...? (BETA V30)"
   },
   ...
   menu: {
      ...
      story6: [ "<24>許多年後.{^16}.{^16}.{}" ],
      story7: [ "<#24>µµµµµµµ EBOTT區 µµµµ \nµµµµµµµµ 251X{^20}{}" ],
