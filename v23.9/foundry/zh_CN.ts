...
import { armorprice, badSpider, dogecon, dogex, geno, ghostpartyCondition, respecc } from '../../code/foundry/extras';
...
const text = {
   a_foundry: {
      ...
      darktoriel5a: [
         "<25>{#p/toriel}{#f/5}* ...嗯？\n* 你还有话要跟我说？",
         "<32>{#p/human}* （你重复Toriel在Archive Six中\n  给你的建议。）",
         "<25>{#p/toriel}{#f/2}* ...",
         "<25>{#f/1}* 这些话...",
         "<25>{#f/1}* 你怎么可能听过...？",
      ...
      darktoriel7: () =>
         SAVE.data.b.c_state_secret1_used
            ...
            : [
                 "<25>{#p/toriel}{#f/5}* Frisk，你得给我时间处理一下。",
                 "<25>{#f/1}* 运输船上见。\n* 好吗？"
              ],
      ghostpartymusic1: [
      ...
      tome4: () => [
         choicer.create(
            ...
            "Spare",
            world.meanie ? "Bully" : world.flirt > 9 ? "调情" : SAVE.data.b.oops ? "Befriend" : "Hug",
            "Kill",
            "Take Gold"
         )
      ],
      ...
      napcomputer1: pager.create(0, () => [
         ...
         choicer.create("* (View the opened application?)", "是", "否")
      ]),
      ...
      run2a2: [ "<32>{#p/undyne}* ...", "<32>{#p/undyne}* This better be good." ],
   ...
   b_opponent_doge: {
      ...
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ...
            ? [ "<32>{#p/human}* （你向Doge调情。）", "<32>{#p/basic}* Doge giggles playfully." ]
            ...
            : world.flirt < 10
            ? [ "<32>{#p/human}* （你向Doge调情。）", "<32>{#p/basic}* Doge tries not to react in any strong way." ]
   ...
   i_goggles: {
      ...
      drop: [ "<32>{#p/human}* （你把AR护目镜扔掉了。）" ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ "<32>{#p/human}* (6 DF.)" ]
            : [ "<32>{#p/basic}* “AR护目镜” （6防御）\n* 超越现实！ \n  能为你提供更长的喘息时间。" ],
      name: "AR护目镜",
   ...
   i_quiche: {
      ...
      use: () => [
         ...
         (fetchCharacters()
            ...
            ? [
                 "<25>{#p/sans}{#f/0}* ... oh.\n* you actually ate it?",
                 "<25>{#p/sans}{#f/2}* i had no idea anyone actually liked my baking skills."
              ]
            : [])
      ]
   },
   ...
   n_shop_tem: {
      ...
      item: (armorprice: number) =>
         SAVE.data.n.plot === 72
            ? [
                 ...
                 "0G - free flake!!",
                 "0G - free flake!!",
                 SAVE.data.b.item_temyarmor || world.runaway
      ...
      itemUnavailable: () => (world.runaway ? "<09>{#p/basic}空无一物。" : "<09>{#p/tem}{#k/2}no more item..."),
      itemRestricted: "<09>{#p/tem}{#k/2}not for sale...",
      menu: () =>
         world.runaway ? [ "拿取", "偷窃", "阅读", "Exit" ] : [ "购买", world.meanie ? "偷窃" : "出售", "交谈", "Exit" ],
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? "Your Future" : SAVE.data.b.colleg ? "About Temmie Armor" : "介绍下自己",
   ...
   n_shop_tortoise: {
      ...
      item: () =>
         world.runaway
            ? [ "0G - Datapad?", "0G - AR护目镜？", "0G - Nebula Tea", "0G - Tree Sap", "Exit" ]
            : world.genocide || world.killed0 || SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE

            ? [ "45G - Datapad?", "45G - AR护目镜？", "16G - Nebula Tea", "25G - Tree Sap", "Exit" ]
            : SAVE.data.n.plot === 72
            ? [
                 SAVE.data.b.item_padd ? "25G - Datapad?" : "35G - Datapad",
                 SAVE.data.b.item_goggles ? "25G - AR护目镜？" : "35G - AR护目镜",
                 "5G - Nebula Tea",
                 "5G - Tree Sap",
                 "Exit"
              ]
            : [
                 ...
                 SAVE.data.b.item_goggles ? "45G - AR护目镜？" : "55G - AR护目镜",
                 "16G - Nebula Tea",
                 "25G - Tree Sap",
                 "Exit"
              ],
      itemInfo: () => [
         SAVE.data.b.item_padd || world.genocide || world.killed5
            ? "Weapon: 0AT\n($(x) AT)\nJust a bit\ninvincible."
            : "Weapon: 2AT\n($(x) AT)\nInvincible\nlonger.",
         SAVE.data.b.item_goggles || world.genocide || world.killed5
            ? "Armor: 4DF\n($(x) DF)\nJust a bit\ninvincible."
            : "Armor: 6DF\n($(x) DF)\nInvincible\nlonger.",
         "Heals 15HP\nSPEED\nup in\nbattle.",
         "Heals 35HP\nMade from\na real\ntree."
         ...
         SAVE.data.n.plot === 72
            ...
            : [
                 48 <= SAVE.data.n.plot && SAVE.data.n.state_foundry_undyne > 0
                    ? "介绍下自己"
                    : [ "介绍下自己", "§fill:#ff0§The War (NEW)", "§fill:#ff0§Retirement (NEW)", "Retirement" ][
