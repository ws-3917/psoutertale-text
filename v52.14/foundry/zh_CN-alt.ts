      ...
      npcinter: {
         ...
         f_temmie4: () =>
            SAVE.data.n.plot === 72
               ...
               ? [
                    [ '<32>{*}{#p/tem}{#i/5}{#s.stop}* 我知道你做了什么。', '{*}{#s.resume}{%}' ],
   ...
   b_opponent_doge: {
      ...
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ...
            ? [ '<32>{#p/human}* （你向督吉调情。）', '<32>{#p/basic}* Doge smiles in return.' ]
      ...
      petTextPost1: [
         '<32>{#p/human}* （你还想试着抚摸督吉。）',
         "<32>{#p/basic}* Doge laps up your love like it's the first time she's been cared for in years..."
      ],
      petTextPost2: [ '<32>{#p/human}* （你再一次试着抚摸督吉。）', '<32>{#p/basic}* Doge has reached nirvana.' ],
