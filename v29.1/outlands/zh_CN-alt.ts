...
export default {
   ...
   b_opponent_froggit: {
      ...
      act_threat2: [
         ...
         "<32>{#p/basic}* 这让蛙吉特想起了你先前的恐吓，所以他决定撒腿跑路。"
      ],
      act_compliment: [
   ...
   b_opponent_mushy: {
      ...
      challengeTalk2: [ "<08>{#p/basic}{~}是想着要把我打败吗？" ],
   ...
   c_call_outlands: {
      about1: [
         "<25>{#p/toriel}{#f/1}* 你是想了解我的更多...对吗？",
         "<25>{#f/0}* 嗯，我怕我没有什么可以跟你讲的。",
         "<25>{#f/0}* 我只不过是一位爱瞎操心的老阿姨罢了！"
      ],
      about2: [
      ...
      flirt1: [
         ...
         "<25>{#f/1}* 哦, 嘻... 嘻嘻...",
         "<25>{#f/6}* 哈哈哈！\n* 让我捏捏你的小脸蛋！",
         "<25>{#f/0}* 你肯定能找到比我这种老阿姨更好的人！"
      ],
      flirt2: [
         "<25>{#p/toriel}{#f/7}* ...\n* 哦亲爱的, 你是认真的吗...？",
         "<25>{#f/1}* 我实在不知道是喜还是悲，我的孩子。"
      ],
      flirt3: [
         "<25>{#p/toriel}{#f/7}* ...\n* 哦亲爱的, 你是认真的吗...？",
         "<25>{#f/5}* 先前你还叫我“妈妈”来着...",
