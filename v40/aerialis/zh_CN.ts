   ...
   a_aerialis: {
      ...
      story: {
         ...
         barricade1: () => [
            ...
            "<25>{#g/alphysGarbo}* Mettaton的安保问题...",
         ...
         barricade1b1: [
            ...
            '<25>{#g/alphysFR}* 我才不喜欢Mettaton呢。',
            "<25>{#g/alphysCutscene2}* 试试... Asgore。"
         ],
         ...
         barricade2: () => [
            ...
            choicer.create('* (What do you say?)', 'MTT美妆', 'MTT烹饪', 'MTT科技', 'MTT卫视')
         ],
         barricade2b1: [
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 ...
                 [ 'Alphys', '§fill=#ff0§Royal Scientist (NEW)', '§fill=#ff0§Asgore（新）', 'Asgore' ][
