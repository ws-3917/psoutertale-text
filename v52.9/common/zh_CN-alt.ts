...
export default {
   ...
   a_common: {
      ...
      end1: [
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* 一号应急预案已生效。{^20}{%}',
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* 正在启动自毁程序。{^20}{%}'
      ],
      end2: [
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* 一号应急预案已生效。{^20}{%}',
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* 自毁程序已远程终止。{^20}{%}',
         '<25>{*}{#p/asgore}{#f/6}{#v/1}* 系统即将关闭。{^20}{%}'
      ],
   ...
   b_opponent_spacetop: {
      ...
      createStatus2: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* Astro Serf.' ] : [ '<32>{#p/story}* 太空帽被打动了。' ],
