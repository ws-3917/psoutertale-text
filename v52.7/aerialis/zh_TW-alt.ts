...
export default {
   a_aerialis: {
      ...
      corndog4: () =>
         [
            [ '<32>{#p/human}* （你得到了玉米熱狗。）', '<25>{#p/sans}{#f/2}* enjoy.' ],
            [
               '<32>{#p/human}* （你得到了玉米熱羊。）',
      ...
      elevator1: () => [
         choicer.create('* （你想去哪裡？）', '取消', 'CORE Start', 'CORE End', '首塔')
      ],
      elevatorStory1: () => [ choicer.create('* （你想去哪裡？）', 'CORE Start', '取消') ],
      elevator2: () => [
         choicer.create('* （你想去哪裡？）', '空境', '取消', 'CORE End', '首塔')
      ],
      elevatorStory2: () => [ choicer.create('* （你想去哪裡？）', '空境', '取消') ],
      elevator3: () => [
         choicer.create('* （你想去哪裡？）', '空境', 'CORE Start', '取消', '首塔')
      ],
      elevatorStory3: () => [ choicer.create('* （你想去哪裡？）', '首塔', '取消') ],
      elevator4: () => [
         choicer.create('* （你想去哪裡？）', '空境', 'CORE Start', 'CORE End', '取消')
      ],
   ...
   n_shop_gossip: {
      ...
      menu: () =>
         adultEvac() ? [ '拿取', '偷竊', '閱讀', 'Exit' ] : [ '購買', world.meanie ? '偷竊' : '出售', '交談', 'Exit' ],
