...
export default {
   a_aerialis: {
      ...
      elevator1: () => [
         choicer.create('* （你想去哪里？）', '取消', 'CORE Start', 'CORE End', '首塔')
      ],
      elevatorStory1: () => [ choicer.create('* （你想去哪里？）', 'CORE Start', '取消') ],
      elevator2: () => [
         choicer.create('* （你想去哪里？）', '空境', '取消', 'CORE End', '首塔')
      ],
      elevatorStory2: () => [ choicer.create('* （你想去哪里？）', '空境', '取消') ],
      elevator3: () => [
         choicer.create('* （你想去哪里？）', '空境', 'CORE Start', '取消', '首塔')
      ],
      elevatorStory3: () => [ choicer.create('* （你想去哪里？）', '首塔', '取消') ],
      elevator4: () => [
         choicer.create('* （你想去哪里？）', '空境', 'CORE Start', 'CORE End', '取消')
      ],
   ...
   n_shop_gossip: {
      ...
      menu: () =>
         adultEvac() ? [ '拿取', '偷窃', '阅读', 'Exit' ] : [ '购买', world.meanie ? '偷窃' : '出售', '交谈', 'Exit' ],
