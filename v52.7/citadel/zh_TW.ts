   ...
   a_citadel: {
      ...
      story: {
         ...
         bad13: () => [
            ...
            '<99>{#p/twinkly}{#v/1}真不愧是我的好兄弟。{^100}{%}',
      ...
      overworld: {
         ...
         cs_vender1: [ '<32>{#p/human}* (You tap on the panel.)', '<32>{#s/equip}{#p/human}* （你得到了洋梅。）' ],
         ...
         cf2_vender1: [ '<32>{#p/human}* (You tap on the panel.)', '<32>{#s/equip}{#p/human}* （你得到了口糧。）' ],
