...
export default {
   a_starton: {
      ...
      papyrusFinal7: [
         ...
         "<18>{#f/5}我們要不要就\n不戰鬥了...",
         "<18>{#f/5}...我直接\n放你走呢？",
         choicer.create("* （你要怎麼回答？）", "放我走吧", "咱們再戰")
      ],
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      ...
      s_backrooms: pager.create(
         ...
         () =>
            solo()
               ? [ "<18>{#p/papyrus}{#f/4}是某種「廚房」...", "<18>{#f/5}現在他們只把這裡\n當成玩私人紙牌\n遊戲的地方了。" ]
               : [
