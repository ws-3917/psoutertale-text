...
export default {
      ...
      trivia: {
         ...
         w_tt_chair: () =>
            SAVE.data.b.svr
               ...
               : [ "<32>{#p/basic}* Toriel的专用阅读椅。", "<32>* Smells like lazy bones." ],
   ...
   c_call_tunnel: pager.create(
      0,
      [ "<25>{#p/toriel}{#f/5}* Frisk？", "<25>{#f/5}* 是你吗？" ],
      [ "<25>{#p/toriel}{#f/5}* 你好...？" ],
      [ "<25>{#p/toriel}{#f/5}* ..." ]
   ),
