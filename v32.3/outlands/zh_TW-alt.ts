...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         d46: [ "<25>{#p/asriel1}{#f/25}* 弗里斯克，你在那裡嗎？", "<25>{#f/22}* 拜託了... 醒來吧..." ],
      ...
      chair2d4: [
         ...
         "<32>{#p/human}{#n1!}* （你要怎麼回答？）{!}\nµµµµµµµµ　　　　　µµµµµ怎麼才能\nµµµµµµµµ別放在心上µµµµµ離開外域{#c/0/8/6}"
      ],
            ...
            () =>
               SAVE.data.b.napsta_performance
                  ? [
                       ...
                       choicer.create("{#n1!}* （買下這本漫畫嗎？）", "買", "不買")
                    ]
                  : [
                       ...(world.postnoot
                          ? [
      ...
      trivia: {
         ...
         w_pacing3: () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    "<32>{#p/basic}* 呱呱，呱呱。\n* （如果你把一隻怪物打到了\n  瀕死的程度...）",
                    "<32>* （它的名字就會變成{@fill=#003cff}藍色{@fill=#fff}。）",
                    "<32>* （很奇怪，對吧？）\n* （但我聽說，人類被打了之後\n  也會變{@fill=#003cff}藍{@fill=#fff}受呢。）",
                    "<32>* （所以我覺得，\n  你應該是可以聯想得到的。）",
                    "<32>* （那麼，感謝你花時間\n  聽我嘮叨這些。）\n* 呱呱。"
                 ],
         w_puzzle1_view: () =>
   ...
   c_call_tunnel: pager.create(
      0,
      [ "<25>{#p/toriel}{#f/5}* 弗里斯克？", "<25>{#f/5}* 是你嗎？" ],
      [ "<25>{#p/toriel}{#f/5}* 你好...？" ],
      [ "<25>{#p/toriel}{#f/5}* ..." ]
   ),
