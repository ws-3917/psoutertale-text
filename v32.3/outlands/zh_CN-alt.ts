...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         d13: [ "<32>{#p/basic}* 别伤心，艾斯利尔。", "<32>* 没必要逼自己觉得\n  我是个好人。" ],
      ...
      asrielDiary: [
         ...
         [
            ...
            "<32>* “妈妈 shuō 我应 gāi 把 日其月 写上\n   不rán 别人 不知到\n   我nǎ 天写的日计”",
            "<32>* “我的 xīngxīng花还是没有开\n  但 bàbà shuō 马上jiù会开”",
         ...
         [
            ...
            "<32>* “我将其从废墟中拉了出来，\n   那人类对我道了谢。”",
            "<32>* “我都没想到有一天\n   居然真的见到了人类。”",
            "<32>* “而且，人类{#p/basic}闂彞{#p/asriel1}{#v/1}呭{#p/basic}浜哈哈哈艾利\n   你真是个大hún求掓潏{#p/asriel1}{#v/1}銊{#p/basic}焼{#p/asriel1}{#v/1}呭镬{#p/basic}拷{#p/asriel1}{#v/1}伞”",
            "<32>* “好，现在我躲到被窝里\n   $(name)应该没法再乱写乱画了。”",
            "<32>* “有时，$(name)会稍微有点淘气，\n   不过我不介意。”",
            "<32>* “妈妈让$(name)进入战斗，\n   发现$(name)的心心是红色的，\n   方向也是反的。”",
            "<32>* “多个能每天陪我聊天的伙伴\n   真是太棒了。”"
      ...
      chair4: [ "<25>{#p/toriel}{#n1!}* 啊，你醒了。", "<25>* 我已经把你的那份早餐\n  放在桌子上了。" ],
      closetrocket: {
         a: () => [
         ...
         ...([ 1, 5 ].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
            ? [
                 early
                    ...
                    : "<25>{#p/toriel}{#g/torielTired}* ...待得不耐烦了？",
                 "<25>{#f/9}* 没事，我已经猜到了。",
                 "<25>{#f/5}* 只是，提醒你一下，\n  外面有很多危险等着你...",
                 "<25>{#f/1}* 保护好自己，别受伤了。"
              ]
      ...
      loox: {
         a: [
            "<32>{#p/basic}{#n1}* 我听说，\n  作为人类的你很喜欢调情。",
            "<32>* 每当你对各式各样的怪物{@fill=#cf7fff}调情{@fill=#fff}时，\n  他们名字的右上角会出现一颗心。",
            ...
            () =>
               SAVE.data.b.napsta_performance
                  ? [
                       ...
                       choicer.create("{#n1!}* （买下这本漫画吗？）", "买", "不买")
                    ]
                  : [
                       ...(world.postnoot
                          ? [
      ...
      steaksale: {
         ...
         b: () => [
            ...
            choicer.create("* （要买它吗？）", "买", "不买")
         ],
         b1: [ "<32>{#p/human}{#n1!}* （你得到了滋滋牛排。）", "<32>{#p/basic}{#n1}* 绝佳的选择，亲 ;)" ],
         b2: [ "<32>{#p/human}{#n1!}* （你决定不去买它。）" ],
         c: () => [
            SAVE.data.b.napsta_performance
               ? world.darker
      ...
      trivia: {
         ...
         w_pacing3: () =>
            SAVE.data.n.plot === 72
               ...
               : [
                    "<32>{#p/basic}* 呱呱，呱呱。\n* （如果你把一只怪物打到了\n  濒死的程度...）",
                    "<32>* （它的名字就会变成{@fill=#003cff}蓝色{@fill=#fff}。）",
                    "<32>* （很奇怪，对吧？）\n* （但我听说，人类被打了之后\n  也会变{@fill=#003cff}蓝{@fill=#fff}受呢。）",
                    "<32>* （所以我觉得，\n  你应该是可以联想得到的。）",
                    "<32>* （那么，感谢你花时间\n  听我唠叨这些。）\n* 呱呱。"
                 ],
         w_puzzle1_view: () =>
         ...
         w_tt_chair: () =>
            SAVE.data.b.svr
               ...
               : [ "<32>{#p/basic}* 托丽尔的专用阅读椅。", "<32>* Smells like lazy bones." ],
      ...
      twinkly21: [
         ...
         "<25>{#f/1}* 受伤了吗？",
         "<25>{#f/0}* ...\n* 请原谅我问了这么多问题。",
         "<25>{#f/0}* 我是{@fill=#003cff}托丽尔{@fill=#000}，\n  {@fill=#f00}外域{@fill=#000}的管理员。",
         "<26>{#f/0}* 我每天都会来看看\n  有没有人被困在这里。",
         "<25>{#f/0}* 跟我来，孩子。\n* 我有很多东西要教你。"
      ],
   ...
   b_opponent_migosp: {
      ...
      act_flirt: [ "<32>{#p/human}* （你对Silente调情。）" ],
   ...
   b_opponent_toriel: {
      spannerText: [ "<32>{#p/human}* （你把扳手丢了出去。）\n* （托丽尔捡起扳手，还给了你。）" ],
      ...
      cutscene2: [
         ...
         "<25>{#p/toriel}{#f/13}* ...",
         "<25>{#p/toriel}{#f/13}* ...但我要是放这孩子走，我就没法...",
         "<32>{#p/basic}* 陪伴他，保护他了？",
   ...
   c_call_tunnel: pager.create(
      0,
      [ "<25>{#p/toriel}{#f/5}* 弗里斯克？", "<25>{#f/5}* 是你吗？" ],
      [ "<25>{#p/toriel}{#f/5}* 你好...？" ],
      [ "<25>{#p/toriel}{#f/5}* ..." ]
   ),
