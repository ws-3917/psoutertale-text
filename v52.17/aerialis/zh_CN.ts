   ...
   a_aerialis: {
      ...
      story: {
         ...
         barricade3b2: [
            ...
            '<25>{#g/alphysNeutralSweat}* 还是说你正打算\n  这么做！？',
            '<25>{#g/alphysNeutralSweat}* ...',
         ...
         cooker4a: [ '<32>{#p/mettaton}* 好极了！', '<32>* 现在，请允许我...' ],
         cooker4b: [ '<32>{#p/mettaton}* 好的！', "<32>* 我们要用这些东西..." ],
         cooker5: () =>
            iFancyYourVilliany()
         ...
         cooker8b: () =>
            iFancyYourVilliany()
               ...
               : [
                    "<32>* 然后，为了增加紧张感，\n  你需要在{@fill=#ff0}九十秒{@fill=#fff}内跨越这条鸿沟..."
                 ],
         cooker9: () =>
            iFancyYourVilliany()
               ? [
               ...
               : [ "<32>{#p/mettaton}* 在你被{@fill=#f00}炸成碎片{@fill=#fff}前完成！" ],
