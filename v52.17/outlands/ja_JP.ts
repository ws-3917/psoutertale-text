...
export default {
   a_outlands: {
      ...
      loox: {
         a: [
            ...
            "<17>＊モンスターに　{@fill=#cf7fff}くどいた{@fill=#fff}あと　そのなまえの　みぎうえに　「{@fill=#cf7fff}\u3917{@fill=#fff}」マークが　ひょうじされます。",
      ...
      w_coffin0: () => [
         '<17>{#p/human}＊(もう　みないほうが　いいと　おもいます)',
   ...
   b_opponent_toriel: {
      ...
      cutscene1: [
         "<17>{#p/basic}＊たぶん君　私の言うことしか　真剣に聞いてくれないからでしょう。",
         '<13>{#p/toriel}{#f/16}＊…！？',
         "<17>{#p/basic}＊でも　何も知らない子供の私に　どんな理屈を　言うつもりなんですか。"
      ],
      cutscene2: [
         '<25>{#p/toriel}{#f/3}* ...',
         '<13>{#p/toriel}{#f/4}＊むりだ…',
   ...
   i_delta: {
      ...
      name: 'カンナビノイド',
      use: [ '<18>{#p/human}＊(カンナビノイドを　すっていました)' ]
   },
   i_halo: {
      battle: {
