...
export default {
   ...
   n_shop_blook: {
      exit: [ "<32>{#p/napstablook}{#k/0}* 喔... 你要走了...", "<32>{#k/1}* 行，下次再見，也許吧..." ],
      item: () =>
         blookGone()
            ? [
                 "§fill=#808080§---- 售罄 ----",
