   ...
   a_aerialis: {
      ...
      story: {
         ...
         barricade2b3: [
            ...
            '<25>{#g/alphysHellYeah}* ...',
            "<25>{#g/alphysWelp}* 你觉得... Mettaton的\n  烹饪节目怎么样？"
         ],
         barricade2b4: [
            '<25>{#p/alphys}{#g/alphysWorried}* 我反正不知道...',
            "<25>{#g/alphysWelp}* 最近Mettaton的电视节目\n  收视率都不太好。",
            '<25>{#g/alphysWTF}{#x1}* ...',
            '<25>{#g/alphysWTF2}* 答对了！？',
               ...
               SAVE.data.n.state_foundry_muffet === 1 && SAVE.data.b.colleg
                  ? [
                       iFancyYourVilliany()
                          ...
                          : '<32>{#p/mettaton}* TEMMIE，由于你比人类早猜中...',
                       "<32>{#p/mettaton}* 恭喜!\n* 你赢得了属于你自己的\n  老式地球收音机！",
                       '<32>{#p/tem}* 呜哇哦哇哦哇哦.....'
                    ]
                  : [
                       iFancyYourVilliany()
                          ...
                          : '<32>{#p/mettaton}* BLOOKY，由于你比人类早猜中...',
                       "<32>{#p/mettaton}* 恭喜!\n* 你赢得了属于你自己的\n  老式地球收音机！",
                       world.scared_ghost ? '<32>{#p/napstablook}* 酷' : '<32>{#p/napstablook}* 唔唔唔唔唔唔唔'
                    ],
            g: () => [
               SAVE.data.n.state_foundry_muffet === 1 && SAVE.data.b.colleg
                  ? iFancyYourVilliany()
                     ...
                     : '<32>{#p/mettaton}* 人类，由于你比TEMMIE早猜中...'
                  : iFancyYourVilliany()
                  ? '<32>{#p/mettaton}* WELL PLAYED, $(moniker3u).\n* SINCE YOU GUESSED BEFORE BLOOKY...'
                  : '<32>{#p/mettaton}* 人类，由于你比BLOOKY早猜中...',
               "<32>{#p/mettaton}* 恭喜!\n* 你赢得了属于你自己的\n  老式地球收音机！"
            ]
         },
         moneyVote1: () => [
         ...
         moneyVote4a2: [ "<32>{#p/mettaton}* 看来，你【不】打算投票。", '<32>* 好的。' ],
         moneyVote4a3: () => [
