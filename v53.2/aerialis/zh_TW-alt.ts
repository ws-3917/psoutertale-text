...
export default {
   a_aerialis: {
      ...
      story: {
         ...
         barricade2: () => [
            ...
            choicer.create('* （你要怎麼回答？）', '鎂塔美妝', '鎂塔烹飪', '鎂塔科技', '鎂塔電視臺')
         ],
         barricade2b1: [
            "<25>{#p/alphys}{#g/alphysCutscene2}* 沒錯... 這個應該就是\n  正確答案。",
            '<25>{#g/alphysTheFactIs}* 他真的很希望他的電視節目\n  火起來，但是...',
            '<25>{#g/alphysUhButHeresTheDeal}* 大家確實很喜歡他的\n  美容產品！'
         ],
         barricade2b2: [
            '<25>{#p/alphys}{#g/alphysYeahYouKnowWhatsUp}* 這附近肯定有很多\n  鎂塔牌的廚房用電器...',
            "<25>{#g/alphysWelp}* 可惡，安黛因倒是有一個，\n  但她根本就不喜歡那傢伙。",
            "<25>{#g/alphysSmileSweat}* ...行吧，咱們試一下。"
         ],
         barricade2b3: [
            '<25>{#p/alphys}{#g/alphysFR}* ...',
            "<25>{#g/alphysFR}* 我就當你沒回答過吧。",
            "<25>{#g/alphysHellYeah}* 出技術問題了該找的是我，\n  這不是共識嗎？",
            '<25>{#g/alphysHellYeah}* ...',
            "<25>{#g/alphysWelp}* 你覺得... 鎂塔頓的\n  烹飪節目怎麼樣？"
         ],
         barricade2b4: [
            '<25>{#p/alphys}{#g/alphysWorried}* 我反正不知道...',
            "<25>{#g/alphysWelp}* 最近鎂塔頓的電視節目\n  收視率都不太好。",
            '<25>{#g/alphysWTF}{#x1}* ...',
            '<25>{#g/alphysWTF2}* 答對了！？',
            '<25>{#g/alphysCutscene3}* ...你是怎麼知道這些的？',
            '<25>{#g/alphysUhButHeresTheDeal}* 好，就剩一個了！'
         ],
         barricade3: () => [
            '<32>{#p/event}* 鈴鈴，鈴鈴...',
         ...
         barricade3b2: [
            ...
            '<25>{#g/alphysNeutralSweat}* 還是說你打算\n  告訴別人！？',
            '<25>{#g/alphysNeutralSweat}* ...',
         ...
         cooker1b: [ "<32>{*}{#p/mettaton}* 歡迎來到前哨戰的首期手藝節目！{^30}{%}" ],
         cooker2a1: () =>
            iFancyYourVilliany()
         ...
         cooker12: () =>
            SAVE.data.n.state_foundry_undyne > 0
               ...
               : [
                    ...
                    '<25>{#g/alphysCutscene1}* 我有個方法，\n  可以幫你飛過去！',
                    "<25>{#g/alphysNervousLaugh}* 雖然...其實...",
                    "<25>{#g/alphysSmileSweat}* 雖然比不上安黛因的，\n  但是，我給你的那部\n  手機裡...",
         ...
         moneyChat3: () =>
            world.scared_ghost
               ? [ "<32>{#p/napstablook}* it's your turn.", "<32>{#p/human}* (但你無話可說。)" ]
               : [
                    '<32>{#p/napstablook}* 呃......',
                    '<32>* 你可以開始講了？',
                    "<32>{#p/human}* (但你無話可說。)"
            ...
            g: () => [
               SAVE.data.n.state_foundry_muffet === 1 && SAVE.data.b.colleg
                  ? iFancyYourVilliany()
                     ...
                     : '<32>{#p/mettaton}* 人類，由於你比提米早猜中...'
                  : iFancyYourVilliany()
                  ? '<32>{#p/mettaton}* WELL PLAYED, $(moniker3u).\n* SINCE YOU GUESSED BEFORE BLOOKY...'
                  : '<32>{#p/mettaton}* 人類，由於你比小幽早猜中...',
               "<32>{#p/mettaton}* 恭喜!\n* 你贏得了屬於你自己的\n  老式地球收音機！"
            ]
         },
         moneyVote1: () => [
         ...
         moneyVote4a2: [ "<32>{#p/mettaton}* 看來，你【不】打算投票。", '<32>* 好的。' ],
         moneyVote4a3: () => [
         ...
         moneyVote5b: [ '<32>{#p/mettaton}* 你知道這投票是為了淘汰，\n  對吧？' ],
         moneyVote5c: () =>
            SAVE.data.n.state_foundry_muffet === 1
               ? [
                    '<32>{#p/tem}* 等等...',
         ...
         opera17: () =>
            world.genocide ? '朋|友|啊...' : iFancyYourVilliany() ? 'Oh |how |sad...' : '愛|人|啊...',
         opera18: () =>
            world.genocide
         ...
         opera21: () =>
            world.genocide ? 'But |be|fore...' : iFancyYourVilliany() ? "I'll |ad|mit..." : '人|類|必...',
         opera22: () =>
            world.genocide
               ? 'I |kill |you |dead...'
               : iFancyYourVilliany()
               ...
               : '應|住|遠|方...',
         opera23: () =>
            world.genocide ? "Let's |re|hearse..." : iFancyYourVilliany() ? "But |you're |just..." : '即|使|將...',
         opera24: () =>
            world.genocide
               ? "The |life |you've |led..."
               : iFancyYourVilliany()
               ...
               SAVE.data.n.plot === 72
                  ...
                  ? iFancyYourVilliany()
                     ...
                     : [
                          ...
                          [ '<32>{#p/basic}{#npc/a}* 要麼就單純是鎂塔節目組他們\n  對你手下留情了。' ]
                       ][SAVE.data.n.state_aerialis_crafterresult]
                  : [
   ...
   b_opponent_pyrope: {
      ...
      idleTalk1: [ '<08>{#p/basic}{~}管他什麼烈焰\n在燃燒', '<08>{#p/basic}{~}我就這樣無畏\n且驕傲！' ],
   ...
   b_opponent_rg01: {
      ...
      randTalkLone2: () =>
         world.bad_lizard > 1
            ? [ '<11>{#p/basic}{~}{@random=1.1/1.1}不可饒恕。' ]
   ...
   b_opponent_rg02: {
      ...
      randTalkLone3: () =>
         world.bad_lizard > 1
            ? [ '<11>{#p/basic}{~}{@random=1.1/1.1}我滅了你！！' ]
            : [ '<11>{#p/basic}{~}{@random=1.1/1.1}She was everything to me...!' ],
      randTalkLone4: () =>
         world.bad_lizard > 1
            ? [ "<11>{#p/basic}{~}{@random=1.1/1.1}給我付出代價！！" ]
