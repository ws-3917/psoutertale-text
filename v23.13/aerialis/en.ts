   ...
   a_aerialis: {
      ...
      corndog1: pager.create(
         ...
         [
            ...
            choicer.create('* (Buy a Corn Dog?)', 'Yes', 'No')
         ],
         [ '<25>{#p/sans}{#f/0}* corn dogs for 5G.', choicer.create('* (Buy a Corn Dog?)', 'Yes', 'No') ]
      ),
      corndog2: [
      ...
      candy1: pager.create(
         ...
         () => [
            ...
            choicer.create('* (Buy a filament for 40G?)', 'Yes', 'No')
         ],
         [ choicer.create('* (Buy a filament for 40G?)', 'Yes', 'No') ]
      ),
         ...
         alphys11: {
            ...
            pm: () =>
               SAVE.data.n.state_starton_papyrus === 0
                  ...
                  : 'oh yeah i remember that' // papyrus is dead
         },
         alphys12: {
