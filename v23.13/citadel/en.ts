...
import { battler, calcLV, choicer, instance, pager, player, world } from '../../code/systems/framework';
...
const text = {
   a_citadel: {
      ...
      story: {
         ...
         hangar20: [
            ...
            '<25>{#p/toriel}{#f/1}* Truth betold, I have heard much about you...',
         ...
         hangar39: [ '<25>{#p/toriel}{#f/14}* My child...' ],
         hangar40: [ '<25>{#p/toriel}{#f/10}* ... be good, alright?' ],
      ...
      trivia: {
         ...
         warningsign: () =>
            SAVE.data.b.svr
               ...
               : SAVE.data.n.plot === 72 ||
                 world.postnoot ||
                 instance('below', 'backdoor')?.object.objects[0].metadata.barrier !== true // NO-TRANSLATE
         ...
         bastion: pager.create(
            ...
            () => [
               ...
               ...(SAVE.data.n.plot < 71.2 && world.bad_lizard < 2 && SAVE.data.n.state_foundry_undyne !== 2
                  ...
                  SAVE.data.b.svr
                     ...
                     : [
                          ...
                          [
                             ...
                             ...(world.darker
                                ? []
                                : [ '<32>{#p/basic}* Sans, Papyrus, Undyne, and Alphys must have all been children...' ])
                          ],
                          [
                             '<32>{#p/human}* (You look to the next entry.)',
   ...
   b_opponent_asriel: {
      ...
      act_check2: () =>
         SAVE.flag.b.pacifist_marker_save1 && SAVE.flag.b.pacifist_marker_save2 && SAVE.flag.b.pacifist_marker_save3
            ? [ '<33>{#p/story}* ASRIEL DREEMURR - ATK{^2}\u1b39{^1} DEF{^2}\u1b39{^1}\n* ...' ]
            : SAVE.data.b.oops
            ? [
   ...
   b_opponent_final: {
      ...
      act_check: [
         '<32>{#p/story}* FORCE FIELD - ATK 0 DEF{^2}\u1b39{^1}\n* Immovable meets unstoppable.\n* The end of the line.'
      ],
      status1: () =>
         SAVE.data.n.bully > 9
