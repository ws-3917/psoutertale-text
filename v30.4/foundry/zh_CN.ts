...
export default {
   a_foundry: {
      ...
      undynefinal2c2: () => [
         ...
         "<25>{#x2}* 不知道你怎么想他的...",
         "<25>{#f/18}* 他很古怪，\n  他很天真，\n  他很自恋...",
         "<25>{#f/20}{#x3}* 但是Papyrus从来不会错过\n  任何一次报道。",
         "<25>{#f/18}{#x4}* 而且不论你在什么时候\n  打电话给他...",
         "<25>{#f/20}{#x5}* 他总会在第二声铃响之前\n  接起电话。",
         "<25>* ...",
         "<25>{#f/18}{#x6}* 现在他却离去了。",
         "<25>{#f/22}{#x7}* 而且他的兄弟，也不见了。",
         "<25>* ...",
         "<25>{#f/18}* 你对他做了什么？",
         "<25>{#f/11}{#x8}* 你对他 做{^4} 了{^4} 什{^4} 么{^4}？",
   ...
   b_opponent_undyne: {
      ...
      turnTalkA3: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/2}当初我参加训练，\n梦想成为一名\n皇家守卫的时候...",
      ...
      turnTalkA5: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               ...
               "<20>{#p/undyne}{#e/undyne/2}那时就感觉\n  自己成了孤家寡人。"
            ]
            : ["<20>{#p/undyne}{#e/undyne/5}NGAHHH!\nEnough warming up!"],
      turnTalkA6a: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/11}我拖着身子四处走动...",
