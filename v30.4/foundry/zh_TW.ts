...
export default {
   a_foundry: {
      ...
      undynefinal2c2: () => [
         ...
         "<25>{#x2}* 不知道你怎麼想他的...",
         "<25>{#f/18}* 他很古怪，\n  他很天真，\n  他很自戀...",
         "<25>{#f/20}{#x3}* 但是Papyrus從來不會錯過\n  任何一次報道。",
         "<25>{#f/18}{#x4}* 而且不論你在什麼時候\n  打電話給他...",
         "<25>{#f/20}{#x5}* 他總會在第二聲鈴響之前\n  接起電話。",
         "<25>* ...",
         "<25>{#f/18}{#x6}* 現在他卻離去了。",
         "<25>{#f/22}{#x7}* 而且他的兄弟，也不見了。",
         "<25>* ...",
         "<25>{#f/18}* 你對他做了什麼？",
         "<25>{#f/11}{#x8}* 你對他 做{^4} 了{^4} 什{^4} 麼{^4}？",
   ...
   b_opponent_undyne: {
      ...
      turnTalkA3: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
               "<20>{#p/undyne}{#e/undyne/2}當初我參加訓練，\n夢想成為一名\n皇家守衛的時候...",
