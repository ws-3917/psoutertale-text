...
export default {
   disclaimer: {
      title: "- ADVERTENCIA -",
      content: "1. PS!OUTERTALE está hecho por Spacey_432.\nY nuestro equipo esta trabajando en la traducción a Chino.\n2. Si encuentras cualquier texto o dialogo sin traducir,\npor favor no te molestes y nos llames flojos.\n3. No hagas preguntas extremadamente estúpidas\n(Ejemplos: \"Como cambio el lenguaje a Chino?\",\n\"Como mato a Toriel?\", o \"Como extraigo el juego?\")\nEstas preguntas ya están en el FAQ.\nNuestros traductores no tienen el tiempo para estas tonterias.\"\n\n",
   },
   battle: {
   ...
   dialog: {
      ...
      dialog_save: { buttonLabel: 'Guardar', name: 'SAVE files', title: 'Save File' },
