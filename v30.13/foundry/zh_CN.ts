...
export default {
   a_foundry: {
      ...
      candy1: () =>
         SAVE.data.b.svr
            ? [
                 ...
                 choicer.create("* (What will you make?)", "甘草糖", "Chisps", "口粮", "Nothing")
              ]
            : [
      ...
      genotext: {
            ...
            SAVE.flag.n.genocide_milestone < 5
               ? SAVE.flag.n.ga_asrielStutter < 1
                  ? [
                       ...
                       "<25>{#p/asriel2}{#f/7}* Asgore，谁都不能分割\n  我和$(name)之间的纽带。\n* 你不是不知道。",
         ...
         kiddFinal4: [ "<32>{#p/asriel2}{#f/6}* 她就在那。" ],
         kiddFinal5: [ "<32>{#f/6}* 给我上。", "<32>{#f/7}* ..." ],
         kiddFinal6: [ "<32>{*}{#p/asriel2}{#f/14}{@random=1.1/1.1}{@fill=#f00}* 少磨蹭，{%100}" ],
         kiddFinal7: [
            "<25>{#p/kidd}{#f/12}* ...",
      ...
      undynefinal2c2: () => [
         ...
         "<25>{#x2}* 不知道你怎么想他的...",
         "<25>{#f/18}* 他很古怪，\n  他很天真，\n  他很自恋...",
         "<25>{#f/20}{#x3}* 但是，Papyrus绝不会\n  错过任何一次报到。",
         "<25>{#f/18}{#x4}* 而且，不管几点钟给他打电话...",
         "<25>{#f/20}{#x5}* 他都绝不会响铃两次\n  还不接。",
         "<25>* ...",
         "<25>{#f/18}{#x6}* 现在，他不在了。",
         "<25>{#f/22}{#x7}* 他的兄弟，也不见了。",
         "<25>* ...",
         "<25>{#f/18}* 告诉我，你把他怎么了？",
   ...
   b_opponent_undyne: {
      ...
      turnTalkA3: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
                 "<20>{#p/undyne}{#e/undyne/2}从我努力训练，\n梦想当上皇家守卫\n讲起吧。",
                 "<20>{#p/undyne}{#e/undyne/2}那时，并非一帆风顺。"
              ]
            : respecc()
      ...
      turnTalkA6a: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
                 "<20>{#p/undyne}{#e/undyne/11}渴望成为皇家守卫，\n但举步维艰...",
      ...
      turnTalkB6: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
                 "<20>{#p/undyne}{#e/undyne/4}我再怎么逞强，\n用尽所有力气...",
                 "<20>{#e/undyne/11}但缺乏他那种品质，\n我到底没法像他那样。"
              ]
            : respecc()
      ...
      turnTalkB7a: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
                 "<20>{#p/undyne}{#e/undyne/2}死在你手下的他\n不只是我的朋友，\n我的学生...",
                 "<20>{#e/undyne/2}更是一个\n能对要杀害他的人\n敞开胸怀的怪物。"
              ]
            : respecc()
         ...
         SAVE.data.n.state_starton_papyrus === 1
            ? [
                 world.trueKills > 9
                    ...
                    : "<20>{#p/undyne}{#e/undyne/11}现在他离去了...",
                 "<20>{#p/undyne}{#e/undyne/2}那我给你的仁慈...",
                 "<20>{#p/undyne}{#e/undyne/1}...就只能是\n让你在我的长矛下\n死快点了！"
              ]
            : respecc()
            ? [
      ...
      turnTalkC2: () =>
         SAVE.data.n.state_starton_papyrus === 1
            ? [
                 "<20>{#p/undyne}{#e/undyne/2}你知道吗，Alphys\n告诉我人类充满决心...",
                 "<20>{#p/undyne}{#e/undyne/1}不过你的决心\n也只能帮你走到这了，\n呵呵。"
              ]
            : respecc()
            ? [
      ...
      genoCutscene15x: [ "<20>{#p/undyne}{#v/1}Y你们还得再加把劲！{%20}" ],
      genoDeath1: [
      ...
      genoStatus4: [ "<32>{#p/asriel2}* $(name)，我感觉单打独斗行不通。" ],
   ...
   n_shop_tortoise: {
      ...
      item: () =>
         world.runaway
            ? [ "0G - Datapad?", "0G - AR眼镜？", "0G - Nebula Tea", "0G - Tree Sap", "离开" ]
            : world.genocide || world.killed0 || SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE

            ? [ "45G - Datapad?", "45G - AR眼镜？", "16G - Nebula Tea", "25G - Tree Sap", "离开" ]
            : SAVE.data.n.plot === 72
            ? [
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : world.genocide
            ? [ "Asriel", "(Threaten)", "(Fight)", "Undyne", "离开" ]
            : world.killed0
            ? [ "Your Fate", "(Threaten)", "(Fight)", "Hero", "离开" ]
            : [
