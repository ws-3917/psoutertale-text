      ...
      final_frontier: {
         ...
         opponents: {
            froggit: {
               ...
               text: {
                  basic: 'じんせいについて　こうさつちゅう',
                  spare: 'プロのカエル',
                  flirt: 'あいについて　こうさつちゅう',
                  bully: 'Hopping In\nFear'
               }
            },
            whimsun: {
            ...
            moldsmal: {
               ...
               author: 'spacey_432',
               text: {
                  basic: 'あらたな　うちゅうステーションを　はっけん',
                  spare: 'バックダンサー',
                  flirt: 'エキゾチックゼリーダンサー',
                  bully: 'あらたな　ぎんがを　はっけん'
               }
            },
            loox: {
               name: 'ルーカス...',
            ...
            stardrake: {
               ...
               text: {
                  basic: 'おわらい　しゅぎょうちゅう',
                  spare: 'そこそこ　うれてる　おわらいげいにん',
                  flirt: 'ぼうゆうめい　せいしゅんえいがで　ゆうめいじん',
                  bully: ''
               }
            },
            chilldrake: {
            ...
            spacetop: {
               ...
               author: 'DESM.al',
               text: {
                  basic: 'じぶんの　アンテナが　きになる',
                  spare: 'ラジオばんぐみで　だいにんき',
                  flirt: 'こいのよかん',
                  bully: 'きんきゅうほうそう　やってます'
               }
            },
            jerry: {
               name: 'ジェリー',
               ...
               text: {
                  basic: 'まいにち　ドタキャンされる　ように',
                  spare: 'ドタキャン　すこし　へりました',
            ...
            mouse: {
               ...
               text: {
                  basic: 'じぶんさがしの　たびへ',
                  spare: 'ネズミしゃかいの　しんメンバー',
                  flirt: 'ネズミと　じゃれあうように',
                  bully: 'ネコしゃかいに　あわててもどった'
               }
            },
            doggo: {
               name: 'ワンボー',
               author: 'Discarded Vessel',
               text: {
                  basic: 'あの　ぼうきれには　きっと　またあえる…',
                  spare: 'もうどう犬との　しんせいかつ',
                  flirt: 'もうどう犬との　ラブラブ生活',
                  bully: 'もうどう犬に　たすけをもとめて'
               }
            },
            lesserdog: {
               name: 'レッサードッグ',
            ...
            dogs: {
               ...
               author: 'major_memestar',
               text: {
                  basic: 'あの　ぼうきれのことが　わすれられず',
                  spare: '「おはなスリスリ　コンテスト」で　ゆうしょう',
