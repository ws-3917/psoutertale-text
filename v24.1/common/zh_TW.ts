...
export default {
   ...
   a_common: {
      ...
      dogcheck2: () => [
         ...
         ...(SAVE.data.n.state_wastelands_napstablook !== 5 && !SAVE.data.b.ultrashortcut && !SAVE.data.b.ubershortcut
            ? SAVE.flag.n._time < 30 * 60 * 60
               ? [
                    "<25>{#s/bark}{#p/event}Bark!\nBark!",
                    "<25>{#p/basic}(Ludicrous speed!)",
                    "<25>{#p/basic}(You got here in under one of your Earth hours with no shortcuts!)"
                 ]
               : SAVE.flag.n._time < 30 * 60 * 60 * 2
               ? [
                    "<25>{#s/bark}{#p/event}Bark!\nBark!",
                    "<25>{#p/basic}(Ridiculous speed!)",
                    "<25>{#p/basic}(You got here in under two of your Earth hours with no shortcuts!)"
                 ]
               : SAVE.flag.n._time < 30 * 60 * 60 * 3
               ? [
                    "<25>{#s/bark}{#p/event}Bark!\nBark!",
                    "<25>{#p/basic}(Light speed!)",
                    "<25>{#p/basic}(You got here in under three of your Earth hours with no shortcuts!)"
                 ]
               : []
            : []),
         ...(!SAVE.flag.b._saved
         ...
         if (world.bad_robot) {
                     ...
                     if (royals === 1) {
                        ...
                        if (!ddoggo) {
                           ...
                           addB([
                              ...
                              "<18>{#p/papyrus}{#f/3}... ALL THOSE ROYAL GUARDS...",
                              "<18>{#p/papyrus}{#f/31}...",
                              "<18>{#p/papyrus}{#f/5}THEY FELT LOST WITHOUT THEIR DUTY, AND...",
                              "<18>{#p/papyrus}{#f/6}THOUGHT I MIGHT BE ABLE TO FIND THEM A NEW ONE.",
                           ...
                           addB([
                              ...
                              "<18>{#p/papyrus}{#f/6}WE HELD EACHOTHER FOR HOURS...",
            ...
            if (SAVE.data.b.ubershortcut) {
               addB([
                  ...
                  "<32>{#p/mettaton}* AVOIDING UNDYNE, AND THOSE GUARDS IN THE CORE...?",
            ...
            addB([
               ...
               "<32>{#p/mettaton}* YOU'RE JUST SAYING THAT TO MAKE FEEL BETTER, RIGHT?",
               "<32>{#p/napstablook}* ......\n* ...... i tried",
               "<32>{#p/mettaton}* AND I APPRECIATE THAT.\n* BUT I THINK IT'D BE BEST IF YOU STAYED OUT OF THIS.",
            ...
            addB([
               ...
               "<25>{#p/sans}{#f/0}* well, before i go..."
            ]);
            if (hkills > 9) {
               addB([
            ...
            if (!dundyne) {
               ...
               if (SAVE.data.b.w_state_lateleave) {
                  ...
                  if (hkills === 0) {
                     ...
                     if (royals < 2) {
                        addB([ "<26>{#p/toriel}{#f/9}* ... and the deaths of the rest of the Royal Guard beyond that." ]);
                     } else if (royals < 7) {
                        addB([ "<26>{#p/toriel}{#f/9}* ... and the deaths of other Royal Guard members beyond that." ]);
                     }
                  } else if (royals < 2) {
                     ...
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinate, Doggo." ]);
                  } else if (dlesserdog) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinate, Canis Minor." ]);
                  } else if (ddogs) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinates, Dogamy and Dogaressa." ]);
                  } else if (dgreatdog) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinate, Canis Major." ]);
                  } else if (ddoge) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinate, Doge" ]);
                  } else if (droyalguards) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinates, 03 and 04." ]);
                  } else if (dmadjick) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinate, Cozmo." ]);
                  } else if (dknightknight) {
                     addB([ "<25>{#p/toriel}{#f/9}* As well as the death of her subordinate, Terrestria." ]);
                  } else if (mdeaths > 9) {
                  ...
                  if (hkills === 0) {
                     ...
                     addB([ "<25>{#p/toriel}{#f/5}* I could have gone with you and encouraged a more peaceful path." ]);
                  }
                  addB([
