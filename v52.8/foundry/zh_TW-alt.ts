...
export default {
   ...
   b_opponent_moldfake: {
      ...
      name: '* 小黏團',
      smalTalk: [ '<08>{#p/basic}{~}...' ],
      status1: () => (world.goatbro ? [ '<32>{#p/asriel2}* Gelatini.' ] : [ '<32>{#p/story}* 小黏團出現了？' ]),
      fakeStatus1: () =>
         world.goatbro
   ...
   b_opponent_doge: {
      ...
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ...
            ? [ '<32>{#p/human}* （你向督吉調情。）', '<32>{#p/basic}* Doge smiles in return.' ]
      ...
      petTextEarly: [ "<32>{#p/human}* （你嘗試撫摸督吉，\n  但你現在還夠不到她。）" ],
      petTextGeno: [
         '<32>{#p/human}* （你想摸摸督吉。）',
   ...
   n_shop_tem: {
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? '未來發展' : SAVE.data.b.colleg ? '關於提米盔甲' : '來個自我介紹',
