...
export default {
   a_aerialis: {
      ...
      story: {
         ...
         barricade1: () => [
            ...
            ...(world.postnoot
               ...
               : [
                    ...
                    choicer.create("* (What do you say?)", "艾菲斯", "艾斯戈尔", "帕派瑞斯", "安黛因")
                 ])
         ],
         barricade1x: [
         ...
         barricade2: () => [
            ...
            choicer.create("* (What do you say?)", "镁塔美妆", "镁塔烹饪", "镁塔科技", "镁塔卫视")
         ],
         barricade2b1: [
      ...
      trivia: {
         ...
         corenote5: [
            "<32>{#p/basic}* 一段录音，标着“镁塔顿”。",
            "<32>{#p/human}* （你按下了播放键...）",
            "<32>{#p/alphys}* 一开始，和你相处不怎么愉快。\n  不过没有你，我走不到今天这一步。",
            "<32>* 镁塔顿，如果你在听...\n  我想说，你是个十足的美人。",
      ...
      genotext: {
         ...
         core7b: [
            "<25>{#p/asriel2}{#f/3}* 原来是镁塔顿。\n* 就在里面等着我们呢。",
            "<25>{#f/10}* 只看得清他的背影...",
            "<25>{#f/6}* 咱悄悄溜到他身后，\n  兴许能打他个措手不及。"
         ],
         core7c: [ "<25>{#p/asriel2}{#f/7}* 你知道该做什么。" ],
         core8a: [
            "<32>{#p/mettaton}* 真觉得我会轻易放你们离开吗？",
            "<25>{#p/asriel2}{#f/8}* ...\n* 少跟我拐弯抹角。\n* 你当然不会放我们走。",
            "<25>{#p/asriel2}{#f/7}* 这毫无意义，\n  你早晚都会死。"
         ],
         core8aX: () => [
            "<32>{#p/mettaton}* 真觉得我会轻易放你们离开吗？",
         ...
         core8b: [
            "<25>{#p/asriel2}{#f/4}* 喂，我说...\n  你抛弃了你的家人...",
            "<25>{#f/3}* 等会也快变成\n  没人要的零件了...",
            "<25>{#f/1}* 还不考虑下他们的感受吗？",
            "<32>{#p/mettaton}* 知道我在做什么，\n  他们肯定会以我为荣的。",
            "<32>* ...至于你呢？",
            "<32>* 那就不好说了。",
   ...
   b_opponent_mettaton2: {
      ...
      neointro: [
         "<20>{*}{#p/mettaton}你现在是橙色的了。{^30}{%}",
         "<20>{*}{#e/mettaton/4}那就是我的攻击。{^30}{%}",
         "<20>{*}{#e/mettaton/12}...嘿，玩得开心点嘛。\n谁说战斗中不行呢？{^30}{%}",
         "<20>{*}{#e/mettaton/0}Now, be a good darling and press [Z] to explode.{^30}{%}",
         "<20>{*}{#e/mettaton/0}不过，要小心哦...{^30}{%}",
         "<20>{*}{#e/mettaton/0}The more you do it, the slower you'll move.{^30}{%}",
         "<20>{*}{#e/mettaton/12}...说得够多了。{^30}{%}",
         "<20>{*}{#e/mettaton/4}是时候送你们入土了。{^30}{%}"
      ],
      mettahero1: [
   ...
   m_aerialis: {
      ...
      sidebarCellPms3: {
         ...
         alphysYdoggo4: {
            author: "ALPHYS",
            pm: "id teach him to use his ears with these little games i came up with"
         },
         alphysYdoggo5: {
            author: "ALPHYS",
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 ...
                 [ "艾菲斯", "§fill=#ff0§Royal Scientist (NEW)", "§fill=#ff0§艾斯戈尔（新）", "艾斯戈尔" ][
