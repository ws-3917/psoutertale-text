...
export default {
   disclaimer: {
      title: "- 游戏声明 -",
      content: "1.PS!OUTERTALE是Spacey_432制作的游戏，\n  PSOT汉化组负责中文翻译。\n2.中文翻译还在进行中，如果发现未翻译的文本或对话，\n  请耐心等待。所有语言中，中文已经是进度最快的了，\n  所以尽量不要反馈对话没有翻译的问题。\n3.一些常见问题（比如“怎么把语言改成中文？”、\n  “怎么下载？”、“怎么解压游戏？”），\n  建议先查阅“Q群管家”，常见问题答案都在那里。\n  汉化组需要花更多时间推进汉化，接受bug反馈。\n  所以过于基础的问题可能不会解答。\n4.如果对游戏比较失望，不想继续测试，或者不愿遵守群规，\n  您可以选择删除游戏，然后退群。这游戏是Spacey做的，\n  汉化组翻译的，我们都付出了很多努力，希望能相互理解。\n\n再次感谢您对本游戏与汉化组的支持，10秒后自动进入游戏。"
   },
   battle: {
...
["特别鸣谢 由§fill=#ff0§Mavis与朋友们§fill=#fff§提供"]
   ...
   general: {
      ...
      lv: "LV",
      chara: "{@mystify=天地玄黄宇宙洪荒日月盈昃辰宿列张寒来暑往秋收冬藏闰余成岁律吕调阳云腾致雨露结为霜金生丽水玉出昆冈剑号巨阙珠称夜光果珍李柰菜重芥姜海咸河淡鳞潜羽翔龙师火帝鸟官人皇始制文字乃服衣裳推位让国有虞陶唐}新名字{@mystify=}",
      charal: "{@mystify=天地玄黄宇宙洪荒日月盈昃辰宿列张寒来暑往秋收冬藏闰余成岁律吕调阳云腾致雨露结为霜金生丽水玉出昆冈剑号巨阙珠称夜光果珍李柰菜重芥姜海咸河淡鳞潜羽翔龙师火帝鸟官人皇始制文字乃服衣裳推位让国有虞陶唐}新名字{@mystify=}",
      charau: "{@mystify=天地玄黄宇宙洪荒日月盈昃辰宿列张寒来暑往秋收冬藏闰余成岁律吕调阳云腾致雨露结为霜金生丽水玉出昆冈剑号巨阙珠称夜光果珍李柰菜重芥姜海咸河淡鳞潜羽翔龙师火帝鸟官人皇始制文字乃服衣裳推位让国有虞陶唐}新名字{@mystify=}",
      no: "否",
      nominal: "§fill=#0f0§正常",
      percent: "$(x)%",
      player: "玩家",
