...
const text = {
   a_aerialis: {
      ...
      businessKILLER: [
         ...
         "<32>* The royal guard'll be all over you for that sorta thing.",
         "<32>* If I were you, I'd quit while I was ahead.",
      ...
      papinter2: [
         ...
         "<18>{#f/4}I'D BE HERE TO CALL, TOO, BUT...",
      ...
      corndog1: pager.create(
         ...
         [ "<25>{#p/sans}{#f/0}* corn dogs for 5G.", choicer.create("* (Buy a Corn Dog?)", "是", "否") ]
      ),
      corndog2: [
      ...
      corndog3x: pager.create(0, [ "<25>{#p/sans}{#f/2}* aw.\n* that's too bad." ], []),
      corndog4: () =>
         [
      ...
      sanscall1: () => [
         ...
         ...(world.dead_skeleton
            ? [
                 ...
                 "<25>{#f/3}* good?\n* bad...?",
                 "<25>{#f/2}* eh.\n* i'm just the guy with the puns.",
                 ...(world.sad_ghost && SAVE.data.n.state_foundry_muffet !== 1 && SAVE.data.b.f_state_kidd_betray
                    ? [ "<25>{#f/0}* i'm surprised i got as far as i did." ]
                    : [ "<25>{#f/0}* it's not like i'd know how to participate." ]),
                 "<25>{#f/0}* oh well.\n* as long as you're satisfied.",
                 "<25>{#f/2}* that's all that matters, right?"
              ]
            : [
                 "<25>{#p/sans}{#f/0}* so, how was the show?",
                 ...(SAVE.data.b.a_state_moneyfish
                    ...
                    : [
                         ...
                         "<26>{#f/3}* don't worry, i'm used to being the odd one of the bunch.",
      ...
      story: {
         ...
         rg1f: [
            ...
            "<32>{#x2}* Yeah, like, let's skedaddle.{#x3}"
         ],
         robocaller1: () =>
            [
               [
               ...
               [
                  ...
                  ...(SAVE.flag.n.genocide_milestone < 5
                     ...
                     : [
                          ...
                          "<32>{#z21}{#p/asriel2}{#f/8}* For your information, SHE is planning to fight us.",
         ...
         barricade3b2: [
            ...
            "<25>{#g/alphysCutscene2}* Er, nope, totally didn't work!",
            "<25>{#g/alphysCutscene1}* Guess that's not Mettaton's true identity after all!!",
            "<25>{#g/alphysUhButHeresTheDeal}* Obviously!!!",
         ...
         barricade4: () => [
            ...
            ...(SAVE.data.b.failshow
               ...
               : [
                    ...
                    "<25>{|}{#g/alphysCutscene3}* Anyway see you at the eleva- {%}"
                 ]),
            "<32>{#s/equip}{#p/event}* Click..."
         ],
         puzzleReaction1: [
            ...
            "<25>{#g/alphysNeutralSweat}* ...",
            "<25>{#g/alphysCutscene2}* You... you did it."
         ],
         ...
         cooker7b: () =>
            iFancyYourVilliany()
               ...
               : [
                    ...
                    "<25>{#p/alphys}{#g/alphysWelp}* I had to turn it on for an experiment.",
                    "<32>{#p/mettaton}* OH."
                 ],
         ...
         cooker12: () => [
            ...
            ...(SAVE.data.n.state_foundry_undyne === 0
               ...
               : [
                    ...
                    "<25>{#g/alphysSmileSweat}* Uh, I mean, the phone I g-gave you..."
                 ]),
         ...
         cooker19a: [
            ...
            "<25>{#g/alphysUhButHeresTheDeal}* I guess I should've expected that, huh?"
         ],
         cooker19b: [
            "<32>{#p/event}* Ring, ring...",
            "<25>{#p/alphys}{#g/alphysSideSad}* ...",
         ...
         puzzleReaction2c: [
            ...
            "<25>{#g/alphysUhButHeresTheDeal}* Or... well done?",
         ...
         moneyChat3: () =>
            world.scared_ghost
               ? [ "<32>{#p/napstablook}* it's your turn.", "<32>{#p/human}* (You didn't have anything to say.)" ]
               : [
                    "<32>{#p/napstablook}* uh......",
                    "<32>* you can talk now?",
                    "<32>{#p/human}* (You didn't have anything to say.)"
                 ],
         moneyChat3a: () =>
            iFancyYourVilliany()
               ? [
         ...
         moneyVote3x: () =>
            world.scared_ghost
               ? [ "<32>{#p/napstablook}* the human.", "<32>{#p/mettaton}* ..." ]
               : [
                    "<32>{#p/napstablook}* ...............",
         ...
         moneyVote4: () => [
            iFancyYourVilliany()
               ? "<32>{#p/mettaton}* WHAT'LL IT BE, DEAR $(moniker2u)?"
         ...
         moneyVote4a2: () => [
            "<32>{#p/mettaton}* DON'T HAVE ANYONE IN MIND?",
            "<32>* WELL, THAT'S ALRIGHT.",
            ...(SAVE.data.n.state_foundry_muffet === 1
         ...
         rg2d: () =>
            world.genocide
               ? [ "<32>{#p/basic}{#x1}* Come on, girl.{#x3}", "<32>{#x1}{#x2}* Let's whoop some traitor backside.{#x3}" ]
               : [
                    "<32>{#x1}* Come on, girl.{#x3}",
                    iFancyYourVilliany()
                       ? "<32>{#x1}{#x2}* Let's whoop some bully backside.{#x3}"
                       : "<32>{#x1}{#x2}* Let's whoop some human backside.{#x3}"
                 ],
         rg2e: [ "<32>{#p/basic}* Wow.\n* That was...", "<32>{#p/basic}* ... something." ],
         rg2f: [
            "<32>{#p/basic}{#x1}* Girl, this human thing might not be worth the trouble.{#x3}",
            "<32>{#x2}* Unfortunately.\n* We'll let the boys handle this one... if they're up for it.{#x3}"
         ],
         hapsta1: [
         ...
         hapsta35: [ "<32>{#p/basic}* I'm just glad I could be useful for once..." ],
         opera1: () => [
            ...
            ...(SAVE.data.b.bad_lizard
               ? [
                    "<25>{#g/alphysSideSad}* Maybe that way, you won't resort to...",
                    "<25>{#g/alphysSideSad}* ...",
                    "<25>{#g/alphysUhButHeresTheDeal}* Uh, anyway!\n* Let's get going!"
                 ]
               : [
         ...
         endY1: [
            "<25>{#p/alphys}{#g/alphysSmileSweat}* Phew... you made it.",
            "<25>* That was more difficult than it had to be, huh?",
            "<25>{#g/alphysNeutralSweat}* I mean, maybe not for you, since, y'know...",
            "<25>* ...",
            ...
            !world.badder_lizard
               ...
               : [
                    ...
                    SAVE.data.n.bad_lizard < 1
                       ? "<26>{#g/alphysCutscene3}* I wasn't gone THAT long."
         ...
         end6: () =>
            !world.badder_lizard
               ...
               : [
                    SAVE.data.n.bad_lizard < 1
                       ? "<25>{#g/alphysWelp}* Okay, maybe I was.\n* But to be fair, you did kind of scare me off."
                       : "<25>{#g/alphysWelp}* Okay, maybe that's NOT the only reason.",
                    "<25>{#g/alphysHaveSomeCompassion}* Look, just... come with me into the next room.",
                    SAVE.data.n.bad_lizard < 1
                       ? "<25>{#g/alphysNeutralSweat}* Th-there's something we have to discuss."
         ...
         end7: () => [
            ...
            ...(SAVE.data.n.state_aerialis_mettastrikes > 2
               ? [
                    "<25>{#g/alphysFR}* As for that damage...",
                    "<32>{#x1}{#p/hapstablook}* There's no damage, dear.\n* I was only lowering my HP for dramatic effect.",
                    "<25>{#p/alphys}{#g/alphysCutscene2}* Eheh... yeah.\n* Why WERE you attacking Mettaton, anyway?",
                    "<25>{#g/alphysInquisitive}* You had to have known that wouldn't really work, right?"
                 ]
               : SAVE.data.b.a_state_hapstablook
               ? [
                    "<25>{#g/alphysCutscene2}* Besides, that's only a vessel...",
                    "<25>{#g/alphysCutscene2}* Mettaton's probably just trying to play dead.",
                    "<32>{#x1}{#p/hapstablook}* It's an acting thing, dear."
                 ]
               : [ "<32>{#x1}{#p/hapstablook}* I'd appreciate that." ])
         ],
         end8: [
         ...
         end10: () => [
            world.bad_lizard > 1 || SAVE.data.n.state_foundry_undyne === 2
               ? "<32>{#p/hapstablook}* Well, darling...\n* It'd probably be a good idea to go along with her."
               : "<32>{#p/hapstablook}* Don't worry, darling. It's probably just a new season of a sci-fi anime she likes.",
            "<32>* As for me?",
            SAVE.data.b.a_state_hapstablook
         ...
         end11: () => [
            ...
            ...(SAVE.data.b.a_state_hapstablook
               ...
               : [
                    ...
                    "<32>* ...",
                    "<32>* I guess, for now, you'll just have to do you best to keep moving forward..."
                 ]),
            "<32>* ...\n* Come on, partner.",
            "<32>* Let's go home."
         ],
         ...
         endwalk2: () => [
            ...(world.bad_lizard < 2 && SAVE.data.n.state_foundry_undyne !== 2
               ...
               : [
                    ...
                    "<25>{#p/alphys}* In any case, there's... nothing else I can do.",
               ...
               : [
                    ...
                    ...(world.postnoot
                       ? world.nootflags.has('undyne') // NO-TRANSLATE
                          ...
                          ? [ "<25>{#g/alphysFR}* ... the atmospheric system, on the other hand..." ]
                          : [ "<25>{#g/alphysFR}* ... whatever's in the air, on the other hand..." ]
                       : [])
                 ])
         ]
      },
      overworld: {
         ...
         puzzle1done: () =>
            SAVE.data.b.svr
               ? [ "<32>{#p/human}* (You stare into the blank screen of the console.)" ]
                    ...
                    ...(world.bad_lizard < 2 && SAVE.data.n.plot < 72
                       ? [
                            ...
                            [
                               ...
                               "<32>* Sorry, Alphys...",
                               "<32>* ... we just don't think protecting this human is a good idea."
                            ]
      ...
      trivia: {
         a_wishflower: pager.create(
            ...
            (power = false) =>
               SAVE.data.b.svr
                  ? [
                       "<32>{#p/human}* (You breathe in the wish flower's aura.)",
                       power ? "{*}{#d.sysx}{%}" : "{*}{#d.sys}{%}"
                    ]
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                       "<32>{#p/basic}* It's a bookshelf.",
                       "<32>{#p/human}* (You pick out a book...)",
                       "<32>{#p/basic}* \"Dr. Roman's notes, page 76.\"",
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                       "<32>{#p/basic}* It's a bookshelf.",
                       "<32>{#p/human}* (You pick out a book...)",
                       "<32>{#p/basic}* \"Dr. Roman's notes, page 195.\"",
            ...
            () =>
               SAVE.data.b.svr
                  ...
                  : [
                       "<32>{#p/basic}* It's a bookshelf.",
                       "<32>{#p/human}* (You pick out a book...)",
                       "<32>{#p/basic}* \"Dr. Roman's notes, page 310.\"",
         ...
         coresign4: () =>
            SAVE.data.b.svr
               ...
               : [ "<32>{#p/basic}* \"This plaque is dedicated to Dr. T. N. Roman.\"\n* \"May your legacy live on.\"" ],
         coresign5: () =>
            SAVE.data.b.svr
      ...
      npc: {
         ...
         a_bowtie: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ? [ "<32>{#p/basic}{#npc/a}* As as slime, I'm still not sure how to feel about this." ]
                  : [ "<32>{#p/basic}{#npc/a}* As as slime, I'm not sure how to feel about this." ]
         ),
         ...
         a_businessdude: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ? world.population < 6
                     ? [
                          "<32>{#p/basic}{#npc/a}* Yeah, sometimes I wonder how a person like you can exist.",
                          "<32>* You saved us in the end, but what's it worth if we're all scared to leave our homes?",
                          "<32>* I'm not judgin' you or anything, but you DO see the irony in that, right?"
                       ]
                     : [
                  ...
                  ? iFancyYourVilliany()
                     ? [
                          "<32>{#p/basic}{#npc/a}* So, you go by \"$(moniker2)\" now, huh kid?",
                          "<32>* ... that's pretty cool."
                       ]
                     : [
                          [
                             "<32>{#p/basic}{#npc/a}* Boy, you really missed the mark on that one, huh kid?",
                          ...
                          [
                             "<32>{#p/basic}{#npc/a}* You did pretty well for someone with no real practice.",
                  ...
                  : [
                       ...
                       "<32>* Wonderful place.\n* Though they say you shouldn't go out of bounds."
                    ],
            () =>
               SAVE.data.n.plot === 72
                  ? world.population < 6
                     ? [ "<32>{#p/basic}{#npc/a}* Why don't you go find someone else to bully, eh?" ]
                     : [
                          "<32>{#p/basic}{#npc/a}* I only hope we can expand our userbase past that one eccentric skeleton fellow."
                       ]
                  : roomKills().a_elevator1 > 0
                  ? [ "<32>{#p/basic}{#npc/a}* Or don't.\n* Just don't make me say I told you so, you got me?" ]
                  : SAVE.data.n.plot < 58
                  ? iFancyYourVilliany()
                     ? [ "<32>{#p/basic}{#npc/a}* It's not like I had a moniker at your age or anything." ]
                     : [
                          [ "<32>{#p/basic}{#npc/a}* It's a wonder you even made it here at all." ],
                          [ "<32>{#p/basic}{#npc/a}* Kinda seems like you weren't." ],
                          [ "<32>{#p/basic}{#npc/a}* I'm sure you'll get another chance on the next episode." ],
                          [ "<32>{#p/basic}{#npc/a}* Maybe next time you could, I dunno, win more comfortably?" ],
                          [ "<32>{#p/basic}{#npc/a}* Or maybe MTT just went a little easy on ya." ]
                       ][SAVE.data.n.state_aerialis_crafterresult]
                  : [
                       "<32>{#p/basic}{#npc/a}* Yeah, you heard that right.\n* Out of bounds.",
         ...
         a_harpy: pager.create(
            ...
            [ "<32>{#p/basic}* Oh dear, I do love my job." ]
         ),
         ...
         a_clamguy: pager.create(
            0,
            [
               "<32>{#p/basic}{#npc/a}* I hear things can get pretty weird if you go too far out in these repeating rooms.",
               "<32>* Time tunnels...\n* Invariant spatial flexures...",
               "<32>* Eh, don't ask me what any of that means, I just overheard Alphys one time.",
               "<32>* If it wasn't her saying it, I'd probably just take it as pure nonsense..."
            ],
         ...
         a_diamond1: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                       iFancyYourVilliany()
                          ? "<32>{#p/basic}{#npc/a}* Hey, you're $(moniker1)!"
                          : "<32>{#p/basic}{#npc/a}* Hey, you're the human who beat Mettaton at his own game!",
                       "<33>{#p/basic}{#npc/a}* What an incredible performance!"
                    ],
            () =>
               SAVE.data.n.plot === 72
         ...
         a_gyftrot: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ? [ "<32>{#p/basic}{#npc/a}* ... maybe the teenagers weren't so bad after all." ]
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                       ...
                       "<32>* Alphys has said recently that we may all have our freedom soon...",
         ...
         a_drakemom: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  ? [
                       "<32>{#p/basic}{#npc/a}* It's called \"Journey to Mole-Rat Outpost.\"\n* I'll show it to my son later."
                    ]
                  : SAVE.data.b.ubershortcut
                  ? [
                       "<32>{#p/basic}{#npc/a}* It's a true disappointment.\n* Immeasurable, even.",
                       "<32>* There's no way I can chronologically recover from this."
                    ]
                  : [
                       "<32>{#p/basic}{#npc/a}* So. Is this what humans do?\n* Quit before you lose?",
      ...
      genotext: {
         ...
         asriel51: [
            "<25>{#p/asriel2}{#f/4}* Anyways, a city that big is probably just a silly idea.",
         ...
         hotel1: () =>
            SAVE.flag.n.genocide_milestone < 5
               ...
               : [
                    "<25>{#p/asriel2}{#f/12}* ... to think this damage was caused by her magic...",
      ...
      rg1chat: pager.create(
         0,
         [
            "<32>{#p/basic}{#x1}* My boyfriend and I were looking for an ice cream stand for so long...{#x3}",
         ...
         [
            "<32>{#p/basic}{#x1}* I've been told security guards get SUPER exclusive discounts at the shop.{#x3}",
      ...
      rg2chat: pager.create(
         0,
         [
            "<32>{#p/basic}{#x2}* Hey, aren't you like, that one quiet kid we met earlier?{#x3}",
      ...
      dinnerdate1: pager.create(
         ...
         [ "<25>{#p/sans}{#f/2}* changed your mind?", choicer.create("* (Have dinner?)", "是", "否") ]
      ),
      dinnerdate2a: pager.create(
         0,
         [ "<25>{#p/sans}{#f/3}* eh, fair enough.\n* i'll be here if you change your mind." ],
         [ "<25>{#p/sans}{#f/4}* ok then." ]
      ),
      ...
      candy1: pager.create(
         0,
         () => [
            ...(SAVE.data.b.svr ? [] : [ "<32>{#p/basic}* It's a filament-exclusive vending machine." ]),
      ...
      core4: () =>
         SAVE.data.b.legendary_madjick
            ...
            ? [
                 ...
                 "<32>{#p/basic}* Heh. Sometimes all you need are the right words."
              ]
      ...
      core6: () =>
         SAVE.data.b.legendary_knightknight
            ...
            ? SAVE.data.b.assist_madjick || SAVE.data.b.legendary_madjick
               ? [
                    "<25>{#p/alphys}{#g/alphysWTF}* I can't believe what I'm seeing...",
                    "<32>{#p/basic}* Take it from me, partner.\n* Sentimentality is my specialty!",
               ...
               : [
                    ...
                    "<32>{#p/basic}* Heh.\n* That's more like it.",
                    "<32>{#p/basic}* Sometimes all you need are the right high notes."
                 ]
      ...
      core9b: () =>
         SAVE.data.n.corekills > 0
            ? [
                 "<25>{#p/alphys}{#g/alphysNeutralSweat}* ...",
                 calm_lizard() ? "<25>* D-did you... really have to do that?" : "<32>{#p/human}* (You hear a sigh.)"
              ]
   ...
   b_opponent_mettaton1: {
      ...
      turn1b1: () => (world.bad_lizard < 1 ? [ "<20>{#p/alphys}Uh, sure!" ] : [ "<20>{#p/alphys}... hm?" ]),
      turn1b2: () => (world.bad_lizard < 1 ? [ "<20>{#p/alphys}F-forgive me..." ] : [ "<20>{#p/alphys}O-oh yeah, that." ]),
      ...
      turn9a: [ "<20>{#p/mettaton}HOW WELL WILL YOU FARE AGAINST THIS, THE FINAL CHALLENGE?" ],
      turn9b: () =>
         world.bad_lizard < 1
      ...
      turn9end7b: [ "<20>{#p/alphys}Are you cheating?\nYou didn't even miss a single time." ],
   ...
   b_opponent_mettaton2: {
      artifact: [ "<33>{#p/human}* (Mettaton shrugs at the sight.)", "<32>{#p/basic}* The audience shrugs, too." ],
      epiphaNOPE: () =>
      ...
      turnTalk12: () =>
         world.bad_robot
            ...
            : SAVE.data.b.a_state_hapstablook
            ? [
                 "<20>{#p/mettaton}I don't get why they had to be so confrentational...",
      ...
      neointro: [
         ...
         "<20>{*}{#e/mettaton/1}Now, be a good darling and press [Z] to explode.{^30}{%}",
         "<20>{*}{#e/mettaton/0}But be careful...{^30}{%}",
         "<20>{*}{#e/mettaton/1}The more you do it, the slower you'll move.{^30}{%}",
      ...
      q4: () =>
         SAVE.data.b.a_state_hapstablook
            ? [ "<20>{#p/mettaton}{^40}{%}Well, that's confidence..." ]
            : !world.badder_lizard
   ...
   b_opponent_mushketeer: {
      ...
      act_disarm3: () => [
         "<32>{#p/human}* (You disarm Mushketeer.)",
         ...(!world.badder_lizard && calm_lizard() ? [ "<32>{#p/alphys}* Finally..." ] : [])
      ],
   ...
   b_opponent_perigee: {
      ...
      act_flirt: [
         "<32>{#p/human}* (You flirt with Perigee.)",
         "<32>{#p/basic}* Perigee remains undeterred in its quest for peace."
      ],
   ...
   b_opponent_rg01: {
      ...
      confess7: [
         "<11>{#p/basic}{~}I'm here now, 04.\nIt's me.",
         "<11>{#p/basic}{~}And, no matter what names we go by...",
         "<11>{#p/basic}{~}I will always love you, 04."
      ],
   ...
   c_name_aerialis: {
      ...
      pms: () =>
         SAVE.data.n.plot_pmcheck < pms().filter(key => key in text.m_aerialis.sidebarCellPms3).length
            ? "§fill:#ff0§OuterNet (NEW)"
            : "OuterNet"
   },

   c_call_aerialis: {
      puzzle2a: pager.create(
         0,
         [
   ...
   i_tvm_mewmew: {
      ...
      drop: [ "<32>{#p/human}* (You throw away the Mew Mew Doll.)" ],
      info: [ "<32>{#p/basic}* It's a life-sized Mew Mew doll, what else would it be?" ],
      name: "Mew Mew Doll",
      use: () =>
         !world.genocide &&
         (battler.target?.opponent.metadata.reactTVM || battler.target?.opponent.metadata.reactMewMew)
            ? []
            : [
                 "<32>{#p/human}* (You use the Mew Mew Doll.)",
                 ...(game.room === 'a_lab_main' && // NO-TRANSLATE
                 ...
                 !world.badder_lizard
                    ...
                    ? [ "<32>{#p/basic}* Would you quit waving that thing in front of me?" ]
   ...
   i_face_steak: {
      ...
      drop: [ "<32>{#p/human}* (You threw away the Glyde's Envy.)" ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ "<32>{#p/human}* (55 HP.)" ]
   ...
   i_visor: {
      ...
      drop: [ "<32>{#p/human}* (You throw away the Tactical Armband.)" ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ "<32>{#p/human}* (12 DF.)" ]
            : [ "<32>{#p/basic}* \"Tactical Armband\" (12 DF)\n* Increases aim time in battle." ],
      name: "Tactical Armband",
      use: [ "<32>{#p/human}* (You wear the Tactical Armband.)" ]
   },
   i_visor_x: {
      battle: {
   ...
   i_filament: {
      ...
      use: [ "<32>{#p/human}* (You extracted some energy from Filament.)" ]
   },
   i_filament_use1: {
   ...
   i_orange_soda: {
      ...
      drop: [ "<32>{#p/human}* (You throw away the Orange Soda.)" ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ "<32>{#p/human}* (16 HP.)" ]
   ...
   i_demise: {
      ...
      drop: [ "<32>{#p/human}* (You threw away the Plunderer's Demise.)" ],
   ...
   m_aerialis: {
      ...
      sidebarCellPms3: {
         ...
         alphys9: {
            author: "ALPHYS",
            pm: "i finally started watching the last season and its actually good WTF"
         },
         alphys10: {
            author: "NAPSTABLOOK22",
            pm: "we did... that one time..."
         },
         alphys11: {
            author: () => (SAVE.data.n.state_starton_papyrus === 0 ? "COOLSKELETON95" : "ALPHYS"),
            pm: () =>
         ...
         alphys18: {
            author: "ALPHYS",
            pm: "i thought i told the royal guard not to go after anyone WTF???"
         },
         alphysX0: {
            author: "SYSTEM",
         ...
         alphysZ9: {
            author: "ALPHYS",
            pm: "god... i couldnt even bear to watch it this time"
         },
         alphysZ10: {
            author: "ALPHYS",
            pm: "um... sans"
         ...
         () =>
            SAVE.data.n.plot === 72
               ? [
                    ...
                    "<32>{#k/7}* ... and that day is probably coming up soon.",
   ...
   n_shop_gossip: {
      ...
      item: () =>
         adultEvac()
            ? [
                 ...
                 SAVE.data.b.item_visor ? "0G - Tactical Armband?" : "0G - Tactical Armband",
            ...
            : [
                 ...
                 SAVE.data.b.item_visor ? "60G - Tactical Armband?" : "70G - Tactical Armband",
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
                 "About You Two",
                 SAVE.data.n.plot < 68 ? "Thrift Shop" : "Grand Finale",
         ...
         () =>
            SAVE.data.n.plot === 72
               ? [
                    ...
                    {
                       b: "<16>{#k/2/5}* I mean, they seem kind of traumatized, but...",
                       c: "",
                       s: true
                    },
                    {
                       b: "",
                       c: "<16>{#k/7/5}* ... we're helping them through it.",
                       s: true
                    },
                    {
                       b: "<16>{#k/2/6}* They keep mentioning this \"archive\" thing...",
