...
const toriel_aerialis = () =>
   SAVE.data.n.plot < 49
      ? [
           ...
           '<25>{#f/1}* ¿Podrías llevarlo todo el camino hasta la Citadel?',
   ...
   a_outlands: {
      ...
      asrielDiary: [
         ...
         [
            ...
            '<32>* \"Además nos vamos a mudar a la nueva citadel cuando sea construida.\"',
      ...
      chair2c6: [
         '<25>{#f/1}{#n1}* \"Había una vez un monstruo...\"',
