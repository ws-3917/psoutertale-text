   ...
   a_aerialis: {
         ...
         end7: () => [
            ...
            ...(SAVE.data.n.state_aerialis_mettastrikes > 2
               ...
               ? [
                    ...
                    "<32>{#p/hapstablook}* It's an acting thing, dear."
                 ]
               : [ "<32>{#p/hapstablook}* I'd appreciate that." ])
         ],
         end8: [
         ...
         end10: () => [
            ...
            ...(SAVE.data.b.oops
               ...
               : [
                    ...
                    "<32>{#p/narrator}* Huh?",
                    "<32>{#p/hapstablook}* ... I wish you luck with your family business as well.",
                    "<32>{#p/narrator}* My... oh.",
                    "<32>{#p/narrator}* Yeah.",
                    "<32>{#p/narrator}* ... thanks, Mettaton."
                 ]),
            "<32>* Heh...",
            world.bad_lizard > 1
               ? "<32>* Until next time...\n* ...\n* ... brat."
         ...
         signposter2: () =>
            SAVE.data.b.svr
               ...
               ? [
                    ...
                    iFancyYourVilliany() ? "<32>{#p/basic}* Naturally, you're the villain." : "<32>{#p/basic}* Naturally, you're the star."
                 ]
               : [
      ...
      dinnerdate16: () => [
         ...
         ...(SAVE.flag.n._deaths > 0
            ...
            : [ "<25>{#f/2}* heh.\n* i don't even think you've been hit." ])
      ],
      dinnerdate18: () => [
            ...
            : [
                 ...
                 !world.badder_lizard
                    ...
                    : game.room === "f_napstablook" &&
                      ...
                      !world.runaway
                    ? [
                         "<32>{#p/basic}* You have a replica of Alphys's Mew Mew doll too, mew!?",
                         "<32>{#p/basic}* Incredible.\n* Incredible!\n* INCREDIBLE!!!"
                      ]
