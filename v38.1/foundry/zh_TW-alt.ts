...
export default {
   a_foundry: {
      ...
      darktoriel7: () =>
         SAVE.data.b.c_state_secret1_used
            ...
            : [
                 "<25>{#p/toriel}{#f/5}* 弗裡斯克，你得給我時間處理一下。",
                 "<25>{#f/1}* 運輸船上見。\n* 好嗎？"
              ],
      ghostpartymusic1: [
      ...
      tome4: () => [
         choicer.create(
            ...
            "Spare",
            world.meanie ? "Bully" : SAVE.data.b.oops && world.flirt > 9 ? "調情" : SAVE.data.b.oops ? "Befriend" : "擁抱",
            "Kill",
            "Take Gold"
         )
      ],
      ...
      genotext: {
         ...
         asriel41: [ "<25>{#p/asriel2}{#f/3}* 回來吧，小傢夥。" ],
      ...
      spookydate12b: [ "<25>{#p/sans}* 烤爾比，給我們來兩份小漢堡。" ],
      spookydate13: () => [
   ...
   b_opponent_muffet: {
      ...
      appeaseTextPost: [ "<32>{#p/human}* （但瑪菲特不需要被再次安撫。）" ],
   ...
   b_opponent_undyne: {
      ...
      randStatus4: () =>
         respecc() ? [ "<32>{#p/story}* 安黛因滿懷激情地跳來跳去。" ] : [ "<32>{#p/story}* 安黛因焦躁的跳來跳去。" ],
      randStatus5: () =>
         respecc()
