...
export default {
   a_outlands: {
      ...
      finaltext: {
         ...
         d13: [ "<32>{#p/basic}* 別傷心，艾斯利爾。", "<32>* 沒必要逼自己覺得\n  我是個好人。" ],
      ...
      asrielDiary: [
         ...
         [
            "<32>{#p/human}* （你翻到第二頁...）",
            "<32>{#p/asriel1}{#v/2}* 「艾利的日計 克ㄌㄧˋ504年」",
         ...
         [
            "<32>{#p/human}* （你翻到第四頁...）",
            "<32>{#p/asriel1}{#v/2}* 「艾利的日記，克曆506年3月」",
            "<32>* 「我和朋友 聊了一下，\n   朋友不生我的氣了\n   太好了。」",
            "<32>* 「今天 媽咪和我 到外面看星空\n   我們看到了流星。」",
            "<32>* 「媽咪讓我許個原...\n   我希望 有一天\n   我能在這裡見到人ㄌㄟˋ。」",
            "<32>* 「爹地和媽咪給我ㄐㄧㄤˇ了\n   很多他們的故事...」",
         ...
         [
            ...
            "<32>* 「$(name)說，是時候執行計畫了。」",
            "<32>* 「我很害怕，\n   但$(name)相信我能行的。」",
            "<32>* \"After this entry, I'll wait for them to eat the poisoned pie...\"",
            "<32>* 「然後，我們一起拯救所有怪物。」",
            "<32>* 「但是，$(name)。\n   如果真出了事，計畫失敗了...\n   如果你看到了這篇日記...」",
            "<32>* 「我想對你說，你是最棒的。」",
            "<32>{#p/basic}* ...",
      ...
      chair4: [ "<25>{#p/toriel}{#n1!}* 啊，你醒了。", "<25>* 我已經把你的那份早餐\n  放在桌子上了。" ],
      closetrocket: {
         a: () => [
      ...
      dummy5: [ "<25>{#p/toriel}{#f/1}* 不要怕，小傢夥..." ],
      dummy6: [
      ...
      steaksale: {
         ...
         b: () => [
            ...
            SAVE.data.b.napsta_performance
               ? choicer.create("* (Buy the Sizzli Steak for 40G?)", "是", "否")
         ...
         c: () => [
            ...
            SAVE.data.b.napsta_performance
               ? choicer.create("* (Buy the Fizzli Soda for 10G?)", "是", "否")
      ...
      tutorial_puzzle3: [ "<25>{#p/toriel}* 非常好，小傢夥！\n* 非常棒。" ],
      ...
      tutorial_puzzle8a: [ "<25>{#p/toriel}* 答案不在我身上，小傢夥。" ],
      ...
      twinkly19: [ "<20>{#p/toriel}真是個殘忍的傢夥，\n居然折磨這麼一個\n弱小無助的孩子..." ],
      twinkly20: [
         "<20>不要害怕，孩子。",
      ...
      twinkly21: [
         ...
         "<25>{#f/1}* 受傷了嗎？",
         "<25>{#f/0}* ...\n* 請原諒我問了這麼多問題。",
         "<25>{#f/0}* 我是{@fill=#003cff}托麗爾{@fill=#000}，\n  {@fill=#f00}外域{@fill=#000}的管理員。",
         "<26>{#f/0}* 我每天都會來看看\n  有沒有人被困在這裡。",
         "<25>{#f/0}* 跟我來，孩子。\n* 我有很多東西要教你。"
      ],
   ...
   b_opponent_toriel: {
      ...
      criminal2: [ "<20>{#p/asriel2}{#f/3}歡迎回來，$(name)。", "<20>{#f/1}準備好再大幹一番了嗎？" ],
