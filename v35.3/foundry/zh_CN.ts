...
export default {
   a_foundry: {
      ...
      spookydate12b: [ "<25>{#p/sans}* grillby，给我们来两份小汉堡。" ],
      spookydate13: () => [
      ...
      unddate41x: [ "<25>{#p/undyne}{#f/12}* 呃，你现在可以过来了，\n  小孩子。" ],
      unddate41y: () => [
