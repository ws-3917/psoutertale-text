...
export default {
   a_starton: {
      ...
      aussie: pager.create(
         ...
         () =>
            SAVE.data.n.state_starton_trashprogress < 1
               ? [ "<25>{#p/sans}{#f/0}* 来嘛，过来看看。", "<25>{#f/2}* it's right up there, bucko." ]
      ...
      trashhunt3: () => [
         ...
         ...(SAVE.storage.inventory.size < 8
            ? [ "<32>{#s/equip}{#p/human}* （你获得了玉狗圣剑。）", "<25>{#p/sans}{#f/2}* use it wisely." ]
            : [
                 "<32>{#p/human}* （你带的东西太多了。）",
      ...
      sanscab1: () => [
         ...
         "<32>{#s/equip}{#p/human}* （重力转换器遥控器被添加到了\n  你的钥匙串上。）"
      ],
      sanscab2: () =>
         SAVE.data.b.svr
      ...
      capstation2: [ "<32>{#p/human}* （你看了眼岗哨后面。）", "<32>{#p/basic}* 没有新东西。" ],
      crossword0: () =>
         world.edgy
            ? [
                 "<25>{#p/sans}* 哦，你来了。",
      ...
      papyrusFinal4: (b: boolean) =>
         world.edgy || world.killed0
            ? [
                 ...
                 "<18>{#p/papyrus}{#f/4}...等等，我是不是该抓你来着？",
                 "<18>{#p/papyrus}{#f/0}嗨，\n随它去吧。",
                 "<18>{#p/papyrus}{#f/0}只要你能成为\n最棒的自己，\n我就满足啦。",
   ...
   b_opponent_dogamy: {
      ...
      flirtTextLone: [ "<32>{#p/human}* （你对狗来米调情。）", "<32>{#p/basic}* 狗来米的表情没有发生变化。" ],
      loneStatus: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 只剩一个了。" ]
            : [ "<32>{#p/story}* 狗媳儿一心想要踢\n  人类的尾巴。" ],
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      ...
      s_backrooms: pager.create(
         ...
         () =>
            solo()
               ? [ "<18>{#p/papyrus}{#f/4}是某种“厨房”...", "<18>{#f/5}现在他们只把这里\n当成玩私人纸牌\n游戏的地方了。" ]
               : [
