...
export default {
   a_aerialis: {
      ...
      corndog1: pager.create(
         ...
         () => [ "<25>{#p/sans}{#f/0}* corn dogs for 5G.", choicer.create("* (Buy the Corn Dog for 5G?)", "是", "否") ]
      ),
      corndog2: [
         "<32>{#p/human}* （你带的东西太多了。）",
      ...
      story: {
         ...
         moneyPun1: () =>
            world.dead_skeleton
               ? [ "<32>{#p/sans}* ...", "<32>{#p/sans}{#f/3}* i might as well show myself out." ]
               : [ "<32>{#p/sans}* welp.", "<32>{#p/sans}{#g/sansWink}* i'm {@fill=#ff0}boned{@fill=#fff}." ],
         moneyPun1a: () =>
            iRespeccYourVilliany()
   ...
   b_opponent_mettaton1: {
      ...
      turn3react2: [ "<20>{#p/mettaton}太接近了..." ],
